...
GitHub code search supports searching across issues, pull requests, commits, packages, discussions, and more. In addition to searching your private code, GitHub has indexed over 7 million public GitHub repositories which are also searchable.
