...
GitHub code search supports searching issues and pull requests along with the codebase. In addition to searching your private code, GitHub has indexed over 7 million public GitHub repositories which are also searchable.
