...
<video class="theme-dark-only" autoplay loop muted playsinline style="width: 100%; max-width: 50rem">
...
<video class="theme-light-only" autoplay loop muted playsinline style="width: 100%; max-width: 50rem">
