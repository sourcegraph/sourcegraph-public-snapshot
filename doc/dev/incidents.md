...
1. If the incident was reported by someone outside of Sourcegraph, acknowledge to them that the incident is being handled.
1. Start an internal communication thread about this incident in the #incidents channel in Slack.
1. Find an engineer to acknowledge ownership of the incident.
