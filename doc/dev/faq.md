...
Sourcegraph is released under the [Apache License v2.0](https://github.com/sourcegraph/sourcegraph/blob/master/LICENSE.apache). This covers all files in this repository except those in the enterprise/ directory.
