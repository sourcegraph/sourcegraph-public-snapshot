...
- [Campaign product documentation](../../../batch_changes/index.md)
- [Campaign design principles](../../../batch_changes/explanations/batch_changes_design.md)
- [Campaign developer documentation](../batch_changes/index.md)
- [How `src` executes a campaign spec](../../../batch_changes/explanations/how_src_executes_a_batch_spec.md)
