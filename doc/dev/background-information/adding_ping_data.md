...
1. Write an RFC describing the problem, data that will be added, and how Sourcegraph will use the data to make decisions. The Data & Analytics team must be a required reviewer. Please include the following information RFC:
