...
Expected values that are not simple scalars (really, anything not comparable with `==`) should use [go-cmp]([https://github.com/google/go-cmp/cmp](https://github.com/google/go-cmp) to create a highly-readable diff string.
