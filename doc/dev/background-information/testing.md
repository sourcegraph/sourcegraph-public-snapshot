...
- You can also run `yarn test` from any of the individual project dirs (`client/ui-kit-legacy-shared/`, `client/app-web/`, `client/extension-browser/`).
...
```
IMAGE=sourcegraph/server:3.25.2 ./dev/run-server-image.sh
```
