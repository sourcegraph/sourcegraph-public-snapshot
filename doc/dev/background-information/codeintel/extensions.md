...
Code navigation queries are resolved favoring [precise](https://docs.sourcegraph.com/code_navigation/explanations/precise_code_intelligence) code navigation, if available, then falling back to [search-based](https://docs.sourcegraph.com/code_navigation/explanations/search_based_code_intelligence).
