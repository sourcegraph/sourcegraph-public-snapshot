...
- Pipeline for `Go` changes:
  ...
  - **Go checks**: Test (all), Test (enterprise/internal/codeintel/shared/dbstore), Test (enterprise/internal/codeintel/shared/lsifstore), Test (enterprise/internal/insights), Test (internal/database), Test (internal/repos), Test (enterprise/internal/batches), Test (cmd/frontend), Test (enterprise/internal/database), Test (enterprise/cmd/frontend/internal/batches/resolvers), Test (dev/sg), Build
  - Upload build trace
...
- Pipeline for `DatabaseSchema` changes:
  - **Metadata**: Pipeline metadata
  - **DB backcompat tests**: Backcompat test (all), Backcompat test (enterprise/internal/codeintel/shared/dbstore), Backcompat test (enterprise/internal/codeintel/shared/lsifstore), Backcompat test (enterprise/internal/insights), Backcompat test (internal/database), Backcompat test (internal/repos), Backcompat test (enterprise/internal/batches), Backcompat test (cmd/frontend), Backcompat test (enterprise/internal/database), Backcompat test (enterprise/cmd/frontend/internal/batches/resolvers), Backcompat test (dev/sg)
  - Upload build trace
...
- **DB backcompat tests**: Backcompat test (all), Backcompat test (internal/codeintel/shared/dbstore), Backcompat test (internal/codeintel/shared/lsifstore), Backcompat test (enterprise/internal/insights), Backcompat test (internal/database), Backcompat test (internal/repos), Backcompat test (enterprise/internal/batches), Backcompat test (cmd/frontend), Backcompat test (enterprise/internal/database), Backcompat test (enterprise/cmd/frontend/internal/batches/resolvers), Backcompat test (dev/sg)
- **CI script tests**: test-trace-command.sh
- **Integration tests**: Backend integration tests, Code Intel QA
- **End-to-end tests**: Sourcegraph E2E, Sourcegraph QA, Sourcegraph Cluster (deploy-sourcegraph) QA, Sourcegraph Upgrade
