...
- Pipeline for `Client` changes:
  ...
  - **Client checks**: Puppeteer tests for chrome extension, Puppeteer tests prep, Puppeteer tests chunk #1, Puppeteer tests chunk #2, Puppeteer tests chunk #3, Puppeteer tests chunk #4, Puppeteer tests chunk #5, Puppeteer tests chunk #6, Puppeteer tests chunk #7, Puppeteer tests chunk #8, Puppeteer tests chunk #9, Upload Storybook to Chromatic, Test (all), Build, Enterprise build, Test (client/web), Test (client/browser), Puppeteer tests for chrome extension, ESLint, Build TS, Stylelint
  - Upload build trace
