...
See the [setting up PostgreSQL guide](../getting-started/configure_local_postgresql.md) or [quickstart step 2: initialize the database](../getting-started/quickstart_2_initialize_database.md)
