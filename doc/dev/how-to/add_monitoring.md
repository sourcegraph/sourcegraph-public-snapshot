...
- [Running the monitoring stack locally](../../local-dev-env/how-to/monitoring_local_dev.md)
...
If the generator runs successfully, you should now [run the monitoring stack locally](../../local-dev-env/how-to/monitoring_local_dev.md) to validate the output and results of your observable by hand.
