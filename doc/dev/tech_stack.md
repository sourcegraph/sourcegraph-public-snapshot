...
2. Open a PR that adds a description for the new exception to that document.
...
Why do we put up with that pain? As of October 2019, Syntect continues to be the best option for us to deliver high quality syntax highlighting to our users across a wide variety of languages. References:
