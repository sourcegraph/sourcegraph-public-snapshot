...
- [Precise code intel system](https://github.com/sourcegraph/sourcegraph/tree/master/precise-code-intel) provides precise code intelligence based on the LSIF data format. It is written in TypeScript.
