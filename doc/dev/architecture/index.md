...
- [LSIF](https://github.com/sourcegraph/sourcegraph/tree/master/lsif) provide precise code intelligence based on the LSIF data format. It is written in TypeScript.
