...
| **file:has.owners(...)** | Conditionally search files only if they are owned by the given owner. See [Sourcegraph Own documentation](../../own) for more. | [`file:has.owner(alice@sourcegraph.com) Sourcegraph`](https://sourcegraph.com/search?q=context:global+file:has.owner%28alice@sourcegraph.com%29+Sourcegraph&patternType=lucky) |
