...
1. Add `"codeIntelLockfileIndexing.enabled": true` to your [site configuration](../../admin/config/site_config) to enable the lockfile-indexing feature.
1. Add `"codeIntelAutoIndexing.allowGlobalPolicies": true` to your [site configuration](../../admin/config/site_config) to allow a lockfile-indexing policy to match multiple repositories.
