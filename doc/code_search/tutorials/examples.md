...
[Search a subset of repositories in an organization](https://sourcegraph.com/search?q=context:global+r:hashicorp/vault*+terraform&patternType=standard&sm=1&groupBy=repo)
