...
- [Ingress controller](../admin/install/kubernetes/configure#ingress-controller-recommended.md)
- [Common configuration](../admin/install/kubernetes/configure#common-configuration)
