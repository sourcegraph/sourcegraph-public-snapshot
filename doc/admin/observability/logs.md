...
Learn more about how to apply these environment variables in [docker-compose](../docker-compose/operations.md#set-environment-variables) and [server](../docker/operations#environment-variables) deployments. 
