...
### Worker: Precise code intelligence stores and clients

#### worker: codeintel_dbstore_99th_percentile_duration

This panel indicates 99th percentile successful database store operation duration over 5m.

> NOTE: Alerts related to this panel are documented in the [alert solutions reference](./alert_solutions.md#worker-codeintel-dbstore-99th-percentile-duration).
...
> NOTE: Alerts related to this panel are documented in the [alert solutions reference](./alert_solutions.md#worker-codeintel-dbstore-errors).
...
> NOTE: Alerts related to this panel are documented in the [alert solutions reference](./alert_solutions.md#worker-codeintel-upload-workerstore-99th-percentile-duration).
...
> NOTE: Alerts related to this panel are documented in the [alert solutions reference](./alert_solutions.md#worker-codeintel-upload-workerstore-errors).
...
> NOTE: Alerts related to this panel are documented in the [alert solutions reference](./alert_solutions.md#worker-codeintel-index-workerstore-99th-percentile-duration).
...
> NOTE: Alerts related to this panel are documented in the [alert solutions reference](./alert_solutions.md#worker-codeintel-index-workerstore-errors).
...
> NOTE: Alerts related to this panel are documented in the [alert solutions reference](./alert_solutions.md#worker-codeintel-lsifstore-99th-percentile-duration).
...
> NOTE: Alerts related to this panel are documented in the [alert solutions reference](./alert_solutions.md#worker-codeintel-lsifstore-errors).
...
> NOTE: Alerts related to this panel are documented in the [alert solutions reference](./alert_solutions.md#worker-codeintel-uploadstore-99th-percentile-duration).
...
> NOTE: Alerts related to this panel are documented in the [alert solutions reference](./alert_solutions.md#worker-codeintel-uploadstore-errors).
...
> NOTE: Alerts related to this panel are documented in the [alert solutions reference](./alert_solutions.md#worker-codeintel-gitserverclient-99th-percentile-duration).
...
> NOTE: Alerts related to this panel are documented in the [alert solutions reference](./alert_solutions.md#worker-codeintel-gitserverclient-errors).
