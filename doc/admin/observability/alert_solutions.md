...
- <span class="badge badge-warning">warning</span> worker: 20s+ 99th percentile successful database store operation duration over 5m
...
```json
"observability.silenceAlerts": [
  "warning_worker_codeintel_dbstore_99th_percentile_duration"
]
```
...
## worker: codeintel_dbstore_errors

<p class="subtitle">database store errors every 5m</p>

**Descriptions**

- <span class="badge badge-warning">warning</span> worker: 20+ database store errors every 5m
...
```json
"observability.silenceAlerts": [
  "warning_worker_codeintel_dbstore_errors"
]
```
...
## worker: codeintel_upload_workerstore_99th_percentile_duration

<p class="subtitle">99th percentile successful upload worker store operation duration over 5m</p>

**Descriptions**

- <span class="badge badge-warning">warning</span> worker: 20s+ 99th percentile successful upload worker store operation duration over 5m
...
```json
"observability.silenceAlerts": [
  "warning_worker_codeintel_upload_workerstore_99th_percentile_duration"
]
```
...
## worker: codeintel_upload_workerstore_errors

<p class="subtitle">upload worker store errors every 5m</p>

**Descriptions**

- <span class="badge badge-warning">warning</span> worker: 20+ upload worker store errors every 5m
...
```json
"observability.silenceAlerts": [
  "warning_worker_codeintel_upload_workerstore_errors"
]
```
...
## worker: codeintel_index_workerstore_99th_percentile_duration

<p class="subtitle">99th percentile successful index worker store operation duration over 5m</p>

**Descriptions**

- <span class="badge badge-warning">warning</span> worker: 20s+ 99th percentile successful index worker store operation duration over 5m
...
```json
"observability.silenceAlerts": [
  "warning_worker_codeintel_index_workerstore_99th_percentile_duration"
]
```
...
## worker: codeintel_index_workerstore_errors

<p class="subtitle">index worker store errors every 5m</p>

**Descriptions**

- <span class="badge badge-warning">warning</span> worker: 20+ index worker store errors every 5m
...
```json
"observability.silenceAlerts": [
  "warning_worker_codeintel_index_workerstore_errors"
]
```
...
- <span class="badge badge-warning">warning</span> worker: 20s+ 99th percentile successful LSIF store operation duration over 5m
...
```json
"observability.silenceAlerts": [
  "warning_worker_codeintel_lsifstore_99th_percentile_duration"
]
```
...
## worker: codeintel_lsifstore_errors

<p class="subtitle">lSIF store errors every 5m</p>

**Descriptions**

- <span class="badge badge-warning">warning</span> worker: 20+ lSIF store errors every 5m
...
```json
"observability.silenceAlerts": [
  "warning_worker_codeintel_lsifstore_errors"
]
```
...
## worker: codeintel_uploadstore_99th_percentile_duration

<p class="subtitle">99th percentile successful upload store operation duration over 5m</p>

**Descriptions**

- <span class="badge badge-warning">warning</span> worker: 20s+ 99th percentile successful upload store operation duration over 5m
...
```json
"observability.silenceAlerts": [
  "warning_worker_codeintel_uploadstore_99th_percentile_duration"
]
```
...
## worker: codeintel_uploadstore_errors

<p class="subtitle">upload store errors every 5m</p>

**Descriptions**

- <span class="badge badge-warning">warning</span> worker: 20+ upload store errors every 5m
...
```json
"observability.silenceAlerts": [
  "warning_worker_codeintel_uploadstore_errors"
]
```
...
## worker: codeintel_gitserverclient_99th_percentile_duration

<p class="subtitle">99th percentile successful gitserver client operation duration over 5m</p>

**Descriptions**

- <span class="badge badge-warning">warning</span> worker: 20s+ 99th percentile successful gitserver client operation duration over 5m
...
```json
"observability.silenceAlerts": [
  "warning_worker_codeintel_gitserverclient_99th_percentile_duration"
]
```
...
## worker: codeintel_gitserverclient_errors

<p class="subtitle">gitserver client errors every 5m</p>

**Descriptions**

- <span class="badge badge-warning">warning</span> worker: 20+ gitserver client errors every 5m
...
```json
"observability.silenceAlerts": [
  "warning_worker_codeintel_gitserverclient_errors"
]
```
