...
- _gitserver: 50+ running git commands for 2m0s_
- _gitserver: 100+ running git commands for 5m0s_
...
- Refer to the [dashboards reference](https://docs.sourcegraph.com/admin/observability/dashboards#gitserver-running-git-commands) for more help interpreting this panel.
- **Silence this alert:** If you are aware of this alert and want to silence notifications for it, add the following to your site configuration and set a reminder to re-evaluate the alert:
