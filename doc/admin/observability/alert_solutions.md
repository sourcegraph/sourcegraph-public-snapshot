...
```json
"observability.silenceAlerts": [
  "warning_replacer_provisioning_container_cpu_usage_long_term"
]
```
...
- _replacer: 80%+ or less than 30% container memory usage (1d maximum) by instance for 336h0m0s_
...
```json
"observability.silenceAlerts": [
  "warning_replacer_provisioning_container_memory_usage_long_term"
]
```
...
```json
"observability.silenceAlerts": [
  "warning_replacer_provisioning_container_cpu_usage_short_term"
]
```
...
```json
"observability.silenceAlerts": [
  "warning_replacer_provisioning_container_memory_usage_short_term"
]
```
...
- _replacer: 10000+ maximum active goroutines for 10m for 10m0s_
...
- _replacer: less than 90% percentage pods available for 10m for 10m0s_
