...
- _frontend: 25%+ search alert user suggestions shown every 5m_
...
- _frontend: 25%+ search code-intel alert user suggestions shown every 5m_
...
- _frontend: 10%+ precise code intel api errors every 5m_
...
- _frontend: 10+ precise code intel database errors every 5m_
...
- _frontend: 10%+ internal indexed search error responses every 5m_
...
- _frontend: 10%+ internal unindexed search error responses every 5m_
...
- _frontend: 10%+ internal API error responses every 5m by route_
...
- _frontend: 10%+ precise-code-intel-bundle-manager error responses every 5m_
