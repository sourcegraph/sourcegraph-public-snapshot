...
- <span class="badge badge-warning">warning</span> worker: 0+ queue size that is not utilized (not processing) for 30m0s
...
- Learn more about the related dashboard panel in the [dashboards reference](./dashboards.md#worker-insights-queue-unutilized-size).
- **Silence this alert:** If you are aware of this alert and want to silence notifications for it, add the following to your site configuration and set a reminder to re-evaluate the alert:
