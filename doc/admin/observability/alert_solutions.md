...
- _frontend: 2%+ hard timeout search responses every 5m_
...
- _frontend: 2%+ hard error search responses every 5m_
...
- _frontend: 5%+ search alert user suggestions shown every 5m_
...
- _frontend: 2%+ hard timeout search code-intel responses every 5m_
...
- _frontend: 2%+ hard error search code-intel responses every 5m_
...
- _frontend: 5%+ search code-intel alert user suggestions shown every 5m_
...
- _frontend: 2%+ hard timeout search API responses every 5m_
...
- _frontend: 2%+ hard error search API responses every 5m_
...
- _frontend: 5%+ precise code intel api errors every 5m_
...
- _frontend: 5+ precise code intel database errors every 5m_
...
- _frontend: 5%+ internal API error responses every 5m by route_
