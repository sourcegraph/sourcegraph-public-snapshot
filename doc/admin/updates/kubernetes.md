...
> Warning: ⚠️ We have update our default replicas for `sourcegraph-frontend` and `precise-code-intel-worker` to 2. If you use a custom value, make sure you do not merge the replica change.
