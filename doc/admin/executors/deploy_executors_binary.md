...
| `EXECUTOR_CA_CERTIFICATE`                | The base64 encoded CA certificate to use for TLS connections to the frontend.                                                                                                                                                      | `LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCk1JSURKakNDQW...` |
