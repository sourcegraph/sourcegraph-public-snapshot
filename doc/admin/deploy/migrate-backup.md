...
|[Code graph metadata](../../code_intelligence/explanations/precise_code_intelligence.md)|Yes (if manually regenerated)|This can be regenerated by re-running the indexing and upload process for affected repositories and revisions, but will not be regenerated by default.|
...
|Search indexes|Yes||
|[Code graph data](../../code_intelligence/explanations/precise_code_intelligence.md)|No|This can be regenerated by re-running the indexing and upload process for affected repositories and revisions, but will not be regenerated by default.|
