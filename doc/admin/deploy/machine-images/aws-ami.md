...
9. Ensure the new instance is part of the Application Load Balancer target group so traffic will be routed appropriately.
10. On the `Attach volume` page:
  - **Instance**: select the new Sourcegraph AMI instance
  - **Device name**: /dev/sdb
11. **Reboot** the new instance
