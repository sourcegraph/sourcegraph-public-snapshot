...
```sh
helm install --version 5.0.5 sourcegraph sourcegraph/sourcegraph
```
...
```sh
helm upgrade --install --values ./override.yaml --version 5.0.5 sourcegraph sourcegraph/sourcegraph
```
...
```bash
helm upgrade --install -f override.yaml --version 5.0.5 sourcegraph sourcegraph/sourcegraph
```
