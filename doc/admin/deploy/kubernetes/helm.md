...
```sh
helm upgrade --install --values ./override.yaml --version 3.41.1 sourcegraph sourcegraph/sourcegraph
```
...
1.  Install the new version:
   ...
   ```bash
      helm upgrade --install -f override.yaml --version 3.41.1 sourcegraph sourcegraph/sourcegraph
   ```
