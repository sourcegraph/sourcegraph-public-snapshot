...
```sh
helm install --version 4.1.3 sourcegraph sourcegraph/sourcegraph
```
...
```sh
helm upgrade --install --values ./override.yaml --version 4.1.3 sourcegraph sourcegraph/sourcegraph
```
...
```bash
helm upgrade --install -f override.yaml --version 4.1.3 sourcegraph sourcegraph/sourcegraph
```
