# [Deprecated Version] Sourcegraph with Kubernetes
...
Not sure if Kubernetes is the right choice for you? Learn more about the various [Sourcegraph installation options](../../index.md#deployment-types).
