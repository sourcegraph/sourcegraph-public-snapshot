...
- Dependency versions (eg redis: "6.0.9" or postgres: "PostgreSQL 13.0 on x86_64-apple-darwin19.6.0, compiled by Apple clang version 12.0.0 (clang-1200.0.32.2), 64-bit")
