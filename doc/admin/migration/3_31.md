...
> ⚠️ We advise all customers upgrading to 3.31 to check for corruption prior to check for corruption prior to upgrade, and allow for greater than normal downtime. See below for more detailed advice.
