# Migrating from Sourcegraph 2.13 to 3.x
...
⚠️ Because 3.x [upgrades the Postgres version](#Postgres-upgrade), it is not possible to downgrade from 3.x to 2.x unless you also restore your Postgres database from a 2.x snapshot.
