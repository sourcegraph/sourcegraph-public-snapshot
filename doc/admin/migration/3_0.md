...
The upgrade procedure is mostly automated for existing deployments which requires mounting the Docker socket the first time running the new container.

 🔸 Please go to our 👉 [Postgres docs](https://docs.sourcegraph.com/admin/postgres) 👈 for **detailed instructions** on *how* to conduct this operation. 🔸
