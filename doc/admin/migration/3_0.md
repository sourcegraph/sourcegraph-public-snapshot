...
> WARNING: ⚠️ Because `3.0.1` [upgrades the Postgres version](./3_0.md#Postgres-upgrade):
>
>* Anyone upgrading from `2.x` to `3.0.1+`, or from `3.0.0` to `3.0.1+` MUST follow the [Postgres upgrade](./3_0.md#Postgres-upgrade) instructions below.
