...
## Postgres has been upgraded to 11.1

Sourcegraph's internal database, Postgres, has been upgraded to version 11.1.
For most deployment types, the upgrade procedure is automated but it can be done manually too.
Please refer to [this page](https://docs.sourcegraph.com/admin/postgres.md) for instructions.
