# Sourcegraph data storage

While much of Sourcegraph's data can be regenerated, some state can be stored in multiple locations. See the [migrate and backup Sourcegraph](../how-to/migrate_and_backup_sourcegraph.md) guide for options on how to restore this data.
