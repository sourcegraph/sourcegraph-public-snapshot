...
Using webhooks is highly recommended when using [Campaigns](../../user/campaigns), since they speed up the syncing of pull request data between Bitbucket Server and Sourcegraph and make it more efficient.
...
Done! Sourcegraph will now receive webhook events from Bitbucket Server and use them to sync pull request events, used by [Campaigns](../../user/campaigns), fast and more efficiently.
