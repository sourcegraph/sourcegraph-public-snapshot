...
When using [campaigns](../../user/campaigns/index.md) the access token needs **write** permissions on the project and repository level. See "[Code host interactions in campaigns](../../user/campaigns/explanations/managing_access.md#code-host-interactions-in-campaigns)" for details.
