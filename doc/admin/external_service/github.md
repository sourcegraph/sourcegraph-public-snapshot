...
- `repo`, `read:org`, and `read:discussion` to use [campaigns](../../user/campaigns/index.md) with GitHub repositories. See "[Code host interactions in campaigns](../../user/campaigns/explanations/managing_access.md#code-host-interactions-in-campaigns)" for details.
