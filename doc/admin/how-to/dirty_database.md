...
1. **Ensure the migration applied, and manually clear the dirty flag on the `schema_migrations` table with the following query: `UPDATE schema_migrations SET version=1528395918, dirty=false;`**
