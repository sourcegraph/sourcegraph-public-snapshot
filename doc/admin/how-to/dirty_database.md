...
The following procedure requires that you are able to execute commands from inside the database container. Learn more about shelling into [kubernetes](../deploy/kubernetes/operations#access-the-database), [docker-compose](../deploy/docker-compose#access-the-database), and [Sourcegraph single-container](../deploy/docker-single-container#access-the-database) instances at these links.
