...
The red dot indicates that you have enabled Sourcegraph on this specific domain. More infomration can be found in our [browser extension docs](https://docs.sourcegraph.com/integration/browser_extension#make-it-work-on-your-code-host).
