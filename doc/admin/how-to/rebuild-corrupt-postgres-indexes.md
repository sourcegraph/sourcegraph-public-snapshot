...
> NOTE: You can refer to the following instructions for accessing databases on your deployment type: [Docker Compose](../deploy/docker-compose#access-the-database), [Kubernetes](../deploy//kubernetes/operations#access-the-database).
