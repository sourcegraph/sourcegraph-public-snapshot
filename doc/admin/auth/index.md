...
> _NOTE: If OAuth is the only sign-in method avaialble on sign-out a new OAuth sign-in will be immediately attempted upon redirect to the sign-in page. If it is necessary to sign-out and have persistent access to the sign-in page, enable `builtin` sign-in in addition to your OAuth sign-in._
