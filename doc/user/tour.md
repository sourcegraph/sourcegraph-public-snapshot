...
You will need to install Sourcegraph to search your own code and walk through the example below. If you'd rather try Sourcegraph out before installing it, use [Sourcegraph Cloud](https://sourcegraph.com/search?_ga=2.63994027.549809329.1600636538-492280637.1594509875) and search public code. 
