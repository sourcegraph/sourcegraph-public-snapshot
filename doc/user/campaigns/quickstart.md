...
See ["Code host interactions in campaigns"](explanations/managing_access.md#code-host-interactions-in-campaigns) for details on what the permissions are used for.
