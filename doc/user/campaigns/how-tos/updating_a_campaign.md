...
To update a campaign, you need [admin access to the campaign](../explanations/managing_access.md#campaign-access-for-each-permission-level), and [write access to all affected repositories](../explanations/managing_access.md#repository-permissions-for-campaigns) with published changesets.
