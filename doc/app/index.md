...
Navigate to your Appliations directory using Finder, and delete the old version of Sourcegraph. Then [download and run the latest version](about.sourcegraph.com/app).
...
Navigate to your Appliations directory using Finder, and delete the old version of Sourcegraph.
