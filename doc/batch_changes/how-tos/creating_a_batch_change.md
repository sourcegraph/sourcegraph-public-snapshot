...
1. Run the following command in your terminal:
    ...
    > NOTE: Campaigns's default behavior is to stop if computing changes in a repository errors. You can choose to ignore errors instead by adding the [`skip-errors`](../../cli/references/batch/preview.md) flag : `src batch preview -f spec.campaign.yml -skip-errors`
