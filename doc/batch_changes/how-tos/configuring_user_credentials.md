...
> NOTE: See ["Code host interactions in campaigns"](../explanations/permissions_in_batch_changes.md#code-host-interactions-in-campaigns) for details on what the permissions are used for.
