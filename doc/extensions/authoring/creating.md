...
The `README.md` is the content for your extension page in the extension registry. See the [Codecov extension](https://github.com/codecov/sourcegraph-codecov) for a great example.
