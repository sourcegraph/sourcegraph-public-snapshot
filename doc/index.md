...
> The Docker server image tags follow SemVer semantics, so version 3.8 can be found at `sourcegraph/server:3.8.1`. You can see the full list of tags on our [Docker Hub page](https://hub.docker.com/r/sourcegraph/server/tags).
