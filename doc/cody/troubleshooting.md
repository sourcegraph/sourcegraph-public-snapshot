...
If you're connected to the Cody app, you can trigger indexing for a repository by adding the repo to your app under Settings > Local repositories, navigating to Settings > Advanced settings > Embeddings jobs in the app, and scheduling embedding. If your repo has no git remote, you'll need to follow the step below to set `Cody: Codebase` to the local path (eg, for `Users/myname/projects/myrepo` set `Cody: Codebase` to `myrepo`). 
