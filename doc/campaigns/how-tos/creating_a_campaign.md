...
1. Run the following command in your terminal:
    ...
    > NOTE: Campaigns's default behavior is to stop if creating changes on a repository errors. You can choose to ignore errors instead by adding the [`skip-errors`](../../cli/references/campaigns/preview.md) flag : `src campaign preview -f spec.campaign.yml -skip-errors`
