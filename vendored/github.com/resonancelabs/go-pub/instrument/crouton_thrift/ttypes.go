...
type SpanRecord struct {
	...
	DeprecatedErrorText *string        `thrift:"deprecated_error_text,7" json:"deprecated_error_text"`
...
var SpanRecord_DeprecatedErrorText_DEFAULT string

func (p *SpanRecord) GetDeprecatedErrorText() string {
	if !p.IsSetDeprecatedErrorText() {
		return SpanRecord_DeprecatedErrorText_DEFAULT
	}
	return *p.DeprecatedErrorText
}
...
func (p *SpanRecord) IsSetDeprecatedErrorText() bool {
	return p.DeprecatedErrorText != nil
}
...
func (p *SpanRecord) ReadField7(iprot thrift.TProtocol) error {
	if v, err := iprot.ReadString(); err != nil {
		return fmt.Errorf("error reading field 7: %s", err)
	} else {
		p.DeprecatedErrorText = &v
	}
	return nil
}
...
func (p *SpanRecord) writeField7(oprot thrift.TProtocol) (err error) {
	if p.IsSetDeprecatedErrorText() {
		if err := oprot.WriteFieldBegin("deprecated_error_text", thrift.STRING, 7); err != nil {
			return fmt.Errorf("%T write field begin error 7:deprecated_error_text: %s", p, err)
		}
		if err := oprot.WriteString(string(*p.DeprecatedErrorText)); err != nil {
			return fmt.Errorf("%T.deprecated_error_text (7) field write error: %s", p, err)
		}
		if err := oprot.WriteFieldEnd(); err != nil {
			return fmt.Errorf("%T write field end error 7:deprecated_error_text: %s", p, err)
		}
	}
	return err
}
...
type ReportRequest struct {
	...
	DiscardedLogRecordSamples []*SampleCount `thrift:"discarded_log_record_samples,6" json:"discarded_log_record_samples"`
}
...
var ReportRequest_DiscardedLogRecordSamples_DEFAULT []*SampleCount

func (p *ReportRequest) GetDiscardedLogRecordSamples() []*SampleCount {
	return p.DiscardedLogRecordSamples
}
...
func (p *ReportRequest) IsSetDiscardedLogRecordSamples() bool {
	return p.DiscardedLogRecordSamples != nil
}
...
func (p *ReportRequest) ReadField3(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.SpanRecords = append(p.SpanRecords, _elem4)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return fmt.Errorf("error reading list end: %s", err)
	}
...
func (p *ReportRequest) ReadField6(iprot thrift.TProtocol) error {
	_, size, err := iprot.ReadListBegin()
	if err != nil {
		return fmt.Errorf("error reading list begin: %s", err)
	}
	tSlice := make([]*SampleCount, 0, size)
	p.DiscardedLogRecordSamples = tSlice
	for i := 0; i < size; i++ {
		_elem6 := &SampleCount{}
		if err := _elem6.Read(iprot); err != nil {
			return fmt.Errorf("%T error reading struct: %s", _elem6, err)
		}
		p.DiscardedLogRecordSamples = append(p.DiscardedLogRecordSamples, _elem6)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return fmt.Errorf("error reading list end: %s", err)
	}
...
func (p *ReportRequest) writeField6(oprot thrift.TProtocol) (err error) {
	if p.IsSetDiscardedLogRecordSamples() {
		if err := oprot.WriteFieldBegin("discarded_log_record_samples", thrift.LIST, 6); err != nil {
			return fmt.Errorf("%T write field begin error 6:discarded_log_record_samples: %s", p, err)
		}
		if err := oprot.WriteListBegin(thrift.STRUCT, len(p.DiscardedLogRecordSamples)); err != nil {
			return fmt.Errorf("error writing list begin: %s", err)
		}
		for _, v := range p.DiscardedLogRecordSamples {
			if err := v.Write(oprot); err != nil {
				return fmt.Errorf("%T error writing struct: %s", v, err)
			}
		}
		...
		if err := oprot.WriteFieldEnd(); err != nil {
			return fmt.Errorf("%T write field end error 6:discarded_log_record_samples: %s", p, err)
		}
	}
	return err
}
...
func (p *ReportResponse) ReadField1(iprot thrift.TProtocol) error {
	...
	for i := 0; i < size; i++ {
		...
		p.Commands = append(p.Commands, _elem7)
	}
	if err := iprot.ReadListEnd(); err != nil {
		return fmt.Errorf("error reading list end: %s", err)
	}
