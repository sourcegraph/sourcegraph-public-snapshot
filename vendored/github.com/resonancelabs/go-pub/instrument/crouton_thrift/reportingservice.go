...
func NewReportingServiceProcessor(handler ReportingService) *ReportingServiceProcessor {
	...
	self10 := &ReportingServiceProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self10.processorMap["Report"] = &reportingServiceProcessorReport{handler: handler}
	return self10
}
