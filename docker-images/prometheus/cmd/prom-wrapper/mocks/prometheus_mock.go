...
func NewMockAPI() *MockAPI {
	return &MockAPI{
		AlertManagersFunc: &APIAlertManagersFunc{
			defaultHook: func(context.Context) (r0 v1.AlertManagersResult, r1 error) {
				return
			},
		},
		AlertsFunc: &APIAlertsFunc{
			defaultHook: func(context.Context) (r0 v1.AlertsResult, r1 error) {
				return
			},
		},
		BuildinfoFunc: &APIBuildinfoFunc{
			defaultHook: func(context.Context) (r0 v1.BuildinfoResult, r1 error) {
				return
			},
		},
		CleanTombstonesFunc: &APICleanTombstonesFunc{
		...
		ConfigFunc: &APIConfigFunc{
			defaultHook: func(context.Context) (r0 v1.ConfigResult, r1 error) {
				return
			},
		},
		DeleteSeriesFunc: &APIDeleteSeriesFunc{
			defaultHook: func(context.Context, []string, time.Time, time.Time) (r0 error) {
				return
			},
		},
		FlagsFunc: &APIFlagsFunc{
			defaultHook: func(context.Context) (r0 v1.FlagsResult, r1 error) {
				return
			},
		},
		LabelNamesFunc: &APILabelNamesFunc{
			defaultHook: func(context.Context, []string, time.Time, time.Time) (r0 []string, r1 v1.Warnings, r2 error) {
				return
			},
		},
		LabelValuesFunc: &APILabelValuesFunc{
			defaultHook: func(context.Context, string, []string, time.Time, time.Time) (r0 model.LabelValues, r1 v1.Warnings, r2 error) {
				return
			},
		},
		MetadataFunc: &APIMetadataFunc{
			defaultHook: func(context.Context, string, string) (r0 map[string][]v1.Metadata, r1 error) {
				return
			},
		},
		QueryFunc: &APIQueryFunc{
		...
		QueryExemplarsFunc: &APIQueryExemplarsFunc{
			defaultHook: func(context.Context, string, time.Time, time.Time) (r0 []v1.ExemplarQueryResult, r1 error) {
				return
			},
		},
		QueryRangeFunc: &APIQueryRangeFunc{
		...
		RulesFunc: &APIRulesFunc{
			defaultHook: func(context.Context) (r0 v1.RulesResult, r1 error) {
				return
			},
		},
		RuntimeinfoFunc: &APIRuntimeinfoFunc{
			defaultHook: func(context.Context) (r0 v1.RuntimeinfoResult, r1 error) {
				return
			},
		},
		SeriesFunc: &APISeriesFunc{
			defaultHook: func(context.Context, []string, time.Time, time.Time) (r0 []model.LabelSet, r1 v1.Warnings, r2 error) {
				return
			},
		},
		SnapshotFunc: &APISnapshotFunc{
			defaultHook: func(context.Context, bool) (r0 v1.SnapshotResult, r1 error) {
				return
			},
		},
		TSDBFunc: &APITSDBFunc{
			defaultHook: func(context.Context) (r0 v1.TSDBResult, r1 error) {
				return
			},
		},
		TargetsFunc: &APITargetsFunc{
			defaultHook: func(context.Context) (r0 v1.TargetsResult, r1 error) {
				return
			},
		},
		TargetsMetadataFunc: &APITargetsMetadataFunc{
			defaultHook: func(context.Context, string, string, string) (r0 []v1.MetricMetadata, r1 error) {
				return
			},
		},
		WalReplayFunc: &APIWalReplayFunc{
			defaultHook: func(context.Context) (r0 v1.WalReplayStatus, r1 error) {
				return
			},
		},
	}
