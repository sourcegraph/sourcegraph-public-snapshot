...
- Gitserver: we disable automatic git-gc for invocations of git-fetch to avoid corruption of repositories by competing git-gc processes. Test. [#36274](https://github.com/sourcegraph/sourcegraph/pull/36274)
