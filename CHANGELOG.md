...
- A Kustomize overlay and Helm override file to apply customized envoy filter are now available in our Kubernetes deployment repositories. [#4150](https://github.com/sourcegraph/deploy-sourcegraph/pull/4150) & [#148](https://github.com/sourcegraph/deploy-sourcegraph-helm/pull/148)
