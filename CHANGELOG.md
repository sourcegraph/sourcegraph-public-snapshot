...
- Added a setting `{ "email.verification": { "coolDown": "30s" } }` to prevent email abuse via verification emails. [#8136](https://github.com/sourcegraph/sourcegraph/pull/8136)
