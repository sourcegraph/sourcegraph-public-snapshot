...
- Extension API: There is now a field `versionContext` and subscribable `versionContextChanges` in `Workspace` to pass the instance's version context to extensions.
