...
- An issue with insights that excluded data when the insight was filtered by a search context that included multiple repositories. [#45574](https://github.com/sourcegraph/sourcegraph/pull/45574)
