...
- Configured `observability.alerts` can now be tested using a GraphQL endpoint, `setObservabilityTestAlertState`. [#12532](https://github.com/sourcegraph/sourcegraph/pull/12532)
