...
- The `stripUsernameHeaderPrefix` field in `HTTPHeaderAuthProvider` lets an admin specify a prefix
  to strip from the HTTP auth header when converting the header value to a username.
