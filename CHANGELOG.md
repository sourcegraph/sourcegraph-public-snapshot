...
- Added informational alerts licensing to batch changes server-side when a user has a Free Licenses that communicate the restrictions of a Free License. [#37834](https://github.com/sourcegraph/sourcegraph/issues/37834)
