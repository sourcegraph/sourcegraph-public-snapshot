...
- [`repo-updater-state`](https://github.com/sourcegraph/sourcegraph/blob/6e4e235/cmd/repo-updater/shared/main.go#L218) now serves an HTML response, in addition to JSON [#12498](https://github.com/sourcegraph/sourcegraph/pull/12498)
