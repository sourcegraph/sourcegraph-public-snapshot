...
- A new search filter `repohasfile` allows users to scope their search to repositories that contain at least one file matching the pattern passed to the filter.
