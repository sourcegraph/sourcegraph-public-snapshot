...
- Public/anonymous usage is now only available on Sourcegraph.com. Public usage leads to a degraded user experience, and it exposes administrators to the risk of releasing source code accidentally.
