...
- Backend Code Insights now respect Sourcegraph repository permissions and will not return unauthorized repositories in any data series. [#22471](https://github.com/sourcegraph/sourcegraph/pull/22471)
