...
- Added a best-effort migration such that existing Code Insights will display zero values instead of missing points at the start and end of a graph. [#44928](https://github.com/sourcegraph/sourcegraph/pull/44928)
