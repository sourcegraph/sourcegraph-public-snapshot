...
- For Docker-Compose and Kubernetes users, the built-in main Postgres, codeintel, and codeinsights databases have switched to a Wolfi Docker image. This requires re-indexing the entire database. This process can take up to a few hours on systems with large datasets. See [Migrating to Sourcegraph 5.1.x](https://docs.sourcegraph.com/admin/migration/5_1) for full details. [#52296](https://github.com/sourcegraph/sourcegraph/pull/52296)
