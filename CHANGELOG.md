...
- The Code Insights commit indexer can now capture commits in smaller batches. Set the number of days per batch in `insights.commit.indexer.windowDuration`. A value of 0 (default) will disable batching. [#33666](https://github.com/sourcegraph/sourcegraph/pull/33666)
