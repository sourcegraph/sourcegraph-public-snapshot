...
- Running a code insight over a timeframe when the repo didn't yet exist doesn't break the entire insight. [#21288](https://github.com/sourcegraph/sourcegraph/pull/21288)
