...
- Anonymous usage (no user accounts) is now only available on Sourcegraph.com. It leads to significantly degraded user experience and exposes unwitting administrators to the risk of exposing their source code accidentally.
