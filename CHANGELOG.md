...
- The Anthropic provider for Cody has been updated to use the messages API which includes support for Claude 3 models.  This is applicable to both BYOK and Cody Gateway enterprise customers.  The messages API does not support model identifiers which only set a major model version such as: `claude-2` or `claude-instant-1`, valid model identifiers can be found [here](https://docs.anthropic.com/claude/docs/models-overview#model-comparison).  Default values have been updated to `claude-2.0` and `claude-instant-1.2` and any legacy model identifiers that remain in the site config will be set to the corresponding the defaults mentioned above. [#60953](https://github.com/sourcegraph/sourcegraph/pull/60953) [#61324](https://github.com/sourcegraph/sourcegraph/pull/61324)
- The Anthropic provider for Cody has been updated to use the messages API which includes support for Claude 3 models. This is applicable to enterprise customers using their own key or the Cody Gateway. The messages API does not support model identifiers which only set the models major version such as: `claude-2` or `claude-instant-1`, valid model identifiers can be found [here](https://docs.anthropic.com/claude/docs/models-overview#model-comparison). Default values have been updated to `claude-2.0` and `claude-instant-1.2` and any legacy model identifiers that remain in the site config will be set to the corresponding defaults mentioned above. [#60953](https://github.com/sourcegraph/sourcegraph/pull/60953) [#61324](https://github.com/sourcegraph/sourcegraph/pull/61324)
