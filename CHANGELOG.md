...
- The SAML auth provider configuration now supports a `usernameKeys` field that can be used to specify the SAML attribute that should be used as the username. [#60603](https://github.com/sourcegraph/sourcegraph/pull/60603)
