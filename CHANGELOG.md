...
- Updates to the site configuration from the site admin panel will now also record the user id of the author in the database in `critical_and_site_config.author.user_id` column. [#46150](https://github.com/sourcegraph/sourcegraph/pull/46150)
