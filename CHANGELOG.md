...
- Users who have enabled the `user:email` token scope when connecting campaigns to GitHub will now have pull requests in their campaigns connected to matching Sourcegraph users when synced. [#17555](https://github.com/sourcegraph/sourcegraph/issues/17555)
