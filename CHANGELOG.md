...
- Update environment variables (`SEARCHER_URL`, `SYMBOLS_URL`, `INDEXED_SEARCH_SERVERS`, `SRC_GIT_SERVERS`) with the respective replica count number allows sourcegraph-frontend to determine the network address of each shard in the sharded statefulsets. [#45862](https://github.com/sourcegraph/sourcegraph/pull/45862)
