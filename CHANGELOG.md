...
- Admins can now turn off site alerts for patch version release updates using the `alerts.showMinorUpdates` setting. Alerts will still be shown for major and minor version updates.
