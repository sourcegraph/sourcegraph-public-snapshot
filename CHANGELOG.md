...
- Git submodule entries in the file tree now link to for all external service types. Previously we did not link for Bitbucket Cloud External Services or Other External Services. [#12399](https://github.com/sourcegraph/sourcegraph/pull/12399)
