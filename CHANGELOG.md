...
- For Docker-Compose and Kubernetes users, the built-in main Postgres, codeintel, and codeinsights databases have switched to a Wolfi Docker image. This requires re-indexing the entire database. This process can take up to a few hours on systems with large datasets. [#52296](https://github.com/sourcegraph/sourcegraph/pull/52296)
