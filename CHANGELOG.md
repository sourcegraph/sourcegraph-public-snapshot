...
- Code insights running over all repositories using a commit search (`type:commit`) would fail to deserialize and produce no results. [#25928](https://github.com/sourcegraph/sourcegraph/pull/25928)
