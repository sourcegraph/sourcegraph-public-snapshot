...
- The Anthropic provider for Cody has been updated to use Anthropic's Messages API, bringing support for Claude 3 models. [#60953](https://github.com/sourcegraph/sourcegraph/pull/60953)
