...
- The endpoint for "Open in Sourcegraph" functionality in editor extensions now uses external service information to resolve the repository, which makes it more correct and respect the `repositoryPathPattern` setting. [#16846](https://github.com/sourcegraph/sourcegraph/pull/16846)
