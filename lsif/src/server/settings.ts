...
/** The interval (in seconds) to run the updateUnconvertedUploadsGauge task. */
export const UPDATE_UNCONVERTED_UPLOADS_GAUGE_INTERVAL = readEnvInt('UPDATE_UNCONVERTED_UPLOADS_GAUGE_INTERVAL', 5)

/** The interval (in seconds) to run the cleanFailedUploads task. */
export const CLEAN_FAILED_UPLOADS_INTERVAL = readEnvInt('CLEAN_FAILED_UPLOADS_INTERVAL', 60)

/** The interval (in seconds) to run the cleanOldUploads task. */
export const CLEAN_OLD_UPLOADS_INTERVAL = readEnvInt('CLEAN_OLD_UPLOADS_INTERVAL', 60)
...
/**
 * The maximum age (in seconds) that an upload will remain in the database.
 */
export const UPLOAD_MAX_AGE = readEnvInt('UPLOAD_MAX_AGE', 60 * 60 * 24 * 7)
