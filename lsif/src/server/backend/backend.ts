...
export class Backend {
     ...
     * to the definition. These are not necessarily fully linked in the LSIF data. If there are
     * any locations in the result set, this method returns the new cursor. This method returns
