...
export const LSIF_API_URL = process.env.LSIF_API_URL || 'http://localhost:3186'
...
/** How many times to retry requests to lsif-api in the background. */
export const MAX_REQUEST_RETRIES = readEnvInt('MAX_REQUEST_RETRIES', 60)

/** How long to wait (minimum, in seconds) between lsif-api request attempts. */
export const MIN_REQUEST_RETRY_TIMEOUT = readEnvInt('MIN_REQUEST_RETRY_TIMEOUT', 1)

/** How long to wait (maximum, in seconds) between lsif-api request attempts. */
