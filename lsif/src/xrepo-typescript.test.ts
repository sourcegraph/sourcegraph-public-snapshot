...
function makeLocation(uri: string, startLine: number, startCharacter: number, endLine: number, endCharacter: number): lsp.Location {
...
function makeRemoteLocation(repository: string, path: string, startLine: number, startCharacter: number, endLine: number, endCharacter: number): lsp.Location {
  return makeLocation(`git://${repository}?${makeCommit(repository)}#${path}`, startLine, startCharacter, endLine, endCharacter)
}
