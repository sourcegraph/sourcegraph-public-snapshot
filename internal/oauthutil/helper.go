...
func (r *RefreshTokenHelperForExternalAccount) RefreshToken(ctx context.Context, doer httpcli.Doer, oauthCtx Context) (string, error) {
	refreshedToken, err := RetrieveToken(ctx, doer, oauthCtx, AuthStyleInParams)
...
func (r *RefreshTokenHelperForExternalService) RefreshToken(ctx context.Context, doer httpcli.Doer, oauthCtx Context) (string, error) {
	refreshedToken, err := RetrieveToken(ctx, doer, oauthCtx, AuthStyleInParams)
