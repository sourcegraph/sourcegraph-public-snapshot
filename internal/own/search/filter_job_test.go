...
func TestApplyCodeOwnershipFiltering(t *testing.T) {
	...
	tests := []struct {
		name  string
		args  args
		setup func(db *databasemocks.MockDB)
		want  autogold.Value
	}{
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			codeownersStore := databasemocks.NewMockCodeownersStore()
			...
			assignedTeamsStore := databasemocks.NewMockAssignedTeamsStore()
			...
			db.TeamsFunc.SetDefaultReturn(databasemocks.NewMockTeamStore())
...
func assignedOwnerSetup(path string, user *types.User) func(*databasemocks.MockDB) {
	return func(db *databasemocks.MockDB) {
