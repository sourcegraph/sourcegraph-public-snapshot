...
func AWSCodeCommitConfigs(ctx context.Context) ([]*schema.AWSCodeCommitConnection, error) {
	...
	if err := internal_api.Client.ExternalServiceConfigs(ctx, extsvc.KindAWSCodeCommit, &config); err != nil {
		return nil, err
	}
	return config, nil
}
...
func BitbucketServerConfigs(ctx context.Context) ([]*schema.BitbucketServerConnection, error) {
	...
	if err := internal_api.Client.ExternalServiceConfigs(ctx, extsvc.KindBitbucketServer, &config); err != nil {
		return nil, err
	}
	return config, nil
}
...
func GitHubConfigs(ctx context.Context) ([]*schema.GitHubConnection, error) {
	...
	if err := internal_api.Client.ExternalServiceConfigs(ctx, extsvc.KindGitHub, &config); err != nil {
		return nil, err
	}
	return config, nil
}
...
func GitLabConfigs(ctx context.Context) ([]*schema.GitLabConnection, error) {
	...
	if err := internal_api.Client.ExternalServiceConfigs(ctx, extsvc.KindGitLab, &config); err != nil {
		return nil, err
	}
	return config, nil
}
...
func GitoliteConfigs(ctx context.Context) ([]*schema.GitoliteConnection, error) {
	...
	if err := internal_api.Client.ExternalServiceConfigs(ctx, extsvc.KindGitolite, &config); err != nil {
		return nil, err
	}
	return config, nil
}
...
func PhabricatorConfigs(ctx context.Context) ([]*schema.PhabricatorConnection, error) {
	...
	if err := internal_api.Client.ExternalServiceConfigs(ctx, extsvc.KindPhabricator, &config); err != nil {
		return nil, err
	}
	return config, nil
}
