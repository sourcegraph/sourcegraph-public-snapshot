...
func (a *automaticRetryClient) ListLanguages(ctx context.Context, in *proto.ListLanguagesRequest, opts ...grpc.CallOption) (*proto.ListLanguagesResponse, error) {
	opts = append(defaults.RetryPolicy, opts...)
	return a.base.ListLanguages(ctx, in, opts...)
}
