		...
		Daily: []*types.SearchUsagePeriod{
			{
				...
				FrontendCodeLoad:              newSearchEventStatistics(),
				FrontendFirstResultLiteralt:   newSearchEventStatistics(),
				FrontendFirstResultRegexp:     newSearchEventStatistics(),
				FrontendFirstResultStructural: newSearchEventStatistics(),
				FrontendFirstResultFile:       newSearchEventStatistics(),
				FrontendFirstResultRepo:       newSearchEventStatistics(),
				FrontendFirstResultDiff:       newSearchEventStatistics(),
				FrontendFirstResultCommit:     newSearchEventStatistics(),
				FrontendFirstResultSymbol:     newSearchEventStatistics(),
