...
func TestUserUsageStatistics_LogPageView(t *testing.T) {
	...
	err := logLocalEvent(context.Background(), db, "ViewRepo", "https://sourcegraph.example.com/", user.ID, "test-cookie-id", "WEB", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestUserUsageStatistics_LogSearchQuery(t *testing.T) {
	...
	err := logLocalEvent(context.Background(), db, "SearchResultsQueried", "https://sourcegraph.example.com/", user.ID, "test-cookie-id", "WEB", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestUserUsageStatistics_LogCodeIntelAction(t *testing.T) {
	...
	err := logLocalEvent(context.Background(), db, "hover", "https://sourcegraph.example.com/", user.ID, "test-cookie-id", "WEB", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestUserUsageStatistics_LogCodeHostIntegrationUsage(t *testing.T) {
	...
	err := logLocalEvent(context.Background(), db, "hover", "https://sourcegraph.example.com/", user.ID, "test-cookie-id", "CODEHOSTINTEGRATION", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestUserUsageStatistics_getUsersActiveToday(t *testing.T) {
	...
	// Test single user
	err := logLocalEvent(ctx, db, "ViewBlob", "https://sourcegraph.example.com/", user1.ID, "test-cookie-id-1", "WEB", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = logLocalEvent(ctx, db, "ViewBlob", "https://sourcegraph.example.com/", user2.ID, "test-cookie-id-2", "WEB", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
	err = logLocalEvent(ctx, db, "ViewBlob", "https://sourcegraph.example.com/", user1.ID, "test-cookie-id-1", "WEB", nil, nil)
	...
	err = logLocalEvent(ctx, db, "ViewBlob", "https://sourcegraph.example.com/", 0, "test-cookie-id-3", "WEB", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
	err = logLocalEvent(ctx, db, "ViewBlob", "https://sourcegraph.example.com/", user2.ID, "test-cookie-id-2", "WEB", nil, nil)
...
func TestUserUsageStatistics_DAUs_WAUs_MAUs(t *testing.T) {
	...
	err = logLocalEvent(ctx, db, "ViewBlob", "https://sourcegraph.example.com/", 0, "068ccbfa-8529-4fa7-859e-2c3514af2434", "WEB", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
	err = logLocalEvent(ctx, db, "hover", "https://sourcegraph.example.com/", 0, "068ccbfa-8529-4fa7-859e-2c3514af2434", "CODEHOSTINTEGRATION", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = logLocalEvent(ctx, db, "ViewBlob", "https://sourcegraph.example.com/", 0, "30dd2661-2e73-4774-bc2b-7a126f360734", "WEB", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = logLocalEvent(ctx, db, "ViewBlob", "https://sourcegraph.example.com/", 0, "b309dad0-b6f9-440d-bf0a-4cf38030ca70", "WEB", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
	err = logLocalEvent(ctx, db, "hover", "https://sourcegraph.example.com/", user2.ID, "test-cookie-id-2", "CODEHOSTINTEGRATION", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = logLocalEvent(ctx, db, "hover", "https://sourcegraph.example.com/", user1.ID, "test-cookie-id-1", "CODEHOSTINTEGRATION", nil, nil)
	if err != nil {
		t.Fatal(err)
	}
