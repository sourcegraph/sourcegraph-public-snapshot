...
func TestIDEExtensionsUsageStatistics(t *testing.T) {
	...
	_, err := db.ExecContext(ctx, `
		...
		VALUES
			...
			(9, 'IDERedirects', '{}', '', 2, '420657f0-d443-4d16-ac7d-003d8cdc19ac', 'IDEEXTENSION', $1::timestamp - interval '1 hour', '{"version": "0.0.1", "editor": "jetbrains"}', '3.35.0'),
			(10, 'IDERedirects', '{"version": "2.2.1", "editor": "vscode"}', '', 2, '420657f0-d443-4d16-ac7d-003d8cdc19ac', 'IDEEXTENSION', $1::timestamp - interval '3 hour', '{"version": "2.2.1", "editor": "vscode"}', '3.35.0'),
			...
			(14, 'IDERedirects', '{}', '', 2, '420657f0-d443-4d16-ac7d-003d8cdc19ac', 'IDEEXTENSION', $1::timestamp - interval '1 week', '{"version": "2.2.1", "editor": "vscode"}', '3.35.0'),
		...
		IDEs: []*types.IDEExtensionsUsageStatistics{
			{
				...
				Day: types.IDEExtensionsUsageRegularPeriod{
