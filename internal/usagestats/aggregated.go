...
var searchExtractors = map[string]func(p *types.SearchUsagePeriod) *types.SearchEventStatistics{
	...
	"search.latencies.frontend.code-load":               func(p *types.SearchUsagePeriod) *types.SearchEventStatistics { return p.FrontendCodeLoad },
	"search.latencies.frontend.first-result.literal":    func(p *types.SearchUsagePeriod) *types.SearchEventStatistics { return p.FrontendFirstResultLiteralt },
	"search.latencies.frontend.first-result.regexp":     func(p *types.SearchUsagePeriod) *types.SearchEventStatistics { return p.FrontendFirstResultRegexp },
	"search.latencies.frontend.first-result.structural": func(p *types.SearchUsagePeriod) *types.SearchEventStatistics { return p.FrontendFirstResultStructural },
	"search.latencies.frontend.first-result.file":       func(p *types.SearchUsagePeriod) *types.SearchEventStatistics { return p.FrontendFirstResultFile },
	"search.latencies.frontend.first-result.repo":       func(p *types.SearchUsagePeriod) *types.SearchEventStatistics { return p.FrontendFirstResultRepo },
	"search.latencies.frontend.first-result.diff":       func(p *types.SearchUsagePeriod) *types.SearchEventStatistics { return p.FrontendFirstResultDiff },
	"search.latencies.frontend.first-result.commit":     func(p *types.SearchUsagePeriod) *types.SearchEventStatistics { return p.FrontendFirstResultCommit },
	"search.latencies.frontend.first-result.symbol":     func(p *types.SearchUsagePeriod) *types.SearchEventStatistics { return p.FrontendFirstResultSymbol },
}
