...
const (
	InsightsTotalCountPingName             = `INSIGHT_TOTAL_COUNTS`
	InsightsTotalCountCriticalPingName     = `INSIGHT_TOTAL_COUNT_CRITICAL`
	InsightsIntervalCountsPingName         = `INSIGHT_TIME_INTERVALS`
	InsightsOrgVisibleInsightsPingName     = `INSIGHT_ORG_VISIBLE_INSIGHTS`
	InsightsTotalOrgsWithDashboardPingName = `INSIGHT_TOTAL_ORGS_WITH_DASHBOARD`
	InsightsDashboardTotalCountPingName    = `INSIGHT_DASHBOARD_TOTAL_COUNT`
	InsightsPerDashboardPingName           = `INSIGHTS_PER_DASHBORD_STATS`
	InsightsBackfillTimePingName           = `INSIGHTS_BACKFILL_TIME`
)
