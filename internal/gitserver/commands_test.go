...
func TestParseGitLogOutput(t *testing.T) {
	input := `
commit 4e5b9dbc6393b195688a93ea04b98fada50bfa03
Author: admin <admin@perforce-server-7df6ff678c-lkzfb>
Date:   Fri Sep 16 18:28:27 2022 +0000

    83733 - Removing this from the workspace

    [p4-fusion: depot-paths = "//rhia-depot-test/": change = 83733]

commit e2f6d6e306490831b0fdd908fdbee702d7074a66
Author: admin <admin@perforce-server-7df6ff678c-lkzfb>
Date:   Fri Sep 16 18:26:06 2022 +0000

    83732 - adding sourcegraph repos

    [p4-fusion: depot-paths = "//rhia-depot-test/": change = 83732]

commit 90b9b9574517f30810346f0ab07f66c49c77ab0f
Author: admin <admin@perforce-server-7df6ff678c-lkzfb>
Date:   Fri Sep 16 18:20:14 2022 +0000

    83731 - "initial commit"

    [p4-fusion: depot-paths = "//rhia-depot-test/": change = 83731]
`

	commits, err := ParseGitLogOutput([]byte(input))
	require.NoError(t, err, "unexpected error")
	require.Equal(t, 3, len(commits))
}

func TestParseCommitFromLog(t *testing.T) {
	input := `
commit 4e5b9dbc6393b195688a93ea04b98fada50bfa03
Author: admin <admin@perforce-server-7df6ff678c-lkzfb>
Date:   Fri Sep 16 18:28:27 2022 +0000
...
`
	...
	allParts := bytes.Split([]byte(input), []byte{'\x00'})
	fmt.Println(len(allParts))
}
