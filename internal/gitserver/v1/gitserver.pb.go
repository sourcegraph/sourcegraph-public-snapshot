...
var file_gitserver_proto_rawDesc = []byte{
	...
	0x72, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b, 0x67,
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x2a, 0x71, 0x0a, 0x0c, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f,
	...
	0x4e, 0x44, 0x5f, 0x4e, 0x4f, 0x54, 0x10, 0x03, 0x32, 0xb4, 0x02, 0x0a, 0x10, 0x47, 0x69, 0x74,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x41, 0x0a,
	...
	0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x48, 0x0a, 0x0a, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x53, 0x74,
	0x61, 0x74, 0x73, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x20, 0x2e, 0x67, 0x69,
...
var file_gitserver_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_gitserver_proto_goTypes = []interface{}{
	...
	(*ReposStatsResponse)(nil),        // 21: gitserver.v1.ReposStatsResponse
	(*CommitMatch_Signature)(nil),     // 22: gitserver.v1.CommitMatch.Signature
	(*CommitMatch_MatchedString)(nil), // 23: gitserver.v1.CommitMatch.MatchedString
	(*CommitMatch_Range)(nil),         // 24: gitserver.v1.CommitMatch.Range
	(*CommitMatch_Location)(nil),      // 25: gitserver.v1.CommitMatch.Location
...
var file_gitserver_proto_depIdxs = []int32{
	...
	26, // 2: gitserver.v1.CommitBeforeNode.timestamp:type_name -> google.protobuf.Timestamp
	26, // 3: gitserver.v1.CommitAfterNode.timestamp:type_name -> google.protobuf.Timestamp
	...
	22, // 16: gitserver.v1.CommitMatch.author:type_name -> gitserver.v1.CommitMatch.Signature
	22, // 17: gitserver.v1.CommitMatch.committer:type_name -> gitserver.v1.CommitMatch.Signature
	23, // 18: gitserver.v1.CommitMatch.message:type_name -> gitserver.v1.CommitMatch.MatchedString
	23, // 19: gitserver.v1.CommitMatch.diff:type_name -> gitserver.v1.CommitMatch.MatchedString
	26, // 20: gitserver.v1.ReposStatsResponse.updated_at:type_name -> google.protobuf.Timestamp
	26, // 21: gitserver.v1.CommitMatch.Signature.date:type_name -> google.protobuf.Timestamp
	24, // 22: gitserver.v1.CommitMatch.MatchedString.ranges:type_name -> gitserver.v1.CommitMatch.Range
	25, // 23: gitserver.v1.CommitMatch.Range.start:type_name -> gitserver.v1.CommitMatch.Location
	25, // 24: gitserver.v1.CommitMatch.Range.end:type_name -> gitserver.v1.CommitMatch.Location
	...
	27, // 28: gitserver.v1.GitserverService.ReposStats:input_type -> google.protobuf.Empty
	...
	21, // 32: gitserver.v1.GitserverService.ReposStats:output_type -> gitserver.v1.ReposStatsResponse
