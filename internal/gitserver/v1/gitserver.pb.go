...
var file_gitserver_proto_rawDesc = []byte{
	...
	0x10, 0x03, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x97, 0x01, 0x0a, 0x0b, 0x45, 0x78,
	0x65, 0x63, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x72, 0x65, 0x70,
	0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x65, 0x70, 0x6f, 0x12, 0x27, 0x0a,
	0x0f, 0x65, 0x6e, 0x73, 0x75, 0x72, 0x65, 0x5f, 0x72, 0x65, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0e, 0x65, 0x6e, 0x73, 0x75, 0x72, 0x65, 0x52, 0x65,
	...
	0x4d, 0x41, 0x54, 0x5f, 0x54, 0x41, 0x52, 0x10, 0x02, 0x32, 0xe5, 0x13, 0x0a, 0x10, 0x47, 0x69,
	...
	0x73, 0x65, 0x22, 0x03, 0x90, 0x02, 0x01, 0x30, 0x01, 0x12, 0x4a, 0x0a, 0x06, 0x50, 0x34, 0x45,
	0x78, 0x65, 0x63, 0x12, 0x1b, 0x2e, 0x67, 0x69, 0x74, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e,
	0x76, 0x31, 0x2e, 0x50, 0x34, 0x45, 0x78, 0x65, 0x63, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x1c, 0x2e, 0x67, 0x69, 0x74, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e,
	0x50, 0x34, 0x45, 0x78, 0x65, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03,
	0x88, 0x02, 0x01, 0x30, 0x01, 0x12, 0x51, 0x0a, 0x09, 0x52, 0x65, 0x70, 0x6f, 0x43, 0x6c, 0x6f,
	...
	0x2f, 0x67, 0x69, 0x74, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70,
...
var file_gitserver_proto_goTypes = []interface{}{
	...
	(*GetCommitRequest)(nil),                            // 4: gitserver.v1.GetCommitRequest
	(*GetCommitResponse)(nil),                           // 5: gitserver.v1.GetCommitResponse
	(*GitCommit)(nil),                                   // 6: gitserver.v1.GitCommit
	(*GitSignature)(nil),                                // 7: gitserver.v1.GitSignature
	(*BlameRequest)(nil),                                // 8: gitserver.v1.BlameRequest
	(*BlameRange)(nil),                                  // 9: gitserver.v1.BlameRange
	(*BlameResponse)(nil),                               // 10: gitserver.v1.BlameResponse
	(*BlameHunk)(nil),                                   // 11: gitserver.v1.BlameHunk
	(*BlameAuthor)(nil),                                 // 12: gitserver.v1.BlameAuthor
	(*DefaultBranchRequest)(nil),                        // 13: gitserver.v1.DefaultBranchRequest
	(*DefaultBranchResponse)(nil),                       // 14: gitserver.v1.DefaultBranchResponse
	(*ReadFileRequest)(nil),                             // 15: gitserver.v1.ReadFileRequest
	(*ReadFileResponse)(nil),                            // 16: gitserver.v1.ReadFileResponse
	(*DiskInfoRequest)(nil),                             // 17: gitserver.v1.DiskInfoRequest
	(*DiskInfoResponse)(nil),                            // 18: gitserver.v1.DiskInfoResponse
...
var file_gitserver_proto_depIdxs = []int32{
	6,  // 0: gitserver.v1.GetCommitResponse.commit:type_name -> gitserver.v1.GitCommit
	7,  // 1: gitserver.v1.GitCommit.author:type_name -> gitserver.v1.GitSignature
	7,  // 2: gitserver.v1.GitCommit.committer:type_name -> gitserver.v1.GitSignature
	93, // 3: gitserver.v1.GitSignature.date:type_name -> google.protobuf.Timestamp
	9,  // 4: gitserver.v1.BlameRequest.range:type_name -> gitserver.v1.BlameRange
	11, // 5: gitserver.v1.BlameResponse.hunk:type_name -> gitserver.v1.BlameHunk
	12, // 6: gitserver.v1.BlameHunk.author:type_name -> gitserver.v1.BlameAuthor
	...
	32, // 11: gitserver.v1.SearchRequest.revisions:type_name -> gitserver.v1.RevisionSpecifier
	42, // 12: gitserver.v1.SearchRequest.query:type_name -> gitserver.v1.QueryNode
	...
	42, // 16: gitserver.v1.OperatorNode.operands:type_name -> gitserver.v1.QueryNode
	33, // 17: gitserver.v1.QueryNode.author_matches:type_name -> gitserver.v1.AuthorMatchesNode
	34, // 18: gitserver.v1.QueryNode.committer_matches:type_name -> gitserver.v1.CommitterMatchesNode
	35, // 19: gitserver.v1.QueryNode.commit_before:type_name -> gitserver.v1.CommitBeforeNode
	36, // 20: gitserver.v1.QueryNode.commit_after:type_name -> gitserver.v1.CommitAfterNode
	37, // 21: gitserver.v1.QueryNode.message_matches:type_name -> gitserver.v1.MessageMatchesNode
	38, // 22: gitserver.v1.QueryNode.diff_matches:type_name -> gitserver.v1.DiffMatchesNode
	39, // 23: gitserver.v1.QueryNode.diff_modifies_file:type_name -> gitserver.v1.DiffModifiesFileNode
	40, // 24: gitserver.v1.QueryNode.boolean:type_name -> gitserver.v1.BooleanNode
	41, // 25: gitserver.v1.QueryNode.operator:type_name -> gitserver.v1.OperatorNode
	44, // 26: gitserver.v1.SearchResponse.match:type_name -> gitserver.v1.CommitMatch
	...
	21, // 58: gitserver.v1.GitserverService.CreateCommitFromPatchBinary:input_type -> gitserver.v1.CreateCommitFromPatchBinaryRequest
	17, // 59: gitserver.v1.GitserverService.DiskInfo:input_type -> gitserver.v1.DiskInfoRequest
	24, // 60: gitserver.v1.GitserverService.Exec:input_type -> gitserver.v1.ExecRequest
	62, // 61: gitserver.v1.GitserverService.GetObject:input_type -> gitserver.v1.GetObjectRequest
	47, // 62: gitserver.v1.GitserverService.IsRepoCloneable:input_type -> gitserver.v1.IsRepoCloneableRequest
	59, // 63: gitserver.v1.GitserverService.ListGitolite:input_type -> gitserver.v1.ListGitoliteRequest
	31, // 64: gitserver.v1.GitserverService.Search:input_type -> gitserver.v1.SearchRequest
	45, // 65: gitserver.v1.GitserverService.Archive:input_type -> gitserver.v1.ArchiveRequest
	57, // 66: gitserver.v1.GitserverService.P4Exec:input_type -> gitserver.v1.P4ExecRequest
	49, // 67: gitserver.v1.GitserverService.RepoClone:input_type -> gitserver.v1.RepoCloneRequest
	51, // 68: gitserver.v1.GitserverService.RepoCloneProgress:input_type -> gitserver.v1.RepoCloneProgressRequest
	53, // 69: gitserver.v1.GitserverService.RepoDelete:input_type -> gitserver.v1.RepoDeleteRequest
	55, // 70: gitserver.v1.GitserverService.RepoUpdate:input_type -> gitserver.v1.RepoUpdateRequest
	65, // 71: gitserver.v1.GitserverService.IsPerforcePathCloneable:input_type -> gitserver.v1.IsPerforcePathCloneableRequest
	67, // 72: gitserver.v1.GitserverService.CheckPerforceCredentials:input_type -> gitserver.v1.CheckPerforceCredentialsRequest
	82, // 73: gitserver.v1.GitserverService.PerforceUsers:input_type -> gitserver.v1.PerforceUsersRequest
	77, // 74: gitserver.v1.GitserverService.PerforceProtectsForUser:input_type -> gitserver.v1.PerforceProtectsForUserRequest
	75, // 75: gitserver.v1.GitserverService.PerforceProtectsForDepot:input_type -> gitserver.v1.PerforceProtectsForDepotRequest
	80, // 76: gitserver.v1.GitserverService.PerforceGroupMembers:input_type -> gitserver.v1.PerforceGroupMembersRequest
	73, // 77: gitserver.v1.GitserverService.IsPerforceSuperUser:input_type -> gitserver.v1.IsPerforceSuperUserRequest
	70, // 78: gitserver.v1.GitserverService.PerforceGetChangelist:input_type -> gitserver.v1.PerforceGetChangelistRequest
	85, // 79: gitserver.v1.GitserverService.MergeBase:input_type -> gitserver.v1.MergeBaseRequest
	8,  // 80: gitserver.v1.GitserverService.Blame:input_type -> gitserver.v1.BlameRequest
	13, // 81: gitserver.v1.GitserverService.DefaultBranch:input_type -> gitserver.v1.DefaultBranchRequest
	15, // 82: gitserver.v1.GitserverService.ReadFile:input_type -> gitserver.v1.ReadFileRequest
	4,  // 83: gitserver.v1.GitserverService.GetCommit:input_type -> gitserver.v1.GetCommitRequest
	23, // 84: gitserver.v1.GitserverService.CreateCommitFromPatchBinary:output_type -> gitserver.v1.CreateCommitFromPatchBinaryResponse
	18, // 85: gitserver.v1.GitserverService.DiskInfo:output_type -> gitserver.v1.DiskInfoResponse
	25, // 86: gitserver.v1.GitserverService.Exec:output_type -> gitserver.v1.ExecResponse
	63, // 87: gitserver.v1.GitserverService.GetObject:output_type -> gitserver.v1.GetObjectResponse
	48, // 88: gitserver.v1.GitserverService.IsRepoCloneable:output_type -> gitserver.v1.IsRepoCloneableResponse
	61, // 89: gitserver.v1.GitserverService.ListGitolite:output_type -> gitserver.v1.ListGitoliteResponse
	43, // 90: gitserver.v1.GitserverService.Search:output_type -> gitserver.v1.SearchResponse
	46, // 91: gitserver.v1.GitserverService.Archive:output_type -> gitserver.v1.ArchiveResponse
	58, // 92: gitserver.v1.GitserverService.P4Exec:output_type -> gitserver.v1.P4ExecResponse
	50, // 93: gitserver.v1.GitserverService.RepoClone:output_type -> gitserver.v1.RepoCloneResponse
	52, // 94: gitserver.v1.GitserverService.RepoCloneProgress:output_type -> gitserver.v1.RepoCloneProgressResponse
	54, // 95: gitserver.v1.GitserverService.RepoDelete:output_type -> gitserver.v1.RepoDeleteResponse
	56, // 96: gitserver.v1.GitserverService.RepoUpdate:output_type -> gitserver.v1.RepoUpdateResponse
	66, // 97: gitserver.v1.GitserverService.IsPerforcePathCloneable:output_type -> gitserver.v1.IsPerforcePathCloneableResponse
	68, // 98: gitserver.v1.GitserverService.CheckPerforceCredentials:output_type -> gitserver.v1.CheckPerforceCredentialsResponse
	83, // 99: gitserver.v1.GitserverService.PerforceUsers:output_type -> gitserver.v1.PerforceUsersResponse
	78, // 100: gitserver.v1.GitserverService.PerforceProtectsForUser:output_type -> gitserver.v1.PerforceProtectsForUserResponse
	76, // 101: gitserver.v1.GitserverService.PerforceProtectsForDepot:output_type -> gitserver.v1.PerforceProtectsForDepotResponse
	81, // 102: gitserver.v1.GitserverService.PerforceGroupMembers:output_type -> gitserver.v1.PerforceGroupMembersResponse
	74, // 103: gitserver.v1.GitserverService.IsPerforceSuperUser:output_type -> gitserver.v1.IsPerforceSuperUserResponse
	71, // 104: gitserver.v1.GitserverService.PerforceGetChangelist:output_type -> gitserver.v1.PerforceGetChangelistResponse
	86, // 105: gitserver.v1.GitserverService.MergeBase:output_type -> gitserver.v1.MergeBaseResponse
	10, // 106: gitserver.v1.GitserverService.Blame:output_type -> gitserver.v1.BlameResponse
	14, // 107: gitserver.v1.GitserverService.DefaultBranch:output_type -> gitserver.v1.DefaultBranchResponse
	16, // 108: gitserver.v1.GitserverService.ReadFile:output_type -> gitserver.v1.ReadFileResponse
	5,  // 109: gitserver.v1.GitserverService.GetCommit:output_type -> gitserver.v1.GetCommitResponse
