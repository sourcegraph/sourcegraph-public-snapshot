...
var file_gitserver_proto_rawDesc = []byte{
	...
	0x44, 0x5f, 0x4e, 0x4f, 0x54, 0x10, 0x03, 0x32, 0x9f, 0x03, 0x0a, 0x10, 0x47, 0x69, 0x74, 0x73,
	...
	0x73, 0x65, 0x22, 0x00, 0x30, 0x01, 0x12, 0x51, 0x0a, 0x0a, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x53,
	0x74, 0x61, 0x74, 0x73, 0x12, 0x1f, 0x2e, 0x67, 0x69, 0x74, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
	...
	0x72, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52,
...
var file_gitserver_proto_goTypes = []interface{}{
	...
	(*ReposStatsRequest)(nil),         // 23: gitserver.v1.ReposStatsRequest
	(*ReposStatsResponse)(nil),        // 24: gitserver.v1.ReposStatsResponse
	(*CommitMatch_Signature)(nil),     // 25: gitserver.v1.CommitMatch.Signature
	(*CommitMatch_MatchedString)(nil), // 26: gitserver.v1.CommitMatch.MatchedString
	(*CommitMatch_Range)(nil),         // 27: gitserver.v1.CommitMatch.Range
	(*CommitMatch_Location)(nil),      // 28: gitserver.v1.CommitMatch.Location
...
var file_gitserver_proto_depIdxs = []int32{
	...
	29, // 2: gitserver.v1.CommitBeforeNode.timestamp:type_name -> google.protobuf.Timestamp
	29, // 3: gitserver.v1.CommitAfterNode.timestamp:type_name -> google.protobuf.Timestamp
	...
	25, // 16: gitserver.v1.CommitMatch.author:type_name -> gitserver.v1.CommitMatch.Signature
	25, // 17: gitserver.v1.CommitMatch.committer:type_name -> gitserver.v1.CommitMatch.Signature
	26, // 18: gitserver.v1.CommitMatch.message:type_name -> gitserver.v1.CommitMatch.MatchedString
	26, // 19: gitserver.v1.CommitMatch.diff:type_name -> gitserver.v1.CommitMatch.MatchedString
	29, // 20: gitserver.v1.ReposStatsResponse.updated_at:type_name -> google.protobuf.Timestamp
	29, // 21: gitserver.v1.CommitMatch.Signature.date:type_name -> google.protobuf.Timestamp
	27, // 22: gitserver.v1.CommitMatch.MatchedString.ranges:type_name -> gitserver.v1.CommitMatch.Range
	28, // 23: gitserver.v1.CommitMatch.Range.start:type_name -> gitserver.v1.CommitMatch.Location
	28, // 24: gitserver.v1.CommitMatch.Range.end:type_name -> gitserver.v1.CommitMatch.Location
	...
	23, // 29: gitserver.v1.GitserverService.ReposStats:input_type -> gitserver.v1.ReposStatsRequest
	2,  // 30: gitserver.v1.GitserverService.Exec:output_type -> gitserver.v1.ExecResponse
	22, // 31: gitserver.v1.GitserverService.IsRepoCloneable:output_type -> gitserver.v1.IsRepoCloneableResponse
	17, // 32: gitserver.v1.GitserverService.Search:output_type -> gitserver.v1.SearchResponse
	20, // 33: gitserver.v1.GitserverService.Archive:output_type -> gitserver.v1.ArchiveResponse
	24, // 34: gitserver.v1.GitserverService.ReposStats:output_type -> gitserver.v1.ReposStatsResponse
