...
type ReadFileRequest struct {
	...
	// repo_name is the name of the repo to get the file from.
	// Note: We use field ID 2 here to reserve 1 for a future repo int32 field.
	RepoName  string `protobuf:"bytes,2,opt,name=repo_name,json=repoName,proto3" json:"repo_name,omitempty"`
	CommitSha string `protobuf:"bytes,3,opt,name=commit_sha,json=commitSha,proto3" json:"commit_sha,omitempty"`
	// Path is the filepath. For now, we allow non-utf8 here.
...
func (x *ReadFileRequest) GetCommitSha() string {
	if x != nil {
		return x.CommitSha
	}
	return ""
...
var file_gitserver_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x22, 0x61, 0x0a, 0x0f, 0x52, 0x65, 0x61, 0x64, 0x46, 0x69, 0x6c, 0x65, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1b, 0x0a, 0x09, 0x72, 0x65, 0x70, 0x6f, 0x5f, 0x6e, 0x61,
	0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x70, 0x6f, 0x4e, 0x61,
	...
	0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x2a, 0x71, 0x0a,
	...
	0x32, 0xba, 0x12, 0x0a, 0x10, 0x47, 0x69, 0x74, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x65,
	...
	0x22, 0x03, 0x90, 0x02, 0x01, 0x12, 0x86, 0x01, 0x0a, 0x1b, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x46, 0x72, 0x6f, 0x6d, 0x50, 0x61, 0x74, 0x63, 0x68, 0x42,
...
var file_gitserver_proto_msgTypes = make([]protoimpl.MessageInfo, 81)
var file_gitserver_proto_goTypes = []interface{}{
	...
	(*ReadFileRequest)(nil),                             // 75: gitserver.v1.ReadFileRequest
	(*ReadFileResponse)(nil),                            // 76: gitserver.v1.ReadFileResponse
	(*CreateCommitFromPatchBinaryRequest_Metadata)(nil), // 77: gitserver.v1.CreateCommitFromPatchBinaryRequest.Metadata
	(*CreateCommitFromPatchBinaryRequest_Patch)(nil),    // 78: gitserver.v1.CreateCommitFromPatchBinaryRequest.Patch
	(*CommitMatch_Signature)(nil),                       // 79: gitserver.v1.CommitMatch.Signature
	(*CommitMatch_MatchedString)(nil),                   // 80: gitserver.v1.CommitMatch.MatchedString
	(*CommitMatch_Range)(nil),                           // 81: gitserver.v1.CommitMatch.Range
	(*CommitMatch_Location)(nil),                        // 82: gitserver.v1.CommitMatch.Location
	nil,                                                 // 83: gitserver.v1.RepoCloneProgressResponse.ResultsEntry
...
var file_gitserver_proto_depIdxs = []int32{
	...
	84, // 3: gitserver.v1.PatchCommitInfo.date:type_name -> google.protobuf.Timestamp
	77, // 4: gitserver.v1.CreateCommitFromPatchBinaryRequest.metadata:type_name -> gitserver.v1.CreateCommitFromPatchBinaryRequest.Metadata
	78, // 5: gitserver.v1.CreateCommitFromPatchBinaryRequest.patch:type_name -> gitserver.v1.CreateCommitFromPatchBinaryRequest.Patch
	...
	84, // 8: gitserver.v1.CommitBeforeNode.timestamp:type_name -> google.protobuf.Timestamp
	84, // 9: gitserver.v1.CommitAfterNode.timestamp:type_name -> google.protobuf.Timestamp
	...
	79, // 22: gitserver.v1.CommitMatch.author:type_name -> gitserver.v1.CommitMatch.Signature
	79, // 23: gitserver.v1.CommitMatch.committer:type_name -> gitserver.v1.CommitMatch.Signature
	80, // 24: gitserver.v1.CommitMatch.message:type_name -> gitserver.v1.CommitMatch.MatchedString
	80, // 25: gitserver.v1.CommitMatch.diff:type_name -> gitserver.v1.CommitMatch.MatchedString
	83, // 26: gitserver.v1.RepoCloneProgressResponse.results:type_name -> gitserver.v1.RepoCloneProgressResponse.ResultsEntry
	85, // 27: gitserver.v1.RepoUpdateRequest.since:type_name -> google.protobuf.Duration
	84, // 28: gitserver.v1.RepoUpdateResponse.last_fetched:type_name -> google.protobuf.Timestamp
	84, // 29: gitserver.v1.RepoUpdateResponse.last_changed:type_name -> google.protobuf.Timestamp
	...
	84, // 37: gitserver.v1.PerforceChangelist.creation_date:type_name -> google.protobuf.Timestamp
	...
	84, // 49: gitserver.v1.CommitMatch.Signature.date:type_name -> google.protobuf.Timestamp
	81, // 50: gitserver.v1.CommitMatch.MatchedString.ranges:type_name -> gitserver.v1.CommitMatch.Range
	82, // 51: gitserver.v1.CommitMatch.Range.start:type_name -> gitserver.v1.CommitMatch.Location
	82, // 52: gitserver.v1.CommitMatch.Range.end:type_name -> gitserver.v1.CommitMatch.Location
	...
	75, // 77: gitserver.v1.GitserverService.ReadFile:input_type -> gitserver.v1.ReadFileRequest
	6,  // 78: gitserver.v1.GitserverService.BatchLog:output_type -> gitserver.v1.BatchLogResponse
	13, // 79: gitserver.v1.GitserverService.CreateCommitFromPatchBinary:output_type -> gitserver.v1.CreateCommitFromPatchBinaryResponse
	4,  // 80: gitserver.v1.GitserverService.DiskInfo:output_type -> gitserver.v1.DiskInfoResponse
	15, // 81: gitserver.v1.GitserverService.Exec:output_type -> gitserver.v1.ExecResponse
	51, // 82: gitserver.v1.GitserverService.GetObject:output_type -> gitserver.v1.GetObjectResponse
	35, // 83: gitserver.v1.GitserverService.IsRepoCloneable:output_type -> gitserver.v1.IsRepoCloneableResponse
	49, // 84: gitserver.v1.GitserverService.ListGitolite:output_type -> gitserver.v1.ListGitoliteResponse
	30, // 85: gitserver.v1.GitserverService.Search:output_type -> gitserver.v1.SearchResponse
	33, // 86: gitserver.v1.GitserverService.Archive:output_type -> gitserver.v1.ArchiveResponse
	46, // 87: gitserver.v1.GitserverService.P4Exec:output_type -> gitserver.v1.P4ExecResponse
	37, // 88: gitserver.v1.GitserverService.RepoClone:output_type -> gitserver.v1.RepoCloneResponse
	40, // 89: gitserver.v1.GitserverService.RepoCloneProgress:output_type -> gitserver.v1.RepoCloneProgressResponse
	42, // 90: gitserver.v1.GitserverService.RepoDelete:output_type -> gitserver.v1.RepoDeleteResponse
	44, // 91: gitserver.v1.GitserverService.RepoUpdate:output_type -> gitserver.v1.RepoUpdateResponse
	54, // 92: gitserver.v1.GitserverService.IsPerforcePathCloneable:output_type -> gitserver.v1.IsPerforcePathCloneableResponse
	56, // 93: gitserver.v1.GitserverService.CheckPerforceCredentials:output_type -> gitserver.v1.CheckPerforceCredentialsResponse
	71, // 94: gitserver.v1.GitserverService.PerforceUsers:output_type -> gitserver.v1.PerforceUsersResponse
	66, // 95: gitserver.v1.GitserverService.PerforceProtectsForUser:output_type -> gitserver.v1.PerforceProtectsForUserResponse
	64, // 96: gitserver.v1.GitserverService.PerforceProtectsForDepot:output_type -> gitserver.v1.PerforceProtectsForDepotResponse
	69, // 97: gitserver.v1.GitserverService.PerforceGroupMembers:output_type -> gitserver.v1.PerforceGroupMembersResponse
	62, // 98: gitserver.v1.GitserverService.IsPerforceSuperUser:output_type -> gitserver.v1.IsPerforceSuperUserResponse
	59, // 99: gitserver.v1.GitserverService.PerforceGetChangelist:output_type -> gitserver.v1.PerforceGetChangelistResponse
	74, // 100: gitserver.v1.GitserverService.MergeBase:output_type -> gitserver.v1.MergeBaseResponse
	76, // 101: gitserver.v1.GitserverService.ReadFile:output_type -> gitserver.v1.ReadFileResponse
...
func file_gitserver_proto_init() {
	...
	file_gitserver_proto_msgTypes[74].OneofWrappers = []interface{}{}
	type x struct{}
