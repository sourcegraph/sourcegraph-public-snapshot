...
var file_gitserver_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x44, 0x0a, 0x18,
	...
	0x01, 0x28, 0x08, 0x52, 0x06, 0x63, 0x6c, 0x6f, 0x6e, 0x65, 0x64, 0x22, 0x27, 0x0a, 0x11, 0x52,
	...
	0x03, 0x32, 0xb8, 0x14, 0x0a, 0x10, 0x47, 0x69, 0x74, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x51, 0x0a, 0x08, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4c,
	0x6f, 0x67, 0x12, 0x1d, 0x2e, 0x67, 0x69, 0x74, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76,
	0x31, 0x2e, 0x42, 0x61, 0x74, 0x63, 0x68, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x65, 0x22, 0x06, 0x88, 0x02, 0x01, 0x90, 0x02, 0x01, 0x12, 0x86, 0x01, 0x0a, 0x1b, 0x43, 0x72,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03, 0x90, 0x02, 0x01, 0x12, 0x4a, 0x0a, 0x06, 0x53, 0x65, 0x61,
	...
	0x90, 0x02, 0x01, 0x30, 0x01, 0x12, 0x4d, 0x0a, 0x07, 0x41, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65,
	...
	0x63, 0x68, 0x69, 0x76, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03, 0x90,
	0x02, 0x01, 0x30, 0x01, 0x12, 0x4a, 0x0a, 0x06, 0x50, 0x34, 0x45, 0x78, 0x65, 0x63, 0x12, 0x1b,
	0x2e, 0x67, 0x69, 0x74, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x34,
	0x45, 0x78, 0x65, 0x63, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x67, 0x69,
...
var file_gitserver_proto_depIdxs = []int32{
	...
	90, // 12: gitserver.v1.CreateCommitFromPatchBinaryRequest.metadata:type_name -> gitserver.v1.CreateCommitFromPatchBinaryRequest.Metadata
	91, // 13: gitserver.v1.CreateCommitFromPatchBinaryRequest.patch:type_name -> gitserver.v1.CreateCommitFromPatchBinaryRequest.Patch
	...
	92, // 30: gitserver.v1.CommitMatch.author:type_name -> gitserver.v1.CommitMatch.Signature
	92, // 31: gitserver.v1.CommitMatch.committer:type_name -> gitserver.v1.CommitMatch.Signature
	93, // 32: gitserver.v1.CommitMatch.message:type_name -> gitserver.v1.CommitMatch.MatchedString
	93, // 33: gitserver.v1.CommitMatch.diff:type_name -> gitserver.v1.CommitMatch.MatchedString
	...
	1,  // 39: gitserver.v1.GitObject.type:type_name -> gitserver.v1.GitObject.ObjectType
	...
	2,  // 45: gitserver.v1.PerforceChangelist.state:type_name -> gitserver.v1.PerforceChangelist.PerforceChangelistState
	...
	22, // 54: gitserver.v1.CreateCommitFromPatchBinaryRequest.Metadata.commit_info:type_name -> gitserver.v1.PatchCommitInfo
	23, // 55: gitserver.v1.CreateCommitFromPatchBinaryRequest.Metadata.push:type_name -> gitserver.v1.PushConfig
	...
	18, // 60: gitserver.v1.GitserverService.BatchLog:input_type -> gitserver.v1.BatchLogRequest
	24, // 61: gitserver.v1.GitserverService.CreateCommitFromPatchBinary:input_type -> gitserver.v1.CreateCommitFromPatchBinaryRequest
	16, // 62: gitserver.v1.GitserverService.DiskInfo:input_type -> gitserver.v1.DiskInfoRequest
	27, // 63: gitserver.v1.GitserverService.Exec:input_type -> gitserver.v1.ExecRequest
	65, // 64: gitserver.v1.GitserverService.GetObject:input_type -> gitserver.v1.GetObjectRequest
	50, // 65: gitserver.v1.GitserverService.IsRepoCloneable:input_type -> gitserver.v1.IsRepoCloneableRequest
	62, // 66: gitserver.v1.GitserverService.ListGitolite:input_type -> gitserver.v1.ListGitoliteRequest
	34, // 67: gitserver.v1.GitserverService.Search:input_type -> gitserver.v1.SearchRequest
	48, // 68: gitserver.v1.GitserverService.Archive:input_type -> gitserver.v1.ArchiveRequest
	60, // 69: gitserver.v1.GitserverService.P4Exec:input_type -> gitserver.v1.P4ExecRequest
	52, // 70: gitserver.v1.GitserverService.RepoClone:input_type -> gitserver.v1.RepoCloneRequest
	54, // 71: gitserver.v1.GitserverService.RepoCloneProgress:input_type -> gitserver.v1.RepoCloneProgressRequest
	56, // 72: gitserver.v1.GitserverService.RepoDelete:input_type -> gitserver.v1.RepoDeleteRequest
	58, // 73: gitserver.v1.GitserverService.RepoUpdate:input_type -> gitserver.v1.RepoUpdateRequest
	68, // 74: gitserver.v1.GitserverService.IsPerforcePathCloneable:input_type -> gitserver.v1.IsPerforcePathCloneableRequest
	70, // 75: gitserver.v1.GitserverService.CheckPerforceCredentials:input_type -> gitserver.v1.CheckPerforceCredentialsRequest
	85, // 76: gitserver.v1.GitserverService.PerforceUsers:input_type -> gitserver.v1.PerforceUsersRequest
	80, // 77: gitserver.v1.GitserverService.PerforceProtectsForUser:input_type -> gitserver.v1.PerforceProtectsForUserRequest
	78, // 78: gitserver.v1.GitserverService.PerforceProtectsForDepot:input_type -> gitserver.v1.PerforceProtectsForDepotRequest
	83, // 79: gitserver.v1.GitserverService.PerforceGroupMembers:input_type -> gitserver.v1.PerforceGroupMembersRequest
	76, // 80: gitserver.v1.GitserverService.IsPerforceSuperUser:input_type -> gitserver.v1.IsPerforceSuperUserRequest
	73, // 81: gitserver.v1.GitserverService.PerforceGetChangelist:input_type -> gitserver.v1.PerforceGetChangelistRequest
	88, // 82: gitserver.v1.GitserverService.MergeBase:input_type -> gitserver.v1.MergeBaseRequest
	7,  // 83: gitserver.v1.GitserverService.Blame:input_type -> gitserver.v1.BlameRequest
	12, // 84: gitserver.v1.GitserverService.DefaultBranch:input_type -> gitserver.v1.DefaultBranchRequest
	14, // 85: gitserver.v1.GitserverService.ReadFile:input_type -> gitserver.v1.ReadFileRequest
	3,  // 86: gitserver.v1.GitserverService.GetCommit:input_type -> gitserver.v1.GetCommitRequest
	19, // 87: gitserver.v1.GitserverService.BatchLog:output_type -> gitserver.v1.BatchLogResponse
	26, // 88: gitserver.v1.GitserverService.CreateCommitFromPatchBinary:output_type -> gitserver.v1.CreateCommitFromPatchBinaryResponse
	17, // 89: gitserver.v1.GitserverService.DiskInfo:output_type -> gitserver.v1.DiskInfoResponse
	28, // 90: gitserver.v1.GitserverService.Exec:output_type -> gitserver.v1.ExecResponse
	66, // 91: gitserver.v1.GitserverService.GetObject:output_type -> gitserver.v1.GetObjectResponse
	51, // 92: gitserver.v1.GitserverService.IsRepoCloneable:output_type -> gitserver.v1.IsRepoCloneableResponse
	64, // 93: gitserver.v1.GitserverService.ListGitolite:output_type -> gitserver.v1.ListGitoliteResponse
	46, // 94: gitserver.v1.GitserverService.Search:output_type -> gitserver.v1.SearchResponse
	49, // 95: gitserver.v1.GitserverService.Archive:output_type -> gitserver.v1.ArchiveResponse
	61, // 96: gitserver.v1.GitserverService.P4Exec:output_type -> gitserver.v1.P4ExecResponse
	53, // 97: gitserver.v1.GitserverService.RepoClone:output_type -> gitserver.v1.RepoCloneResponse
	55, // 98: gitserver.v1.GitserverService.RepoCloneProgress:output_type -> gitserver.v1.RepoCloneProgressResponse
	57, // 99: gitserver.v1.GitserverService.RepoDelete:output_type -> gitserver.v1.RepoDeleteResponse
	59, // 100: gitserver.v1.GitserverService.RepoUpdate:output_type -> gitserver.v1.RepoUpdateResponse
	69, // 101: gitserver.v1.GitserverService.IsPerforcePathCloneable:output_type -> gitserver.v1.IsPerforcePathCloneableResponse
	71, // 102: gitserver.v1.GitserverService.CheckPerforceCredentials:output_type -> gitserver.v1.CheckPerforceCredentialsResponse
	86, // 103: gitserver.v1.GitserverService.PerforceUsers:output_type -> gitserver.v1.PerforceUsersResponse
	81, // 104: gitserver.v1.GitserverService.PerforceProtectsForUser:output_type -> gitserver.v1.PerforceProtectsForUserResponse
	79, // 105: gitserver.v1.GitserverService.PerforceProtectsForDepot:output_type -> gitserver.v1.PerforceProtectsForDepotResponse
	84, // 106: gitserver.v1.GitserverService.PerforceGroupMembers:output_type -> gitserver.v1.PerforceGroupMembersResponse
	77, // 107: gitserver.v1.GitserverService.IsPerforceSuperUser:output_type -> gitserver.v1.IsPerforceSuperUserResponse
	74, // 108: gitserver.v1.GitserverService.PerforceGetChangelist:output_type -> gitserver.v1.PerforceGetChangelistResponse
	89, // 109: gitserver.v1.GitserverService.MergeBase:output_type -> gitserver.v1.MergeBaseResponse
