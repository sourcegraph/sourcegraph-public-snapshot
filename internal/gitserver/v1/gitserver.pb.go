...
type SearchResponse struct {
	...
	Matches []*CommitMatch `protobuf:"bytes,1,rep,name=matches,proto3" json:"matches,omitempty"`
}
...
func (x *SearchResponse) GetMatches() []*CommitMatch {
	if x != nil {
		return x.Matches
	}
	return nil
...
var file_gitserver_proto_rawDesc = []byte{
	...
	0x6c, 0x75, 0x65, 0x22, 0x45, 0x0a, 0x0e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x33, 0x0a, 0x07, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x69, 0x74, 0x73, 0x65, 0x72, 0x76,
	0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x4d, 0x61, 0x74, 0x63,
	0x68, 0x52, 0x07, 0x6d, 0x61, 0x74, 0x63, 0x68, 0x65, 0x73, 0x22, 0xa9, 0x06, 0x0a, 0x0b, 0x43,
...
var file_gitserver_proto_depIdxs = []int32{
	...
	18, // 15: gitserver.v1.SearchResponse.matches:type_name -> gitserver.v1.CommitMatch
