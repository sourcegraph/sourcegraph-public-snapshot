...
var file_gitserver_proto_rawDesc = []byte{
	...
	0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x6f, 0x0a, 0x0d, 0x50, 0x34, 0x45, 0x78, 0x65,
	0x63, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x16, 0x0a, 0x06, 0x70, 0x34, 0x70, 0x6f,
	...
	0x73, 0x73, 0x77, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x61, 0x72, 0x67, 0x73, 0x18, 0x04, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x22, 0x24, 0x0a, 0x0e, 0x50, 0x34, 0x45, 0x78,
	...
	0x4f, 0x42, 0x10, 0x04, 0x2a, 0x71, 0x0a, 0x0c, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72,
	...
	0x44, 0x5f, 0x4e, 0x4f, 0x54, 0x10, 0x03, 0x32, 0xf0, 0x08, 0x0a, 0x10, 0x47, 0x69, 0x74, 0x73,
	0x65, 0x72, 0x76, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x4b, 0x0a, 0x08,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x84, 0x01, 0x0a, 0x1b, 0x43, 0x72,
...
var file_gitserver_proto_msgTypes = make([]protoimpl.MessageInfo, 53)
var file_gitserver_proto_goTypes = []interface{}{
	...
	(*P4ExecRequest)(nil),                       // 42: gitserver.v1.P4ExecRequest
	(*P4ExecResponse)(nil),                      // 43: gitserver.v1.P4ExecResponse
	(*ListGitoliteRequest)(nil),                 // 44: gitserver.v1.ListGitoliteRequest
	(*GitoliteRepo)(nil),                        // 45: gitserver.v1.GitoliteRepo
	(*ListGitoliteResponse)(nil),                // 46: gitserver.v1.ListGitoliteResponse
	(*GetObjectRequest)(nil),                    // 47: gitserver.v1.GetObjectRequest
	(*GetObjectResponse)(nil),                   // 48: gitserver.v1.GetObjectResponse
	(*GitObject)(nil),                           // 49: gitserver.v1.GitObject
	(*CommitMatch_Signature)(nil),               // 50: gitserver.v1.CommitMatch.Signature
	(*CommitMatch_MatchedString)(nil),           // 51: gitserver.v1.CommitMatch.MatchedString
	(*CommitMatch_Range)(nil),                   // 52: gitserver.v1.CommitMatch.Range
	(*CommitMatch_Location)(nil),                // 53: gitserver.v1.CommitMatch.Location
	nil,                                         // 54: gitserver.v1.RepoCloneProgressResponse.ResultsEntry
...
var file_gitserver_proto_depIdxs = []int32{
	...
	55, // 3: gitserver.v1.PatchCommitInfo.date:type_name -> google.protobuf.Timestamp
	...
	55, // 9: gitserver.v1.CommitBeforeNode.timestamp:type_name -> google.protobuf.Timestamp
	55, // 10: gitserver.v1.CommitAfterNode.timestamp:type_name -> google.protobuf.Timestamp
	...
	50, // 23: gitserver.v1.CommitMatch.author:type_name -> gitserver.v1.CommitMatch.Signature
	50, // 24: gitserver.v1.CommitMatch.committer:type_name -> gitserver.v1.CommitMatch.Signature
	51, // 25: gitserver.v1.CommitMatch.message:type_name -> gitserver.v1.CommitMatch.MatchedString
	51, // 26: gitserver.v1.CommitMatch.diff:type_name -> gitserver.v1.CommitMatch.MatchedString
	54, // 27: gitserver.v1.RepoCloneProgressResponse.results:type_name -> gitserver.v1.RepoCloneProgressResponse.ResultsEntry
	56, // 28: gitserver.v1.RepoUpdateRequest.since:type_name -> google.protobuf.Duration
	55, // 29: gitserver.v1.RepoUpdateResponse.last_fetched:type_name -> google.protobuf.Timestamp
	55, // 30: gitserver.v1.RepoUpdateResponse.last_changed:type_name -> google.protobuf.Timestamp
	45, // 31: gitserver.v1.ListGitoliteResponse.repos:type_name -> gitserver.v1.GitoliteRepo
	49, // 32: gitserver.v1.GetObjectResponse.object:type_name -> gitserver.v1.GitObject
	1,  // 33: gitserver.v1.GitObject.type:type_name -> gitserver.v1.GitObject.ObjectType
	55, // 34: gitserver.v1.CommitMatch.Signature.date:type_name -> google.protobuf.Timestamp
	52, // 35: gitserver.v1.CommitMatch.MatchedString.ranges:type_name -> gitserver.v1.CommitMatch.Range
	53, // 36: gitserver.v1.CommitMatch.Range.start:type_name -> gitserver.v1.CommitMatch.Location
	53, // 37: gitserver.v1.CommitMatch.Range.end:type_name -> gitserver.v1.CommitMatch.Location
	...
	47, // 42: gitserver.v1.GitserverService.GetObject:input_type -> gitserver.v1.GetObjectRequest
	31, // 43: gitserver.v1.GitserverService.IsRepoCloneable:input_type -> gitserver.v1.IsRepoCloneableRequest
	44, // 44: gitserver.v1.GitserverService.ListGitolite:input_type -> gitserver.v1.ListGitoliteRequest
	...
	42, // 47: gitserver.v1.GitserverService.P4Exec:input_type -> gitserver.v1.P4ExecRequest
	...
	3,  // 52: gitserver.v1.GitserverService.BatchLog:output_type -> gitserver.v1.BatchLogResponse
	10, // 53: gitserver.v1.GitserverService.CreateCommitFromPatchBinary:output_type -> gitserver.v1.CreateCommitFromPatchBinaryResponse
	12, // 54: gitserver.v1.GitserverService.Exec:output_type -> gitserver.v1.ExecResponse
	48, // 55: gitserver.v1.GitserverService.GetObject:output_type -> gitserver.v1.GetObjectResponse
	32, // 56: gitserver.v1.GitserverService.IsRepoCloneable:output_type -> gitserver.v1.IsRepoCloneableResponse
	46, // 57: gitserver.v1.GitserverService.ListGitolite:output_type -> gitserver.v1.ListGitoliteResponse
	27, // 58: gitserver.v1.GitserverService.Search:output_type -> gitserver.v1.SearchResponse
	30, // 59: gitserver.v1.GitserverService.Archive:output_type -> gitserver.v1.ArchiveResponse
	43, // 60: gitserver.v1.GitserverService.P4Exec:output_type -> gitserver.v1.P4ExecResponse
	34, // 61: gitserver.v1.GitserverService.RepoClone:output_type -> gitserver.v1.RepoCloneResponse
	37, // 62: gitserver.v1.GitserverService.RepoCloneProgress:output_type -> gitserver.v1.RepoCloneProgressResponse
	39, // 63: gitserver.v1.GitserverService.RepoDelete:output_type -> gitserver.v1.RepoDeleteResponse
	41, // 64: gitserver.v1.GitserverService.RepoUpdate:output_type -> gitserver.v1.RepoUpdateResponse
