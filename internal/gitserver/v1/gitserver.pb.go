...
var file_gitserver_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x61, 0x6d, 0x70, 0x52, 0x04, 0x64, 0x61, 0x74, 0x65, 0x22, 0xf4, 0x01, 0x0a, 0x0c,
	...
	0x08, 0x72, 0x65, 0x70, 0x6f, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x06, 0x63, 0x6f, 0x6d,
	0x6d, 0x69, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x06, 0x63, 0x6f, 0x6d,
	0x6d, 0x69, 0x74, 0x88, 0x01, 0x01, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x74, 0x68, 0x18, 0x04,
	...
	0x74, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x22, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72, 0x74,
	0x5f, 0x6c, 0x69, 0x6e, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x01, 0x52, 0x09, 0x73,
	0x74, 0x61, 0x72, 0x74, 0x4c, 0x69, 0x6e, 0x65, 0x88, 0x01, 0x01, 0x12, 0x1e, 0x0a, 0x08, 0x65,
	0x6e, 0x64, 0x5f, 0x6c, 0x69, 0x6e, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x02, 0x52,
	0x07, 0x65, 0x6e, 0x64, 0x4c, 0x69, 0x6e, 0x65, 0x88, 0x01, 0x01, 0x42, 0x09, 0x0a, 0x07, 0x5f,
	0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x74, 0x42, 0x0d, 0x0a, 0x0b, 0x5f, 0x73, 0x74, 0x61, 0x72, 0x74,
	...
	0x5f, 0x4e, 0x4f, 0x54, 0x10, 0x03, 0x32, 0xb8, 0x14, 0x0a, 0x10, 0x47, 0x69, 0x74, 0x73, 0x65,
...
var file_gitserver_proto_depIdxs = []int32{
	...
	97, // 3: gitserver.v1.GitSignature.date:type_name -> google.protobuf.Timestamp
	9,  // 4: gitserver.v1.BlameResponse.hunk:type_name -> gitserver.v1.BlameHunk
	10, // 5: gitserver.v1.BlameHunk.author:type_name -> gitserver.v1.BlameAuthor
	97, // 6: gitserver.v1.BlameAuthor.date:type_name -> google.protobuf.Timestamp
	20, // 7: gitserver.v1.BatchLogRequest.repo_commits:type_name -> gitserver.v1.RepoCommit
	19, // 8: gitserver.v1.BatchLogResponse.results:type_name -> gitserver.v1.BatchLogResult
	20, // 9: gitserver.v1.BatchLogResult.repo_commit:type_name -> gitserver.v1.RepoCommit
	...
	34, // 13: gitserver.v1.SearchRequest.revisions:type_name -> gitserver.v1.RevisionSpecifier
	44, // 14: gitserver.v1.SearchRequest.query:type_name -> gitserver.v1.QueryNode
	...
	44, // 18: gitserver.v1.OperatorNode.operands:type_name -> gitserver.v1.QueryNode
	35, // 19: gitserver.v1.QueryNode.author_matches:type_name -> gitserver.v1.AuthorMatchesNode
	36, // 20: gitserver.v1.QueryNode.committer_matches:type_name -> gitserver.v1.CommitterMatchesNode
	37, // 21: gitserver.v1.QueryNode.commit_before:type_name -> gitserver.v1.CommitBeforeNode
	38, // 22: gitserver.v1.QueryNode.commit_after:type_name -> gitserver.v1.CommitAfterNode
	39, // 23: gitserver.v1.QueryNode.message_matches:type_name -> gitserver.v1.MessageMatchesNode
	40, // 24: gitserver.v1.QueryNode.diff_matches:type_name -> gitserver.v1.DiffMatchesNode
	41, // 25: gitserver.v1.QueryNode.diff_modifies_file:type_name -> gitserver.v1.DiffModifiesFileNode
	42, // 26: gitserver.v1.QueryNode.boolean:type_name -> gitserver.v1.BooleanNode
	43, // 27: gitserver.v1.QueryNode.operator:type_name -> gitserver.v1.OperatorNode
	46, // 28: gitserver.v1.SearchResponse.match:type_name -> gitserver.v1.CommitMatch
	...
	96, // 33: gitserver.v1.RepoCloneProgressResponse.results:type_name -> gitserver.v1.RepoCloneProgressResponse.ResultsEntry
	...
	21, // 54: gitserver.v1.CreateCommitFromPatchBinaryRequest.Metadata.commit_info:type_name -> gitserver.v1.PatchCommitInfo
	22, // 55: gitserver.v1.CreateCommitFromPatchBinaryRequest.Metadata.push:type_name -> gitserver.v1.PushConfig
	...
	54, // 60: gitserver.v1.RepoCloneProgressResponse.ResultsEntry.value:type_name -> gitserver.v1.RepoCloneProgress
	17, // 61: gitserver.v1.GitserverService.BatchLog:input_type -> gitserver.v1.BatchLogRequest
	23, // 62: gitserver.v1.GitserverService.CreateCommitFromPatchBinary:input_type -> gitserver.v1.CreateCommitFromPatchBinaryRequest
	15, // 63: gitserver.v1.GitserverService.DiskInfo:input_type -> gitserver.v1.DiskInfoRequest
	26, // 64: gitserver.v1.GitserverService.Exec:input_type -> gitserver.v1.ExecRequest
	65, // 65: gitserver.v1.GitserverService.GetObject:input_type -> gitserver.v1.GetObjectRequest
	49, // 66: gitserver.v1.GitserverService.IsRepoCloneable:input_type -> gitserver.v1.IsRepoCloneableRequest
	62, // 67: gitserver.v1.GitserverService.ListGitolite:input_type -> gitserver.v1.ListGitoliteRequest
	33, // 68: gitserver.v1.GitserverService.Search:input_type -> gitserver.v1.SearchRequest
	47, // 69: gitserver.v1.GitserverService.Archive:input_type -> gitserver.v1.ArchiveRequest
	60, // 70: gitserver.v1.GitserverService.P4Exec:input_type -> gitserver.v1.P4ExecRequest
	51, // 71: gitserver.v1.GitserverService.RepoClone:input_type -> gitserver.v1.RepoCloneRequest
	53, // 72: gitserver.v1.GitserverService.RepoCloneProgress:input_type -> gitserver.v1.RepoCloneProgressRequest
	56, // 73: gitserver.v1.GitserverService.RepoDelete:input_type -> gitserver.v1.RepoDeleteRequest
	58, // 74: gitserver.v1.GitserverService.RepoUpdate:input_type -> gitserver.v1.RepoUpdateRequest
	68, // 75: gitserver.v1.GitserverService.IsPerforcePathCloneable:input_type -> gitserver.v1.IsPerforcePathCloneableRequest
	70, // 76: gitserver.v1.GitserverService.CheckPerforceCredentials:input_type -> gitserver.v1.CheckPerforceCredentialsRequest
	85, // 77: gitserver.v1.GitserverService.PerforceUsers:input_type -> gitserver.v1.PerforceUsersRequest
	80, // 78: gitserver.v1.GitserverService.PerforceProtectsForUser:input_type -> gitserver.v1.PerforceProtectsForUserRequest
	78, // 79: gitserver.v1.GitserverService.PerforceProtectsForDepot:input_type -> gitserver.v1.PerforceProtectsForDepotRequest
	83, // 80: gitserver.v1.GitserverService.PerforceGroupMembers:input_type -> gitserver.v1.PerforceGroupMembersRequest
	76, // 81: gitserver.v1.GitserverService.IsPerforceSuperUser:input_type -> gitserver.v1.IsPerforceSuperUserRequest
	73, // 82: gitserver.v1.GitserverService.PerforceGetChangelist:input_type -> gitserver.v1.PerforceGetChangelistRequest
	88, // 83: gitserver.v1.GitserverService.MergeBase:input_type -> gitserver.v1.MergeBaseRequest
	7,  // 84: gitserver.v1.GitserverService.Blame:input_type -> gitserver.v1.BlameRequest
	11, // 85: gitserver.v1.GitserverService.DefaultBranch:input_type -> gitserver.v1.DefaultBranchRequest
	13, // 86: gitserver.v1.GitserverService.ReadFile:input_type -> gitserver.v1.ReadFileRequest
	3,  // 87: gitserver.v1.GitserverService.GetCommit:input_type -> gitserver.v1.GetCommitRequest
	18, // 88: gitserver.v1.GitserverService.BatchLog:output_type -> gitserver.v1.BatchLogResponse
	25, // 89: gitserver.v1.GitserverService.CreateCommitFromPatchBinary:output_type -> gitserver.v1.CreateCommitFromPatchBinaryResponse
	16, // 90: gitserver.v1.GitserverService.DiskInfo:output_type -> gitserver.v1.DiskInfoResponse
	27, // 91: gitserver.v1.GitserverService.Exec:output_type -> gitserver.v1.ExecResponse
	66, // 92: gitserver.v1.GitserverService.GetObject:output_type -> gitserver.v1.GetObjectResponse
	50, // 93: gitserver.v1.GitserverService.IsRepoCloneable:output_type -> gitserver.v1.IsRepoCloneableResponse
	64, // 94: gitserver.v1.GitserverService.ListGitolite:output_type -> gitserver.v1.ListGitoliteResponse
	45, // 95: gitserver.v1.GitserverService.Search:output_type -> gitserver.v1.SearchResponse
	48, // 96: gitserver.v1.GitserverService.Archive:output_type -> gitserver.v1.ArchiveResponse
	61, // 97: gitserver.v1.GitserverService.P4Exec:output_type -> gitserver.v1.P4ExecResponse
	52, // 98: gitserver.v1.GitserverService.RepoClone:output_type -> gitserver.v1.RepoCloneResponse
	55, // 99: gitserver.v1.GitserverService.RepoCloneProgress:output_type -> gitserver.v1.RepoCloneProgressResponse
	57, // 100: gitserver.v1.GitserverService.RepoDelete:output_type -> gitserver.v1.RepoDeleteResponse
	59, // 101: gitserver.v1.GitserverService.RepoUpdate:output_type -> gitserver.v1.RepoUpdateResponse
	69, // 102: gitserver.v1.GitserverService.IsPerforcePathCloneable:output_type -> gitserver.v1.IsPerforcePathCloneableResponse
	71, // 103: gitserver.v1.GitserverService.CheckPerforceCredentials:output_type -> gitserver.v1.CheckPerforceCredentialsResponse
	86, // 104: gitserver.v1.GitserverService.PerforceUsers:output_type -> gitserver.v1.PerforceUsersResponse
	81, // 105: gitserver.v1.GitserverService.PerforceProtectsForUser:output_type -> gitserver.v1.PerforceProtectsForUserResponse
	79, // 106: gitserver.v1.GitserverService.PerforceProtectsForDepot:output_type -> gitserver.v1.PerforceProtectsForDepotResponse
	84, // 107: gitserver.v1.GitserverService.PerforceGroupMembers:output_type -> gitserver.v1.PerforceGroupMembersResponse
	77, // 108: gitserver.v1.GitserverService.IsPerforceSuperUser:output_type -> gitserver.v1.IsPerforceSuperUserResponse
	74, // 109: gitserver.v1.GitserverService.PerforceGetChangelist:output_type -> gitserver.v1.PerforceGetChangelistResponse
	89, // 110: gitserver.v1.GitserverService.MergeBase:output_type -> gitserver.v1.MergeBaseResponse
	8,  // 111: gitserver.v1.GitserverService.Blame:output_type -> gitserver.v1.BlameResponse
	12, // 112: gitserver.v1.GitserverService.DefaultBranch:output_type -> gitserver.v1.DefaultBranchResponse
	14, // 113: gitserver.v1.GitserverService.ReadFile:output_type -> gitserver.v1.ReadFileResponse
	4,  // 114: gitserver.v1.GitserverService.GetCommit:output_type -> gitserver.v1.GetCommitResponse
