...
func (r *automaticRetryClient) ReposStats(ctx context.Context, in *proto.ReposStatsRequest, opts ...grpc.CallOption) (*proto.ReposStatsResponse, error) {
	opts = append(defaults.RetryPolicy, opts...)
	return r.base.ReposStats(ctx, in, opts...)
}
