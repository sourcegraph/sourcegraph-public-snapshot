...
type MockGitserverServiceClient struct {
	...
	ReadDirPatternsFunc *GitserverServiceClientReadDirPatternsFunc
...
func NewMockGitserverServiceClient() *MockGitserverServiceClient {
	return &MockGitserverServiceClient{
		...
		ReadDirPatternsFunc: &GitserverServiceClientReadDirPatternsFunc{
			defaultHook: func(context.Context, *v1.ReadDirPatternsRequest, ...grpc.CallOption) (r0 v1.GitserverService_ReadDirPatternsClient, r1 error) {
				return
			},
		},
		ReadFileFunc: &GitserverServiceClientReadFileFunc{
...
func NewStrictMockGitserverServiceClient() *MockGitserverServiceClient {
	return &MockGitserverServiceClient{
		...
		ReadDirPatternsFunc: &GitserverServiceClientReadDirPatternsFunc{
			defaultHook: func(context.Context, *v1.ReadDirPatternsRequest, ...grpc.CallOption) (v1.GitserverService_ReadDirPatternsClient, error) {
				panic("unexpected invocation of MockGitserverServiceClient.ReadDirPatterns")
			},
		},
		ReadFileFunc: &GitserverServiceClientReadFileFunc{
...
// GitserverServiceClientReadDirPatternsFunc describes the behavior when the
// ReadDirPatterns method of the parent MockGitserverServiceClient instance
// is invoked.
type GitserverServiceClientReadDirPatternsFunc struct {
	defaultHook func(context.Context, *v1.ReadDirPatternsRequest, ...grpc.CallOption) (v1.GitserverService_ReadDirPatternsClient, error)
	hooks       []func(context.Context, *v1.ReadDirPatternsRequest, ...grpc.CallOption) (v1.GitserverService_ReadDirPatternsClient, error)
	history     []GitserverServiceClientReadDirPatternsFuncCall
	mutex       sync.Mutex
}

// ReadDirPatterns delegates to the next hook function in the queue and
// stores the parameter and result values of this invocation.
func (m *MockGitserverServiceClient) ReadDirPatterns(v0 context.Context, v1 *v1.ReadDirPatternsRequest, v2 ...grpc.CallOption) (v1.GitserverService_ReadDirPatternsClient, error) {
	r0, r1 := m.ReadDirPatternsFunc.nextHook()(v0, v1, v2...)
	m.ReadDirPatternsFunc.appendCall(GitserverServiceClientReadDirPatternsFuncCall{v0, v1, v2, r0, r1})
	return r0, r1
}
...
// method of the parent MockGitserverServiceClient instance is invoked and
// the hook queue is empty.
func (f *GitserverServiceClientReadDirPatternsFunc) SetDefaultHook(hook func(context.Context, *v1.ReadDirPatternsRequest, ...grpc.CallOption) (v1.GitserverService_ReadDirPatternsClient, error)) {
	f.defaultHook = hook
}
...
// queue is empty, the default hook function is invoked for any future
// action.
func (f *GitserverServiceClientReadDirPatternsFunc) PushHook(hook func(context.Context, *v1.ReadDirPatternsRequest, ...grpc.CallOption) (v1.GitserverService_ReadDirPatternsClient, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *GitserverServiceClientReadDirPatternsFunc) SetDefaultReturn(r0 v1.GitserverService_ReadDirPatternsClient, r1 error) {
	f.SetDefaultHook(func(context.Context, *v1.ReadDirPatternsRequest, ...grpc.CallOption) (v1.GitserverService_ReadDirPatternsClient, error) {
		return r0, r1
	})
}

// PushReturn calls PushHook with a function that returns the given values.
func (f *GitserverServiceClientReadDirPatternsFunc) PushReturn(r0 v1.GitserverService_ReadDirPatternsClient, r1 error) {
	f.PushHook(func(context.Context, *v1.ReadDirPatternsRequest, ...grpc.CallOption) (v1.GitserverService_ReadDirPatternsClient, error) {
		return r0, r1
	})
}

func (f *GitserverServiceClientReadDirPatternsFunc) nextHook() func(context.Context, *v1.ReadDirPatternsRequest, ...grpc.CallOption) (v1.GitserverService_ReadDirPatternsClient, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
func (f *GitserverServiceClientReadDirPatternsFunc) appendCall(r0 GitserverServiceClientReadDirPatternsFuncCall) {
	f.mutex.Lock()
	f.history = append(f.history, r0)
	f.mutex.Unlock()
}
...
// History returns a sequence of
// GitserverServiceClientReadDirPatternsFuncCall objects describing the
// invocations of this function.
func (f *GitserverServiceClientReadDirPatternsFunc) History() []GitserverServiceClientReadDirPatternsFuncCall {
	f.mutex.Lock()
	history := make([]GitserverServiceClientReadDirPatternsFuncCall, len(f.history))
	copy(history, f.history)
	f.mutex.Unlock()
...
// GitserverServiceClientReadDirPatternsFuncCall is an object that describes
// an invocation of method ReadDirPatterns on an instance of
// MockGitserverServiceClient.
type GitserverServiceClientReadDirPatternsFuncCall struct {
	// Arg0 is the value of the 1st argument passed to this method
	// invocation.
	Arg0 context.Context
	// Arg1 is the value of the 2nd argument passed to this method
	// invocation.
	Arg1 *v1.ReadDirPatternsRequest
	// Arg2 is a slice containing the values of the variadic arguments
	// passed to this method invocation.
	Arg2 []grpc.CallOption
	// Result0 is the value of the 1st result returned from this method
	// invocation.
	Result0 v1.GitserverService_ReadDirPatternsClient
	// Result1 is the value of the 2nd result returned from this method
	// invocation.
	Result1 error
}
...
// that one positional argument and three variadic arguments would result in
// a slice of four, not two.
func (c GitserverServiceClientReadDirPatternsFuncCall) Args() []interface{} {
	trailing := []interface{}{}
	for _, val := range c.Arg2 {
		trailing = append(trailing, val)
	}
...
// Results returns an interface slice containing the results of this
// invocation.
func (c GitserverServiceClientReadDirPatternsFuncCall) Results() []interface{} {
	return []interface{}{c.Result0, c.Result1}
}
