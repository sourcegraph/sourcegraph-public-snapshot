...
func (f *FeelingLuckySearchJob) Fields(job.Verbosity) []attribute.KeyValue { return nil }
...
func (g *generatedSearchJob) Fields(job.Verbosity) []attribute.KeyValue { return nil }
