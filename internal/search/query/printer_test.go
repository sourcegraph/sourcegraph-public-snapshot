...
func TestStringHuman(t *testing.T) {
	...
	autogold.Want("14", "-repo:modspeed repo:modspeed -file:pogspeed file:pogspeed ((not Phoenicians) and Arizonan)").Equal(t, test("-repo:modspeed -file:pogspeed Arizonan -content:Phoenicians"))
}
