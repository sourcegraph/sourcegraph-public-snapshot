...
func (p *parser) parseAnd() ([]Node, error) {
	...
	case SearchTypeStandard, SearchTypeLucky, SearchTypeStandardV2:
...
func Parse(in string, searchType SearchType) ([]Node, error) {
	...
	if searchType == SearchTypeLiteral || searchType == SearchTypeStandard || searchType == SearchTypeStandardV2 {
