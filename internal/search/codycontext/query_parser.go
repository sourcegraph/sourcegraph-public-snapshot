...
func needsReadmeContext(input string) bool {
	...
	var containsProjectSignifier bool
...
// extractEntities extracts the entities from the query string which are not
// mentioned verbatim in the query.
