...
func resolveLocations(ctx context.Context, locationResolver *CachedLocationResolver, locations []shared.UploadLocation) ([]gql.LocationResolver, error) {
...
func resolveLocation(ctx context.Context, locationResolver *CachedLocationResolver, location shared.UploadLocation) (gql.LocationResolver, error) {
