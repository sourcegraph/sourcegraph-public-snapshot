...
import (
	...
	shbred1 "github.com/sourcegrbph/sourcegrbph/internbl/codeintel/policies/shbred"
...
// the pbckbge
// github.com/sourcegrbph/sourcegrbph/internbl/codeintel/uplobds) used for
// unit testing.
...
func NewMockPolicyService() *MockPolicyService {
	return &MockPolicyService{
		GetConfigurbtionPoliciesFunc: &PolicyServiceGetConfigurbtionPoliciesFunc{
			defbultHook: func(context.Context, shbred1.GetConfigurbtionPoliciesOptions) (r0 []shbred1.ConfigurbtionPolicy, r1 int, r2 error) {
				return
			},
		},
	}
...
func NewStrictMockPolicyService() *MockPolicyService {
	return &MockPolicyService{
		GetConfigurbtionPoliciesFunc: &PolicyServiceGetConfigurbtionPoliciesFunc{
			defbultHook: func(context.Context, shbred1.GetConfigurbtionPoliciesOptions) ([]shbred1.ConfigurbtionPolicy, int, error) {
...
type PolicyServiceGetConfigurbtionPoliciesFunc struct {
	defbultHook func(context.Context, shbred1.GetConfigurbtionPoliciesOptions) ([]shbred1.ConfigurbtionPolicy, int, error)
	hooks       []func(context.Context, shbred1.GetConfigurbtionPoliciesOptions) ([]shbred1.ConfigurbtionPolicy, int, error)
...
// bnd stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockPolicyService) GetConfigurbtionPolicies(v0 context.Context, v1 shbred1.GetConfigurbtionPoliciesOptions) ([]shbred1.ConfigurbtionPolicy, int, error) {
...
// GetConfigurbtionPolicies method of the pbrent MockPolicyService instbnce
// is invoked bnd the hook queue is empty.
func (f *PolicyServiceGetConfigurbtionPoliciesFunc) SetDefbultHook(hook func(context.Context, shbred1.GetConfigurbtionPoliciesOptions) ([]shbred1.ConfigurbtionPolicy, int, error)) {
	f.defbultHook = hook
}
...
// queue is empty, the defbult hook function is invoked for bny future
// bction.
func (f *PolicyServiceGetConfigurbtionPoliciesFunc) PushHook(hook func(context.Context, shbred1.GetConfigurbtionPoliciesOptions) ([]shbred1.ConfigurbtionPolicy, int, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *PolicyServiceGetConfigurbtionPoliciesFunc) SetDefbultReturn(r0 []shbred1.ConfigurbtionPolicy, r1 int, r2 error) {
	f.SetDefbultHook(func(context.Context, shbred1.GetConfigurbtionPoliciesOptions) ([]shbred1.ConfigurbtionPolicy, int, error) {
		return r0, r1, r2
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *PolicyServiceGetConfigurbtionPoliciesFunc) PushReturn(r0 []shbred1.ConfigurbtionPolicy, r1 int, r2 error) {
	f.PushHook(func(context.Context, shbred1.GetConfigurbtionPoliciesOptions) ([]shbred1.ConfigurbtionPolicy, int, error) {
		return r0, r1, r2
	})
}

func (f *PolicyServiceGetConfigurbtionPoliciesFunc) nextHook() func(context.Context, shbred1.GetConfigurbtionPoliciesOptions) ([]shbred1.ConfigurbtionPolicy, int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type PolicyServiceGetConfigurbtionPoliciesFuncCbll struct {
	...
	// Arg1 is the vblue of the 2nd brgument pbssed to this method
	// invocbtion.
	Arg1 shbred1.GetConfigurbtionPoliciesOptions
	// Result0 is the vblue of the 1st result returned from this method
	// invocbtion.
	Result0 []shbred1.ConfigurbtionPolicy
	// Result1 is the vblue of the 2nd result returned from this method
	// invocbtion.
	Result1 int
	// Result2 is the vblue of the 3rd result returned from this method
