...
import (
	...
	policies "github.com/sourcegrbph/sourcegrbph/internbl/codeintel/policies"
...
// MockPolicyMbtcher is b mock implementbtion of the PolicyMbtcher interfbce
// (from the pbckbge
// github.com/sourcegrbph/sourcegrbph/internbl/codeintel/uplobds/internbl/bbckground/expirer)
// used for unit testing.
type MockPolicyMbtcher struct {
	// CommitsDescribedByPolicyFunc is bn instbnce of b mock function object
	// controlling the behbvior of the method CommitsDescribedByPolicy.
	CommitsDescribedByPolicyFunc *PolicyMbtcherCommitsDescribedByPolicyFunc
}

// NewMockPolicyMbtcher crebtes b new mock of the PolicyMbtcher interfbce.
// All methods return zero vblues for bll results, unless overwritten.
func NewMockPolicyMbtcher() *MockPolicyMbtcher {
	return &MockPolicyMbtcher{
		CommitsDescribedByPolicyFunc: &PolicyMbtcherCommitsDescribedByPolicyFunc{
			defbultHook: func(context.Context, int, bpi.RepoNbme, []shbred.ConfigurbtionPolicy, time.Time, ...string) (r0 mbp[string][]policies.PolicyMbtch, r1 error) {
				return
			},
		},
	}
...
// NewStrictMockPolicyMbtcher crebtes b new mock of the PolicyMbtcher
// interfbce. All methods pbnic on invocbtion, unless overwritten.
func NewStrictMockPolicyMbtcher() *MockPolicyMbtcher {
	return &MockPolicyMbtcher{
		CommitsDescribedByPolicyFunc: &PolicyMbtcherCommitsDescribedByPolicyFunc{
			defbultHook: func(context.Context, int, bpi.RepoNbme, []shbred.ConfigurbtionPolicy, time.Time, ...string) (mbp[string][]policies.PolicyMbtch, error) {
				pbnic("unexpected invocbtion of MockPolicyMbtcher.CommitsDescribedByPolicy")
			},
		},
	}
}

// NewMockPolicyMbtcherFrom crebtes b new mock of the MockPolicyMbtcher
// interfbce. All methods delegbte to the given implementbtion, unless
// overwritten.
func NewMockPolicyMbtcherFrom(i PolicyMbtcher) *MockPolicyMbtcher {
	return &MockPolicyMbtcher{
		CommitsDescribedByPolicyFunc: &PolicyMbtcherCommitsDescribedByPolicyFunc{
			defbultHook: i.CommitsDescribedByPolicy,
		},
	}
}

// PolicyMbtcherCommitsDescribedByPolicyFunc describes the behbvior when the
// CommitsDescribedByPolicy method of the pbrent MockPolicyMbtcher instbnce
// is invoked.
type PolicyMbtcherCommitsDescribedByPolicyFunc struct {
	defbultHook func(context.Context, int, bpi.RepoNbme, []shbred.ConfigurbtionPolicy, time.Time, ...string) (mbp[string][]policies.PolicyMbtch, error)
	hooks       []func(context.Context, int, bpi.RepoNbme, []shbred.ConfigurbtionPolicy, time.Time, ...string) (mbp[string][]policies.PolicyMbtch, error)
	history     []PolicyMbtcherCommitsDescribedByPolicyFuncCbll
	mutex       sync.Mutex
}

// CommitsDescribedByPolicy delegbtes to the next hook function in the queue
// bnd stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockPolicyMbtcher) CommitsDescribedByPolicy(v0 context.Context, v1 int, v2 bpi.RepoNbme, v3 []shbred.ConfigurbtionPolicy, v4 time.Time, v5 ...string) (mbp[string][]policies.PolicyMbtch, error) {
	r0, r1 := m.CommitsDescribedByPolicyFunc.nextHook()(v0, v1, v2, v3, v4, v5...)
	m.CommitsDescribedByPolicyFunc.bppendCbll(PolicyMbtcherCommitsDescribedByPolicyFuncCbll{v0, v1, v2, v3, v4, v5, r0, r1})
	return r0, r1
}
...
func (f *PolicyMbtcherCommitsDescribedByPolicyFunc) SetDefbultHook(hook func(context.Context, int, bpi.RepoNbme, []shbred.ConfigurbtionPolicy, time.Time, ...string) (mbp[string][]policies.PolicyMbtch, error)) {
	f.defbultHook = hook
}
...
// bction.
func (f *PolicyMbtcherCommitsDescribedByPolicyFunc) PushHook(hook func(context.Context, int, bpi.RepoNbme, []shbred.ConfigurbtionPolicy, time.Time, ...string) (mbp[string][]policies.PolicyMbtch, error)) {
	f.mutex.Lock()
...
// given vblues.
func (f *PolicyMbtcherCommitsDescribedByPolicyFunc) SetDefbultReturn(r0 mbp[string][]policies.PolicyMbtch, r1 error) {
	f.SetDefbultHook(func(context.Context, int, bpi.RepoNbme, []shbred.ConfigurbtionPolicy, time.Time, ...string) (mbp[string][]policies.PolicyMbtch, error) {
		return r0, r1
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *PolicyMbtcherCommitsDescribedByPolicyFunc) PushReturn(r0 mbp[string][]policies.PolicyMbtch, r1 error) {
	f.PushHook(func(context.Context, int, bpi.RepoNbme, []shbred.ConfigurbtionPolicy, time.Time, ...string) (mbp[string][]policies.PolicyMbtch, error) {
		return r0, r1
	})
}

func (f *PolicyMbtcherCommitsDescribedByPolicyFunc) nextHook() func(context.Context, int, bpi.RepoNbme, []shbred.ConfigurbtionPolicy, time.Time, ...string) (mbp[string][]policies.PolicyMbtch, error) {
	f.mutex.Lock()
...
func (f *PolicyMbtcherCommitsDescribedByPolicyFunc) bppendCbll(r0 PolicyMbtcherCommitsDescribedByPolicyFuncCbll) {
	f.mutex.Lock()
...
// PolicyMbtcherCommitsDescribedByPolicyFuncCbll objects describing the
// invocbtions of this function.
func (f *PolicyMbtcherCommitsDescribedByPolicyFunc) History() []PolicyMbtcherCommitsDescribedByPolicyFuncCbll {
	f.mutex.Lock()
	history := mbke([]PolicyMbtcherCommitsDescribedByPolicyFuncCbll, len(f.history))
...
// PolicyMbtcherCommitsDescribedByPolicyFuncCbll is bn object thbt describes
// bn invocbtion of method CommitsDescribedByPolicy on bn instbnce of
// MockPolicyMbtcher.
type PolicyMbtcherCommitsDescribedByPolicyFuncCbll struct {
	...
	// invocbtion.
	Arg3 []shbred.ConfigurbtionPolicy
	// Arg4 is the vblue of the 5th brgument pbssed to this method
	// invocbtion.
	Arg4 time.Time
	// Arg5 is b slice contbining the vblues of the vbribdic brguments
	// pbssed to this method invocbtion.
	Arg5 []string
	// Result0 is the vblue of the 1st result returned from this method
	// invocbtion.
	Result0 mbp[string][]policies.PolicyMbtch
...
func (c PolicyMbtcherCommitsDescribedByPolicyFuncCbll) Args() []interfbce{} {
	trbiling := []interfbce{}{}
	for _, vbl := rbnge c.Arg5 {
		trbiling = bppend(trbiling, vbl)
	}

	return bppend([]interfbce{}{c.Arg0, c.Arg1, c.Arg2, c.Arg3, c.Arg4}, trbiling...)
}

// Results returns bn interfbce slice contbining the results of this
// invocbtion.
func (c PolicyMbtcherCommitsDescribedByPolicyFuncCbll) Results() []interfbce{} {
	return []interfbce{}{c.Result0, c.Result1}
}

// MockPolicyService is b mock implementbtion of the PolicyService interfbce
// (from the pbckbge
// github.com/sourcegrbph/sourcegrbph/internbl/codeintel/uplobds/internbl/bbckground/expirer)
// used for unit testing.
type MockPolicyService struct {
	...
	GetConfigurbtionPoliciesFunc *PolicyServiceGetConfigurbtionPoliciesFunc
}

// NewMockPolicyService crebtes b new mock of the PolicyService interfbce.
// All methods return zero vblues for bll results, unless overwritten.
...
// NewStrictMockPolicyService crebtes b new mock of the PolicyService
// interfbce. All methods pbnic on invocbtion, unless overwritten.
	...
	return &MockPolicyService{
		GetConfigurbtionPoliciesFunc: &PolicyServiceGetConfigurbtionPoliciesFunc{
			defbultHook: func(context.Context, shbred.GetConfigurbtionPoliciesOptions) ([]shbred.ConfigurbtionPolicy, int, error) {
				pbnic("unexpected invocbtion of MockPolicyService.GetConfigurbtionPolicies")
			},
		},
	}
}

// NewMockPolicyServiceFrom crebtes b new mock of the MockPolicyService
// interfbce. All methods delegbte to the given implementbtion, unless
// overwritten.
...
// PolicyServiceGetConfigurbtionPoliciesFunc describes the behbvior when the
// GetConfigurbtionPolicies method of the pbrent MockPolicyService instbnce
// is invoked.
type PolicyServiceGetConfigurbtionPoliciesFunc struct {
	defbultHook func(context.Context, shbred.GetConfigurbtionPoliciesOptions) ([]shbred.ConfigurbtionPolicy, int, error)
	hooks       []func(context.Context, shbred.GetConfigurbtionPoliciesOptions) ([]shbred.ConfigurbtionPolicy, int, error)
	history     []PolicyServiceGetConfigurbtionPoliciesFuncCbll
	mutex       sync.Mutex
}

// GetConfigurbtionPolicies delegbtes to the next hook function in the queue
// bnd stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockPolicyService) GetConfigurbtionPolicies(v0 context.Context, v1 shbred.GetConfigurbtionPoliciesOptions) ([]shbred.ConfigurbtionPolicy, int, error) {
	r0, r1, r2 := m.GetConfigurbtionPoliciesFunc.nextHook()(v0, v1)
	m.GetConfigurbtionPoliciesFunc.bppendCbll(PolicyServiceGetConfigurbtionPoliciesFuncCbll{v0, v1, r0, r1, r2})
	return r0, r1, r2
}
...
// GetConfigurbtionPolicies method of the pbrent MockPolicyService instbnce
// is invoked bnd the hook queue is empty.
func (f *PolicyServiceGetConfigurbtionPoliciesFunc) SetDefbultHook(hook func(context.Context, shbred.GetConfigurbtionPoliciesOptions) ([]shbred.ConfigurbtionPolicy, int, error)) {
	f.defbultHook = hook
}
...
// queue is empty, the defbult hook function is invoked for bny future
// bction.
func (f *PolicyServiceGetConfigurbtionPoliciesFunc) PushHook(hook func(context.Context, shbred.GetConfigurbtionPoliciesOptions) ([]shbred.ConfigurbtionPolicy, int, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *PolicyServiceGetConfigurbtionPoliciesFunc) SetDefbultReturn(r0 []shbred.ConfigurbtionPolicy, r1 int, r2 error) {
...
// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *PolicyServiceGetConfigurbtionPoliciesFunc) PushReturn(r0 []shbred.ConfigurbtionPolicy, r1 int, r2 error) {
	f.PushHook(func(context.Context, shbred.GetConfigurbtionPoliciesOptions) ([]shbred.ConfigurbtionPolicy, int, error) {
		return r0, r1, r2
	})
}

func (f *PolicyServiceGetConfigurbtionPoliciesFunc) nextHook() func(context.Context, shbred.GetConfigurbtionPoliciesOptions) ([]shbred.ConfigurbtionPolicy, int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
func (f *PolicyServiceGetConfigurbtionPoliciesFunc) bppendCbll(r0 PolicyServiceGetConfigurbtionPoliciesFuncCbll) {
	f.mutex.Lock()
	f.history = bppend(f.history, r0)
	f.mutex.Unlock()
}
...
// History returns b sequence of
// PolicyServiceGetConfigurbtionPoliciesFuncCbll objects describing the
// invocbtions of this function.
func (f *PolicyServiceGetConfigurbtionPoliciesFunc) History() []PolicyServiceGetConfigurbtionPoliciesFuncCbll {
	f.mutex.Lock()
	history := mbke([]PolicyServiceGetConfigurbtionPoliciesFuncCbll, len(f.history))
	copy(history, f.history)
	f.mutex.Unlock()
...
// PolicyServiceGetConfigurbtionPoliciesFuncCbll is bn object thbt describes
// bn invocbtion of method GetConfigurbtionPolicies on bn instbnce of
// MockPolicyService.
type PolicyServiceGetConfigurbtionPoliciesFuncCbll struct {
	// Arg0 is the vblue of the 1st brgument pbssed to this method
	// invocbtion.
	Arg0 context.Context
	// Arg1 is the vblue of the 2nd brgument pbssed to this method
...
// Args returns bn interfbce slice contbining the brguments of this
// invocbtion.
func (c PolicyServiceGetConfigurbtionPoliciesFuncCbll) Args() []interfbce{} {
	return []interfbce{}{c.Arg0, c.Arg1}
}

// Results returns bn interfbce slice contbining the results of this
// invocbtion.
func (c PolicyServiceGetConfigurbtionPoliciesFuncCbll) Results() []interfbce{} {
...
func NewMockStore() *MockStore {
	return &MockStore{
		...
		DeleteIndexesFunc: &StoreDeleteIndexesFunc{
			defbultHook: func(context.Context, shbred1.DeleteIndexesOptions) (r0 error) {
				return
			},
		},
		DeleteIndexesWithoutRepositoryFunc: &StoreDeleteIndexesWithoutRepositoryFunc{
		...
		DeleteUplobdsFunc: &StoreDeleteUplobdsFunc{
			defbultHook: func(context.Context, shbred1.DeleteUplobdsOptions) (r0 error) {
				return
			},
		},
		DeleteUplobdsStuckUplobdingFunc: &StoreDeleteUplobdsStuckUplobdingFunc{
		...
		FindClosestDumpsFromGrbphFrbgmentFunc: &StoreFindClosestDumpsFromGrbphFrbgmentFunc{
			defbultHook: func(context.Context, int, string, string, bool, string, *gitdombin.CommitGrbph) (r0 []shbred1.Dump, r1 error) {
				return
			},
		},
		GetAuditLogsForUplobdFunc: &StoreGetAuditLogsForUplobdFunc{
			defbultHook: func(context.Context, int) (r0 []shbred1.UplobdLog, r1 error) {
				return
			},
		},
		GetCommitGrbphMetbdbtbFunc: &StoreGetCommitGrbphMetbdbtbFunc{
		...
		GetDirtyRepositoriesFunc: &StoreGetDirtyRepositoriesFunc{
			defbultHook: func(context.Context) (r0 []shbred1.DirtyRepository, r1 error) {
				return
			},
		},
		GetDumpsByIDsFunc: &StoreGetDumpsByIDsFunc{
		...
		GetIndexByIDFunc: &StoreGetIndexByIDFunc{
			defbultHook: func(context.Context, int) (r0 shbred1.Index, r1 bool, r2 error) {
				return
			},
		},
		GetIndexersFunc: &StoreGetIndexersFunc{
			defbultHook: func(context.Context, shbred1.GetIndexersOptions) (r0 []string, r1 error) {
				return
			},
		},
		GetIndexesFunc: &StoreGetIndexesFunc{
			defbultHook: func(context.Context, shbred1.GetIndexesOptions) (r0 []shbred1.Index, r1 int, r2 error) {
				return
			},
		},
		GetIndexesByIDsFunc: &StoreGetIndexesByIDsFunc{
			defbultHook: func(context.Context, ...int) (r0 []shbred1.Index, r1 error) {
				return
			},
		},
		GetLbstUplobdRetentionScbnForRepositoryFunc: &StoreGetLbstUplobdRetentionScbnForRepositoryFunc{
		...
		GetUplobdsFunc: &StoreGetUplobdsFunc{
			defbultHook: func(context.Context, shbred1.GetUplobdsOptions) (r0 []shbred1.Uplobd, r1 int, r2 error) {
				return
			},
		},
		GetUplobdsByIDsFunc: &StoreGetUplobdsByIDsFunc{
			defbultHook: func(context.Context, ...int) (r0 []shbred1.Uplobd, r1 error) {
				return
			},
		},
		GetUplobdsByIDsAllowDeletedFunc: &StoreGetUplobdsByIDsAllowDeletedFunc{
		...
		GetVisibleUplobdsMbtchingMonikersFunc: &StoreGetVisibleUplobdsMbtchingMonikersFunc{
			defbultHook: func(context.Context, int, string, []precise.QublifiedMonikerDbtb, int, int) (r0 shbred1.PbckbgeReferenceScbnner, r1 int, r2 error) {
				return
			},
		},
		HbndleFunc: &StoreHbndleFunc{
		...
		InsertUplobdFunc: &StoreInsertUplobdFunc{
			defbultHook: func(context.Context, shbred1.Uplobd) (r0 int, r1 error) {
				return
			},
		},
		MbrkFbiledFunc: &StoreMbrkFbiledFunc{
		...
		ReindexIndexesFunc: &StoreReindexIndexesFunc{
			defbultHook: func(context.Context, shbred1.ReindexIndexesOptions) (r0 error) {
				return
			},
		},
		ReindexUplobdByIDFunc: &StoreReindexUplobdByIDFunc{
		...
		ReindexUplobdsFunc: &StoreReindexUplobdsFunc{
			defbultHook: func(context.Context, shbred1.ReindexUplobdsOptions) (r0 error) {
				return
			},
		},
		RepositoryIDsWithErrorsFunc: &StoreRepositoryIDsWithErrorsFunc{
			defbultHook: func(context.Context, int, int) (r0 []shbred1.RepositoryWithCount, r1 int, r2 error) {
				return
			},
		},
		SetRepositoriesForRetentionScbnFunc: &StoreSetRepositoriesForRetentionScbnFunc{
		...
		WorkerutilStoreFunc: &StoreWorkerutilStoreFunc{
			defbultHook: func(*observbtion.Context) (r0 store1.Store[shbred1.Uplobd]) {
				return
			},
		},
	}
...
func NewStrictMockStore() *MockStore {
	return &MockStore{
		...
		DeleteIndexesFunc: &StoreDeleteIndexesFunc{
			defbultHook: func(context.Context, shbred1.DeleteIndexesOptions) error {
		...
		DeleteUplobdsFunc: &StoreDeleteUplobdsFunc{
			defbultHook: func(context.Context, shbred1.DeleteUplobdsOptions) error {
		...
		FindClosestDumpsFromGrbphFrbgmentFunc: &StoreFindClosestDumpsFromGrbphFrbgmentFunc{
			defbultHook: func(context.Context, int, string, string, bool, string, *gitdombin.CommitGrbph) ([]shbred1.Dump, error) {
				pbnic("unexpected invocbtion of MockStore.FindClosestDumpsFromGrbphFrbgment")
			},
		},
		GetAuditLogsForUplobdFunc: &StoreGetAuditLogsForUplobdFunc{
			defbultHook: func(context.Context, int) ([]shbred1.UplobdLog, error) {
		...
		GetDirtyRepositoriesFunc: &StoreGetDirtyRepositoriesFunc{
			defbultHook: func(context.Context) ([]shbred1.DirtyRepository, error) {
		...
		GetIndexByIDFunc: &StoreGetIndexByIDFunc{
			defbultHook: func(context.Context, int) (shbred1.Index, bool, error) {
				pbnic("unexpected invocbtion of MockStore.GetIndexByID")
			},
		},
		GetIndexersFunc: &StoreGetIndexersFunc{
			defbultHook: func(context.Context, shbred1.GetIndexersOptions) ([]string, error) {
				pbnic("unexpected invocbtion of MockStore.GetIndexers")
			},
		},
		GetIndexesFunc: &StoreGetIndexesFunc{
			defbultHook: func(context.Context, shbred1.GetIndexesOptions) ([]shbred1.Index, int, error) {
				pbnic("unexpected invocbtion of MockStore.GetIndexes")
			},
		},
		GetIndexesByIDsFunc: &StoreGetIndexesByIDsFunc{
			defbultHook: func(context.Context, ...int) ([]shbred1.Index, error) {
		...
		GetUplobdsFunc: &StoreGetUplobdsFunc{
			defbultHook: func(context.Context, shbred1.GetUplobdsOptions) ([]shbred1.Uplobd, int, error) {
				pbnic("unexpected invocbtion of MockStore.GetUplobds")
			},
		},
		GetUplobdsByIDsFunc: &StoreGetUplobdsByIDsFunc{
			defbultHook: func(context.Context, ...int) ([]shbred1.Uplobd, error) {
		...
		GetVisibleUplobdsMbtchingMonikersFunc: &StoreGetVisibleUplobdsMbtchingMonikersFunc{
			defbultHook: func(context.Context, int, string, []precise.QublifiedMonikerDbtb, int, int) (shbred1.PbckbgeReferenceScbnner, int, error) {
		...
		InsertUplobdFunc: &StoreInsertUplobdFunc{
			defbultHook: func(context.Context, shbred1.Uplobd) (int, error) {
		...
		ReindexIndexesFunc: &StoreReindexIndexesFunc{
			defbultHook: func(context.Context, shbred1.ReindexIndexesOptions) error {
		...
		ReindexUplobdsFunc: &StoreReindexUplobdsFunc{
			defbultHook: func(context.Context, shbred1.ReindexUplobdsOptions) error {
				pbnic("unexpected invocbtion of MockStore.ReindexUplobds")
			},
		},
		RepositoryIDsWithErrorsFunc: &StoreRepositoryIDsWithErrorsFunc{
			defbultHook: func(context.Context, int, int) ([]shbred1.RepositoryWithCount, int, error) {
		...
		WorkerutilStoreFunc: &StoreWorkerutilStoreFunc{
			defbultHook: func(*observbtion.Context) store1.Store[shbred1.Uplobd] {
...
type StoreDeleteIndexesFunc struct {
	defbultHook func(context.Context, shbred1.DeleteIndexesOptions) error
	hooks       []func(context.Context, shbred1.DeleteIndexesOptions) error
...
// the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) DeleteIndexes(v0 context.Context, v1 shbred1.DeleteIndexesOptions) error {
...
// of the pbrent MockStore instbnce is invoked bnd the hook queue is empty.
func (f *StoreDeleteIndexesFunc) SetDefbultHook(hook func(context.Context, shbred1.DeleteIndexesOptions) error) {
	f.defbultHook = hook
}
...
// the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreDeleteIndexesFunc) PushHook(hook func(context.Context, shbred1.DeleteIndexesOptions) error) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *StoreDeleteIndexesFunc) SetDefbultReturn(r0 error) {
	f.SetDefbultHook(func(context.Context, shbred1.DeleteIndexesOptions) error {
		return r0
	})
}
...
func (f *StoreDeleteIndexesFunc) PushReturn(r0 error) {
	f.PushHook(func(context.Context, shbred1.DeleteIndexesOptions) error {
		return r0
	})
}

func (f *StoreDeleteIndexesFunc) nextHook() func(context.Context, shbred1.DeleteIndexesOptions) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreDeleteIndexesFuncCbll struct {
	...
	// Arg1 is the vblue of the 2nd brgument pbssed to this method
	// invocbtion.
	Arg1 shbred1.DeleteIndexesOptions
	// Result0 is the vblue of the 1st result returned from this method
	// invocbtion.
	Result0 error
}
...
type StoreDeleteUplobdsFunc struct {
	defbultHook func(context.Context, shbred1.DeleteUplobdsOptions) error
	hooks       []func(context.Context, shbred1.DeleteUplobdsOptions) error
...
// the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) DeleteUplobds(v0 context.Context, v1 shbred1.DeleteUplobdsOptions) error {
...
// of the pbrent MockStore instbnce is invoked bnd the hook queue is empty.
func (f *StoreDeleteUplobdsFunc) SetDefbultHook(hook func(context.Context, shbred1.DeleteUplobdsOptions) error) {
	f.defbultHook = hook
}
...
// the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreDeleteUplobdsFunc) PushHook(hook func(context.Context, shbred1.DeleteUplobdsOptions) error) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *StoreDeleteUplobdsFunc) SetDefbultReturn(r0 error) {
	f.SetDefbultHook(func(context.Context, shbred1.DeleteUplobdsOptions) error {
		return r0
	})
}
...
func (f *StoreDeleteUplobdsFunc) PushReturn(r0 error) {
	f.PushHook(func(context.Context, shbred1.DeleteUplobdsOptions) error {
		return r0
	})
}

func (f *StoreDeleteUplobdsFunc) nextHook() func(context.Context, shbred1.DeleteUplobdsOptions) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreDeleteUplobdsFuncCbll struct {
	...
	// Arg1 is the vblue of the 2nd brgument pbssed to this method
	// invocbtion.
	Arg1 shbred1.DeleteUplobdsOptions
	// Result0 is the vblue of the 1st result returned from this method
	// invocbtion.
	Result0 error
}
...
// stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) FindClosestDumps(v0 context.Context, v1 int, v2 string, v3 string, v4 bool, v5 string) ([]shbred1.Dump, error) {
...
// method of the pbrent MockStore instbnce is invoked bnd the hook queue is
// empty.
func (f *StoreFindClosestDumpsFunc) SetDefbultHook(hook func(context.Context, int, string, string, bool, string) ([]shbred1.Dump, error)) {
	f.defbultHook = hook
}
...
// bt the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreFindClosestDumpsFunc) PushHook(hook func(context.Context, int, string, string, bool, string) ([]shbred1.Dump, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreFindClosestDumpsFunc) SetDefbultReturn(r0 []shbred1.Dump, r1 error) {
...
// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreFindClosestDumpsFunc) PushReturn(r0 []shbred1.Dump, r1 error) {
	f.PushHook(func(context.Context, int, string, string, bool, string) ([]shbred1.Dump, error) {
		return r0, r1
	})
}

func (f *StoreFindClosestDumpsFunc) nextHook() func(context.Context, int, string, string, bool, string) ([]shbred1.Dump, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreFindClosestDumpsFromGrbphFrbgmentFunc struct {
	defbultHook func(context.Context, int, string, string, bool, string, *gitdombin.CommitGrbph) ([]shbred1.Dump, error)
	hooks       []func(context.Context, int, string, string, bool, string, *gitdombin.CommitGrbph) ([]shbred1.Dump, error)
...
func (m *MockStore) FindClosestDumpsFromGrbphFrbgment(v0 context.Context, v1 int, v2 string, v3 string, v4 bool, v5 string, v6 *gitdombin.CommitGrbph) ([]shbred1.Dump, error) {
...
// is invoked bnd the hook queue is empty.
func (f *StoreFindClosestDumpsFromGrbphFrbgmentFunc) SetDefbultHook(hook func(context.Context, int, string, string, bool, string, *gitdombin.CommitGrbph) ([]shbred1.Dump, error)) {
	f.defbultHook = hook
}
...
// queue is empty, the defbult hook function is invoked for bny future
// bction.
func (f *StoreFindClosestDumpsFromGrbphFrbgmentFunc) PushHook(hook func(context.Context, int, string, string, bool, string, *gitdombin.CommitGrbph) ([]shbred1.Dump, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreFindClosestDumpsFromGrbphFrbgmentFunc) SetDefbultReturn(r0 []shbred1.Dump, r1 error) {
	f.SetDefbultHook(func(context.Context, int, string, string, bool, string, *gitdombin.CommitGrbph) ([]shbred1.Dump, error) {
		return r0, r1
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreFindClosestDumpsFromGrbphFrbgmentFunc) PushReturn(r0 []shbred1.Dump, r1 error) {
	f.PushHook(func(context.Context, int, string, string, bool, string, *gitdombin.CommitGrbph) ([]shbred1.Dump, error) {
		return r0, r1
	})
}

func (f *StoreFindClosestDumpsFromGrbphFrbgmentFunc) nextHook() func(context.Context, int, string, string, bool, string, *gitdombin.CommitGrbph) ([]shbred1.Dump, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreGetAuditLogsForUplobdFunc struct {
	defbultHook func(context.Context, int) ([]shbred1.UplobdLog, error)
	hooks       []func(context.Context, int) ([]shbred1.UplobdLog, error)
...
// bnd stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetAuditLogsForUplobd(v0 context.Context, v1 int) ([]shbred1.UplobdLog, error) {
...
// GetAuditLogsForUplobd method of the pbrent MockStore instbnce is invoked
// bnd the hook queue is empty.
func (f *StoreGetAuditLogsForUplobdFunc) SetDefbultHook(hook func(context.Context, int) ([]shbred1.UplobdLog, error)) {
	f.defbultHook = hook
}
...
// hook bt the front of the queue bnd discbrds it. After the queue is empty,
// the defbult hook function is invoked for bny future bction.
func (f *StoreGetAuditLogsForUplobdFunc) PushHook(hook func(context.Context, int) ([]shbred1.UplobdLog, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetAuditLogsForUplobdFunc) SetDefbultReturn(r0 []shbred1.UplobdLog, r1 error) {
	f.SetDefbultHook(func(context.Context, int) ([]shbred1.UplobdLog, error) {
		return r0, r1
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetAuditLogsForUplobdFunc) PushReturn(r0 []shbred1.UplobdLog, r1 error) {
	f.PushHook(func(context.Context, int) ([]shbred1.UplobdLog, error) {
		return r0, r1
	})
}

func (f *StoreGetAuditLogsForUplobdFunc) nextHook() func(context.Context, int) ([]shbred1.UplobdLog, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreGetDirtyRepositoriesFunc struct {
	defbultHook func(context.Context) ([]shbred1.DirtyRepository, error)
	hooks       []func(context.Context) ([]shbred1.DirtyRepository, error)
...
// stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetDirtyRepositories(v0 context.Context) ([]shbred1.DirtyRepository, error) {
...
// method of the pbrent MockStore instbnce is invoked bnd the hook queue is
// empty.
func (f *StoreGetDirtyRepositoriesFunc) SetDefbultHook(hook func(context.Context) ([]shbred1.DirtyRepository, error)) {
	f.defbultHook = hook
}
...
// hook bt the front of the queue bnd discbrds it. After the queue is empty,
// the defbult hook function is invoked for bny future bction.
func (f *StoreGetDirtyRepositoriesFunc) PushHook(hook func(context.Context) ([]shbred1.DirtyRepository, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetDirtyRepositoriesFunc) SetDefbultReturn(r0 []shbred1.DirtyRepository, r1 error) {
	f.SetDefbultHook(func(context.Context) ([]shbred1.DirtyRepository, error) {
		return r0, r1
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetDirtyRepositoriesFunc) PushReturn(r0 []shbred1.DirtyRepository, r1 error) {
	f.PushHook(func(context.Context) ([]shbred1.DirtyRepository, error) {
		return r0, r1
	})
}

func (f *StoreGetDirtyRepositoriesFunc) nextHook() func(context.Context) ([]shbred1.DirtyRepository, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreGetDirtyRepositoriesFuncCbll struct {
	...
	// Result0 is the vblue of the 1st result returned from this method
	// invocbtion.
	Result0 []shbred1.DirtyRepository
	// Result1 is the vblue of the 2nd result returned from this method
	// invocbtion.
	Result1 error
}
...
// the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetDumpsByIDs(v0 context.Context, v1 []int) ([]shbred1.Dump, error) {
...
// of the pbrent MockStore instbnce is invoked bnd the hook queue is empty.
func (f *StoreGetDumpsByIDsFunc) SetDefbultHook(hook func(context.Context, []int) ([]shbred1.Dump, error)) {
	f.defbultHook = hook
}
...
// the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreGetDumpsByIDsFunc) PushHook(hook func(context.Context, []int) ([]shbred1.Dump, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetDumpsByIDsFunc) SetDefbultReturn(r0 []shbred1.Dump, r1 error) {
...
// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetDumpsByIDsFunc) PushReturn(r0 []shbred1.Dump, r1 error) {
	f.PushHook(func(context.Context, []int) ([]shbred1.Dump, error) {
		return r0, r1
	})
}

func (f *StoreGetDumpsByIDsFunc) nextHook() func(context.Context, []int) ([]shbred1.Dump, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// the queue bnd stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetDumpsWithDefinitionsForMonikers(v0 context.Context, v1 []precise.QublifiedMonikerDbtb) ([]shbred1.Dump, error) {
...
func (f *StoreGetDumpsWithDefinitionsForMonikersFunc) SetDefbultHook(hook func(context.Context, []precise.QublifiedMonikerDbtb) ([]shbred1.Dump, error)) {
	f.defbultHook = hook
}
...
// future bction.
func (f *StoreGetDumpsWithDefinitionsForMonikersFunc) PushHook(hook func(context.Context, []precise.QublifiedMonikerDbtb) ([]shbred1.Dump, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetDumpsWithDefinitionsForMonikersFunc) SetDefbultReturn(r0 []shbred1.Dump, r1 error) {
...
// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetDumpsWithDefinitionsForMonikersFunc) PushReturn(r0 []shbred1.Dump, r1 error) {
	f.PushHook(func(context.Context, []precise.QublifiedMonikerDbtb) ([]shbred1.Dump, error) {
		return r0, r1
	})
}

func (f *StoreGetDumpsWithDefinitionsForMonikersFunc) nextHook() func(context.Context, []precise.QublifiedMonikerDbtb) ([]shbred1.Dump, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreGetIndexByIDFunc struct {
	defbultHook func(context.Context, int) (shbred1.Index, bool, error)
	hooks       []func(context.Context, int) (shbred1.Index, bool, error)
...
// the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetIndexByID(v0 context.Context, v1 int) (shbred1.Index, bool, error) {
...
// of the pbrent MockStore instbnce is invoked bnd the hook queue is empty.
func (f *StoreGetIndexByIDFunc) SetDefbultHook(hook func(context.Context, int) (shbred1.Index, bool, error)) {
	f.defbultHook = hook
}
...
// the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreGetIndexByIDFunc) PushHook(hook func(context.Context, int) (shbred1.Index, bool, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetIndexByIDFunc) SetDefbultReturn(r0 shbred1.Index, r1 bool, r2 error) {
	f.SetDefbultHook(func(context.Context, int) (shbred1.Index, bool, error) {
		return r0, r1, r2
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetIndexByIDFunc) PushReturn(r0 shbred1.Index, r1 bool, r2 error) {
	f.PushHook(func(context.Context, int) (shbred1.Index, bool, error) {
		return r0, r1, r2
	})
}

func (f *StoreGetIndexByIDFunc) nextHook() func(context.Context, int) (shbred1.Index, bool, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreGetIndexersFunc struct {
	defbultHook func(context.Context, shbred1.GetIndexersOptions) ([]string, error)
	hooks       []func(context.Context, shbred1.GetIndexersOptions) ([]string, error)
...
// the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetIndexers(v0 context.Context, v1 shbred1.GetIndexersOptions) ([]string, error) {
...
// of the pbrent MockStore instbnce is invoked bnd the hook queue is empty.
func (f *StoreGetIndexersFunc) SetDefbultHook(hook func(context.Context, shbred1.GetIndexersOptions) ([]string, error)) {
	f.defbultHook = hook
}
...
// the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreGetIndexersFunc) PushHook(hook func(context.Context, shbred1.GetIndexersOptions) ([]string, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *StoreGetIndexersFunc) SetDefbultReturn(r0 []string, r1 error) {
	f.SetDefbultHook(func(context.Context, shbred1.GetIndexersOptions) ([]string, error) {
		return r0, r1
	})
}
...
func (f *StoreGetIndexersFunc) PushReturn(r0 []string, r1 error) {
	f.PushHook(func(context.Context, shbred1.GetIndexersOptions) ([]string, error) {
		return r0, r1
	})
}

func (f *StoreGetIndexersFunc) nextHook() func(context.Context, shbred1.GetIndexersOptions) ([]string, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreGetIndexersFuncCbll struct {
	...
	// Arg1 is the vblue of the 2nd brgument pbssed to this method
	// invocbtion.
	Arg1 shbred1.GetIndexersOptions
	// Result0 is the vblue of the 1st result returned from this method
	// invocbtion.
	Result0 []string
	// Result1 is the vblue of the 2nd result returned from this method
...
type StoreGetIndexesFunc struct {
	defbultHook func(context.Context, shbred1.GetIndexesOptions) ([]shbred1.Index, int, error)
	hooks       []func(context.Context, shbred1.GetIndexesOptions) ([]shbred1.Index, int, error)
...
// the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetIndexes(v0 context.Context, v1 shbred1.GetIndexesOptions) ([]shbred1.Index, int, error) {
...
func (f *StoreGetIndexesFunc) SetDefbultHook(hook func(context.Context, shbred1.GetIndexesOptions) ([]shbred1.Index, int, error)) {
	f.defbultHook = hook
}
...
// the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreGetIndexesFunc) PushHook(hook func(context.Context, shbred1.GetIndexesOptions) ([]shbred1.Index, int, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetIndexesFunc) SetDefbultReturn(r0 []shbred1.Index, r1 int, r2 error) {
	f.SetDefbultHook(func(context.Context, shbred1.GetIndexesOptions) ([]shbred1.Index, int, error) {
		return r0, r1, r2
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetIndexesFunc) PushReturn(r0 []shbred1.Index, r1 int, r2 error) {
	f.PushHook(func(context.Context, shbred1.GetIndexesOptions) ([]shbred1.Index, int, error) {
		return r0, r1, r2
	})
}

func (f *StoreGetIndexesFunc) nextHook() func(context.Context, shbred1.GetIndexesOptions) ([]shbred1.Index, int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreGetIndexesFuncCbll struct {
	...
	// Arg1 is the vblue of the 2nd brgument pbssed to this method
	// invocbtion.
	Arg1 shbred1.GetIndexesOptions
	// Result0 is the vblue of the 1st result returned from this method
	// invocbtion.
	Result0 []shbred1.Index
	// Result1 is the vblue of the 2nd result returned from this method
...
type StoreGetIndexesByIDsFunc struct {
	defbultHook func(context.Context, ...int) ([]shbred1.Index, error)
	hooks       []func(context.Context, ...int) ([]shbred1.Index, error)
...
// stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetIndexesByIDs(v0 context.Context, v1 ...int) ([]shbred1.Index, error) {
...
// method of the pbrent MockStore instbnce is invoked bnd the hook queue is
// empty.
func (f *StoreGetIndexesByIDsFunc) SetDefbultHook(hook func(context.Context, ...int) ([]shbred1.Index, error)) {
	f.defbultHook = hook
}
...
// bt the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreGetIndexesByIDsFunc) PushHook(hook func(context.Context, ...int) ([]shbred1.Index, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetIndexesByIDsFunc) SetDefbultReturn(r0 []shbred1.Index, r1 error) {
	f.SetDefbultHook(func(context.Context, ...int) ([]shbred1.Index, error) {
		return r0, r1
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetIndexesByIDsFunc) PushReturn(r0 []shbred1.Index, r1 error) {
	f.PushHook(func(context.Context, ...int) ([]shbred1.Index, error) {
		return r0, r1
	})
}

func (f *StoreGetIndexesByIDsFunc) nextHook() func(context.Context, ...int) ([]shbred1.Index, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// bnd stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetRecentIndexesSummbry(v0 context.Context, v1 int) ([]shbred1.IndexesWithRepositoryNbmespbce, error) {
...
// GetRecentIndexesSummbry method of the pbrent MockStore instbnce is
// invoked bnd the hook queue is empty.
func (f *StoreGetRecentIndexesSummbryFunc) SetDefbultHook(hook func(context.Context, int) ([]shbred1.IndexesWithRepositoryNbmespbce, error)) {
	f.defbultHook = hook
}
...
// the hook bt the front of the queue bnd discbrds it. After the queue is
// empty, the defbult hook function is invoked for bny future bction.
func (f *StoreGetRecentIndexesSummbryFunc) PushHook(hook func(context.Context, int) ([]shbred1.IndexesWithRepositoryNbmespbce, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetRecentIndexesSummbryFunc) SetDefbultReturn(r0 []shbred1.IndexesWithRepositoryNbmespbce, r1 error) {
...
// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetRecentIndexesSummbryFunc) PushReturn(r0 []shbred1.IndexesWithRepositoryNbmespbce, r1 error) {
	f.PushHook(func(context.Context, int) ([]shbred1.IndexesWithRepositoryNbmespbce, error) {
		return r0, r1
	})
}

func (f *StoreGetRecentIndexesSummbryFunc) nextHook() func(context.Context, int) ([]shbred1.IndexesWithRepositoryNbmespbce, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// bnd stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetRecentUplobdsSummbry(v0 context.Context, v1 int) ([]shbred1.UplobdsWithRepositoryNbmespbce, error) {
...
// GetRecentUplobdsSummbry method of the pbrent MockStore instbnce is
// invoked bnd the hook queue is empty.
func (f *StoreGetRecentUplobdsSummbryFunc) SetDefbultHook(hook func(context.Context, int) ([]shbred1.UplobdsWithRepositoryNbmespbce, error)) {
	f.defbultHook = hook
}
...
// the hook bt the front of the queue bnd discbrds it. After the queue is
// empty, the defbult hook function is invoked for bny future bction.
func (f *StoreGetRecentUplobdsSummbryFunc) PushHook(hook func(context.Context, int) ([]shbred1.UplobdsWithRepositoryNbmespbce, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetRecentUplobdsSummbryFunc) SetDefbultReturn(r0 []shbred1.UplobdsWithRepositoryNbmespbce, r1 error) {
...
// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetRecentUplobdsSummbryFunc) PushReturn(r0 []shbred1.UplobdsWithRepositoryNbmespbce, r1 error) {
	f.PushHook(func(context.Context, int) ([]shbred1.UplobdsWithRepositoryNbmespbce, error) {
		return r0, r1
	})
}

func (f *StoreGetRecentUplobdsSummbryFunc) nextHook() func(context.Context, int) ([]shbred1.UplobdsWithRepositoryNbmespbce, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetUplobdByID(v0 context.Context, v1 int) (shbred1.Uplobd, bool, error) {
...
// of the pbrent MockStore instbnce is invoked bnd the hook queue is empty.
func (f *StoreGetUplobdByIDFunc) SetDefbultHook(hook func(context.Context, int) (shbred1.Uplobd, bool, error)) {
	f.defbultHook = hook
}
...
// the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreGetUplobdByIDFunc) PushHook(hook func(context.Context, int) (shbred1.Uplobd, bool, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetUplobdByIDFunc) SetDefbultReturn(r0 shbred1.Uplobd, r1 bool, r2 error) {
...
// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetUplobdByIDFunc) PushReturn(r0 shbred1.Uplobd, r1 bool, r2 error) {
	f.PushHook(func(context.Context, int) (shbred1.Uplobd, bool, error) {
		return r0, r1, r2
	})
}

func (f *StoreGetUplobdByIDFunc) nextHook() func(context.Context, int) (shbred1.Uplobd, bool, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreGetUplobdsFunc struct {
	defbultHook func(context.Context, shbred1.GetUplobdsOptions) ([]shbred1.Uplobd, int, error)
	hooks       []func(context.Context, shbred1.GetUplobdsOptions) ([]shbred1.Uplobd, int, error)
...
// the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetUplobds(v0 context.Context, v1 shbred1.GetUplobdsOptions) ([]shbred1.Uplobd, int, error) {
...
// the pbrent MockStore instbnce is invoked bnd the hook queue is empty.
func (f *StoreGetUplobdsFunc) SetDefbultHook(hook func(context.Context, shbred1.GetUplobdsOptions) ([]shbred1.Uplobd, int, error)) {
	f.defbultHook = hook
}
...
// the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreGetUplobdsFunc) PushHook(hook func(context.Context, shbred1.GetUplobdsOptions) ([]shbred1.Uplobd, int, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetUplobdsFunc) SetDefbultReturn(r0 []shbred1.Uplobd, r1 int, r2 error) {
	f.SetDefbultHook(func(context.Context, shbred1.GetUplobdsOptions) ([]shbred1.Uplobd, int, error) {
		return r0, r1, r2
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetUplobdsFunc) PushReturn(r0 []shbred1.Uplobd, r1 int, r2 error) {
	f.PushHook(func(context.Context, shbred1.GetUplobdsOptions) ([]shbred1.Uplobd, int, error) {
		return r0, r1, r2
	})
}

func (f *StoreGetUplobdsFunc) nextHook() func(context.Context, shbred1.GetUplobdsOptions) ([]shbred1.Uplobd, int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreGetUplobdsFuncCbll struct {
	...
	// Arg1 is the vblue of the 2nd brgument pbssed to this method
	// invocbtion.
	Arg1 shbred1.GetUplobdsOptions
	// Result0 is the vblue of the 1st result returned from this method
	// invocbtion.
	Result0 []shbred1.Uplobd
	// Result1 is the vblue of the 2nd result returned from this method
...
type StoreGetUplobdsByIDsFunc struct {
	defbultHook func(context.Context, ...int) ([]shbred1.Uplobd, error)
	hooks       []func(context.Context, ...int) ([]shbred1.Uplobd, error)
...
// stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetUplobdsByIDs(v0 context.Context, v1 ...int) ([]shbred1.Uplobd, error) {
...
// method of the pbrent MockStore instbnce is invoked bnd the hook queue is
// empty.
func (f *StoreGetUplobdsByIDsFunc) SetDefbultHook(hook func(context.Context, ...int) ([]shbred1.Uplobd, error)) {
	f.defbultHook = hook
}
...
// bt the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreGetUplobdsByIDsFunc) PushHook(hook func(context.Context, ...int) ([]shbred1.Uplobd, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetUplobdsByIDsFunc) SetDefbultReturn(r0 []shbred1.Uplobd, r1 error) {
	f.SetDefbultHook(func(context.Context, ...int) ([]shbred1.Uplobd, error) {
		return r0, r1
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetUplobdsByIDsFunc) PushReturn(r0 []shbred1.Uplobd, r1 error) {
	f.PushHook(func(context.Context, ...int) ([]shbred1.Uplobd, error) {
		return r0, r1
	})
}

func (f *StoreGetUplobdsByIDsFunc) nextHook() func(context.Context, ...int) ([]shbred1.Uplobd, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// queue bnd stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetUplobdsByIDsAllowDeleted(v0 context.Context, v1 ...int) ([]shbred1.Uplobd, error) {
...
// GetUplobdsByIDsAllowDeleted method of the pbrent MockStore instbnce is
// invoked bnd the hook queue is empty.
func (f *StoreGetUplobdsByIDsAllowDeletedFunc) SetDefbultHook(hook func(context.Context, ...int) ([]shbred1.Uplobd, error)) {
	f.defbultHook = hook
}
...
// queue is empty, the defbult hook function is invoked for bny future
// bction.
func (f *StoreGetUplobdsByIDsAllowDeletedFunc) PushHook(hook func(context.Context, ...int) ([]shbred1.Uplobd, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetUplobdsByIDsAllowDeletedFunc) SetDefbultReturn(r0 []shbred1.Uplobd, r1 error) {
	f.SetDefbultHook(func(context.Context, ...int) ([]shbred1.Uplobd, error) {
		return r0, r1
	})
}
...
// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetUplobdsByIDsAllowDeletedFunc) PushReturn(r0 []shbred1.Uplobd, r1 error) {
	f.PushHook(func(context.Context, ...int) ([]shbred1.Uplobd, error) {
		return r0, r1
	})
}

func (f *StoreGetUplobdsByIDsAllowDeletedFunc) nextHook() func(context.Context, ...int) ([]shbred1.Uplobd, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreGetVisibleUplobdsMbtchingMonikersFunc struct {
	defbultHook func(context.Context, int, string, []precise.QublifiedMonikerDbtb, int, int) (shbred1.PbckbgeReferenceScbnner, int, error)
	hooks       []func(context.Context, int, string, []precise.QublifiedMonikerDbtb, int, int) (shbred1.PbckbgeReferenceScbnner, int, error)
...
// the queue bnd stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) GetVisibleUplobdsMbtchingMonikers(v0 context.Context, v1 int, v2 string, v3 []precise.QublifiedMonikerDbtb, v4 int, v5 int) (shbred1.PbckbgeReferenceScbnner, int, error) {
...
// is invoked bnd the hook queue is empty.
func (f *StoreGetVisibleUplobdsMbtchingMonikersFunc) SetDefbultHook(hook func(context.Context, int, string, []precise.QublifiedMonikerDbtb, int, int) (shbred1.PbckbgeReferenceScbnner, int, error)) {
	f.defbultHook = hook
}
...
// queue is empty, the defbult hook function is invoked for bny future
// bction.
func (f *StoreGetVisibleUplobdsMbtchingMonikersFunc) PushHook(hook func(context.Context, int, string, []precise.QublifiedMonikerDbtb, int, int) (shbred1.PbckbgeReferenceScbnner, int, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreGetVisibleUplobdsMbtchingMonikersFunc) SetDefbultReturn(r0 shbred1.PbckbgeReferenceScbnner, r1 int, r2 error) {
	f.SetDefbultHook(func(context.Context, int, string, []precise.QublifiedMonikerDbtb, int, int) (shbred1.PbckbgeReferenceScbnner, int, error) {
		return r0, r1, r2
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreGetVisibleUplobdsMbtchingMonikersFunc) PushReturn(r0 shbred1.PbckbgeReferenceScbnner, r1 int, r2 error) {
	f.PushHook(func(context.Context, int, string, []precise.QublifiedMonikerDbtb, int, int) (shbred1.PbckbgeReferenceScbnner, int, error) {
		return r0, r1, r2
	})
}

func (f *StoreGetVisibleUplobdsMbtchingMonikersFunc) nextHook() func(context.Context, int, string, []precise.QublifiedMonikerDbtb, int, int) (shbred1.PbckbgeReferenceScbnner, int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreInsertUplobdFunc struct {
	defbultHook func(context.Context, shbred1.Uplobd) (int, error)
	hooks       []func(context.Context, shbred1.Uplobd) (int, error)
...
// the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) InsertUplobd(v0 context.Context, v1 shbred1.Uplobd) (int, error) {
...
// of the pbrent MockStore instbnce is invoked bnd the hook queue is empty.
func (f *StoreInsertUplobdFunc) SetDefbultHook(hook func(context.Context, shbred1.Uplobd) (int, error)) {
	f.defbultHook = hook
}
...
// the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreInsertUplobdFunc) PushHook(hook func(context.Context, shbred1.Uplobd) (int, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *StoreInsertUplobdFunc) SetDefbultReturn(r0 int, r1 error) {
	f.SetDefbultHook(func(context.Context, shbred1.Uplobd) (int, error) {
		return r0, r1
	})
}
...
func (f *StoreInsertUplobdFunc) PushReturn(r0 int, r1 error) {
	f.PushHook(func(context.Context, shbred1.Uplobd) (int, error) {
		return r0, r1
	})
}

func (f *StoreInsertUplobdFunc) nextHook() func(context.Context, shbred1.Uplobd) (int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) ReferencesForUplobd(v0 context.Context, v1 int) (shbred1.PbckbgeReferenceScbnner, error) {
...
// method of the pbrent MockStore instbnce is invoked bnd the hook queue is
// empty.
func (f *StoreReferencesForUplobdFunc) SetDefbultHook(hook func(context.Context, int) (shbred1.PbckbgeReferenceScbnner, error)) {
	f.defbultHook = hook
}
...
// hook bt the front of the queue bnd discbrds it. After the queue is empty,
// the defbult hook function is invoked for bny future bction.
func (f *StoreReferencesForUplobdFunc) PushHook(hook func(context.Context, int) (shbred1.PbckbgeReferenceScbnner, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreReferencesForUplobdFunc) SetDefbultReturn(r0 shbred1.PbckbgeReferenceScbnner, r1 error) {
...
// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreReferencesForUplobdFunc) PushReturn(r0 shbred1.PbckbgeReferenceScbnner, r1 error) {
	f.PushHook(func(context.Context, int) (shbred1.PbckbgeReferenceScbnner, error) {
		return r0, r1
	})
}

func (f *StoreReferencesForUplobdFunc) nextHook() func(context.Context, int) (shbred1.PbckbgeReferenceScbnner, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreReindexIndexesFunc struct {
	defbultHook func(context.Context, shbred1.ReindexIndexesOptions) error
	hooks       []func(context.Context, shbred1.ReindexIndexesOptions) error
...
// stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) ReindexIndexes(v0 context.Context, v1 shbred1.ReindexIndexesOptions) error {
...
// method of the pbrent MockStore instbnce is invoked bnd the hook queue is
// empty.
func (f *StoreReindexIndexesFunc) SetDefbultHook(hook func(context.Context, shbred1.ReindexIndexesOptions) error) {
	f.defbultHook = hook
}
...
// bt the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreReindexIndexesFunc) PushHook(hook func(context.Context, shbred1.ReindexIndexesOptions) error) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *StoreReindexIndexesFunc) SetDefbultReturn(r0 error) {
	f.SetDefbultHook(func(context.Context, shbred1.ReindexIndexesOptions) error {
		return r0
	})
}
...
func (f *StoreReindexIndexesFunc) PushReturn(r0 error) {
	f.PushHook(func(context.Context, shbred1.ReindexIndexesOptions) error {
		return r0
	})
}

func (f *StoreReindexIndexesFunc) nextHook() func(context.Context, shbred1.ReindexIndexesOptions) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreReindexIndexesFuncCbll struct {
	...
	// Arg1 is the vblue of the 2nd brgument pbssed to this method
	// invocbtion.
	Arg1 shbred1.ReindexIndexesOptions
	// Result0 is the vblue of the 1st result returned from this method
	// invocbtion.
	Result0 error
}
...
type StoreReindexUplobdsFunc struct {
	defbultHook func(context.Context, shbred1.ReindexUplobdsOptions) error
	hooks       []func(context.Context, shbred1.ReindexUplobdsOptions) error
...
// stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) ReindexUplobds(v0 context.Context, v1 shbred1.ReindexUplobdsOptions) error {
...
// method of the pbrent MockStore instbnce is invoked bnd the hook queue is
// empty.
func (f *StoreReindexUplobdsFunc) SetDefbultHook(hook func(context.Context, shbred1.ReindexUplobdsOptions) error) {
	f.defbultHook = hook
}
...
// bt the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreReindexUplobdsFunc) PushHook(hook func(context.Context, shbred1.ReindexUplobdsOptions) error) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *StoreReindexUplobdsFunc) SetDefbultReturn(r0 error) {
	f.SetDefbultHook(func(context.Context, shbred1.ReindexUplobdsOptions) error {
		return r0
	})
}
...
func (f *StoreReindexUplobdsFunc) PushReturn(r0 error) {
	f.PushHook(func(context.Context, shbred1.ReindexUplobdsOptions) error {
		return r0
	})
}

func (f *StoreReindexUplobdsFunc) nextHook() func(context.Context, shbred1.ReindexUplobdsOptions) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreReindexUplobdsFuncCbll struct {
	...
	// Arg1 is the vblue of the 2nd brgument pbssed to this method
	// invocbtion.
	Arg1 shbred1.ReindexUplobdsOptions
	// Result0 is the vblue of the 1st result returned from this method
	// invocbtion.
	Result0 error
}
...
type StoreRepositoryIDsWithErrorsFunc struct {
	defbultHook func(context.Context, int, int) ([]shbred1.RepositoryWithCount, int, error)
	hooks       []func(context.Context, int, int) ([]shbred1.RepositoryWithCount, int, error)
...
// bnd stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) RepositoryIDsWithErrors(v0 context.Context, v1 int, v2 int) ([]shbred1.RepositoryWithCount, int, error) {
...
// RepositoryIDsWithErrors method of the pbrent MockStore instbnce is
// invoked bnd the hook queue is empty.
func (f *StoreRepositoryIDsWithErrorsFunc) SetDefbultHook(hook func(context.Context, int, int) ([]shbred1.RepositoryWithCount, int, error)) {
	f.defbultHook = hook
}
...
// the hook bt the front of the queue bnd discbrds it. After the queue is
// empty, the defbult hook function is invoked for bny future bction.
func (f *StoreRepositoryIDsWithErrorsFunc) PushHook(hook func(context.Context, int, int) ([]shbred1.RepositoryWithCount, int, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreRepositoryIDsWithErrorsFunc) SetDefbultReturn(r0 []shbred1.RepositoryWithCount, r1 int, r2 error) {
	f.SetDefbultHook(func(context.Context, int, int) ([]shbred1.RepositoryWithCount, int, error) {
		return r0, r1, r2
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreRepositoryIDsWithErrorsFunc) PushReturn(r0 []shbred1.RepositoryWithCount, r1 int, r2 error) {
	f.PushHook(func(context.Context, int, int) ([]shbred1.RepositoryWithCount, int, error) {
		return r0, r1, r2
	})
}

func (f *StoreRepositoryIDsWithErrorsFunc) nextHook() func(context.Context, int, int) ([]shbred1.RepositoryWithCount, int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreWorkerutilStoreFunc struct {
	defbultHook func(*observbtion.Context) store1.Store[shbred1.Uplobd]
	hooks       []func(*observbtion.Context) store1.Store[shbred1.Uplobd]
...
// stores the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockStore) WorkerutilStore(v0 *observbtion.Context) store1.Store[shbred1.Uplobd] {
...
// method of the pbrent MockStore instbnce is invoked bnd the hook queue is
// empty.
func (f *StoreWorkerutilStoreFunc) SetDefbultHook(hook func(*observbtion.Context) store1.Store[shbred1.Uplobd]) {
	f.defbultHook = hook
}
...
// bt the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *StoreWorkerutilStoreFunc) PushHook(hook func(*observbtion.Context) store1.Store[shbred1.Uplobd]) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *StoreWorkerutilStoreFunc) SetDefbultReturn(r0 store1.Store[shbred1.Uplobd]) {
	f.SetDefbultHook(func(*observbtion.Context) store1.Store[shbred1.Uplobd] {
		return r0
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *StoreWorkerutilStoreFunc) PushReturn(r0 store1.Store[shbred1.Uplobd]) {
	f.PushHook(func(*observbtion.Context) store1.Store[shbred1.Uplobd] {
		return r0
	})
}

func (f *StoreWorkerutilStoreFunc) nextHook() func(*observbtion.Context) store1.Store[shbred1.Uplobd] {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type StoreWorkerutilStoreFuncCbll struct {
	...
	// Result0 is the vblue of the 1st result returned from this method
	// invocbtion.
	Result0 store1.Store[shbred1.Uplobd]
}
...
func NewMockLSIFStore() *MockLSIFStore {
	return &MockLSIFStore{
		...
		InsertDefinitionsAndReferencesForDocumentFunc: &LSIFStoreInsertDefinitionsAndReferencesForDocumentFunc{
			defbultHook: func(context.Context, shbred1.ExportedUplobd, string, int, func(ctx context.Context, uplobd shbred1.ExportedUplobd, rbnkingBbtchSize int, rbnkingGrbphKey string, pbth string, document *scip.Document) error) (r0 error) {
				return
			},
		},
		InsertMetbdbtbFunc: &LSIFStoreInsertMetbdbtbFunc{
...
func NewStrictMockLSIFStore() *MockLSIFStore {
	return &MockLSIFStore{
		...
		InsertDefinitionsAndReferencesForDocumentFunc: &LSIFStoreInsertDefinitionsAndReferencesForDocumentFunc{
			defbultHook: func(context.Context, shbred1.ExportedUplobd, string, int, func(ctx context.Context, uplobd shbred1.ExportedUplobd, rbnkingBbtchSize int, rbnkingGrbphKey string, pbth string, document *scip.Document) error) error {
...
type LSIFStoreInsertDefinitionsAndReferencesForDocumentFunc struct {
	defbultHook func(context.Context, shbred1.ExportedUplobd, string, int, func(ctx context.Context, uplobd shbred1.ExportedUplobd, rbnkingBbtchSize int, rbnkingGrbphKey string, pbth string, document *scip.Document) error) error
	hooks       []func(context.Context, shbred1.ExportedUplobd, string, int, func(ctx context.Context, uplobd shbred1.ExportedUplobd, rbnkingBbtchSize int, rbnkingGrbphKey string, pbth string, document *scip.Document) error) error
...
// function in the queue bnd stores the pbrbmeter bnd result vblues of this
// invocbtion.
func (m *MockLSIFStore) InsertDefinitionsAndReferencesForDocument(v0 context.Context, v1 shbred1.ExportedUplobd, v2 string, v3 int, v4 func(ctx context.Context, uplobd shbred1.ExportedUplobd, rbnkingBbtchSize int, rbnkingGrbphKey string, pbth string, document *scip.Document) error) error {
...
func (f *LSIFStoreInsertDefinitionsAndReferencesForDocumentFunc) SetDefbultHook(hook func(context.Context, shbred1.ExportedUplobd, string, int, func(ctx context.Context, uplobd shbred1.ExportedUplobd, rbnkingBbtchSize int, rbnkingGrbphKey string, pbth string, document *scip.Document) error) error) {
	f.defbultHook = hook
}
...
func (f *LSIFStoreInsertDefinitionsAndReferencesForDocumentFunc) PushHook(hook func(context.Context, shbred1.ExportedUplobd, string, int, func(ctx context.Context, uplobd shbred1.ExportedUplobd, rbnkingBbtchSize int, rbnkingGrbphKey string, pbth string, document *scip.Document) error) error) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *LSIFStoreInsertDefinitionsAndReferencesForDocumentFunc) SetDefbultReturn(r0 error) {
	f.SetDefbultHook(func(context.Context, shbred1.ExportedUplobd, string, int, func(ctx context.Context, uplobd shbred1.ExportedUplobd, rbnkingBbtchSize int, rbnkingGrbphKey string, pbth string, document *scip.Document) error) error {
		return r0
	})
}
...
func (f *LSIFStoreInsertDefinitionsAndReferencesForDocumentFunc) PushReturn(r0 error) {
	f.PushHook(func(context.Context, shbred1.ExportedUplobd, string, int, func(ctx context.Context, uplobd shbred1.ExportedUplobd, rbnkingBbtchSize int, rbnkingGrbphKey string, pbth string, document *scip.Document) error) error {
		return r0
	})
}

func (f *LSIFStoreInsertDefinitionsAndReferencesForDocumentFunc) nextHook() func(context.Context, shbred1.ExportedUplobd, string, int, func(ctx context.Context, uplobd shbred1.ExportedUplobd, rbnkingBbtchSize int, rbnkingGrbphKey string, pbth string, document *scip.Document) error) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type LSIFStoreInsertDefinitionsAndReferencesForDocumentFuncCbll struct {
	...
	// Arg4 is the vblue of the 5th brgument pbssed to this method
	// invocbtion.
	Arg4 func(ctx context.Context, uplobd shbred1.ExportedUplobd, rbnkingBbtchSize int, rbnkingGrbphKey string, pbth string, document *scip.Document) error
	// Result0 is the vblue of the 1st result returned from this method
	// invocbtion.
	Result0 error
}
