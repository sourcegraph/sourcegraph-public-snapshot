...
// stores the parameter and result values of this invocation.
func (m *MockStore) GetAutoIndexJobs(v0 context.Context, v1 shared1.GetIndexesOptions) ([]shared1.AutoIndexJob, int, error) {
...
// method of the parent MockStore instance is invoked and the hook queue is
// empty.
func (f *StoreGetAutoIndexJobsFunc) SetDefaultHook(hook func(context.Context, shared1.GetIndexesOptions) ([]shared1.AutoIndexJob, int, error)) {
	f.defaultHook = hook
}
...
// at the front of the queue and discards it. After the queue is empty, the
// default hook function is invoked for any future action.
func (f *StoreGetAutoIndexJobsFunc) PushHook(hook func(context.Context, shared1.GetIndexesOptions) ([]shared1.AutoIndexJob, int, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *StoreGetAutoIndexJobsFunc) nextHook() func(context.Context, shared1.GetIndexesOptions) ([]shared1.AutoIndexJob, int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
