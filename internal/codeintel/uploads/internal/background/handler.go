...
func (b *backgroundJob) WorkerutilHandler(uploadStore uploadstore.Store, numProcessorRoutines int, budgetMax int64) workerutil.Handler {
	return &handler{
		// dbStore:           s.store,
		// repoStore:         s.repoStore,
		// workerStore:       s.workerutilStore,
		// lsifStore:         b.uploadSvc.GetLsifStore(),
