...
func (h *handler) HandleRawUpload(ctx context.Context, logger log.Logger, upload uploadsshared.Upload, uploadStore kv.Store, trace observation.TraceLogger) (requeued bool, err error) {
...
func withUploadData(ctx context.Context, logger log.Logger, uploadStore kv.Store, uploadStats uploadsshared.UploadSizeStats, trace observation.TraceLogger, fn func(r gzipReadSeeker) error) error {
