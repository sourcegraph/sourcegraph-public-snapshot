...
-- source: internal/codeintel/stores/lsifstore/migration/apidocs_search.go:Progress
...
-- source: internal/codeintel/stores/lsifstore/migration/apidocs_search.go:Up
