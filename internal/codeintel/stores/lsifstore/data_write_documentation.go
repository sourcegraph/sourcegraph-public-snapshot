...
import (
	...
	"github.com/sourcegraph/sourcegraph/internal/codeintel/stores/lsifstore/apidocs"
...
-- source: internal/codeintel/stores/lsifstore/data_write_documentation.go:WriteDocumentationPages
...
-- source: internal/codeintel/stores/lsifstore/data_write_documentation.go:WriteDocumentationPathInfo
...
-- source: internal/codeintel/stores/lsifstore/data_write_documentation.go:WriteDocumentationMappings
...
-- source: internal/codeintel/stores/lsifstore/data_write_documentation.go:upsertRepositoryName
WITH inserted AS (
...
-- source: internal/codeintel/stores/lsifstore/data_write_documentation.go:upsertLanguageName
WITH inserted AS (
...
-- source: internal/codeintel/stores/lsifstore/data_write_documentation.go:upsertTags
...
-- source: internal/codeintel/stores/lsifstore/data_write_documentation.go:insertSearchRecords
...
-- source: internal/codeintel/stores/lsifstore/data_write_documentation.go:truncateDocumentationSearchIndexSize
