...
-- source: internal/codeintel/stores/dbstore/migration/committed_at.go:Progress
...
-- source: internal/codeintel/stores/dbstore/migration/committed_at.go:Up
...
-- source: internal/codeintel/stores/dbstore/migration/committed_at.go:handleCommit
...
-- source: internal/codeintel/stores/dbstore/migration/committed_at.go:Down
