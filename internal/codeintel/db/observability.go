...
func (db *ObservedDB) GetUploadByID(ctx context.Context, id int) (_ Upload, _ bool, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.GetUploadByID, "DB.GetUploadByID", "db.get-upload-by-id")
	defer endTrace(1)
...
func (db *ObservedDB) GetUploadsByRepo(ctx context.Context, repositoryID int, state, term string, visibleAtTip bool, limit, offset int) (uploads []Upload, _ int, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.GetUploadsByRepo, "DB.GetUploadsByRepo", "db.get-uploads-by-repo")
	defer func() {
		endTrace(float64(len(uploads)))
	}()
...
func (db *ObservedDB) Enqueue(ctx context.Context, commit, root, tracingContext string, repositoryID int, indexerName string) (_ int, _ TxCloser, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.Enqueue, "DB.Enqueue", "db.enqueue")
	defer endTrace(1)
...
func (db *ObservedDB) Dequeue(ctx context.Context) (_ Upload, _ JobHandle, _ bool, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.Dequeue, "DB.Dequeue", "db.dequeue")
	defer endTrace(1)
...
func (db *ObservedDB) GetStates(ctx context.Context, ids []int) (states map[int]string, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.GetStates, "DB.GetStates", "db.get-states")
	defer func() {
		endTrace(float64(len(states)))
	}()
...
func (db *ObservedDB) DeleteUploadByID(ctx context.Context, id int, getTipCommit func(repositoryID int) (string, error)) (_ bool, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.DeleteUploadByID, "DB.DeleteUploadByID", "db.delete-upload-by-id")
	defer endTrace(1)
...
func (db *ObservedDB) ResetStalled(ctx context.Context, now time.Time) (ids []int, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.ResetStalled, "DB.ResetStalled", "db.reset-stalled")
	defer func() {
		endTrace(float64(len(ids)))
	}()
...
func (db *ObservedDB) GetDumpByID(ctx context.Context, id int) (_ Dump, _ bool, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.GetDumpByID, "DB.GetDumpByID", "db.get-dump-by-id")
	defer endTrace(1)
...
func (db *ObservedDB) FindClosestDumps(ctx context.Context, repositoryID int, commit, file string) (dumps []Dump, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.FindClosestDumps, "DB.FindClosestDumps", "db.find-closest-dumps")
	defer func() {
...
func (db *ObservedDB) DeleteOldestDump(ctx context.Context) (_ int, _ bool, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.DeleteOldestDump, "DB.DeleteOldestDump", "db.delete-oldest-dump")
	defer endTrace(1)
...
func (db *ObservedDB) UpdateDumpsVisibleFromTip(ctx context.Context, tx *sql.Tx, repositoryID int, tipCommit string) (err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.UpdateDumpsVisibleFromTip, "DB.UpdateDumpsVisibleFromTip", "db.update-dumps-visible-from-tip")
	defer endTrace(1)
...
func (db *ObservedDB) DeleteOverlappingDumps(ctx context.Context, tx *sql.Tx, repositoryID int, commit, root, indexer string) (err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.DeleteOverlappingDumps, "DB.DeleteOverlappingDumps", "db.delete-overlapping-dumps")
	defer endTrace(1)
...
func (db *ObservedDB) GetPackage(ctx context.Context, scheme, name, version string) (_ Dump, _ bool, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.GetPackage, "DB.GetPackage", "db.get-package")
	defer endTrace(1)
...
func (db *ObservedDB) UpdatePackages(ctx context.Context, tx *sql.Tx, packages []types.Package) (err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.UpdatePackages, "DB.UpdatePackages", "db.update-packages")
	defer endTrace(1)
...
func (db *ObservedDB) SameRepoPager(ctx context.Context, repositoryID int, commit, scheme, name, version string, limit int) (_ int, _ ReferencePager, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.SameRepoPager, "DB.SameRepoPager", "db.same-repo-pager")
	defer endTrace(1)
...
func (db *ObservedDB) UpdatePackageReferences(ctx context.Context, tx *sql.Tx, packageReferences []types.PackageReference) (err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.UpdatePackageReferences, "DB.UpdatePackageReferences", "db.update-package-references")
	defer endTrace(1)
...
func (db *ObservedDB) PackageReferencePager(ctx context.Context, scheme, name, version string, repositoryID, limit int) (_ int, _ ReferencePager, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.PackageReferencePager, "DB.PackageReferencePager", "db.pacakge-reference-pager")
	defer endTrace(1)
...
func (db *ObservedDB) UpdateCommits(ctx context.Context, tx *sql.Tx, repositoryID int, commits map[string][]string) (err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.UpdateCommits, "DB.UpdateCommits", "db.update-commits")
	defer endTrace(1)
...
func (db *ObservedDB) RepoName(ctx context.Context, repositoryID int) (_ string, err error) {
	ctx, endTrace := db.prepTrace(ctx, &err, db.metrics.RepoName, "DB.RepoName", "db.repo-name")
	defer endTrace(1)

	return db.db.RepoName(ctx, repositoryID)
}

func (db *ObservedDB) prepTrace(
	ctx context.Context,
	err *error,
	...
	return observability.PrepTrace(ctx, db.logger, metrics, db.tracer, err, traceName, logName, preFields...)
}
