...
func NewMockInferenceService() *MockInferenceService {
	return &MockInferenceService{
		InferIndexJobsFunc: &InferenceServiceInferIndexJobsFunc{
			defaultHook: func(context.Context, api.RepoID, string, string) (r0 *shared.InferenceResult, r1 error) {
				return
			},
		},
	}
...
func NewStrictMockInferenceService() *MockInferenceService {
	return &MockInferenceService{
		InferIndexJobsFunc: &InferenceServiceInferIndexJobsFunc{
			defaultHook: func(context.Context, api.RepoID, string, string) (*shared.InferenceResult, error) {
...
type InferenceServiceInferIndexJobsFunc struct {
	defaultHook func(context.Context, api.RepoID, string, string) (*shared.InferenceResult, error)
	hooks       []func(context.Context, api.RepoID, string, string) (*shared.InferenceResult, error)
...
// stores the parameter and result values of this invocation.
func (m *MockInferenceService) InferIndexJobs(v0 context.Context, v1 api.RepoID, v2 string, v3 string) (*shared.InferenceResult, error) {
...
// hook queue is empty.
func (f *InferenceServiceInferIndexJobsFunc) SetDefaultHook(hook func(context.Context, api.RepoID, string, string) (*shared.InferenceResult, error)) {
	f.defaultHook = hook
}
...
// the hook at the front of the queue and discards it. After the queue is
// empty, the default hook function is invoked for any future action.
func (f *InferenceServiceInferIndexJobsFunc) PushHook(hook func(context.Context, api.RepoID, string, string) (*shared.InferenceResult, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *InferenceServiceInferIndexJobsFunc) SetDefaultReturn(r0 *shared.InferenceResult, r1 error) {
	f.SetDefaultHook(func(context.Context, api.RepoID, string, string) (*shared.InferenceResult, error) {
		return r0, r1
	})
}
...
func (f *InferenceServiceInferIndexJobsFunc) PushReturn(r0 *shared.InferenceResult, r1 error) {
	f.PushHook(func(context.Context, api.RepoID, string, string) (*shared.InferenceResult, error) {
		return r0, r1
	})
}

func (f *InferenceServiceInferIndexJobsFunc) nextHook() func(context.Context, api.RepoID, string, string) (*shared.InferenceResult, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
