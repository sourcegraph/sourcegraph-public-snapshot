...
func TestQueueIndexesExplicit(t *testing.T) {
	...
	scheduler := newService(mockDBStore, mockUploadSvc, nil, nil, nil, nil, nil, nil, nil, mockGitserverClient, nil, nil, inferenceService, &observation.TestContext)
...
func TestQueueIndexesForPackage(t *testing.T) {
	...
	scheduler := newService(mockDBStore, mockUploadSvc, nil, nil, nil, nil, nil, nil, nil, mockGitserverClient, nil, mockRepoUpdater, inferenceService, &observation.TestContext)
