...
func (c *config) Load() {
	...
	c.RepositoryMinimumCheckInterval = c.GetInterval("CODEINTEL_DEPENDENCIES_INDEXER_REPOSITORY_MINIMUM_CHECK_INTERVAL", "10m", "How frequently to re-index the same repository.")
