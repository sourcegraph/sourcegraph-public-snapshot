...
func TestParseYarnLockFile(t *testing.T) {
	yarnLockFile := `# THIS IS AN AUTOGENERATED FILE. DO NOT EDIT THIS FILE DIRECTLY.
# yarn lockfile v1
...
gradient-string@^2.0.1:
  version "2.0.1"
  resolved "https://registry.yarnpkg.com/gradient-string/-/gradient-string-2.0.1.tgz#ea21740ce8fc0beaac16888ee60f6732985b4c83"
  integrity sha512-+xDOYR2fMa4QHGysTgyQsl8g16mcAKqvvsKI014qYP2XVf1SWUPlD8KhdBJPUM8AVwDUB+ls0NFkqRzAB5URkA==
  dependencies:
    chalk "^4.1.2"
    tinygradient "^1.1.5"
...
`
	...
	want := []byte(`@types/tinycolor2 1.4.3
ansi-styles 4.3.0
chalk 4.1.2
color-convert 2.0.1
color-name 1.1.4
