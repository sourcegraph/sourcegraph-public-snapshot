...
func NewMockCodeNavService() *MockCodeNavService {
	return &MockCodeNavService{
		...
		SyntacticUsagesFunc: &CodeNavServiceSyntacticUsagesFunc{
			defaultHook: func(context.Context, string, scip.Range, types.Repo, api.CommitID) (r0 []struct{}, r1 error) {
				return
			},
		},
		VisibleUploadsForPathFunc: &CodeNavServiceVisibleUploadsForPathFunc{
...
func NewStrictMockCodeNavService() *MockCodeNavService {
	return &MockCodeNavService{
		...
		SyntacticUsagesFunc: &CodeNavServiceSyntacticUsagesFunc{
			defaultHook: func(context.Context, string, scip.Range, types.Repo, api.CommitID) ([]struct{}, error) {
...
type CodeNavServiceSyntacticUsagesFunc struct {
	defaultHook func(context.Context, string, scip.Range, types.Repo, api.CommitID) ([]struct{}, error)
	hooks       []func(context.Context, string, scip.Range, types.Repo, api.CommitID) ([]struct{}, error)
...
// stores the parameter and result values of this invocation.
func (m *MockCodeNavService) SyntacticUsages(v0 context.Context, v1 string, v2 scip.Range, v3 types.Repo, v4 api.CommitID) ([]struct{}, error) {
...
// method of the parent MockCodeNavService instance is invoked and the hook
// queue is empty.
func (f *CodeNavServiceSyntacticUsagesFunc) SetDefaultHook(hook func(context.Context, string, scip.Range, types.Repo, api.CommitID) ([]struct{}, error)) {
	f.defaultHook = hook
}
...
// the hook at the front of the queue and discards it. After the queue is
// empty, the default hook function is invoked for any future action.
func (f *CodeNavServiceSyntacticUsagesFunc) PushHook(hook func(context.Context, string, scip.Range, types.Repo, api.CommitID) ([]struct{}, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *CodeNavServiceSyntacticUsagesFunc) SetDefaultReturn(r0 []struct{}, r1 error) {
	f.SetDefaultHook(func(context.Context, string, scip.Range, types.Repo, api.CommitID) ([]struct{}, error) {
		return r0, r1
	})
}

// PushReturn calls PushHook with a function that returns the given values.
func (f *CodeNavServiceSyntacticUsagesFunc) PushReturn(r0 []struct{}, r1 error) {
	f.PushHook(func(context.Context, string, scip.Range, types.Repo, api.CommitID) ([]struct{}, error) {
		return r0, r1
	})
}

func (f *CodeNavServiceSyntacticUsagesFunc) nextHook() func(context.Context, string, scip.Range, types.Repo, api.CommitID) ([]struct{}, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
