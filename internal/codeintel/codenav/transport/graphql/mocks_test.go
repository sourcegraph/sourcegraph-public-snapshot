...
func NewMockCodeNavService() *MockCodeNavService {
	return &MockCodeNavService{
		...
		SyntacticUsagesFunc: &CodeNavServiceSyntacticUsagesFunc{
			defaultHook: func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs) (r0 codenav.SyntacticUsagesResult, r1 core.Option[codenav.PreviousSyntacticSearch], r2 *codenav.SyntacticUsagesError) {
				return
			},
		},
		VisibleUploadsForPathFunc: &CodeNavServiceVisibleUploadsForPathFunc{
...
func NewStrictMockCodeNavService() *MockCodeNavService {
	return &MockCodeNavService{
		...
		SyntacticUsagesFunc: &CodeNavServiceSyntacticUsagesFunc{
			defaultHook: func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs) (codenav.SyntacticUsagesResult, core.Option[codenav.PreviousSyntacticSearch], *codenav.SyntacticUsagesError) {
...
func (m *MockCodeNavService) GetDefinitions(v0 context.Context, v1 codenav.PositionalRequestArgs, v2 codenav.RequestState, v3 codenav.Cursor) ([]shared1.UploadLocation, codenav.Cursor, error) {
...
// queue is empty.
func (f *CodeNavServiceGetDefinitionsFunc) SetDefaultHook(hook func(context.Context, codenav.PositionalRequestArgs, codenav.RequestState, codenav.Cursor) ([]shared1.UploadLocation, codenav.Cursor, error)) {
	f.defaultHook = hook
}
...
func (f *CodeNavServiceGetDefinitionsFunc) PushHook(hook func(context.Context, codenav.PositionalRequestArgs, codenav.RequestState, codenav.Cursor) ([]shared1.UploadLocation, codenav.Cursor, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *CodeNavServiceGetDefinitionsFunc) SetDefaultReturn(r0 []shared1.UploadLocation, r1 codenav.Cursor, r2 error) {
...
// PushReturn calls PushHook with a function that returns the given values.
func (f *CodeNavServiceGetDefinitionsFunc) PushReturn(r0 []shared1.UploadLocation, r1 codenav.Cursor, r2 error) {
...
func (f *CodeNavServiceGetDefinitionsFunc) nextHook() func(context.Context, codenav.PositionalRequestArgs, codenav.RequestState, codenav.Cursor) ([]shared1.UploadLocation, codenav.Cursor, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type CodeNavServiceSyntacticUsagesFunc struct {
	defaultHook func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs) (codenav.SyntacticUsagesResult, core.Option[codenav.PreviousSyntacticSearch], *codenav.SyntacticUsagesError)
	hooks       []func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs) (codenav.SyntacticUsagesResult, core.Option[codenav.PreviousSyntacticSearch], *codenav.SyntacticUsagesError)
...
// stores the parameter and result values of this invocation.
func (m *MockCodeNavService) SyntacticUsages(v0 context.Context, v1 codenav.GitTreeTranslator, v2 codenav.UsagesForSymbolArgs) (codenav.SyntacticUsagesResult, core.Option[codenav.PreviousSyntacticSearch], *codenav.SyntacticUsagesError) {
...
// method of the parent MockCodeNavService instance is invoked and the hook
// queue is empty.
func (f *CodeNavServiceSyntacticUsagesFunc) SetDefaultHook(hook func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs) (codenav.SyntacticUsagesResult, core.Option[codenav.PreviousSyntacticSearch], *codenav.SyntacticUsagesError)) {
	f.defaultHook = hook
}
...
// the hook at the front of the queue and discards it. After the queue is
// empty, the default hook function is invoked for any future action.
func (f *CodeNavServiceSyntacticUsagesFunc) PushHook(hook func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs) (codenav.SyntacticUsagesResult, core.Option[codenav.PreviousSyntacticSearch], *codenav.SyntacticUsagesError)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *CodeNavServiceSyntacticUsagesFunc) SetDefaultReturn(r0 codenav.SyntacticUsagesResult, r1 core.Option[codenav.PreviousSyntacticSearch], r2 *codenav.SyntacticUsagesError) {
	f.SetDefaultHook(func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs) (codenav.SyntacticUsagesResult, core.Option[codenav.PreviousSyntacticSearch], *codenav.SyntacticUsagesError) {
		return r0, r1, r2
	})
}

// PushReturn calls PushHook with a function that returns the given values.
func (f *CodeNavServiceSyntacticUsagesFunc) PushReturn(r0 codenav.SyntacticUsagesResult, r1 core.Option[codenav.PreviousSyntacticSearch], r2 *codenav.SyntacticUsagesError) {
	f.PushHook(func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs) (codenav.SyntacticUsagesResult, core.Option[codenav.PreviousSyntacticSearch], *codenav.SyntacticUsagesError) {
		return r0, r1, r2
	})
}

func (f *CodeNavServiceSyntacticUsagesFunc) nextHook() func(context.Context, codenav.GitTreeTranslator, codenav.UsagesForSymbolArgs) (codenav.SyntacticUsagesResult, core.Option[codenav.PreviousSyntacticSearch], *codenav.SyntacticUsagesError) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type CodeNavServiceSyntacticUsagesFuncCall struct {
	...
	// Result1 is the value of the 2nd result returned from this method
	// invocation.
	Result1 core.Option[codenav.PreviousSyntacticSearch]
	// Result2 is the value of the 3rd result returned from this method
	// invocation.
