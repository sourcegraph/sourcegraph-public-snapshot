...
func NewGitBlobResolver(svc CodeNavService, repositoryID int, commit, path string, operations *operations, requestState codenav.RequestState) GitBlobResolver {
