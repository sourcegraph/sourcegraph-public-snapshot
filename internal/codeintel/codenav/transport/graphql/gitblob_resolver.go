...
// GitBlobLSIFDataResolverOLD is the main interface to bundle-related operations exposed to the GraphQL API. This
...
type GitBlobLSIFDataResolverOLD interface {
...
func NewGitBlobLSIFDataResolverOLD(svc Service, repositoryID int, commit, path string, operations *operations, requestState codenav.RequestState) GitBlobLSIFDataResolverOLD {
...
func (r *gitBlobLSIFDataResolver) Definitions(ctx context.Context, line, character int) (_ []types.UploadLocation, err error) {
...
func (r *gitBlobLSIFDataResolver) Hover(ctx context.Context, line, character int) (_ string, _ types.Range, _ bool, err error) {
	args := shared.RequestArgs{RepositoryID: r.repositoryID, Commit: r.commit, Path: r.path, Line: line, Character: character}
...
func (r *gitBlobLSIFDataResolver) Implementations(ctx context.Context, line, character int, limit int, rawCursor string) (_ []types.UploadLocation, nextCursor string, err error) {
...
func (r *gitBlobLSIFDataResolver) LSIFUploads(ctx context.Context) (uploads []types.Dump, err error) {
...
func (r *gitBlobLSIFDataResolver) References(ctx context.Context, line, character, limit int, rawCursor string) (_ []types.UploadLocation, nextCursor string, err error) {
	args := shared.RequestArgs{RepositoryID: r.repositoryID, Commit: r.commit, Path: r.path, Line: line, Character: character, Limit: limit, RawCursor: rawCursor}
...
func (r *gitBlobLSIFDataResolver) Stencil(ctx context.Context) (adjustedRanges []types.Range, err error) {
	args := shared.RequestArgs{RepositoryID: r.repositoryID, Commit: r.commit, Path: r.path}
