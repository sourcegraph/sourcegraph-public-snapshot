...
// github.com/sourcegraph/sourcegraph/internal/codeintel/symbols/transport/graphql)
...
// stores the parameter and result values of this invocation.
func (m *MockService) GetImplementations(v0 context.Context, v1 int, v2 string, v3 int, v4 int, v5 int, v6 int) ([]shared.Location, int, error) {
	r0, r1, r2 := m.GetImplementationsFunc.nextHook()(v0, v1, v2, v3, v4, v5, v6)
	m.GetImplementationsFunc.appendCall(ServiceGetImplementationsFuncCall{v0, v1, v2, v3, v4, v5, v6, r0, r1, r2})
	return r0, r1, r2
}
...
// method of the parent MockService instance is invoked and the hook queue
// is empty.
func (f *ServiceGetImplementationsFunc) SetDefaultHook(hook func(context.Context, int, string, int, int, int, int) ([]shared.Location, int, error)) {
	f.defaultHook = hook
}
...
func (f *ServiceGetImplementationsFunc) PushHook(hook func(context.Context, int, string, int, int, int, int) ([]shared.Location, int, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *ServiceGetImplementationsFunc) SetDefaultReturn(r0 []shared.Location, r1 int, r2 error) {
	f.SetDefaultHook(func(context.Context, int, string, int, int, int, int) ([]shared.Location, int, error) {
		return r0, r1, r2
	})
}
...
// PushReturn calls PushHook with a function that returns the given values.
func (f *ServiceGetImplementationsFunc) PushReturn(r0 []shared.Location, r1 int, r2 error) {
	f.PushHook(func(context.Context, int, string, int, int, int, int) ([]shared.Location, int, error) {
		return r0, r1, r2
	})
}

func (f *ServiceGetImplementationsFunc) nextHook() func(context.Context, int, string, int, int, int, int) ([]shared.Location, int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// the parameter and result values of this invocation.
func (m *MockService) GetReferences(v0 context.Context, v1 int, v2 string, v3 int, v4 int, v5 int, v6 int) ([]shared.Location, int, error) {
	r0, r1, r2 := m.GetReferencesFunc.nextHook()(v0, v1, v2, v3, v4, v5, v6)
	m.GetReferencesFunc.appendCall(ServiceGetReferencesFuncCall{v0, v1, v2, v3, v4, v5, v6, r0, r1, r2})
	return r0, r1, r2
}
...
// of the parent MockService instance is invoked and the hook queue is
// empty.
func (f *ServiceGetReferencesFunc) SetDefaultHook(hook func(context.Context, int, string, int, int, int, int) ([]shared.Location, int, error)) {
	f.defaultHook = hook
}
...
// at the front of the queue and discards it. After the queue is empty, the
// default hook function is invoked for any future action.
func (f *ServiceGetReferencesFunc) PushHook(hook func(context.Context, int, string, int, int, int, int) ([]shared.Location, int, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *ServiceGetReferencesFunc) SetDefaultReturn(r0 []shared.Location, r1 int, r2 error) {
	f.SetDefaultHook(func(context.Context, int, string, int, int, int, int) ([]shared.Location, int, error) {
		return r0, r1, r2
	})
}
...
// PushReturn calls PushHook with a function that returns the given values.
func (f *ServiceGetReferencesFunc) PushReturn(r0 []shared.Location, r1 int, r2 error) {
	f.PushHook(func(context.Context, int, string, int, int, int, int) ([]shared.Location, int, error) {
		return r0, r1, r2
	})
}

func (f *ServiceGetReferencesFunc) nextHook() func(context.Context, int, string, int, int, int, int) ([]shared.Location, int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
