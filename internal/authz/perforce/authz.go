...
func newAuthzProvider(urn string, a *schema.PerforceAuthorization, host, user, password string) (authz.Provider, error) {
	if a == nil {
		return nil, nil
	}
...
// ValidateGitHubAuthz validates the authorization fields of the given Perforce
