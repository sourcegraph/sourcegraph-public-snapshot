...
func (p *SudoProvider) FetchUserPerms(ctx context.Context, account *extsvc.Account, opts *authz.FetchPermOptions) (*authz.ExternalUserPermissions, error) {
	if account == nil {
...
// token.
func (p *SudoProvider) FetchUserPermsByToken(ctx context.Context, token string, opts *authz.FetchPermOptions) (*authz.ExternalUserPermissions, error) {
