...
// BeforeCreateExternalServiceHook enforces any per-tier validations prior to
// creating a new external service.
func BeforeCreateExternalServiceHook(ctx context.Context, es *types.ExternalService) error {
