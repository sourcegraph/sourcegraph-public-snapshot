...
type MockErrorHandler struct {
	// HandleFunc is an instance of a mock function object controlling the
	// behavior of the method Handle.
	HandleFunc *ErrorHandlerHandleFunc
	// HandleErrorFunc is an instance of a mock function object controlling
	// the behavior of the method HandleError.
	HandleErrorFunc *ErrorHandlerHandleErrorFunc
}
...
func NewStrictMockErrorHandler() *MockErrorHandler {
	return &MockErrorHandler{
		HandleFunc: &ErrorHandlerHandleFunc{
			defaultHook: func(context.Context) error {
				panic("unexpected invocation of MockErrorHandler.Handle")
			},
		},
		HandleErrorFunc: &ErrorHandlerHandleErrorFunc{
			defaultHook: func(error) {
...
// surrogateMockErrorHandler is a copy of the errorHandler interface (from
// the package github.com/sourcegraph/sourcegraph/internal/goroutine). It is
// redefined here as it is unexported in the source package.
type surrogateMockErrorHandler interface {
...
// interface. All methods delegate to the given implementation, unless
// overwritten.
func NewMockErrorHandlerFrom(i surrogateMockErrorHandler) *MockErrorHandler {
	return &MockErrorHandler{
		HandleFunc: &ErrorHandlerHandleFunc{
			defaultHook: i.Handle,
		},
...
// ErrorHandlerHandleFunc describes the behavior when the Handle method of
// the parent MockErrorHandler instance is invoked.
type ErrorHandlerHandleFunc struct {
	defaultHook func(context.Context) error
	hooks       []func(context.Context) error
	history     []ErrorHandlerHandleFuncCall
	mutex       sync.Mutex
}

// Handle delegates to the next hook function in the queue and stores the
// parameter and result values of this invocation.
func (m *MockErrorHandler) Handle(v0 context.Context) error {
	r0 := m.HandleFunc.nextHook()(v0)
	m.HandleFunc.appendCall(ErrorHandlerHandleFuncCall{v0, r0})
	return r0
}

// SetDefaultHook sets function that is called when the Handle method of the
// parent MockErrorHandler instance is invoked and the hook queue is empty.
func (f *ErrorHandlerHandleFunc) SetDefaultHook(hook func(context.Context) error) {
	f.defaultHook = hook
}

// PushHook adds a function to the end of hook queue. Each invocation of the
// Handle method of the parent MockErrorHandler instance invokes the hook at
// the front of the queue and discards it. After the queue is empty, the
// default hook function is invoked for any future action.
func (f *ErrorHandlerHandleFunc) PushHook(hook func(context.Context) error) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *ErrorHandlerHandleFunc) SetDefaultReturn(r0 error) {
	f.SetDefaultHook(func(context.Context) error {
		return r0
	})
}
...
// PushReturn calls PushHook with a function that returns the given values.
func (f *ErrorHandlerHandleFunc) PushReturn(r0 error) {
	f.PushHook(func(context.Context) error {
		return r0
	})
}

func (f *ErrorHandlerHandleFunc) nextHook() func(context.Context) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
func (f *ErrorHandlerHandleFunc) appendCall(r0 ErrorHandlerHandleFuncCall) {
	f.mutex.Lock()
	f.history = append(f.history, r0)
	f.mutex.Unlock()
}

// History returns a sequence of ErrorHandlerHandleFuncCall objects
// describing the invocations of this function.
func (f *ErrorHandlerHandleFunc) History() []ErrorHandlerHandleFuncCall {
	f.mutex.Lock()
	history := make([]ErrorHandlerHandleFuncCall, len(f.history))
	copy(history, f.history)
	f.mutex.Unlock()
...
// ErrorHandlerHandleFuncCall is an object that describes an invocation of
// method Handle on an instance of MockErrorHandler.
type ErrorHandlerHandleFuncCall struct {
	// Arg0 is the value of the 1st argument passed to this method
	// invocation.
	Arg0 context.Context
	// Result0 is the value of the 1st result returned from this method
...
// Args returns an interface slice containing the arguments of this
// invocation.
func (c ErrorHandlerHandleFuncCall) Args() []interface{} {
	return []interface{}{c.Arg0}
}

// Results returns an interface slice containing the results of this
// invocation.
func (c ErrorHandlerHandleFuncCall) Results() []interface{} {
	return []interface{}{c.Result0}
}
