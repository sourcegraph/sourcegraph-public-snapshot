...
// invocation.
func (m *MockStore) DequeueWithIndependentTransactionContext(v0 context.Context, v1 []*sqlf.Query) (Record, Store, bool, error) {
...
func (f *StoreDequeueWithIndependentTransactionContextFunc) SetDefaultHook(hook func(context.Context, []*sqlf.Query) (Record, Store, bool, error)) {
	f.defaultHook = hook
}
...
// future action.
func (f *StoreDequeueWithIndependentTransactionContextFunc) PushHook(hook func(context.Context, []*sqlf.Query) (Record, Store, bool, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultDefaultHook with a function that returns
// the given values.
func (f *StoreDequeueWithIndependentTransactionContextFunc) SetDefaultReturn(r0 Record, r1 Store, r2 bool, r3 error) {
	f.SetDefaultHook(func(context.Context, []*sqlf.Query) (Record, Store, bool, error) {
		return r0, r1, r2, r3
	})
}
...
// PushReturn calls PushDefaultHook with a function that returns the given
// values.
func (f *StoreDequeueWithIndependentTransactionContextFunc) PushReturn(r0 Record, r1 Store, r2 bool, r3 error) {
	f.PushHook(func(context.Context, []*sqlf.Query) (Record, Store, bool, error) {
		return r0, r1, r2, r3
	})
}

func (f *StoreDequeueWithIndependentTransactionContextFunc) nextHook() func(context.Context, []*sqlf.Query) (Record, Store, bool, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
