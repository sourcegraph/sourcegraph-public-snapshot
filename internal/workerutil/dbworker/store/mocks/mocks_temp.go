...
type MockStore struct {
	...
	ProcessingJobsFunc *StoreProcessingJobsFunc
	...
	return &MockStore{
		...
		ProcessingJobsFunc: &StoreProcessingJobsFunc{
			defaultHook: func(context.Context, store.ProcessingJobsOptions) ([]workerutil.Record, int64, error) {
				panic("unexpected invocation of MockStore.ProcessingJobs")
			},
		},
		QueuedCountFunc: &StoreQueuedCountFunc{
...
func (m *MockStore) CanceledJobs(v0 context.Context, v1 []int, v2 store.CanceledJobsOptions) ([]int, error) {
	r0, r1 := m.CanceledJobsFunc.nextHook()(v0, v1, v2)
	m.CanceledJobsFunc.appendCall(StoreCanceledJobsFuncCall{v0, v1, v2, r0, r1})
	return r0, r1
}

// SetDefaultHook sets function that is called when the CanceledJobs method
// of the parent MockStore instance is invoked and the hook queue is empty.
func (f *StoreCanceledJobsFunc) SetDefaultHook(hook func(context.Context, []int, store.CanceledJobsOptions) ([]int, error)) {
	f.defaultHook = hook
}
...
func (f *StoreCanceledJobsFunc) PushHook(hook func(context.Context, []int, store.CanceledJobsOptions) ([]int, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *StoreCanceledJobsFunc) nextHook() func(context.Context, []int, store.CanceledJobsOptions) ([]int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
// StoreProcessingJobsFunc describes the behavior when the ProcessingJobs
// method of the parent MockStore instance is invoked.
type StoreProcessingJobsFunc struct {
	defaultHook func(context.Context, store.ProcessingJobsOptions) ([]workerutil.Record, int64, error)
	hooks       []func(context.Context, store.ProcessingJobsOptions) ([]workerutil.Record, int64, error)
	history     []StoreProcessingJobsFuncCall
	mutex       sync.Mutex
}

// ProcessingJobs delegates to the next hook function in the queue and
// stores the parameter and result values of this invocation.
func (m *MockStore) ProcessingJobs(v0 context.Context, v1 store.ProcessingJobsOptions) ([]workerutil.Record, int64, error) {
	r0, r1, r2 := m.ProcessingJobsFunc.nextHook()(v0, v1)
	m.ProcessingJobsFunc.appendCall(StoreProcessingJobsFuncCall{v0, v1, r0, r1, r2})
	return r0, r1, r2
}
...
// method of the parent MockStore instance is invoked and the hook queue is
// empty.
func (f *StoreProcessingJobsFunc) SetDefaultHook(hook func(context.Context, store.ProcessingJobsOptions) ([]workerutil.Record, int64, error)) {
	f.defaultHook = hook
}

// PushHook adds a function to the end of hook queue. Each invocation of the
// ProcessingJobs method of the parent MockStore instance invokes the hook
// at the front of the queue and discards it. After the queue is empty, the
// default hook function is invoked for any future action.
func (f *StoreProcessingJobsFunc) PushHook(hook func(context.Context, store.ProcessingJobsOptions) ([]workerutil.Record, int64, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultHook with a function that returns the
// given values.
func (f *StoreProcessingJobsFunc) SetDefaultReturn(r0 []workerutil.Record, r1 int64, r2 error) {
...
// PushReturn calls PushHook with a function that returns the given values.
func (f *StoreProcessingJobsFunc) PushReturn(r0 []workerutil.Record, r1 int64, r2 error) {
	f.PushHook(func(context.Context, store.ProcessingJobsOptions) ([]workerutil.Record, int64, error) {
		return r0, r1, r2
	})
}

func (f *StoreProcessingJobsFunc) nextHook() func(context.Context, store.ProcessingJobsOptions) ([]workerutil.Record, int64, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
func (f *StoreProcessingJobsFunc) appendCall(r0 StoreProcessingJobsFuncCall) {
	f.mutex.Lock()
	f.history = append(f.history, r0)
	f.mutex.Unlock()
}

// History returns a sequence of StoreProcessingJobsFuncCall objects
// describing the invocations of this function.
func (f *StoreProcessingJobsFunc) History() []StoreProcessingJobsFuncCall {
	f.mutex.Lock()
	history := make([]StoreProcessingJobsFuncCall, len(f.history))
	copy(history, f.history)
	f.mutex.Unlock()
...
// StoreProcessingJobsFuncCall is an object that describes an invocation of
// method ProcessingJobs on an instance of MockStore.
type StoreProcessingJobsFuncCall struct {
	// Arg0 is the value of the 1st argument passed to this method
	// invocation.
	Arg0 context.Context
	// Arg1 is the value of the 2nd argument passed to this method
...
// Args returns an interface slice containing the arguments of this
// invocation.
func (c StoreProcessingJobsFuncCall) Args() []interface{} {
	return []interface{}{c.Arg0, c.Arg1}
}

// Results returns an interface slice containing the results of this
// invocation.
func (c StoreProcessingJobsFuncCall) Results() []interface{} {
	return []interface{}{c.Result0, c.Result1, c.Result2}
}
...
// the parameter and result values of this invocation.
func (m *MockStore) QueuedCount(v0 context.Context, v1 bool) (int, error) {
...
// of the parent MockStore instance is invoked and the hook queue is empty.
func (f *StoreQueuedCountFunc) SetDefaultHook(hook func(context.Context, bool) (int, error)) {
	f.defaultHook = hook
}
...
// the front of the queue and discards it. After the queue is empty, the
// default hook function is invoked for any future action.
func (f *StoreQueuedCountFunc) PushHook(hook func(context.Context, bool) (int, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *StoreQueuedCountFunc) nextHook() func(context.Context, bool) (int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
