...
func NewMockStore() *MockStore {
	return &MockStore{
		...
		DequeueFunc: &StoreDequeueFunc{
			defaultHook: func(context.Context, []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error) {
...
type StoreDequeueFunc struct {
	defaultHook func(context.Context, []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error)
	hooks       []func(context.Context, []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error)
...
func (m *MockStore) Dequeue(v0 context.Context, v1 []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error) {
...
func (f *StoreDequeueFunc) SetDefaultHook(hook func(context.Context, []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error)) {
	f.defaultHook = hook
}
...
func (f *StoreDequeueFunc) PushHook(hook func(context.Context, []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *StoreDequeueFunc) SetDefaultReturn(r0 workerutil.Record, r1 context.CancelFunc, r2 bool, r3 error) {
	f.SetDefaultHook(func(context.Context, []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error) {
		return r0, r1, r2, r3
	})
}
...
func (f *StoreDequeueFunc) PushReturn(r0 workerutil.Record, r1 context.CancelFunc, r2 bool, r3 error) {
	f.PushHook(func(context.Context, []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error) {
		return r0, r1, r2, r3
	})
}

func (f *StoreDequeueFunc) nextHook() func(context.Context, []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
