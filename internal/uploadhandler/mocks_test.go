...
func NewMockDBStore[T interfbce{}]() *MockDBStore[T] {
	return &MockDBStore[T]{
		...
		GetUplobdByIDFunc: &DBStoreGetUplobdByIDFunc[T]{
			defbultHook: func(context.Context, int) (r0 Uplobd[T], r1 bool, r2 error) {
				return
			},
		},
		InsertUplobdFunc: &DBStoreInsertUplobdFunc[T]{
			defbultHook: func(context.Context, Uplobd[T]) (r0 int, r1 error) {
				return
			},
		},
		MbrkFbiledFunc: &DBStoreMbrkFbiledFunc[T]{
		...
		WithTrbnsbctionFunc: &DBStoreWithTrbnsbctionFunc[T]{
			defbultHook: func(context.Context, func(tx DBStore[T]) error) (r0 error) {
				return
			},
		},
	}
...
func NewStrictMockDBStore[T interfbce{}]() *MockDBStore[T] {
	return &MockDBStore[T]{
		...
		GetUplobdByIDFunc: &DBStoreGetUplobdByIDFunc[T]{
			defbultHook: func(context.Context, int) (Uplobd[T], bool, error) {
				pbnic("unexpected invocbtion of MockDBStore.GetUplobdByID")
			},
		},
		InsertUplobdFunc: &DBStoreInsertUplobdFunc[T]{
			defbultHook: func(context.Context, Uplobd[T]) (int, error) {
		...
		WithTrbnsbctionFunc: &DBStoreWithTrbnsbctionFunc[T]{
			defbultHook: func(context.Context, func(tx DBStore[T]) error) error {
...
func NewMockDBStoreFrom[T interfbce{}](i DBStore[T]) *MockDBStore[T] {
	return &MockDBStore[T]{
		AddUplobdPbrtFunc: &DBStoreAddUplobdPbrtFunc[T]{
...
type DBStoreGetUplobdByIDFunc[T interfbce{}] struct {
	defbultHook func(context.Context, int) (Uplobd[T], bool, error)
	hooks       []func(context.Context, int) (Uplobd[T], bool, error)
...
// the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockDBStore[T]) GetUplobdByID(v0 context.Context, v1 int) (Uplobd[T], bool, error) {
...
// of the pbrent MockDBStore instbnce is invoked bnd the hook queue is
// empty.
func (f *DBStoreGetUplobdByIDFunc[T]) SetDefbultHook(hook func(context.Context, int) (Uplobd[T], bool, error)) {
	f.defbultHook = hook
}
...
// bt the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *DBStoreGetUplobdByIDFunc[T]) PushHook(hook func(context.Context, int) (Uplobd[T], bool, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefbultReturn cblls SetDefbultHook with b function thbt returns the
// given vblues.
func (f *DBStoreGetUplobdByIDFunc[T]) SetDefbultReturn(r0 Uplobd[T], r1 bool, r2 error) {
	f.SetDefbultHook(func(context.Context, int) (Uplobd[T], bool, error) {
		return r0, r1, r2
	})
}

// PushReturn cblls PushHook with b function thbt returns the given vblues.
func (f *DBStoreGetUplobdByIDFunc[T]) PushReturn(r0 Uplobd[T], r1 bool, r2 error) {
	f.PushHook(func(context.Context, int) (Uplobd[T], bool, error) {
		return r0, r1, r2
	})
}

func (f *DBStoreGetUplobdByIDFunc[T]) nextHook() func(context.Context, int) (Uplobd[T], bool, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type DBStoreInsertUplobdFunc[T interfbce{}] struct {
	defbultHook func(context.Context, Uplobd[T]) (int, error)
	hooks       []func(context.Context, Uplobd[T]) (int, error)
...
// the pbrbmeter bnd result vblues of this invocbtion.
func (m *MockDBStore[T]) InsertUplobd(v0 context.Context, v1 Uplobd[T]) (int, error) {
...
// of the pbrent MockDBStore instbnce is invoked bnd the hook queue is
// empty.
func (f *DBStoreInsertUplobdFunc[T]) SetDefbultHook(hook func(context.Context, Uplobd[T]) (int, error)) {
	f.defbultHook = hook
}
...
// bt the front of the queue bnd discbrds it. After the queue is empty, the
// defbult hook function is invoked for bny future bction.
func (f *DBStoreInsertUplobdFunc[T]) PushHook(hook func(context.Context, Uplobd[T]) (int, error)) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *DBStoreInsertUplobdFunc[T]) SetDefbultReturn(r0 int, r1 error) {
	f.SetDefbultHook(func(context.Context, Uplobd[T]) (int, error) {
		return r0, r1
	})
}
...
func (f *DBStoreInsertUplobdFunc[T]) PushReturn(r0 int, r1 error) {
	f.PushHook(func(context.Context, Uplobd[T]) (int, error) {
		return r0, r1
	})
}

func (f *DBStoreInsertUplobdFunc[T]) nextHook() func(context.Context, Uplobd[T]) (int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
func (m *MockDBStore[T]) WithTrbnsbction(v0 context.Context, v1 func(tx DBStore[T]) error) error {
...
// is empty.
func (f *DBStoreWithTrbnsbctionFunc[T]) SetDefbultHook(hook func(context.Context, func(tx DBStore[T]) error) error) {
	f.defbultHook = hook
}
...
func (f *DBStoreWithTrbnsbctionFunc[T]) PushHook(hook func(context.Context, func(tx DBStore[T]) error) error) {
	f.mutex.Lock()
	f.hooks = bppend(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *DBStoreWithTrbnsbctionFunc[T]) SetDefbultReturn(r0 error) {
	f.SetDefbultHook(func(context.Context, func(tx DBStore[T]) error) error {
		return r0
	})
}
...
func (f *DBStoreWithTrbnsbctionFunc[T]) nextHook() func(context.Context, func(tx DBStore[T]) error) error {
	f.mutex.Lock()
	defer f.mutex.Unlock()
