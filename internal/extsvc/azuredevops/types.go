...
func (e *HTTPError) Error() string {
	// Do not write HTTPError.Body as part of the error string as the ADO API returns raw HTML for
	// 4xx errors and non 200 OK responses inspite of using the "application/json" header in the
	// request. It does return JSON for 200 OK responses though.
	//
