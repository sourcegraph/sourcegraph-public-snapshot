...
// will be used.
func NewClient(urn string, config *schema.BitbucketCloudConnection, httpClient httpcli.Doer, logger log.Logger) (Client, error) {
	return newClient(urn, config, httpClient, logger)
}
