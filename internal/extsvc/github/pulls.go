...
func (c *V3Client) CreatePullRequest(ctx context.Context, in *CreatePullRequestInput) (*PullRequest, error) {
...
func (c *V3Client) UpdatePullRequest(ctx context.Context, in *UpdatePullRequestInput) (*PullRequest, error) {
	var q strings.Builder
	q.WriteString(pullRequestFragments)
...
func (c *V3Client) MarkPullRequestReadyForReview(ctx context.Context, pr *PullRequest) error {
	var q strings.Builder
	q.WriteString(pullRequestFragments)
...
func (c *V3Client) ClosePullRequest(ctx context.Context, pr *PullRequest) error {
	var q strings.Builder
	q.WriteString(pullRequestFragments)
...
func (c *V3Client) ReopenPullRequest(ctx context.Context, pr *PullRequest) error {
	var q strings.Builder
	q.WriteString(pullRequestFragments)
...
func (c *V3Client) LoadPullRequest(ctx context.Context, pr *PullRequest) error {
...
func (c *V3Client) GetOpenPullRequestByRefs(ctx context.Context, owner, name, baseRef, headRef string) (*PullRequest, error) {
	var q strings.Builder
	q.WriteString(pullRequestFragments)
	q.WriteString("query {\n")
...
func (c *V3Client) loadRemainingTimelineItems(ctx context.Context, prID string, pageInfo PageInfo) (items []TimelineItem, err error) {
	pi := pageInfo
	for pi.HasNextPage {
		var q strings.Builder
