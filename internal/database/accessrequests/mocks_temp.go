...
import (
	...
	dbtypes "github.com/sourcegraph/sourcegraph/internal/database/dbtypes"
...
func NewMockAccessRequestStore() *MockAccessRequestStore {
	return &MockAccessRequestStore{
		...
		ListFunc: &AccessRequestStoreListFunc{
			defaultHook: func(context.Context, *AccessRequestsFilterArgs, *dbtypes.PaginationArgs) (r0 []*types.AccessRequest, r1 error) {
				return
			},
		},
		UpdateFunc: &AccessRequestStoreUpdateFunc{
...
func NewStrictMockAccessRequestStore() *MockAccessRequestStore {
	return &MockAccessRequestStore{
		...
		ListFunc: &AccessRequestStoreListFunc{
			defaultHook: func(context.Context, *AccessRequestsFilterArgs, *dbtypes.PaginationArgs) ([]*types.AccessRequest, error) {
...
type AccessRequestStoreListFunc struct {
	defaultHook func(context.Context, *AccessRequestsFilterArgs, *dbtypes.PaginationArgs) ([]*types.AccessRequest, error)
	hooks       []func(context.Context, *AccessRequestsFilterArgs, *dbtypes.PaginationArgs) ([]*types.AccessRequest, error)
...
// parameter and result values of this invocation.
func (m *MockAccessRequestStore) List(v0 context.Context, v1 *AccessRequestsFilterArgs, v2 *dbtypes.PaginationArgs) ([]*types.AccessRequest, error) {
...
// parent MockAccessRequestStore instance is invoked and the hook queue is
// empty.
func (f *AccessRequestStoreListFunc) SetDefaultHook(hook func(context.Context, *AccessRequestsFilterArgs, *dbtypes.PaginationArgs) ([]*types.AccessRequest, error)) {
	f.defaultHook = hook
}
...
// hook at the front of the queue and discards it. After the queue is empty,
// the default hook function is invoked for any future action.
func (f *AccessRequestStoreListFunc) PushHook(hook func(context.Context, *AccessRequestsFilterArgs, *dbtypes.PaginationArgs) ([]*types.AccessRequest, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *AccessRequestStoreListFunc) SetDefaultReturn(r0 []*types.AccessRequest, r1 error) {
	f.SetDefaultHook(func(context.Context, *AccessRequestsFilterArgs, *dbtypes.PaginationArgs) ([]*types.AccessRequest, error) {
		return r0, r1
	})
}
...
func (f *AccessRequestStoreListFunc) PushReturn(r0 []*types.AccessRequest, r1 error) {
	f.PushHook(func(context.Context, *AccessRequestsFilterArgs, *dbtypes.PaginationArgs) ([]*types.AccessRequest, error) {
		return r0, r1
	})
}

func (f *AccessRequestStoreListFunc) nextHook() func(context.Context, *AccessRequestsFilterArgs, *dbtypes.PaginationArgs) ([]*types.AccessRequest, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
