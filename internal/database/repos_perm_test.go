...
func (p *fakeProvider) FetchUserPerms(context.Context, *extsvc.Account, *authz.FetchPermOptions) (*authz.ExternalUserPermissions, error) {
	return nil, nil
}

func (p *fakeProvider) FetchUserPermsByToken(context.Context, string, *authz.FetchPermOptions) (*authz.ExternalUserPermissions, error) {
	return nil, nil
}
