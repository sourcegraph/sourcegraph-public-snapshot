...
func (u *userStore) CreateInTransaction(ctx context.Context, info NewUser, spec *extsvc.AccountSpec) (newUser *types.User, err error) {
	...
	if err := enforcement.NewBeforeCreateUserHook()(ctx, NewDBWith(u.logger, u.Store), spec); err != nil {
...

	{
		...
		if err := enforcement.NewAfterCreateUserHook()(ctx, NewDBWith(u.logger, u.Store), user); err != nil {
...
func (u *userStore) SetIsSiteAdmin(ctx context.Context, id int32, isSiteAdmin bool) error {
	if err := enforcement.NewBeforeSetUserIsSiteAdmin()(ctx, isSiteAdmin); err != nil {
		return err
	}
