...
// with the handle.
func ConnectRawForTestDatabase(dsn string, schemas ...*migrations.Schema) (*sql.DB, func(err error) error, error) {
...
func connect(dsn, appName, dbName string, schemas []*migrations.Schema) (*sql.DB, func(err error) error, error) {
