...
type AccessTokenStore interface {
	...
	Lookup(ctx context.Context, tokenHexEncoded, requiredScope string) (subjectUserID int32, tokenID int64, err error)
...
func (s *accessTokenStore) Lookup(ctx context.Context, tokenHexEncoded, requiredScope string) (subjectUserID int32, tokenID int64, err error) {
	if requiredScope == "" {
...
`,
	...
	return subjectUserID, tokenID, nil
}
