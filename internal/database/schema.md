...
Indexes:
    ...
    "event_logs_name_is_cody_explanation_event" isCodyExplanationEvent(name)
    "event_logs_name_is_cody_generation_event" isCodyGenerationEvent(name)
    "event_logs_name_is_cody_active_event" isCodyActiveEvent(name)
