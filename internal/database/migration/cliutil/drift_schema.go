...
// a version of Sourcegraph that did not yet contain the squashed schema file in-tree. These files have been
// backfilled to this bucket by hand. A false-valued flag is returned if the schema does not exist for this
// version.
