...
func compareConstraints(out *preambledOutput, version string, actualTable, expectedTable schemas.TableDescription) bool {
...
func compareIndexes(out *preambledOutput, version string, actualTable, expectedTable schemas.TableDescription) bool {
...
func compareTriggers(out *preambledOutput, version string, actualTable, expectedTable schemas.TableDescription) bool {
...
func compareTableComments(out *preambledOutput, version string, actualTable, expectedTable schemas.TableDescription) bool {
