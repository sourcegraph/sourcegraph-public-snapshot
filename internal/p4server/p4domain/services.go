...
type GetObjectFunc func(ctx context.Context, repo api.RepoName, objectName string) (*P4Object, error)

// GetObjectService will get an information about a p4 object
...
func (s *GetObjectService) GetObject(ctx context.Context, repo api.RepoName, objectName string) (*P4Object, error) {
