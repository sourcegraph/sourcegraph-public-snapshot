...
// UserMirrorsState specifies the state of the user's access to the
// GitHub repo mirrors feature.
type UserMirrorsState int32

const (
	// NotAllowed is the state where the user is not allowed to access
	// the repo mirrors feature on this server.
	UserMirrorsState_NotAllowed UserMirrorsState = 0
	// OnWaitlist is the state where user is on the waitlist for the
	// repo mirrors feature.
	UserMirrorsState_OnWaitlist UserMirrorsState = 1
	// NoToken is the state where the user has not yet linked their
	// GitHub account on this server.
	UserMirrorsState_NoToken UserMirrorsState = 2
	// InvalidToken is the state where the user's stored GitHub OAuth2 token
	// is invalid.
	UserMirrorsState_InvalidToken UserMirrorsState = 3
	// HasAccess is the state where user has access to the repo mirrors
	// feature.
	UserMirrorsState_HasAccess UserMirrorsState = 4
)

var UserMirrorsState_name = map[int32]string{
	0: "NotAllowed",
	1: "OnWaitlist",
	2: "NoToken",
	3: "InvalidToken",
...
var UserMirrorsState_value = map[string]int32{
	"NotAllowed":   0,
	"OnWaitlist":   1,
	"NoToken":      2,
	"InvalidToken": 3,
...
func (x UserMirrorsState) String() string {
	return proto.EnumName(UserMirrorsState_name, int32(x))
}
...
type Badge struct {
	...
	UncountedImageURL string `protobuf:"bytes,4,opt,name=UncountedImageURL,proto3" json:"UncountedImageURL,omitempty"`
...
type StorageKey struct {
	...
	Bucket *StorageBucket `protobuf:"bytes,3,opt,name=Bucket" json:"Bucket,omitempty"`
...
type StoragePutOp struct {
	...
	Key StorageKey `protobuf:"bytes,1,opt,name=Key" json:"Key"`
	// Value is the value of the object.
	Value []byte `protobuf:"bytes,2,opt,name=Value,proto3" json:"Value,omitempty"`
}
...
// WaitlistedUser describes a user who has been added to the waitlist
// for access to the private repos feature.
type WaitlistedUser struct {
	// UID is the unique id of the waitlisted user.
	UID int32 `protobuf:"varint,1,opt,name=UID,proto3" json:"UID,omitempty"`
	// AddedAt is the timestamp at which the user was added to the
	// waitlist.
	AddedAt *pbtypes.Timestamp `protobuf:"bytes,2,opt,name=AddedAt" json:"AddedAt,omitempty"`
	// GrantedAt is the timestamp at which the user was granted
	// access to the feature. If this field is null, the user is
	// still on the waitlist.
	GrantedAt *pbtypes.Timestamp `protobuf:"bytes,3,opt,name=GrantedAt" json:"GrantedAt,omitempty"`
}

func (m *WaitlistedUser) Reset()         { *m = WaitlistedUser{} }
func (m *WaitlistedUser) String() string { return proto.CompactTextString(m) }
func (*WaitlistedUser) ProtoMessage()    {}

// WaitlistedOrg describes a GitHub organization which has been added
// to the waitlist for access to the private repos feature.
type WaitlistedOrg struct {
	// Name is the unique name of the waitlisted GitHub org.
	Name string `protobuf:"bytes,1,opt,name=Name,proto3" json:"Name,omitempty"`
	// AddedAt is the timestamp at which the org was added to the
	// waitlist.
	AddedAt *pbtypes.Timestamp `protobuf:"bytes,2,opt,name=AddedAt" json:"AddedAt,omitempty"`
	// GrantedAt is the timestamp at which the org was granted
	// access to the feature. If this field is null, the org is
	// still on the waitlist.
	GrantedAt *pbtypes.Timestamp `protobuf:"bytes,3,opt,name=GrantedAt" json:"GrantedAt,omitempty"`
}

func (m *WaitlistedOrg) Reset()         { *m = WaitlistedOrg{} }
...
type UserMirrorData struct {
	...
	// Host is the name of the external code host.
...
func (m *UserMirrorData) Reset()         { *m = UserMirrorData{} }
func (m *UserMirrorData) String() string { return proto.CompactTextString(m) }
func (*UserMirrorData) ProtoMessage()    {}

type WaitlistState struct {
	// State is the state of the user on the waitlist.
	State UserMirrorsState `protobuf:"varint,1,opt,name=State,proto3,enum=sourcegraph.UserMirrorsState" json:"State,omitempty"`
}

func (m *WaitlistState) Reset()         { *m = WaitlistState{} }
func (m *WaitlistState) String() string { return proto.CompactTextString(m) }
func (*WaitlistState) ProtoMessage()    {}
...
type SSHKeyList struct {
	SSHKeys []SSHPublicKey `protobuf:"bytes,1,rep,name=SSHKeys" json:"SSHKeys"`
}
...
type SSHPublicKey struct {
	...
	//
	// NOTE: When adding a key, the server instead expects the data to be
	// serialized in the same format as keys in an OpenSSH authorized_keys
	// file.
...
type Delta struct {
	...
	BaseRepo   *Repo       `protobuf:"bytes,5,opt,name=BaseRepo" json:"BaseRepo,omitempty"`
	HeadRepo   *Repo       `protobuf:"bytes,6,opt,name=HeadRepo" json:"HeadRepo,omitempty"`
}
...
func init() {
	proto.RegisterEnum("sourcegraph.UserMirrorsState", UserMirrorsState_name, UserMirrorsState_value)
...
type MirrorReposClient interface {
	...
	// GetUserData returns the list of GitHub repos that are visible
	// to the currently authenticated user.
	GetUserData(ctx context.Context, in *pbtypes1.Void, opts ...grpc.CallOption) (*UserMirrorData, error)
	// AddToWaitlist adds the authenticated user to the waitlist for
	// private repo mirrors feature.
	AddToWaitlist(ctx context.Context, in *pbtypes1.Void, opts ...grpc.CallOption) (*WaitlistState, error)
}
...
func (c *mirrorReposClient) GetUserData(ctx context.Context, in *pbtypes1.Void, opts ...grpc.CallOption) (*UserMirrorData, error) {
	out := new(UserMirrorData)
	err := grpc.Invoke(ctx, "/sourcegraph.MirrorRepos/GetUserData", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mirrorReposClient) AddToWaitlist(ctx context.Context, in *pbtypes1.Void, opts ...grpc.CallOption) (*WaitlistState, error) {
	out := new(WaitlistState)
	err := grpc.Invoke(ctx, "/sourcegraph.MirrorRepos/AddToWaitlist", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MirrorReposServer interface {
	...
	// GetUserData returns the list of GitHub repos that are visible
	// to the currently authenticated user.
	GetUserData(context.Context, *pbtypes1.Void) (*UserMirrorData, error)
	// AddToWaitlist adds the authenticated user to the waitlist for
	// private repo mirrors feature.
	AddToWaitlist(context.Context, *pbtypes1.Void) (*WaitlistState, error)
}
...
func _MirrorRepos_GetUserData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(pbtypes1.Void)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(MirrorReposServer).GetUserData(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MirrorRepos_AddToWaitlist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error) (interface{}, error) {
	in := new(pbtypes1.Void)
	if err := dec(in); err != nil {
		return nil, err
	}
	out, err := srv.(MirrorReposServer).AddToWaitlist(ctx, in)
	if err != nil {
		return nil, err
	}
	return out, nil
...
var _MirrorRepos_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MirrorRepos_GetUserData_Handler,
		},
		{
			MethodName: "AddToWaitlist",
			Handler:    _MirrorRepos_AddToWaitlist_Handler,
		},
	},
	Streams: []grpc.StreamDesc{},
}
...
func (m *Repo) MarshalTo(data []byte) (int, error) {
	...
	if m.GitHub != nil {
		...
		n5, err := m.GitHub.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *RepoBadgesCountHitsOp) MarshalTo(data []byte) (int, error) {
	...
	if m.Since != nil {
		...
		n7, err := m.Since.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *RepoRevSpec) MarshalTo(data []byte) (int, error) {
	...
	n9, err := m.RepoSpec.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n9
...
func (m *RepoStatus) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.UpdatedAt.Size()))
	n11, err := m.UpdatedAt.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n11
...
func (m *RepoResolution) MarshalTo(data []byte) (int, error) {
	...
	_ = l
	if m.Result != nil {
		nn14, err := m.Result.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn14
...
func (m *RepoResolution_RemoteRepo) MarshalTo(data []byte) (int, error) {
	...
	if m.RemoteRepo != nil {
		...
		n16, err := m.RemoteRepo.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n16
...
func (m *ReposCreateOp) MarshalTo(data []byte) (int, error) {
	...
	_ = l
	if m.Op != nil {
		nn20, err := m.Op.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn20
...
func (m *ReposListBranchesOp) MarshalTo(data []byte) (int, error) {
	...
	if m.Opt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Opt.Size()))
		n28, err := m.Opt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n28
...
func (m *RepoListBranchesOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListOptions.Size()))
	n29, err := m.ListOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n29
...
func (m *BranchList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n30, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n30
...
func (m *ReposListCommittersOp) MarshalTo(data []byte) (int, error) {
	...
	if m.Opt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Opt.Size()))
		n34, err := m.Opt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n34
...
func (m *TagList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n38, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n38
...
func (m *WaitlistedUser) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *WaitlistedUser) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.AddedAt != nil {
		data[i] = 0x12
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.AddedAt.Size()))
		n40, err := m.AddedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n40
	...
	if m.GrantedAt != nil {
		data[i] = 0x1a
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.GrantedAt.Size()))
		n41, err := m.GrantedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n41
...
func (m *WaitlistedOrg) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *WaitlistedOrg) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if m.AddedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.AddedAt.Size()))
		n42, err := m.AddedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n42
	...
	if m.GrantedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.GrantedAt.Size()))
		n43, err := m.GrantedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *RemoteRepo) MarshalTo(data []byte) (int, error) {
	...
	if m.UpdatedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.UpdatedAt.Size()))
		n44, err := m.UpdatedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n44
	...
	if m.Permissions != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Permissions.Size()))
		n45, err := m.Permissions.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *UserMirrorData) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *UserMirrorData) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *WaitlistState) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *WaitlistState) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *Build) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.CreatedAt.Size()))
	n46, err := m.CreatedAt.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n46
	if m.StartedAt != nil {
		...
		n47, err := m.StartedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n47
	...
	if m.EndedAt != nil {
		...
		n48, err := m.EndedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n48
	...
	if m.HeartbeatAt != nil {
		...
		n49, err := m.HeartbeatAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n49
	...
	n50, err := m.BuildConfig.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n50
...
func (m *BuildTask) MarshalTo(data []byte) (int, error) {
	...
	n53, err := m.Build.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n53
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.CreatedAt.Size()))
	n54, err := m.CreatedAt.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n54
	if m.StartedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.StartedAt.Size()))
		n55, err := m.StartedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n55
	...
	if m.EndedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.EndedAt.Size()))
		n56, err := m.EndedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n56
...
func (m *BuildUpdate) MarshalTo(data []byte) (int, error) {
	...
	if m.HeartbeatAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.HeartbeatAt.Size()))
		n60, err := m.HeartbeatAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n60
...
func (m *BuildList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n61, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n61
...
func (m *BuildsCreateOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Repo.Size()))
	n62, err := m.Repo.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n62
	...
	n63, err := m.Config.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n63
...
func (m *BuildsListBuildTasksOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Build.Size()))
	n66, err := m.Build.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n66
...
func (m *BuildsCreateTasksOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Build.Size()))
	n68, err := m.Build.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n68
...
func (m *BuildsUpdateTaskOp) MarshalTo(data []byte) (int, error) {
	...
	n69, err := m.Task.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n69
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Info.Size()))
	n70, err := m.Info.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n70
...
func (m *BuildsGetTaskLogOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Task.Size()))
	n71, err := m.Task.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n71
...
func (m *Org) MarshalTo(data []byte) (int, error) {
	...
	n73, err := m.User.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n73
...
func (m *OrgListMembersOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListOptions.Size()))
	n74, err := m.ListOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n74
...
func (m *OrgsListMembersOp) MarshalTo(data []byte) (int, error) {
	...
	n75, err := m.Org.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n75
	if m.Opt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Opt.Size()))
		n76, err := m.Opt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n76
...
func (m *Person) MarshalTo(data []byte) (int, error) {
	...
	n77, err := m.PersonSpec.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n77
...
func (m *RemoteUser) MarshalTo(data []byte) (int, error) {
	...
	if m.RemoteAccount != nil {
		...
		n78, err := m.RemoteAccount.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n78
	...
	if m.LocalAccount != nil {
		...
		n79, err := m.LocalAccount.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n79
...
func (m *TaskUpdate) MarshalTo(data []byte) (int, error) {
	...
	if m.StartedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.StartedAt.Size()))
		n81, err := m.StartedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n81
	...
	if m.EndedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.EndedAt.Size()))
		n82, err := m.EndedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n82
...
func (m *User) MarshalTo(data []byte) (int, error) {
	...
	if m.RegisteredAt != nil {
		...
		n83, err := m.RegisteredAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n83
...
func (m *UsersListOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListOptions.Size()))
	n84, err := m.ListOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n84
...
func (m *OrgsListOp) MarshalTo(data []byte) (int, error) {
	...
	n85, err := m.Member.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n85
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListOptions.Size()))
	n86, err := m.ListOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n86
...
func (m *PendingPasswordReset) MarshalTo(data []byte) (int, error) {
	...
	if m.Token != nil {
		...
		n87, err := m.Token.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n87
...
func (m *NewPassword) MarshalTo(data []byte) (int, error) {
	...
	if m.Token != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Token.Size()))
		n88, err := m.Token.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n88
...
func (m *AcceptedInvite) MarshalTo(data []byte) (int, error) {
	...
	if m.Account != nil {
		...
		n89, err := m.Account.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n89
...
func (m *AccessTokenRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.AuthorizationGrant != nil {
		nn90, err := m.AuthorizationGrant.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn90
...
func (m *AccessTokenRequest_AuthorizationCode) MarshalTo(data []byte) (int, error) {
	...
	if m.AuthorizationCode != nil {
		...
		n91, err := m.AuthorizationCode.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n91
...
func (m *AccessTokenRequest_ResourceOwnerPassword) MarshalTo(data []byte) (int, error) {
	...
	if m.ResourceOwnerPassword != nil {
		...
		n92, err := m.ResourceOwnerPassword.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n92
...
func (m *AccessTokenRequest_BearerJWT) MarshalTo(data []byte) (int, error) {
	...
	if m.BearerJWT != nil {
		...
		n93, err := m.BearerJWT.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n93
...
func (m *Def) MarshalTo(data []byte) (int, error) {
	...
	if m.DocHTML != nil {
		...
		n95, err := m.DocHTML.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n95
	...
	if m.FmtStrings != nil {
		...
		n96, err := m.FmtStrings.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n96
...
func (m *DefList) MarshalTo(data []byte) (int, error) {
	...
	n102, err := m.ListResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n102
...
func (m *RefList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n105, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n105
...
func (m *Delta) MarshalTo(data []byte) (int, error) {
	...
	if m.BaseCommit != nil {
		...
		n111, err := m.BaseCommit.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n111
	...
	if m.HeadCommit != nil {
		...
		n112, err := m.HeadCommit.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n112
	...
	if m.BaseRepo != nil {
		...
		n113, err := m.BaseRepo.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n113
	...
	if m.HeadRepo != nil {
		...
		n114, err := m.HeadRepo.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n114
...
func (m *FileDiff) MarshalTo(data []byte) (int, error) {
	...
	n115, err := m.FileDiff.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n115
	...
	n116, err := m.Stats.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n116
...
func (m *DeltaFiles) MarshalTo(data []byte) (int, error) {
	...
	if m.Delta != nil {
		...
		n117, err := m.Delta.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n117
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Stats.Size()))
	n118, err := m.Stats.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n118
...
func (m *DeltaListFilesOptions) MarshalTo(data []byte) (int, error) {
	...
	n119, err := m.DeltaFilter.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n119
...
func (m *DeltaSpec) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Base.Size()))
	n120, err := m.Base.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n120
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Head.Size()))
	n121, err := m.Head.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n121
...
func (m *DeltasListFilesOp) MarshalTo(data []byte) (int, error) {
	...
	n122, err := m.Ds.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n122
...
func (m *Example) MarshalTo(data []byte) (int, error) {
	...
	n124, err := m.Ref.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n124
...
func (m *RepoTreeGetOptions) MarshalTo(data []byte) (int, error) {
	...
	n126, err := m.GetFileOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n126
...
func (m *RepoTreeSearchOptions) MarshalTo(data []byte) (int, error) {
	...
	n128, err := m.SearchOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n128
...
func (m *RepoTreeSearchResult) MarshalTo(data []byte) (int, error) {
	...
	n129, err := m.SearchResult.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n129
...
func (m *RepoTreeGetOp) MarshalTo(data []byte) (int, error) {
	...
	n131, err := m.Entry.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n131
...
func (m *RepoTreeSearchOp) MarshalTo(data []byte) (int, error) {
	...
	n133, err := m.Rev.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n133
...
func (m *RepoTreeListOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Rev.Size()))
	n135, err := m.Rev.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n135
...
func (m *VCSSearchResultList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListResponse.Size()))
	n136, err := m.ListResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n136
...
func (m *TokenSearchOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.RepoRev.Size()))
	n137, err := m.RepoRev.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n137
...
func (m *TextSearchOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.RepoRev.Size()))
	n139, err := m.RepoRev.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n139
...
func (m *TreeEntry) MarshalTo(data []byte) (int, error) {
	...
	if m.BasicTreeEntry != nil {
		...
		n141, err := m.BasicTreeEntry.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n141
	...
	if m.FileRange != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.FileRange.Size()))
		n142, err := m.FileRange.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n142
...
func (m *TreeEntrySpec) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.RepoRev.Size()))
	n143, err := m.RepoRev.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n143
...
func (m *FileToken) MarshalTo(data []byte) (int, error) {
	...
	if m.Entry != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Entry.Size()))
		n144, err := m.Entry.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n144
...
func (m *RegisteredClient) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.UpdatedAt.Size()))
	n146, err := m.UpdatedAt.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n146
...
func (m *RegisteredClientListOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListOptions.Size()))
	n147, err := m.ListOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n147
...
func (m *RegisteredClientList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n148, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n148
...
func (m *UserPermissionsOptions) MarshalTo(data []byte) (int, error) {
	...
	if m.ClientSpec != nil {
		...
		n149, err := m.ClientSpec.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n149
...
func (m *UserEvent) MarshalTo(data []byte) (int, error) {
	...
	if m.CreatedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.CreatedAt.Size()))
		n150, err := m.CreatedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n150
...
func (m *Event) MarshalTo(data []byte) (int, error) {
	...
	if m.Timestamp != nil {
		...
		n151, err := m.Timestamp.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n151
...
func (m *NotifyGenericEvent) MarshalTo(data []byte) (int, error) {
	...
	if m.Actor != nil {
		...
		n152, err := m.Actor.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n152
...
func (m *AnnotationsListOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Entry.Size()))
	n153, err := m.Entry.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n153
	if m.Range != nil {
		...
		n154, err := m.Range.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n154
...
func (m *WaitlistedUser) Size() (n int) {
	var l int
	_ = l
	if m.UID != 0 {
...
func (m *WaitlistedOrg) Size() (n int) {
	var l int
	_ = l
	l = len(m.Name)
	if l > 0 {
...
func (m *UserMirrorData) Size() (n int) {
	var l int
	_ = l
	l = len(m.URL)
	if l > 0 {
...
func (m *WaitlistState) Size() (n int) {
	var l int
	_ = l
	if m.State != 0 {
		n += 1 + sovSourcegraph(uint64(m.State))
...
func (m *WaitlistedUser) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WaitlistedUser: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WaitlistedUser: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *WaitlistedOrg) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WaitlistedOrg: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WaitlistedOrg: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *UserMirrorData) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: UserMirrorData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: UserMirrorData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				m.State |= (UserMirrorsState(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *WaitlistState) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: WaitlistState: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: WaitlistState: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
