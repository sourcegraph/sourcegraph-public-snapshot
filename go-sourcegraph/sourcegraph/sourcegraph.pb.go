...
func (m *StorageKey) MarshalTo(data []byte) (int, error) {
	...
	if m.Bucket != nil {
		...
		n15, err := m.Bucket.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n15
...
func (m *RepoListCommitsOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListOptions.Size()))
	n20, err := m.ListOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n20
...
func (m *CommitList) MarshalTo(data []byte) (int, error) {
	...
	n21, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n21
...
func (m *RepoListBranchesOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListOptions.Size()))
	n24, err := m.ListOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n24
...
func (m *BranchList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n25, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n25
...
func (m *ReposListTagsOp) MarshalTo(data []byte) (int, error) {
	...
	if m.Opt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Opt.Size()))
		n27, err := m.Opt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *RepoListCommittersOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListOptions.Size()))
	n30, err := m.ListOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n30
...
func (m *CommitterList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n31, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n31
...
func (m *MirrorReposRefreshVCSOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Repo.Size()))
	n34, err := m.Repo.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n34
...
func (m *WaitlistedUser) MarshalTo(data []byte) (int, error) {
	...
	if m.AddedAt != nil {
		...
		n35, err := m.AddedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n35
	...
	if m.GrantedAt != nil {
		...
		n36, err := m.GrantedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *WaitlistedOrg) MarshalTo(data []byte) (int, error) {
	...
	if m.AddedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.AddedAt.Size()))
		n37, err := m.AddedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n37
	...
	if m.GrantedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.GrantedAt.Size()))
		n38, err := m.GrantedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n38
