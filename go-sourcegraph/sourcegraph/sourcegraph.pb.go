...
type RefLocationsList struct {
	...
	// TotalRefs is the total number of references to the def.
	TotalRefs int32 `protobuf:"varint,3,opt,name=TotalRefs,proto3" json:"TotalRefs,omitempty"`
	// TotalFiles is the total number of files which reference the def.
	TotalFiles int32 `protobuf:"varint,4,opt,name=TotalFiles,proto3" json:"TotalFiles,omitempty"`
	// TotalRepos is the total number of repos which reference the def.
	TotalRepos int32 `protobuf:"varint,5,opt,name=TotalRepos,proto3" json:"TotalRepos,omitempty"`
...
func (m *RefLocationsList) MarshalTo(data []byte) (int, error) {
	...
	if m.TotalRefs != 0 {
		data[i] = 0x18
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.TotalRefs))
	}
	if m.TotalFiles != 0 {
		data[i] = 0x20
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.TotalFiles))
	}
	if m.TotalRepos != 0 {
		data[i] = 0x28
		i++
...
func (m *RefLocationsList) Size() (n int) {
	...
	n += 1 + l + sovSourcegraph(uint64(l))
	if m.TotalRefs != 0 {
		n += 1 + sovSourcegraph(uint64(m.TotalRefs))
	}
	if m.TotalFiles != 0 {
		n += 1 + sovSourcegraph(uint64(m.TotalFiles))
	}
	if m.TotalRepos != 0 {
...
func (m *RefLocationsList) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalRefs", wireType)
			}
			m.TotalRefs = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := data[iNdEx]
				iNdEx++
				m.TotalRefs |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := data[iNdEx]
				iNdEx++
				m.TotalFiles |= (int32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorSourcegraph = []byte{
	// 6332 bytes of a gzipped FileDescriptorProto
	...
	,
}
