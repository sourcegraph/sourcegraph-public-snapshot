...
func (m *Def) MarshalTo(data []byte) (int, error) {
	...
	if m.QualifiedName != nil {
		...
		n92, err := m.QualifiedName.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n92
...
func (m *TreeEntry) MarshalTo(data []byte) (int, error) {
	...
	if m.BasicTreeEntry != nil {
		...
		n131, err := m.BasicTreeEntry.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n131
	...
	if m.FileRange != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.FileRange.Size()))
		n132, err := m.FileRange.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n132
...
func (m *RegisteredClient) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.UpdatedAt.Size()))
	n136, err := m.UpdatedAt.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n136
...
func (m *RegisteredClientList) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.StreamResponse.Size()))
	n138, err := m.StreamResponse.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n138
...
func (m *UserPermissionsOptions) MarshalTo(data []byte) (int, error) {
	...
	if m.ClientSpec != nil {
		...
		n139, err := m.ClientSpec.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n139
...
func (m *Event) MarshalTo(data []byte) (int, error) {
	...
	if m.Timestamp != nil {
		...
		n141, err := m.Timestamp.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n141
...
func (m *NotifyGenericEvent) MarshalTo(data []byte) (int, error) {
	...
	if m.Actor != nil {
		...
		n142, err := m.Actor.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n142
...
func (m *AnnotationsListOptions) MarshalTo(data []byte) (int, error) {
	...
	if m.Range != nil {
		...
		n144, err := m.Range.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n144
