...
func TestPermsSyncer_syncUserPerms(t *testing.T) {
	...
	syncJobs := databasemocks.NewMockPermissionSyncJobStore()
...
func TestPermsSyncer_syncUserPerms_fetchAccount(t *testing.T) {
	...
	permissionSyncJobs := databasemocks.NewMockPermissionSyncJobStore()
...
func TestPermsSyncer_syncUserPermsTemporaryProviderError(t *testing.T) {
	...
	subRepoPerms := databasemocks.NewMockSubRepoPermsStore()
...
func TestPermsSyncer_syncRepoPerms(t *testing.T) {
	mockRepos := databasemocks.NewMockRepoStore()
	mockFeatureFlags := databasemocks.NewMockFeatureFlagStore()
	mockSyncJobs := databasemocks.NewMockPermissionSyncJobStore()
