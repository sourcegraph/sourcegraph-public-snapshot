...
// func (e *types.ExternalService) Exclude(rs ...*Repo) error {
...
// // the given repos.
// func (e *types.ExternalService) excludeOtherRepos(rs ...*Repo) error {
// 	if len(rs) == 0 {
// 		return nil
// 	}
...
// func (e *types.ExternalService) excludeGitLabRepos(rs ...*Repo) error {
// 	if len(rs) == 0 {
// 		return nil
// 	}
...
// // given repos from being synced.
// func (e *types.ExternalService) excludeBitbucketServerRepos(rs ...*Repo) error {
// 	if len(rs) == 0 {
// 		return nil
// 	}
...
// // given repos from being synced.
// func (e *types.ExternalService) excludeGitoliteRepos(rs ...*Repo) error {
// 	if len(rs) == 0 {
// 		return nil
// 	}
...
// // given repos from being synced.
// func (e *types.ExternalService) excludeGithubRepos(rs ...*Repo) error {
// 	if len(rs) == 0 {
// 		return nil
// 	}
...
// func (e *types.ExternalService) excludeAWSCodeCommitRepos(rs ...*Repo) error {
// 	if len(rs) == 0 {
// 		return nil
// 	}
...
// func (e *types.ExternalService) config(kind string, opt func(c interface{}) (string, interface{}, error)) error {
...
// func (e *types.ExternalService) Clone() *types.ExternalService {
// 	clone := *e
// 	return &clone
// }

// // Apply applies the given functional options to the ExternalService.
// func (e *types.ExternalService) Apply(opts ...func(*types.ExternalService)) {
// 	if e == nil {
// 		return
// 	}
...
// func (e *types.ExternalService) With(opts ...func(*types.ExternalService)) *types.ExternalService {
// 	clone := e.Clone()
// 	clone.Apply(opts...)
// 	return clone
// }
...
// type ExternalServices []*types.ExternalService
...
// func (es ExternalServices) Clone() types.ExternalServices {
...
// // Apply applies the given functional options to the ExternalService.
// func (es ExternalServices) Apply(opts ...func(*types.ExternalService)) {
// 	for _, r := range es {
// 		r.Apply(opts...)
// 	}
// }
...
// func (es ExternalServices) With(opts ...func(*ExternalService)) types.ExternalServices {
// 	clone := es.Clone()
// 	clone.Apply(opts...)
// 	return clone
// }
