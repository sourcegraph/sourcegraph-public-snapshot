...
// $ /Users/efritz/dev/sourcegraph/sourcegraph/cmd/precise-code-intel-api-server/internal/mocks/.bin/go-mockgen -f github.com/sourcegraph/sourcegraph/cmd/precise-code-intel-api-server/internal/db -i DB -o mock_db.go
