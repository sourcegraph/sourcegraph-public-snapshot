...
// using the command
// $ /Users/efritz/dev/sourcegraph/sourcegraph/cmd/precise-code-intel-api-server/.bin/go-mockgen -f github.com/sourcegraph/sourcegraph/cmd/precise-code-intel-api-server/internal/db -i ReferencePager -o mock_reference_pager.go
