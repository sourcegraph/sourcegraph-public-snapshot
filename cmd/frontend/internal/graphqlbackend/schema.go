...
type Mutation {
	...
	createThread(orgID: Int!, canonicalRemoteID: String!, cloneURL: String!, file: String!, repoRevision: String!, linesRevision: String!, branch: String, startLine: Int!, endLine: Int!, startCharacter: Int!, endCharacter: Int!, rangeLength: Int!, contents: String!, lines: ThreadLinesInput): Thread!
...
type Org {
	...
	threads(repoCanonicalRemoteID: String, branch: String, file: String, limit: Int): ThreadConnection!
	tags: [OrgTag!]!
}
