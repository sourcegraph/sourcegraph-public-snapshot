...
type Package {
    ...
    lang: String!
    # The repository that defines the package.
    repository: Repository
    # The following fields are properties of build package configuration as returned by the workspace/xpackages LSP
    # endpoint.
    id: String
    type: String
    name: String
...
type Dependency {
    # The repository that depends on the unit of code described by this resolver's other fields.
    repository: Repository
    # The following fields are properties of build package configuration as returned by the workspace/xpackages LSP
    # endpoint.
    name: String
