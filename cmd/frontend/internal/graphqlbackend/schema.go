...
type ThreadLines {
	htmlBefore: String! # HTML context lines before 'html'.
	html: String!       # HTML lines that the user's selection was made on.
	htmlAfter: String!  # HTML context lines after 'html'.

	textBefore: String! # text context lines before 'text'.
	text: String!       # text lines that the user's selection was made on.
	textAfter: String!  # text context lines after 'text'.

	# Two integers which represent the original user selection of text.
	#
	# In Go syntax, userSelection := text[rangeStart:rangeStart+rangeLength]
	textSelectionRangeStart: Int!  # byte offset into textLines where user selection begins
	textSelectionRangeLength: Int! # length in bytes of the user selection
}
