...
func HandleSignUp(db dbutil.DB) func(w http.ResponseWriter, r *http.Request) {
...
func handleSignUp(db dbutil.DB, failIfNewUserIsNotInitialSiteAdmin bool) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		if r.Method != "POST" {
...
func HandleSignIn(db dbutil.DB) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		usr, err := getByEmailOrUsername(ctx, db, creds.Email)
		if err != nil {
