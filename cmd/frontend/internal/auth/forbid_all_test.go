...
func TestForbidAllMiddleware(t *testing.T) {
	...
	t.Run("disabled", func(t *testing.T) {
		conf.Mock(&conf.UnifiedConfiguration{Core: schema.CoreSiteConfiguration{AuthProviders: []schema.AuthProviders{{Builtin: &schema.BuiltinAuthProvider{Type: "builtin"}}}}})
		defer conf.Mock(nil)
	...
	t.Run("enabled", func(t *testing.T) {
		conf.Mock(&conf.UnifiedConfiguration{Core: schema.CoreSiteConfiguration{}})
		defer conf.Mock(nil)
