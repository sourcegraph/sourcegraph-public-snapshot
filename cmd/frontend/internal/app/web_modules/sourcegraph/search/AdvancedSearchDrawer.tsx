...
namespace Styles {
    ...
    const input = {
        ...
        color: white,
        fontSize: '14px',
        $nest: { '&::placeholder': { color: normalFontColor },
        '&:focus': { outline: 'none' } }
    };

    export const icon = style({ fontSize: '18px', marginRight: '8px' });

    export const container = style(csstips.horizontal, csstips.center, {
        height: '120px',
        backgroundColor: referencesBackgroundColor,
...
export class AdvancedSearchDrawer extends React.Component<{}, SearchState> {
    ...
    public componentDidUpdate(_: {}, prevState: SearchState): void {
    ...
    public onSelect(item: RepoResult): void {
    ...
    public onUpdateRepos(value: string): void {
