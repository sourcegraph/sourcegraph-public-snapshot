...
func mockGatewayDoer(t *testing.T, mockResponse *http.Response) {
	...
	httpcli.CodyGatewayDoer = &mockDoer{
		do: func(r *http.Request) (*http.Response, error) {
			if hasBeenCalled {
				t.Fatalf("mock gateway doer should only be called once")
			}
			hasBeenCalled = true
...
func TestAPI(t *testing.T) {
	...
	t.Run("/api/openai/v1/chat/completions", func(t *testing.T) {
