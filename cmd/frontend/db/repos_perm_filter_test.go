			...
			calls: []authzFilter_call{
				{
					...
					perm:             authz.Read,
					repos:            types.Repo{types.Repo{RepoIDs: types.RepoIDs{Name: "gitolite.mycorp.co/foo"}}},
					expFilteredRepos: types.Repo{types.Repo{RepoIDs: types.RepoIDs{Name: "gitolite.mycorp.co/foo"}}},
				},
				{
