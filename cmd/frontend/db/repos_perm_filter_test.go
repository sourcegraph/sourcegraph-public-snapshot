...
func Test_authzFilter(t *testing.T) {
	...
	//						"gitlab.mine/org/r0":           {},
	//					},
	//					perms: map[extsvc.ExternalAccount][]*types.Repo{
...
// }
//
// func (m *MockAuthzProvider) RepoPerms(ctx context.Context, acct *extsvc.ExternalAccount, repos []*types.Repo) ([]*types.Repo, error) {
// 	retPerms := make([]*types.Repo)
...
// 	}
//
// 	var userPerms []*types.Repo = m.perms[*acct]
...
// }
//
// func (m *MockAuthzProvider) Repos(ctx context.Context, repos []*types.Repo) (mine []*types.Repo, others []*types.Repo) {
// 	mine, others = make([]*types.Repo), make([]*types.Repo)
// 	for repo := range repos {
