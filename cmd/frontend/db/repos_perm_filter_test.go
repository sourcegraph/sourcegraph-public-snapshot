			...
			calls: []authzFilter_call{
				{
					...
					perm:             authz.Read,
					repos:            []*types.Repo{{RepoIDs: types.RepoIDs{ID: 0, Name: "gitolite.mycorp.co/foo"}}},
					expFilteredRepos: []*types.Repo{{RepoIDs: types.RepoIDs{ID: 0, Name: "gitolite.mycorp.co/foo"}}},
				},
				{
