...
Indexes:
    ...
    "campaigns_thread_ids_gin_idx" gin (thread_ids)
Check constraints:
    "campaigns_has_1_namespace" CHECK ((namespace_user_id IS NULL) <> (namespace_org_id IS NULL))
    "campaigns_thread_ids_check" CHECK (jsonb_typeof(thread_ids) = 'object'::text)
Foreign-key constraints:
...
Indexes:
    ...
    "threads_campaign_ids_gin_idx" gin (campaign_ids)
Check constraints:
    "threads_campaign_ids_check" CHECK (jsonb_typeof(campaign_ids) = 'object'::text)
