...
func TestAccessRequestsMutation_SetAccessRequestStatus(t *testing.T) {
	newMockAccessRequestStore := func(t *testing.T, existing *types.AccessRequest, want database.AccessRequestUpdate) database.AccessRequestStore {
		mockStore := database.NewMockAccessRequestStore()
		...
		mockStore.UpdateFunc.SetDefaultHook(func(ctx context.Context, update database.AccessRequestUpdate) (*types.AccessRequest, error) {
	...
	t.Run("existing access request", func(t *testing.T) {
		...
		accessRequestStore := newMockAccessRequestStore(t, existingAccessRequest, database.AccessRequestUpdate{
