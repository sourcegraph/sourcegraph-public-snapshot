...
func TestSearchSuggestions(t *testing.T) {
	...
	t.Run("single term", func(t *testing.T) {
		...
		mockSearchFilesInRepos = func(args *search.Args) ([]*fileMatchResolver, *searchResultsCommon, error) {
			...
			return []*fileMatchResolver{
				{uri: "git://repo?rev#dir/file", JPath: "dir/file", repo: &types.Repo{RepoIDs: types.RepoIDs{Name: "repo"}}, commitID: "rev"},
	...
	t.Run("repogroup: and single term", func(t *testing.T) {
		...
		mockSearchFilesInRepos = func(args *search.Args) ([]*fileMatchResolver, *searchResultsCommon, error) {
			...
			return []*fileMatchResolver{
				{uri: "git://repo?rev#dir/foo-repo3-file-name-match", JPath: "dir/foo-repo3-file-name-match", repo: &types.Repo{RepoIDs: types.RepoIDs{Name: "repo3"}}, commitID: "rev"},
				{uri: "git://repo?rev#dir/foo-repo1-file-name-match", JPath: "dir/foo-repo1-file-name-match", repo: &types.Repo{RepoIDs: types.RepoIDs{Name: "repo1"}}, commitID: "rev"},
				{uri: "git://repo?rev#dir/file-content-match", JPath: "dir/file-content-match", repo: &types.Repo{RepoIDs: types.RepoIDs{Name: "repo"}}, commitID: "rev"},
			}, &searchResultsCommon{}, nil
		}
		defer func() { mockSearchFilesInRepos = nil }()
		...
		mockResolveRepoGroups = func() (map[string][]*types.Repo, error) {
			...
			return map[string][]*types.Repo{
				"sample": {
					&types.Repo{RepoIDs: types.RepoIDs{Name: "foo-repo1"}},
					&types.Repo{RepoIDs: types.RepoIDs{Name: "repo3"}},
				},
			}, nil
		}
	...
	t.Run("repo: field", func(t *testing.T) {
		...
		mockSearchFilesInRepos = func(args *search.Args) ([]*fileMatchResolver, *searchResultsCommon, error) {
			...
			return []*fileMatchResolver{
				{uri: "git://foo-repo?rev#dir/file", JPath: "dir/file", repo: &types.Repo{RepoIDs: types.RepoIDs{Name: "foo-repo"}}, commitID: ""},
			}, &searchResultsCommon{}, nil
		}
		defer func() { mockSearchFilesInRepos = nil }()
	...
	t.Run("repo: and file: field", func(t *testing.T) {
		...
		mockSearchFilesInRepos = func(args *search.Args) ([]*fileMatchResolver, *searchResultsCommon, error) {
			...
			return []*fileMatchResolver{
				{uri: "git://foo-repo?rev#dir/bar-file", JPath: "dir/bar-file", repo: &types.Repo{RepoIDs: types.RepoIDs{Name: "foo-repo"}}, commitID: ""},
			}, &searchResultsCommon{}, nil
		}
		defer func() { mockSearchFilesInRepos = nil }()
