...
func TestSearchSuggestions(t *testing.T) {
	...
	t.Run("single term", func(t *testing.T) {
		...
		db.Mocks.Repos.List = func(_ context.Context, op db.ReposListOptions) ([]*types.Repo, error) {
			wantFoo := db.ReposListOptions{IncludePatterns: []string{"foo"}, OnlyRepoIDs: true, LimitOffset: limitOffset, NoArchived: true} // when treating term as repo: field
			wantAll := db.ReposListOptions{OnlyRepoIDs: true, LimitOffset: limitOffset, NoArchived: true}                                   // when treating term as text query
