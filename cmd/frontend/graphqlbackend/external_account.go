...
func (r *externalAccountResolver) CreatedAt() DateTime { return DateTime{r.account.CreatedAt} }
func (r *externalAccountResolver) UpdatedAt() DateTime { return DateTime{r.account.UpdatedAt} }
