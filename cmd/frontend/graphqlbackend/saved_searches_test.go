...
func TestSavedSearches(t *testing.T) {
	...
	ss.ListSavedSearchesByOrgOrUserFunc.SetDefaultHook(func(_ context.Context, userID, orgId *int32, paginationArgs *dbtypes.PaginationArgs) ([]*types.SavedSearch, error) {
