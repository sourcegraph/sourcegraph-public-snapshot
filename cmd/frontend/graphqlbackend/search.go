...
// nil error.
func handleRepoSearchResult(repoRev *search.RepositoryRevisions, limitHit, timedOut bool, searchErr error) (_ streaming.SearchResultsCommon, fatalErr error) {
	...
	return streaming.SearchResultsCommon{
