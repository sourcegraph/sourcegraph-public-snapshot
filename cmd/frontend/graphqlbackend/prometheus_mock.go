...
// github.com/sourcegraph/sourcegraph/cmd/frontend/graphqlbackend) used for
// unit testing.
...
// surrogateMockPrometheusQuerier is a copy of the prometheusQuerier
// interface (from the package
// github.com/sourcegraph/sourcegraph/cmd/frontend/graphqlbackend). It is
// redefined here as it is unexported in the source packge.
type surrogateMockPrometheusQuerier interface {
	QueryRange(context.Context, string, v1.Range) (model.Value, v1.Warnings, error)
}
...
func NewMockPrometheusQuerierFrom(i surrogateMockPrometheusQuerier) *MockPrometheusQuerier {
	return &MockPrometheusQuerier{
		QueryRangeFunc: &PrometheusQuerierQueryRangeFunc{
