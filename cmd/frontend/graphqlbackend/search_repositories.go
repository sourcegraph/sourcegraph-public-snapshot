...
var mockSearchRepositories func(args *search.TextParameters) ([]SearchResultResolver, *progress.SearchResultsCommon, error)
...
func searchRepositories(ctx context.Context, args *search.TextParameters, limit int32) (res []SearchResultResolver, common *progress.SearchResultsCommon, err error) {
	...
	return results, &progress.SearchResultsCommon{
		IsLimitHit: limitHit,
	}, nil
}
