...
var mockSearchRepositories func(args *search.TextParameters) ([]SearchResultResolver, *streaming.SearchResultsCommon, error)
...
func searchRepositories(ctx context.Context, args *search.TextParameters, limit int32) (res []SearchResultResolver, common *streaming.SearchResultsCommon, err error) {
	...
	return results, &streaming.SearchResultsCommon{
		IsLimitHit: limitHit,
	}, nil
}
