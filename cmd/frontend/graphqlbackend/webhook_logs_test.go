...
func TestWebhookLogConnectionResolver(t *testing.T) {
	...
	createMockStore := func(logs []*types.WebhookLog, next int64, err error) *databasemocks.MockWebhookLogStore {
...
func TestListWebhookLogs(t *testing.T) {
	...
	webhookLogsStore := databasemocks.NewMockWebhookLogStore()
