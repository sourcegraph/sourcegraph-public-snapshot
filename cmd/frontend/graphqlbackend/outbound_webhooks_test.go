	...
	t.Run("site admin", func(t *testing.T) {
		...
		for name, tc := range map[string]struct {
			...
			t.Run(name, func(t *testing.T) {
				...
				store := databasemocks.NewMockOutboundWebhookStore()
...
func fakeUser(t *testing.T, inputCtx context.Context, db *databasemocks.MockDB, siteAdmin bool) (ctx context.Context, user *types.User, store *databasemocks.MockUserStore) {
	t.Helper()
	...
	store = databasemocks.NewMockUserStore()
