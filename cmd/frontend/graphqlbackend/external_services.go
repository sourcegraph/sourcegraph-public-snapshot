...
func (r *schemaResolver) AddExternalService(ctx context.Context, args *addExternalServiceArgs) (*externalServiceResolver, error) {
	...
	if err = backend.SyncExternalService(ctx, r.logger.Scoped("SyncExternalService", ""), externalService, syncExternalServiceTimeout, r.repoupdaterClient); err != nil {
...
func (r *schemaResolver) UpdateExternalService(ctx context.Context, args *updateExternalServiceArgs) (*externalServiceResolver, error) {
	...
	if oldConfig != newConfig {
		err = backend.SyncExternalService(ctx, r.logger.Scoped("SyncExternalService", ""), es, syncExternalServiceTimeout, r.repoupdaterClient)
		if err != nil {
...
func (r *schemaResolver) deleteExternalService(ctx context.Context, id int64, es *types.ExternalService) error {
	...
	go func() {
		if err := backend.SyncExternalService(context.Background(), r.logger.Scoped("SyncExternalService", ""), es, syncExternalServiceTimeout, r.repoupdaterClient); err != nil {
