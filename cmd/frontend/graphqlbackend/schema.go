...
# EXPERIMENTAL (subject to change until Sourcegraph 3.1):
# Any search result that is not a FileMatch, CommitSearchResult, or Repository.
# All new search result types added to Sourcegraph, and any result contributed by
