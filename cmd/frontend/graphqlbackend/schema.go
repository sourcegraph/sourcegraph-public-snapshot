...
type Query {
    ...
    # DEPRECATED
    configurationSubject(id: ID!): ConfigurationSubject @deprecated(reason: "use settingsSubject instead")
...
# A user.
type User implements Node & SettingsSubject & ConfigurationSubject {
...
type Org implements Node & SettingsSubject & ConfigurationSubject {
...
type Site implements SettingsSubject & ConfigurationSubject {
...
# DEPRECATED: Renamed to SettingsSubject.
interface ConfigurationSubject {
    id: ID! @deprecated(reason: "use SettingsSubject instead")
    latestSettings: Settings @deprecated(reason: "use SettingsSubject instead")
    settingsURL: String! @deprecated(reason: "use SettingsSubject instead")
    viewerCanAdminister: Boolean! @deprecated(reason: "use SettingsSubject instead")
    configurationCascade: ConfigurationCascade! @deprecated(reason: "use SettingsSubject.settingsCascade instead")
}
...
type ConfigurationCascade {
    subjects: [ConfigurationSubject!]! @deprecated(reason: "use SettingsCascade.subjects instead")
