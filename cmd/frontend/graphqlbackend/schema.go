...
type Thread implements Node & RepositoryNode & RepositoryAndNumberAddressable & Updatable & ExpCampaignNode & Assignable & Labelable {
...
input ExpUpdateCampaignInput {
    ...
    # The new workflow for the campaign (as JSONC).
    workflowAsJSONCString: JSONCString
...
type ExpCampaign implements Node & Updatable {
    # The unique ID for the campaign.
    id: ID!
    ...
    # The definition of this campaign's workflow.
    workflow: JSONC
