...
type SearchMatch {
    ...
    url: String!
    # A markdown string containing the contents of the result match.
    body: Markdown!
    # A list of objects containing the line, character, and length of matches in the result body.
    # This is used to highlight matches in the match body. Currently, highlights will only be shown on
    # match bodies that are code blocks. If the result body is a code block, exclude the code fence lines
    # in the line number count. This can be left as an empty list if these values are not given by the
    # result provider.
