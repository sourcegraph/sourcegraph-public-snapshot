...
type Query {
    ...
    # A preview of a campaign. The campaign preview is not persisted.
...
type GitCommitConnection {
    # A list of Git commits.
    nodes: [GitCommit!]!
    # The total number of Git commits in the connection.
    totalCount: Int
    # Pagination information.
    pageInfo: PageInfo!
}
...
type Org implements Node & SettingsSubject & Namespace {
    ...
    name: String!
    # Same as Org.name, for consistency with User.
    username: String!
...
# A commentable is an object that can be commented on.
...
# Input arguments for generating a campaign preview.
