...
type ExternalChangeset implements Node & Changeset {
    ...
    # The external URL of the changeset on the code host. Not set when changeset state is UNPUBLISHED or externalState is DELETED or the changeset's data hasn't been synced yet.
