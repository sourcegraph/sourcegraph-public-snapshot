...
=======
    ...
    # The branch of the changesets. TODO(sqs): remove
    branch: String
...
>>>>>>> Stashed changes
    ...
    # The date and time when the campaign spec was applied to this campaign.
    specAppliedAt: DateTime!

    # The user who applied the campaign spec to this campaign.
    specAppliedByUser: User
