...
type Query {
    ...
    # Renders a list of Markdown strings to HTML. Each returned HTML string is already sanitized and
    # escaped and thus is always safe to render.
    renderMarkdowns(markdown: [String!]!, options: MarkdownOptions): [String!]!
...
type SearchMatch {
    ...
    url: String!
    # A markdown string containing the contents of the result match. Currently, code blocks will be rendered as code, and all other
    # markdown syntax will not be rendered specially.
    body: String!
    # A list of objects containing the line, character, and length of matches in the result body.
    # This is used to highlight matches in the match body. Currently, highlights will only be shown on matches that return code blocks
    # This can be left as an empty list if these values are not given by the result provider.
