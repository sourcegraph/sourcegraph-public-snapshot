...
type ThreadsMutation {
    ...
    # Delete a thread. All threads that were associated with or created by this thread remain
    # (and are not deleted when the thread is deleted).
...
input UpdateThreadInput {
    ...
    # The new title of the thread (if non-null).
    title: String
...
type Campaign implements Node {
    ...
    # A list of threads (including issues and changesets) in this campaign.
    threads(
