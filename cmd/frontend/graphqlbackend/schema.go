...
type Mutation {
    ...
    # Updates a user's cached permissions of all external services with authorization enabled.
    updateUserPermissions(input: UpdateUserPermissionsInput!): EmptyResponse!
...
# Input to update a user's cached permissions.
