...
func TestAlertForDiffCommitSearchLimits(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			multiErr:             multierror.Append(&multierror.Error{}, repoLimitAlertErr("diff", 50)),
		...
		},
		{
			...
			multiErr:             multierror.Append(&multierror.Error{}, repoLimitAlertErr("commit", 50)),
		...
		},
		{
			...
			multiErr:             multierror.Append(&multierror.Error{}, timeLimitAlertErr("commit", 10000)),
