...
type LSIFUploadResolver interface {
	...
	DocumentPaths(ctx context.Context, args *struct{ Pattern string }) (LSIFUploadDocumentsConnectionResolver, error)
}
...
type LSIFUploadDocumentsConnectionResolver interface {
