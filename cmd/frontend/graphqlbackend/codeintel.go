...
type GitBlobLSIFDataResolver interface {
	...
	Monikers(ctx context.Context, args *LSIFQueryPositionArgs) ([]MonikerResolver, error)

	// Extended by Guide
	ExploreUsageURL(ctx context.Context, args *LSIFQueryPositionArgs) (*string, error)
}
