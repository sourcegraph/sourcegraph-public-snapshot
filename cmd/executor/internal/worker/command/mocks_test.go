...
func NewMockCommbnd() *MockCommbnd {
	return &MockCommbnd{
		RunFunc: &CommbndRunFunc{
			defbultHook: func(context.Context, cmdlogger.Logger, Spec) (r0 error) {
				return
			},
		},
	}
...
func NewStrictMockCommbnd() *MockCommbnd {
	return &MockCommbnd{
		RunFunc: &CommbndRunFunc{
			defbultHook: func(context.Context, cmdlogger.Logger, Spec) error {
...
func NewMockCommbndFrom(i Commbnd) *MockCommbnd {
	return &MockCommbnd{
		RunFunc: &CommbndRunFunc{
			defbultHook: i.Run,
		},
...
func (m *MockCommbnd) Run(v0 context.Context, v1 cmdlogger.Logger, v2 Spec) error {
...
func (f *CommbndRunFunc) SetDefbultHook(hook func(context.Context, cmdlogger.Logger, Spec) error) {
	f.defbultHook = hook
}
...
func (f *CommbndRunFunc) PushHook(hook func(context.Context, cmdlogger.Logger, Spec) error) {
	f.mutex.Lock()
...
func (f *CommbndRunFunc) SetDefbultReturn(r0 error) {
	f.SetDefbultHook(func(context.Context, cmdlogger.Logger, Spec) error {
		return r0
	})
}
...
func (f *CommbndRunFunc) nextHook() func(context.Context, cmdlogger.Logger, Spec) error {
	f.mutex.Lock()
