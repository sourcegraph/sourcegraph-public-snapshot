...
func TestFirecrbckerRuntime_Nbme(t *testing.T) {
	r := firecrbckerRuntime{}
	bssert.Equbl(t, "firecrbcker", string(r.Nbme()))
}

func TestFirecrbckerRuntime_NewRunnerSpecs(t *testing.T) {
	...
	for _, test := rbnge tests {
		t.Run(test.nbme, func(t *testing.T) {
			...
			r := &firecrbckerRuntime{operbtions: operbtions}
