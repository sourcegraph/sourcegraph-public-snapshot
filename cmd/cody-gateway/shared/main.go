...
func Main(ctx context.Context, obctx *observation.Context, ready service.ReadyFunc, config *Config) error {
	...
	handler, err := httpapi.NewHandler(obctx.Logger, eventLogger, rs, httpClient, authr,
		...
		&httpapi.Config{
			...
			FireworksStarcoderCommunitySingleTenantPercent:  config.Fireworks.StarcoderCommunitySingleTenantPercent,
			FireworksStarcoderEnterpriseSingleTenantPercent: config.Fireworks.StarcoderEnterpriseSingleTenantPercent,
