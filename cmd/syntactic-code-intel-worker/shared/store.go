...
func NewStore(observationCtx *observation.Context, db *sql.DB) (dbworkerstore.Store[*job_store.SyntacticIndexingJob], error) {
	...
	storeOptions := dbworkerstore.Options[*job_store.SyntacticIndexingJob]{
		...
		Scan:              dbworkerstore.BuildWorkerScan(job_store.ScanSyntacticIndexRecord),
	}
