...
func TestRepositoryServiceServer_DeleteRepository(t *testing.T) {
	...
	t.Run("checks for uncloned repo", func(t *testing.T) {
		...
		gs := &tenantManagerServiceServer{svc: NewMockService(), fs: fs}
...
func spawnRepositoryServer(t *testing.T, server *tenantManagerServiceServer) proto.GitserverRepositoryServiceClient {
	t.Helper()
