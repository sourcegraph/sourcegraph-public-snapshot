...
func Main() {
	...
	procfile := []string{
		...
		`symbols: symbols`,
		`lsif-server: node /lsif/out/cmd/server/server.js`,
		`lsif-dump-manager: node /lsif/out/cmd/dump-manager/dump-manager.js`,
		`lsif-dump-processor: node /lsif/out/cmd/dump-processor/dump-processor.js`,
		`searcher: searcher`,
		`replacer: replacer`,
