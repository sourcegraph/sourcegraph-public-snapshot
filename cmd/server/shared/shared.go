...
var defaultEnv = map[string]string{
	...
	"PCI_API_SERVER_URL":     "http://127.0.0.1:3186",
	"PCI_BUNDLE_MANAGER_URL": "http://127.0.0.1:3187",
	"SRC_HTTP_ADDR":          ":8080",
	"SRC_HTTPS_ADDR":         ":8443",
...
func Main() {
	...
	procfile := []string{
		...
		`symbols: symbols`,
		`pci-api-server: node /pci/out/api-server/api.js`,
		`pci-bundle-manager: node /pci/out/bundle-manager/manager.js`,
		`pci-worker: node /pci/out/worker/worker.js`,
		`searcher: searcher`,
		`replacer: replacer`,
