...
var defaultEnv = map[string]string{
	...
	"PRECISE_CODE_INTEL_SERVER_URL":         "http://127.0.0.1:3186",
...
func Main() {
	...
	procfile := []string{
		...
		`symbols: symbols`,
		`precise-code-intel-server: precise-code-intel-server`,
		`precise-code-intel-bundle-manager: precise-code-intel-bundle-manager`,
		`precise-code-intel-converter: precise-code-intel-converter`,
		`searcher: searcher`,
		`replacer: replacer`,
