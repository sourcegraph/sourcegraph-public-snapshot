...
func Main() {
	...
	procfile := []string{
		...
		`prometheus: prometheus -config.file=/etc/prometheus/prometheus_localhost.yml  -storage.local.path=/prometheus-data -web.console.libraries=/etc/prometheus/console_libraries  -web.console.templates=/etc/prometheus/consoles`,
	}
