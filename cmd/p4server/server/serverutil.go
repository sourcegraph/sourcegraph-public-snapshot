...
import (
	...
	"github.com/sourcegraph/sourcegraph/cmd/p4server/server/internal/cacert"
...
func getTlsExternalDoNotInvoke() *tlsConfig {
	...
	if len(c.Certificates) > 0 {
		...
		p, err := writeTempFile("p4server*.crt", b.Bytes())
		if err != nil {
...
// to walkFn. This is a common pattern used in p4server for best effort work.
//
