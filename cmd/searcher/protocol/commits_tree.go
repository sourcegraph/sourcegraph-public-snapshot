...
func (a *AuthorMatches) ToProto() *proto.CommitSearchQueryNode {
	return &proto.CommitSearchQueryNode{
		Value: &proto.CommitSearchQueryNode_AuthorMatches{
...
func (a *CommitterMatches) ToProto() *proto.CommitSearchQueryNode {
	return &proto.CommitSearchQueryNode{
		Value: &proto.CommitSearchQueryNode_CommitterMatches{
...
func (c *CommitBefore) ToProto() *proto.CommitSearchQueryNode {
	return &proto.CommitSearchQueryNode{
		Value: &proto.CommitSearchQueryNode_CommitBefore{
...
func (c *CommitAfter) ToProto() *proto.CommitSearchQueryNode {
	return &proto.CommitSearchQueryNode{
		Value: &proto.CommitSearchQueryNode_CommitAfter{
...
func (m *MessageMatches) ToProto() *proto.CommitSearchQueryNode {
	return &proto.CommitSearchQueryNode{
		Value: &proto.CommitSearchQueryNode_MessageMatches{
...
func (m *DiffMatches) ToProto() *proto.CommitSearchQueryNode {
	return &proto.CommitSearchQueryNode{
		Value: &proto.CommitSearchQueryNode_DiffMatches{
...
func (m *DiffModifiesFile) ToProto() *proto.CommitSearchQueryNode {
	return &proto.CommitSearchQueryNode{
		Value: &proto.CommitSearchQueryNode_DiffModifiesFile{
...
func (c *Boolean) ToProto() *proto.CommitSearchQueryNode {
	return &proto.CommitSearchQueryNode{
		Value: &proto.CommitSearchQueryNode_Boolean{
...
func (o *Operator) ToProto() *proto.CommitSearchQueryNode {
	operands := make([]*proto.CommitSearchQueryNode, 0, len(o.Operands))
	for _, operand := range o.Operands {
		operands = append(operands, operand.ToProto())
	}
	return &proto.CommitSearchQueryNode{
		Value: &proto.CommitSearchQueryNode_Operator{
			Operator: &proto.CommitSearchOperatorNode{
				Kind:     o.Kind.ToProto(),
				Operands: operands,
			},
		},
...
func newOperator(kind OperatorKind, operands ...CommitSearchNode) *Operator {
	return &Operator{
		Kind:     kind,
		Operands: operands,
	}
...
func NewAnd(operands ...CommitSearchNode) CommitSearchNode {
	...
	// P ∧ (Q ∧ R) <=> (P ∧ Q) ∧ R
	flattened := make([]CommitSearchNode, 0, len(operands))
...
func NewOr(operands ...CommitSearchNode) CommitSearchNode {
...
// Optimizations/simplifications:
// - Not(Not(x)) => x
func NewNot(operand CommitSearchNode) CommitSearchNode {
