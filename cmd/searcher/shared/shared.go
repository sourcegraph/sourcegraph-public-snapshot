...
// ParseGitDiffNameStatus returns the paths changedA and changedB for commits A
// and B respectively. It expects to be parsing the output of the command git
// diff -z --name-status --no-renames A B.
