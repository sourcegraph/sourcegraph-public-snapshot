...
func getRemoteURLFunc(
	...
	for _, info := range r.Sources {
		...
		return repos.CloneURL(log.Scoped("getRemoteURLFunc", ""), svc.Kind, svc.Config, r)
	}
...
func editGitHubAppExternalServiceConfigToken(
	...
	token, err := repos.GetOrRenewGitHubAppInstallationAccessToken(ctx, log.Scoped("editGitHubAppExternalServiceConfigToken", ""), externalServiceStore, svc, client, installationID)
	if err != nil {
