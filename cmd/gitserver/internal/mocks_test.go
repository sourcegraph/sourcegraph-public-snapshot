...
func NewMockRepositoryLocker() *MockRepositoryLocker {
	return &MockRepositoryLocker{
		...
		TryAcquireFunc: &RepositoryLockerTryAcquireFunc{
			defaultHook: func(context.Context, api.RepoName, string) (r0 RepositoryLock, r1 bool) {
				return
			},
		},
	}
...
func NewStrictMockRepositoryLocker() *MockRepositoryLocker {
	return &MockRepositoryLocker{
		...
		TryAcquireFunc: &RepositoryLockerTryAcquireFunc{
			defaultHook: func(context.Context, api.RepoName, string) (RepositoryLock, bool) {
...
type RepositoryLockerTryAcquireFunc struct {
	defaultHook func(context.Context, api.RepoName, string) (RepositoryLock, bool)
	hooks       []func(context.Context, api.RepoName, string) (RepositoryLock, bool)
...
// the parameter and result values of this invocation.
func (m *MockRepositoryLocker) TryAcquire(v0 context.Context, v1 api.RepoName, v2 string) (RepositoryLock, bool) {
...
// empty.
func (f *RepositoryLockerTryAcquireFunc) SetDefaultHook(hook func(context.Context, api.RepoName, string) (RepositoryLock, bool)) {
	f.defaultHook = hook
}
...
// hook at the front of the queue and discards it. After the queue is empty,
// the default hook function is invoked for any future action.
func (f *RepositoryLockerTryAcquireFunc) PushHook(hook func(context.Context, api.RepoName, string) (RepositoryLock, bool)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *RepositoryLockerTryAcquireFunc) SetDefaultReturn(r0 RepositoryLock, r1 bool) {
	f.SetDefaultHook(func(context.Context, api.RepoName, string) (RepositoryLock, bool) {
		return r0, r1
	})
}
...
func (f *RepositoryLockerTryAcquireFunc) PushReturn(r0 RepositoryLock, r1 bool) {
	f.PushHook(func(context.Context, api.RepoName, string) (RepositoryLock, bool) {
		return r0, r1
	})
}

func (f *RepositoryLockerTryAcquireFunc) nextHook() func(context.Context, api.RepoName, string) (RepositoryLock, bool) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
