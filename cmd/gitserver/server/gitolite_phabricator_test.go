...
// TODO: Remove Blacklist in 3.19 and delete this test
func TestServer_handleGet_DEPRECATED(t *testing.T) {
	conn := []*schema.GitoliteConnection{{
...
// TODO: Remove Blacklist in 3.19 and delete this test
func TestServer_handleGet_invalid_DEPRECATED(t *testing.T) {
	conn := []*schema.GitoliteConnection{{
		Blacklist: "isblaclist.*",
		Prefix:    "mygitolite.host/",
		Host:      "git@mygitolite.host",
