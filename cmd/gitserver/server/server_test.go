				...
				Results: []protocol.BatchLogResult{
					{
						...
						CommandOutput: "stdout<github.com/foo/bar/.git:git log --format=test deadbeef1>",
						CommandError:  "",
					},
					{
						RepoCommit:    api.RepoCommit{Repo: "github.com/foo/baz", CommitID: "deadbeef2"},
						CommandOutput: "stdout<github.com/foo/baz/.git:git log --format=test deadbeef2>",
						CommandError:  "",
					},
					{
						RepoCommit:    api.RepoCommit{Repo: "github.com/foo/bonk", CommitID: "deadbeef3"},
						CommandOutput: "stdout<github.com/foo/bonk/.git:git log --format=test deadbeef3>",
						CommandError:  "",
					},
				},
			}),
