...
func TestJVMCloneCommand(t *testing.T) {
	...
	createPlaceholderByteCodeJar(t,
		[]byte{0xca, 0xfe, 0xba, 0xbe, 0x00, 0x00, 0x00, java8MajorVersion, 0xab}, dir, exampleByteCodeJar)
	...
	assertCommandOutput(t,
		...
		bareGitDirectory,
		// Assert that Java 8 is used for version 1.
	...
	assertCommandOutput(t,
		...
		bareGitDirectory,
		// Assert that Java 11 is used for version 2.
