...
func Start(ctx context.Context, observationCtx *observation.Context, config *Config, enterpriseInit EnterpriseInit) error {
	...
	allRoutines, err := createBackgroundRoutines(observationCtx, config.Jobs)
	if err != nil {
		return err
	}
