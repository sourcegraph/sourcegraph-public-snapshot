...
func NewExternalAccountsMigratorWithDB(logger log.Logger, db dbutil.DB) *ExternalAccountsMigrator {
	return NewExternalAccountsMigrator(logger, basestore.NewWithDB(db, sql.TxOptions{}))
}
