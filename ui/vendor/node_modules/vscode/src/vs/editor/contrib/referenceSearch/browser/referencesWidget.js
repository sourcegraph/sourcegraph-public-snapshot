...
var Controller = (function (_super) {
    ...
    function Controller(_expandedElements, _revealedReference) {
        var _this = _super.call(this) || this;
        _this._expandedElements = _expandedElements;
        _this._revealedReference = _revealedReference;
        return _this;
    }
...
var ReferenceWidget = (function (_super) {
    ...
    function ReferenceWidget(editor, layoutData, _textModelResolverService, _contextService, _instantiationService) {
        var _this = _super.call(this, editor, { showFrame: false, showArrow: true, isResizeable: true }) || this;
         ...
         */
        _this._expandedElements = {};
        _this._revealedReference = { ref: undefined };
    ...
    ReferenceWidget.prototype._fillBody = function (containerElement) {
        ...
        container.div({ 'class': 'ref-tree inline' }, function (div) {
            var config = {
                ...
                //sorter: new Sorter(),
                controller: new Controller(_this._expandedElements, _this._revealedReference)
            };
            var options = {
    ...
    ReferenceWidget.prototype.isTreeInDefaultState = function () {
        var expandedCount = Object.keys(this._expandedElements).length;
    ...
    ReferenceWidget.prototype.setModel = function (newModel, incrementalUpdate) {
        if (incrementalUpdate === void 0) { incrementalUpdate = false; }
        // clean up
    ...
    ReferenceWidget.prototype._onNewModel = function () {
        ...
        return this._tree.setInput(input).then(function () {
            // Apply any saved state (for incremental updates).
            for (var key in _this._expandedElements) {
                var element = _this._expandedElements[key];
                _this._tree.expand(element).done(null, errors_1.onUnexpectedError);
            }
            if (_this._revealedReference.ref) {
                _this._revealReference(_this._revealedReference.ref);
            }
        });
    };
