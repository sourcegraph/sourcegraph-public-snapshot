...
var RenameController = RenameController_1 = (function () {
    function RenameController(editor, _messageService, _eventService, _textModelResolverService, _progressService, contextKeyService) {
        this.editor = editor;
    ...
    RenameController.prototype._prepareRename = function (newName) {
        ...
        var edit = bulkEdit_1.createBulkEdit(this._eventService, this._textModelResolverService, this.editor);
