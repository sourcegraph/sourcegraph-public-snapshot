...
var findWidget_1 = require("vs/editor/contrib/find/browser/findWidget");
var findOptionsWidget_1 = require("vs/editor/contrib/find/browser/findOptionsWidget");
...
var FindController = (function (_super) {
    ...
    function FindController(editor, contextViewService, contextKeyService, keybindingService) {
        ...
        _this._findOptionsWidget = _this._register(new findOptionsWidget_1.FindOptionsWidget(editor, _this._state, keybindingService));
        return _this;
    }
