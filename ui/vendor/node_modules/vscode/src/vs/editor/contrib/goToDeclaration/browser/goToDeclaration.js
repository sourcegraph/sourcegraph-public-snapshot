...
var DefinitionAction = (function (_super) {
    ...
    DefinitionAction.prototype.run = function (accessor, editor) {
        ...
        return this.getDeclarationsAtPosition(model, pos).then(function (references) {
            ...
            if (result.length === 0) {
                ...
                messageController_1.MessageController.get(editor).showMessage(_this.getNoResultFoundMessage(info), pos);
                return;
            }
    ...
    DefinitionAction.prototype.getNoResultFoundMessage = function (info) {
...
var GoToDefinitionAction = GoToDefinitionAction_1 = (function (_super) {
    ...
    function GoToDefinitionAction() {
        return _super.call(this, new DefinitionActionConfig(), {
            ...
            precondition: contextkey_1.ContextKeyExpr.and(ModeContextKeys.hasDefinitionProvider, ModeContextKeys.isInEmbeddedEditor.toNegated()),
            kbOpts: {
...
var PeekDefinitionAction = (function (_super) {
    ...
    function PeekDefinitionAction() {
        return _super.call(this, new DefinitionActionConfig(void 0, true, false), {
            ...
            precondition: contextkey_1.ContextKeyExpr.and(ModeContextKeys.hasDefinitionProvider, peekViewWidget_1.PeekContext.notInPeekEditor, ModeContextKeys.isInEmbeddedEditor.toNegated()),
            kbOpts: {
                kbExpr: EditorContextKeys.TextFocus,
...
var ImplementationAction = (function (_super) {
    ...
    ImplementationAction.prototype.getDeclarationsAtPosition = function (model, position) {
        return goToDeclaration_1.getImplementationsAtPosition(model, position);
    };
    ImplementationAction.prototype.getNoResultFoundMessage = function (info) {
        return info && info.word
...
var GoToImplementationAction = GoToImplementationAction_1 = (function (_super) {
    ...
    function GoToImplementationAction() {
        return _super.call(this, new DefinitionActionConfig(), {
            ...
            precondition: contextkey_1.ContextKeyExpr.and(ModeContextKeys.hasImplementationProvider, ModeContextKeys.isInEmbeddedEditor.toNegated()),
            kbOpts: {
                kbExpr: EditorContextKeys.TextFocus,
...
var TypeDefinitionAction = (function (_super) {
    ...
    TypeDefinitionAction.prototype.getDeclarationsAtPosition = function (model, position) {
        return goToDeclaration_1.getTypeDefinitionsAtPosition(model, position);
    };
    TypeDefinitionAction.prototype.getNoResultFoundMessage = function (info) {
        return info && info.word
...
var GoToTypeDefintionAction = GoToTypeDefintionAction_1 = (function (_super) {
    ...
    function GoToTypeDefintionAction() {
        return _super.call(this, new DefinitionActionConfig(), {
            ...
            precondition: contextkey_1.ContextKeyExpr.and(ModeContextKeys.hasTypeDefinitionProvider, ModeContextKeys.isInEmbeddedEditor.toNegated()),
            kbOpts: {
                kbExpr: EditorContextKeys.TextFocus,
                primary: 0
            },
...
var PeekTypeDefinitionAction = PeekTypeDefinitionAction_1 = (function (_super) {
            ...
            if (results.length > 1) {
                ...
                _this.textModelResolverService.createModelReference(result_1.uri).then(function (ref) {
                    ...
                    if (model && model.textEditorModel) {
                        ...
                        var to = Math.min(from + GotoDefinitionWithMouseEditorContribution_1.MAX_SOURCE_PREVIEW_LINES, editorModel.getLineCount());
...
var GoToDefinitionAction_1, OpenDefinitionToSideAction_1, GoToImplementationAction_1, PeekImplementationAction_1, GoToTypeDefintionAction_1, PeekTypeDefinitionAction_1, GotoDefinitionWithMouseEditorContribution_1;
