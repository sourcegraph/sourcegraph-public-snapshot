...
var tokenSelectionSupport_1 = require("./tokenSelectionSupport");
    ...
    function GrowSelectionAction() {
        return _super.call(this, true, {
            ...
            kbOpts: {
                ...
                primary: 16384 /* Shift */ | 8192 /* Alt */ | 17 /* RightArrow */,
                mac: { primary: 32768 /* CtrlCmd */ | 4096 /* WinCtrl */ | 16384 /* Shift */ | 17 /* RightArrow */ }
            }
        }) || this;
    }
...
var ShrinkSelectionAction = (function (_super) {
    ...
    function ShrinkSelectionAction() {
        return _super.call(this, false, {
            ...
            kbOpts: {
                kbExpr: editorCommon_1.EditorContextKeys.TextFocus,
                primary: 16384 /* Shift */ | 8192 /* Alt */ | 15 /* LeftArrow */,
                mac: { primary: 32768 /* CtrlCmd */ | 4096 /* WinCtrl */ | 16384 /* Shift */ | 15 /* LeftArrow */ }
            }
        }) || this;
    }
