...
export declare class SnippetController {
    ...
    private _runForAllSelections(snippet, overwriteBefore, overwriteAfter);
    private static _prepareSnippet(editor, selection, snippet, overwriteBefore, overwriteAfter);
