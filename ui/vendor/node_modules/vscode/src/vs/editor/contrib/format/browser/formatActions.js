...
var formatCommand_1 = require("../common/formatCommand");
...
var FormatOnPaste = FormatOnPaste_1 = (function () {
    ...
    FormatOnPaste.prototype.trigger = function (range) {
        ...
        format_1.getDocumentRangeFormattingEdits(model, range, { tabSize: tabSize, insertSpaces: insertSpaces }).then(function (edits) {
            ...
            var command = new formatCommand_1.EditOperationsCommand(edits, _this.editor.getSelection());
            _this.editor.executeCommand(_this.getId(), command);
            alertFormattingEdits(edits);
        });
    };
    FormatOnPaste.prototype.getId = function () {
        return FormatOnPaste_1.ID;
    };
...
FormatOnPaste = FormatOnPaste_1 = __decorate([
    editorCommonExtensions_1.commonEditorContribution,
    __param(1, editorWorkerService_1.IEditorWorkerService)
], FormatOnPaste);
...
var FormatOnType_1, FormatOnPaste_1;
