...
var AccessibilityHelpWidget = (function (_super) {
    ...
    function AccessibilityHelpWidget(editor, contextKeyService, keybindingService) {
        ...
        _this._domNode.className = 'accessibilityHelpWidget';
        styleMutator_1.StyleMutator.setWidth(_this._domNode, AccessibilityHelpWidget.WIDTH);
        styleMutator_1.StyleMutator.setHeight(_this._domNode, AccessibilityHelpWidget.HEIGHT);
        ...
        _this.onblur(_this._domNode, function () {
            _this.hide();
        });
