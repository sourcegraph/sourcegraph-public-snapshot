...
var TokenScanner = (function () {
    ...
    TokenScanner.prototype.next = function () {
        ...
        var standardTokenType = token.standardType;
        ...
        if (!modeBrackets || supports_1.ignoreBracketsInToken(standardTokenType)) {
        ...
        do {
            ...
            if (foundBracket) {
                ...
                this._nextBuff.push(new Token(new range_1.Range(lineNumber, foundBracketStartOffset + 1, lineNumber, foundBracketEndOffset + 1), bracketIsOpen ? 1 /* Open */ : -1 /* Close */, bracketData.modeId + ";" + bracketData.open + ";" + bracketData.close));
