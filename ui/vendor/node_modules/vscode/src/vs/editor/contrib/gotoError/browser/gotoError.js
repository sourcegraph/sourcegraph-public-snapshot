...
var MarkerNavigationWidget = (function (_super) {
    ...
    MarkerNavigationWidget.prototype.showAtMarker = function (marker) {
        ...
        this._model.withoutWatchingEditorPosition(function () {
            var errorWidgetClass = 'marker-error-widget', warningWidgetClass = 'marker-warning-widget';
            // update frame color (only applied on 'show')
            switch (marker.severity) {
                case severity_1.default.Error:
                    _this.setCssClass(errorWidgetClass, warningWidgetClass);
                    break;
                case severity_1.default.Warning:
                case severity_1.default.Info:
                    _this.setCssClass(warningWidgetClass, errorWidgetClass);
                    break;
            }
            _this.show({
