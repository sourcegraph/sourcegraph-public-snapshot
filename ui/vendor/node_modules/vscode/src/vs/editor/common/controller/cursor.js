...
var Cursor = (function (_super) {
    ...
    function Cursor(configuration, model, viewModelHelper, enableEmptySelectionClipboard) {
        ...
        _this.modelUnbinds = [];
        _this.modelUnbinds.push(_this.model.addBulkListener(function (events) {
    ...
    Cursor.prototype._columnSelectMouse = function (ctx) {
        ...
        var result = cursorColumnSelection_1.ColumnSelection.columnSelect(primary.config, primary.viewModel, primary.viewState.selection, validatedViewPosition.lineNumber, ctx.eventData.mouseColumn - 1);
