...
var BaseTextInputAwareCommand = (function (_super) {
    __extends(BaseTextInputAwareCommand, _super);
    function BaseTextInputAwareCommand() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    BaseTextInputAwareCommand.prototype.runCommand = function (accessor, args) {
        var HANDLER = this.getEditorHandler();
    ...
    return BaseTextInputAwareCommand;
}(Command));
var SelectAllCommand = (function (_super) {
    ...
    SelectAllCommand.prototype.getEditorHandler = function () {
        return editorCommon.Handler.SelectAll;
    };
    SelectAllCommand.prototype.getInputHandler = function () {
        return 'selectAll';
    };
...
var UndoCommand = (function (_super) {
    ...
    UndoCommand.prototype.getEditorHandler = function () {
        return H.Undo;
    };
    UndoCommand.prototype.getInputHandler = function () {
        return 'undo';
    };
    return UndoCommand;
}(BaseTextInputAwareCommand));
...
var RedoCommand = (function (_super) {
    ...
    RedoCommand.prototype.getEditorHandler = function () {
        return H.Redo;
    };
    RedoCommand.prototype.getInputHandler = function () {
        return 'redo';
    };
    return RedoCommand;
}(BaseTextInputAwareCommand));
