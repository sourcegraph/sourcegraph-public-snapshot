...
var RichEditSupport = (function () {
    ...
    RichEditSupport.prototype._handleOnEnter = function (modeId, conf) {
        ...
        if (!empty) {
            this.onEnter = new onEnter_1.OnEnterSupport(onEnter);
        }
    };
...
var LanguageConfigurationRegistryImpl = (function () {
    ...
    LanguageConfigurationRegistryImpl.prototype._getElectricCharacterSupport = function (modeId) {
    ...
    LanguageConfigurationRegistryImpl.prototype.getElectricCharacters = function (modeId) {
        var electricCharacterSupport = this._getElectricCharacterSupport(modeId);
    ...
    LanguageConfigurationRegistryImpl.prototype.onElectricCharacter = function (character, context, column) {
        ...
        var electricCharacterSupport = this._getElectricCharacterSupport(scopedLineTokens.modeId);
        if (!electricCharacterSupport) {
            return null;
        }
    ...
    // begin characterPair
    LanguageConfigurationRegistryImpl.prototype._getCharacterPairSupport = function (modeId) {
        var value = this._getRichEditSupport(modeId);
        if (!value) {
            return null;
        }
    ...
    LanguageConfigurationRegistryImpl.prototype.getAutoClosingPairs = function (modeId) {
        var characterPairSupport = this._getCharacterPairSupport(modeId);
        if (!characterPairSupport) {
            return [];
        }
        return characterPairSupport.getAutoClosingPairs();
    };
    LanguageConfigurationRegistryImpl.prototype.getSurroundingPairs = function (modeId) {
        var characterPairSupport = this._getCharacterPairSupport(modeId);
        if (!characterPairSupport) {
            return [];
        }
    ...
    LanguageConfigurationRegistryImpl.prototype.shouldAutoClosePair = function (character, context, column) {
        var scopedLineTokens = supports_1.createScopedLineTokens(context, column - 1);
        var characterPairSupport = this._getCharacterPairSupport(scopedLineTokens.modeId);
        if (!characterPairSupport) {
            return false;
        }
    ...
    // begin onEnter
    LanguageConfigurationRegistryImpl.prototype._getOnEnterSupport = function (modeId) {
        var value = this._getRichEditSupport(modeId);
        if (!value) {
            return null;
        }
    ...
    LanguageConfigurationRegistryImpl.prototype.getRawEnterActionAtPosition = function (model, lineNumber, column) {
        ...
        var onEnterSupport = this._getOnEnterSupport(scopedLineTokens.modeId);
        if (!onEnterSupport) {
            return null;
        }
