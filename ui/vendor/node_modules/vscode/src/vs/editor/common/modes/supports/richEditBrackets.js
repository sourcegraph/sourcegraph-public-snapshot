...
var RichEditBracket = (function () {
    function RichEditBracket(modeId, open, close, forwardRegex, reversedRegex) {
        this.modeId = modeId;
        this.open = open;
        this.close = close;
...
var RichEditBrackets = (function () {
    function RichEditBrackets(modeId, brackets) {
        ...
        this.brackets = brackets.map(function (b) {
            return new RichEditBracket(modeId, b[0], b[1], getRegexForBracketPair({ open: b[0], close: b[1] }), getReversedRegexForBracketPair({ open: b[0], close: b[1] }));
        });
