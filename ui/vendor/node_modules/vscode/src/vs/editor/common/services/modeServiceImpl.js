...
var ModeServiceImpl = (function () {
    ...
    ModeServiceImpl.prototype._getOrCreateMode = function (modeId) {
        if (!this._instantiatedModes.hasOwnProperty(modeId)) {
            this._instantiatedModes[modeId] = this._instantiationService.createInstance(abstractMode_1.FrankensteinMode, {
                id: modeId
            });
            this._onDidCreateMode.fire(this._instantiatedModes[modeId]);
            this._extensionService.activateByEvent("onLanguage:" + modeId).done(null, errors_1.onUnexpectedError);
        }
...
var MainThreadModeServiceImpl = (function (_super) {
    ...
    function MainThreadModeServiceImpl(instantiationService, extensionService, configurationService) {
        ...
        _this._configurationService.onDidUpdateConfiguration(function (e) { return _this.onConfigurationChange(e.config); });
        return _this;
    }
