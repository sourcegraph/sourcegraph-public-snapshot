 ...
 * @internal
 */
export declare type SuggestionType = 'method' | 'function' | 'constructor' | 'field' | 'variable' | 'class' | 'interface' | 'module' | 'property' | 'unit' | 'value' | 'enum' | 'keyword' | 'snippet' | 'text' | 'color' | 'file' | 'reference' | 'customcolor' | 'folder';
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const WorkspaceReferenceProviderRegistry: LanguageFeatureRegistry<WorkspaceReferenceProvider>;
/**
 * @internal
 */
