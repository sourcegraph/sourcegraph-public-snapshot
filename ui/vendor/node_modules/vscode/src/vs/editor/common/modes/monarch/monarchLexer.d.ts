...
export declare class MonarchLexer extends AbstractState {
     ...
     */
    tokenize(stream: LineStream, noConsumeIsOk?: boolean): ITokenizationResult;
}
export declare function createTokenizationSupport(_modeService: IModeService, modeId: string, lexer: monarchCommon.ILexer): modes.ITokenizationSupport;
