...
var EditorModeContext = (function () {
    function EditorModeContext(editor, contextKeyService) {
        ...
        this._hasImplementationProvider = editorCommon_1.ModeContextKeys.hasImplementationProvider.bindTo(contextKeyService);
        ...
        this._hasWorkspaceReferenceProvider = editorCommon_1.ModeContextKeys.hasWorkspaceReferenceProvider.bindTo(contextKeyService);
        ...
        this._isInWalkThrough = editorCommon_1.ModeContextKeys.isInEmbeddedEditor.bindTo(contextKeyService);
