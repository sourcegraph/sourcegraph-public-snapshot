...
var monarchCommon = require("vs/editor/common/modes/monarch/monarchCommon");
...
var MonarchLexer = (function (_super) {
    ...
    function MonarchLexer(modeId, modeService, lexer, stack, embeddedMode) {
        var _this = _super.call(this, modeId) || this;
        _this.id = MonarchLexer.ID++; // for debugging, assigns unique id to each instance
        _this.modeService = modeService;
        _this.lexer = lexer; // (compiled) lexer description
        _this.stack = (stack ? stack : [lexer.start]); // stack of states
        _this.embeddedMode = (embeddedMode ? embeddedMode : null); // are we scanning an embedded section?
        // did we encounter an embedded start on this line?
        // no need for cloning or equality since it is used only within a line
        _this.embeddedEntered = false;
        // regular expression group matching
        // these never need cloning or equality since they are only used within a line match
        _this.groupActions = null;
        _this.groupMatches = null;
        _this.groupMatched = null;
        _this.groupRule = null;
        return _this;
    }
...
function createTokenizationSupport(_modeService, modeId, lexer) {
    return new tokenizationSupport_1.TokenizationSupport(_modeService, modeId, {
        ...
        getNestedMode: function (rawState, locator) {
