...
var LanguageFeatureRegistry = (function () {
    ...
    LanguageFeatureRegistry.prototype.register = function (selector, provider, workspace) {
        var _this = this;
        var entry = {
            selector: selector,
