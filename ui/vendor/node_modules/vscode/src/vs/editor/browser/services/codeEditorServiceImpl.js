    ...
    DecorationRenderHelper.getCSSTextForModelDecorationContentClassName = function (opts) {
        ...
        if (typeof opts !== 'undefined') {
            ...
            if (typeof opts.contentIconPath === 'string') {
                cssTextArr.push(strings.format(this._CSS_MAP.contentIconPath, uri_1.default.file(opts.contentIconPath).toString().replace(/'/g, '%27')));
            }
...
DecorationRenderHelper.border_rules = ['border', 'borderRadius', 'borderColor', 'borderSpacing', 'borderStyle', 'borderWidth'];
var ThemeType;
(function (ThemeType) {
