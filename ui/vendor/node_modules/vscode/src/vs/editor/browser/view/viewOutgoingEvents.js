...
var ViewOutgoingEvents = (function (_super) {
    ...
    ViewOutgoingEvents.prototype.emitMouseDrag = function (e) {
        this._actual.emit(editorCommon_1.EventType.MouseDrag, this._convertViewToModelMouseEvent(e));
    };
    ViewOutgoingEvents.prototype.emitMouseDrop = function (e) {
        this._actual.emit(editorCommon_1.EventType.MouseDrop, this._convertViewToModelMouseEvent(e));
    };
