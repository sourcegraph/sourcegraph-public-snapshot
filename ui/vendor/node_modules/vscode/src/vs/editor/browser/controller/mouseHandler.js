...
var MouseDownOperation = (function (_super) {
    ...
    MouseDownOperation.prototype.start = function (targetType, e) {
        ...
        if (!this._context.configuration.editor.readOnly
            ...
            this._isActive = true;
            this._mouseMoveMonitor.startMonitoring(createMouseMoveEventMerger(null), this._mouseDownThenMoveEventHandler.handler, function () {
    ...
    MouseDownOperation.prototype._getPositionOutsideEditor = function (e) {
        ...
        if (e.posy < editorContent.y) {
            ...
            return new mouseTarget_1.MouseTarget(null, editorCommon.MouseTargetType.OUTSIDE_EDITOR, mouseColumn, new position_1.Position(aboveLineNumber, 1));
        }
        if (e.posy > editorContent.y + editorContent.height) {
            ...
            return new mouseTarget_1.MouseTarget(null, editorCommon.MouseTargetType.OUTSIDE_EDITOR, mouseColumn, new position_1.Position(belowLineNumber, this._context.model.getLineMaxColumn(belowLineNumber)));
        }
        ...
        if (e.posx < editorContent.x) {
            return new mouseTarget_1.MouseTarget(null, editorCommon.MouseTargetType.OUTSIDE_EDITOR, mouseColumn, new position_1.Position(possibleLineNumber, 1));
        }
        if (e.posx > editorContent.x + editorContent.width) {
            return new mouseTarget_1.MouseTarget(null, editorCommon.MouseTargetType.OUTSIDE_EDITOR, mouseColumn, new position_1.Position(possibleLineNumber, this._context.model.getLineMaxColumn(possibleLineNumber)));
        }
        return null;
    };
