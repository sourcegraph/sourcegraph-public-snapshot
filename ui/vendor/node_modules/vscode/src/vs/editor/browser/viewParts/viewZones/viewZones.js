...
var ViewZones = (function (_super) {
    ...
    function ViewZones(context, viewLayout) {
        ...
        _this.domNode.setClassName(editorBrowser_1.ClassNames.VIEW_ZONES);
    ...
    ViewZones.prototype.addZone = function (zone) {
        ...
        var whitespaceId = this._viewLayout.addWhitespace(props.afterViewLineNumber, this._getZoneOrdinal(zone), props.heightInPx);
        var myZone = {
    ...
    ViewZones.prototype.render = function (ctx) {
        var visibleWhitespaces = this._viewLayout.getWhitespaceViewportData();
        var visibleZones = {};
