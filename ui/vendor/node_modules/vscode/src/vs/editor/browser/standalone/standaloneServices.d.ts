...
export declare module StaticServices {
    ...
    const messageService: LazyStaticService<IMessageService>;
    ...
    const progressService: LazyStaticService<IProgressService>;
    const storageService: LazyStaticService<IStorageService>;
    const standaloneColorService: LazyStaticService<IStandaloneColorService>;
}
