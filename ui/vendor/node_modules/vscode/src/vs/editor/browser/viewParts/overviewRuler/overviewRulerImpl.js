...
var OverviewRulerImpl = (function () {
    function OverviewRulerImpl(canvasLeftOffset, cssClassName, scrollHeight, lineHeight, canUseTranslate3d, minimumHeight, maximumHeight, getVerticalOffsetForLine) {
        ...
        this._zoomListener = browser.onDidChangeZoomLevel(function () {
            ...
            _this._domNode.setWidth(_this._zoneManager.getDOMWidth());
            _this._domNode.setHeight(_this._zoneManager.getDOMHeight());
            _this._domNode.domNode.width = _this._zoneManager.getCanvasWidth();
            _this._domNode.domNode.height = _this._zoneManager.getCanvasHeight();
            _this.render(true);
        });
