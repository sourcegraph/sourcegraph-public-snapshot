...
var CodeEditorWidget = (function (_super) {
    ...
    function CodeEditorWidget(domElement, options, instantiationService, codeEditorService, commandService, contextKeyService) {
        ...
        _this.onMouseDrag = event_1.fromEventEmitter(_this, editorCommon.EventType.MouseDrag);
        _this.onMouseDrop = event_1.fromEventEmitter(_this, editorCommon.EventType.MouseDrop);
