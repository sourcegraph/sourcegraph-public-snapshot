...
var menu_1 = require("vs/platform/actions/common/menu");
...
var StandaloneKeybindingService = (function (_super) {
    ...
    StandaloneKeybindingService.prototype._getResolver = function () {
        if (!this._cachedResolver) {
            var defaults = keybindingsRegistry_1.KeybindingsRegistry.getDefaultKeybindings().map(function (k) { return keybindingResolver_1.NormalizedKeybindingItem.fromKeybindingItem(k, true); });
            var overrides = this._dynamicKeybindings.map(function (k) { return keybindingResolver_1.NormalizedKeybindingItem.fromKeybindingItem(k, false); });
            this._cachedResolver = new keybindingResolver_1.KeybindingResolver(defaults, overrides);
        }
        return this._cachedResolver;
    };
    StandaloneKeybindingService.prototype._createResolvedKeybinding = function (kb) {
        return new abstractKeybindingService_1.SimpleResolvedKeybinding(kb);
    };
