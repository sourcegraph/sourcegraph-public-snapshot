...
var MainThreadStatusBar = (function (_super) {
    ...
    function MainThreadStatusBar(statusbarService) {
        ...
        _this.mapIdToDisposable = Object.create(null);
        return _this;
    }
    MainThreadStatusBar.prototype.$setEntry = function (id, extensionId, text, tooltip, command, color, alignment, priority) {
        ...
        this.$dispose(id);
        // Add new
        var disposeable = this.statusbarService.addEntry({ text: text, tooltip: tooltip, command: command, color: color, extensionId: extensionId }, alignment, priority);
