...
export declare class MainProcessExtensionService extends AbstractExtensionService<ActivatedExtension> {
     ...
     */
    constructor(forcedDisabledExtensions: string[], threadService: IThreadService, messageService: IMessageService, environmentService: IEnvironmentService, extensionEnablementService: IExtensionEnablementService);
