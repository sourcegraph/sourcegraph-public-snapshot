...
var ExtHostWorkspace = (function () {
    function ExtHostWorkspace(threadService, workspacePath) {
        ...
        this._workspaceEmitter = new event_1.Emitter();
    }
    ...
    Object.defineProperty(ExtHostWorkspace.prototype, "onDidUpdateWorkspace", {
        get: function () {
    ...
    ExtHostWorkspace.prototype.$setWorkspace = function (resource, state) {
        this._proxy.$setWorkspace(resource, state);
        return winjs_base_1.TPromise.as(void 0);
    };
    ExtHostWorkspace.prototype.$setWorkspaceState = function (workspace, state) {
        this._proxy.$setWorkspaceState(workspace, state);
        return winjs_base_1.TPromise.as(void 0);
    };
    ExtHostWorkspace.prototype.$onDidUpdateWorkspace = function (workspace) {
