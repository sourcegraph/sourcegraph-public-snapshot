...
var MainProcessExtensionService = (function (_super) {
     ...
     */
    function MainProcessExtensionService(threadService, messageService, environmentService, extensionEnablementService) {
        ...
        var disabledExtensions = extensionEnablementService.getGloballyDisabledExtensions().concat(extensionEnablementService.getWorkspaceDisabledExtensions());
        _this.scanExtensions().done(function (extensionDescriptions) {
            _this._onExtensionDescriptions(disabledExtensions.length ? extensionDescriptions.filter(function (e) { return disabledExtensions.indexOf(e.publisher + "." + e.name) === -1; }) : extensionDescriptions);
        });
        return _this;
    }
