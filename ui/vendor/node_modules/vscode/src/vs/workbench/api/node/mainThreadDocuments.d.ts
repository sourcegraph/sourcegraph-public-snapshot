...
export declare class MainThreadDocuments extends MainThreadDocumentsShape {
    ...
    constructor(threadService: IThreadService, modelService: IModelService, modeService: IModeService, eventService: IEventService, textFileService: ITextFileService, codeEditorService: ICodeEditorService, fileService: IFileService, textModelResolverService: ITextModelResolverService, untitledEditorService: IUntitledEditorService);
    dispose(): void;
