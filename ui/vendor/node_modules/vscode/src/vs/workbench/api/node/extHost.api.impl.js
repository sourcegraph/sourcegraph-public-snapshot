...
var extHostDocumentsAndEditors_1 = require("vs/workbench/api/node/extHostDocumentsAndEditors");
...
var extHostProgress_1 = require("vs/workbench/api/node/extHostProgress");
var extHostSCM_1 = require("vs/workbench/api/node/extHostSCM");
...
var extHostTextEditors_1 = require("vs/workbench/api/node/extHostTextEditors");
...
var extHostFunctions_1 = require("vs/workbench/api/node/extHostFunctions");
...
function createApiFactory(initData, threadService, extensionService, contextService) {
    ...
    return function (extension) {
        ...
        var workspace = {
            ...
            onDidRevertTextDocument: function (listener, thisArgs, disposables) {
            ...
            setWorkspaceState: function (workspace, state) {
                return extHostWorkspace.$setWorkspaceState(uri_1.default.parse(workspace.toString()), state);
            },
        ...
        return {
            ...
            // functions
            computeDiff: extHostFunctions_1.computeDiff
        };
    };
}
