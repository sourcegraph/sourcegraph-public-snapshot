...
var MainThreadWorkspace = (function (_super) {
    ...
    function MainThreadWorkspace(searchService, contextService, threadService, textFileService, editorService, textModelResolverService, eventService) {
    ...
    MainThreadWorkspace.prototype.$applyWorkspaceEdit = function (edits) {
        ...
        return bulkEdit_1.bulkEdit(this._eventService, this._textModelResolverService, codeEditor, edits)
            .then(function () { return true; });
    };
    MainThreadWorkspace.prototype.$setWorkspace = function (resource, state) {
        this._contextService.setWorkspace(__assign({}, this._contextService.getWorkspace(), { resource: resource, revState: state }));
        return winjs_base_1.TPromise.as(void 0);
    };
    MainThreadWorkspace.prototype.$setWorkspaceState = function (state) {
        this._contextService.setWorkspace(__assign({}, this._contextService.getWorkspace(), { revState: state }));
        return winjs_base_1.TPromise.as(void 0);
    };
