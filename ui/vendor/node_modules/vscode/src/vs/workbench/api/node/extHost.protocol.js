...
var MainThreadDocumentsShape = (function () {
    ...
    MainThreadDocumentsShape.prototype.$tryRevertAll = function (uris) { throw ni(); };
    MainThreadDocumentsShape.prototype.$tryDeleteDocument = function (uri) { throw ni(); };
...
var MainThreadLanguageFeaturesShape = (function () {
    ...
    MainThreadLanguageFeaturesShape.prototype.$registerOutlineSupport = function (handle, selector, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerCodeLensSupport = function (handle, selector, eventHandle, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$emitCodeLensEvent = function (eventHandle, event, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerDeclaractionSupport = function (handle, selector, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerImplementationSupport = function (handle, selector, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerTypeDefinitionSupport = function (handle, selector, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerHoverProvider = function (handle, selector, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerDocumentHighlightProvider = function (handle, selector, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerReferenceSupport = function (handle, selector, workspace) { throw ni(); };
    /**
     ...
     */
    MainThreadLanguageFeaturesShape.prototype.$notifyProvideReferencesProgress = function (handle, progressHandle, locations) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerWorkspaceReferenceSupport = function (handle, selector, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$notifyProvideWorkspaceReferencesProgress = function (handle, progressHandle, references) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerQuickFixSupport = function (handle, selector, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerDocumentFormattingSupport = function (handle, selector, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerRangeFormattingSupport = function (handle, selector, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerOnTypeFormattingSupport = function (handle, selector, autoFormatTriggerCharacters, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerNavigateTypeSupport = function (handle, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerRenameSupport = function (handle, selector, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerSuggestSupport = function (handle, selector, triggerCharacters, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerSignatureHelpProvider = function (handle, selector, triggerCharacter, workspace) { throw ni(); };
    MainThreadLanguageFeaturesShape.prototype.$registerDocumentLinkProvider = function (handle, selector, workspace) { throw ni(); };
...
var MainThreadWorkspaceShape = (function () {
    ...
    MainThreadWorkspaceShape.prototype.$setWorkspace = function (resource, state) { throw ni(); };
    MainThreadWorkspaceShape.prototype.$setWorkspaceState = function (workspace, state) { throw ni(); };
...
var MainThreadSCMShape = (function () {
    ...
    MainThreadSCMShape.prototype.$onChange = function (id, resources, count, state) { throw ni(); };
...
var ExtHostWorkspaceShape = (function () {
    function ExtHostWorkspaceShape() {
    }
    ExtHostWorkspaceShape.prototype.$onDidUpdateWorkspace = function (workspace) { throw ni(); };
    return ExtHostWorkspaceShape;
}());
exports.ExtHostWorkspaceShape = ExtHostWorkspaceShape;
...
var ExtHostEditorsShape = (function () {
    ...
    ExtHostEditorsShape.prototype.$acceptOptionsChanged = function (id, opts, document) { throw ni(); };
    ExtHostEditorsShape.prototype.$acceptSelectionsChanged = function (id, event, document) { throw ni(); };
    ExtHostEditorsShape.prototype.$acceptEditorPositionData = function (data, document) { throw ni(); };
...
var ExtHostLanguageFeaturesShape = (function () {
    ...
    ExtHostLanguageFeaturesShape.prototype.$provideReferences = function (handle, progressHandle, resource, position, context) { throw ni(); };
    ExtHostLanguageFeaturesShape.prototype.$provideWorkspaceReferences = function (handle, progressHandle, resource, query, hints) { throw ni(); };
...
var ExtHostSCMShape = (function () {
    ...
    ExtHostSCMShape.prototype.$acceptChanges = function (id) { throw ni(); };
...
exports.ExtHostContext = {
    ...
    ExtHostWorkspace: threadService_1.createExtHostContextProxyIdentifier('ExtHostWorkspace', ExtHostWorkspaceShape),
