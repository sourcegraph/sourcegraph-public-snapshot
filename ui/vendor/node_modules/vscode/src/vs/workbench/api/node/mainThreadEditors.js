...
var MainThreadEditors = (function (_super) {
    ...
    function MainThreadEditors(threadService, workbenchEditorService, editorGroupService, telemetryService, editorService, eventService, modelService) {
        ...
        _this._textEditorsMap = Object.create(null);
        _this._activeTextEditor = null;
        _this._visibleEditors = [];
        _this._editorPositionData = null;
        _this._editorTracker = new mainThreadEditorsTracker_1.MainThreadEditorsTracker(editorService, modelService);
        _this._toDispose.push(_this._editorTracker);
        _this._toDispose.push(_this._editorTracker.onTextEditorAdd(function (textEditor) { return _this._onTextEditorAdd(textEditor); }));
        _this._toDispose.push(_this._editorTracker.onTextEditorRemove(function (textEditor) { return _this._onTextEditorRemove(textEditor); }));
        _this._toDispose.push(_this._editorTracker.onDidUpdateTextEditors(function () { return _this._updateActiveAndVisibleTextEditors(); }));
        _this._toDispose.push(_this._editorTracker.onChangedFocusedTextEditor(function (focusedTextEditorId) { return _this._updateActiveAndVisibleTextEditors(); }));
    ...
    MainThreadEditors.prototype.$tryShowTextDocument = function (resource, position, preserveFocus) {
        ...
        return this._workbenchEditorService.openEditor(input, position).then(function (editor) {
            ...
            var syncEditorId = findEditor();
            if (syncEditorId) {
                return winjs_base_1.TPromise.as(syncEditorId);
            }
    ...
    MainThreadEditors.prototype.$trySetDecorations = function (id, key, ranges) {
        var numEditors = Object.keys(this._textEditorsMap).length;
