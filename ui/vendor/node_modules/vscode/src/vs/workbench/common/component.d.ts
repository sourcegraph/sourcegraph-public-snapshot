...
export declare class WorkbenchComponent extends Disposable implements IWorkbenchComponent {
    private _toUnbind;
    private id;
    ...
    */
    protected getMemento(storageService: IStorageService, scope?: Scope): any;
    /**
