...
var EditorStacksModel = (function () {
    ...
    EditorStacksModel.prototype.next = function (jumpGroups) {
        this.ensureLoaded();
        if (!this.activeGroup) {
            return null;
        }
    ...
    EditorStacksModel.prototype.previous = function (jumpGroups) {
        this.ensureLoaded();
        if (!this.activeGroup) {
            return null;
        }
    ...
    EditorStacksModel.prototype.handleOnEditorClosed = function (event) {
        ...
        if (!this.isOpen(editor)) {
            ...
            if (editor instanceof editor_1.SideBySideEditorInput) {
                [editor.master, editor.details].forEach(function (editor) {
