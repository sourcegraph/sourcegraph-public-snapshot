...
var StringEditorInput = (function (_super) {
    ...
    function StringEditorInput(name, description, value, modeId, singleton, instantiationService) {
        var _this = _super.call(this) || this;
        _this.instantiationService = instantiationService;
        _this.name = name;
        _this.description = description;
        _this.value = value;
        _this.modeId = modeId || modesRegistry_1.PLAINTEXT_MODE_ID;
    ...
    StringEditorInput.prototype.getTypeId = function () {
    ...
    StringEditorInput.prototype.resolve = function (refresh) {
        ...
        var model = this.instantiationService.createInstance(stringEditorModel_1.StringEditorModel, this.value, this.modeId, this.getResource());
    ...
    StringEditorInput.prototype.matches = function (otherInput) {
        ...
        if (otherInput instanceof StringEditorInput) {
            ...
            var otherResource = otherStringEditorInput.getResource();
