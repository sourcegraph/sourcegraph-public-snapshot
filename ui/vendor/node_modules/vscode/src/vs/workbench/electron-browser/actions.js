...
var ShowStartupPerformance = (function (_super) {
    ...
    ShowStartupPerformance.prototype.run = function () {
        ...
        setTimeout(function () {
            ...
            var fingerprint = timers.fingerprint;
            ...
            console.table(_this.getFingerprintTable(nodeModuleLoadTime));
            if (nodeModuleLoadDetails) {
                console.groupCollapsed('node_modules Load Details');
                console.table(nodeModuleLoadDetails);
                console.groupEnd();
            }
            console.groupEnd();
        }, 1000);
    ...
    ShowStartupPerformance.prototype.getFingerprintTable = function (nodeModuleLoadTime) {
        var table = [];
        var fingerprint = timers.fingerprint;
...
var OpenRecentAction = (function (_super) {
    ...
    OpenRecentAction.prototype.openRecent = function (recentFiles, recentFolders) {
        ...
        var runPick = function (path, context) {
            ...
            _this.windowsService.windowOpen([path], newWindow);
        };
