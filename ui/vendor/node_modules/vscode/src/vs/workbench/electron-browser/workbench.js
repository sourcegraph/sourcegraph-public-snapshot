...
var clipboardService_2 = require("vs/platform/clipboard/electron-browser/clipboardService");
...
var progressService2_1 = require("vs/workbench/services/progress/browser/progressService2");
...
var Workbench = (function () {
    function Workbench(parent, container, options, serviceCollection, instantiationService, untitledEditorService, contextService, storageService, lifecycleService, messageService, configurationService, telemetryService, environmentService, windowService) {
        var _this = this;
            ...
            var workbenchDone_1 = function (error) {
                ...
                if (_this.callbacks && _this.callbacks.onWorkbenchStarted) {
                    _this.callbacks.onWorkbenchStarted({
                        ...
                        themeId: _this.themeService.getColorTheme().id
                    });
                }
                if (error) {
    ...
    Workbench.prototype.resolveEditorsToOpen = function () {
        ...
        if (this.hasFilesToCreateOpenOrDiff) {
            ...
            var filesToDiff = wbopt.filesToDiff;
            // Files to diff is exclusive
            if (filesToDiff && filesToDiff.length === 2) {
                return this.editorService.createInput({ leftResource: filesToDiff[0].resource, rightResource: filesToDiff[1].resource }).then(function (input) { return [{ input: input, options: editor_2.EditorOptions.create({ pinned: true }) }]; });
            }
            else {
                var inputs_1 = [];
                var options_1 = [];
                ...
                options_1.push.apply(options_1, filesToCreate.map(function (r) { return editor_2.EditorOptions.create({ pinned: true }); }));
                // Files to open
                ...
                return winjs_base_1.TPromise.join(filesToOpenInputPromise).then(function (inputsToOpen) {
                    ...
                    options_1.push.apply(options_1, filesToOpen_1.map(function (resourceInput) {
                        var options = editor_2.TextEditorOptions.from(resourceInput) || editor_2.EditorOptions.create({ pinned: true });
                        options.pinned = true;
                        return options;
                    }));
            ...
            return this.backupFileService.hasBackups().then(function (hasBackups) {
                ...
                return winjs_base_1.TPromise.as([{ input: _this.untitledEditorService.createOrGet() }]);
            });
        }
    ...
    Workbench.prototype.initServices = function () {
        ...
        // Backup File Service
        this.backupFileService = this.instantiationService.createInstance(backupFileService_1.BackupFileService);
        ...
        serviceCollection.set(resolverService_1.ITextModelResolverService, new descriptors_1.SyncDescriptor(textModelResolverService_1.TextModelResolverService));
        ...
        // Theme Service
        this.themeService = this.instantiationService.createInstance(themeService_2.WorkbenchThemeService, document.body);
        serviceCollection.set(themeService_1.IWorkbenchThemeService, this.themeService);
        // Configuration Resolver
        var workspace = this.contextService.getWorkspace();
        serviceCollection.set(configurationResolver_1.IConfigurationResolverService, new descriptors_1.SyncDescriptor(configurationResolverService_1.ConfigurationResolverService, workspace ? workspace.resource : null, process.env));
    ...
    Workbench.prototype.getCustomTitleBarStyle = function () {
        ...
        if (platform_2.isMacintosh && isDev) {
    ...
    Workbench.prototype.setPanelHidden = function (hidden, skipLayout) {
        ...
        return promise.then(function () {
            // Remember in settings
            _this.storageService.store(Workbench.panelHiddenSettingKey, hidden ? 'true' : 'false', storage_1.StorageScope.WORKSPACE);
            // Layout
            if (!skipLayout) {
                _this.workbenchLayout.layout();
            }
    ...
    Workbench.prototype.shutdownComponents = function (reason) {
        ...
        this.storageService.store(Workbench.zenModeActiveSettingKey, (zenConfig.restore || reason === lifecycle_2.ShutdownReason.RELOAD) && this.zenMode.active, storage_1.StorageScope.WORKSPACE);
