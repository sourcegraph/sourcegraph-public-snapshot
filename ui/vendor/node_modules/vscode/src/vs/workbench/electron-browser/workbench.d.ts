...
export declare class Workbench implements IPartService {
    ...
    private zenMode;
    constructor(parent: HTMLElement, container: HTMLElement, options: IOptions, serviceCollection: ServiceCollection, instantiationService: IInstantiationService, untitledEditorService: IUntitledEditorService, contextService: IWorkspaceContextService, storageService: IStorageService, lifecycleService: ILifecycleService, messageService: IMessageService, configurationService: WorkspaceConfigurationService, telemetryService: ITelemetryService, environmentService: IEnvironmentService, windowService: IWindowService);
