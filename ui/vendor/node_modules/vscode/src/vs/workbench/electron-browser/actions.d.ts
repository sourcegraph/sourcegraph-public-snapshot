...
export declare class ShowStartupPerformance extends Action {
    ...
    static ID: string;
    static LABEL: string;
    constructor(id: string, label: string, windowService: IWindowService, timerService: ITimerService, environmentService: IEnvironmentService);
    run(): TPromise<boolean>;
