...
var ResourceModelCollection = (function (_super) {
    ...
    function ResourceModelCollection(instantiationService) {
    ...
    ResourceModelCollection.prototype.resolveTextModelContent = function (key) {
        ...
        return async_1.first(factories).then(function (model) {
            if (!model) {
                ...
                return winjs_base_1.TPromise.wrapError('resource is not available');
            }
            return model;
        });
    };
...
var TextModelResolverService = (function () {
    function TextModelResolverService(textFileService, untitledEditorService, instantiationService, modelService, modeService) {
    ...
    TextModelResolverService.prototype._createModelReference = function (resource) {
        ...
        if (resource.scheme === 'git' || resource.scheme === 'zap') {
            return this.textFileService.models.loadOrCreate(resource).then(function (model) {
                return _this.modeService.getOrCreateModeByFilenameOrFirstLine(resource.fragment).then(function (mode) {
        ...
        if (resource.scheme === 'inmemory') {
            ...
            if (!cachedModel) {
                return winjs_base_1.TPromise.wrapError('Cant resolve inmemory resource');
            }
