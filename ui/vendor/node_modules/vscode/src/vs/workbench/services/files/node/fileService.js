...
var FileService = (function () {
    ...
    FileService.prototype.resolveContent = function (resource, options) {
        var _this = this;
        return this.doResolveContent(resource, options, function (resource, etag, enc) { return _this.resolveFileContent(resource, etag, enc); });
    };
    FileService.prototype.resolveStreamContent = function (resource, options) {
        var _this = this;
        return this.doResolveContent(resource, options, function (resource, etag, enc) { return _this.resolveFileStreamContent(resource, etag, enc); });
    };
            ...
            return createParentsPromise.then(function () {
                ...
                if (encodingToWrite === encoding.UTF16be || encodingToWrite === encoding.UTF16le || encodingToWrite === encoding.UTF8_with_bom) {
                    ...
                    if (options.overwriteEncoding) {
                        ...
                        addBomPromise = async_1.nfcall(encoding.detectEncodingByBOM, absolutePath).then(function (enc) { return enc === encoding.UTF8; }); // otherwise preserve it if found
                    }
                }
    ...
    FileService.prototype.resolveFileStreamContent = function (resource, etag, enc) {
        var _this = this;
        var absolutePath = this.toAbsolutePath(resource);
    ...
    FileService.prototype.resolveFileContent = function (resource, etag, enc) {
        return this.resolveFileStreamContent(resource, etag, enc).then(function (streamContent) {
        ...
        if (!watcher) {
            ...
            watcher.on('change', function (eventType, filename) {
                ...
                _this.fileChangesWatchDelayer.trigger(function () {
                    ...
                    // Emit
                    _this.eventEmitter.emit(files_1.EventType.FILE_CHANGES, common_1.toFileChangesEvent(normalizedEvents));
                    return winjs_base_1.TPromise.as(null);
                });
            });
            // Errors
