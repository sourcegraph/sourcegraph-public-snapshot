...
export declare class ConfigurationResolverService implements IConfigurationResolverService {
    ...
    private _execPath;
    constructor(workspaceRoot: uri, envVariables: {
        [key: string]: string;
    ...
    private resolveString(value);
    private resolveConfigVariable(value, originalValue);
    private resolveLiteral(values);
    private resolveAnyLiteral<T>(values);
    private resolveArray(value);
    private resolveAnyArray<T>(value);
    /**
