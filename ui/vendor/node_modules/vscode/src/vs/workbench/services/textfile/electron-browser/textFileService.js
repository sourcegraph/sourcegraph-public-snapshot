...
var textFileService_1 = require("vs/workbench/services/textfile/common/textFileService");
...
var TextFileService = (function (_super) {
    ...
    function TextFileService(contextService, fileService, untitledEditorService, lifecycleService, instantiationService, telemetryService, configurationService, modeService, windowService, environmentService, messageService, backupFileService, storageService, windowsService, editorGroupService) {
        var _this = _super.call(this, lifecycleService, contextService, configurationService, telemetryService, fileService, untitledEditorService, instantiationService, messageService, environmentService, backupFileService, editorGroupService, windowsService) || this;
    ...
    TextFileService.prototype.showHotExitMessage = function () {
        var key = 'hotExit/hasShownMessage';
        var hasShownMessage = !!this.storageService.get(key, storage_1.StorageScope.GLOBAL);
        if (!hasShownMessage) {
            this.storageService.store(key, true, storage_1.StorageScope.GLOBAL);
            var opts = {
                title: product_1.default.nameLong,
...
TextFileService = __decorate([
    ...
    __param(8, windowService_1.IWindowIPCService),
    ...
    __param(13, windows_1.IWindowsService),
    __param(14, groupService_1.IEditorGroupService)
], TextFileService);
