...
var FancyResolvedKeybinding = (function (_super) {
    __extends(FancyResolvedKeybinding, _super);
    function FancyResolvedKeybinding(actual) {
        var _this = _super.call(this) || this;
        _this._actual = actual;
        return _this;
    }
    FancyResolvedKeybinding.prototype.getLabel = function () {
        return keybindingLabels_1.KeybindingLabels.toCustomLabel(this._actual, nativeKeymap_1.getNativeLabelProvider());
    };
    FancyResolvedKeybinding.prototype.getAriaLabel = function () {
        return keybindingLabels_1.KeybindingLabels.toCustomLabel(this._actual, nativeKeymap_1.getNativeAriaLabelProvider());
    };
    FancyResolvedKeybinding.prototype.getHTMLLabel = function () {
        return keybindingLabels_1.KeybindingLabels.toCustomHTMLLabel(this._actual, nativeKeymap_1.getNativeLabelProvider());
    };
    FancyResolvedKeybinding.prototype.getElectronAccelerator = function () {
        if (platform.isWindows) {
            // electron menus always do the correct rendering on Windows
            return keybindingLabels_1.KeybindingLabels._toElectronAccelerator(this._actual);
        }
        var usLabel = keybindingLabels_1.KeybindingLabels._toUSLabel(this._actual);
    ...
    FancyResolvedKeybinding.prototype.getUserSettingsLabel = function () {
        return keybindingLabels_1.KeybindingLabels.toUserSettingsLabel(this._actual);
    };
    return FancyResolvedKeybinding;
}(keyCodes_1.ResolvedKeybinding));
exports.FancyResolvedKeybinding = FancyResolvedKeybinding;
var WorkbenchKeybindingService = (function (_super) {
    __extends(WorkbenchKeybindingService, _super);
    function WorkbenchKeybindingService(windowElement, contextKeyService, commandService, telemetryService, messageService, environmentService, statusBarService) {
        ...
        var data = nativeKeymap_1.getCurrentKeyboardLayout();
    ...
    WorkbenchKeybindingService.prototype._getResolver = function () {
        if (!this._cachedResolver) {
            ...
            var overrides = this._getExtraKeybindings(this._firstTimeComputingResolver).map(function (k) { return keybindingResolver_1.NormalizedKeybindingItem.fromKeybindingItem(k, false); });
    ...
    WorkbenchKeybindingService.prototype._createResolvedKeybinding = function (kb) {
        return new FancyResolvedKeybinding(kb);
    };
    WorkbenchKeybindingService.prototype.getLabelFor = function (keybinding) {
        return keybindingLabels_1.KeybindingLabels.toCustomLabel(keybinding, nativeKeymap_1.getNativeLabelProvider());
    };
