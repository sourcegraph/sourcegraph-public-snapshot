...
function appendKeyBindingLabel(label, keyBinding, keyBindingService2) {
    ...
    if (typeof keyBinding === 'number') {
        resolvedKb = keyBindingService2.resolveKeybinding(keyCodes_1.createKeybinding(keyBinding));
    }
    else {
...
exports.findInFolderCommand = function (accessor, resource) {
    ...
    if (!uri_1.default.isUri(resource) && contextService.hasWorkspace()) {
...
var ReplaceAllAction = (function (_super) {
    ...
    Object.defineProperty(ReplaceAllAction, "KEY_BINDING", {
        get: function () {
            return 2048 /* CtrlCmd */ | 1024 /* Shift */ | 3 /* Enter */;
        },
        enumerable: true,
        configurable: true
    });
...
var ReplaceAction = (function (_super) {
    ...
    Object.defineProperty(ReplaceAction, "KEY_BINDING", {
        get: function () {
            return 1024 /* Shift */ | 2048 /* CtrlCmd */ | 22 /* KEY_1 */;
        },
        enumerable: true,
        configurable: true
    });
    ...
    ReplaceAction.prototype.hasToOpenFile = function () {
        ...
        if (file) {
            return files_2.isEqual(file.fsPath, this.element.parent().resource().fsPath);
        }
        return false;
    };
