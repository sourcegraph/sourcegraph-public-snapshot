...
export declare class StackFrame implements debug.IStackFrame {
    ...
    getMostSpecificScopes(range: IRange): TPromise<debug.IScope[]>;
...
export declare class Process implements debug.IProcess {
    ...
    constructor(configuration: debug.IConfig, _session: debug.ISession & debug.ITreeElement);
...
export declare class Breakpoint implements debug.IBreakpoint {
    ...
    condition: string;
    hitCondition: string;
    respectColumn: boolean;
    verified: boolean;
    idFromAdapter: number;
    message: string;
    private id;
    constructor(uri: uri, lineNumber: number, column: number, enabled: boolean, condition: string, hitCondition: string, respectColumn: boolean);
    getId(): string;
}
...
export declare class ThreadAndProcessIds implements debug.ITreeElement {
    processId: string;
    threadId: number;
...
export declare class Model implements debug.IModel {
    ...
    addProcess(configuration: debug.IConfig, session: debug.ISession & debug.ITreeElement): Process;
