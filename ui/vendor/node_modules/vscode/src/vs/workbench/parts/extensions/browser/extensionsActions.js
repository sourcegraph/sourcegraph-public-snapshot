...
var UninstallAction = (function (_super) {
    ...
    UninstallAction.prototype.update = function () {
        ...
        var installedExtensions = this.extensionsWorkbenchService.local.filter(function (e) { return e.identifier === _this.extension.identifier; });
...
var DropDownMenuActionItem = (function (_super) {
    ...
    DropDownMenuActionItem.prototype.getActions = function () {
        ...
        for (var _i = 0, _a = this.menuActionGroups; _i < _a.length; _i++) {
            var menuActions = _a[_i];
            var filtered = menuActions.filter(function (a) { return a.enabled; });
            if (filtered.length > 0) {
                actions = actions.concat(filtered, [new actionbar_1.Separator()]);
            }
        }
...
var ManageExtensionActionItem = (function (_super) {
    __extends(ManageExtensionActionItem, _super);
    function ManageExtensionActionItem(action, instantiationService, contextMenuService) {
        return _super.call(this, action, [
            [instantiationService.createInstance(EnableForWorkspaceAction, nls_1.localize('enableForWorkspaceAction.label', "Enable (Workspace)")),
                instantiationService.createInstance(EnableGloballyAction, nls_1.localize('enableAlwaysAction.label', "Enable")),
                ...
                instantiationService.createInstance(DisableGloballyAction, nls_1.localize('disableAlwaysAction.label', "Disable"))],
            [instantiationService.createInstance(UninstallAction)]
        ], contextMenuService) || this;
    }
    return ManageExtensionActionItem;
}(DropDownMenuActionItem));
ManageExtensionActionItem = __decorate([
    __param(1, instantiation_1.IInstantiationService),
    __param(2, contextView_1.IContextMenuService)
], ManageExtensionActionItem);
exports.ManageExtensionActionItem = ManageExtensionActionItem;
var ManageExtensionAction = (function (_super) {
    ...
    function ManageExtensionAction(workspaceContextService, extensionsWorkbenchService, extensionEnablementService, instantiationService) {
        ...
        _this.instantiationService = instantiationService;
        _this.disposables = [];
        _this._actionItem = _this.instantiationService.createInstance(ManageExtensionActionItem, _this);
    ...
    ManageExtensionAction.prototype.update = function () {
        ...
        if (this.extension) {
            ...
            this.class = this.enabled || state === extensions_1.ExtensionState.Uninstalling ? ManageExtensionAction.Class : ManageExtensionAction.NoExtensionClass;
...
ManageExtensionAction.NoExtensionClass = ManageExtensionAction.Class + " no-extension";
...
var EnableAction = (function (_super) {
    ...
    function EnableAction(instantiationService, extensionsWorkbenchService, extensionEnablementService) {
        ...
        _this.extensionEnablementService = extensionEnablementService;
        _this.disposables = [];
        _this._actionItem = _this.instantiationService.createInstance(EnableActionItem, _this);
        _this.disposables.push(_this._actionItem);
        _this.disposables.push(_this.extensionsWorkbenchService.onChange(function () { return _this.update(); }));
        _this.update();
        return _this;
    ...
    EnableAction.prototype.update = function () {
        ...
        this.enabled = this.extension.state === extensions_1.ExtensionState.Installed && (this.extension.disabledGlobally || this.extension.disabledForWorkspace) && this.extensionEnablementService.canEnable(this.extension.identifier);
...
var DisableAction = (function (_super) {
    ...
    function DisableAction(instantiationService, extensionsWorkbenchService) {
        ...
        _this.extensionsWorkbenchService = extensionsWorkbenchService;
        _this.disposables = [];
        _this._actionItem = _this.instantiationService.createInstance(DisableActionItem, _this);
        _this.disposables.push(_this._actionItem);
        _this.disposables.push(_this.extensionsWorkbenchService.onChange(function () { return _this.update(); }));
        _this.update();
        return _this;
...
var EnableActionItem = (function (_super) {
    __extends(EnableActionItem, _super);
    function EnableActionItem(action, instantiationService, contextMenuService) {
        return _super.call(this, action, [[instantiationService.createInstance(EnableForWorkspaceAction, EnableForWorkspaceAction.LABEL), instantiationService.createInstance(EnableGloballyAction, EnableGloballyAction.LABEL)]], contextMenuService) || this;
    }
    return EnableActionItem;
}(DropDownMenuActionItem));
EnableActionItem = __decorate([
    __param(1, instantiation_1.IInstantiationService),
    __param(2, contextView_1.IContextMenuService)
], EnableActionItem);
exports.EnableActionItem = EnableActionItem;
var DisableActionItem = (function (_super) {
    __extends(DisableActionItem, _super);
    function DisableActionItem(action, instantiationService, contextMenuService) {
        return _super.call(this, action, [[instantiationService.createInstance(DisableForWorkspaceAction, DisableForWorkspaceAction.LABEL), instantiationService.createInstance(DisableGloballyAction, DisableGloballyAction.LABEL)]], contextMenuService) || this;
    }
    return DisableActionItem;
}(DropDownMenuActionItem));
DisableActionItem = __decorate([
    __param(1, instantiation_1.IInstantiationService),
    __param(2, contextView_1.IContextMenuService)
], DisableActionItem);
exports.DisableActionItem = DisableActionItem;
...
var ReloadAction = (function (_super) {
    ...
    ReloadAction.prototype.computeReloadState = function (runningExtensions) {
        var _this = this;
        var isInstalled = this.extensionsWorkbenchService.local.some(function (e) { return e.identifier === _this.extension.identifier; });
        ...
        var filteredExtensions = runningExtensions.filter(function (e) { return e.id === _this.extension.identifier; });
...
var ShowWorkspaceRecommendedExtensionsAction = (function (_super) {
    ...
    function ShowWorkspaceRecommendedExtensionsAction(id, label, contextService, viewletService) {
        var _this = _super.call(this, id, label, null, !!contextService.getWorkspace()) || this;
        _this.viewletService = viewletService;
        return _this;
    }
...
var DisableAllWorkpsaceAction = (function (_super) {
    ...
    DisableAllWorkpsaceAction.prototype.update = function () {
        this.enabled = !!this.workspaceContextService.getWorkspace() && this.extensionsWorkbenchService.local.some(function (e) { return e.type === extensionManagement_1.LocalExtensionType.User && !e.disabledForWorkspace && !e.disabledGlobally; });
    };
...
var EnableAllAction = (function (_super) {
    ...
    EnableAllAction.prototype.update = function () {
        var _this = this;
        this.enabled = this.extensionsWorkbenchService.local.some(function (e) { return _this.extensionEnablementService.canEnable(e.identifier) && e.disabledGlobally; });
    };
...
var EnableAllWorkpsaceAction = (function (_super) {
    ...
    EnableAllWorkpsaceAction.prototype.update = function () {
        var _this = this;
        this.enabled = !!this.workspaceContextService.getWorkspace() && this.extensionsWorkbenchService.local.some(function (e) { return _this.extensionEnablementService.canEnable(e.identifier) && !e.disabledGlobally && e.disabledForWorkspace; });
    };
