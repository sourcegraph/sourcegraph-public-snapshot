...
var gitScm_1 = require("./gitScm");
var IGitService = git.IGitService;
var StatusUpdater = (function () {
    function StatusUpdater(gitService, activityBarService, messageService, configurationService) {
        var _this = this;
    ...
    StatusUpdater.prototype.onGitServiceChange = function () {
        ...
        if (this.gitService.getState() !== git.ServiceState.OK) {
            ...
            this.progressBadgeDelayer.trigger(function () {
                _this.badgeHandle = _this.activityBarService.showActivity('workbench.view.git', new activityBarService_1.ProgressBadge(function () { return nls.localize('gitProgressBadge', 'Running git status'); }), 'git-viewlet-label-progress');
            });
        }
    };
...
function registerContributions() {
    ...
    platform.Registry.as(ext.Extensions.Workbench).registerWorkbenchContribution(gitScm_1.GitSCMProvider);
