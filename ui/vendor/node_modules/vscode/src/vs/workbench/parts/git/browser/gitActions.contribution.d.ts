...
export declare class RevertRangesAction extends baseeditor.EditorInputAction {
    private editorService;
    private messageService;
    static ID: string;
    static LABEL: string;
    private editor;
    constructor(editor: tdeditor.TextDiffEditor, editorService: IWorkbenchEditorService, messageService: IMessageService);
    isEnabled(): boolean;
    run(): TPromise<any>;
    private updateEnablement();
}
