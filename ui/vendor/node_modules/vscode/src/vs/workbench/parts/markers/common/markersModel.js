...
var MarkersModel = (function () {
    ...
    MarkersModel.prototype.toFilteredResource = function (entry) {
        ...
        for (var i = 0; i < entry.value.length; i++) {
            ...
            if (entry.key.scheme !== network_1.Schemas.walkThrough && entry.key.scheme !== network_1.Schemas.walkThroughSnippet && (!this._filterOptions.hasFilters() || this.filterMarker(m))) {
