...
export declare abstract class AbstractSearchAndReplaceAction extends Action {
     ...
     */
    getElementToFocusAfterRemoved(viewer: ITree, elementToBeRemoved: FileMatchOrMatch): FileMatchOrMatch;
    getNextElementAfterRemoved(viewer: ITree, element: FileMatchOrMatch): FileMatchOrMatch;
    getPreviousElementAfterRemoved(viewer: ITree, element: FileMatchOrMatch): FileMatchOrMatch;
...
export declare class ReplaceAllAction extends AbstractSearchAndReplaceAction {
    ...
    static readonly KEY_BINDING: number;
    constructor(viewer: ITree, fileMatch: FileMatch, viewlet: SearchViewlet, replaceService: IReplaceService, keyBindingService2: IKeybindingService, telemetryService: ITelemetryService);
    run(): TPromise<any>;
}
export declare class ReplaceAction extends AbstractSearchAndReplaceAction {
    ...
    private telemetryService;
    static readonly KEY_BINDING: number;
    constructor(viewer: ITree, element: Match, viewlet: SearchViewlet, replaceService: IReplaceService, keyBindingService2: IKeybindingService, editorService: IWorkbenchEditorService, telemetryService: ITelemetryService);
    run(): TPromise<any>;
