...
var FileDragAndDrop = (function () {
    ...
    FileDragAndDrop.prototype.getDragURI = function (tree, stat) {
        if (stat.isDirectory) {
            return uri_1.default.from({ scheme: 'folder', path: stat.resource.fsPath, authority: stat.resource.authority }).toString(); // indicates that we are dragging a folder
        }
