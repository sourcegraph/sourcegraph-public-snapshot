...
var TreeExplorerView = (function (_super) {
    ...
    function TreeExplorerView(viewletState, treeNodeProviderId, actionRunner, headerSize, messageService, keybindingService, contextMenuService, contextService, instantiationService, treeExplorerService) {
    ...
    TreeExplorerView.prototype.createViewer = function (container) {
        ...
        var filter = null;
        var dnd = null;
        var accessibilityProvider = null;
        return new treeImpl_1.Tree(container.getHTMLElement(), {
