...
export declare class ProcessRunnerSystem extends EventEmitter implements ITaskSystem {
    ...
    constructor(configuration: TaskRunnerConfiguration, markerService: IMarkerService, modelService: IModelService, telemetryService: ITelemetryService, outputService: IOutputService, configurationResolverService: IConfigurationResolverService, outputChannelId: string, hasErrors: boolean);
