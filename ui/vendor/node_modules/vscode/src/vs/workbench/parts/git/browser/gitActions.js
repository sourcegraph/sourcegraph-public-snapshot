...
var BaseUndoAction = (function (_super) {
    ...
    function BaseUndoAction(id, label, className, gitService, messageService, fileService, editorService, contextService) {
        var _this = _super.call(this, id, label, className, gitService) || this;
        _this.editorService = editorService;
...
var UndoAction = (function (_super) {
    ...
    function UndoAction(gitService, messageService, fileService, editorService, contextService) {
        return _super.call(this, UndoAction.ID, nls.localize('undoChanges', "Clean"), 'git-action undo', gitService, messageService, fileService, editorService, contextService) || this;
    }
    return UndoAction;
}(BaseUndoAction));
UndoAction.ID = 'workbench.action.git.undo';
UndoAction = __decorate([
    __param(0, git_1.IGitService), __param(1, message_1.IMessageService), __param(2, files_1.IFileService), __param(3, editorService_1.IWorkbenchEditorService), __param(4, workspace_1.IWorkspaceContextService)
], UndoAction);
exports.UndoAction = UndoAction;
var GlobalUndoAction = (function (_super) {
    __extends(GlobalUndoAction, _super);
    function GlobalUndoAction(gitService, messageService, fileService, editorService, contextService) {
        return _super.call(this, GlobalUndoAction.ID, nls.localize('undoAllChanges', "Clean All"), 'git-action undo', gitService, messageService, fileService, editorService, contextService) || this;
    }
...
var CommitAmendAction = (function (_super) {
    __extends(CommitAmendAction, _super);
    function CommitAmendAction(commitState, gitService) {
        return _super.call(this, commitState, CommitAction.ID, nls.localize('commitStagedAmend', "Commit Staged (Amend)"), 'git-action commit-amend', gitService) || this;
    }
    CommitAmendAction.prototype.commit = function () {
        return this.gitService.commit(this.commitState.getCommitMessage(), true);
    };
    return CommitAmendAction;
}(BaseCommitAction));
CommitAmendAction.ID = 'workbench.action.git.commitAmend';
CommitAmendAction = __decorate([
    __param(1, git_1.IGitService)
], CommitAmendAction);
...
var PullWithRebaseAction = (function (_super) {
    ...
    function PullWithRebaseAction(id, label, gitService) {
        if (id === void 0) { id = PullWithRebaseAction.ID; }
        if (label === void 0) { label = PullWithRebaseAction.LABEL; }
        return _super.call(this, id, label, gitService) || this;
    }
