...
var MergeDecoratorBoundToModel = (function (_super) {
    ...
    function MergeDecoratorBoundToModel(editor, model, filePath, gitService) {
        ...
        _this._register(model.onDidChangeContent(function () { return delayer.trigger(function () { return _this.redecorate(); }); }));
        _this._register(gitModel.addListener2(git_1.ModelEvents.STATUS_MODEL_UPDATED, function () { return delayer.trigger(function () { return _this.redecorate(); }); }));
        return _this;
    }
...
// TODO@Joao: remove
var MergeDecoratorWrapper = MergeDecoratorWrapper_1 = (function (_super) {
    __extends(MergeDecoratorWrapper, _super);
    function MergeDecoratorWrapper(editor, instantiationService) {
        var _this = _super.call(this) || this;
        _this.editor = editor;
        if (scmPreview_1.default.enabled) {
            return _this;
        }
        _this.decorator = instantiationService.createInstance(MergeDecorator, editor);
        return _this;
    }
    MergeDecoratorWrapper.prototype.getId = function () {
        return MergeDecoratorWrapper_1.ID;
    };
    MergeDecoratorWrapper.prototype.dispose = function () {
        if (this.decorator) {
            this.decorator.dispose();
            this.decorator = null;
        }
    };
    return MergeDecoratorWrapper;
}(lifecycle_1.Disposable));
MergeDecoratorWrapper.ID = 'vs.git.editor.merge.decoratorwrapper';
MergeDecoratorWrapper = MergeDecoratorWrapper_1 = __decorate([
    editorBrowserExtensions_1.editorContribution,
    __param(1, instantiation_1.IInstantiationService)
], MergeDecoratorWrapper);
exports.MergeDecoratorWrapper = MergeDecoratorWrapper;
var MergeDecoratorWrapper_1;
