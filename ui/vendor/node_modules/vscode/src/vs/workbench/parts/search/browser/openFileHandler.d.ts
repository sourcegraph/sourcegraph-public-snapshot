...
export declare class OpenFileHandler extends QuickOpenHandler {
    ...
    private cacheState;
    constructor(editorGroupService: IEditorGroupService, instantiationService: IInstantiationService, themeService: IWorkbenchThemeService, contextService: IWorkspaceContextService, searchService: ISearchService);
