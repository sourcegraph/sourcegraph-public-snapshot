    ...
    SearchRenderer.prototype.renderContents = function (tree, element, domElement, previousCleanupFn) {
        ...
        if (element instanceof searchModel_1.FileMatch) {
            ...
            rightRenderer = function (right) {
                ...
                new countBadge_1.CountBadge(right, len, len > 1 ? nls.localize('searchMatches', "{0} matches found", len) : nls.localize('searchMatch', "{0} match found", len));
                return null;
            };
...
var SearchController = (function (_super) {
    ...
    function SearchController(viewlet, instantiationService) {
        ...
        _this.downKeyBindingDispatcher.set(16 /* UpArrow */, _this.onUp.bind(_this));
        // Open to side
        _this.upKeyBindingDispatcher.set(platform.isMacintosh ? 256 /* WinCtrl */ | 3 /* Enter */ : 2048 /* CtrlCmd */ | 3 /* Enter */, _this.onEnter.bind(_this));
        // Delete
        _this.downKeyBindingDispatcher.set(platform.isMacintosh ? 2048 /* CtrlCmd */ | 1 /* Backspace */ : 20 /* Delete */, function (tree, event) { _this.onDelete(tree, event); });
        // Cancel search
