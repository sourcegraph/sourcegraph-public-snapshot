...
var WatermarkContribution = (function () {
    ...
    WatermarkContribution.prototype.create = function () {
        ...
        var folder = this.contextService.hasWorkspace();
        ...
        update();
        watermark.build(container.firstElementChild, 0);
        layout();
