...
var CheckoutCommand = (function () {
    function CheckoutCommand(gitService, messageService, configurationService) {
    ...
    CheckoutCommand.prototype.getResults = function (input) {
        ...
        var checkoutType = config.checkoutType;
        var includeTags = checkoutType === 'all' || checkoutType === 'tags';
        var includeRemotes = checkoutType === 'all' || checkoutType === 'remote';
        ...
        var tags = includeTags ? refs.filter(function (ref) { return ref.type === git_1.RefType.Tag; }) : [];
        var remoteHeads = includeRemotes ? refs.filter(function (ref) { return ref.type === git_1.RefType.RemoteHead; }) : [];
...
var GitCommandQuickOpenHandler = (function (_super) {
    ...
    function GitCommandQuickOpenHandler(quickOpenService, gitService, messageService, configurationService) {
