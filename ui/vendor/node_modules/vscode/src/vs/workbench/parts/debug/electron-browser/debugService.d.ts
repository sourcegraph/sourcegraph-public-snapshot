...
export declare class DebugService implements debug.IDebugService {
    ...
    constructor(storageService: IStorageService, editorService: IWorkbenchEditorService, textFileService: ITextFileService, viewletService: IViewletService, panelService: IPanelService, messageService: IMessageService, partService: IPartService, windowsService: IWindowsService, windowService: IWindowIPCService, telemetryService: ITelemetryService, contextService: IWorkspaceContextService, contextKeyService: IContextKeyService, lifecycleService: ILifecycleService, instantiationService: IInstantiationService, extensionService: IExtensionService, markerService: IMarkerService, taskService: ITaskService, fileService: IFileService, configurationService: IConfigurationService);
    ...
    focusStackFrameAndEvaluate(stackFrame: debug.IStackFrame, process?: debug.IProcess): TPromise<void>;
    ...
    private doCreateProcess(configuration);
