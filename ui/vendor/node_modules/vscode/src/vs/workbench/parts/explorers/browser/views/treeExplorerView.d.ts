...
export declare class TreeExplorerView extends CollapsibleViewletView {
    ...
    private listService;
    constructor(viewletState: TreeExplorerViewletState, treeNodeProviderId: string, actionRunner: IActionRunner, headerSize: number, messageService: IMessageService, keybindingService: IKeybindingService, contextMenuService: IContextMenuService, contextService: IWorkspaceContextService, instantiationService: IInstantiationService, treeExplorerService: ITreeExplorerService, listService: IListService);
