...
export declare class AutoFetcher implements IAutoFetcher, IDisposable {
    ...
    constructor(gitService: GitService, messageService: IMessageService, editorService: IWorkbenchEditorService, configurationService: IConfigurationService, instantiationService: IInstantiationService);
...
export declare class GitService extends EventEmitter implements IGitService {
    ...
    constructor(raw: IRawGitService, instantiationService: IInstantiationService, fileService: IFileService, messageService: IMessageService, editorService: IWorkbenchEditorService, outputService: IOutputService, textFileService: ITextFileService, contextService: IWorkspaceContextService, lifecycleService: ILifecycleService, storageService: IStorageService, configurationService: IConfigurationService);
