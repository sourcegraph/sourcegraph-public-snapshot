...
var openRepoHandler_1 = require("vs/workbench/parts/search/browser/openRepoHandler");
/* tslint:disable:no-unused-variable */
var openSymbolHandler = require("vs/workbench/parts/search/browser/openSymbolHandler");
/* tslint:enable:no-unused-variable */
var openRepoHandler = require("vs/workbench/parts/search/browser/openRepoHandler");
...
exports.OpenRepoHandler = openRepoHandler.OpenRepoHandler;
var OpenAnythingHandler = (function (_super) {
    ...
    function OpenAnythingHandler(messageService, instantiationService, configurationService, telemetryService) {
        ...
        _this.openRepoHandler = instantiationService.createInstance(openRepoHandler_1.OpenRepoHandler);
    ...
    OpenAnythingHandler.prototype.getResults = function (searchValue) {
        ...
        var promiseFactory = function () {
            ...
            if (_this.includeSymbols && !searchWithRange && !path.isAbsolute(searchValue)) {
                resultPromises.push(_this.openRepoHandler.getResults(searchValue));
            }
            else {
