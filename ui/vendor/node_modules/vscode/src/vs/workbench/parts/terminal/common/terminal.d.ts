...
export declare const TERMINAL_PANEL_ID = "workbench.panel.terminal";
export declare const TERMINAL_SERVICE_ID = "terminalService";
export declare const TERMINAL_DEFAULT_RIGHT_CLICK_COPY_PASTE: boolean;
...
export declare const KEYBINDING_CONTEXT_TERMINAL_TEXT_SELECTED: RawContextKey<boolean>;
/** A keybinding context key that is set when the integrated terminal does not have text selected. */
export declare const KEYBINDING_CONTEXT_TERMINAL_TEXT_NOT_SELECTED: ContextKeyExpr;
