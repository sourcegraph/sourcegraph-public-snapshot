...
var RawDebugSession = (function (_super) {
    ...
    function RawDebugSession(id, debugServerPort, adapter, customTelemetryService, messageService, telemetryService, outputService, terminalService, nativeTerminalService, configurationService) {
        ...
        _this.allThreadsContinued = false;
        _this.sentPromises = [];
    ...
    RawDebugSession.prototype.startServer = function () {
        var _this = this;
        return this.adapter.getAdapterExecutable().then(function (ae) { return _this.launchServer(ae).then(function () {
...
RawDebugSession = __decorate([
    ...
    __param(8, execution_1.ITerminalService),
