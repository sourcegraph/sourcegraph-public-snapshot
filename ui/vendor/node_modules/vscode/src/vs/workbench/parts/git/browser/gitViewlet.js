...
var GitViewlet = (function (_super) {
    ...
    function GitViewlet(telemetryService, progressService, instantiationService, gitService) {
        var _this = _super.call(this, contrib.VIEWLET_ID, telemetryService) || this;
        ...
        _this.toDispose = [];
        var views = [
            _this.instantiationService.createInstance(changes.ChangesView, _this.getActionRunner()),
            _this.instantiationService.createInstance(empty.EmptyView, _this, _this.getActionRunner()),
            _this.instantiationService.createInstance(gitless.GitlessView),
            new notroot.NotRootView(),
            _this.instantiationService.createInstance(noworkspace.NoWorkspaceView, _this.getActionRunner()),
            new disabledView_1.DisabledView(),
            _this.instantiationService.createInstance(hugeView_1.HugeView)
        ];
        views.forEach(function (v) {
            _this.views[v.ID] = v;
            _this.toDispose.push(v);
        });
        _this.toUnbind.push(_this.gitService.addBulkListener2(function () { return _this.onGitServiceChanges(); }));
        return _this;
    }
    // GitView.IController
...
GitViewlet = __decorate([
    __param(0, telemetry_1.ITelemetryService), __param(1, progress_1.IProgressService), __param(2, instantiation_1.IInstantiationService), __param(3, IGitService)
], GitViewlet);
