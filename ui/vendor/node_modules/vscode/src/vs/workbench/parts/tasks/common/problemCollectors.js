...
var AbstractProblemCollector = (function (_super) {
    ...
    function AbstractProblemCollector(problemMatchers, modelService) {
        ...
        _this.matchers = Object.create(null);
        _this.bufferLength = 1;
        ...
        _this.buffer = [];
        _this.activeMatcher = null;
        _this._numberOfMatches = 0;
        _this.openModels = Object.create(null);
        _this.modelListeners = [];
        _this.modelService.onModelAdded(function (model) {
            _this.openModels[model.uri.toString()] = true;
        }, _this, _this.modelListeners);
        _this.modelService.onModelRemoved(function (model) {
            delete _this.openModels[model.uri.toString()];
        }, _this, _this.modelListeners);
        _this.modelService.getModels().forEach(function (model) { return _this.openModels[model.uri.toString()] = true; });
        return _this;
    }
...
var StartStopProblemCollector = (function (_super) {
    ...
    function StartStopProblemCollector(problemMatchers, markerService, modelService, strategy) {
        ...
        var _this = _super.call(this, problemMatchers, modelService) || this;
        // Current State
        _this.currentResource = null;
        _this.currentResourceAsString = null;
        _this.markers = Object.create(null);
        ...
        _this.currentResourcesWithMarkers = Object.create(null);
        _this.reportedResourcesWithMarkers = Object.create(null);
...
var WatchingProblemCollector = (function (_super) {
    ...
    function WatchingProblemCollector(problemMatchers, markerService, modelService) {
        ...
        _this.resourcesToClean = Object.create(null);
        _this.ignoreOpenResourcesByOwner = Object.create(null);
