...
import { ISearchProgressItem, ISearchComplete, ISearchQuery, IPatternInfo, IFileMatch } from 'vs/platform/search/common/search';
...
export declare class FileMatch extends Disposable {
    ...
    constructor(_query: IPatternInfo, _parent: SearchResult, rawMatch: IFileMatch, modelService: IModelService, replaceService: IReplaceService);
    ...
    private updatesMatchesForLine(lineNumber);
    private updateMatches(matches);
