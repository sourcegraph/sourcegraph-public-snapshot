...
var OutputEditorInput = (function (_super) {
    ...
    function OutputEditorInput(outputChannel, instantiationService, outputService, panelService) {
        var _this = _super.call(this, nls.localize('output', "Output"), outputChannel ? nls.localize('outputChannel', "for '{0}'", outputChannel.label) : '', '', output_1.OUTPUT_MIME, true, instantiationService) || this;
        _this.outputChannel = outputChannel;
        _this.outputService = outputService;
        _this.panelService = panelService;
        _this.bufferedOutput = '';
        _this.toDispose = [];
        _this.toDispose.push(_this.outputService.onOutput(_this.onOutputReceived, _this));
        _this.toDispose.push(_this.outputService.onActiveOutputChannel(function () { return _this.scheduleOutputAppend(); }));
        _this.toDispose.push(_this.panelService.onDidPanelOpen(function (panel) {
            if (panel.getId() === output_1.OUTPUT_PANEL_ID) {
                _this.appendOutput();
            }
        }));
        _this.appendOutputScheduler = new async_1.RunOnceScheduler(function () {
            if (_this.isVisible()) {
                _this.appendOutput();
            }
    ...
    OutputEditorInput.prototype.getTypeId = function () {
