...
import { ITree, IAccessibilityProvider, ContextMenuEvent, IDataSource, IRenderer, IDragAndDropData, IDragOverReaction } from 'vs/base/parts/tree/browser/tree';
...
export declare class WatchExpressionsRenderer implements IRenderer {
    ...
    private toDispose;
    private actionProvider;
    constructor(actionProvider: IActionProvider, actionRunner: IActionRunner, debugService: debug.IDebugService, contextViewService: IContextViewService);
    getHeight(tree: ITree, element: any): number;
    getTemplateId(tree: ITree, element: any): string;
    renderTemplate(tree: ITree, templateId: string, container: HTMLElement): any;
    renderElement(tree: ITree, element: any, templateId: string, templateData: any): void;
...
export declare class BreakpointsRenderer implements IRenderer {
    ...
    constructor(actionProvider: BreakpointsActionProvider, actionRunner: IActionRunner, contextService: IWorkspaceContextService, debugService: debug.IDebugService, contextViewService: IContextViewService);
    getHeight(tree: ITree, element: any): number;
    getTemplateId(tree: ITree, element: any): string;
    renderTemplate(tree: ITree, templateId: string, container: HTMLElement): any;
    renderElement(tree: ITree, element: any, templateId: string, templateData: any): void;
