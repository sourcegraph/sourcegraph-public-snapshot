...
var HtmlPreviewPart = (function (_super) {
    ...
    function HtmlPreviewPart(telemetryService, textModelResolverService, themeService, openerService, contextService) {
        var _this = _super.call(this, HtmlPreviewPart.ID, telemetryService) || this;
        ...
        _this._openerService = openerService;
        _this._baseUrl = contextService.toResource('/');
        return _this;
    }
    Object.defineProperty(HtmlPreviewPart.prototype, "_model", {
        get: function () { return this._modelRef.object.textEditorModel; },
        enumerable: true,
        configurable: true
    });
    ...
    Object.defineProperty(HtmlPreviewPart.prototype, "webview", {
        get: function () {
            var _this = this;
            if (!this._webview) {
                this._webview = new webview_1.default(this._container, document.querySelector('.monaco-editor-background'), { nodeintegration: true });
    ...
    HtmlPreviewPart.prototype.setInput = function (input, options) {
        ...
        return _super.prototype.setInput.call(this, input, options).then(function () {
            ...
            return _this._textModelResolverService.createModelReference(resourceUri).then(function (ref) {
