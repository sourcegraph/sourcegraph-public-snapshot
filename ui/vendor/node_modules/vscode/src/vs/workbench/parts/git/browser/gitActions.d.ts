...
export declare class UndoAction extends BaseUndoAction {
    static ID: string;
    constructor(gitService: IGitService, messageService: IMessageService, fileService: IFileService, editorService: IWorkbenchEditorService, contextService: IWorkspaceContextService);
}
...
export declare class CommitAmendAction extends BaseCommitAction {
    static ID: string;
    constructor(commitState: ICommitState, gitService: IGitService);
    protected commit(): Promise;
}
export declare class CommitSignedOffAction extends BaseCommitAction {
    static ID: string;
    constructor(commitState: ICommitState, gitService: IGitService);
    protected commit(): Promise;
}
...
export declare class StageAndCommitSignedOffAction extends StageAndCommitAction {
    static ID: string;
    constructor(commitState: ICommitState, gitService: IGitService);
    protected commit(): Promise;
}
...
export declare class PushToRemoteAction extends GitAction {
    private quickOpenService;
    static ID: string;
    static LABEL: string;
    constructor(id: string, label: string, gitService: IGitService, quickOpenService: IQuickOpenService);
...
export declare class SyncAction extends GitAction {
    ...
    static ID: string;
    static LABEL: string;
    constructor(id: string, label: string, gitService: IGitService, configurationService: IConfigurationService, configurationEditingService: IConfigurationEditingService, choiceService: IChoiceService);
    protected isEnabled(): boolean;
    run(context?: any): Promise;
    private sync();
}
