...
var ExtensionsViewlet = (function (_super) {
    ...
    function ExtensionsViewlet(telemetryService, galleryService, extensionManagementService, progressService, instantiationService, editorService, editorInputService, listService, extensionsWorkbenchService, tipsService, messageService, viewletService, extensionService, modeService) {
    ...
    ExtensionsViewlet.prototype.create = function (parent) {
        ...
        var onKeyDown = event_1.chain(event_2.domEvent(this.searchBox, 'keydown'))
            .filter(function () { return _this.list.length > 0; })
    ...
    ExtensionsViewlet.prototype.query = function (value) {
        ...
        if (!value || /@installed/i.test(value)) {
            ...
            return this.extensionsWorkbenchService.queryLocal()
                ...
                .then(function (result) { return result.filter(function (e) { return e.type === extensionManagement_1.LocalExtensionType.User && e.name.toLowerCase().indexOf(value) > -1; }); })
        ...
        if (/@outdated/i.test(value)) {
            ...
            return this.extensionsWorkbenchService.queryLocal()
                .then(function (result) { return result.sort(function (e1, e2) { return e1.displayName.localeCompare(e2.displayName); }); })
                .then(function (extensions) { return extensions.filter(function (extension) { return extension.outdated && extension.name.toLowerCase().indexOf(value) > -1; }); })
                .then(function (result) { return new paging_1.PagedModel(result); });
        }
        if (/@disabled/i.test(value)) {
            ...
            return this.extensionsWorkbenchService.queryLocal()
                ...
                .then(function (runningExtensions) { return result.filter(function (e) { return runningExtensions.every(function (r) { return !extensionManagementUtil_1.areSameExtensions(r, e); }) && e.name.toLowerCase().indexOf(value) > -1; }); }); })
                .then(function (result) { return new paging_1.PagedModel(result); });
        }
        ...
        if (extensionRegex.test(query.value)) {
            ...
            if (names_1.length) {
                var namesOptions = objects_1.assign({}, options, { names: names_1 });
        ...
        return winjs_base_1.TPromise.join(pagers).then(function (pagers) {
            var pager = pagers.length === 2 ? paging_1.mergePagers(pagers[0], pagers[1]) : pagers[0];
...
ExtensionsViewlet = __decorate([
    ...
    __param(11, viewlet_2.IViewletService),
...
var StatusUpdater = (function () {
    ...
    StatusUpdater.prototype.onServiceChange = function () {
        ...
        if (this.extensionsWorkbenchService.local.some(function (e) { return e.state === extensions_1.ExtensionState.Installing; })) {
            this.badgeHandle = this.activityBarService.showActivity(extensions_1.VIEWLET_ID, new activityBarService_1.ProgressBadge(function () { return nls_1.localize('extensions', "Extensions"); }), 'extensions-badge progress-badge');
            return;
        }
        ...
        if (outdated > 0) {
            ...
            this.badgeHandle = this.activityBarService.showActivity(extensions_1.VIEWLET_ID, badge, 'extensions-badge count-badge');
        }
    };
