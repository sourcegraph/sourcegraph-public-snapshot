...
var TerminalPanel = (function (_super) {
    ...
    function TerminalPanel(_configurationService, _contextMenuService, _instantiationService, _keybindingService, _terminalService, _themeService, telemetryService) {
        var _this = _super.call(this, terminal_1.TERMINAL_PANEL_ID, telemetryService) || this;
    ...
    TerminalPanel.prototype.create = function (parent) {
        ...
        this._register(this._themeService.onDidColorThemeChange(function (theme) { return _this._updateTheme(theme); }));
            ...
            if (!_this._cancelContextMenu) {
                ...
                _this._contextMenuService.showContextMenu({
                    ...
                    getKeyBinding: function (action) {
                        var kb = _this._keybindingService.lookupKeybinding(action.id);
                        if (kb) {
                            return kb;
                        }
                        return null;
    ...
    TerminalPanel.prototype._updateTheme = function (colorTheme) {
        var _this = this;
        if (!colorTheme) {
            colorTheme = this._themeService.getColorTheme();
        }
        var baseThemeId = colorTheme.getBaseThemeId();
