...
export declare class ExplorerView extends CollapsibleViewletView {
    ...
    private autoReveal;
    private settings;
    constructor(viewletState: FileViewletState, actionRunner: IActionRunner, settings: any, headerSize: number, messageService: IMessageService, contextMenuService: IContextMenuService, instantiationService: IInstantiationService, editorGroupService: IEditorGroupService, eventService: IEventService, contextService: IWorkspaceContextService, progressService: IProgressService, editorService: IWorkbenchEditorService, fileService: IFileService, partService: IPartService, keybindingService: IKeybindingService, contextKeyService: IContextKeyService, configurationService: IConfigurationService);
     ...
     */
    refresh(workspaceUpdated?: boolean): TPromise<void>;
    private doRefresh(workspaceUpdated?);
    /**
