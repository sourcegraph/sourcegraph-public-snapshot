...
var SearchViewlet = (function (_super) {
    ...
    function SearchViewlet(telemetryService, eventService, editorService, editorGroupService, progressService, messageService, storageService, contextViewService, instantiationService, configurationService, contextService, searchService, contextKeyService, keybindingService, replaceService, untitledEditorService, preferencesService) {
        ...
        _this.toUnbind.push(_this.eventService.addListener2(files_1.EventType.FILE_CHANGES, function (e) { return _this.onFilesChanged(e); }));
    ...
    SearchViewlet.prototype.reLayout = function () {
        ...
        var searchResultContainerSize = this.size.height - dom.getTotalHeight(this.searchWidgetsContainer.getContainer()) - 6 /** container margin top */;
