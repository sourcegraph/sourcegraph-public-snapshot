...
var ProcessRunnerDetector = (function () {
    ...
    ProcessRunnerDetector.prototype.detect = function (list, detectSpecific) {
        ...
        if (this.taskConfiguration && this.taskConfiguration.command && ProcessRunnerDetector.supports(this.taskConfiguration.command)) {
            ...
            return this.runDetection(new processes_2.LineProcess(this.taskConfiguration.command, this.configurationResolverService.resolve(args), isShellCommand, options), this.taskConfiguration.command, isShellCommand, config.matcher, ProcessRunnerDetector.DefaultProblemMatchers, list);
        }
        else {
            if (detectSpecific) {
