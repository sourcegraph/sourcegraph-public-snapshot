...
export declare class ExtensionsWorkbenchService implements IExtensionsWorkbenchService {
    ...
    constructor(instantiationService: IInstantiationService, editorService: IWorkbenchEditorService, extensionService: IExtensionManagementService, galleryService: IExtensionGalleryService, configurationService: IConfigurationService, telemetryService: ITelemetryService, messageService: IMessageService, choiceService: IChoiceService, urlService: IURLService, extensionEnablementService: IExtensionEnablementService, tipsService: IExtensionTipsService, workspaceContextService: IWorkspaceContextService);
    ...
    setEnablement(extension: IExtension, enable: boolean, workspace?: boolean): TPromise<any>;
