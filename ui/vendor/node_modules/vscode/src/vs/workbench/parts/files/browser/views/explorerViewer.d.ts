...
export declare class FileRenderer extends ActionsRenderer implements IRenderer {
    ...
    private state;
    constructor(state: FileViewletState, actionRunner: IActionRunner, contextViewService: IContextViewService, instantiationService: IInstantiationService);
    ...
    private renderLabel(container, stat);
...
export declare class FileController extends DefaultController {
    ...
    constructor(state: FileViewletState, editorService: IWorkbenchEditorService, contextMenuService: IContextMenuService, instantiationService: IInstantiationService, telemetryService: ITelemetryService, contextService: IWorkspaceContextService, menuService: IMenuService, contextKeyService: IContextKeyService, keybindingService: IKeybindingService);
...
export declare class FileDragAndDrop implements IDragAndDrop {
    ...
    private toDispose;
    private dropEnabled;
    constructor(messageService: IMessageService, contextService: IWorkspaceContextService, progressService: IProgressService, fileService: IFileService, configurationService: IConfigurationService, instantiationService: IInstantiationService, textFileService: ITextFileService, textModelResolverService: ITextModelResolverService, backupFileService: IBackupFileService);
