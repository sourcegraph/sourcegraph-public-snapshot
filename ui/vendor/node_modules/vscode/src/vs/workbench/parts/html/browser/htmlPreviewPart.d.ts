...
export declare class HtmlPreviewPart extends BaseEditor {
    ...
    constructor(telemetryService: ITelemetryService, textModelResolverService: ITextModelResolverService, themeService: IThemeService, openerService: IOpenerService, contextService: IWorkspaceContextService);
    dispose(): void;
