    ...
    MainProcessTextMateSnippet.prototype._withSnippetContribution = function (extensionName, extensionFolderPath, snippet, collector) {
        ...
        if (languageIdentifier) {
            var disposable_1 = this._modeService.onDidCreateMode(function (mode) {
                ...
                readAndRegisterSnippets(_this._snippetService, languageIdentifier, normalizedAbsolutePath, extensionName);
...
function readAndRegisterSnippets(snippetService, languageIdentifier, filePath, ownerName) {
