...
export declare class RepoQuickOpenModel extends QuickOpenModel {
    stats: ISearchStats;
    constructor(entries: QuickOpenEntry[], stats?: ISearchStats);
}
export declare class RepoEntry extends EditorQuickOpenEntry {
    private resource;
    private name;
    private description;
    private icon;
...
export declare class OpenRepoHandler extends QuickOpenHandler {
    ...
    private cacheState;
    constructor(editorGroupService: IEditorGroupService, instantiationService: IInstantiationService, themeService: IThemeService, contextService: IWorkspaceContextService, searchService: ISearchService);
    setOptions(options: IOpenRepoOptions): void;
    getResults(searchValue: string, maxSortedResults?: number): TPromise<RepoQuickOpenModel>;
