...
function getSourceName(source, contextService) {
    ...
    return labels_1.getPathLabel(paths.basename(source.uri.fsPath), contextService);
}
var BaseDebugController = (function (_super) {
    __extends(BaseDebugController, _super);
    function BaseDebugController(actionProvider, menuId, debugService, contextMenuService, contextKeyService, menuService) {
        ...
        if (platform_1.isMacintosh) {
            _this.downKeyBindingDispatcher.set(32768 /* CtrlCmd */ | 1 /* Backspace */, _this.onDelete.bind(_this));
        }
        else {
            _this.downKeyBindingDispatcher.set(20 /* Delete */, _this.onDelete.bind(_this));
            _this.downKeyBindingDispatcher.set(16384 /* Shift */ | 20 /* Delete */, _this.onDelete.bind(_this));
        }
        if (platform_1.isMacintosh) {
            _this.downKeyBindingDispatcher.set(3 /* Enter */, _this.onRename.bind(_this));
        }
        else {
            _this.downKeyBindingDispatcher.set(60 /* F2 */, _this.onRename.bind(_this));
        }
        return _this;
    }
        ...
        if (this.actionProvider.hasSecondaryActions(tree, element)) {
            ...
            this.contextMenuService.showContextMenu({
                ...
                getActions: function () { return _this.actionProvider.getSecondaryActions(tree, element).then(function (actions) {
                    menuItemActionItem_1.fillInActions(_this.contributedContextMenu, _this.getContext(element), actions);
                    return actions;
                }); },
    ...
    BaseDebugController.prototype.onRename = function (tree, event) {
        return false;
    };
...
var CallStackController = (function (_super) {
    ...
    CallStackController.prototype.showMoreStackFrames = function (tree, threadAndProcessIds) {
        ...
        if (thread) {
            thread.fetchCallStack(true)
                .done(function () { return tree.refresh(); }, errors.onUnexpectedError);
        }
        return true;
    };
    CallStackController.prototype.focusStackFrame = function (element, event, preserveFocus) {
        var stackFrame;
        var process;
        if (element instanceof debugModel_1.StackFrame) {
            stackFrame = element;
...
var CallStackActionProvider = (function () {
    ...
    CallStackActionProvider.prototype.hasSecondaryActions = function (tree, element) {
        return element instanceof debugModel_1.Thread || element instanceof debugModel_1.StackFrame;
    };
    CallStackActionProvider.prototype.getSecondaryActions = function (tree, element) {
        ...
        if (element instanceof debugModel_1.Thread) {
            ...
            var capabilities = this.debugService.getViewModel().focusedProcess.session.configuration.capabilities;
...
var CallStackDataSource = (function () {
    ...
    CallStackDataSource.prototype.getThreadChildren = function (thread) {
        return thread.fetchCallStack().then(function (callStack) {
...
var VariablesActionProvider = (function () {
    ...
    VariablesActionProvider.prototype.hasSecondaryActions = function (tree, element) {
        return element instanceof debugModel_1.Variable;
    };
...
var VariablesController = (function (_super) {
    ...
    VariablesController.prototype.onEnter = function (tree, event) {
        var element = tree.getFocus();
        if (element instanceof debugModel_1.Variable && !element.hasChildren) {
...
var WatchExpressionsActionProvider = (function () {
    ...
    WatchExpressionsActionProvider.prototype.getExpressionActions = function () {
        return [this.instantiationService.createInstance(debugActions_1.RemoveWatchExpressionAction, debugActions_1.RemoveWatchExpressionAction.ID, debugActions_1.RemoveWatchExpressionAction.LABEL)];
    };
    WatchExpressionsActionProvider.prototype.getSecondaryActions = function (tree, element) {
        ...
        if (element instanceof debugModel_1.Expression) {
            ...
            actions.push(this.instantiationService.createInstance(debugActions_1.EditWatchExpressionAction, debugActions_1.EditWatchExpressionAction.ID, debugActions_1.EditWatchExpressionAction.LABEL, expression));
            if (!expression.hasChildren) {
...
var WatchExpressionsRenderer = (function () {
    ...
    WatchExpressionsRenderer.prototype.renderTemplate = function (tree, templateId, container) {
        ...
        if (templateId === WatchExpressionsRenderer.WATCH_EXPRESSION_TEMPLATE_ID) {
            ...
            data_6.actionBar = new actionbar_1.ActionBar(data_6.watchExpression, { actionRunner: this.actionRunner });
            data_6.actionBar.push(this.actionProvider.getExpressionActions(), { icon: true, label: false });
            return data_6;
        }
        var data = Object.create(null);
...
var BreakpointsActionProvider = (function () {
    ...
    BreakpointsActionProvider.prototype.hasActions = function (tree, element) {
        return element instanceof debugModel_1.Breakpoint;
    };
    ...
    BreakpointsActionProvider.prototype.getBreakpointActions = function () {
        return [this.instantiationService.createInstance(debugActions_1.RemoveBreakpointAction, debugActions_1.RemoveBreakpointAction.ID, debugActions_1.RemoveBreakpointAction.LABEL)];
    };
    BreakpointsActionProvider.prototype.getSecondaryActions = function (tree, element) {
        var actions = [this.instantiationService.createInstance(debugActions_1.ToggleEnablementAction, debugActions_1.ToggleEnablementAction.ID, debugActions_1.ToggleEnablementAction.LABEL)];
        actions.push(new actionbar_1.Separator());
        ...
        actions.push(new actionbar_1.Separator());
        actions.push(this.instantiationService.createInstance(debugActions_1.ToggleBreakpointsActivatedAction, debugActions_1.ToggleBreakpointsActivatedAction.ID, debugActions_1.ToggleBreakpointsActivatedAction.ACTIVATE_LABEL));
        actions.push(new actionbar_1.Separator());
        ...
        actions.push(new actionbar_1.Separator());
        actions.push(this.instantiationService.createInstance(debugActions_1.AddFunctionBreakpointAction, debugActions_1.AddFunctionBreakpointAction.ID, debugActions_1.AddFunctionBreakpointAction.LABEL));
        if (element instanceof debugModel_1.FunctionBreakpoint) {
            actions.push(this.instantiationService.createInstance(debugActions_1.RenameFunctionBreakpointAction, debugActions_1.RenameFunctionBreakpointAction.ID, debugActions_1.RenameFunctionBreakpointAction.LABEL));
        }
        actions.push(new actionbar_1.Separator());
...
var BreakpointsRenderer = (function () {
    ...
    BreakpointsRenderer.prototype.renderFunctionBreakpoint = function (tree, functionBreakpoint, data) {
        ...
        if (!functionBreakpoint.name || (selected && selected.getId() === functionBreakpoint.getId())) {
            ...
            if ((process_1 && !process_1.session.configuration.capabilities.supportsFunctionBreakpoints) || !this.debugService.getModel().areBreakpointsActivated()) {
                tree.addTraits('disabled', [functionBreakpoint]);
                if (process_1 && !process_1.session.configuration.capabilities.supportsFunctionBreakpoints) {
    ...
    BreakpointsRenderer.prototype.renderBreakpoint = function (tree, breakpoint, data) {
        ...
        data.name.textContent = labels_1.getPathLabel(paths.basename(breakpoint.uri.fsPath), this.contextService);
        data.lineNumber.textContent = breakpoint.lineNumber.toString();
        data.filePath.textContent = labels_1.getPathLabel(paths.dirname(breakpoint.uri.fsPath), this.contextService);
...
var BreakpointsController = (function (_super) {
    ...
    BreakpointsController.prototype.onRename = function (tree, event) {
        var element = tree.getFocus();
        if (element instanceof debugModel_1.FunctionBreakpoint && element.name) {
            this.debugService.getViewModel().setSelectedFunctionBreakpoint(element);
            return true;
        }
        if (element instanceof debugModel_1.Breakpoint) {
