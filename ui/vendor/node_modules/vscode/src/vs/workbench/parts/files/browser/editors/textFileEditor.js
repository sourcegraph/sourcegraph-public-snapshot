...
var TextFileEditor = (function (_super) {
    ...
    function TextFileEditor(telemetryService, fileService, viewletService, instantiationService, contextService, storageService, historyService, messageService, configurationService, eventService, editorService, themeService) {
        var _this = _super.call(this, TextFileEditor.ID, telemetryService, instantiationService, contextService, storageService, messageService, configurationService, eventService, editorService, themeService) || this;
        _this.fileService = fileService;
        _this.viewletService = viewletService;
        _this.historyService = historyService;
        // Clear view state for deleted files
        _this.toUnbind.push(_this.eventService.addListener2(files_2.EventType.FILE_CHANGES, function (e) { return _this.onFilesChanged(e); }));
        return _this;
    }
