...
var ToggleRenderWhitespaceAction = (function (_super) {
    ...
    ToggleRenderWhitespaceAction.prototype.run = function (accessor, editor) {
        ...
        configurationEditingService.writeConfiguration(configurationEditing_1.ConfigurationTarget.USER, { key: 'editor.renderWhitespace', value: newRenderWhitespace }).then(null, function (error) {
            messageService.show(message_1.Severity.Error, error);
        });
    };
