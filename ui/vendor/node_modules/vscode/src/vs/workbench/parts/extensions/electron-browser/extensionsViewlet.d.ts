...
export declare class ExtensionsViewlet extends Viewlet implements IExtensionsViewlet {
    ...
    private disposables;
    constructor(telemetryService: ITelemetryService, galleryService: IExtensionGalleryService, extensionManagementService: IExtensionManagementService, progressService: IProgressService, instantiationService: IInstantiationService, editorService: IWorkbenchEditorService, editorInputService: IEditorGroupService, listService: IListService, extensionsWorkbenchService: IExtensionsWorkbenchService, tipsService: IExtensionTipsService, messageService: IMessageService, viewletService: IViewletService, extensionService: IExtensionService, modeService: IModeService);
