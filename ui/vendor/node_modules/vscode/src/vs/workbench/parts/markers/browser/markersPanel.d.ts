...
export declare class MarkersPanel extends Panel {
    ...
    private currentFileGotAddedToMarkersData;
    constructor(instantiationService: IInstantiationService, markerService: IMarkerService, editorGroupService: IEditorGroupService, editorService: IWorkbenchEditorService, configurationService: IConfigurationService, contextKeyService: IContextKeyService, telemetryService: ITelemetryService, listService: IListService);
    ...
    private isCurrentFileGotAddedToMarkersData(changedResources);
