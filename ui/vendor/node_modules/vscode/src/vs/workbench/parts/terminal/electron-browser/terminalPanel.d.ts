...
export declare class TerminalPanel extends Panel {
    ...
    private _currentBaseThemeId;
    private _font;
    private _fontStyleElement;
    private _parentDomElement;
    private _terminalContainer;
    private _themeStyleElement;
    constructor(_configurationService: IConfigurationService, _contextMenuService: IContextMenuService, _instantiationService: IInstantiationService, _keybindingService: IKeybindingService, _terminalService: ITerminalService, _themeService: IWorkbenchThemeService, telemetryService: ITelemetryService);
    ...
    private _updateTheme(colorTheme?);
    /**
     * Converts a CSS hex color (#rrggbb) to a CSS rgba color (rgba(r, g, b, a)).
     */
    private _convertHexCssColorToRgba(hex, alpha);
    private _updateFont();
