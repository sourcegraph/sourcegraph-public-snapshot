...
var mime_2 = require("vs/base/node/mime");
...
var Repository = (function () {
    ...
    Repository.prototype.buffer = function (object) {
        ...
        if (!child.stdout) {
            return winjs_base_1.TPromise.wrapError(nls_1.localize('errorBuffer', "Can't open file from git"));
        }
        return mime_2.detectMimesFromStream(child.stdout, null).then(function (result) {
            return mime_1.isBinaryMime(result.mimes) ?
                winjs_base_1.TPromise.wrapError({
                    message: nls_1.localize('fileBinaryError', "File seems to be binary and cannot be opened as text"),
                    fileOperationResult: files_1.FileOperationResult.FILE_IS_BINARY
                }) :
                _this.doBuffer(object);
        });
    };
