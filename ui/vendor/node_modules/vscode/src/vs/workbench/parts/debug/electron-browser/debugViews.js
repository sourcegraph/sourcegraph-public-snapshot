...
var VariablesView = (function (_super) {
    ...
    function VariablesView(actionRunner, settings, messageService, contextMenuService, telemetryService, debugService, keybindingService, instantiationService, contextKeyService, listService) {
...
var WatchExpressionsView = (function (_super) {
    ...
    function WatchExpressionsView(actionRunner, settings, messageService, contextMenuService, debugService, keybindingService, instantiationService, contextKeyService, listService) {
...
var CallStackView = (function (_super) {
    ...
    function CallStackView(actionRunner, settings, messageService, contextMenuService, telemetryService, debugService, keybindingService, instantiationService, listService) {
    ...
    CallStackView.prototype.renderBody = function (container) {
        ...
        var controller = this.instantiationService.createInstance(viewer.CallStackController, actionProvider, actions_1.MenuId.DebugCallStackContext);
        this.tree = new treeImpl_1.Tree(this.treeContainer, {
        ...
        this.toDispose.push(this.tree.addListener2('selection', function (event) {
...
var BreakpointsView = (function (_super) {
    ...
    function BreakpointsView(actionRunner, settings, contextMenuService, debugService, keybindingService, instantiationService, contextKeyService, listService) {
    ...
    BreakpointsView.prototype.renderBody = function (container) {
        ...
        var controller = this.instantiationService.createInstance(viewer.BreakpointsController, actionProvider, actions_1.MenuId.DebugBreakpointsContext);
        this.tree = new treeImpl_1.Tree(this.treeContainer, {
