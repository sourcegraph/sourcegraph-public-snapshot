...
var QueryBuilder = (function () {
    ...
    QueryBuilder.prototype.text = function (contentPattern, options) {
        return this.query(search_1.QueryType.Text, contentPattern, options);
    };
    QueryBuilder.prototype.file = function (options) {
        return this.query(search_1.QueryType.File, null, options);
    };
    QueryBuilder.prototype.query = function (type, contentPattern, options) {
        ...
        var excludePattern = search_1.getExcludes(configuration);
        if (!options.excludePattern) {
            options.excludePattern = excludePattern;
        }
        else {
            objects_1.mixin(options.excludePattern, excludePattern, false /* no overwrite */);
        }
        return {
            type: type,
