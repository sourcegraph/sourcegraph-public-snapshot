...
export declare class WalkThroughInput extends EditorInput {
    ...
    constructor(name: string, description: string, resource: URI, telemetryFrom: string, onReady: (container: HTMLElement) => void, telemetryService: ITelemetryService, lifecycleService: ILifecycleService, textModelResolverService: ITextModelResolverService);
    getResource(): URI;
    getTypeId(): string;
    getName(): string;
