...
export declare namespace WorkspaceSymbolProviderRegistry {
    function register(support: IWorkspaceSymbolProvider, workspace?: IWorkspace): IDisposable;
    function all(workspace?: IWorkspace): IWorkspaceSymbolProvider[];
}
export declare function getWorkspaceSymbols(query: string, workspace?: IWorkspace): TPromise<[IWorkspaceSymbolProvider, IWorkspaceSymbol[]][]>;
