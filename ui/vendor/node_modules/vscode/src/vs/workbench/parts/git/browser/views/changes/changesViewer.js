...
var countbadge = require("vs/base/browser/ui/countBadge/countBadge");
var tree = require("vs/base/parts/tree/browser/tree");
var treednd = require("vs/base/parts/tree/browser/treeDnd");
...
ActionProvider = __decorate([
    __param(0, instantiation_1.IInstantiationService), __param(1, IGitService)
], ActionProvider);
exports.ActionProvider = ActionProvider;
var STAGED_CHANGES = nls.localize('stagedChanges', "Staged Changes");
var CHANGES = nls.localize('allChanges', "Changes");
var MERGE_CHANGES = nls.localize('mergeChanges', "Merge Changes");
var Renderer = (function () {
    ...
    Renderer.prototype.renderStatusGroupTemplate = function (statusType, container) {
        ...
        switch (statusType) {
            case git.StatusType.INDEX:
                data.root.textContent = STAGED_CHANGES;
                break;
            case git.StatusType.WORKING_TREE:
                data.root.textContent = CHANGES;
                break;
            case git.StatusType.MERGE:
                data.root.textContent = MERGE_CHANGES;
                break;
        }
...
DragAndDrop = __decorate([
    __param(0, instantiation_1.IInstantiationService), __param(1, IGitService), __param(2, message_1.IMessageService)
], DragAndDrop);
...
var Controller = (function (_super) {
    ...
    function Controller(actionProvider, contextMenuService) {
        var _this = _super.call(this, { clickBehavior: treedefaults.ClickBehavior.ON_MOUSE_UP }) || this;
        _this.actionProvider = actionProvider;
        _this.contextMenuService = contextMenuService;
        _this.downKeyBindingDispatcher.set(16384 /* Shift */ | 16 /* UpArrow */, _this.onUp.bind(_this));
        _this.downKeyBindingDispatcher.set(16384 /* Shift */ | 18 /* DownArrow */, _this.onDown.bind(_this));
        _this.downKeyBindingDispatcher.set(16384 /* Shift */ | 11 /* PageUp */, _this.onPageUp.bind(_this));
        _this.downKeyBindingDispatcher.set(16384 /* Shift */ | 12 /* PageDown */, _this.onPageDown.bind(_this));
        return _this;
    }
