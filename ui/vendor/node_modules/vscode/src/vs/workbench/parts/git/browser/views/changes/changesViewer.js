...
var Controller = (function (_super) {
    ...
    function Controller(actionProvider, contextMenuService) {
        ...
        _this.downKeyBindingDispatcher.set(1024 /* Shift */ | 16 /* UpArrow */, _this.onUp.bind(_this));
        _this.downKeyBindingDispatcher.set(1024 /* Shift */ | 18 /* DownArrow */, _this.onDown.bind(_this));
        _this.downKeyBindingDispatcher.set(1024 /* Shift */ | 11 /* PageUp */, _this.onPageUp.bind(_this));
        _this.downKeyBindingDispatcher.set(1024 /* Shift */ | 12 /* PageDown */, _this.onPageDown.bind(_this));
        return _this;
    }
