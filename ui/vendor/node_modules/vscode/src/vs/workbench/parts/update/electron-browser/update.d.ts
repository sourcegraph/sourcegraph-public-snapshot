...
export declare class UpdateContribution implements IWorkbenchContribution {
    private static KEY;
    getId(): string;
    constructor(storageService: IStorageService, instantiationService: IInstantiationService, messageService: IMessageService, updateService: IUpdateService, editorService: IWorkbenchEditorService);
}
