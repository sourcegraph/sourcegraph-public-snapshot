...
var ExtensionEditor = (function (_super) {
    ...
    function ExtensionEditor(telemetryService, galleryService, configurationService, instantiationService, viewletService, extensionsWorkbenchService, themeService, keybindingService, messageService, openerService, listService) {
    ...
    ExtensionEditor.prototype.openMarkdown = function (content, noContentCopy) {
        ...
        return this.loadContents(function () { return content
            ...
            _this.themeService.onDidColorThemeChange(function (theme) { return webview.style(theme); }, null, _this.contentDisposables);
    ...
    ExtensionEditor.prototype.openDependencies = function (extension) {
        ...
        return this.loadContents(function () {
            return _this.extensionDependencies.get().then(function (extensionDependencies) {
                ...
                var layout = function () {
                    scrollableContent.scanDomNode();
                    var scrollState = scrollableContent.getScrollState();
    ...
    ExtensionEditor.prototype.renderDependencies = function (container, extensionDependencies) {
        ...
        this.contentDisposables.push(tree.addListener2('selection', function (event) {
    ...
    ExtensionEditor.prototype.keybindingToLabel = function (rawKeyBinding) {
        ...
        var keyBinding = keyCodes_1.createKeybinding(keybindingLabels_1.KeybindingLabels.fromUserSettingsLabel(key || rawKeyBinding.key));
        var resolvedKeybinding = this.keybindingService.resolveKeybinding(keyBinding);
        var result = resolvedKeybinding.getLabel();
...
ExtensionEditor = __decorate([
    ...
    __param(6, themeService_1.IWorkbenchThemeService),
