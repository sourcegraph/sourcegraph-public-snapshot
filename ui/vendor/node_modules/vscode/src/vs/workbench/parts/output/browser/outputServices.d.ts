...
import { IOutputChannelIdentifier, IOutputEvent, IOutputChannel, IOutputService } from 'vs/workbench/parts/output/common/output';
...
export declare class OutputService implements IOutputService {
    ...
    constructor(storageService: IStorageService, instantiationService: IInstantiationService, panelService: IPanelService, contextService: IWorkspaceContextService, modelService: IModelService, textModelResolverService: ITextModelResolverService);
