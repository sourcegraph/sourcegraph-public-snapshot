...
var ExplorerViewerActionContributor = (function (_super) {
    ...
    ExplorerViewerActionContributor.prototype.getSecondaryActions = function (context) {
        ...
        if (this.hasSecondaryActions(context)) {
            ...
            var action = this._instantiationService.createInstance(searchActions.FindInFolderAction, fileResource.resource);
            action.order = 55;
            actions.push(action);
...
var OPEN_REPO_ACTION_ID = 'workbench.action.openRepo';
var OPEN_REPO_ACTION_LABEL = nls.localize('goToRepository', "Go to Repository...");
var ALL_REPOS_PREFIX = '!';
var OpenRepoAction = (function (_super) {
    __extends(OpenRepoAction, _super);
    function OpenRepoAction(actionId, actionLabel, quickOpenService) {
        return _super.call(this, actionId, actionLabel, ALL_REPOS_PREFIX, quickOpenService) || this;
    }
    return OpenRepoAction;
}(quickopen_1.QuickOpenAction));
OpenRepoAction = __decorate([
    __param(2, quickOpen_1.IQuickOpenService)
], OpenRepoAction);
// Register Viewlet
...
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(searchActions.OpenSearchViewletAction, Constants.VIEWLET_ID, nls.localize('showSearchViewlet', "Show Search"), { primary: 2048 /* CtrlCmd */ | 1024 /* Shift */ | 36 /* KEY_F */ }, Constants.SearchViewletVisibleKey.toNegated()), 'View: Show Search', nls.localize('view', "View"));
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(searchActions.FocusActiveEditorAction, Constants.FocusActiveEditorActionId, '', { primary: 2048 /* CtrlCmd */ | 1024 /* Shift */ | 36 /* KEY_F */ }, contextkey_1.ContextKeyExpr.and(Constants.SearchViewletVisibleKey, Constants.SearchInputBoxFocussedKey)), '');
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(searchActions.FindInFilesAction, Constants.FindInFilesActionId, nls.localize('findInFiles', "Find in Files"), { primary: 2048 /* CtrlCmd */ | 1024 /* Shift */ | 36 /* KEY_F */ }, Constants.SearchInputBoxFocussedKey.toNegated()), 'Find in Files');
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(searchActions.FocusNextSearchResultAction, searchActions.FocusNextSearchResultAction.ID, searchActions.FocusNextSearchResultAction.LABEL, { primary: 62 /* F4 */ }), '');
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(searchActions.FocusPreviousSearchResultAction, searchActions.FocusPreviousSearchResultAction.ID, searchActions.FocusPreviousSearchResultAction.LABEL, { primary: 1024 /* Shift */ | 62 /* F4 */ }), '');
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(searchActions.ReplaceInFilesAction, searchActions.ReplaceInFilesAction.ID, searchActions.ReplaceInFilesAction.LABEL, { primary: 2048 /* CtrlCmd */ | 1024 /* Shift */ | 38 /* KEY_H */ }), 'Replace in Files');
...
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(ShowAllSymbolsAction, ACTION_ID, ACTION_LABEL, { primary: 2048 /* CtrlCmd */ | 50 /* KEY_T */ }), 'Go to Symbol in Workspace...');
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(OpenRepoAction, OPEN_REPO_ACTION_ID, OPEN_REPO_ACTION_LABEL), 'Go to Repository...');
...
platform_1.Registry.as(quickopen_1.Extensions.Quickopen).registerQuickOpenHandler(new quickopen_1.QuickOpenHandlerDescriptor('vs/workbench/parts/search/browser/openAnythingHandler', 'OpenRepoHandler', ALL_REPOS_PREFIX, [
    {
