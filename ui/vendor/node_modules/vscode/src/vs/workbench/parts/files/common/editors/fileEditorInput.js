...
var FileEditorInput = (function (_super) {
     ...
     */
    function FileEditorInput(resource, preferredEncoding, instantiationService, contextService, textFileService) {
    ...
    FileEditorInput.prototype.isDirty = function () {
        ...
        if (state === textfiles_1.ModelState.CONFLICT || state === textfiles_1.ModelState.ERROR) {
