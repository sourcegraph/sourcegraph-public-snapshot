...
var FileEditorInput = (function (_super) {
     ...
     */
    function FileEditorInput(resource, preferredEncoding, instantiationService, contextService, textFileService, environmentService) {
    ...
    FileEditorInput.prototype.getDescription = function () {
        if (!this.description) {
    ...
    FileEditorInput.prototype.isDirty = function () {
        ...
        if (state === textfiles_1.ModelState.CONFLICT || state === textfiles_1.ModelState.ORPHAN || state === textfiles_1.ModelState.ERROR) {
