...
export declare const REPL_ID = "workbench.panel.repl";
export declare const DEBUG_SERVICE_ID = "debugService";
export declare const CONTEXT_IN_DEBUG_MODE: RawContextKey<boolean>;
export declare const CONTEXT_NOT_IN_DEBUG_MODE: ContextKeyExpr;
export declare const CONTEXT_IN_DEBUG_REPL: RawContextKey<boolean>;
export declare const CONTEXT_NOT_IN_DEBUG_REPL: ContextKeyExpr;
export declare const CONTEXT_ON_FIRST_DEBUG_REPL_LINE: RawContextKey<boolean>;
export declare const CONTEXT_ON_LAST_DEBUG_REPL_LINE: RawContextKey<boolean>;
...
export declare const NO_CONFIGURATIONS_LABEL: string;
