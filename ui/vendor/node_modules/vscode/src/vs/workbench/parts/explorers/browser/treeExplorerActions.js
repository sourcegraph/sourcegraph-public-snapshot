...
var RefreshViewExplorerAction = (function (_super) {
    ...
    function RefreshViewExplorerAction(view) {
        return _super.call(this, treeExplorer_1.toViewletActionId('refresh'), nls.localize('refresh', "Refresh"), 'extensionViewlet-action toggle', true, function () {
            view.updateInput();
