...
var OpenEditorsView = (function (_super) {
    ...
    function OpenEditorsView(actionRunner, settings, instantiationService, contextMenuService, textFileService, editorGroupService, configurationService, keybindingService, listService, untitledEditorService, contextKeyService, viewletService) {
        ...
        _this.openEditorsFocussedContext = files_1.OpenEditorsFocussedContext.bindTo(contextKeyService);
    ...
    OpenEditorsView.prototype.renderBody = function (container) {
        ...
        this.toDispose.push(this.tree.addListener2('item:collapsed', function (event) {
    ...
    OpenEditorsView.prototype.onEditorStacksModelChanged = function (e) {
        ...
        if (e.structural) {
            ...
            var toRefresh = e.editor ? new explorerViewModel_1.OpenEditor(e.editor, e.group) : e.group;
    ...
    OpenEditorsView.prototype.highlightActiveEditor = function () {
        if (this.model.activeGroup && this.model.activeGroup.activeEditor /* could be empty */) {
            var openEditor = new explorerViewModel_1.OpenEditor(this.model.activeGroup.activeEditor, this.model.activeGroup);
