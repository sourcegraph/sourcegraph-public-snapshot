...
var FileOnDiskEditorInput = (function (_super) {
    ...
    function FileOnDiskEditorInput(fileResource, name, description, modelService, modeService, textModelResolverService, instantiationService, textFileService) {
        var _this = 
        ...
        _super.call(this, name, description, uri_1.default.from({ scheme: 'disk', path: fileResource.fsPath }), textModelResolverService) || this;
        _this.modelService = modelService;
        _this.modeService = modeService;
        _this.textFileService = textFileService;
        _this.fileResource = fileResource;
        return _this;
    }
