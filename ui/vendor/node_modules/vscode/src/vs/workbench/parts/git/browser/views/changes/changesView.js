...
var ChangesView = (function (_super) {
    ...
    function ChangesView(actionRunner, instantiationService, editorService, editorGroupService, messageService, contextViewService, contextService, gitService, outputService, configurationService) {
        ...
        _this.toDispose = [
            _this.smartCommitAction = _this.instantiationService.createInstance(GitActions.SmartCommitAction, _this),
            ...
            _this.gitService.addListener2(git.ServiceEvents.OPERATION_START, function (e) { return _this.onGitOperationStart(e); }),
            _this.gitService.addListener2(git.ServiceEvents.OPERATION_END, function (e) { return _this.onGitOperationEnd(e); }),
            _this.gitService.getModel().addListener2(git.ModelEvents.MODEL_UPDATED, _this.onGitModelUpdate.bind(_this))
        ];
        return _this;
    }
    ...
    ChangesView.prototype.render = function () {
        ...
        $(this.commitInputBox.inputElement).on('keydown', function (e) {
            ...
            if (keyboardEvent.equals(2048 /* CtrlCmd */ | 3 /* Enter */) || keyboardEvent.equals(2048 /* CtrlCmd */ | 49 /* KEY_S */)) {
    ...
    ChangesView.prototype.getStatusFromInput = function (input) {
        ...
        var resource = WorkbenchEditorCommon.toResource(input, { filter: 'file' });
        if (resource) {
