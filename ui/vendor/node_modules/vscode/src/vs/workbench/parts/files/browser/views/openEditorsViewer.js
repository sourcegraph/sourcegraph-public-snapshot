...
var DataSource = (function () {
    ...
    DataSource.prototype.getChildren = function (tree, element) {
        ...
        return winjs_base_1.TPromise.as(editorGroup.getEditors().map(function (ei) { return new explorerViewModel_1.OpenEditor(ei, editorGroup); }));
    };
...
var Controller = (function (_super) {
    ...
    Controller.prototype.onClick = function (tree, element, event) {
        ...
        if (element instanceof explorerViewModel_1.OpenEditor && event.browserEvent && event.browserEvent.button === 1 /* Middle Button */) {
    ...
    Controller.prototype.onLeftClick = function (tree, element, event, origin) {
        ...
        if (!(element instanceof explorerViewModel_1.OpenEditor)) {
            return true;
        }
        // Set DOM focus
        tree.DOMFocus();
    ...
    Controller.prototype.onContextMenu = function (tree, element, event) {
        ...
        var editor = element instanceof explorerViewModel_1.OpenEditor ? element.editorInput : undefined;
...
var ActionProvider = (function (_super) {
    ...
    ActionProvider.prototype.hasActions = function (tree, element) {
        ...
        return element instanceof explorerViewModel_1.OpenEditor || (element instanceof editorStacksModel_1.EditorGroup && multipleGroups);
    };
    ...
    ActionProvider.prototype.hasSecondaryActions = function (tree, element) {
        return element instanceof explorerViewModel_1.OpenEditor || element instanceof editorStacksModel_1.EditorGroup;
    };
...
var DragAndDrop = (function (_super) {
    ...
    DragAndDrop.prototype.onDragOver = function (tree, data, target, originalEvent) {
        if (!(target instanceof explorerViewModel_1.OpenEditor) && !(target instanceof editorStacksModel_1.EditorGroup)) {
    ...
    DragAndDrop.prototype.drop = function (tree, data, target, originalEvent) {
        ...
        var index = target instanceof explorerViewModel_1.OpenEditor ? target.editorGroup.indexOf(target.editorInput) : undefined;
        ...
        if (draggedElement) {
            if (draggedElement instanceof explorerViewModel_1.OpenEditor) {
