...
var ReplExpressionsRenderer = (function () {
    function ReplExpressionsRenderer(editorService) {
    ...
    ReplExpressionsRenderer.prototype.handleLinks = function (text) {
        ...
        var _loop_1 = function (pattern) {
            ...
            if (resource) {
                ...
                link.onclick = function (e) { return _this.onLinkClick(new mouseEvent_1.StandardMouseEvent(e), resource, Number(match[3]), Number(match[4])); };
