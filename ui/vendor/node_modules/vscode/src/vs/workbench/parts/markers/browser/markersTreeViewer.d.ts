...
export declare class Renderer implements IRenderer {
    ...
    constructor(actionRunner: IActionRunner, actionProvider: IActionProvider, contextService: IWorkspaceContextService, instantiationService: IInstantiationService);
