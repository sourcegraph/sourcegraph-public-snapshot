...
export declare class ViewModel implements debug.IViewModel {
    private _selectedConfigurationName;
    ...
    constructor(_selectedConfigurationName: string);
    getId(): string;
    readonly focusedProcess: debug.IProcess;
    readonly focusedThread: debug.IThread;
    readonly focusedStackFrame: debug.IStackFrame;
    setFocusedStackFrame(stackFrame: debug.IStackFrame, process: debug.IProcess): void;
    readonly onDidFocusStackFrame: Event<debug.IStackFrame>;
    ...
    readonly selectedConfigurationName: string;
    setSelectedConfigurationName(configurationName: string): void;
    isMultiProcessView(): boolean;
    setMultiProcessView(isMultiProcessView: boolean): void;
    readonly onDidSelectConfiguration: Event<string>;
}
