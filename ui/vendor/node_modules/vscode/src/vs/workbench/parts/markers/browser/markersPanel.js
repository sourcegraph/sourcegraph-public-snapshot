...
var MarkersPanel = (function (_super) {
    ...
    function MarkersPanel(instantiationService, markerService, editorGroupService, editorService, configurationService, contextKeyService, telemetryService, listService) {
    ...
    MarkersPanel.prototype.createTree = function (parent) {
        ...
        this._register(this.tree.addListener2('selection', function (event) {
            if (event && event.payload && event.payload.origin === 'keyboard') {
                controller.openFileAtElement(_this.tree.getFocus(), false, false, true);
            }
        }));
