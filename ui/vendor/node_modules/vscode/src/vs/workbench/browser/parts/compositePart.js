...
var CompositePart = (function (_super) {
    ...
    function CompositePart(messageService, storageService, telemetryService, contextMenuService, partService, keybindingService, instantiationService, registry, activeCompositeSettingsKey, nameForTelemetry, compositeCSSClass, actionContributionScope, id, options) {
        ...
        _this.lastActiveCompositeId = storageService.get(activeCompositeSettingsKey, storage_1.StorageScope.WORKSPACE);
        return _this;
    }
    ...
    CompositePart.prototype.createComposite = function (id, isActive) {
        ...
        for (var i = 0; i < this.instantiatedComposites.length; i++) {
            if (this.instantiatedComposites[i].getId() === id) {
                return winjs_base_1.TPromise.as(this.instantiatedComposites[i]);
            }
        }
        ...
        if (compositeDescriptor) {
            ...
            if (!loaderPromise) {
                ...
                loaderPromise = compositeInstantiationService.createInstance(compositeDescriptor).then(function (composite) {
                    ...
                    _this.instantiatedComposites.push(composite);
