...
export declare abstract class AdaptiveCollapsibleViewletView extends FixedCollapsibleView implements IViewletView {
    ...
    private dragHandler;
    constructor(actionRunner: IActionRunner, initialBodySize: number, collapsed: boolean, viewName: string, keybindingService: IKeybindingService, contextMenuService: IContextMenuService);
    create(): TPromise<void>;
