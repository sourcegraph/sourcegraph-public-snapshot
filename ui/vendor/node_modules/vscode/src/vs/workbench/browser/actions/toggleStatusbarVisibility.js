...
var ToggleStatusbarVisibilityAction = (function (_super) {
    ...
    function ToggleStatusbarVisibilityAction(id, label, partService, messageService, configurationEditingService) {
    ...
    ToggleStatusbarVisibilityAction.prototype.run = function () {
        ...
        this.configurationEditingService.writeConfiguration(configurationEditing_1.ConfigurationTarget.USER, { key: ToggleStatusbarVisibilityAction.statusbarVisibleKey, value: newVisibilityValue }).then(null, function (error) {
