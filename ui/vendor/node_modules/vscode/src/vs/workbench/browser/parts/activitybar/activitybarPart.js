...
var ActivitybarPart = (function (_super) {
    ...
    function ActivitybarPart(id, viewletService, extensionService, storageService, contextMenuService, instantiationService, partService) {
        ...
        if (pinnedViewlets) {
            ...
            var map = scmPreview_1.default.enabled
                ? (function (id) { return id === 'workbench.view.git' ? 'workbench.view.scm' : id; })
                : (function (id) { return id === 'workbench.view.scm' ? 'workbench.view.git' : id; });
