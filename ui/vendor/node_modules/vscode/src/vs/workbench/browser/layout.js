...
var MIN_SIDEBAR_PART_WIDTH = 300;
...
var TITLE_BAR_HEIGHT = 45;
var STATUS_BAR_HEIGHT = 32;
...
var WorkbenchLayout = (function () {
    ...
    function WorkbenchLayout(parent, workbenchContainer, parts, quickopen, storageService, contextViewService, editorService, editorGroupService, partService, viewletService, themeService) {
        ...
        this.toUnbind.push(themeService.onDidColorThemeChange(function (_) { return _this.layout(); }));
    ...
    WorkbenchLayout.prototype.registerSashListeners = function () {
        ...
        var startX = 0;
        var startY = 0;
        this.sashX.addListener2('start', function (e) {
            _this.startSidebarWidth = _this.sidebarWidth;
            startX = e.startX;
        });
        this.sashY.addListener2('start', function (e) {
            _this.startPanelHeight = _this.panelHeight;
            startY = e.startY;
        });
        this.sashX.addListener2('change', function (e) {
            var doLayout = false;
        ...
        this.sashY.addListener2('change', function (e) {
            var doLayout = false;
        ...
        this.sashX.addListener2('reset', function () {
    ...
    WorkbenchLayout.prototype.layout = function (options) {
        ...
        // Panel part
        var panelHeight;
        var maxPanelHeight = sidebarSize.height - MIN_EDITOR_PART_HEIGHT;
        if (isPanelHidden) {
            panelHeight = 0;
        }
