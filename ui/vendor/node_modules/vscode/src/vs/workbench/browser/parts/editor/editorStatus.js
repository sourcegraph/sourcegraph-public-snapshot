...
require("./media/editorstatus.css");
...
var linesOperations_1 = require("vs/editor/contrib/linesOperations/common/linesOperations");
var indentation_1 = require("vs/workbench/parts/indentation/common/indentation");
...
function getCodeEditor(editorWidget) {
    if (editorWidget) {
...
function getTextModel(editorWidget) {
    ...
    return editorWidget ? editorWidget.getModel() : null;
}
...
var EditorStatus = (function () {
    ...
    EditorStatus.prototype.render = function (container) {
        ...
        this.tabFocusModeElement = dom_1.append(this.element, dom_1.$('a.editor-status-tabfocusmode'));
    ...
    EditorStatus.prototype.onEditorsChanged = function () {
        ...
        if (control) {
            ...
            this.activeEditorListeners.push(control.onDidChangeModelMode(function (event) {
                _this.onModeChange(control);
            }));
            // Hook Listener for content changes
            this.activeEditorListeners.push(control.onDidChangeModelRawContent(function (event) {
            ...
            this.activeEditorListeners.push(activeEditor.onMetadataChanged(function (metadata) {
    ...
    EditorStatus.prototype.onEOLChange = function (editorWidget) {
        var info = { EOL: null };
        var codeEditor = getCodeEditor(editorWidget);
...
function isWritableCodeEditor(e) {
    var editorWidget = codeEditorService_1.getCodeEditor(e);
    if (!editorWidget) {
        return false;
    }
    if (editorWidget.getEditorType() === editorCommon_1.EditorType.IDiffEditor) {
...
var ShowLanguageExtensionsAction = (function (_super) {
    ...
    function ShowLanguageExtensionsAction(extension, viewletService, galleryService) {
        var _this = _super.call(this, ShowLanguageExtensionsAction.ID, nls.localize('showLanguageExtensions', "Search Marketplace Extensions for '{0}'...", extension), null, true) || this;
    ...
    ShowLanguageExtensionsAction.prototype.run = function () {
        ...
        return this.viewletService.openViewlet(extensions_1.VIEWLET_ID, true)
            ...
            viewlet.search("ext:" + _this.extension.replace(/^\./, ''));
            viewlet.focus();
        });
    };
...
var ChangeModeAction = (function (_super) {
    ...
    function ChangeModeAction(actionId, actionLabel, modeService, modelService, editorService, configurationEditingService, messageService, configurationService, quickOpenService, instantiationService) {
    ...
    ChangeModeAction.prototype.run = function () {
        ...
        return this.quickOpenService.pick(picks, { placeHolder: nls.localize('pickLanguage', "Select Language Mode") }).then(function (pick) {
            ...
            if (pick === configureModeAssociations) {
                _this.configureFileAssociation(fileinput.getResource());
                return;
            }
            ...
            if (editorWidget) {
                var models = [];
                var textModel_2 = getTextModel(editorWidget);
                if (textModel_2) {
        ...
        winjs_base_1.TPromise.timeout(50 /* quick open is sensitive to being opened so soon after another */).done(function () {
            _this.quickOpenService.pick(picks, { placeHolder: nls.localize('pickLanguageToConfigure', "Select Language Mode to Associate with '{0}'", extension || basename) }).done(function (language) {
                if (language) {
                    ...
                    // Write config
                    _this.configurationEditingService.writeConfiguration(target, { key: ChangeModeAction.FILE_ASSOCIATION_KEY, value: currentAssociations }).done(null, function (error) { return _this.messageService.show(message_1.Severity.Error, error.toString()); });
                }
            });
        });
    };
    ...
    ChangeEOLAction.prototype.run = function () {
        ...
        return this.quickOpenService.pick(EOLOptions, { placeHolder: nls.localize('pickEndOfLine', "Select End of Line Sequence"), autoFocus: { autoFocusIndex: selectedIndex } }).then(function (eol) {
            if (eol) {
                ...
                if (editorWidget_1 && isWritableCodeEditor(activeEditor)) {
                    var textModel_3 = getTextModel(editorWidget_1);
