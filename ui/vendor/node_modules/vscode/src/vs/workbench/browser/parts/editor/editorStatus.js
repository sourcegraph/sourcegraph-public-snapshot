...
var indentation_1 = require("vs/editor/contrib/indentation/common/indentation");
...
var ShowLanguageExtensionsAction = (function (_super) {
    ...
    ShowLanguageExtensionsAction.prototype.run = function () {
        return this.commandService.executeCommand('workbench.extensions.action.showLanguageExtensions', this.fileExtension).then(function () { return void 0; });
    };
...
var ChangeModeAction = (function (_super) {
    ...
    function ChangeModeAction(actionId, actionLabel, modeService, modelService, editorService, configurationEditingService, messageService, configurationService, quickOpenService, preferencesService, instantiationService, commandService, configurationEditService) {
...
ChangeModeAction = __decorate([
    ...
    __param(8, quickOpen_1.IQuickOpenService),
