...
export declare class ActivitybarPart extends Part implements IActivityBarService {
    ...
    constructor(id: string, viewletService: IViewletService, extensionService: IExtensionService, storageService: IStorageService, contextMenuService: IContextMenuService, instantiationService: IInstantiationService, partService: IPartService);
