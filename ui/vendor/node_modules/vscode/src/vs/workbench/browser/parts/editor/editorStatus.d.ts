...
export declare class ShowLanguageExtensionsAction extends Action {
    ...
    static ID: string;
    constructor(extension: string, viewletService: IViewletService, galleryService: IExtensionGalleryService);
    run(): TPromise<void>;
}
export declare class ChangeModeAction extends Action {
    ...
    constructor(actionId: string, actionLabel: string, modeService: IModeService, modelService: IModelService, editorService: IWorkbenchEditorService, configurationEditingService: IConfigurationEditingService, messageService: IMessageService, configurationService: IWorkspaceConfigurationService, quickOpenService: IQuickOpenService, instantiationService: IInstantiationService);
    run(): TPromise<any>;
