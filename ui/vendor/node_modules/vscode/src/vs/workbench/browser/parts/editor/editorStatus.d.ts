...
export declare class ChangeModeAction extends Action {
    ...
    constructor(actionId: string, actionLabel: string, modeService: IModeService, modelService: IModelService, editorService: IWorkbenchEditorService, configurationEditingService: IConfigurationEditingService, messageService: IMessageService, configurationService: IWorkspaceConfigurationService, quickOpenService: IQuickOpenService, preferencesService: IPreferencesService, instantiationService: IInstantiationService, commandService: ICommandService, configurationEditService: IConfigurationEditingService);
    run(): TPromise<any>;
...
export declare class ChangeEncodingAction extends Action {
    ...
    static ID: string;
    static LABEL: string;
    constructor(actionId: string, actionLabel: string, editorService: IWorkbenchEditorService, quickOpenService: IQuickOpenService, configurationService: IWorkspaceConfigurationService);
    run(): TPromise<any>;
}
