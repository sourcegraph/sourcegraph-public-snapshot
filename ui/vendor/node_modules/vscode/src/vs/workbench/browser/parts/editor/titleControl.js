...
var TitleControl = (function () {
    function TitleControl(contextMenuService, instantiationService, editorService, editorGroupService, contextKeyService, keybindingService, telemetryService, messageService, menuService, quickOpenService) {
        var _this = this;
        ...
        this.contextMenu = this.menuService.createMenu(actions_1.MenuId.EditorTitleContext, this.contextKeyService);
    ...
    TitleControl.prototype.getEditorActions = function (identifier) {
        ...
        if (control instanceof baseEditor_1.BaseEditor && control.input && typeof control.position === 'number') {
            ...
            menuItemActionItem_1.fillInActions(titleBarMenu, this.resourceContext.get(), { primary: primary, secondary: secondary });
        }
    ...
    TitleControl.prototype.updateEditorActionsToolbar = function () {
        ...
        if (!arrays.equals(primaryEditorActionIds, this.currentPrimaryEditorActionIds) ||
            ...
            primaryEditorActions.some(function (action) { return action instanceof actions_1.ExecuteCommandAction; }) ||
    ...
    TitleControl.prototype.getContextMenuActions = function (identifier) {
        ...
        menuItemActionItem_1.fillInActions(this.contextMenu, this.resourceContext.get(), actions);
        return actions;
    };
