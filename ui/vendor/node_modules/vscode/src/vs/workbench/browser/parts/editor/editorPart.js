...
var EditorPart = (function (_super) {
    ...
    function EditorPart(id, restoreFromStorage, messageService, telemetryService, storageService, partService, configurationService, contextKeyService, instantiationService) {
    ...
    EditorPart.prototype.findPosition = function (input, options, arg1, ratio) {
        ...
        var skipRevealIfOpen = (options && options.index) || arg1;
