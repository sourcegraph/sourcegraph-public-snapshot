...
var EditorGroupsControl = (function () {
    function EditorGroupsControl(parent, groupOrientation, editorService, editorGroupService, telemetryService, contextKeyService, extensionService, instantiationService, windowService) {
        var _this = this;
    ...
    EditorGroupsControl.prototype.registerListeners = function () {
        ...
        this.toDispose.push(this.editorGroupService.onTabOptionsChanged(function (options) { return _this.updateTabOptions(options, false); }));
    ...
    EditorGroupsControl.prototype.enableDropTarget = function (node) {
        ...
        this.toDispose.push(DOM.addDisposableListener(node, DOM.EventType.DRAG_ENTER, function (e) {
            if (!titleControl_1.TitleControl.getDraggedEditor() && !dnd_1.extractResources(e).length) {
                return; // invalid DND
            }
            counter++;
