import './media/editorGroupsControl.css';
 ...
 */
export declare class EditorGroupsControl implements IEditorGroupsControl, IVerticalSashLayoutProvider, IHorizontalSashLayoutProvider {
    ...
    private toDispose;
    constructor(parent: Builder, groupOrientation: GroupOrientation, editorService: IWorkbenchEditorService, editorGroupService: IEditorGroupService, telemetryService: ITelemetryService, contextKeyService: IContextKeyService, extensionService: IExtensionService, instantiationService: IInstantiationService, windowService: IWindowService);
