...
require("./media/binarydiffeditor.css");
...
var BinaryResourceDiffEditor = (function (_super) {
    ...
    function BinaryResourceDiffEditor(telemetryService) {
        var _this = _super.call(this, BinaryResourceDiffEditor.ID, telemetryService) || this;
        _this._onMetadataChanged = new event_1.Emitter();
        return _this;
    }
    Object.defineProperty(BinaryResourceDiffEditor.prototype, "onMetadataChanged", {
        get: function () {
    ...
    BinaryResourceDiffEditor.prototype.createEditor = function (parent) {
        ...
        this.leftScrollbar = new scrollableElement_1.DomScrollableElement(leftBinaryContainerElement, { canUseTranslate3d: false, horizontal: scrollable_1.ScrollbarVisibility.Auto, vertical: scrollable_1.ScrollbarVisibility.Auto });
        ...
        this.sash.addListener2('start', function () { return _this.onSashDragStart(); });
        this.sash.addListener2('change', function (e) { return _this.onSashDrag(e); });
        this.sash.addListener2('end', function () { return _this.onSashDragEnd(); });
        this.sash.addListener2('reset', function () { return _this.onSashReset(); });
        ...
        this.rightScrollbar = new scrollableElement_1.DomScrollableElement(rightBinaryContainerElement, { canUseTranslate3d: false, horizontal: scrollable_1.ScrollbarVisibility.Auto, vertical: scrollable_1.ScrollbarVisibility.Auto });
    ...
    BinaryResourceDiffEditor.prototype.setInput = function (input, options) {
        ...
        return input.resolve(true).then(function (resolvedModel) {
            ...
            _this.renderInput(original.getName(), original.getResource(), original.getSize(), original.getETag(), true);
            // Render modified
            var modified = resolvedModel.modifiedModel;
            _this.renderInput(modified.getName(), modified.getResource(), modified.getSize(), modified.getETag(), false);
        });
    };
    BinaryResourceDiffEditor.prototype.renderInput = function (name, resource, size, etag, isOriginal) {
        var _this = this;
        ...
        resourceViewer_1.ResourceViewer.show({ name: name, resource: resource, size: size, etag: etag }, container, scrollbar, function (meta) { return _this.handleMetadataChanged(meta, isOriginal); });
    };
    BinaryResourceDiffEditor.prototype.handleMetadataChanged = function (meta, isOriginal) {
        if (isOriginal) {
