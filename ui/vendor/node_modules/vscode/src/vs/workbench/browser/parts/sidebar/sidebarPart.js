...
var SidebarPart = (function (_super) {
    ...
    function SidebarPart(id, messageService, storageService, telemetryService, contextMenuService, partService, keybindingService, instantiationService) {
        return _super.call(this, messageService, storageService, telemetryService, contextMenuService, partService, keybindingService, instantiationService, platform_1.Registry.as(viewlet_1.Extensions.Viewlets), SidebarPart.activeViewletSettingsKey, 'sideBar', 'viewlet', actionBarRegistry_1.Scope.VIEWLET, id, { hasTitle: true }) || this;
    }
