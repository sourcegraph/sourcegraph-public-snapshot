...
var TextDiffEditor = (function (_super) {
    ...
    TextDiffEditor.prototype.computeConfiguration = function (configuration) {
        ...
        if (language) {
            objects.assign(editorConfiguration, this.configurationService.getConfiguration({ overrideIdentifier: language, section: 'diffEditor' }));
        }
    ...
    TextDiffEditor.prototype.isReadOnly = function () {
        ...
        if (input instanceof diffEditorInput_1.DiffEditorInput) {
            var modifiedInput = input.modifiedInput;
            return modifiedInput instanceof stringEditorInput_1.StringEditorInput || modifiedInput instanceof resourceEditorInput_1.ResourceEditorInput;
        }
        return false;
    };
