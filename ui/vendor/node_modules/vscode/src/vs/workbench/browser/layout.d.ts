...
import { IPartService, ILayoutOptions } from 'vs/workbench/services/part/common/partService';
...
export declare class WorkbenchLayout implements IVerticalSashLayoutProvider, IHorizontalSashLayoutProvider {
    ...
    constructor(parent: Builder, workbenchContainer: Builder, parts: {
        ...
        panel: Part;
        statusbar: Part;
    }, quickopen: QuickOpenController, storageService: IStorageService, contextViewService: IContextViewService, editorService: IWorkbenchEditorService, editorGroupService: IEditorGroupService, partService: IPartService, viewletService: IViewletService, themeService: IWorkbenchThemeService);
