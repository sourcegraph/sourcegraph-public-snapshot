...
var SimpleResolvedKeybinding = (function (_super) {
    __extends(SimpleResolvedKeybinding, _super);
    function SimpleResolvedKeybinding(actual) {
        var _this = _super.call(this) || this;
        _this._actual = actual;
        return _this;
    }
    SimpleResolvedKeybinding.prototype.getLabel = function () {
        return keybindingLabels_1.KeybindingLabels._toUSLabel(this._actual);
    };
    SimpleResolvedKeybinding.prototype.getAriaLabel = function () {
        return keybindingLabels_1.KeybindingLabels._toUSAriaLabel(this._actual);
    };
    SimpleResolvedKeybinding.prototype.getHTMLLabel = function () {
        return keybindingLabels_1.KeybindingLabels._toUSHTMLLabel(this._actual);
    };
    SimpleResolvedKeybinding.prototype.getElectronAccelerator = function () {
        return keybindingLabels_1.KeybindingLabels._toElectronAccelerator(this._actual);
    };
    SimpleResolvedKeybinding.prototype.getUserSettingsLabel = function () {
        return keybindingLabels_1.KeybindingLabels.toUserSettingsLabel(this._actual);
    };
    return SimpleResolvedKeybinding;
}(keyCodes_1.ResolvedKeybinding));
exports.SimpleResolvedKeybinding = SimpleResolvedKeybinding;
var AbstractKeybindingService = (function () {
    ...
    AbstractKeybindingService.prototype.resolveKeybinding = function (keybinding) {
        return this._createResolvedKeybinding(keybinding);
    };
    AbstractKeybindingService.prototype.getLabelFor = function (keybinding) {
        return keybindingLabels_1.KeybindingLabels._toUSLabel(keybinding);
    };
    ...
    AbstractKeybindingService.prototype.lookupKeybinding = function (commandId) {
        var keybindings = this.lookupKeybindings(commandId);
        if (keybindings.length > 0) {
            return this._createResolvedKeybinding(keybindings[0]);
        }
        return null;
    };
    ...
    AbstractKeybindingService.prototype._dispatch = function (keybinding, target) {
        ...
        if (resolveResult && resolveResult.enterChord) {
            ...
            if (this._statusService) {
                var firstPartLabel = this.getLabelFor(this._currentChord);
