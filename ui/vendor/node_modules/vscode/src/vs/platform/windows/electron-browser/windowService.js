...
var WindowService = (function () {
    ...
    WindowService.prototype.openFileFolderPicker = function (forceNewWindow, data) {
        return this.windowsService.openFileFolderPicker(this.windowId, forceNewWindow, data);
    };
    WindowService.prototype.openFilePicker = function (forceNewWindow, path, data) {
        return this.windowsService.openFilePicker(this.windowId, forceNewWindow, path, data);
    };
    WindowService.prototype.openFolderPicker = function (forceNewWindow, data) {
