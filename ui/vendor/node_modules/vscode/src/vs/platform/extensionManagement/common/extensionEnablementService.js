...
var ExtensionEnablementService = (function () {
    ...
    Object.defineProperty(ExtensionEnablementService.prototype, "workspace", {
        get: function () {
    ...
    ExtensionEnablementService.prototype.setEnablement = function (identifier, enable, workspace) {
        ...
        if (workspace && !this.workspace) {
            return winjs_base_1.TPromise.wrapError(nls_1.localize('noWorkspace', "No workspace."));
        }
        if (this.environmentService.disableExtensions) {
    ...
    ExtensionEnablementService.prototype.getDisabledExtensions = function (scope) {
        if (scope === storage_1.StorageScope.WORKSPACE && !this.workspace) {
            return [];
        }
