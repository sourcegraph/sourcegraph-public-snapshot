...
var DomListener = (function (_super) {
    ...
    function DomListener(node, type, handler, useCapture) {
        ...
        _this._node = node;
        _this._type = type;
        _this._useCapture = (useCapture || false);
        _this._wrapHandler = function (e) {
            e = e || window.event;
            handler(e);
        };
        if (typeof _this._node.addEventListener === 'function') {
            _this._usedAddEventListener = true;
            _this._node.addEventListener(_this._type, _this._wrapHandler, _this._useCapture);
        }
        else {
            _this._usedAddEventListener = false;
            _this._node.attachEvent('on' + _this._type, _this._wrapHandler);
        }
        return _this;
    }
