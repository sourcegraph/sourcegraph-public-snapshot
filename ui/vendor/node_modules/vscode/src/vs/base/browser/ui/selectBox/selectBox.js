...
var SelectBox = (function (_super) {
    ...
    function SelectBox(options, selected) {
        ...
        _this.select.className = 'select-box';
        _this.options = options;
        _this.selected = selected;
        _this.toDispose = [];
        _this._onDidSelect = new event_1.Emitter();
        _this.toDispose.push(dom.addStandardDisposableListener(_this.select, 'change', function (e) {
            _this.select.title = e.target.value;
