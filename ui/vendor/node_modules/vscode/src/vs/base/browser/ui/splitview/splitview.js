...
var HeaderView = (function (_super) {
    ...
    function HeaderView(opts) {
        ...
        _this.headerSize = types.isUndefined(opts.headerSize) ? 22 : opts.headerSize;
        return _this;
    }
...
var AbstractCollapsibleView = (function (_super) {
    ...
    function AbstractCollapsibleView(opts) {
        var _this = _super.call(this, opts) || this;
        _this.ariaHeaderLabel = opts && opts.ariaHeaderLabel;
...
var FixedCollapsibleView = (function (_super) {
    ...
    function FixedCollapsibleView(opts) {
        var _this = _super.call(this, objects.mixin({ sizing: ViewSizing.Fixed }, opts)) || this;
        _this._expandedBodySize = types.isUndefined(opts.expandedBodySize) ? 22 : opts.expandedBodySize;
        return _this;
    }
...
var DeadView = (function (_super) {
    ...
    function DeadView(view) {
        var _this = _super.call(this, { sizing: ViewSizing.Fixed, fixedSize: 0 }) || this;
        _this.size = view.size;
        return _this;
    }
    return DeadView;
}(PlainView));
var VoidView = (function (_super) {
    ...
    function VoidView() {
        return _super.call(this, { sizing: ViewSizing.Fixed, minimumSize: 0, fixedSize: 0 }) || this;
    }
