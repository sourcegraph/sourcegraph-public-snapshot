...
function createKeybinding(keybinding) {
...
var SimpleKeybinding = (function () {
    function SimpleKeybinding(keybinding) {
        this.value = keybinding;
    }
    /**
     * @internal
     */
    SimpleKeybinding.prototype.isChord = function () {
        return false;
    };
    /**
     * @internal
...
var ChordKeybinding = (function () {
    function ChordKeybinding(keybinding) {
        this.value = keybinding;
    }
    ChordKeybinding.prototype.isChord = function () {
        return true;
    };
    ChordKeybinding.prototype.equals = function (other) {
        return (other && this.value === other.value);
    };
    ChordKeybinding.prototype.extractFirstPart = function () {
        return new SimpleKeybinding(BinaryKeybindings.extractFirstPart(this.value));
    };
    ChordKeybinding.prototype.extractChordPart = function () {
