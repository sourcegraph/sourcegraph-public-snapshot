...
export declare function createKeybinding(keybinding: number): Keybinding;
export declare class SimpleKeybinding {
     ...
     * @internal
     */
    isChord(): this is ChordKeybinding;
    /**
     * @internal
     */
...
export declare class ChordKeybinding {
    ...
    isChord(): this is ChordKeybinding;
    equals(other: Keybinding): boolean;
    extractFirstPart(): SimpleKeybinding;
    extractChordPart(): SimpleKeybinding;
}
...
export declare abstract class ResolvedKeybinding {
    ...
    abstract getHTMLLabel(): IHTMLContentElement[];
