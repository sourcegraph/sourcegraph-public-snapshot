...
export declare class LegacyRenderer implements _.IRenderer {
    getHeight(tree: _.ITree, element: any): number;
    getTemplateId(tree: _.ITree, element: any): string;
    renderTemplate(tree: _.ITree, templateId: string, container: HTMLElement): any;
    renderElement(tree: _.ITree, element: any, templateId: string, templateData: ILegacyTemplateData): void;
...
export declare class KeybindingDispatcher {
    ...
    dispatch(keybinding: Keybinding): IKeyBindingCallback;
}
