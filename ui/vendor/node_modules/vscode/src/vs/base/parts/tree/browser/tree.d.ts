...
export declare class MouseContextMenuEvent extends ContextMenuEvent {
    private originalEvent;
    constructor(originalEvent: Mouse.IMouseEvent);
    preventDefault(): void;
    stopPropagation(): void;
}
export declare class KeyboardContextMenuEvent extends ContextMenuEvent {
    private originalEvent;
...
export declare enum DragOverEffect {
    COPY = 0,
    MOVE = 1,
}
export declare enum DragOverBubble {
    BUBBLE_DOWN = 0,
    BUBBLE_UP = 1,
}
...
export declare const DRAG_OVER_REJECT: IDragOverReaction;
export declare const DRAG_OVER_ACCEPT: IDragOverReaction;
export declare const DRAG_OVER_ACCEPT_BUBBLE_UP: IDragOverReaction;
export declare const DRAG_OVER_ACCEPT_BUBBLE_DOWN: (autoExpand?: boolean) => {
    accept: boolean;
    bubble: DragOverBubble;
    autoExpand: boolean;
};
export declare const DRAG_OVER_ACCEPT_BUBBLE_UP_COPY: IDragOverReaction;
export declare const DRAG_OVER_ACCEPT_BUBBLE_DOWN_COPY: (autoExpand?: boolean) => {
    accept: boolean;
    bubble: DragOverBubble;
    effect: DragOverEffect;
};
