 ...
 */
function detectMimesFromStream(instream, nameHint) {
    return doDetectMimesFromStream(instream).then(function (encoding) {
 ...
 */
function detectMimesFromFile(absolutePath) {
    return doDetectMimesFromFile(absolutePath).then(function (encoding) {
