...
function _loadLanguage(languageId:string): TPromise<void> {
	...
	return new monaco.TPromise<void>((c, e, p) => {
...
let languagePromises:{[languageId:string]: TPromise<void>} = {};

export function loadLanguage(languageId:string): TPromise<void> {
