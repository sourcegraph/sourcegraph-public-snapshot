...
module.exports = {
	...
	module: {
		loaders: [
			...
			{test: /\.svg$/, loader: "url"},
			{test: /\.css$/, exclude: /\.raw\.css$/, loader: "style!css?sourceMap&modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!postcss"},
			{test: /\.css$/, include: /\.raw\.css$/, loader: "style!css"},
		],
		noParse: /\.min\.js$/,
	},
	ts: {
