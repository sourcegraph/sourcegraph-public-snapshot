...
//
// Assumes it runs AFTER withFileBlob (which sets state.path).
export function withLastSrclibDataVersion(C) {
	class WithLastSrclibDataVersion extends Container<Props, State> {
		reconcileState(state: State, props: Props): void {
			...
			state.vcsCommitID = props.commitID || null;
	...
	return WithLastSrclibDataVersion;
}
