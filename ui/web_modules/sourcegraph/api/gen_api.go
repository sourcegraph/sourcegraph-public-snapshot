...
func main() {
	...
	conf.Import("sourcegraph.com/sourcegraph/sourcegraph/vendor/github.com/sourcegraph/sourcegraph-go/pkg/lsp")
	prog, err := conf.Load()
	if err != nil {
		log.Fatal(err)
	}
	...
	packages := []string{
		...
		"sourcegraph.com/sourcegraph/sourcegraph/vendor/github.com/sourcegraph/sourcegraph-go/pkg/lsp",
