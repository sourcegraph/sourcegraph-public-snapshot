	...
	return (
		<div>
			...
			<div className={styles.content}>
				...
				<ol>
					<li>Transform the “m-times-n” language-editor tool problem into a more manageable “m-plus-n” problem by using the Language Server Protocol (LSP) open standard</li>
				...
				<ol>
					<li>Add basic code intelligence (jump-to-def, hover, find-references, etc.) to diff views in code review tools (GitHub pull requests, etc.) - DONE TODO</li>
