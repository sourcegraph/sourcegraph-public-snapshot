	...
	return (
		<div>
			...
			<div className={styles.content}>
				<Heading level={4} className={styles.h5}><Link to="/plan"><u>Sourcegraph Master Plan</u> &raquo;</Link></Heading>
				<p className={styles.p}>What we're building and why you should care</p>
				<br/>

				<Heading level={4} className={styles.h5}><Link to="/docs"><u>Sourcegraph Documentation</u> &raquo;</Link></Heading>
				<p className={styles.p}>How to use Sourcegraph</p>
				...
				<p className={styles.p}>In the last 24 hours, you almost certainly used a product built by developers who use Sourcegraph. We believe every developer will eventually be using Sourcegraph. If you want to help make that happen, <a href="/jobs">join our team</a>.</p>
