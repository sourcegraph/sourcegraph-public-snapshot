	...
	return (
		<div>
			...
			<div className={styles.content}>
				...
				<Heading level="3" underline="blue" id="sourcegraph">Sourcegraph</Heading>
				<Heading level="4" className={styles.h5} id="code_intelligence">Code Intelligence</Heading>
				...
				<Heading level="5" className={styles.h5} id="find_local_references">Find Local References</Heading>
				...
				<Heading level="5" className={styles.h5} id="peek_definition">Peek Definition</Heading>
				...
				<Heading level="5" className={styles.h5} id="go_to_definition">Go to Definition</Heading>
				...
				<Heading level="5" className={styles.h5} id="find_external_references">Find External References</Heading>
				...
				<Heading level="4" className={styles.h5} id="search">Search</Heading>
				...
				<Heading level="5" className={styles.h5} id="repo_search">Repo Search</Heading>
				...
				<Heading level="5" className={styles.h5} id="file_search">File Search</Heading>
				...
				<Heading level="5" className={styles.h5} id="definition_search">Definition Search</Heading>
				...
				<br/>
				<Heading level="3" underline="blue" id="github_extension">GitHub Extension</Heading>
				...
				<Heading level="5" className={styles.h5} id="github_hover_over_documentation">Hover over Documentation</Heading>
				...
				<Heading level="5" className={styles.h5} id="github_jump_to_definition">Jump to Definition</Heading>
				...
				<br/>
				<Heading level="3" underline="blue" id="auth_private_repos">Sourcegraph for your Private Code</Heading>
				...
				<Heading level="3" underline="blue" id="languages_supported">Languages Supported</Heading>
