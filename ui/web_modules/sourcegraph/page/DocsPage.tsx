	...
	return (
		<div>
			...
			<div className={styles.content}>
				...
				<p className={styles.p}>Click on a symbol (i.e. a function, struct, variable or package) and you'll get a view that includes the symbol's definition, any documentation provided, an ability to jump to where it's defined, and a list of where it's referenced both in the current repository, and every other publicly available repository on Github.</p>
