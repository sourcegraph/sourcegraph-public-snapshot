	...
	render(): JSX.Element {
		...
		if (!this.renderedElement) {
			...
			if (this.props.injectedComponent) {
				this.renderedElement = React.cloneElement(this.props.main, { injectedComponentCallback: this.renderInjectedComponent.bind(this, this.props.injectedComponent) });
			} else {
				this.renderedElement = React.cloneElement(this.props.main, { injectedComponentCallback: this.renderInjectedComponent.bind(this) });
			}
		}
