...
export function Graduate(props: Props): JSX.Element {
	return <Symbol {...props} viewBox="0 0 64 64"><path fillRule="evenodd" d="M13.1 30.8l-7.44-3.72a1.2 1.2 0 0 1 0-2.15l25.5-12.73a1.87 1.87 0 0 1 1.67 0l25.5 12.73a1.2 1.2 0 0 1 0 2.15L32.84 39.8a1.87 1.87 0 0 1-1.67 0l-11.4-5.68a.5.5 0 0 1 0-.9l12.68-6.32a1 1 0 0 0-.9-1.8L17.9 31.94a2 2 0 0 0-1.1 1.55c-.1.66-1.58 12.57-1.58 12.57a2.97 2.97 0 0 1-.2 4.14l.94 5.96a1 1 0 0 1-.53 1.05 5.92 5.92 0 0 1-7.08-.86 1 1 0 0 1-.26-1.15l2.35-5.58a2.97 2.97 0 0 1 .8-4.05zm17.17 10.76a3.86 3.86 0 0 0 3.45 0l13.55-6.75a.5.5 0 0 1 .72.4c.45 4.03.95 8.3.98 8.5a1 1 0 0 1-.37.97A31 31 0 0 1 32.03 50a31.66 31.66 0 0 1-14.16-3.8 1 1 0 0 1-.5-1l1.08-8.8a.5.5 0 0 1 .72-.37z" /></Symbol>;
}
