import * as utilColorHelpers from "sourcegraph/components/utils/colorHelpers";
...
import * as utilPaddingMargin from "sourcegraph/components/utils/paddingMargin";
...
export let paddingMargin = utilPaddingMargin;
export let typography = utilTypography;
export let colorHelpers = utilColorHelpers;
