...
export declare class SuggestModel implements IDisposable {
    ...
    trigger(auto: boolean, retrigger?: boolean, onlyFrom?: ISuggestSupport[]): void;
    private triggerFromIncomplete(auto);
