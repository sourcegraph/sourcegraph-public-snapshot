...
var CompletionModel = (function () {
    ...
    CompletionModel.prototype._createCachedState = function () {
        ...
        for (var _i = 0, _b = this._items; _i < _b.length; _i++) {
            ...
            var score = CompletionModel._score(suggestion.insertText, word, wordLowerCase);
            if (score > topScore) {
                topScore = score;
    ...
    CompletionModel._score = function (suggestion, currentWord, currentWordLowerCase) {
        var suggestionLowerCase = suggestion.toLowerCase();
        var score = 0;
        for (var i = 0, len = Math.min(currentWord.length, suggestion.length); i < len; i++) {
