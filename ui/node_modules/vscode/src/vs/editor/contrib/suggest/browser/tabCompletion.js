...
editorCommonExtensions_1.CommonEditorRegistry.registerEditorCommand(new TabCompletionCommand({
    ...
    kbOpts: {
        ...
        kbExpr: contextkey_1.ContextKeyExpr.and(EditorContextKeys.TextFocus, EditorContextKeys.TabDoesNotMoveFocus, contextkey_1.ContextKeyExpr.has('config.editor.tabCompletion')),
        primary: 2 /* Tab */
    }
}));
