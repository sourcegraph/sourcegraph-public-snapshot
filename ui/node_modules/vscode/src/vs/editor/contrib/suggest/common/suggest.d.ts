...
export declare const snippetSuggestSupport: ISuggestSupport;
export declare function provideSuggestionItems(model: IReadOnlyModel, position: Position, snippetConfig?: SnippetConfig, onlyFrom?: ISuggestSupport[]): TPromise<ISuggestionItem[]>;
