...
var FindController = (function (_super) {
    ...
    function FindController(editor, contextViewService, contextKeyService, keybindingService) {
        _super.call(this, editor, contextKeyService);
        this._widget = this._register(new findWidget_1.FindWidget(editor, this, this._state, contextViewService, keybindingService, contextKeyService));
    }
