...
export declare class FindModelBoundToEditorModel {
    ...
    private _moveToNextMatch(nextMatch);
    private _moveToNextMatch(after);
    private _getNextMatch(after, isRecursed?);
    moveToNextMatch(): void;
    private getReplaceString(matchRange);
    private _getTextToMatch(matchRange, regExp);
    replace(): void;
    private _findMatches(findScope, limitResultCount);
    replaceAll(): void;
