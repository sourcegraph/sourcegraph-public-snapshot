...
var CommonFindController = (function (_super) {
    ...
    function CommonFindController(editor, contextKeyService) {
        ...
        _super.call(this);
        this._editor = editor;
        this._findWidgetVisible = exports.CONTEXT_FIND_WIDGET_VISIBLE.bindTo(contextKeyService);
        this._updateHistoryDelayer = new async_1.Delayer(500);
        this._currentHistoryNavigator = new history_1.HistoryNavigator();
...
var SelectNextFindMatchAction = (function (_super) {
    ...
    SelectNextFindMatchAction.prototype._getNextMatch = function (editor) {
        var r = multiCursorFind(editor, true);
        if (!r) {
            return null;
        }
        if (r.currentMatch) {
...
var SelectionHighlighter = (function (_super) {
    ...
    function SelectionHighlighter(editor) {
        ...
        this._register(CommonFindController.get(editor).getState().addChangeListener(function (e) {
            _this._update();
        }));
    }
