        ...
        for (var _i = 0, selectionEntries_1 = selectionEntries; _i < selectionEntries_1.length; _i++) {
            ...
            if (finalCursorPos) {
                ...
                if (finalCursorPos.lineNumber === typeRange.startLineNumber) {
                    ...
                    for (var i_3 = 0, lineNumber = typeRange.startLineNumber; lineNumber < finalCursorPos.lineNumber; i_3++, lineNumber++) {
                        finalCursorOffset += adaptedSnippet.lines[i_3].length + model.getEOL().length;
                    }
                }
