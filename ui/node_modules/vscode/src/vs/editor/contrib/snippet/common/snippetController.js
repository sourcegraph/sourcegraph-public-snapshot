...
var InsertSnippetController = (function () {
    ...
    InsertSnippetController.prototype.initialize = function (adaptedSnippet, startLineNumber) {
        ...
        for (var _c = 0, _d = adaptedSnippet.placeHolders; _c < _d.length; _c++) {
            var occurences = _d[_c].occurences;
            var trackedRanges = [];
            for (var _e = 0, occurences_2 = occurences; _e < occurences_2.length; _e++) {
                var range = occurences_2[_e];
        ...
        this.editor.changeDecorations(function (changeAccessor) {
            ...
            for (var i = 0, len = _this.trackedPlaceHolders.length; i < len; i++) {
                ...
                newDecorations.push({
                    range: _this.model.getTrackedRange(_this.trackedPlaceHolders[i].ranges[0]),
                    options: {
                        className: className
                    }
                });
    ...
    InsertSnippetController.prototype.stopAll = function () {
        ...
        this.editor.changeDecorations(function (changeAccessor) {
            ...
            for (var i_1 = 0; i_1 < _this.placeHolderDecorations.length; i_1++) {
                toRemove.push(_this.placeHolderDecorations[i_1]);
            }
...
var SnippetController = (function () {
    ...
    SnippetController.prototype.run = function (snippet, overwriteBefore, overwriteAfter, stripPrefix) {
        ...
        this._runAndRestoreController(function () {
            if (snippet.isInsertOnly || snippet.isSingleTabstopOnly) {
                ...
                var prepared = SnippetController._prepareSnippet(_this._editor, _this._editor.getSelection(), snippet, overwriteBefore, overwriteAfter, stripPrefix);
    ...
    SnippetController.prototype.runWithReplaceRange = function (snippet, replaceRange) {
        ...
        this._runAndRestoreController(function () {
            _this._runPreparedSnippetForPrimarySelection({
                ...
                adaptedSnippet: SnippetController._getAdaptedSnippet(_this._editor.getModel(), snippet, replaceRange)
            }, false);
        });
    };
    ...
    SnippetController.prototype._runForAllSelections = function (snippet, overwriteBefore, overwriteAfter, stripPrefix) {
        ...
        for (var _i = 0, selectionEntries_1 = selectionEntries; _i < selectionEntries_1.length; _i++) {
            ...
            var _b = SnippetController._prepareSnippet(this._editor, selection, snippet, overwriteBefore, overwriteAfter, stripPrefix), adaptedSnippet = _b.adaptedSnippet, typeRange = _b.typeRange;
            ...
            var finalCursorPos = SnippetController._getSnippetCursorOnly(adaptedSnippet);
            if (finalCursorPos) {
                ...
                if (finalCursorPos.lineNumber === typeRange.startLineNumber) {
                    ...
                    for (var i_2 = 0, lineNumber = typeRange.startLineNumber; lineNumber < finalCursorPos.lineNumber; i_2++, lineNumber++) {
                        finalCursorOffset += adaptedSnippet.lines[i_2].length + model.getEOL().length;
                    }
                }
