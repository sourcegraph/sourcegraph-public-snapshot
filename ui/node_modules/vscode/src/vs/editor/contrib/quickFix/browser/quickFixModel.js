...
var QuickFixOracle = (function () {
    ...
    QuickFixOracle.prototype._onCursorChange = function () {
        var range = this._markerAtPosition() || this._wordAtPosition();
        this._signalChange({
            type: 'auto',
            range: range,
            position: this._editor.getPosition(),
            fixes: range && quickFix_1.getCodeActions(this._editor.getModel(), range_1.Range.lift(range))
        });
    };
    QuickFixOracle.prototype._markerAtPosition = function () {
        ...
        var idx = arrays.findFirst(markers, function (marker) { return marker.startLineNumber >= positionLineNumber; });
...
var QuickFixModel = (function () {
    function QuickFixModel(editor, markerService) {
        ...
        this._disposables.push(this._editor.onDidChangeModelMode(function () { return _this._update(); }));
    ...
    QuickFixModel.prototype.triggerManual = function (selection) {
        var model = this._editor.getModel();
        if (model) {
            var fixes = quickFix_1.getCodeActions(model, selection);
