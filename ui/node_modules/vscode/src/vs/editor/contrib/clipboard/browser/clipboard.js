    ...
    function ExecCommandCutAction() {
        _super.call(this, 'cut', {
            ...
            kbOpts: {
                ...
                primary: 32768 /* CtrlCmd */ | 54 /* KEY_X */,
                win: { primary: 32768 /* CtrlCmd */ | 54 /* KEY_X */, secondary: [16384 /* Shift */ | 20 /* Delete */] }
            },
            menuOpts: {
    ...
    function ExecCommandCopyAction() {
        _super.call(this, 'copy', {
            ...
            kbOpts: {
                ...
                win: { primary: 32768 /* CtrlCmd */ | 33 /* KEY_C */, secondary: [32768 /* CtrlCmd */ | 19 /* Insert */] }
            },
            menuOpts: {
                group: CLIPBOARD_CONTEXT_MENU_GROUP,
                order: 2
    ...
    function ExecCommandPasteAction() {
        _super.call(this, 'paste', {
            ...
            kbOpts: {
                ...
                win: { primary: 32768 /* CtrlCmd */ | 52 /* KEY_V */, secondary: [16384 /* Shift */ | 19 /* Insert */] }
            },
            menuOpts: {
                group: CLIPBOARD_CONTEXT_MENU_GROUP,
                order: 3
