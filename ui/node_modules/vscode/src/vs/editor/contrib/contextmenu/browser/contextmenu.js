...
var ContextMenuController = (function () {
    function ContextMenuController(editor, _contextMenuService, _contextViewService, _contextKeyService, _keybindingService, _menuService) {
        ...
        this._editor = editor;
        this._contextMenu = this._menuService.createMenu(actions_1.MenuId.EditorContext, this._contextKeyService);
    ...
    ContextMenuController.prototype._getMenuActions = function () {
        var result = [];
        var groups = this._contextMenu.getActions();
