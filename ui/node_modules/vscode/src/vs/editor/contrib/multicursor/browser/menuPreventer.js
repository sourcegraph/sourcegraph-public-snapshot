...
var MenuPreventer = (function (_super) {
    ...
    function MenuPreventer(editor) {
        ...
        this._register(this._editor.onMouseDown(function (e) {
            if (_this._altListeningMouse) {
                _this._altMouseTriggered = true;
            }
        }));
        this._register(this._editor.onKeyDown(function (e) {
        ...
        this._register(this._editor.onKeyUp(function (e) {
            if (e.equals(8192 /* Alt */)) {
