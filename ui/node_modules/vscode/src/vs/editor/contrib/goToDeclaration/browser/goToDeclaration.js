...
var GoToDefinitionAction = (function (_super) {
    ...
    function GoToDefinitionAction() {
        _super.call(this, new DefinitionActionConfig(), {
...
var OpenDefinitionToSideAction = (function (_super) {
    ...
    function OpenDefinitionToSideAction() {
        _super.call(this, new DefinitionActionConfig(true), {
...
var PeekDefinitionAction = (function (_super) {
    ...
    function PeekDefinitionAction() {
        _super.call(this, new DefinitionActionConfig(void 0, true, false), {
...
var GotoDefinitionWithMouseEditorContribution = (function () {
    function GotoDefinitionWithMouseEditorContribution(editor, editorService, modeService) {
        var _this = this;
            ...
            if (results.length > 1) {
                ...
                _this.editorService.resolveEditorModel({ resource: result_1.uri }).then(function (model) {
                    ...
                    if (model && model.textEditorModel) {
                        ...
                        // Sourcegraph uses a nonstandard URI field, because it needs to
                        // distinguish between repository URL and the filepath inside the
                        // repository.
