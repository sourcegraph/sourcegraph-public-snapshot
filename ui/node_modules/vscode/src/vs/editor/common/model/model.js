...
var Model = (function (_super) {
    ...
    function Model(rawText, languageId, associatedResource) {
        ...
        var _this = _super.call(this, [editorCommon_1.EventType.ModelDispose], rawText, languageId) || this;
        ...
        if (aliveModels[String(_this._associatedResource)]) {
            throw new Error('Cannot instantiate a second Model with the same URI: ' + String(_this._associatedResource));
        }
