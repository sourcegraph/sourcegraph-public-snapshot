...
var TokensBinaryEncodingValues;
...
})(TokensBinaryEncodingValues = exports.TokensBinaryEncodingValues || (exports.TokensBinaryEncodingValues = {}));
    ...
    TokensBinaryEncoding.deflateArr = function (map, tokens) {
        ...
        for (i = 0, len = tokens.length; i < len; i++) {
            ...
            if (token.startIndex <= prevStartIndex) {
                token = new token_1.Token(prevStartIndex + 1, token.type);
