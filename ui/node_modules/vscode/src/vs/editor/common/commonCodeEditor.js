...
var CommonCodeEditor = (function (_super) {
    ...
    function CommonCodeEditor(domElement, options, instantiationService, contextKeyService) {
        ...
        this._lifetimeDispose.push(this._configuration.onDidChange(function (e) {
        ...
        this._lifetimeDispose.push(new editorModeContext_1.EditorModeContext(this, this._contextKeyService));
    ...
    CommonCodeEditor.prototype.addAction = function (descriptor) {
        ...
        commands_1.CommandsRegistry.registerCommand(uniqueId, function () { return action.run(); });
        ...
        if (this.model) {
            ...
            var viewModelHelper = {
                ...
                convertViewRangeToModelRange: function (viewRange) {
                    return _this.viewModel.convertViewRangeToModelRange(viewRange);
                },
...
var EditorContextKeysManager = (function (_super) {
    ...
    function EditorContextKeysManager(editor, contextKeyService) {
        ...
        this._register(this._editor.onDidChangeConfiguration(function () { return _this._updateFromConfig(); }));
        this._register(this._editor.onDidChangeCursorSelection(function () { return _this._updateFromSelection(); }));
        this._register(this._editor.onDidFocusEditor(function () { return _this._updateFromFocus(); }));
        this._register(this._editor.onDidBlurEditor(function () { return _this._updateFromFocus(); }));
        this._register(this._editor.onDidFocusEditorText(function () { return _this._updateFromFocus(); }));
        this._register(this._editor.onDidBlurEditorText(function () { return _this._updateFromFocus(); }));
