 ...
 * @internal
 */
export declare type SuggestionType = 'method' | 'function' | 'constructor' | 'field' | 'variable' | 'class' | 'interface' | 'module' | 'property' | 'unit' | 'value' | 'enum' | 'keyword' | 'snippet' | 'text' | 'color' | 'file' | 'reference' | 'customcolor';
/**
 * @internal
 */
...
export declare namespace SymbolKind {
     ...
     * @internal
     */
    function from(kind: number | SymbolKind): string;
    /**
     * @internal
     */
    function to(type: string): SymbolKind;
}
/**
...
export interface IRichEditBrackets {
    ...
    textIsBracket: {
        [text: string]: editorCommon.IRichEditBracket;
    };
    textIsOpenBracket: {
        [text: string]: boolean;
    };
 ...
 * @internal
 */
export declare const SuggestRegistry: LanguageFeatureRegistry<ISuggestSupport>;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare class TokenizationRegistryImpl {
    private _map;
     ...
     */
    fire(languageId: string): void;
    register(languageId: string, support: ITokenizationSupport): IDisposable;
    get(languageId: string): ITokenizationSupport;
}
/**
 * @internal
 */
