...
var CommonEditorConfiguration = (function (_super) {
    ...
    function CommonEditorConfiguration(options, elementSizeObserver) {
        ...
        this._register(exports.EditorZoom.onDidChangeZoomLevel(function (_) { return _this._recomputeOptions(); }));
        this._register(exports.TabFocus.onDidChangeTabFocus(function (_) { return _this._recomputeOptions(); }));
    }
