...
var Cursor = (function (_super) {
    ...
    Cursor.prototype._replacePreviousChar = function (ctx) {
        ...
        return this._invokeForAll(ctx, function (cursorIndex, oneCursor, oneCtx) { return oneCursor_1.OneCursorOp.replacePreviousChar(oneCursor, text, replaceCharCnt, oneCtx); }, false, false);
    };
    ...
    Cursor.prototype._revealLine = function (ctx) {
        ...
        var revealAt = editorCommon.VerticalRevealType.Simple;
        if (revealLineArg.at) {
