...
var CodeEditorWidget = (function (_super) {
    ...
    function CodeEditorWidget(domElement, options, instantiationService, codeEditorService, commandService, contextKeyService) {
        var _this = this;
        _super.call(this, domElement, options, instantiationService, contextKeyService);
        ...
        this.contentWidgets = {};
        this.overlayWidgets = {};
        var contributions = this._getContributions();
        for (var i = 0, len = contributions.length; i < len; i++) {
            var ctor = contributions[i];
            try {
                var contribution = this._instantiationService.createInstance(ctor, this);
        ...
        this._getActions().forEach(function (action) {
...
var CodeEditorWidgetFocusTracker = (function (_super) {
    ...
    function CodeEditorWidgetFocusTracker(domElement) {
        ...
        this._domFocusTracker.addFocusListener(function () {
            _this._hasFocus = true;
            _this._onChange.fire(void 0);
        });
        this._domFocusTracker.addBlurListener(function () {
