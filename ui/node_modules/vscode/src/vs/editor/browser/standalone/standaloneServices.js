...
(function (StaticServices) {
    ...
    StaticServices.editorWorkerService = define(editorWorkerService_1.IEditorWorkerService, function (o) { return new editorWorkerServiceImpl_1.EditorWorkerServiceImpl(StaticServices.modelService.get(o)); });
...
var DynamicStandaloneServices = (function (_super) {
    ...
    function DynamicStandaloneServices(domElement, overrides) {
        ...
        var configurationService = this.get(configuration_1.IConfigurationService);
        var extensionService = this.get(extensions_1.IExtensionService);
        var messageService = this.get(message_1.IMessageService);
        var telemetryService = this.get(telemetry_1.ITelemetryService);
