...
var lineParts_1 = require("vs/editor/common/core/lineParts");
var Colorizer = (function () {
    ...
    Colorizer.colorizeLine = function (line, tokens, tabSize) {
        ...
        var renderResult = viewLineRenderer_1.renderLine(new viewLineRenderer_1.RenderLineInput(line, tabSize, 0, -1, 'none', false, new lineParts_1.LineParts(tokens, line.length + 1)));
...
function _fakeColorize(lines, tabSize) {
    ...
    for (var i = 0, length_1 = lines.length; i < length_1; i++) {
        var line = lines[i];
        var renderResult = viewLineRenderer_1.renderLine(new viewLineRenderer_1.RenderLineInput(line, tabSize, 0, -1, 'none', false, new lineParts_1.LineParts([], line.length + 1)));
...
function _actualColorize(lines, tabSize, tokenizationSupport) {
    ...
    for (var i = 0, length_2 = lines.length; i < length_2; i++) {
        ...
        var renderResult = viewLineRenderer_1.renderLine(new viewLineRenderer_1.RenderLineInput(line, tabSize, 0, -1, 'none', false, new lineParts_1.LineParts(tokenizeResult.tokens.map(function (t) { return new viewLineToken_1.ViewLineToken(t.startIndex, t.type); }), line.length + 1)));
        html = html.concat(renderResult.output);
        html.push('<br/>');
