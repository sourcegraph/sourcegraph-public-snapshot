 ...
 * @internal
 */
export declare type IEditorContributionCtor = IConstructorSignature1<ICodeEditor, editorCommon.IEditorContribution>;
/**
 * An overview ruler
 * @internal
 */
...
export interface ICodeEditor extends editorCommon.ICommonCodeEditor {
     ...
     */
    getScrolledVisiblePosition(position: editorCommon.IPosition): {
        top: number;
        left: number;
        height: number;
    };
