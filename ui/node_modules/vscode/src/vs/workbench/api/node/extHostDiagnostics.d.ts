...
import { MainThreadDiagnosticsShape, ExtHostDiagnosticsShape } from './extHost.protocol';
export declare class DiagnosticCollection implements vscode.DiagnosticCollection {
    private static _maxDiagnosticsPerFile;
    private _name;
    private _proxy;
    private _isDisposed;
    private _data;
    ...
    private static _compareTuplesByUri(a, b);
}
export declare class ExtHostDiagnostics extends ExtHostDiagnosticsShape {
