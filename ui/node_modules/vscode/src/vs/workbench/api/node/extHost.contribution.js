...
var languageConfiguration_1 = require('vs/editor/node/languageConfiguration');
...
var ExtHostContribution = (function () {
    ...
    ExtHostContribution.prototype.initExtensionSystem = function () {
        ...
        col.define(extHost_protocol_1.MainContext.MainThreadDocuments).set(create(mainThreadDocuments_1.MainThreadDocuments));
        col.define(extHost_protocol_1.MainContext.MainThreadEditors).set(create(mainThreadEditors_1.MainThreadEditors));
        ...
        // Other interested parties
        create(TMSyntax_1.MainProcessTextMateSyntax);
        create(TMSnippets_1.MainProcessTextMateSnippet);
        create(jsonValidationExtensionPoint_1.JSONValidationExtensionPoint);
        create(languageConfiguration_1.LanguageConfigurationFileHandler);
        create(mainThreadFileSystemEventService_1.MainThreadFileSystemEventService);
        create(mainThreadHeapService_1.MainThreadHeapService);
