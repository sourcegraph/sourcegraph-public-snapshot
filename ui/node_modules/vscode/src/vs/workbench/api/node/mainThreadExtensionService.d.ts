...
export declare class MainProcessExtensionService extends AbstractExtensionService<ActivatedExtension> {
     ...
     */
    constructor(threadService: IThreadService, messageService: IMessageService, environmentService: IEnvironmentService, extensionEnablementService: IExtensionEnablementService);
    ...
    private _onExtensionDescriptions(extensionDescriptions);
    private _handleExtensionPoint<T>(extensionPoint, availableExtensions);
