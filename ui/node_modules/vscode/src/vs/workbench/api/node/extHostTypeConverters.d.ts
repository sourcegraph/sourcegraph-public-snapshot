...
export declare function fromSymbolInformation(info: vscode.SymbolInformation): IWorkspaceSymbol;
export declare function toSymbolInformation(bearing: IWorkspaceSymbol): types.SymbolInformation;
