...
var EditorGroup = (function () {
    ...
    EditorGroup.prototype.getEditor = function (arg1) {
        ...
        for (var i = 0; i < this.editors.length; i++) {
            ...
            var editorResource = editor_1.getResource(editor);
    ...
    EditorGroup.prototype.closeEditor = function (editor, openNext) {
        ...
        // Event
        this.fireEvent(this._onEditorClosed, { editor: editor, pinned: pinned, index: index }, true);
    };
    ...
    EditorGroup.prototype.isPinned = function (editor) {
        var index = this.indexOf(editor);
        if (index === -1) {
    ...
    EditorGroup.prototype.updateResourceMap = function (editor, remove) {
        ...
        if (resource) {
            ...
            var counter = this.mapResourceToEditorCount[resource.toString()] || 0;
    ...
    EditorGroup.prototype.contains = function (arg1) {
        if (arg1 instanceof editor_1.EditorInput) {
            return this.indexOf(arg1) >= 0;
        }
        var counter = this.mapResourceToEditorCount[arg1.toString()];
...
var EditorStacksModel = (function () {
    ...
    EditorStacksModel.prototype.registerListeners = function () {
        var _this = this;
        this.toDispose.push(this.lifecycleService.onShutdown(function () { return _this.onShutdown(); }));
    };
    ...
    EditorStacksModel.prototype.next = function () {
        this.ensureLoaded();
        if (!this.activeGroup) {
            return null;
        }
    ...
    EditorStacksModel.prototype.previous = function () {
        this.ensureLoaded();
        if (!this.activeGroup) {
            return null;
        }
    ...
    EditorStacksModel.prototype.handleOnEditorClosed = function (event) {
        ...
        if (!this.isOpen(editor)) {
            ...
            if (editor instanceof diffEditorInput_1.DiffEditorInput) {
                [editor.originalInput, editor.modifiedInput].forEach(function (editor) {
                    if (!_this.isOpen(editor)) {
                        editor.close();
                    }
                });
            }
    ...
    EditorStacksModel.prototype.isOpen = function (arg1) {
        return this._groups.some(function (group) { return group.contains(arg1); });
    };
    EditorStacksModel.prototype.count = function (arg1) {
        return this._groups.filter(function (group) { return group.contains(arg1); }).length;
    };
