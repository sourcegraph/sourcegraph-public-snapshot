...
var UntitledEditorInput = (function (_super) {
    ...
    UntitledEditorInput.prototype.createModel = function () {
        var _this = this;
        var content = '';
        var model = this.instantiationService.createInstance(untitledEditorModel_1.UntitledEditorModel, content, this.modeId, this.resource, this.hasAssociatedFilePath);
