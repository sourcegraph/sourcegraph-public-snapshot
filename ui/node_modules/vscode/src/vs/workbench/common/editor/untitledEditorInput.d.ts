...
export declare class UntitledEditorInput extends AbstractUntitledEditorInput {
    ...
    private toUnbind;
    constructor(resource: URI, hasAssociatedFilePath: boolean, modeId: string, instantiationService: IInstantiationService, contextService: IWorkspaceContextService, textFileService: ITextFileService);
