...
export declare class UntitledEditorModel extends StringEditorModel implements IEncodingSupport {
    ...
    constructor(value: string, mime: string, resource: URI, hasAssociatedFilePath: boolean, modeService: IModeService, modelService: IModelService, configurationService: IConfigurationService);
