...
var UntitledEditorModel = (function (_super) {
    ...
    function UntitledEditorModel(value, mime, resource, hasAssociatedFilePath, modeService, modelService, configurationService) {
        _super.call(this, value, mime, resource, modeService, modelService);
    ...
    UntitledEditorModel.prototype.getOrCreateMode = function (modeService, mime, firstLineText) {
        if (mime_1.isUnspecific(mime)) {
        ...
        return _super.prototype.getOrCreateMode.call(this, modeService, mime, firstLineText);
    };
