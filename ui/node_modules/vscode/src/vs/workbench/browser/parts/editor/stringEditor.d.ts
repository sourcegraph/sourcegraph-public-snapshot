...
export declare class StringEditor extends BaseTextEditor {
    ...
    constructor(telemetryService: ITelemetryService, instantiationService: IInstantiationService, contextService: IWorkspaceContextService, storageService: IStorageService, messageService: IMessageService, configurationService: IConfigurationService, eventService: IEventService, editorService: IWorkbenchEditorService, themeService: IThemeService, untitledEditorService: IUntitledEditorService);
     ...
     */
    revealLastLine(smartReveal?: boolean): void;
    clearInput(): void;
}
