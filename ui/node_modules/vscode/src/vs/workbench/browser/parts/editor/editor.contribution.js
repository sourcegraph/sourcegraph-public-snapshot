...
platform_1.Registry.as(quickopen_1.Extensions.Quickopen).registerQuickOpenHandler(new quickopen_1.QuickOpenHandlerDescriptor('vs/workbench/browser/parts/editor/editorPicker', 'LeftEditorGroupPicker', editorActions_1.NAVIGATE_IN_LEFT_GROUP_PREFIX, [
    {
        prefix: editorActions_1.NAVIGATE_IN_LEFT_GROUP_PREFIX,
        needsEditor: false,
        description: nls.localize('leftEditorGroupPicker', "Show Editors in Left Group")
    }
]));
platform_1.Registry.as(quickopen_1.Extensions.Quickopen).registerQuickOpenHandler(new quickopen_1.QuickOpenHandlerDescriptor('vs/workbench/browser/parts/editor/editorPicker', 'CenterEditorGroupPicker', editorActions_1.NAVIGATE_IN_CENTER_GROUP_PREFIX, [
    {
        prefix: editorActions_1.NAVIGATE_IN_CENTER_GROUP_PREFIX,
        needsEditor: false,
        description: nls.localize('centerEditorGroupPicker', "Show Editors in Center Group")
    }
]));
platform_1.Registry.as(quickopen_1.Extensions.Quickopen).registerQuickOpenHandler(new quickopen_1.QuickOpenHandlerDescriptor('vs/workbench/browser/parts/editor/editorPicker', 'RightEditorGroupPicker', editorActions_1.NAVIGATE_IN_RIGHT_GROUP_PREFIX, [
    {
        prefix: editorActions_1.NAVIGATE_IN_RIGHT_GROUP_PREFIX,
        needsEditor: false,
...
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(editorActions_1.ShowEditorsInLeftGroupAction, editorActions_1.ShowEditorsInLeftGroupAction.ID, editorActions_1.ShowEditorsInLeftGroupAction.LABEL), 'View: Show Editors in Left Group', category);
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(editorActions_1.ShowEditorsInCenterGroupAction, editorActions_1.ShowEditorsInCenterGroupAction.ID, editorActions_1.ShowEditorsInCenterGroupAction.LABEL), 'View: Show Editors in Center Group', category);
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(editorActions_1.ShowEditorsInRightGroupAction, editorActions_1.ShowEditorsInRightGroupAction.ID, editorActions_1.ShowEditorsInRightGroupAction.LABEL), 'View: Show Editors in Left Group', category);
...
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(editorActions_1.FocusFirstGroupAction, editorActions_1.FocusFirstGroupAction.ID, editorActions_1.FocusFirstGroupAction.LABEL, { primary: 32768 /* CtrlCmd */ | 22 /* KEY_1 */ }), 'View: Focus Left Editor Group', category);
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(editorActions_1.FocusSecondGroupAction, editorActions_1.FocusSecondGroupAction.ID, editorActions_1.FocusSecondGroupAction.LABEL, { primary: 32768 /* CtrlCmd */ | 23 /* KEY_2 */ }), 'View: Focus Center Editor Group', category);
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(editorActions_1.FocusThirdGroupAction, editorActions_1.FocusThirdGroupAction.ID, editorActions_1.FocusThirdGroupAction.LABEL, { primary: 32768 /* CtrlCmd */ | 24 /* KEY_3 */ }), 'View: Focus Right Editor Group', category);
...
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(editorActions_1.MoveEditorToLeftGroupAction, editorActions_1.MoveEditorToLeftGroupAction.ID, editorActions_1.MoveEditorToLeftGroupAction.LABEL, { primary: 32768 /* CtrlCmd */ | 8192 /* Alt */ | 15 /* LeftArrow */, mac: { primary: 32768 /* CtrlCmd */ | 4096 /* WinCtrl */ | 15 /* LeftArrow */ } }), 'View: Move Editor into Group to the Left', category);
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(editorActions_1.MoveEditorToRightGroupAction, editorActions_1.MoveEditorToRightGroupAction.ID, editorActions_1.MoveEditorToRightGroupAction.LABEL, { primary: 32768 /* CtrlCmd */ | 8192 /* Alt */ | 17 /* RightArrow */, mac: { primary: 32768 /* CtrlCmd */ | 4096 /* WinCtrl */ | 17 /* RightArrow */ } }), 'View: Move Editor into Group to the Right', category);
...
registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(editorActions_1.RemoveFromEditorHistoryAction, editorActions_1.RemoveFromEditorHistoryAction.ID, editorActions_1.RemoveFromEditorHistoryAction.LABEL), 'Remove From Editor History');
