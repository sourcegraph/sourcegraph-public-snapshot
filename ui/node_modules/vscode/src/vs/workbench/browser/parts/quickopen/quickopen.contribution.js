...
function navigateKeybinding(shift) {
    if (shift) {
        return {
            ...
            secondary: [32768 /* CtrlCmd */ | 16384 /* Shift */ | 35 /* KEY_E */, 32768 /* CtrlCmd */ | 16384 /* Shift */ | 2 /* Tab */],
            mac: {
                primary: 32768 /* CtrlCmd */ | 16384 /* Shift */ | 46 /* KEY_P */,
                secondary: [4096 /* WinCtrl */ | 16384 /* Shift */ | 2 /* Tab */]
            }
        };
    }
    else {
        return {
            ...
            secondary: [32768 /* CtrlCmd */ | 35 /* KEY_E */, 32768 /* CtrlCmd */ | 2 /* Tab */],
            mac: {
                primary: 32768 /* CtrlCmd */ | 46 /* KEY_P */,
                secondary: [4096 /* WinCtrl */ | 2 /* Tab */]
            }
        };
    }
}
...
registry.registerWorkbenchAction(new actions_2.SyncActionDescriptor(QuickOpenNavigateNextAction, QuickOpenNavigateNextAction.ID, QuickOpenNavigateNextAction.LABEL, navigateKeybinding(false), condition), 'Navigate Next in Quick Open');
