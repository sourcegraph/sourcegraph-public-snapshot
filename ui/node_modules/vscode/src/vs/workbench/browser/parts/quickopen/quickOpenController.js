...
var QuickOpenController = (function (_super) {
    ...
    QuickOpenController.prototype.getEditorHistoryEntries = function (searchValue) {
        ...
        history.forEach(function (input) {
            ...
            var targetToMatch = searchInPath ? labels.getPathLabel(resource, _this.contextService) : input.getName();
...
var EditorHistoryEntry = (function (_super) {
    ...
    function EditorHistoryEntry(input, editorService, modeService, modelService, configurationService) {
