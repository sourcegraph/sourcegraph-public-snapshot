...
var StatusBarEntryItem = (function () {
    function StatusBarEntryItem(entry, commandService, instantiationService, messageService, telemetryService, editorService) {
    ...
    StatusBarEntryItem.prototype.executeCommand = function (id) {
        ...
        if (builtInActionDescriptor) {
            ...
            if (action_1.enabled) {
                ...
                this.messageService.show(message_1.Severity.Warning, nls.localize('canNotRun', "Command '{0}' can not be run from here.", action_1.label || id));
            }
            return;
        }
