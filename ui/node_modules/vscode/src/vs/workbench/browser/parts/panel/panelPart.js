...
var PanelPart = (function (_super) {
    ...
    function PanelPart(id, messageService, storageService, telemetryService, contextMenuService, partService, keybindingService, instantiationService) {
        _super.call(this, messageService, storageService, telemetryService, contextMenuService, partService, keybindingService, instantiationService, platform_1.Registry.as(panel_1.Extensions.Panels), PanelPart.activePanelSettingsKey, 'panel', 'panel', actionBarRegistry_1.Scope.PANEL, id);
    }
...
var ClosePanelAction = (function (_super) {
    ...
    function ClosePanelAction(id, name, partService) {
        _super.call(this, id, name, 'hide-panel-action');
...
var TogglePanelAction = (function (_super) {
    ...
    function TogglePanelAction(id, name, partService) {
        _super.call(this, id, name, partService.isPanelHidden() ? 'panel' : 'panel expanded');
        this.partService = partService;
    }
