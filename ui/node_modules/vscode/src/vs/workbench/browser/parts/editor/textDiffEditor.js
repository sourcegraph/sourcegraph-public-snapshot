...
var TextDiffEditor = (function (_super) {
    ...
    function TextDiffEditor(telemetryService, instantiationService, contextService, storageService, messageService, configurationService, eventService, editorService, contextKeyService, themeService) {
        _super.call(this, TextDiffEditor.ID, telemetryService, instantiationService, contextService, storageService, messageService, configurationService, eventService, editorService, themeService);
        this.textDiffEditorVisible = exports.TextCompareEditorVisible.bindTo(contextKeyService);
    }
