...
var StringEditor = (function (_super) {
    ...
    function StringEditor(telemetryService, instantiationService, contextService, storageService, messageService, configurationService, eventService, editorService, themeService, untitledEditorService) {
        var _this = this;
        _super.call(this, StringEditor.ID, telemetryService, instantiationService, contextService, storageService, messageService, configurationService, eventService, editorService, themeService);
        this.untitledEditorService = untitledEditorService;
        this.mapResourceToEditorViewState = Object.create(null);
        this.toUnbind.push(this.untitledEditorService.onDidChangeDirty(function (e) { return _this.onUntitledDirtyChange(e); }));
    }
