...
var TabsTitleControl = (function (_super) {
    ...
    function TabsTitleControl(contextMenuService, instantiationService, configurationService, editorService, editorGroupService, untitledEditorService, contextKeyService, keybindingService, telemetryService, messageService, menuService, quickOpenService) {
        _super.call(this, contextMenuService, instantiationService, configurationService, editorService, editorGroupService, contextKeyService, keybindingService, telemetryService, messageService, menuService, quickOpenService);
    ...
    TabsTitleControl.prototype.create = function (parent) {
        ...
        this.toDispose.push(DOM.addDisposableListener(this.tabsContainer, DOM.EventType.DBLCLICK, function (e) {
            ...
            if (target instanceof HTMLElement && target.className.indexOf('tabs-container') === 0) {
                ...
                return _this.editorService.openEditor(_this.untitledEditorService.createOrGet(), { pinned: true, index: group.count /* always at the end */ }); // untitled are always pinned
            }
        }));
        // Custom Scrollbar
    ...
    TabsTitleControl.prototype.refreshTabs = function (group) {
        ...
        this.context.getEditors().forEach(function (editor) {
            ...
            bar.push(_this.closeEditorAction, { icon: true, label: false });
    ...
    TabsTitleControl.prototype.hookTabListeners = function (tab, identifier) {
        ...
        // Drag over
        this.tabDisposeables.push(DOM.addDisposableListener(tab, DOM.EventType.DRAG_OVER, function (e) {
    ...
    TabsTitleControl.prototype.handleExternalDrop = function (e, targetPosition, targetIndex) {
        var _this = this;
        var resources = dnd_1.extractResources(e).filter(function (r) { return r.scheme === 'file' || r.scheme === 'untitled'; });
        // Open resources if found
        if (resources.length) {
            DOM.EventHelper.stop(e, true);
            this.editorService.openEditors(resources.map(function (resource) {
                return {
                    input: { resource: resource, options: { pinned: true, index: targetIndex } },
