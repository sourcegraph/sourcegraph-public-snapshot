...
var files_2 = require('vs/workbench/parts/files/common/files'); // TODO@Ben layer breaker
...
var EditorStatus = (function () {
    ...
    EditorStatus.prototype.onEditorsChanged = function () {
        ...
        if (activeEditor instanceof textEditor_1.BaseTextEditor) {
            var control_1 = activeEditor.getControl();
            // Hook Listener for Selection changes
            this.activeEditorListeners.push(control_1.onDidChangeCursorPosition(function (event) {
                _this.onSelectionChange(control_1);
            }));
            // Hook Listener for mode changes
            this.activeEditorListeners.push(control_1.onDidChangeModelMode(function (event) {
                _this.onModeChange(control_1);
            }));
            // Hook Listener for content changes
            this.activeEditorListeners.push(control_1.onDidChangeModelRawContent(function (event) {
                _this.onEOLChange(control_1);
            }));
            // Hook Listener for content options changes
            this.activeEditorListeners.push(control_1.onDidChangeModelOptions(function (event) {
                _this.onIndentationChange(control_1);
            }));
        }
    ...
    EditorStatus = __decorate([
        ...
        __param(6, files_2.ITextFileService)
    ], EditorStatus);
    return EditorStatus;
}());
...
var ChangeModeAction = (function (_super) {
    ...
    function ChangeModeAction(actionId, actionLabel, modeService, modelService, editorService, configurationEditingService, messageService, configurationService, quickOpenService) {
