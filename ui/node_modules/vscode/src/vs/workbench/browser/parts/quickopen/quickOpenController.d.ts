...
export declare class EditorHistoryEntry extends EditorQuickOpenEntry {
    ...
    private label;
    private description;
    constructor(input: IEditorInput | IResourceInput, editorService: IWorkbenchEditorService, modeService: IModeService, modelService: IModelService, textFileService: ITextFileService, contextService: IWorkspaceContextService, configurationService: IConfigurationService);
    getIcon(): string;
    getLabel(): string;
