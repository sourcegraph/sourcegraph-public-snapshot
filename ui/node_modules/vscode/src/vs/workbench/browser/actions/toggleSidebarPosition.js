...
var ToggleSidebarPositionAction = (function (_super) {
    ...
    function ToggleSidebarPositionAction(id, label, partService, messageService, configurationEditingService) {
    ...
    ToggleSidebarPositionAction.prototype.run = function () {
        ...
        this.configurationEditingService.writeConfiguration(configurationEditing_1.ConfigurationTarget.USER, { key: ToggleSidebarPositionAction.sidebarPositionConfigurationKey, value: newPositionValue }).then(null, function (error) {
