...
var OutputEditorInput = (function (_super) {
    ...
    function OutputEditorInput(outputChannel, instantiationService, outputService, panelService) {
        var _this = this;
        _super.call(this, nls.localize('output', "Output"), outputChannel ? nls.localize('outputChannel', "for '{0}'", outputChannel.label) : '', '', output_1.OUTPUT_MODE_ID, true, instantiationService);
