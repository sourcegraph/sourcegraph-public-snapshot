...
var EmmetEditorAction = (function (_super) {
    ...
    EmmetEditorAction.prototype.run = function (accessor, editor) {
        ...
        var editorAccessor = new editorAccessor_1.EditorAccessor(editor, configurationService.getConfiguration().emmet.syntaxProfiles, configurationService.getConfiguration().emmet.excludeLanguages, new GrammarContributions());
