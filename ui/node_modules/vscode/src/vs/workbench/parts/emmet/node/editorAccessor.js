...
var EditorAccessor = (function () {
    function EditorAccessor(editor, syntaxProfiles, excludedLanguages, grammars) {
        this.emmetSupportedModes = ['html', 'xhtml', 'css', 'xml', 'xsl', 'haml', 'jade', 'jsx', 'slim', 'scss', 'sass', 'less', 'stylus', 'styl'];
        this._editor = editor;
    ...
    EditorAccessor.prototype.getSyntax = function () {
        ...
        var modeId = this._editor.getModel().getModeIdAtPosition(position.lineNumber, position.column);
        var syntax = modeId.split('.').pop();
