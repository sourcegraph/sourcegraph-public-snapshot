...
export declare const CONTEXT_DEFAULT_SETTINGS_EDITOR: RawContextKey<boolean>;
export declare const DEFAULT_EDITOR_COMMAND_COLLAPSE_ALL = "defaultSettingsEditor.action.collapseAllGroups";
