...
var WorkbenchContentProvider = (function () {
    function WorkbenchContentProvider(modelService, textModelResolverService, preferencesService, modeService) {
    ...
    WorkbenchContentProvider.prototype.start = function () {
        ...
        this.textModelResolverService.registerTextModelContentProvider('vscode', {
            provideTextContent: function (uri) {
                ...
                return _this.preferencesService.createDefaultPreferencesEditorModel(uri)
                    .then(function (preferencesModel) {
                    if (preferencesModel) {
                        var mode = _this.modeService.getOrCreateMode('json');
                        return winjs_base_1.TPromise.as(_this.modelService.createModel(preferencesModel.content, mode, uri));
                    }
                    return null;
                });
            }
