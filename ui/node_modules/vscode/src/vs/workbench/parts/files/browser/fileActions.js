...
var TriggerRenameFileAction = (function (_super) {
    ...
    function TriggerRenameFileAction(tree, element, contextService, editorService, fileService, messageService, textFileService, eventService, instantiationService) {
        var _this = _super.call(this, TriggerRenameFileAction.ID, nls.localize('rename', "Rename"), contextService, editorService, fileService, messageService, textFileService, eventService) || this;
        _this.tree = tree;
...
var BaseRenameAction = (function (_super) {
    ...
    function BaseRenameAction(id, label, element, contextService, editorService, fileService, messageService, textFileService, eventService) {
        var _this = _super.call(this, id, label, contextService, editorService, fileService, messageService, textFileService, eventService) || this;
        _this.element = element;
        return _this;
    }
...
var RenameFileAction = (function (_super) {
    ...
    function RenameFileAction(element, contextService, editorService, fileService, messageService, textFileService, eventService) {
        var _this = _super.call(this, RenameFileAction.ID, nls.localize('rename', "Rename"), element, contextService, editorService, fileService, messageService, textFileService, eventService) || this;
        _this._updateEnablement();
        return _this;
    }
...
var NewFileAction = (function (_super) {
    ...
    function NewFileAction(tree, element, contextService, editorService, fileService, messageService, textFileService, eventService, instantiationService) {
        var _this = _super.call(this, 'workbench.action.files.newFile', nls.localize('newFile', "New File"), tree, true, instantiationService.createInstance(CreateFileAction, element), null, contextService, editorService, fileService, messageService, textFileService, eventService) || this;
...
var NewFolderAction = (function (_super) {
    ...
    function NewFolderAction(tree, element, contextService, editorService, fileService, messageService, textFileService, eventService, instantiationService) {
        var _this = _super.call(this, 'workbench.action.files.newFolder', nls.localize('newFolder', "New Folder"), tree, false, instantiationService.createInstance(CreateFolderAction, element), null, contextService, editorService, fileService, messageService, textFileService, eventService) || this;
...
var CreateFileAction = (function (_super) {
    ...
    function CreateFileAction(element, contextService, editorService, fileService, messageService, textFileService, eventService) {
        var _this = _super.call(this, CreateFileAction.ID, CreateFileAction.LABEL, element, contextService, editorService, fileService, messageService, textFileService, eventService) || this;
        _this._updateEnablement();
        return _this;
    }
...
var CreateFolderAction = (function (_super) {
    ...
    function CreateFolderAction(element, contextService, editorService, fileService, messageService, textFileService, eventService) {
        var _this = _super.call(this, CreateFolderAction.ID, CreateFolderAction.LABEL, null, contextService, editorService, fileService, messageService, textFileService, eventService) || this;
        _this._updateEnablement();
        return _this;
    }
...
var MoveFileToTrashAction = (function (_super) {
    ...
    function MoveFileToTrashAction(tree, element, contextService, editorService, fileService, messageService, textFileService, eventService) {
        return _super.call(this, MoveFileToTrashAction.ID, nls.localize('delete', "Delete"), tree, element, true, contextService, editorService, fileService, messageService, textFileService, eventService) || this;
    }
...
var ImportFileAction = (function (_super) {
    ...
    function ImportFileAction(tree, element, clazz, contextService, editorService, fileService, messageService, textFileService, eventService) {
        var _this = _super.call(this, ImportFileAction.ID, nls.localize('importFiles', "Import Files"), contextService, editorService, fileService, messageService, textFileService, eventService) || this;
        _this.tree = tree;
        _this.element = element;
        if (clazz) {
            _this.class = clazz;
...
var FileImportedEvent = (function (_super) {
    ...
    function FileImportedEvent(stat, isNew, originalEvent) {
        var _this = _super.call(this, null, stat, originalEvent) || this;
        _this.isNew = isNew;
        return _this;
    }
...
var CopyFileAction = (function (_super) {
    ...
    function CopyFileAction(tree, element, contextService, editorService, fileService, messageService, textFileService, eventService) {
        var _this = _super.call(this, CopyFileAction.ID, nls.localize('copyFile', "Copy"), contextService, editorService, fileService, messageService, textFileService, eventService) || this;
        _this.tree = tree;
        _this.element = element;
        _this._updateEnablement();
        return _this;
...
var PasteFileAction = (function (_super) {
    ...
    function PasteFileAction(tree, element, contextService, editorService, fileService, messageService, textFileService, eventService, instantiationService) {
        var _this = _super.call(this, PasteFileAction.ID, nls.localize('pasteFile', "Paste"), contextService, editorService, fileService, messageService, textFileService, eventService) || this;
        _this.instantiationService = instantiationService;
        _this.tree = tree;
        _this.element = element;
        _this._updateEnablement();
...
var DuplicateFileAction = (function (_super) {
    ...
    function DuplicateFileAction(tree, element, target, contextService, editorService, fileService, messageService, textFileService, eventService) {
        var _this = _super.call(this, 'workbench.files.action.duplicateFile', nls.localize('duplicateFile', "Duplicate"), contextService, editorService, fileService, messageService, textFileService, eventService) || this;
        _this.tree = tree;
        _this.element = element;
    ...
    GlobalCompareResourcesAction.prototype.run = function () {
        ...
        if (fileInput) {
            ...
            var picks = history_2.map(function (input) {
                ...
                description = labels.getPathLabel(paths.dirname(resource.fsPath), _this.contextService);
                return { input: input, resource: resource, label: label, description: description };
            }).filter(function (p) { return !!p; });
            return this.quickOpenService.pick(picks, { placeHolder: nls.localize('pickHistory', "Select an editor history entry to compare with"), autoFocus: { autoFocusFirstEntry: true }, matchOnDescription: true }).then(function (pick) {
                if (pick) {
            ...
            if (this.isSaveAs() || source.scheme === 'untitled') {
                ...
                if (editor) {
                    ...
                    if (activeResource && activeResource.toString() === source.toString()) {
                        selectionOfSource_1 = editor.getSelection();
                    }
                }
