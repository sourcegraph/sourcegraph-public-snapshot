...
export declare class Renderer implements IRenderer {
    ...
    constructor(actionProvider: ActionProvider, instantiationService: IInstantiationService);
...
export declare class Controller extends treedefaults.DefaultController {
    ...
    constructor(actionProvider: ActionProvider, model: IEditorStacksModel, editorService: IWorkbenchEditorService, editorGroupService: IEditorGroupService, contextMenuService: IContextMenuService, telemetryService: ITelemetryService, keybindingService: IKeybindingService);
