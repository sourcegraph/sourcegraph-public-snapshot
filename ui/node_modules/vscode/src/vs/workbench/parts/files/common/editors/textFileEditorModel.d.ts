...
import { ITextFileService, ModelState, ITextFileEditorModel, IModelSaveOptions, ISaveErrorHandler, ISaveParticipant, StateChange } from 'vs/workbench/parts/files/common/files';
...
export declare class TextFileEditorModel extends BaseTextEditorModel implements ITextFileEditorModel {
    ...
    constructor(resource: URI, preferredEncoding: string, messageService: IMessageService, modeService: IModeService, modelService: IModelService, fileService: IFileService, lifecycleService: ILifecycleService, instantiationService: IInstantiationService, telemetryService: ITelemetryService, textFileService: ITextFileService);
    ...
    private doSave(versionId, reason, overwriteReadonly?, overwriteEncoding?);
