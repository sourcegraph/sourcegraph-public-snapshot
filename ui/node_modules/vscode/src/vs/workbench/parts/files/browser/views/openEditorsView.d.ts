...
export declare class OpenEditorsView extends AdaptiveCollapsibleViewletView {
    ...
    constructor(actionRunner: IActionRunner, settings: any, instantiationService: IInstantiationService, contextMenuService: IContextMenuService, textFileService: ITextFileService, editorGroupService: IEditorGroupService, configurationService: IConfigurationService, keybindingService: IKeybindingService, untitledEditorService: IUntitledEditorService, viewletService: IViewletService);
