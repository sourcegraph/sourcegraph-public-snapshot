...
var FileEditorTracker = (function () {
    ...
    FileEditorTracker.prototype.onLocalFileChange = function (e) {
        ...
        if (e.gotMoved()) {
            ...
            this.handleMovedFileInOpenedEditors(before_1 ? before_1.resource : null, after_1 ? after_1.resource : null, after_1 ? after_1.mime : null);
        }
    };
    FileEditorTracker.prototype.handleMovedFileInOpenedEditors = function (oldResource, newResource, mimeHint) {
        var _this = this;
            ...
            group.getEditors().forEach(function (input) {
                if (input instanceof fileEditorInput_1.FileEditorInput) {
                    ...
                    if (paths.isEqualOrParent(resource.fsPath, oldResource.fsPath)) {
                        ...
                        // Reopen
                        _this.editorService.openEditor({ resource: reopenFileResource, mime: mimeHint || mime_1.MIME_UNKNOWN, options: { preserveFocus: true, pinned: group.isPinned(input), index: group.indexOf(input), inactive: !group.isActive(input) } }, stacks.positionOfGroup(group)).done(null, errors.onUnexpectedError);
                    }
                }
            });
        });
            ...
            if (input instanceof fileEditorInput_1.FileEditorInput) {
                ...
                if (e.contains(fileInputResource, files_2.FileChangeType.UPDATED) || e.contains(fileInputResource, files_2.FileChangeType.ADDED)) {
                    ...
                    if (textModel_1) {
                        ...
                        if (textModel_1.getState() === files_1.ModelState.SAVED) {
