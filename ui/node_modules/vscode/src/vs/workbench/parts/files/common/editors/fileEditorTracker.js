...
var FileEditorTracker = (function () {
    ...
    FileEditorTracker.prototype.handleDeletes = function (arg1, movedTo) {
        var fileInputs = this.getOpenedFileInputs();
        fileInputs.forEach(function (input) {
            ...
            if (arg1 instanceof files_2.FileChangesEvent) {
                matches = arg1.contains(input.getResource(), files_2.FileChangeType.DELETED);
            }
            else {
    ...
    FileEditorTracker.prototype.getOpenedFileInputs = function () {
        var inputs = [];
        ...
        stacks.groups.forEach(function (group) {
            group.getEditors().forEach(function (input) {
                ...
                else if (input instanceof editor_1.SideBySideEditorInput) {
    ...
    FileEditorTracker.prototype.handleUpdatesToVisibleEditors = function (e) {
        ...
        editors.forEach(function (editor) {
            ...
            if (input instanceof editor_1.SideBySideEditorInput) {
                input = _this.getMatchingFileEditorInputFromSideBySide(input, e);
            }
            // File Editor Input
            if (input instanceof fileEditorInput_1.FileEditorInput) {
    ...
    FileEditorTracker.prototype.getMatchingFileEditorInputFromSideBySide = function (input, e) {
        // First try master
        var master = input.master;
        var res = this.getMatchingFileEditorInputFromInput(master, e);
        if (res) {
            return res;
        }
        // Second try details
    ...
    FileEditorTracker.prototype.getMatchingFileEditorInputFromInput = function (input, e) {
        if (input instanceof fileEditorInput_1.FileEditorInput && e.contains(input.getResource(), files_2.FileChangeType.UPDATED)) {
            return input;
        }
        return null;
    };
