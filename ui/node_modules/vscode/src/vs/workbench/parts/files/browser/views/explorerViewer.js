...
var FileController = (function (_super) {
    ...
    FileController.prototype.openEditor = function (stat, preserveFocus, sideBySide, pinned) {
        ...
        if (stat && !stat.isDirectory) {
            ...
            this.editorService.openEditor({ resource: stat.resource, mime: stat.mime, options: { preserveFocus: preserveFocus, pinned: pinned } }, sideBySide).done(null, errors.onUnexpectedError);
        }
    };
