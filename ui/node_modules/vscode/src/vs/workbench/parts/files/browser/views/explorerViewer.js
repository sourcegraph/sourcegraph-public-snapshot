...
var FileController = (function (_super) {
    ...
    function FileController(state, editorService, contextMenuService, instantiationService, telemetryService, contextService, menuService, contextKeyService, keybindingService) {
        ...
        _this.didCatchEnterDown = false;
        _this.downKeyBindingDispatcher.set(platform.isMacintosh ? 32768 /* CtrlCmd */ | 18 /* DownArrow */ : 3 /* Enter */, _this.onEnterDown.bind(_this));
        _this.upKeyBindingDispatcher.set(platform.isMacintosh ? 32768 /* CtrlCmd */ | 18 /* DownArrow */ : 3 /* Enter */, _this.onEnterUp.bind(_this));
        if (platform.isMacintosh) {
            _this.upKeyBindingDispatcher.set(4096 /* WinCtrl */ | 3 /* Enter */, _this.onModifierEnterUp.bind(_this)); // Mac: somehow Cmd+Enter does not work
        }
        else {
            _this.upKeyBindingDispatcher.set(32768 /* CtrlCmd */ | 3 /* Enter */, _this.onModifierEnterUp.bind(_this)); // Mac: somehow Cmd+Enter does not work
        }
        _this.downKeyBindingDispatcher.set(platform.isMacintosh ? 3 /* Enter */ : 60 /* F2 */, _this.onF2.bind(_this));
        _this.downKeyBindingDispatcher.set(32768 /* CtrlCmd */ | 33 /* KEY_C */, _this.onCopy.bind(_this));
        _this.downKeyBindingDispatcher.set(32768 /* CtrlCmd */ | 52 /* KEY_V */, _this.onPaste.bind(_this));
        if (platform.isMacintosh) {
            _this.downKeyBindingDispatcher.set(32768 /* CtrlCmd */ | 16 /* UpArrow */, _this.onLeft.bind(_this));
            _this.downKeyBindingDispatcher.set(32768 /* CtrlCmd */ | 1 /* Backspace */, _this.onDelete.bind(_this));
            _this.downKeyBindingDispatcher.set(32768 /* CtrlCmd */ | 8192 /* Alt */ | 1 /* Backspace */, _this.onDelete.bind(_this));
        }
        else {
    ...
    FileController.prototype.onPaste = function (tree, event) {
        var stat = tree.getFocus() || tree.getInput() /* root */;
        if (stat) {
