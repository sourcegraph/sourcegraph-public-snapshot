...
var OpenEditorsView = (function (_super) {
    ...
    function OpenEditorsView(actionRunner, settings, instantiationService, contextMenuService, textFileService, editorGroupService, configurationService, keybindingService, untitledEditorService, viewletService) {
        var _this = this;
        _super.call(this, actionRunner, OpenEditorsView.computeExpandedBodySize(editorGroupService.getStacksModel()), !!settings[OpenEditorsView.MEMENTO_COLLAPSED], nls.localize({ key: 'openEditosrSection', comment: ['Open is an adjective'] }, "Open Editors Section"), keybindingService, contextMenuService);
        ...
        this.structuralTreeRefreshScheduler = new async_1.RunOnceScheduler(function () { return _this.structuralTreeUpdate(); }, this.structuralRefreshDelay);
    }
    ...
    OpenEditorsView.prototype.updateDirtyIndicator = function () {
        var dirty = this.textFileService.getAutoSaveMode() !== files_1.AutoSaveMode.AFTER_SHORT_DELAY ? this.textFileService.getDirty().length
    ...
    OpenEditorsView = __decorate([
        ...
        __param(9, viewletService_1.IViewletService)
    ], OpenEditorsView);
