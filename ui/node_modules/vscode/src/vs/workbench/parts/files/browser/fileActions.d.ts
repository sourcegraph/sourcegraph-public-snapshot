...
export declare class GlobalNewUntitledFileAction extends Action {
    ...
    static ID: string;
    static LABEL: string;
    constructor(id: string, label: string, editorService: IWorkbenchEditorService, untitledEditorService: IUntitledEditorService);
    run(): TPromise<any>;
}
...
export declare class GlobalCompareResourcesAction extends Action {
    ...
    static ID: string;
    static LABEL: string;
    constructor(id: string, label: string, quickOpenService: IQuickOpenService, instantiationService: IInstantiationService, editorService: IWorkbenchEditorService, historyService: IHistoryService, contextService: IWorkspaceContextService, messageService: IMessageService);
    run(): TPromise<any>;
}
...
export declare abstract class BaseSaveFileAction extends BaseActionWithErrorReporting {
    ...
    private untitledEditorService;
    private resource;
    constructor(id: string, label: string, editorService: IWorkbenchEditorService, textFileService: ITextFileService, untitledEditorService: IUntitledEditorService, messageService: IMessageService);
...
export declare function keybindingForAction(id: string, keybindingService: IKeybindingService): Keybinding;
