...
var SaveErrorHandler = (function () {
    ...
    SaveErrorHandler = __decorate([
        ...
        __param(1, files_2.ITextFileService),
...
var FileOnDiskEditorInput = (function (_super) {
    ...
    function FileOnDiskEditorInput(fileResource, mime, name, description, modelService, modeService, instantiationService, textFileService) {
