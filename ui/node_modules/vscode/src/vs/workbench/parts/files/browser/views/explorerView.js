...
var ExplorerView = (function (_super) {
    ...
    function ExplorerView(viewletState, actionRunner, settings, headerSize, messageService, contextMenuService, instantiationService, editorGroupService, eventService, contextService, progressService, editorService, fileService, partService, keybindingService, contextKeyService, configurationService) {
        _super.call(this, actionRunner, false, nls.localize('explorerSection', "Files Explorer Section"), messageService, keybindingService, contextMenuService, headerSize);
        ...
        this.folderContext = new contextkey_1.RawContextKey('explorerResourceIsFolder', undefined).bindTo(contextKeyService);
    }
    ...
    ExplorerView.prototype.openFocusedElement = function (preserveFocus) {
        ...
        if (stat && !stat.isDirectory) {
            this.editorService.openEditor({ resource: stat.resource, mime: stat.mime, options: { preserveFocus: preserveFocus, revealIfVisible: true } }).done(null, errors.onUnexpectedError);
        }
    };
