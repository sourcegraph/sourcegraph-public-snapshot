...
var OpenEditor = (function () {
    ...
    OpenEditor.prototype.isUntitled = function () {
        return this.editor instanceof editor_1.UntitledEditorInput;
    };
    OpenEditor.prototype.isDirty = function () {
        return this.editor.isDirty();
    };
    OpenEditor.prototype.getResource = function () {
        if (this.editor instanceof files_1.FileEditorInput) {
            return this.editor.getResource();
        }
        else if (this.editor instanceof editor_1.UntitledEditorInput) {
            return this.editor.getResource();
        }
        return null;
    };
...
var Renderer = (function () {
    function Renderer(actionProvider, instantiationService) {
...
var Controller = (function (_super) {
    ...
    function Controller(actionProvider, model, editorService, editorGroupService, contextMenuService, telemetryService, keybindingService) {
        _super.call(this, { clickBehavior: treedefaults.ClickBehavior.ON_MOUSE_DOWN });
        this.actionProvider = actionProvider;
        this.model = model;
    ...
    Controller.prototype.openEditor = function (element, pinEditor) {
        var _this = this;
        if (element) {
            ...
            this.editorService.openEditor(element.editorInput, { preserveFocus: !pinEditor }, position)
                .done(function () { return _this.editorGroupService.activateGroup(element.editorGroup); }, errors.onUnexpectedError);
        }
    };
...
var ActionProvider = (function (_super) {
    ...
    ActionProvider.prototype.getSecondaryActions = function (tree, element) {
        ...
        return _super.prototype.getSecondaryActions.call(this, tree, element).then(function (result) {
            var autoSaveEnabled = _this.textFileService.getAutoSaveMode() === files_1.AutoSaveMode.AFTER_SHORT_DELAY;
            if (element instanceof editorStacksModel_1.EditorGroup) {
                if (!autoSaveEnabled) {
