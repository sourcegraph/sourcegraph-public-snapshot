...
export declare class FileOnDiskEditorInput extends ResourceEditorInput {
    ...
    constructor(fileResource: URI, name: string, description: string, modelService: IModelService, modeService: IModeService, instantiationService: IInstantiationService, textFileService: ITextFileService);
