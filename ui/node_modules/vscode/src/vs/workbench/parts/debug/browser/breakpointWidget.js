...
var EXPRESSION_PLACEHOLDER = nls.localize('breakpointWidgetExpressionPlaceholder', "Break when expression evaluates to true");
...
var HIT_COUNT_PLACEHOLDER = nls.localize('breakpointWidgetHitCountPlaceholder', "Break when expression equals the hit count");
...
var BreakpointWidget = (function (_super) {
    ...
    function BreakpointWidget(editor, lineNumber, contextViewService, debugService, contextKeyService) {
        var _this = this;
        _super.call(this, editor, { showFrame: true, showArrow: false, frameColor: '#007ACC', frameWidth: 1 });
    ...
    BreakpointWidget.prototype._fillContainer = function (container) {
        ...
        var selectBox = new selectBox_1.SelectBox([nls.localize('expression', "Expression"), nls.localize('hitCount', "Hit Count")], 0);
        ...
        selectBox.onDidSelect(function (e) {
            ...
            _this.inputBox.setAriaLabel(_this.hitCountContext ? HIT_COUNT_ARIA_LABEL : EXPRESSION_ARIA_LABEL);
            _this.inputBox.setPlaceHolder(_this.hitCountContext ? HIT_COUNT_PLACEHOLDER : EXPRESSION_PLACEHOLDER);
            _this.inputBox.value = (_this.hitCountContext && breakpoint && breakpoint.hitCondition) ? breakpoint.hitCondition : breakpoint && breakpoint.condition ? breakpoint.condition : '';
        });
