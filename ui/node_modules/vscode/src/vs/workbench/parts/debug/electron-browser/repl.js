...
require('./../browser/media/repl.css');
...
var viewer = require('vs/workbench/parts/debug/electron-browser/replViewer');
...
var replhistory = require('vs/workbench/parts/debug/common/replHistory');
...
var Repl = (function (_super) {
    ...
    Repl.prototype.onReplElementsUpdated = function () {
        ...
        if (this.tree) {
            ...
            var elements = this.debugService.getModel().getReplElements();
            var delay = elements.length > 0 ? Repl.REFRESH_DELAY : 0;
    ...
    Repl.prototype.createReplInput = function (container) {
        ...
        modes.SuggestRegistry.register({ scheme: debug.DEBUG_SCHEME }, {
            ...
            provideCompletionItems: function (model, position, token) {
                ...
                return async_1.wireCancellationToken(token, _this.debugService.completions(text, position).then(function (suggestions) { return ({
    ...
    Repl.REPL_INPUT_INITIAL_HEIGHT = 22;
