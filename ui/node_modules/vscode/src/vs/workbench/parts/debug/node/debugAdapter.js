...
var Adapter = (function () {
    function Adapter(rawAdapter, extensionDescription, configurationResolverService, commandService) {
    ...
    Adapter.prototype.getInitialConfigurations = function () {
        if (typeof this.initialConfigurations === 'string') {
            ...
            return this.commandService.executeCommand(this.initialConfigurations)
                .then(function (result) { return JSON.parse(result); });
        }
        return winjs_base_1.TPromise.as(this.initialConfigurations);
    };
    ;
