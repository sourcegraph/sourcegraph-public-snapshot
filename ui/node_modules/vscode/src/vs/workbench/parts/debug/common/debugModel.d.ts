...
export declare abstract class ExpressionContainer implements debug.IExpressionContainer {
    ...
    private children;
    private _value;
    constructor(reference: number, id: string, cacheChildren: boolean, namedVariables: number, indexedVariables: number, startOfVariables?: number);
...
export declare class Variable extends ExpressionContainer implements debug.IExpression {
    ...
    available: boolean;
    errorMessage: string;
    constructor(parent: debug.IExpressionContainer, reference: number, name: string, value: string, namedVariables: number, indexedVariables: number, type?: string, available?: boolean, startOfVariables?: number);
}
...
export declare class Breakpoint implements debug.IBreakpoint {
    ...
    message: string;
    private id;
    constructor(source: Source, desiredLineNumber: number, enabled: boolean, condition: string, hitCondition: string);
    getId(): string;
}
