...
var DebugService = (function () {
    ...
    DebugService.prototype.loadBreakpoints = function () {
        ...
        try {
            result = JSON.parse(this.storageService.get(DEBUG_BREAKPOINTS_KEY, storage_1.StorageScope.WORKSPACE, '[]')).map(function (breakpoint) {
                return new model.Breakpoint(new debugSource_1.Source(breakpoint.source.raw ? breakpoint.source.raw : { path: uri_1.default.parse(breakpoint.source.uri).fsPath, name: breakpoint.source.name }), breakpoint.desiredLineNumber || breakpoint.lineNumber, breakpoint.enabled, breakpoint.condition, breakpoint.hitCondition);
            });
        }
        catch (e) { }
        return result || [];
    ...
    DebugService.prototype.sendBreakpoints = function (modelUri, sourceModified) {
        ...
        return this.session.setBreakpoints({
            ...
            breakpoints: breakpointsToSend.map(function (bp) { return ({ line: bp.desiredLineNumber, condition: bp.condition, hitCondition: bp.hitCondition }); }),
