...
var tabCompletion_1 = require('vs/editor/contrib/suggest/browser/tabCompletion');
var ReplEditor = (function (_super) {
    __extends(ReplEditor, _super);
    function ReplEditor(domElement, options, instantiationService, codeEditorService, commandService, contextKeyService) {
        _super.call(this, domElement, options, instantiationService, codeEditorService, commandService, contextKeyService);
    }
    ReplEditor.prototype._getContributions = function () {
        return [
    ...
    ReplEditor.prototype._getActions = function () {
