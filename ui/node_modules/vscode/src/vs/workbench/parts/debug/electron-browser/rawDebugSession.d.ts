...
export declare class RawDebugSession extends v8.V8Protocol implements debug.IRawDebugSession {
    ...
    private _onDidEvent;
    constructor(debugServerPort: number, adapter: Adapter, customTelemetryService: ITelemetryService, messageService: IMessageService, telemetryService: ITelemetryService, outputService: IOutputService, terminalService: ITerminalService, nativeTerminalService: IExternalTerminalService, configurationService: IConfigurationService);
