...
var FeedbackDropdown = (function (_super) {
    ...
    function FeedbackDropdown(container, options, telemetryService, commandService, integrityService) {
        ...
        this._isPure = true;
        this.integrityService.isPure().then(function (result) {
            if (!result.isPure) {
                _this._isPure = false;
            }
        });
        ...
        this.reportIssueLink = product_1.default.reportIssueUrl;
        this.requestFeatureLink = product_1.default.requestFeatureUrl;
    }
