...
var ReplaceAllAction = (function (_super) {
    ...
    function ReplaceAllAction() {
        _super.call(this, ReplaceAllAction.ID, '', 'action-replace-all', false);
...
var SearchWidget = (function (_super) {
    ...
    function SearchWidget(container, contextViewService, options, keyBindingService, keyBindingService2, instantiationService) {
        ...
        this.keyBindingService2 = keyBindingService2;
        ...
        this.searchHistory = new history_1.HistoryNavigator();
...
function registerContributions() {
    keybindingsRegistry_1.KeybindingsRegistry.registerCommandAndKeybindingRule({ id: ReplaceAllAction.ID,
        ...
        handler: function (accessor) {
            if (searchActions_1.isSearchViewletFocussed(accessor.get(viewletService_1.IViewletService))) {
