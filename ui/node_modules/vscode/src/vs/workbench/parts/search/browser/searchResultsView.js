...
var SearchController = (function (_super) {
    ...
    function SearchController(viewlet, instantiationService) {
        ...
        if (platform.isMacintosh) {
            this.downKeyBindingDispatcher.set(32768 /* CtrlCmd */ | 1 /* Backspace */, function (tree, event) { _this.onDelete(tree, event); });
            this.upKeyBindingDispatcher.set(4096 /* WinCtrl */ | 3 /* Enter */, this.onEnter.bind(this));
        }
        else {
            this.downKeyBindingDispatcher.set(20 /* Delete */, function (tree, event) { _this.onDelete(tree, event); });
        ...
        this.downKeyBindingDispatcher.set(9 /* Escape */, function (tree, event) { _this.onEscape(tree, event); });
    }
