...
export declare function appendKeyBindingLabel(label: string, keyBinding: Keybinding, keyBindingService2: IKeybindingService): string;
export declare function appendKeyBindingLabel(label: string, keyBinding: number, keyBindingService2: IKeybindingService): string;
...
export declare class FindInFilesAction extends Action {
    private viewletService;
    constructor(id: string, label: string, viewletService: IViewletService);
    run(): TPromise<any>;
}
