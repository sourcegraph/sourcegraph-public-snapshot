...
var OpenSearchViewletAction = (function (_super) {
    ...
    function OpenSearchViewletAction(id, label, viewletService, editorService) {
        _super.call(this, id, label, Constants.VIEWLET_ID, viewletService, editorService);
    }
    OpenSearchViewletAction.ID = Constants.VIEWLET_ID;
...
var CollapseAllAction = (function (_super) {
    ...
    function CollapseAllAction(viewlet) {
        _super.call(this, viewlet.getControl(), false);
...
var ReplaceAllAction = (function (_super) {
    ...
    function ReplaceAllAction(viewer, fileMatch, viewlet, replaceService, keyBindingService2, telemetryService) {
        _super.call(this, 'file-action-replace-all', appendKeyBindingLabel(nls.localize('file.replaceAll.label', "Replace All"), ReplaceAllAction.KEY_BINDING, keyBindingService2), 'action-replace-all');
        this.viewer = viewer;
...
var ReplaceAction = (function (_super) {
    ...
    function ReplaceAction(viewer, element, viewlet, replaceService, keyBindingService2, editorService, telemetryService) {
        _super.call(this, 'action-replace', appendKeyBindingLabel(nls.localize('match.replace.label', "Replace"), ReplaceAction.KEY_BINDING, keyBindingService2), 'action-replace');
        this.viewer = viewer;
        this.element = element;
        this.viewlet = viewlet;
        this.replaceService = replaceService;
    ...
    ReplaceAction.prototype.run = function () {
        ...
        var elementToFocus = this.getElementToFocusAfterRemoved(this.viewer, this.element);
        var elementToShowReplacePreview = this.getElementToShowReplacePreview(elementToFocus);
