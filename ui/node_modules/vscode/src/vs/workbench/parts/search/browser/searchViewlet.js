...
var SearchViewlet = (function (_super) {
    ...
    function SearchViewlet(telemetryService, eventService, editorService, editorGroupService, progressService, messageService, storageService, contextViewService, instantiationService, configurationService, contextService, searchService, contextKeyService, keybindingService, replaceService, untitledEditorService) {
        var _this = this;
        _super.call(this, Constants.VIEWLET_ID, telemetryService);
    ...
    SearchViewlet.prototype.replaceAll = function () {
        ...
        var afterReplaceAllMessage = replaceValue ? nls.localize('replaceAll.message', "Replaced {0} occurrences across {1} files with {2}.", occurrences, fileCount, replaceValue)
    ...
    SearchViewlet.prototype.createSearchResultsView = function (builder) {
        ...
        builder.div({ 'class': 'results' }, function (div) {
            ...
            _this.toUnbind.push(_this.tree.addListener2('selection', function (event) {
                ...
                var focusEditor = (keyboard && originalEvent.keyCode === 3 /* Enter */) || doubleClick;
    ...
    SearchViewlet.prototype.open = function (element, preserveFocus, sideBySide, pinned) {
        ...
        return this.editorService.openEditor({
            ...
            if (element instanceof searchModel_1.Match && preserveFocus) {
