...
export declare class SearchViewlet extends Viewlet {
    ...
    constructor(telemetryService: ITelemetryService, eventService: IEventService, editorService: IWorkbenchEditorService, editorGroupService: IEditorGroupService, progressService: IProgressService, messageService: IMessageService, storageService: IStorageService, contextViewService: IContextViewService, instantiationService: IInstantiationService, configurationService: IConfigurationService, contextService: IWorkspaceContextService, searchService: ISearchService, contextKeyService: IContextKeyService, keybindingService: IKeybindingService, replaceService: IReplaceService, untitledEditorService: IUntitledEditorService);
    ...
    private trackInputBox(inputFocusTracker);
