...
var AutoFetcher = (function () {
    ...
    AutoFetcher.prototype.loop = function () {
        ...
        var remotes = this.gitService.getModel().getRemotes();
        if (remotes.length === 0) {
            this.timeout = AutoFetcher.MIN_TIMEOUT;
...
var GitService = (function (_super) {
    ...
    function GitService(raw, instantiationService, eventService, messageService, editorService, outputService, textFileService, contextService, lifecycleService, storageService, configurationService) {
        ...
        this.raw = raw;
        this.state = git_1.ServiceState.NotInitialized;
        this.operations = [];
        this.model = new gitModel_1.Model();
        this.toDispose = [];
        this.needsRefresh = false;
        this.statusDelayer = new async_1.ThrottledDelayer(500);
        this.reactiveStatusDelayer = new async_1.PeriodThrottledDelayer(500, 10000);
    ...
    GitService.prototype.registerListeners = function () {
        ...
        var blurEvent = event_3.domEvent(window, 'blur');
        this.toDispose.push(blurEvent(function () { return _this.isFocused = false; }));
    };
    ...
    GitService.prototype.onFileChanges = function (e) {
        ...
        var shouldTriggerStatus = e.changes.some(function (c) {
            ...
            if (workspacePath === '.git') {
                return c.type === files_2.FileChangeType.ADDED || c.type === files_2.FileChangeType.DELETED;
            }
    ...
    GitService.prototype._run = function (operationId, fn) {
        ...
        return operation.run().then(function (status) {
            ...
            error = errors_1.create(nls_1.localize('checkNativeConsole', "There was an issue running a git operation. Please review the output or use a console to check the state of your repository."), { actions: [cancelAction, showOutputAction] });
