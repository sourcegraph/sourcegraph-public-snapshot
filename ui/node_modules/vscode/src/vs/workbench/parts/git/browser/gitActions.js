...
var UnstageAction = (function (_super) {
    ...
    function UnstageAction(gitService, editorService) {
        _super.call(this, UnstageAction.ID, UnstageAction.LABEL, 'git-action unstage', gitService, editorService);
    }
...
var BranchAction = (function (_super) {
    ...
    function BranchAction(checkout, gitService) {
        _super.call(this, BranchAction.ID, 'Branch', 'git-action checkout', gitService);
...
var CommitSignedOffAction = (function (_super) {
    ...
    function CommitSignedOffAction(commitState, gitService) {
        _super.call(this, commitState, CommitAction.ID, nls.localize('commitStagedSignedOff', "Commit Staged (Signed Off)"), 'git-action commit-signed-off', gitService);
    }
...
var StageAndCommitAction = (function (_super) {
    ...
    function StageAndCommitAction(commitState, id, label, cssClass, gitService) {
        ...
        _super.call(this, commitState, id, label, cssClass, gitService);
    }
...
var StageAndCommitSignedOffAction = (function (_super) {
    ...
    function StageAndCommitSignedOffAction(commitState, gitService) {
        _super.call(this, commitState, StageAndCommitAction.ID, nls.localize('commitAllSignedOff', "Commit All (Signed Off)"), 'git-action stage-and-commit-signed-off', gitService);
    }
...
var SyncAction = (function (_super) {
    ...
    function SyncAction(id, label, gitService, configurationService) {
