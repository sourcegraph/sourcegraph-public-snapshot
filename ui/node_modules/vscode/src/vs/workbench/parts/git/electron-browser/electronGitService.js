...
var noopGitService_1 = require('vs/workbench/parts/git/common/noopGitService');
...
function createRawGitService(gitPath, execPath, workspaceRoot, encoding, verbose) {
    var promise = new winjs_base_1.TPromise(function (c, e) {
        require(['vs/workbench/parts/git/node/rawGitServiceBootstrap'], function (_a) {
...
var ElectronGitService = (function (_super) {
    ...
    function ElectronGitService(instantiationService, eventService, messageService, editorService, outputService, textFileService, contextService, lifecycleService, storageService, environmentService, configurationService) {
        ...
        _super.call(this, raw, instantiationService, eventService, messageService, editorService, outputService, textFileService, contextService, lifecycleService, storageService, configurationService);
    }
