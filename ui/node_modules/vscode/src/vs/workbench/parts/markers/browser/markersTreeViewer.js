...
var Renderer = (function () {
    function Renderer(actionRunner, actionProvider, contextService, instantiationService) {
    ...
    Renderer.prototype.renderResourceTemplate = function (container) {
        ...
        data.file = this.instantiationService.createInstance(labels_1.FileLabel, resourceLabelContainer, { supportHighlights: true });
