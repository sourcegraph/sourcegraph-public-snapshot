...
var ToggleMarkersPanelAction = (function (_super) {
    ...
    function ToggleMarkersPanelAction(id, label, partService, panelService, telemetryService) {
        _super.call(this, id, label, constants_1.default.MARKERS_PANEL_ID, panelService, partService);
...
var CollapseAllAction = (function (_super) {
    ...
    function CollapseAllAction(viewer, enabled, telemetryService) {
        _super.call(this, viewer, enabled);
        this.telemetryService = telemetryService;
    }
...
var FilterAction = (function (_super) {
    ...
    function FilterAction(markersPanel) {
        _super.call(this, FilterAction.ID, messages_1.default.MARKERS_PANEL_ACTION_TOOLTIP_FILTER, 'markers-panel-action-filter', true);
        this.markersPanel = markersPanel;
    }
...
var FilterInputBoxActionItem = (function (_super) {
    ...
    function FilterInputBoxActionItem(markersPanel, action, contextViewService, telemetryService) {
        _super.call(this, markersPanel, action);
        this.markersPanel = markersPanel;
        this.contextViewService = contextViewService;
        this.telemetryService = telemetryService;
        this.toDispose = [];
        this.delayedFilterUpdate = new async_1.Delayer(500);
    }
