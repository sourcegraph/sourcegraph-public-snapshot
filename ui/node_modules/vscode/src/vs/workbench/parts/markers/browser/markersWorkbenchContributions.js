...
var StatusUpdater = (function () {
    function StatusUpdater(markerService, activityBarService) {
        var _this = this;
    ...
    StatusUpdater.prototype.updateActivityBadge = function () {
        ...
        if (problemCount > 0) {
            var badge = new activityBarService_1.NumberBadge(problemCount, function (n) { return nls_1.localize({ comment: ['Argument represents count (number) of errors and warnings.'], key: 'errorsAndWarnings' }, '{0} Errors and Warnings', n); });
            this.activityBarService.showActivity(constants_1.default.MARKERS_PANEL_ID, badge);
        }
        else {
            this.activityBarService.showActivity(constants_1.default.MARKERS_PANEL_ID, null);
        }
    };
...
function registerContributions() {
    ...
    registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(markersPanelActions.ToggleMarkersPanelAction, markersPanelActions.ToggleMarkersPanelAction.ID, markersPanelActions.ToggleMarkersPanelAction.LABEL, {
    ...
    registry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(markersPanelActions.ToggleErrorsAndWarningsAction, markersPanelActions.ToggleErrorsAndWarningsAction.ID, markersPanelActions.ToggleErrorsAndWarningsAction.LABEL), '');
