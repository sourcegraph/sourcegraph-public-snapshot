...
var markersActionProvider_1 = require('vs/workbench/parts/markers/browser/markersActionProvider');
...
var MarkersPanel = (function (_super) {
    ...
    MarkersPanel.prototype.createTree = function (parent) {
        ...
        var controller = this.instantiationService.createInstance(markersTreeController_1.Controller, this.rangeHighlightDecorations);
