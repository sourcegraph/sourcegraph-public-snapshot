...
var extensionsList_1 = require("vs/workbench/parts/extensions/browser/extensionsList");
...
var ExtensionsViewlet = (function (_super) {
    ...
    function ExtensionsViewlet(telemetryService, galleryService, extensionManagementService, progressService, instantiationService, editorService, editorInputService, extensionsWorkbenchService, tipsService, messageService, viewletService, extensionService) {
        var _this = _super.call(this, extensions_1.VIEWLET_ID, telemetryService) || this;
    ...
    ExtensionsViewlet.prototype.getSecondaryActions = function () {
        if (!this.secondaryActions) {
            this.secondaryActions = [
                ...
                this.instantiationService.createInstance(extensionsActions_1.ShowRecommendedKeymapExtensionsAction, extensionsActions_1.ShowRecommendedKeymapExtensionsAction.ID, extensionsActions_1.ShowRecommendedKeymapExtensionsAction.LABEL),
    ...
    ExtensionsViewlet.prototype.query = function (value) {
        ...
        if (!value) {
            ...
            return this.extensionsWorkbenchService.queryLocal()
                .then(function (result) { return result.sort(function (e1, e2) { return e1.displayName.localeCompare(e2.displayName); }); })
        ...
        if (/@disabled/i.test(value)) {
            return this.extensionsWorkbenchService.queryLocal()
                .then(function (result) { return result.sort(function (e1, e2) { return e1.displayName.localeCompare(e2.displayName); }); })
                .then(function (result) { return _this.extensionService.getExtensions()
                .then(function (runningExtensions) { return result.filter(function (e) { return runningExtensions.every(function (r) { return r.id !== e.identifier; }); }); }); })
                .then(function (result) { return new paging_1.PagedModel(result); });
        }
        ...
        var text = value = query.value
            .replace(/\bext:([^\s]+)\b/g, 'tag:"__ext_$1"')
            .substr(0, 200);
        if (text) {
            options = objects_1.assign(options, { text: text });
        }
    ...
    ExtensionsViewlet.prototype.getKeymapRecommendationsModel = function (query, options) {
...
ExtensionsViewlet = __decorate([
    ...
    __param(10, viewlet_2.IViewletService),
...
var StatusUpdater = (function () {
    ...
    StatusUpdater.prototype.onServiceChange = function () {
        if (this.extensionsWorkbenchService.local.some(function (e) { return e.state === extensions_1.ExtensionState.Installing; })) {
            this.activityBarService.showActivity(extensions_1.VIEWLET_ID, new activityBarService_1.ProgressBadge(function () { return nls_1.localize('extensions', 'Extensions'); }), 'extensions-badge progress-badge');
            return;
        }
        ...
        if (outdated > 0) {
            ...
            this.activityBarService.showActivity(extensions_1.VIEWLET_ID, badge, 'extensions-badge count-badge');
        }
        else {
            this.activityBarService.showActivity(extensions_1.VIEWLET_ID, null, 'extensions-badge');
        }
    };
