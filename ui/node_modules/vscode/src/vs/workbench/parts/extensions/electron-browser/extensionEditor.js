...
var NavBar = (function () {
    ...
    NavBar.prototype.push = function (id, label) {
        var _this = this;
        var run = function () {
            _this._onChange.fire(id);
            _this.actions.forEach(function (a) { return a.enabled = a.id !== action.id; });
...
var ExtensionEditor = (function (_super) {
    ...
    function ExtensionEditor(telemetryService, galleryService, configurationService, instantiationService, viewletService, extensionsWorkbenchService, themeService, keybindingService, messageService, openerService) {
        _super.call(this, ExtensionEditor.ID, telemetryService);
        ...
        this.highlightDisposable = lifecycle_1.empty;
        this.disposables = [];
    ...
    ExtensionEditor.prototype.createEditor = function (parent) {
        ...
        this.name = dom_1.append(title, dom_1.$('span.name.clickable'));
        this.identifier = dom_1.append(title, dom_1.$('span.identifier'));
        var subtitle = dom_1.append(details, dom_1.$('.subtitle'));
        this.publisher = dom_1.append(subtitle, dom_1.$('span.publisher.clickable'));
        this.installCount = dom_1.append(subtitle, dom_1.$('span.install'));
        this.rating = dom_1.append(subtitle, dom_1.$('span.rating.clickable'));
        ...
        this.extensionActionBar = new actionbar_1.ActionBar(extensionActions, { animated: false });
    ...
    ExtensionEditor.prototype.setInput = function (input, options) {
        ...
        if (product_1.default.extensionsGallery) {
            ...
            this.name.onclick = dom_1.finalHandler(function () { return electron_1.shell.openExternal(extensionUrl_1); });
            this.rating.onclick = dom_1.finalHandler(function () { return electron_1.shell.openExternal(extensionUrl_1 + "#review-details"); });
            ...
            if (extension.licenseUrl) {
                this.license.onclick = dom_1.finalHandler(function () { return electron_1.shell.openExternal(extension.licenseUrl); });
    ...
    ExtensionEditor.prototype.openMarkdown = function (content, noContentCopy) {
        ...
        return this.loadContents(function () { return content
            ...
            .then(null, function () {
            var p = dom_1.append(_this.content, dom_1.$('p'));
    ...
    ExtensionEditor.renderSettings = function (container, manifest, onDetailsToggle) {
        ...
        var details = dom_1.$('details', { open: true, ontoggle: onDetailsToggle }, dom_1.$('summary', null, nls_1.localize('settings', "Settings ({0})", contrib.length)), dom_1.$.apply(void 0, ['table', null, dom_1.$('tr', null, dom_1.$('th', null, nls_1.localize('setting name', "Name")), dom_1.$('th', null, nls_1.localize('description', "Description")), dom_1.$('th', null, nls_1.localize('default', "Default")))].concat(contrib.map(function (key) { return dom_1.$('tr', null, dom_1.$('td', null, dom_1.$('code', null, key)), dom_1.$('td', null, properties[key].description), dom_1.$('td', null, dom_1.$('code', null, properties[key].default))); }))));
    ...
    ExtensionEditor.renderDebuggers = function (container, manifest, onDetailsToggle) {
        ...
        var details = dom_1.$('details', { open: true, ontoggle: onDetailsToggle }, dom_1.$('summary', null, nls_1.localize('debuggers', "Debuggers ({0})", contrib.length)), dom_1.$.apply(void 0, ['table', null, dom_1.$('tr', null, dom_1.$('th', null, nls_1.localize('debugger name', "Name")))].concat(contrib.map(function (d) { return dom_1.$('tr', null, dom_1.$('td', null, d.label || d.type)); }))));
        dom_1.append(container, details);
    };
    ...
    ExtensionEditor.prototype.renderCommands = function (container, manifest, onDetailsToggle) {
        ...
        var details = dom_1.$('details', { open: true, ontoggle: onDetailsToggle }, dom_1.$('summary', null, nls_1.localize('commands', "Commands ({0})", commands.length)), dom_1.$.apply(void 0, ['table', null, dom_1.$('tr', null, dom_1.$('th', null, nls_1.localize('command name', "Name")), dom_1.$('th', null, nls_1.localize('description', "Description")), dom_1.$('th', null, nls_1.localize('keyboard shortcuts', "Keyboard Shortcuts")), dom_1.$('th', null, nls_1.localize('menuContexts', "Menu Contexts")))].concat(commands.map(function (c) { return dom_1.$('tr', null, dom_1.$('td', null, dom_1.$('code', null, c.id)), dom_1.$('td', null, c.title), dom_1.$.apply(void 0, ['td', null].concat(dom_1.join(c.keybindings.map(function (keybinding) { return dom_1.$('code', null, keybinding); }), ' '))), dom_1.$.apply(void 0, ['td', null].concat(c.menus.map(function (context) { return dom_1.$('code', null, context); })))); }))));
        dom_1.append(container, details);
    };
    ExtensionEditor.renderLanguages = function (container, manifest, onDetailsToggle) {
        ...
        var details = dom_1.$('details', { open: true, ontoggle: onDetailsToggle }, dom_1.$('summary', null, nls_1.localize('languages', "Languages ({0})", languages.length)), dom_1.$.apply(void 0, ['table', null, dom_1.$('tr', null, dom_1.$('th', null, nls_1.localize('language id', "ID")), dom_1.$('th', null, nls_1.localize('language name', "Name")), dom_1.$('th', null, nls_1.localize('file extensions', "File Extensions")), dom_1.$('th', null, nls_1.localize('grammar', "Grammar")), dom_1.$('th', null, nls_1.localize('snippets', "Snippets")))].concat(languages.map(function (l) { return dom_1.$('tr', null, dom_1.$('td', null, l.id), dom_1.$('td', null, l.name), dom_1.$.apply(void 0, ['td', null].concat(dom_1.join(l.extensions.map(function (ext) { return dom_1.$('code', null, ext); }), ' '))), dom_1.$('td', null, document.createTextNode(l.hasGrammar ? '✔︎' : '—')), dom_1.$('td', null, document.createTextNode(l.hasSnippets ? '✔︎' : '—'))); }))));
        dom_1.append(container, details);
    };
