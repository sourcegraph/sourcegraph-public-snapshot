 ...
 */
export declare const KEYBINDING_CONTEXT_TERMINAL_FOCUS: RawContextKey<boolean>;
export declare const KEYBINDING_CONTEXT_TERMINAL_NOT_FOCUSED: ContextKeyExpr;
