...
var TerminalPanel = (function (_super) {
    ...
    TerminalPanel.prototype._attachEventListeners = function () {
        var _this = this;
        this._toDispose.push(DOM.addDisposableListener(this._parentDomElement, 'mousedown', function (event) {
        ...
        this._toDispose.push(DOM.addDisposableListener(this._parentDomElement, 'click', function (event) {
            if (_this._terminalService.terminalInstances.length === 0) {
                return;
            }
            if (event.which !== 3) {
        ...
        this._toDispose.push(DOM.addDisposableListener(this._parentDomElement, 'keyup', function (event) {
            if (event.keyCode === 27) {
