...
import { ITerminalInstance, ITerminalService } from 'vs/workbench/parts/terminal/common/terminal';
...
export declare class TerminalService implements ITerminalService {
    ...
    constructor(_contextKeyService: IContextKeyService, _configurationService: IConfigurationService, _instantiationService: IInstantiationService, _panelService: IPanelService, _partService: IPartService, _workspaceContextService: IWorkspaceContextService);
