...
export declare class CommandsHandler extends QuickOpenHandler {
    ...
    private menuService;
    constructor(editorService: IWorkbenchEditorService, instantiationService: IInstantiationService, keybindingService: IKeybindingService, menuService: IMenuService);
