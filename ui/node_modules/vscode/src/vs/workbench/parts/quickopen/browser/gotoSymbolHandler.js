...
require('./media/gotoSymbolHandler.css');
...
var SymbolEntry = (function (_super) {
    ...
    SymbolEntry.prototype.runOpen = function (context) {
        ...
        var sideBySide = context.keymods.indexOf(32768 /* CtrlCmd */) >= 0;
        if (sideBySide) {
...
var GotoSymbolHandler = (function (_super) {
    ...
    GotoSymbolHandler.prototype.toQuickOpenEntries = function (flattened) {
        ...
        for (var i = 0; i < flattened.length; i++) {
            ...
            // Add
            var icon = modes_1.SymbolKind.from(element.kind);
            results.push(new SymbolEntry(i, label, modes_1.SymbolKind.from(element.kind), description, icon, element.location.range, null, this.editorService, this));
        }
        return results;
    };
    ...
    GotoSymbolHandler.prototype.doGetActiveOutline = function () {
        ...
        if (editor instanceof textEditor_1.BaseTextEditor) {
            ...
            if (model && types.isFunction(model.getMode)) {
                ...
                return quickOpen_2.getDocumentSymbols(model).then(function (outline) {
