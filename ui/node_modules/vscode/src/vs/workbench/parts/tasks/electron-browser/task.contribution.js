...
var ConfigureTaskRunnerAction = (function (_super) {
    ...
    function ConfigureTaskRunnerAction(id, label, configurationService, editorService, fileService, contextService, outputService, messageService, quickOpenService, environmentService, configurationResolverService) {
        _super.call(this, id, label, configurationService, editorService, fileService, contextService, outputService, messageService, quickOpenService, environmentService, configurationResolverService);
    }
                ...
                return _this.taskSystemPromise.
                    ...
                    if (executeResult.kind === taskSystem_1.TaskExecuteKind.Active) {
                        ...
                        if (active.same && active.watching) {
                            _this.messageService.show(severity_1.default.Info, nls.localize('TaskSystem.activeSame', 'The task is already active and in watch mode.'));
                        }
                        else {
