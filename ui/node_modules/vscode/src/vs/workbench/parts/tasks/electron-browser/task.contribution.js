...
var languageServiceTaskSystem_1 = require("vs/workbench/parts/tasks/common/languageServiceTaskSystem");
...
var BuildAction = (function (_super) {
    ...
    function BuildAction(id, label, taskService, telemetryService, messageService, contextService) {
        return _super.call(this, id, label, taskService, telemetryService, messageService, contextService) || this;
    }
...
BuildAction = __decorate([
    __param(2, taskService_1.ITaskService), __param(3, telemetry_1.ITelemetryService),
    __param(4, message_1.IMessageService), __param(5, workspace_1.IWorkspaceContextService)
], BuildAction);
...
OpenTaskConfigurationAction = __decorate([
    ...
    __param(7, message_1.IMessageService), __param(8, quickOpenService_1.IQuickOpenService),
...
var ShowLogAction = (function (_super) {
    ...
    function ShowLogAction(id, label, taskService, telemetryService, messageService, contextService, outputService) {
        var _this = _super.call(this, id, label, taskService, telemetryService, messageService, contextService) || this;
        _this.outputService = outputService;
        return _this;
    }
...
RunTaskAction = __decorate([
    ...
    __param(3, taskService_1.ITaskService), __param(4, telemetry_1.ITelemetryService),
    __param(5, message_1.IMessageService), __param(6, workspace_1.IWorkspaceContextService)
], RunTaskAction);
...
var TaskService = (function (_super) {
    ...
    function TaskService(modeService, configurationService, markerService, outputService, messageService, editorService, fileService, contextService, telemetryService, textFileService, lifecycleService, eventService, modelService, extensionService, quickOpenService, environmentService, configurationResolverService) {
                    ...
                    this._taskSystemPromise = winjs_base_1.TPromise.as(this.configurationService.getConfiguration('tasks')).then(function (config) {
                        ...
                        if (config) {
                            if (_this.isRunnerConfig(config) && _this.hasDetectorSupport(config)) {
                                ...
                                configPromise = new processRunnerDetector_1.ProcessRunnerDetector(_this.fileService, _this.contextService, _this.configurationResolverService, fileConfig_1).detect(true).then(function (value) {
                        ...
                        return configPromise.then(function (config) {
                            ...
                            if (config.buildSystem === 'service') {
                                ...
                                result = new processRunnerSystem_1.ProcessRunnerSystem(config, _this.markerService, _this.modelService, _this.telemetryService, _this.outputService, _this.configurationResolverService, TaskService.OutputChannelId, clearOutput_1);
                            }
                            if (result === null) {
                                _this._taskSystemPromise = null;
                ...
                return _this.taskSystemPromise.
                    ...
                    if (executeResult.kind === taskSystem_1.TaskExecuteKind.Started) {
                        if (executeResult.started.restartOnFileChanges) {
                            ...
                            _this.fileChangesListener = _this.eventService.addListener2(files_1.EventType.FILE_CHANGES, function (event) {
...
TaskService = __decorate([
    ...
    __param(10, lifecycle_2.ILifecycleService), __param(11, event_1.IEventService),
...
workbenchActionsRegistry.registerWorkbenchAction(new actions_2.SyncActionDescriptor(BuildAction, BuildAction.ID, BuildAction.TEXT, { primary: 32768 /* CtrlCmd */ | 16384 /* Shift */ | 32 /* KEY_B */ }), 'Tasks: Run Build Task', tasksCategory);
