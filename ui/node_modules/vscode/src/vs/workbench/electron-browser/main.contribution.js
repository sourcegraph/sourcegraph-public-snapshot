...
workbenchActionsRegistry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(actions_2.OpenRecentAction, actions_2.OpenRecentAction.ID, actions_2.OpenRecentAction.LABEL, { primary: 32768 /* CtrlCmd */ | 48 /* KEY_R */, mac: { primary: 4096 /* WinCtrl */ | 48 /* KEY_R */ } }), 'File: Open Recent', fileCategory);
...
workbenchActionsRegistry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(actions_2.ZoomInAction, actions_2.ZoomInAction.ID, actions_2.ZoomInAction.LABEL, { primary: 32768 /* CtrlCmd */ | 81 /* US_EQUAL */, secondary: [32768 /* CtrlCmd */ | 16384 /* Shift */ | 81 /* US_EQUAL */] }), 'View: Zoom In', viewCategory);
workbenchActionsRegistry.registerWorkbenchAction(new actions_1.SyncActionDescriptor(actions_2.ZoomOutAction, actions_2.ZoomOutAction.ID, actions_2.ZoomOutAction.LABEL, {
    ...
    secondary: [32768 /* CtrlCmd */ | 16384 /* Shift */ | 83 /* US_MINUS */],
    linux: { primary: 32768 /* CtrlCmd */ | 83 /* US_MINUS */, secondary: [] }
...
keybindingsRegistry_1.KeybindingsRegistry.registerCommandAndKeybindingRule({
    ...
    handler: function (accessor) {
        var windowService = accessor.get(windowService_1.IWindowService);
