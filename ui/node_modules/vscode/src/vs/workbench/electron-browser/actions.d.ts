...
export declare class SwitchWindow extends Action {
    ...
    static ID: string;
    static LABEL: string;
    constructor(id: string, label: string, windowService: IWindowService, quickOpenService: IQuickOpenService);
    run(): TPromise<boolean>;
}
...
export declare abstract class BaseZoomAction extends Action {
    ...
    constructor(id: string, label: string, messageService: IMessageService, configurationService: IWorkspaceConfigurationService, configurationEditingService: IConfigurationEditingService);
...
export declare class ReloadWindowAction extends Action {
    ...
    static ID: string;
    static LABEL: string;
    constructor(id: string, label: string, windowService: IWindowService, partService: IPartService);
    run(): TPromise<boolean>;
}
export declare class OpenRecentAction extends Action {
    ...
    static ID: string;
    static LABEL: string;
    constructor(id: string, label: string, windowService: IWindowService, quickOpenService: IQuickOpenService, contextService: IWorkspaceContextService);
    run(): TPromise<boolean>;
...
export declare class ReportIssueAction extends Action {
    ...
    static ID: string;
    static LABEL: string;
    constructor(id: string, label: string, messageService: IMessageService, integrityService: IIntegrityService, extensionManagementService: IExtensionManagementService, editorService: IWorkbenchEditorService);
    run(): TPromise<boolean>;
