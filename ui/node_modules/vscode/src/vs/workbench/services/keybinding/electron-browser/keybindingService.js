...
var keybindingServiceImpl_1 = require('vs/platform/keybinding/browser/keybindingServiceImpl');
...
var WorkbenchKeybindingService = (function (_super) {
    ...
    function WorkbenchKeybindingService(domNode, contextKeyService, commandService, telemetryService, messageService, environmentService, statusBarService) {
        var _this = this;
        _super.call(this, contextKeyService, commandService, messageService, statusBarService);
        this.telemetryService = telemetryService;
        this.userKeybindings = new config_1.ConfigWatcher(environmentService.appKeybindingsPath, { defaultConfig: [] });
        this.toDispose.push(lifecycle_1.toDisposable(function () { return _this.userKeybindings.dispose(); }));
        ...
        this.toDispose.push(this.userKeybindings.onDidUpdateConfiguration(function () { return _this.updateResolver(); }));
