...
export declare class TextFileService extends AbstractTextFileService {
    ...
    constructor(contextService: IWorkspaceContextService, fileService: IFileService, untitledEditorService: IUntitledEditorService, lifecycleService: ILifecycleService, instantiationService: IInstantiationService, telemetryService: ITelemetryService, configurationService: IConfigurationService, modeService: IModeService, editorService: IWorkbenchEditorService, editorGroupService: IEditorGroupService, windowService: IWindowService, modelService: IModelService, environmentService: IEnvironmentService);
