...
import { ITextFileService, ModelState, ITextFileEditorModel, IModelSaveOptions, ISaveErrorHandler, ISaveParticipant, StateChange } from 'vs/workbench/services/textfile/common/textfiles';
...
export declare class TextFileEditorModel extends BaseTextEditorModel implements ITextFileEditorModel {
    ...
    constructor(resource: URI, preferredEncoding: string, messageService: IMessageService, modeService: IModeService, modelService: IModelService, fileService: IFileService, lifecycleService: ILifecycleService, instantiationService: IInstantiationService, telemetryService: ITelemetryService, textFileService: ITextFileService, backupFileService: IBackupFileService);
    ...
    private loadWithContent(content);
