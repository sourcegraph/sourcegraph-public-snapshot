...
var htmlRenderer = require("vs/base/browser/htmlContentRenderer");
...
var MessageList = (function () {
    function MessageList(container, usageLogger, options) {
    ...
    MessageList.prototype.registerListeners = function () {
        var _this = this;
        browser.onDidChangeFullscreen(function () { return _this.positionMessageList(); });
        browser.onDidChangeZoomLevel(function () { return _this.positionMessageList(); });
    };
    ...
    MessageList.prototype.renderMessage = function (message, container, total, delta) {
        ...
        container.li({ class: 'message-list-entry message-list-entry-with-action' }, function (li) {
            ...
            li.div({ class: 'actions-container' }, function (actionContainer) {
                var _loop_1 = function (i) {
                    ...
                    actionContainer.div({ class: 'message-action' }, function (div) {
                        div.a({ class: 'action-button', tabindex: '0', role: 'button' }).text(action.label).on([DOM.EventType.CLICK, DOM.EventType.KEY_DOWN], function (e) {
            ...
            li.div({ class: 'message-left-side' }, function (div) {
                ...
                builder_1.$(messageContentElement).title(messageContentElement.textContent).appendTo(div);
            });
        });
    };
