...
var messageList_1 = require('vs/workbench/services/message/browser/messagelist/messageList');
...
var WorkbenchMessageService = (function () {
    ...
    WorkbenchMessageService.prototype.choose = function (severity, message, options) {
        var _this = this;
        var onCancel = null;
