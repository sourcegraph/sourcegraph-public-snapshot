...
var FileService = (function () {
    ...
    FileService.prototype.onFileServiceError = function (msg) {
        ...
        if (msg && msg.indexOf(FileService.NET_VERSION_ERROR) >= 0 && !this.storageService.getBoolean(FileService.NET_VERSION_ERROR_IGNORE_KEY, storage_1.StorageScope.WORKSPACE)) {
