...
var themesExtPoint = extensionsRegistry_1.ExtensionsRegistry.registerExtensionPoint('themes', [], {
    ...
    items: {
        type: 'object',
        defaultSnippets: [{ body: { label: '${1:label}', uiTheme: themeService_1.VS_DARK_THEME, path: './themes/${2:id}.tmTheme.' } }],
        properties: {
            label: {
...
var ThemeService = (function () {
    ...
    ThemeService.prototype.onThemes = function (extensionFolderPath, extensionData, themes, collector) {
        var _this = this;
    ...
    ThemeService.prototype.onIconThemes = function (extensionFolderPath, extensionData, iconThemes, collector) {
        var _this = this;
...
function _processThemeObject(themeId, themeDocument) {
    ...
    if (Array.isArray(themeSettings)) {
        ...
        new stylesContributions_1.TerminalStylesContribution().contributeStyles(themeId, themeDocument, cssRules);
    }
    return cssRules.join('\n');
}
