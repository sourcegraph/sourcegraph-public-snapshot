...
import { ICommandLineArguments, IProcessEnvironment, IEnvService } from 'vs/code/electron-main/env';
...
export declare class WindowsManager implements IWindowsService {
    ...
    onNewWindowOpen: CommonEvent<number>;
    constructor(instantiationService: IInstantiationService, logService: ILogService, storageService: IStorageService, envService: IEnvService, lifecycleService: ILifecycleService, updateService: IUpdateService, configurationService: IConfigurationService);
    onOpen(clb: (path: IPath) => void): () => void;
    onReady(clb: (win: VSCodeWindow) => void): () => void;
    onClose(clb: (id: number) => void): () => void;
    ready(initialUserEnv: IProcessEnvironment): void;
