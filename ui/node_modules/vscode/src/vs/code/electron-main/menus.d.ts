...
export declare class VSCodeMenu {
    ...
    constructor(storageService: IStorageService, updateService: IUpdateService, configurationService: IConfigurationService, windowsService: IWindowsService, envService: IEnvService);
    ready(): void;
