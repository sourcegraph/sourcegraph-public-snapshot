...
export declare class UpdateManager extends EventEmitter implements IUpdateService {
    ...
    private _feedUrl;
    private _channel;
    constructor(instantiationService: IInstantiationService, lifecycleService: ILifecycleService, envService: IEnvService, configurationService: IConfigurationService, requestService: IRequestService);
    private initRaw();
