...
var InstantiationService = (function () {
    ...
    InstantiationService.prototype._createInstanceAsync = function (descriptor, args) {
        ...
        return new winjs_base_1.TPromise(function (c, e, p) {
            require([], function () {
				var _module = {
					ExplorerViewlet: require("vs/workbench/parts/files/browser/explorerViewlet")["ExplorerViewlet"],
					StringEditor: require("vs/workbench/browser/parts/editor/stringEditor")["StringEditor"],
				};
                if (canceledError) {
                    e(canceledError);
                }
