...
function _loadLanguage(languageId) {
    ...
    return new winjs_base_1.TPromise(function (c, e, p) {
        require([("monaco-languages/out/" + module.slice(2) + ".js")], function (mod) {
            standaloneLanguages_1.setMonarchTokensProvider(languageId, mod.language);
            standaloneLanguages_1.setLanguageConfiguration(languageId, mod.conf);
            c(void 0);
        });
    });
}
...
function registerLanguage(def) {
    ...
    standaloneLanguages_1.register(def);
    standaloneLanguages_1.onLanguage(languageId, function () {
