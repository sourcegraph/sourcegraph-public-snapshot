...
var TOKEN_SELECTOR = 'entity.name.selector';
var TOKEN_SELECTOR_TAG = 'entity.name.tag';
var TOKEN_PROPERTY = 'support.type.property-name';
var TOKEN_VALUE = 'support.property-value';
...
exports.language = {
    ...
    tokenizer: {
        ...
        numbers: [
            ['(\\d*\\.)?\\d+([eE][\\-+]?\\d+)?', { token: TOKEN_VALUE + '.numeric', next: '@units' }],
