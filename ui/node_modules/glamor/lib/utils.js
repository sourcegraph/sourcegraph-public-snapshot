...
function aspectRatio() {
  ...
  var height = arguments.length <= 1 || arguments[1] === undefined ? 9 : arguments[1];
...
function circle(radius) {
  var color = arguments.length <= 1 || arguments[1] === undefined ? 'transparent' : arguments[1];
...
function hr() {
  var color = arguments.length <= 0 || arguments[0] === undefined ? '#ccc' : arguments[0];
  var verticalMargin = arguments.length <= 1 || arguments[1] === undefined ? '1em' : arguments[1];
...
function textHide() {
  var alternative = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
...
function triangle() {
  ...
  var color = arguments.length <= 1 || arguments[1] === undefined ? '#ccc' : arguments[1];
  var orientation = arguments.length <= 2 || arguments[2] === undefined ? 'down' : arguments[2];
...
function truncate() {
  var lines = arguments.length <= 0 || arguments[0] === undefined ? 0 : arguments[0];
  var lineHeight = arguments.length <= 1 || arguments[1] === undefined ? 1 : arguments[1];
  var textOverflow = arguments.length <= 2 || arguments[2] === undefined ? 'ellipsis' : arguments[2];
...
function wordWrap() {
  var wrap = arguments.length <= 0 || arguments[0] === undefined ? 'break-word' : arguments[0];
  var wordBreak = arguments.length <= 1 || arguments[1] === undefined ? wrap !== 'break-word' ? wrap : 'break-all' : arguments[1];
