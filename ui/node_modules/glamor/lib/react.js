...
function createElement(tag, allProps) {
  ...
  if (typeof tag === 'string' && allProps && allProps.css) {
    ...
    return _react2.default.createElement.apply(_react2.default, [tag, _extends({}, props, Array.isArray(css) ? _index.merge.apply(undefined, _toConsumableArray(css)) : (0, _index.isLikeRule)(css) ? css : (0, _index.style)(css))].concat(children));
  }
