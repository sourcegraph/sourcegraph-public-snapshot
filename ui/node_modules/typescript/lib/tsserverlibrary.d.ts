...
declare namespace ts {
    ...
    const enum TransformFlags {
        ...
        AssertTypeScript = 3,
        AssertJsx = 12,
        AssertRelay = -1073741824,
        AssertES2017 = 48,
        AssertES2016 = 192,
        AssertES2015 = 768,
        AssertGenerator = 6144,
        NodeExcludes = 1610616149,
        ArrowFunctionExcludes = 1665969493,
        FunctionExcludes = 1666035029,
        ConstructorExcludes = 1665502549,
        MethodOrAccessorExcludes = 1665502549,
        ClassExcludes = 1613491541,
        ModuleExcludes = 1648471381,
        TypeExcludes = -3,
        ObjectLiteralExcludes = 1612852565,
        ArrayLiteralOrCallOrNewExcludes = 1611664725,
        VariableDeclarationListExcludes = 1619004757,
        ParameterExcludes = 1619004757,
...
declare namespace ts {
    function transformRelay(context: TransformationContext): (node: SourceFile) => SourceFile;
}
declare namespace ts {
