...
var IoChatboxWorking = function (_React$Component) {
    _inherits(IoChatboxWorking, _React$Component);

    function IoChatboxWorking() {
        _classCallCheck(this, IoChatboxWorking);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(IoChatboxWorking).apply(this, arguments));
    }

    _createClass(IoChatboxWorking, [{
        key: 'render',
