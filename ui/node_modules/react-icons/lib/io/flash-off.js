...
var IoFlashOff = function (_React$Component) {
    _inherits(IoFlashOff, _React$Component);

    function IoFlashOff() {
        _classCallCheck(this, IoFlashOff);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(IoFlashOff).apply(this, arguments));
    }

    _createClass(IoFlashOff, [{
        key: 'render',
