...
var TiBatteryMid = function (_React$Component) {
    _inherits(TiBatteryMid, _React$Component);

    function TiBatteryMid() {
        _classCallCheck(this, TiBatteryMid);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(TiBatteryMid).apply(this, arguments));
    }

    _createClass(TiBatteryMid, [{
        key: 'render',
