...
var TiSocialGithubCircular = function (_React$Component) {
    _inherits(TiSocialGithubCircular, _React$Component);

    function TiSocialGithubCircular() {
        _classCallCheck(this, TiSocialGithubCircular);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(TiSocialGithubCircular).apply(this, arguments));
    }

    _createClass(TiSocialGithubCircular, [{
        key: 'render',
