...
var TiFlowSwitch = function (_React$Component) {
    _inherits(TiFlowSwitch, _React$Component);

    function TiFlowSwitch() {
        _classCallCheck(this, TiFlowSwitch);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(TiFlowSwitch).apply(this, arguments));
    }

    _createClass(TiFlowSwitch, [{
        key: 'render',
