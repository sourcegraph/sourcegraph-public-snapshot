...
var FaCcAmex = function (_React$Component) {
    _inherits(FaCcAmex, _React$Component);

    function FaCcAmex() {
        _classCallCheck(this, FaCcAmex);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaCcAmex).apply(this, arguments));
    }

    _createClass(FaCcAmex, [{
        key: 'render',
