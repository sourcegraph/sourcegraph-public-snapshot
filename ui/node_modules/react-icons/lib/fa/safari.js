...
var FaSafari = function (_React$Component) {
    _inherits(FaSafari, _React$Component);

    function FaSafari() {
        _classCallCheck(this, FaSafari);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaSafari).apply(this, arguments));
    }

    _createClass(FaSafari, [{
        key: 'render',
