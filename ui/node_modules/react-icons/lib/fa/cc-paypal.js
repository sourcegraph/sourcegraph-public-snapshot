...
var FaCcPaypal = function (_React$Component) {
    _inherits(FaCcPaypal, _React$Component);

    function FaCcPaypal() {
        _classCallCheck(this, FaCcPaypal);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaCcPaypal).apply(this, arguments));
    }

    _createClass(FaCcPaypal, [{
        key: 'render',
