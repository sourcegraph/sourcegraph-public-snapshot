...
var FaCcStripe = function (_React$Component) {
    _inherits(FaCcStripe, _React$Component);

    function FaCcStripe() {
        _classCallCheck(this, FaCcStripe);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaCcStripe).apply(this, arguments));
    }

    _createClass(FaCcStripe, [{
        key: 'render',
