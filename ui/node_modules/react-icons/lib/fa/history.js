...
var FaHistory = function (_React$Component) {
    _inherits(FaHistory, _React$Component);

    function FaHistory() {
        _classCallCheck(this, FaHistory);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaHistory).apply(this, arguments));
    }

    _createClass(FaHistory, [{
        key: 'render',
