...
var FaUnderline = function (_React$Component) {
    _inherits(FaUnderline, _React$Component);

    function FaUnderline() {
        _classCallCheck(this, FaUnderline);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaUnderline).apply(this, arguments));
    }

    _createClass(FaUnderline, [{
        key: 'render',
