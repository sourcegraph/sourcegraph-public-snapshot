...
var FaWpforms = function (_React$Component) {
    _inherits(FaWpforms, _React$Component);

    function FaWpforms() {
        _classCallCheck(this, FaWpforms);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaWpforms).apply(this, arguments));
    }

    _createClass(FaWpforms, [{
        key: 'render',
