...
var FaAmazon = function (_React$Component) {
    _inherits(FaAmazon, _React$Component);

    function FaAmazon() {
        _classCallCheck(this, FaAmazon);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaAmazon).apply(this, arguments));
    }

    _createClass(FaAmazon, [{
        key: 'render',
