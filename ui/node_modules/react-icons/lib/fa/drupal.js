...
var FaDrupal = function (_React$Component) {
    _inherits(FaDrupal, _React$Component);

    function FaDrupal() {
        _classCallCheck(this, FaDrupal);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaDrupal).apply(this, arguments));
    }

    _createClass(FaDrupal, [{
        key: 'render',
