...
var FaDollar = function (_React$Component) {
    _inherits(FaDollar, _React$Component);

    function FaDollar() {
        _classCallCheck(this, FaDollar);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaDollar).apply(this, arguments));
    }

    _createClass(FaDollar, [{
        key: 'render',
