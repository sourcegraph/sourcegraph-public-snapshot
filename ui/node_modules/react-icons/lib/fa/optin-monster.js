...
var FaOptinMonster = function (_React$Component) {
    _inherits(FaOptinMonster, _React$Component);

    function FaOptinMonster() {
        _classCallCheck(this, FaOptinMonster);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaOptinMonster).apply(this, arguments));
    }

    _createClass(FaOptinMonster, [{
        key: 'render',
