...
var FaEmpire = function (_React$Component) {
    _inherits(FaEmpire, _React$Component);

    function FaEmpire() {
        _classCallCheck(this, FaEmpire);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaEmpire).apply(this, arguments));
    }

    _createClass(FaEmpire, [{
        key: 'render',
