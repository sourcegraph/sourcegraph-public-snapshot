...
var FaJoomla = function (_React$Component) {
    _inherits(FaJoomla, _React$Component);

    function FaJoomla() {
        _classCallCheck(this, FaJoomla);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaJoomla).apply(this, arguments));
    }

    _createClass(FaJoomla, [{
        key: 'render',
