...
var FaAngellist = function (_React$Component) {
    _inherits(FaAngellist, _React$Component);

    function FaAngellist() {
        _classCallCheck(this, FaAngellist);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaAngellist).apply(this, arguments));
    }

    _createClass(FaAngellist, [{
        key: 'render',
