...
var FaCcJcb = function (_React$Component) {
    _inherits(FaCcJcb, _React$Component);

    function FaCcJcb() {
        _classCallCheck(this, FaCcJcb);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaCcJcb).apply(this, arguments));
    }

    _createClass(FaCcJcb, [{
        key: 'render',
