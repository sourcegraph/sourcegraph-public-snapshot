...
var FaListOl = function (_React$Component) {
    _inherits(FaListOl, _React$Component);

    function FaListOl() {
        _classCallCheck(this, FaListOl);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaListOl).apply(this, arguments));
    }

    _createClass(FaListOl, [{
        key: 'render',
