...
var FaBicycle = function (_React$Component) {
    _inherits(FaBicycle, _React$Component);

    function FaBicycle() {
        _classCallCheck(this, FaBicycle);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaBicycle).apply(this, arguments));
    }

    _createClass(FaBicycle, [{
        key: 'render',
