...
var FaThList = function (_React$Component) {
    _inherits(FaThList, _React$Component);

    function FaThList() {
        _classCallCheck(this, FaThList);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaThList).apply(this, arguments));
    }

    _createClass(FaThList, [{
        key: 'render',
