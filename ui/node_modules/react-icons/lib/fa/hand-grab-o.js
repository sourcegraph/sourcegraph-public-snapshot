...
var FaHandGrabO = function (_React$Component) {
    _inherits(FaHandGrabO, _React$Component);

    function FaHandGrabO() {
        _classCallCheck(this, FaHandGrabO);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaHandGrabO).apply(this, arguments));
    }

    _createClass(FaHandGrabO, [{
        key: 'render',
