...
var MdTurnedIn = function (_React$Component) {
    _inherits(MdTurnedIn, _React$Component);

    function MdTurnedIn() {
        _classCallCheck(this, MdTurnedIn);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdTurnedIn).apply(this, arguments));
    }

    _createClass(MdTurnedIn, [{
        key: 'render',
