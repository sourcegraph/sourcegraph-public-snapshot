...
var MdBubbleChart = function (_React$Component) {
    _inherits(MdBubbleChart, _React$Component);

    function MdBubbleChart() {
        _classCallCheck(this, MdBubbleChart);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdBubbleChart).apply(this, arguments));
    }

    _createClass(MdBubbleChart, [{
        key: 'render',
