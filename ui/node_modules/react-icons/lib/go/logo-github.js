...
var GoLogoGithub = function (_React$Component) {
    _inherits(GoLogoGithub, _React$Component);

    function GoLogoGithub() {
        _classCallCheck(this, GoLogoGithub);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(GoLogoGithub).apply(this, arguments));
    }

    _createClass(GoLogoGithub, [{
        key: 'render',
