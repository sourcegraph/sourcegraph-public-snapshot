...
//go:generate $PWD/.bin/go-mockgen -f github.com/sourcegraph/sourcegraph/enterprise/cmd/precise-code-intel-worker/internal/worker -i DBStore -i LSIFStore -i GitserverClient -i IndexEnqueuer -o mock_iface_test.go
