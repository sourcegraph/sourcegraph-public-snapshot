...
func (m *MockWorkerStore) Dequeue(v0 context.Context, v1 []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error) {
...
// empty.
func (f *WorkerStoreDequeueFunc) SetDefaultHook(hook func(context.Context, []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error)) {
	f.defaultHook = hook
}
...
func (f *WorkerStoreDequeueFunc) PushHook(hook func(context.Context, []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *WorkerStoreDequeueFunc) nextHook() func(context.Context, []*sqlf.Query) (workerutil.Record, context.CancelFunc, bool, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
