...
func (c *Config) Load() {
	...
	c.BigQuery.EventBufferSize = c.GetInt("CODY_GATEWAY_BIGQUERY_EVENT_BUFFER_SIZE", "10", "The number of events to buffer when submitting BigQuery events - set to 0 to disable.")
