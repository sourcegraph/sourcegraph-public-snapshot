...
func (c *Config) Load() {
	...
	c.OpenAI.AccessToken = c.Get("LLM_PROXY_OPENAI_ACCESS_TOKEN", "", "The OpenAI access token to be used.")
	c.OpenAI.OrgID = c.Get("LLM_PROXY_OPENAI_ORG_ID", "", "The OpenAI organization to count billing towards. Setting this ensures we always use the correct negotiated terms.")
