...
import (
	...
	sharedconfig "github.com/sourcegraph/sourcegraph/enterprise/cmd/executor-queue/internal/config"
...
func main() {
	...
	configs := []config{serviceConfig, sharedConfig, batchesConfig, codeintelConfig}
