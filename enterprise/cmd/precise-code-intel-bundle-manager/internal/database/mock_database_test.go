...
func NewMockDatabase() *MockDatabase {
	return &MockDatabase{
		...
		WindowFunc: &DatabaseWindowFunc{
			defaultHook: func(context.Context, string, int, int) ([]client.AggregateCodeIntelligence, error) {
				return nil, nil
			},
		},
	}
...
// DatabaseWindowFunc describes the behavior when the Window method of the
// parent MockDatabase instance is invoked.
type DatabaseWindowFunc struct {
	defaultHook func(context.Context, string, int, int) ([]client.AggregateCodeIntelligence, error)
	hooks       []func(context.Context, string, int, int) ([]client.AggregateCodeIntelligence, error)
	history     []DatabaseWindowFuncCall
	mutex       sync.Mutex
}

// Window delegates to the next hook function in the queue and stores the
// parameter and result values of this invocation.
func (m *MockDatabase) Window(v0 context.Context, v1 string, v2 int, v3 int) ([]client.AggregateCodeIntelligence, error) {
	r0, r1 := m.WindowFunc.nextHook()(v0, v1, v2, v3)
	m.WindowFunc.appendCall(DatabaseWindowFuncCall{v0, v1, v2, v3, r0, r1})
	return r0, r1
}

// SetDefaultHook sets function that is called when the Window method of the
// parent MockDatabase instance is invoked and the hook queue is empty.
func (f *DatabaseWindowFunc) SetDefaultHook(hook func(context.Context, string, int, int) ([]client.AggregateCodeIntelligence, error)) {
	f.defaultHook = hook
}

// PushHook adds a function to the end of hook queue. Each invocation of the
// Window method of the parent MockDatabase instance inovkes the hook at the
// front of the queue and discards it. After the queue is empty, the default
// hook function is invoked for any future action.
func (f *DatabaseWindowFunc) PushHook(hook func(context.Context, string, int, int) ([]client.AggregateCodeIntelligence, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
// SetDefaultReturn calls SetDefaultDefaultHook with a function that returns
// the given values.
func (f *DatabaseWindowFunc) SetDefaultReturn(r0 []client.AggregateCodeIntelligence, r1 error) {
	f.SetDefaultHook(func(context.Context, string, int, int) ([]client.AggregateCodeIntelligence, error) {
		return r0, r1
	})
}
...
// PushReturn calls PushDefaultHook with a function that returns the given
// values.
func (f *DatabaseWindowFunc) PushReturn(r0 []client.AggregateCodeIntelligence, r1 error) {
	f.PushHook(func(context.Context, string, int, int) ([]client.AggregateCodeIntelligence, error) {
		return r0, r1
	})
}

func (f *DatabaseWindowFunc) nextHook() func(context.Context, string, int, int) ([]client.AggregateCodeIntelligence, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
func (f *DatabaseWindowFunc) appendCall(r0 DatabaseWindowFuncCall) {
	f.mutex.Lock()
	f.history = append(f.history, r0)
	f.mutex.Unlock()
}

// History returns a sequence of DatabaseWindowFuncCall objects describing
// the invocations of this function.
func (f *DatabaseWindowFunc) History() []DatabaseWindowFuncCall {
	f.mutex.Lock()
	history := make([]DatabaseWindowFuncCall, len(f.history))
	copy(history, f.history)
	f.mutex.Unlock()
...
// DatabaseWindowFuncCall is an object that describes an invocation of
// method Window on an instance of MockDatabase.
type DatabaseWindowFuncCall struct {
	// Arg0 is the value of the 1st argument passed to this method
	// invocation.
	Arg0 context.Context
	// Arg1 is the value of the 2nd argument passed to this method
	...
	// Result0 is the value of the 1st result returned from this method
	// invocation.
	Result0 []client.AggregateCodeIntelligence
	// Result1 is the value of the 2nd result returned from this method
	// invocation.
	Result1 error
}
...
// Args returns an interface slice containing the arguments of this
// invocation.
func (c DatabaseWindowFuncCall) Args() []interface{} {
	return []interface{}{c.Arg0, c.Arg1, c.Arg2, c.Arg3}
}

// Results returns an interface slice containing the results of this
// invocation.
func (c DatabaseWindowFuncCall) Results() []interface{} {
	return []interface{}{c.Result0, c.Result1}
}
