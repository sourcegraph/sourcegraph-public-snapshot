...
var (
	...
	rawMaxDataAge          = env.Get("PRECISE_CODE_INTEL_MAX_DATA_AGE", "30d", "The maximum time LSIF data not visible from the tip of the default branch can remain in the database.")
