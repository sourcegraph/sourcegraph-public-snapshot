...
./enterprise/cmd/precise-code-intel-bundle-manager/go-build.sh "$OUTPUT"

echo "--- docker build"
docker build -f enterprise/cmd/precise-code-intel-bundle-manager/Dockerfile -t "$IMAGE" "$OUTPUT" \
  --progress=plain \
