...
func NewMockDBStore() *MockDBStore {
	return &MockDBStore{
		...
		SelectRepositoriesForIndexScanFunc: &DBStoreSelectRepositoriesForIndexScanFunc{
			defaultHook: func(context.Context, time.Duration, bool, int) ([]int, error) {
				return nil, nil
			},
		},
		WithFunc: &DBStoreWithFunc{
...
type DBStoreSelectRepositoriesForIndexScanFunc struct {
	defaultHook func(context.Context, time.Duration, bool, int) ([]int, error)
	hooks       []func(context.Context, time.Duration, bool, int) ([]int, error)
...
// queue and stores the parameter and result values of this invocation.
func (m *MockDBStore) SelectRepositoriesForIndexScan(v0 context.Context, v1 time.Duration, v2 bool, v3 int) ([]int, error) {
	r0, r1 := m.SelectRepositoriesForIndexScanFunc.nextHook()(v0, v1, v2, v3)
	m.SelectRepositoriesForIndexScanFunc.appendCall(DBStoreSelectRepositoriesForIndexScanFuncCall{v0, v1, v2, v3, r0, r1})
	return r0, r1
}
...
// SelectRepositoriesForIndexScan method of the parent MockDBStore instance
// is invoked and the hook queue is empty.
func (f *DBStoreSelectRepositoriesForIndexScanFunc) SetDefaultHook(hook func(context.Context, time.Duration, bool, int) ([]int, error)) {
	f.defaultHook = hook
}
...
// queue is empty, the default hook function is invoked for any future
// action.
func (f *DBStoreSelectRepositoriesForIndexScanFunc) PushHook(hook func(context.Context, time.Duration, bool, int) ([]int, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *DBStoreSelectRepositoriesForIndexScanFunc) SetDefaultReturn(r0 []int, r1 error) {
	f.SetDefaultHook(func(context.Context, time.Duration, bool, int) ([]int, error) {
		return r0, r1
	})
}
...
func (f *DBStoreSelectRepositoriesForIndexScanFunc) PushReturn(r0 []int, r1 error) {
	f.PushHook(func(context.Context, time.Duration, bool, int) ([]int, error) {
		return r0, r1
	})
}

func (f *DBStoreSelectRepositoriesForIndexScanFunc) nextHook() func(context.Context, time.Duration, bool, int) ([]int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
