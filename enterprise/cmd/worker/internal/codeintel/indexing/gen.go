...
//go:generate ../../../../../../dev/mockgen.sh github.com/sourcegraph/sourcegraph/enterprise/cmd/worker/internal/codeintel/indexing -i DBStore -i GitserverClient -i IndexEnqueuer -i IndexingSettingStore -i IndexingRepoStore -i ExternalServiceStore -i RepoUpdaterClient -o mock_iface_test.go
