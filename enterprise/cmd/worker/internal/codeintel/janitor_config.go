...
func (c *janitorConfig) Load() {
	...
	c.UpdatedPoliciesBatchSize = c.GetInt("PRECISE_CODE_INTEL_CONFIGURATION_POLICIES_BATCH_SIZE", "100", "The maximum number of policy configurations to update at a time.")
