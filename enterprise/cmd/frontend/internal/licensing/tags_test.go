...
func TestProductNameWithBrand(t *testing.T) {
	tests := []struct {
		...
		{hasLicense: true, licenseTags: []string{EliteTag}, want: "Sourcegraph Elite"},
		...
		{hasLicense: true, licenseTags: []string{EliteTag, "trial", "dev"}, want: "Sourcegraph Elite (trial, dev use only)"},
	}
