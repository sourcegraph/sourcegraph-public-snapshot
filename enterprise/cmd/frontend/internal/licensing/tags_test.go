...
func TestProductNameWithBrand(t *testing.T) {
	tests := []struct {
		...
		{hasLicense: true, licenseTags: []string{EnterpriseTag}, want: "Sourcegraph Enterprise"},
		...
		{hasLicense: true, licenseTags: []string{EnterpriseTag, "trial", "dev"}, want: "Sourcegraph Enterprise (trial, dev use only)"},
