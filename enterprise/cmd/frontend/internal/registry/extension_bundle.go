...
func handleRegistryExtensionBundle(db dbutil.DB) func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		bundle, sourceMap, err := dbReleases{db: db}.GetArtifacts(r.Context(), releaseID)
