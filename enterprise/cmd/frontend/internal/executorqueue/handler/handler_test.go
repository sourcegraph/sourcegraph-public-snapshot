...
func TestHandler_HandleHeartbeat(t *testing.T) {
	tests := []struct {
		name                 string
		body                 string
		mockFunc             func(metricsStore *metricsstore.MockDistributedStore, executorStore *databasemocks.MockExecutorStore, mockStore *dbworkerstoremocks.MockStore[testRecord])
		expectedStatusCode   int
		expectedResponseBody string
		assertionFunc        func(t *testing.T, metricsStore *metricsstore.MockDistributedStore, executorStore *databasemocks.MockExecutorStore, mockStore *dbworkerstoremocks.MockStore[testRecord])
	}{
		{
