...
func NewMockQueryResolver() *MockQueryResolver {
	return &MockQueryResolver{
		...
		DocumentationFunc: &QueryResolverDocumentationFunc{
			defaultHook: func(context.Context, int, int) (r0 []*resolvers.Documentation, r1 error) {
				return
			},
		},
		DocumentationDefinitionsFunc: &QueryResolverDocumentationDefinitionsFunc{
			defaultHook: func(context.Context, string) (r0 []resolvers.AdjustedLocation, r1 error) {
				return
			},
		},
		DocumentationPageFunc: &QueryResolverDocumentationPageFunc{
			defaultHook: func(context.Context, string) (r0 *precise.DocumentationPageData, r1 error) {
				return
			},
		},
		DocumentationPathInfoFunc: &QueryResolverDocumentationPathInfoFunc{
			defaultHook: func(context.Context, string) (r0 *precise.DocumentationPathInfoData, r1 error) {
				return
			},
		},
		DocumentationReferencesFunc: &QueryResolverDocumentationReferencesFunc{
			defaultHook: func(context.Context, string, int, string) (r0 []resolvers.AdjustedLocation, r1 string, r2 error) {
				return
			},
		},
		HoverFunc: &QueryResolverHoverFunc{
