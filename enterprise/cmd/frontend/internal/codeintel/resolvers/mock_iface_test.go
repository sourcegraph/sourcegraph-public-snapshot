...
func NewMockGitserverClient() *MockGitserverClient {
	return &MockGitserverClient{
		...
		CommitGraphFunc: &GitserverClientCommitGraphFunc{
			defaultHook: func(context.Context, int, gitdomain.CommitGraphOptions) (*gitdomain.CommitGraph, error) {
				return nil, nil
			},
		},
		CommitsExistFunc: &GitserverClientCommitsExistFunc{
...
type GitserverClientCommitGraphFunc struct {
	defaultHook func(context.Context, int, gitdomain.CommitGraphOptions) (*gitdomain.CommitGraph, error)
	hooks       []func(context.Context, int, gitdomain.CommitGraphOptions) (*gitdomain.CommitGraph, error)
...
// the parameter and result values of this invocation.
func (m *MockGitserverClient) CommitGraph(v0 context.Context, v1 int, v2 gitdomain.CommitGraphOptions) (*gitdomain.CommitGraph, error) {
...
// is empty.
func (f *GitserverClientCommitGraphFunc) SetDefaultHook(hook func(context.Context, int, gitdomain.CommitGraphOptions) (*gitdomain.CommitGraph, error)) {
	f.defaultHook = hook
}
...
// hook at the front of the queue and discards it. After the queue is empty,
// the default hook function is invoked for any future action.
func (f *GitserverClientCommitGraphFunc) PushHook(hook func(context.Context, int, gitdomain.CommitGraphOptions) (*gitdomain.CommitGraph, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *GitserverClientCommitGraphFunc) SetDefaultReturn(r0 *gitdomain.CommitGraph, r1 error) {
	f.SetDefaultHook(func(context.Context, int, gitdomain.CommitGraphOptions) (*gitdomain.CommitGraph, error) {
		return r0, r1
	})
}
...
func (f *GitserverClientCommitGraphFunc) PushReturn(r0 *gitdomain.CommitGraph, r1 error) {
	f.PushHook(func(context.Context, int, gitdomain.CommitGraphOptions) (*gitdomain.CommitGraph, error) {
		return r0, r1
	})
}

func (f *GitserverClientCommitGraphFunc) nextHook() func(context.Context, int, gitdomain.CommitGraphOptions) (*gitdomain.CommitGraph, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
...
type GitserverClientCommitGraphFuncCall struct {
	...
	// Arg2 is the value of the 3rd argument passed to this method
	// invocation.
	Arg2 gitdomain.CommitGraphOptions
	// Result0 is the value of the 1st result returned from this method
	// invocation.
