...
//go:generate $PWD/.bin/go-mockgen -f github.com/sourcegraph/sourcegraph/enterprise/cmd/frontend/internal/codeintel/resolvers -i GitserverClient -i CodeIntelAPI -i DBStore -i LSIFStore -i IndexEnqueuer -o mock_iface_test.go
