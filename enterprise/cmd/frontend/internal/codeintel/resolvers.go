...
func (r *Resolver) Vulnerabilities(ctx context.Context, args *resolverstubs.VulnerabilitiesArgs) (_ []resolverstubs.VulnerabilityResolver, err error) {
	return r.codenavResolver.Vulnerabilities(ctx, args)
}
