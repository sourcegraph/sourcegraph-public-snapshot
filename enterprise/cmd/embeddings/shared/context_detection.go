...
func isQuerySimilarToNoContextMessages(
	...
	messagesWithContextSimilarity := contextDetectionEmbeddingIndex.MessagesWithAdditionalContextMeanEmbedding.Dot(queryEmbedding)
	messagesWithoutContextSimilarity := contextDetectionEmbeddingIndex.MessagesWithoutAdditionalContextMeanEmbedding.Dot(queryEmbedding)
