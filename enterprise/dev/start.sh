...
export ENTERPRISE_ONLY_COMMANDS=" precise-code-intel-bundle-manager precise-code-intel-index-manager precise-code-intel-indexer precise-code-intel-worker "
