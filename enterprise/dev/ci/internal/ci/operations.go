...
func executorsE2E(candidateTag string) operations.Operation {
	return func(p *bk.Pipeline) {
		p.AddStep(":docker::brain: Executors E2E",
			// Run tests against the candidate server image
			bk.DependsOn(candidateImageStepKey("server")),
			bk.DependsOn(candidateImageStepKey("executor")),
			bk.Env("SERVER_CANDIDATE_VERSION", candidateTag),
			bk.Env("EXECUTOR_CANDIDATE_VERSION", candidateTag),
			bk.Env("SOURCEGRAPH_BASE_URL", "http://127.0.0.1:7080"),
			bk.Env("SOURCEGRAPH_SUDO_USER", "admin"),
			bk.Env("TEST_USER_EMAIL", "test@sourcegraph.com"),
			bk.Env("TEST_USER_PASSWORD", "supersecurepassword"),
		...
		p.AddStep(":docker::brain: Executors E2E old executor",
			// Run tests against the candidate server image
			bk.DependsOn(candidateImageStepKey("server")),
			bk.DependsOn(candidateImageStepKey("executor")),
			bk.Env("SERVER_CANDIDATE_VERSION", candidateTag),
			bk.Env("EXECUTOR_CANDIDATE_VERSION", "4.1.3"),
			bk.Env("SOURCEGRAPH_BASE_URL", "http://127.0.0.1:7080"),
			bk.Env("SOURCEGRAPH_SUDO_USER", "admin"),
			bk.Env("TEST_USER_EMAIL", "test@sourcegraph.com"),
			bk.Env("TEST_USER_PASSWORD", "supersecurepassword"),
		...
		p.AddStep(":docker::brain: Executors E2E old Sourcegraph",
			// Run tests against the candidate server image
			bk.DependsOn(candidateImageStepKey("server")),
			bk.DependsOn(candidateImageStepKey("executor")),
			bk.Env("SERVER_CANDIDATE_VERSION", "4.1.3"),
			bk.Env("EXECUTOR_CANDIDATE_VERSION", candidateTag),
			bk.Env("SOURCEGRAPH_BASE_URL", "http://127.0.0.1:7080"),
			bk.Env("SOURCEGRAPH_SUDO_USER", "admin"),
			bk.Env("TEST_USER_EMAIL", "test@sourcegraph.com"),
