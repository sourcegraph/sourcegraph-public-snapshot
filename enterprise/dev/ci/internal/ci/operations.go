...
func buildGoTests(f func(description, testSuffix string)) {
	...
	slowGoTestPackages := []string{
		"github.com/sourcegraph/sourcegraph/enterprise/internal/codeintel/shared/dbstore",       // 224s
		"github.com/sourcegraph/sourcegraph/enterprise/internal/codeintel/shared/lsifstore",     // 122s
