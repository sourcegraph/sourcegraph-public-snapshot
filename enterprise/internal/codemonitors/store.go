...
type CodeMonitorStore interface {
	...
	ListActionJobs(ctx context.Context, opts ListActionEventsOpts) ([]*ActionJob, error)
	CountActionJobs(ctx context.Context, opts ListActionEventsOpts) (int, error)
	ReadActionEmailEvents(ctx context.Context, emailID int64, triggerEventID *int, args *graphqlbackend.ListEventsArgs) ([]*ActionJob, error)
	TotalActionEmailEvents(ctx context.Context, emailID int64, triggerEventID *int) (int, error)
