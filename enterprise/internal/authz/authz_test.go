...
func (m gitlabAuthzProviderParams) FetchUserPerms(context.Context, *extsvc.Account, *authz.FetchPermOptions) (*authz.ExternalUserPermissions, error) {
	panic("should never be called")
}

func (m gitlabAuthzProviderParams) FetchUserPermsByToken(context.Context, string, *authz.FetchPermOptions) (*authz.ExternalUserPermissions, error) {
	panic("should never be called")
}
