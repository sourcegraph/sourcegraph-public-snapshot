...
func NewMockGitHubAppsStore() *MockGitHubAppsStore {
	return &MockGitHubAppsStore{
		CreateFunc: &GitHubAppsStoreCreateFunc{
			defaultHook: func(context.Context, *types.GitHubApp) (r0 *types.GitHubApp, r1 error) {
				return
			},
		},
		DeleteFunc: &GitHubAppsStoreDeleteFunc{
...
func NewStrictMockGitHubAppsStore() *MockGitHubAppsStore {
	return &MockGitHubAppsStore{
		CreateFunc: &GitHubAppsStoreCreateFunc{
			defaultHook: func(context.Context, *types.GitHubApp) (*types.GitHubApp, error) {
...
type GitHubAppsStoreCreateFunc struct {
	defaultHook func(context.Context, *types.GitHubApp) (*types.GitHubApp, error)
	hooks       []func(context.Context, *types.GitHubApp) (*types.GitHubApp, error)
...
func (m *MockGitHubAppsStore) Create(v0 context.Context, v1 *types.GitHubApp) (*types.GitHubApp, error) {
...
// empty.
func (f *GitHubAppsStoreCreateFunc) SetDefaultHook(hook func(context.Context, *types.GitHubApp) (*types.GitHubApp, error)) {
	f.defaultHook = hook
}
...
func (f *GitHubAppsStoreCreateFunc) PushHook(hook func(context.Context, *types.GitHubApp) (*types.GitHubApp, error)) {
	f.mutex.Lock()
...
// given values.
func (f *GitHubAppsStoreCreateFunc) SetDefaultReturn(r0 *types.GitHubApp, r1 error) {
	f.SetDefaultHook(func(context.Context, *types.GitHubApp) (*types.GitHubApp, error) {
		return r0, r1
	})
}

// PushReturn calls PushHook with a function that returns the given values.
func (f *GitHubAppsStoreCreateFunc) PushReturn(r0 *types.GitHubApp, r1 error) {
	f.PushHook(func(context.Context, *types.GitHubApp) (*types.GitHubApp, error) {
		return r0, r1
	})
}

func (f *GitHubAppsStoreCreateFunc) nextHook() func(context.Context, *types.GitHubApp) (*types.GitHubApp, error) {
	f.mutex.Lock()
