...
func testShouldDeleteRecordsForCommit(t *testing.T, resolveRevisionFunc func(commit string) error, expectedCalls []updateInvocation) {
	...
	gitserverClient.ResolveRevisionFunc.SetDefaultHook(func(ctx context.Context, r api.RepoName, spec string, opts gitserver.ResolveRevisionOptions) (api.CommitID, error) {
