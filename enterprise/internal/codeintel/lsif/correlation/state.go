...
type State struct {
	...
	// TODO(beyang): rename DocumentSymbolResults
	DocumentSymbols            map[int][]*protocol.RangeBasedDocumentSymbol // TODO(beyang): use local types
	TextDocumentDocumentSymbol map[int]int
...
func newState() *State {
	return &State{
		DocumentData:               map[int]string{},
		DocumentSymbols:            map[int][]*protocol.RangeBasedDocumentSymbol{},
		TextDocumentDocumentSymbol: map[int]int{},
		RangeData:                  map[int]lsif.Range{},
		ResultSetData:              map[int]lsif.ResultSet{},
		DefinitionData:             map[int]*datastructures.DefaultIDSetMap{},
