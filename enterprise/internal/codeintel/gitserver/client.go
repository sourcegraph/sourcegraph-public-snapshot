...
func (c *Client) CommitGraph(ctx context.Context, repositoryID int, opts CommitGraphOptions) (_ *gitdomain.CommitGraph, err error) {
	...
	return gitdomain.ParseCommitGraph(strings.Split(out, "\n")), nil
}
