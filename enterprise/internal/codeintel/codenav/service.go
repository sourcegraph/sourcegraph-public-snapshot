...
func (s *Service) getUploadLocation(ctx context.Context, args RequestArgs, requestState RequestState, dump types.Dump, location shared.Location) (shared.UploadLocation, bool, error) {
