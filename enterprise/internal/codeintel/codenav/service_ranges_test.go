...
func TestRanges(t *testing.T) {
	...
	testLocation1 := Location{DumpID: 50, Path: "a.go", Range: testRange1}
	testLocation2 := Location{DumpID: 51, Path: "b.go", Range: testRange2}
	testLocation3 := Location{DumpID: 51, Path: "c.go", Range: testRange1}
	testLocation4 := Location{DumpID: 51, Path: "d.go", Range: testRange2}
	testLocation5 := Location{DumpID: 51, Path: "e.go", Range: testRange1}
	testLocation6 := Location{DumpID: 51, Path: "a.go", Range: testRange2}
	testLocation7 := Location{DumpID: 51, Path: "a.go", Range: testRange3}
	testLocation8 := Location{DumpID: 52, Path: "a.go", Range: testRange4}
	testLocation9 := Location{DumpID: 52, Path: "changed.go", Range: testRange6}

	ranges := []CodeIntelligenceRange{
		{Range: testRange1, HoverText: "text1", Definitions: nil, References: []Location{testLocation1}, Implementations: []Location{}},
		{Range: testRange2, HoverText: "text2", Definitions: []Location{testLocation2}, References: []Location{testLocation3}, Implementations: []Location{}},
		{Range: testRange3, HoverText: "text3", Definitions: []Location{testLocation4}, References: []Location{testLocation5}, Implementations: []Location{}},
		{Range: testRange4, HoverText: "text4", Definitions: []Location{testLocation6}, References: []Location{testLocation7}, Implementations: []Location{}},
		{Range: testRange5, HoverText: "text5", Definitions: []Location{testLocation8}, References: nil, Implementations: []Location{}},
		{Range: testRange6, HoverText: "text6", Definitions: []Location{testLocation9}, References: nil, Implementations: []Location{}},
	}
