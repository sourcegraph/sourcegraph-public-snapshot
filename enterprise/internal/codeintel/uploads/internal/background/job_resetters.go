...
// by a worker.
func NewUploadResetter(logger log.Logger, store store.Store[shared.Upload], interval time.Duration, metrics *resetterMetrics) *dbworker.Resetter[shared.Upload] {
