...
func (s *expirer) HandleExpiredUploadsBatch(ctx context.Context, metrics *ExpirationMetrics, cfg ExpirerConfig) (err error) {
...
func (s *expirer) handleRepository(ctx context.Context, repositoryID int, cfg ExpirerConfig, now time.Time, metrics *ExpirationMetrics) error {
