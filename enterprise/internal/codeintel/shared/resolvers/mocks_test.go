...
func (m *MockUploadsService) GetIndexes(v0 context.Context, v1 shared1.GetIndexesOptions) ([]types.Index, int, error) {
...
// empty.
func (f *UploadsServiceGetIndexesFunc) SetDefaultHook(hook func(context.Context, shared1.GetIndexesOptions) ([]types.Index, int, error)) {
	f.defaultHook = hook
}
...
func (f *UploadsServiceGetIndexesFunc) PushHook(hook func(context.Context, shared1.GetIndexesOptions) ([]types.Index, int, error)) {
	f.mutex.Lock()
	f.hooks = append(f.hooks, hook)
	f.mutex.Unlock()
}
...
func (f *UploadsServiceGetIndexesFunc) nextHook() func(context.Context, shared1.GetIndexesOptions) ([]types.Index, int, error) {
	f.mutex.Lock()
	defer f.mutex.Unlock()
