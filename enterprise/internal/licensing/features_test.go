...
func TestCheckFeature(t *testing.T) {
	...
	testBatchChanges := func(feature Feature) func(*testing.T) {
		return func(t *testing.T) {
			...
			check(t, feature, license(plan(business0)), false)
			check(t, feature, license(plan(enterprise1)), false)
			check(t, feature, license(plan(business0), string(feature)), true)
			check(t, feature, license(plan(enterprise1), string(feature)), true)
		}
	}
