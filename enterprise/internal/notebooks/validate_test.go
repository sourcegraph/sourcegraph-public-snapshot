...
func TestNotebookBlocksValidation(t *testing.T) {
	tests := []struct {
		...
		{blocks: []NotebookBlock{{ID: "id1", Type: NotebookQueryBlockType}}, wantErr: "invalid query block with id: id1"},
		{blocks: []NotebookBlock{{ID: "id1", Type: NotebookMarkdownBlockType}}, wantErr: "invalid markdown block with id: id1"},
		{blocks: []NotebookBlock{{ID: "id1", Type: NotebookFileBlockType}}, wantErr: "invalid file block with id: id1"},
	}
