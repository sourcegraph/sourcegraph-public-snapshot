...
func (r *disabledResolver) InsightAdminBackfillQueue(ctx context.Context, args *graphqlbackend.AdminBackfillQueueArgs) (graphqlutil.ConnectionResolver[graphqlbackend.InsightBackfillQueueItemResolver], error) {
	return graphqlutil.ConnectionResolver[graphqlbackend.InsightBackfillQueueItemResolver]{}, errors.New(r.reason)
}
