...
func (r *disabledResolver) CreateBarChartInsight(ctx context.Context, args *graphqlbackend.CreateBarChartInsightArgs) (graphqlbackend.InsightViewPayloadResolver, error) {
	return nil, errors.New(r.reason)
}
