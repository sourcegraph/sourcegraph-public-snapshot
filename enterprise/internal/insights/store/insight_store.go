...
default_filter_search_contexts, iv.series_sort_mode, iv.series_sort_direction, iv.series_limit, i.group_by, i.backfill_attempts, i.data_format
FROM (%s) iv
...
sample_interval_unit, sample_interval_value, generated_from_capture_groups,
just_in_time, generation_method, repositories, group_by, backfill_attempts, data_format
from insight_series
WHERE %s
`
