...
func NewMockDefaultRepoLister() *MockDefaultRepoLister {
	return &MockDefaultRepoLister{
		ListFunc: &DefaultRepoListerListFunc{
			defaultHook: func(context.Context, dbutil.DB) ([]types.RepoName, error) {
				return nil, nil
			},
		},
	}
...
type DefaultRepoListerListFunc struct {
	defaultHook func(context.Context, dbutil.DB) ([]types.RepoName, error)
	hooks       []func(context.Context, dbutil.DB) ([]types.RepoName, error)
...
func (m *MockDefaultRepoLister) List(v0 context.Context, v1 dbutil.DB) ([]types.RepoName, error) {
	r0, r1 := m.ListFunc.nextHook()(v0, v1)
	m.ListFunc.appendCall(DefaultRepoListerListFuncCall{v0, v1, r0, r1})
	return r0, r1
}
...
// empty.
func (f *DefaultRepoListerListFunc) SetDefaultHook(hook func(context.Context, dbutil.DB) ([]types.RepoName, error)) {
	f.defaultHook = hook
}
...
func (f *DefaultRepoListerListFunc) PushHook(hook func(context.Context, dbutil.DB) ([]types.RepoName, error)) {
	f.mutex.Lock()
...
func (f *DefaultRepoListerListFunc) SetDefaultReturn(r0 []types.RepoName, r1 error) {
	f.SetDefaultHook(func(context.Context, dbutil.DB) ([]types.RepoName, error) {
		return r0, r1
	})
}
...
func (f *DefaultRepoListerListFunc) PushReturn(r0 []types.RepoName, r1 error) {
	f.PushHook(func(context.Context, dbutil.DB) ([]types.RepoName, error) {
		return r0, r1
	})
}

func (f *DefaultRepoListerListFunc) nextHook() func(context.Context, dbutil.DB) ([]types.RepoName, error) {
	f.mutex.Lock()
