...
=======
			&btypes.ChangesetSpec{BatchSpecID: batchSpec.ID, RepoID: repo1.ID, DiffStatAdded: 10, DiffStatDeleted: 10, Spec: &batcheslib.ChangesetSpec{ExternalID: "123"}},
			&btypes.ChangesetSpec{BatchSpecID: batchSpec.ID, RepoID: repo2.ID, DiffStatAdded: 20, DiffStatDeleted: 20, Spec: &batcheslib.ChangesetSpec{ExternalID: "123"}},
>>>>>>> 09c5a5bf2a (remove more references to changed)
		); err != nil {
			t.Fatal(err)
		}
