...
//go:generate ../../../../dev/mockgen.sh github.com/sourcegraph/sourcegraph/enterprise/internal/batches/sources -i ChangesetSource -i SourcerStore -o mock_ifaces_test.go
