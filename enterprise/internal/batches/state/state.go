...
func SetDerivedState(ctx context.Context, repoStore database.IRepoStore, c *btypes.Changeset, es []*btypes.ChangesetEvent) {
...
func changesetRepoName(ctx context.Context, repoStore database.IRepoStore, c *btypes.Changeset) (api.RepoName, error) {
