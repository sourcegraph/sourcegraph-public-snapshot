...
func (s *Store) GetGithubExternalIDForRefs(ctx context.Context, externalRepoID string, refs []string) ([]string, error) {
	queryFmtString := `
...
`
	...
	q := sqlf.Sprintf(queryFmtString, sqlf.Join(inClause, ","), externalRepoID)
