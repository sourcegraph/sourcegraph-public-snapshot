...
// for a campaign. But only if they have all been created, one for each CampaignJob belonging to the PatchSet attached to the Campaign. If not, it returns a zero time.Time.
