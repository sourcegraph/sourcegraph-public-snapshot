...
func (r *campaignResolver) SpecCreator(ctx context.Context) (*graphqlbackend.UserResolver, error) {
	spec, err := r.store.GetCampaignSpec(ctx, cstore.GetCampaignSpecOpts{
...
func (r *campaignResolver) ChangesetsStats(ctx context.Context) (graphqlbackend.ChangesetsStatsResolver, error) {
	stats, err := r.store.GetChangesetsStats(ctx, cstore.GetChangesetsStatsOpts{
...
func (r *campaignResolver) ChangesetCountsOverTime(
	...
	opts := cstore.ListChangesetsOpts{
		CampaignID:       r.Campaign.ID,
	...
	eventsOpts := cstore.ListChangesetEventsOpts{ChangesetIDs: cs.IDs(), Kinds: ee.RequiredEventTypesForHistory}
...
func (r *campaignResolver) CurrentSpec(ctx context.Context) (graphqlbackend.CampaignSpecResolver, error) {
	campaignSpec, err := r.store.GetCampaignSpec(ctx, cstore.GetCampaignSpecOpts{ID: r.Campaign.CampaignSpecID})
	if err != nil {
