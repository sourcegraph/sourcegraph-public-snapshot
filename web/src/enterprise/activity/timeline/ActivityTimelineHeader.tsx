...
/**
 * The header for the list of events.
 */
export const EventsListHeader: React.FunctionComponent<Props> = ({ location, className = '' }) => (
        ...
        <div className="flex-1 mr-5 d-flex">
            <div className="btn-group mb-3 mr-4" role="group">
                <Link to={`${location.pathname}/-/manage/activity`} className="btn btn-link">
                    <HistoryIcon className="icon-inline" /> Event
                </Link>
