...
/**
 * The filter control (dropdown and input field) for a list of thread changes.
 */
// tslint:disable: jsx-no-lambda
export const ThreadChangesItemsListFilter: React.FunctionComponent<Props> = ({ value, onChange, className }) => {
