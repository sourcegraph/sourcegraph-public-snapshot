...
/**
 * A button dropdown with filter options shown in the list of a thread's changes.
 */
export const ThreadChangesListHeaderFilterButtonDropdown: React.FunctionComponent<Props> = ({
    children,
    header,
    items,
}) => {
