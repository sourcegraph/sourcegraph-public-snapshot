...
const { fragment: eventFragment, query: eventQuery } = queryAndFragmentForUnion<
    GQL.ExpCampaignTimelineItem['__typename'],
    keyof GQL.ExpCampaignTimelineItem
>(
    [
...
type Result = typeof LOADING | GQL.IExpCampaignTimelineItemConnection | ErrorLike
 ...
 */
export const useCampaignTimelineItems = (campaign: Pick<GQL.IExpCampaign, 'id'>): [Result, () => void] => {
