...
describe('CampaignHeaderEditableName', () => {
    ...
    test('save', async () => {
        let resolve: (value: GQL.IExpCampaign) => void
        const updateCampaignResult = new Promise<GQL.IExpCampaign>(resolve_ => {
            resolve = resolve_
        })
        const e = create({
    ...
    test('error saving', async () => {
        ...
        const updateCampaignResult = new Promise<GQL.IExpCampaign>((_resolve, reject_) => {
            reject = reject_
        })
