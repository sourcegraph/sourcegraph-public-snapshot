...
export const NamespaceCampaignsArea: React.FunctionComponent<Props> = ({ ...props }) => {
    ...
    const removeHeader = (
        <style>
            {
                '.user-area-header, .org-header { display: none; } .org-area > .container, .user-area > .container { margin: unset; margin-top: unset !important; width: 100%; max-width: unset !important; padding: unset; } /* TODO!(sqs): hack */'
            }
        </style>
    )
