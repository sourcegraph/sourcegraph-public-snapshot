...
export interface SiteConfiguration {
  ...
  experimentalFeatures?: {
    ...
    /**
     * Enables a new update scheduler algorithm
     */
    updateScheduler2?: "enabled" | "disabled";
  };
  /**
...
export interface GitLabConnection {
  ...
  authorization?: {
    /**
     * Identifies the authentication provider to use to identify users to GitLab.
     */
    authnProvider: {
      /**
       * The value of the `configID` field of the targeted authentication provider.
       */
      configID: string;
      /**
       * The `type` field of the targeted authentication provider.
       */
      type: string;
      /**
