...
interface Props extends Omit<PatternTypeProps, 'setPatternType'>, OptionalAuthProps {
    location: H.Location
    history: H.History
    query?: string
    onDidCancel: () => void
    ...
    public render(): JSX.Element | null {
        return (
            this.props.authenticatedUser && (
                <Form onSubmit={this.onSubmit} className="saved-search-modal-form test-saved-search-modal">
