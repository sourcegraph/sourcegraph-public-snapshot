...
export type SettingsSubject = IUser | IOrg | ISite
...
export const enum RepositoryOrderBy {
    REPO_URI = 'REPO_URI',
...
export interface ICreateSavedQueryOnSettingsMutationArguments {
    description: string
    query: string
...
export interface IUpdateSavedQueryOnSettingsMutationArguments {
    id: ID
    description?: string | null
    query?: string | null
...
export interface IDeleteSavedQueryOnSettingsMutationArguments {
    id: ID
