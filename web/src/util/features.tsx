 ...
 */
export const showDotComMarketing = window.context ? window.context.sourcegraphDotComMode : false

/**
 * Whether the signup form should show terms and privacy policy links.
 */
export const signupTerms = window.context ? window.context.sourcegraphDotComMode : false
