...
export const lazyComponent = <P extends {}, K extends string>(
    componentFactory: () => Promise<{ [k in K]: React.ComponentType<P> | React.NamedExoticComponent<P> }>,
    name: K
    ...
    const LazyComponent = React.lazy(async () => {
        const component: React.ComponentType<P> | React.NamedExoticComponent<P> = (await componentFactory())[name]
