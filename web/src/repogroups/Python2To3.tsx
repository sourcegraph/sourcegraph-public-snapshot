...
export const python2To3Metadata: RepogroupMetadata = {
    ...
    examples: [
        ...
        },
        {
            ...
            description: `In Python 2, the division operator / rounds down the result to the nearest integer. To get a floating point number, you need to convert
    ...
    homepageDescription: 'Searches and suggestions to help migrate your code Python 3.',
    homepageIcon:
