...
export const android: RepogroupMetadata = {
    ...
    examples: [
        ...
        },
        {
            ...
            exampleQuery:
                '<span class="repogroup-page__keyword-text">file:</span>.kt .setOnClickListener {:[function]}',
        ...
        },
        {
            ...
            exampleQuery:
                '<span class="repogroup-page__keyword-text">lang:</span>.xml <intent-filter> :[string] </intent-filter>',
        ...
        },
        {
            ...
            exampleQuery:
                '<span class="repogroup-page__keyword-text">file:</span>xml <LinearLayout :[0] <LinearLayout :[1] </LinearLayout> :[2] </LinearLayout>',
