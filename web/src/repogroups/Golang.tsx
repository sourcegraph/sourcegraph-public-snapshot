    ...
    examples: [
        {
            ...
            exampleQuery: (
                <>
                    <span className="web-content__search-keyword">lang:</span>go{' '}
                    <span className="web-content__search-keyword">-file:</span>
                    vendor/ Retry-After
                </>
            ),
        ...
        },
        {
            ...
            exampleQuery: (
                <>
                    <span className="web-content__search-keyword">lang:</span>go http.Post json
                </>
            ),
        ...
        },
        {
            ...
            exampleQuery: (
                <>
                    {'if err != nil {:[_]}'} <span className="web-content__search-keyword">lang:</span>go
                </>
            ),
        ...
        },
        {
            ...
            exampleQuery: (
                <>
                    <span className="web-content__search-keyword">lang:go</span> cmp.Diff(:[_], :[_], :[opts])
                </>
            ),
        ...
        },
        {
            ...
            exampleQuery: (
                <>
                    ...
                    <span className="web-content__search-keyword">-file:</span>vendor{' '}
                    <span className="web-content__search-keyword">lang:</span>go
                </>
            ),
