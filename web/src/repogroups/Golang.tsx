    ...
    examples: [
        {
            ...
            exampleQuery: (
                <>
                    <span className="web-content__link">lang:</span>go <span className="web-content__link">-file:</span>
                    vendor/ Retry-After
                </>
            ),
        ...
        },
        {
            ...
            exampleQuery: (
                <>
                    <span className="web-content__link">lang:</span>go http.Post json
                </>
            ),
        ...
        },
        {
            ...
            exampleQuery: (
                <>
                    {'if err != nil {:[_]}'} <span className="web-content__link">lang:</span>go
                </>
            ),
        ...
        },
        {
            ...
            exampleQuery: (
                <>
                    <span className="web-content__link">lang:go</span> cmp.Diff(:[_], :[_], :[opts])
                </>
            ),
        ...
        },
        {
            ...
            exampleQuery: (
                <>
                    ...
                    <span className="web-content__link">-file:</span>vendor{' '}
                    <span className="web-content__link">lang:</span>go
                </>
            ),
        ...
        },
        {
            ...
            exampleQuery: (
                <>
                    {'switch :[_] := :[_].(type) { :[string] }'} <span className="web-content__link">lang:</span>go{' '}
                </>
            ),
