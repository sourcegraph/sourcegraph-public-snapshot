...
import { ShadowRoot } from '../../../shared/src/components/ShadowRoot'
...
import navLinkStyles from './NavLinks.scss'
...
export class NavLinks extends React.PureComponent<Props> {
    public render(): JSX.Element | null {
        return (
            <ShadowRoot className="nav-links" css={[globalStyles, navLinkStyles]}>
                <ul className="nav align-items-center pl-2 pr-1">
