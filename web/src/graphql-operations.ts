...
export type RepositoryIDResult = { repository: Maybe<{ id: string }> }
...
export type CreateChangesetResult = { createChangesets: Array<{ id: string }> }
...
export type AddChangeSetToCampaignResult = { addChangesetsToCampaign: { id: string } }
...
export type CampaignFields = {
    ...
    status: { completedCount: number; pendingCount: number; state: BackgroundProcessState; errors: Array<string> }
...
export type UpdateCampaignResult = { updateCampaign: CampaignFields }

export type CreateCampaignVariables = Exact<{
    input: CreateCampaignInput
}>

export type CreateCampaignResult = { createCampaign: { id: string; url: string } }

export type RetryCampaignChangesetsVariables = Exact<{
    campaign: Scalars['ID']
}>

export type RetryCampaignChangesetsResult = { retryCampaignChangesets: CampaignFields }

export type PublishCampaignChangesetsVariables = Exact<{
    campaign: Scalars['ID']
}>

export type PublishCampaignChangesetsResult = { publishCampaignChangesets: CampaignFields }
...
export type CloseCampaignResult = { closeCampaign: { id: string } }
...
export type DeleteCampaignResult = { deleteCampaign: Maybe<{ alwaysNil: Maybe<string> }> }
...
export type PublishChangesetResult = { publishChangeset: { alwaysNil: Maybe<string> } }
...
export type CampaignsResult = {
    campaigns: {
        ...
        nodes: Array<{
            ...
            createdAt: string
            closedAt: Maybe<string>
            changesets: { totalCount: number; nodes: Array<{ state: ChangesetState } | { state: ChangesetState }> }
            patches: { totalCount: number }
        }>
    }
}
...
export type CampaignsCountResult = { campaigns: { totalCount: number } }
