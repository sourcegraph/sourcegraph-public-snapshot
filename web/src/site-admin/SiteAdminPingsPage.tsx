                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>Total count of campaign changesets generated by actions</li>
                            <li>Total count of campaign changesets generated by actions that have been merged</li>
                            <li>Total count of campaign changesets manually added to a campaign</li>
                            <li>
                                Total count of campaign changesets manually added to a campaign that have been merged
                            </li>
                        </ul>
                    </li>
                </ul>
