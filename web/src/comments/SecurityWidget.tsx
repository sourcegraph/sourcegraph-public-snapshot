...
export const SecurityWidget: React.SFC<{ isPublic: boolean }> = ({ isPublic }) =>
    isPublic ? (
        ...
        <div className="security-widget">
            ...
            <div className="security-widget__extended-help">Only members of your organization can view this page.</div>
        </div>
    )
