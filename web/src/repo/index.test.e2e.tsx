...
describe('Repository component', () => {
    const host = process.env.SOURCEGRAPH_HOST || 'localhost'
    ...
    const getTooltipDoc = async (): Promise<string> => {
        ...
        return (await chrome.evaluate(() => document.querySelector('.tooltip__doc')!.textContent)) as string
    }
    ...
    describe('external code host links', () => {
        it('on line blame', async () => {
            ...
            await chrome.wait('.repository__viewer > div > table > tbody')
