...
const extensionRegistryNodes: RegistryExtensionFieldsForList[] = [
    {
        id:
            'UmVnaXN0cnlFeHRlbnNpb246eyJyIjp7InIiOiJodHRwczovL3NvdXJjZWdyYXBoLmNvbS8uYXBpL3JlZ2lzdHJ5IiwidSI6IjM2YjQ0MjEwLTFjNzktNDg0ZC1iNmZkLThiNzg1M2ZiYTYwNiJ9fQ==',
        publisher: null,
...
describe('Extension Registry', () => {
    ...
    describe('toggling', () => {
        ...
        //     latestSettings: { id: number; contents: string }
        // } {
        //     return {
        //         __typename: 'User',
        //         id: 'TestGQLUserID',
        ...
        it('a disabled extension enables it', async () => {
            ...
            // gql: EditSettings, then ViewerSettings. assert that EditSettings is called with the right args
            // assert that sourcegraph/typescript is now enabled

            const vars = await testContext.waitForGraphQLRequest(async () => {
            ...
            assert.deepStrictEqual(vars.edit.keyPath, [
                { property: 'extensions' },
                { property: 'sourcegraph/typescript' },
            ])
            // await driver.page.keyboard.press(String.fromCharCode(13))
