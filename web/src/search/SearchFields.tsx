    ...
    public render(): JSX.Element | null {
        return (
            <div className="search-fields">
                <div className="search-fields__header">
                    <h3 className="search-fields__header-input">Search in...</h3>
                    <h3 className="search-fields__header-example">Shortcut</h3>
                </div>
                <div className="search-fields__row">
                    <label className="search-fields__row-label" htmlFor="search-fields__repo">
                        Repositories:
                    </label>
                    <div className="search-fields__row-input">
                        <input
                            id="search-fields__repo"
                            className="form-control search-fields__input"
                            spellCheck={false}
                            autoCapitalize="off"
                            placeholder=""
                    ...
                    <div
                        className="search-fields__row-example"
                ...
                <div className="search-fields__row">
                    <label className="search-fields__row-label" htmlFor="search-fields__file">
                        File paths:
                    </label>
                    <div className="search-fields__row-input">
                        <input
                            id="search-fields__file"
                            className="form-control search-fields__input"
                            spellCheck={false}
                            autoCapitalize="off"
                            placeholder=""
                ...
                <div className="search-fields__header">
                    <h3 className="search-fields__header-input">Match...</h3>
                </div>
                <div className="search-fields__row">
                    <label className="search-fields__row-label" htmlFor="search-fields__patterns">
                        Patterns:
                    </label>
                    <div className="search-fields__row-input">
                        <input
                            id="search-fields__patterns"
                            className="form-control search-fields__input"
                            spellCheck={false}
                            autoCapitalize="off"
                            placeholder=""
                ...
                <div className="search-fields__row">
                    <label className="search-fields__row-label" htmlFor="search-fields__quoted-term">
                        Exact string:
                    </label>
                    <div className="search-fields__row-input">
                        <input
                            id="search-fields__quoted-term"
                            className="form-control search-fields__input"
                            spellCheck={false}
                            autoCapitalize="off"
                            placeholder=""
                ...
                <div className="search-fields__row">
                    <label className="search-fields__row-label" htmlFor="search-fields__case">
                        Case sensitive?
                    </label>
                    <div className="search-fields__row-input">
                        <select
                            id="search-fields__case"
                            className="form-control search-fields__input search-fields__input-select"
                    ...
                    <div className="search-fields__row-example">case:yes</div>
                </div>
            </div>
        )
    }
