                        ...
                        <div>
                            ...
                            <div className="search-page__lang-list mt-3">
                                <dl>
                                    ...
                                    <dd className="text-monospace"><p>repo:my/repo</p></dd>
                                    <dd className="text-monospace"><p>repo:github.com/myorg/</p></dd>
                                    <dd className="text-monospace"><p>file:my/file</p></dd>
                                    <dd className="text-monospace"><p>lang:javascript</p></dd>
                                </dl>
                                <dl>
                                    <dt className="search-page__help-content-subheading">
                                        <h5>Diff/commit search keywords</h5>
                                    </dt>
                                    <dd className="text-monospace"><p>type:diff or type:commit</p></dd>
                                    <dd className="text-monospace"><p>after:”2 weeks ago”</p></dd>
                                    <dd className="text-monospace"><p>author:alice@example.com</p></dd>{' '}
                                    <dd className="text-monospace"><p>repo:r@*refs/heads/ (all branches)</p></dd>
                                </dl>
                                <dl>
                                    <dt className="search-page__help-content-subheading">
