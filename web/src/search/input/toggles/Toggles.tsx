    ...
    return (
        <div className={classNames('toggle-container', className)}>
            ...
            <QueryInputToggle
                ...
                className="e2e-case-sensitivity-toggle ga-case-sensitivity-toggle"
            ...
            <QueryInputToggle
                ...
                icon={RegexIcon}
                className="e2e-regexp-toggle ga-regexp-toggle"
            ...
            {!structuralSearchDisabled && (
                <QueryInputToggle
                    ...
                    className="e2e-structural-search-toggle ga-structural-search-toggle"
