        ...
        return (
            <div className="search">
                ...
                <div className="search__nav">
                    {!window.context.user && (
                        <a href="https://about.sourcegraph.com" className="search__nav-link">
                            About
                        </a>
                    )}
                ...
                <div className="search__search-box-container">
                    ...
                    <button
                        type="button"
                        className={
                            'btn btn-icon search__help-button' +
                            (this.state.helpVisible ? ' search__help-button--active' : '')
                        }
                    ...
                    <div
                        className={
                            'search__instructions' + (this.state.helpVisible ? ' search__instructions--open' : '')
                        }
                    >
                        <button
                            type="button"
                            className="btn btn-icon search__instructions-close-button"
                            onClick={this.hideHelp}
                        >
                            <CloseIcon />
                        </button>
                        <div className="search__instruction-row">
                            <div className="search__explanation">Go to the repository github.com/gorilla/mux</div>
                            <div className="search__instruction">
                                gorilla/mux <kbd>tab</kbd> <kbd>enter</kbd>
                            </div>
                        </div>
                        <div className="search__instruction-row">
                            <div className="search__explanation">Go to the file route.go in that repository</div>
                            <div className="search__instruction">
                                gorilla/mux <kbd>tab</kbd> route.go <kbd>tab</kbd> <kbd>enter</kbd>
                            </div>
                        </div>
                        <div className="search__instruction-row">
                            <div className="search__explanation">Search a single repository for the term "route"</div>
                            <div className="search__instruction">
                                gorilla/mux <kbd>tab</kbd> route <kbd>enter</kbd>
                            </div>
                        </div>
                        <div className="search__instruction-row">
                            <div className="search__explanation">Search multiple repositories for the term "route"</div>
                            <div className="search__instruction">
                                gorilla/mux <kbd>tab</kbd> kubernetes/kubernetes <kbd>tab</kbd> route <kbd>enter</kbd>
                            </div>
                        </div>
                        <div className="search__instruction-row">
                            <div className="search__explanation">Search the "Kubernetes" repository group</div>
                            <div className="search__instruction">
                                Kubernetes <kbd>tab</kbd> route <kbd>enter</kbd>
                            </div>
                        </div>
                        <div className="search__instruction-row">
                            <div className="search__explanation">Search all .go files for "route"</div>
                            <div className="search__instruction">
                        ...
                        <div className="search__instruction-row">
                            ...
                            <div className="search__instruction">
                                aws/aws-sdk-go <kbd>tab</kbd>
                                {/* prettier can't format this document without wrapping /** in '' */}
                                {' !vendor/** '}
                                <kbd>tab</kbd> session <kbd>enter</kbd>
                            </div>
                        </div>
                        <div className="search__instruction-row">
                            <div className="search__explanation">
                            ...
                            <div className="search__instruction">
                                gorilla/mux <kbd>tab</kbd> type .+ struct <kbd>{shortcutMofidier}</kbd>+<kbd>R</kbd>{' '}
                                <kbd>enter</kbd>
                            </div>
                        </div>
                    </div>
