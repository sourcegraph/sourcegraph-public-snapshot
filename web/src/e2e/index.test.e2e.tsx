    ...
    describe('Repository component', () => {
        ...
        describe('rev resolution', () => {
            ...
            it('updates rev with switcher', async () => {
                ...
                await page.waitForSelector('.git-ref-node a[href*="0.1.0"]')
                await page.click('.git-ref-node a[href*="0.1.0"]')
        ...
        describe('external code host links', () => {
            it('on line blame', async () => {
                ...
                await enableOrAddRepositoryIfNeeded()
                await page.waitForSelector('[data-e2e="blob"] > table > tbody > tr:nth-child(19) .blame')
                await page.evaluate(() => {
                    const blame = document.querySelector('[data-e2e="blob"] > table > tbody > tr:nth-child(19) .blame')!
