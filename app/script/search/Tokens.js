...
function renderToken(tok, query) {
	...
	var html = "<p class=\"" + tok._label + " " + typ + "\"><span class=\"main-icon octicon octicon-" + data.icon + "\"></span> <span class=\"title\">" + escapeHTML(title) + "</span> <span class=\"more\">" + escapeHTML(more) + "</span></p>";
