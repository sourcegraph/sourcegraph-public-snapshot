...
describe("CodeFileController", () => {
	it("should handle unavailable file", () => {
		CodeStore.handle(new CodeActions.SetFile("aRepo", "aRev", "aTree", undefined));
	...
	it("should handle available file", () => {
		CodeStore.handle(new CodeActions.SetFile("aRepo", "aRev", "aTree", {Entry: {SourceCode: {Lines: ["someLine"]}}}));
