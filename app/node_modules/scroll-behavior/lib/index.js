...
function withScroll(history, shouldUpdateScroll) {
  ...
  function listen(listener) {
    if (listeners.length === 0) {
      scrollBehavior = new _ScrollBehavior2.default(history, getCurrentLocation, shouldUpdateScroll);
