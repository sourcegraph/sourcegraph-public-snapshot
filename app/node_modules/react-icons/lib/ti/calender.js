...
var TiCalender = function (_React$Component) {
    _inherits(TiCalender, _React$Component);

    function TiCalender() {
        _classCallCheck(this, TiCalender);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(TiCalender).apply(this, arguments));
    }

    _createClass(TiCalender, [{
        key: 'render',
