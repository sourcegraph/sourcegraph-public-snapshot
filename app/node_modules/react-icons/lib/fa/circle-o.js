...
var FaCircleO = function (_React$Component) {
    _inherits(FaCircleO, _React$Component);

    function FaCircleO() {
        _classCallCheck(this, FaCircleO);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaCircleO).apply(this, arguments));
    }

    _createClass(FaCircleO, [{
        key: 'render',
