...
var FaSearchMinus = function (_React$Component) {
    _inherits(FaSearchMinus, _React$Component);

    function FaSearchMinus() {
        _classCallCheck(this, FaSearchMinus);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(FaSearchMinus).apply(this, arguments));
    }

    _createClass(FaSearchMinus, [{
        key: 'render',
