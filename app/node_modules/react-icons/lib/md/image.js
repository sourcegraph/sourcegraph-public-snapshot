...
var MdImage = function (_React$Component) {
    _inherits(MdImage, _React$Component);

    function MdImage() {
        _classCallCheck(this, MdImage);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdImage).apply(this, arguments));
    }

    _createClass(MdImage, [{
        key: 'render',
