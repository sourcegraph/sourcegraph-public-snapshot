...
var MdPhone = function (_React$Component) {
    _inherits(MdPhone, _React$Component);

    function MdPhone() {
        _classCallCheck(this, MdPhone);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdPhone).apply(this, arguments));
    }

    _createClass(MdPhone, [{
        key: 'render',
