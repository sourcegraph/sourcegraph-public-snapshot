...
var MdWbCloudy = function (_React$Component) {
    _inherits(MdWbCloudy, _React$Component);

    function MdWbCloudy() {
        _classCallCheck(this, MdWbCloudy);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdWbCloudy).apply(this, arguments));
    }

    _createClass(MdWbCloudy, [{
        key: 'render',
