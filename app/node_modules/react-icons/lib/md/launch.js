...
var MdLaunch = function (_React$Component) {
    _inherits(MdLaunch, _React$Component);

    function MdLaunch() {
        _classCallCheck(this, MdLaunch);

        return _possibleConstructorReturn(this, Object.getPrototypeOf(MdLaunch).apply(this, arguments));
    }

    _createClass(MdLaunch, [{
        key: 'render',
