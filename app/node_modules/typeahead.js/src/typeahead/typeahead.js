...
var Typeahead = (function() {
  ...
  function Typeahead(o, www) {
    var onSelectableClicked, onSelectableMouseEnter, onSelectableMouseLeave,
        onDatasetRendered, onDatasetCleared, onFocused,
    ...
    .onSync('selectableMouseEnter', onSelectableMouseEnter, this)
    .onSync('selectableMouseLeave', onSelectableMouseLeave, this)
    ...
    _updateHint: function updateHint() {
      ...
      if (data && !_.isBlankString(val) && !this.input.hasOverflow()) {
        ...
        if (data.obj && data.obj.hints) {
          // find the shortest matching hint
          var hint;
