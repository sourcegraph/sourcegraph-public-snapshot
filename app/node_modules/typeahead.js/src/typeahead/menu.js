...
var Menu = (function() {
  ...
  _.mixin(Menu.prototype, EventEmitter, {
    ...
    _onSelectableMouseEnter: function onSelectableMouseEnter($e) {
      this.trigger('selectableMouseEnter', $($e.currentTarget));
    },

    _onSelectableMouseLeave: function onSelectableMouseLeave() {
      this.trigger('selectableMouseLeave');
    },
    ...
    bind: function() {
    var that = this, onSelectableClick, onSelectableMouseEnter, onSelectableMouseLeave;

      onSelectableClick = _.bind(this._onSelectableClick, this);
      this.$node.on('click.tt', this.selectors.selectable, onSelectableClick);
      onSelectableMouseEnter = _.bind(this._onSelectableMouseEnter, this);
      this.$node.on('mouseenter.tt', this.selectors.selectable, onSelectableMouseEnter);
      onSelectableMouseLeave = _.bind(this._onSelectableMouseLeave, this);
      this.$node.on('mouseleave.tt', this.selectors.selectable, onSelectableMouseLeave);
