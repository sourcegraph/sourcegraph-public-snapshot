...
if (typeof window !== "undefined" && window.__PushPromises) {
	...
	setTimeout(() => {
		...
		if (unused.length > 0) {
			console.warn(`Warning: detected unused push promise URL(s). The following push promises generated by the server may be formatted incorrectly or unnecessary:\n${unused.join("\n")}`);
		}
	}, 6 * 1000);
}
