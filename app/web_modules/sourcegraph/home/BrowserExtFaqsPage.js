	...
	render() {
		...
		return (
			<div>
				...
				<div styleName="faqs-content">
					<div styleName="faqs-div">
					...
					<div styleName={hash === "#signin" ? "faqs-div-selected" : "faqs-div"}>
					...
					<a id="build"/>
					<div styleName={hash === "#build" ? "faqs-div-selected" : "faqs-div"}>
