...
require (
	...
	github.com/sourcegraph/managed-services-platform-cdktf/gen/sentry v0.0.0-20240513135716-8702bd2752fb
...
require (
	...
	github.com/sourcegraph/zoekt v0.0.0-20240514170004-fe8f2a3d9cab
