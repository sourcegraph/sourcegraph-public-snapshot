...
replace (
	...
	github.com/google/zoekt => github.com/sourcegraph/zoekt v0.0.0-20211018100733-604df7db4253
...
replace (
	...
	github.com/shurcooL/httpgzip => github.com/sourcegraph/httpgzip v0.0.0-20211018083453-5380005fefa5
)
