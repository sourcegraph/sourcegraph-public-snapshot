...
func changesetHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "changeset.html", size: 118, mode: os.FileMode(420), modTime: time.Unix(1444704208, 0)}
...
func listHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "list.html", size: 1765, mode: os.FileMode(420), modTime: time.Unix(1444757132, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
