...
declare module 'sourcegraph' {
    ...
    export class WorkspaceEdit {
         ...
         *
         * @returns A shallow copy of `[URL, TextEdit[]]`-tuples.
         */
    ...
    export namespace workspace {
         ...
         * @returns A promise that resolves to the opened [document](#TextDocument).
         */
    ...
    export interface CodeActionProvider {
         ...
         * @returns An array of commands, quick fixes, or refactorings or an observable of such. The
