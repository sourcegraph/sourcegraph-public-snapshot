...
declare module 'sourcegraph' {
    ...
    export interface CompletionItem {
        /**
         * The label of this completion item. If no {@link CompletionItem#insertText} is specified,
         * the label is the text inserted when the user selects this completion.
         */
        label: string
