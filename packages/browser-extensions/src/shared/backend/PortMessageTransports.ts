...
import { Message } from '@sourcegraph/extensions-client-common/lib/api/protocol/jsonrpc2/messages'
import {
    ...
    MessageReader,
    MessageWriter,
} from '@sourcegraph/extensions-client-common/lib/api/protocol/jsonrpc2/transport'
