...
export class Services {
    ...
    public readonly contribution = new ContributionRegistry(this.editor.model, this.settings, this.context.data)
    public readonly extensions = new ExtensionsService(this.platformContext, this.editor.model, this.settings)
