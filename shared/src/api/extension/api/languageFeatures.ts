...
export class ExtLanguageFeatures {
    constructor(private proxy: Remote<ClientLanguageFeaturesAPI>, private documents: ExtDocuments) {}
    ...
    public registerLocationProvider(
        ...
        return syncSubscription(
            this.proxy.$registerLocationProvider(idStr, fromDocumentSelector(selector), proxy(providerFunction))
        )
    }
