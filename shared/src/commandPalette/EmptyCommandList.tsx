...
export const EmptyCommandList: React.FunctionComponent<Props> = ({ settingsCascade, sourcegraphURL }) => {
    ...
    return (
        <div className="empty-command-list">
            ...
            <span className="empty-command-list__illustration">{puzzleIllustration}</span>
        </div>
    )
}
