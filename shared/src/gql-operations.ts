...
export interface SharedGQLOperations {
    ...
    ExternalServicesForTests: /* src/testing/driver.ts */ (
        input: ExternalServicesForTestsInput
    ) => ExternalServicesForTestsOutput
    ...
    UpdateSiteConfigurationForTests: /* src/testing/driver.ts */ (
        input: UpdateSiteConfigurationForTestsInput
    ) => UpdateSiteConfigurationForTestsOutput
    ...
    OverwriteSettingsForTests: /* src/testing/driver.ts */ (
        input: OverwriteSettingsForTestsInput
