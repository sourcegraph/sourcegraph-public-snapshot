		...
		Groups: []Group{
					...
					{
						{
							...
							Query:             `histogram_quantile(0.99, sum by (le)(rate(src_code_intel_db_duration_seconds_bucket{job="precise-code-intel-converter"}[5m])))`,
							DataMayNotExist:   true,
							DataMayBeNaN:      true,
							Warning:           Alert{GreaterOrEqual: 20},
						...
						},
						{
							...
							Query:             `increase(src_code_intel_db_errors_total{job="precise-code-intel-converter"}[5m])`,
							DataMayNotExist:   true,
							Warning:           Alert{GreaterOrEqual: 20},
			...
			},
			{
				...
				Rows: []Row{
					{
						{
							...
							Query:             `histogram_quantile(0.99, sum by (le,category)(rate(src_precise_code_intel_bundle_manager_request_duration_seconds_bucket{job="precise-code-intel-converter",category="transfer"}[5m])))`,
							DataMayNotExist:   true,
							DataMayBeNaN:      true,
						...
						},
						{
							...
							Query:             `sum by (category)(increase(src_precise_code_intel_bundle_manager_request_duration_seconds_count{job="precise-code-intel-converter",code!~"2.."}[5m]))`,
							DataMayNotExist:   true,
							Warning:           Alert{GreaterOrEqual: 5},
					...
					{
						{
							...
							Query:             `histogram_quantile(0.99, sum by (le,category)(rate(src_gitserver_request_duration_seconds_bucket{job="precise-code-intel-converter"}[5m])))`,
							DataMayNotExist:   true,
							DataMayBeNaN:      true,
							Warning:           Alert{GreaterOrEqual: 20},
							PanelOptions:      PanelOptions().LegendFormat("{{category}}").Unit(Seconds),
						...
						},
						{
							...
							Query:             `sum by (category)(increase(src_gitserver_request_duration_seconds_count{job="precise-code-intel-converter",code!~"2.."}[5m]))`,
							DataMayNotExist:   true,
							Warning:           Alert{GreaterOrEqual: 5},
							PanelOptions:      PanelOptions().LegendFormat("{{category}}"),
							PossibleSolutions: "none",
					...
					{
						sharedFrontendInternalAPIErrorResponses("precise-code-intel-converter"),
					},
				},
			},
			{
				...
				Rows: []Row{
					{
						sharedContainerRestarts("precise-code-intel-converter"),
						sharedContainerMemoryUsage("precise-code-intel-converter"),
						sharedContainerCPUUsage("precise-code-intel-converter"),
					},
				},
			},
		},
