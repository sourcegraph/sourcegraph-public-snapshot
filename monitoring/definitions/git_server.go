		...
		Groups: []monitoring.Group{
			{
				...
				Rows: []monitoring.Row{
					...
					},
					{
						...
						shared.FrontendInternalAPIErrorResponses("gitserver", monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.ContainerCPUUsage("gitserver", monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ContainerMemoryUsage("gitserver", monitoring.ObservableOwnerCoreApp).Observable(),
					},
					{
						shared.ContainerMissing("gitserver", monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ContainerIOUsage("gitserver", monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.ProvisioningCPUUsageLongTerm("gitserver", monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ProvisioningMemoryUsageLongTerm("gitserver", monitoring.ObservableOwnerCoreApp).
							WithNoAlerts(`Git Server is expected to use up all the memory it is provided.`).
							Observable(),
					},
					{
						shared.ProvisioningCPUUsageShortTerm("gitserver", monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ProvisioningMemoryUsageShortTerm("gitserver", monitoring.ObservableOwnerCoreApp).
							WithNoAlerts(`Git Server is expected to use up all the memory it is provided.`).
							Observable(),
					},
				},
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.GoGoroutines("gitserver", monitoring.ObservableOwnerCoreApp).Observable(),
						shared.GoGcDuration("gitserver", monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.KubernetesPodsAvailable("gitserver", monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
		},
