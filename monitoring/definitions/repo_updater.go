					...
					{
						{
							...
							Query:          `src_repoupdater_perms_syncer_success_syncs{type="user"}`,
							Panel:          monitoring.Panel().LegendFormat("{{type}}").Unit(monitoring.Number),
							Owner:          monitoring.ObservableOwnerRepoManagement,
							NoAlert:        true,
						...
						},
						{
							...
							Description:    "number of user permissions syncs [10m]",
							Query:          `rate(src_repoupdater_perms_syncer_success_syncs{type="user"}[10m]) * 10`,
							Panel:          monitoring.Panel().LegendFormat("{{type}}").Unit(monitoring.Number),
							Owner:          monitoring.ObservableOwnerRepoManagement,
							NoAlert:        true,
							Interpretation: "Indicates the number of users permissions syncs completed in last minute.",
						},
						{
							Name:           "user_initial_syncs",
							Description:    "number of first user permissions syncs [10m]",
							Query:          `rate(src_repoupdater_perms_syncer_initial_syncs{type="user"}[10m]) * 10`,
							Panel:          monitoring.Panel().LegendFormat("{{type}}").Unit(monitoring.Number),
							Owner:          monitoring.ObservableOwnerRepoManagement,
							NoAlert:        true,
							Interpretation: "Indicates the number of permissions syncs done for the first time for the user in last minute.",
						},
					},
					{

						{
							...
							Query:          `src_repoupdater_perms_syncer_success_syncs{type="repo"}`,
							Panel:          monitoring.Panel().LegendFormat("{{type}}").Unit(monitoring.Number),
							Owner:          monitoring.ObservableOwnerRepoManagement,
							NoAlert:        true,
						...
						},
						{
							...
							Description:    "number of repo permissions syncs [10m]",
							Query:          `rate(src_repoupdater_perms_syncer_success_syncs{type="repo"}[10m]) * 10`,
							Panel:          monitoring.Panel().LegendFormat("{{type}}").Unit(monitoring.Number),
							Owner:          monitoring.ObservableOwnerRepoManagement,
							NoAlert:        true,
							Interpretation: "Indicates the number of repos permissions syncs completed in last minute.",
						},
						{
							Name:           "repo_initial_syncs",
							Description:    "number of first repo permissions syncs [10m]",
							Query:          `rate(src_repoupdater_perms_syncer_initial_syncs{type="repo"}[10m]) * 10`,
							Panel:          monitoring.Panel().LegendFormat("{{type}}").Unit(monitoring.Number),
							Owner:          monitoring.ObservableOwnerRepoManagement,
							NoAlert:        true,
							Interpretation: "Indicates the number of permissions syncs done for the first time for the repo in last minute.",
						},
					},
					{
						{
							Name:           "users_consecutive_sync_delay",
							Description:    "max duration between two consecutive permissions sync for user (minutes) [10m]",
							Query:          `max_over_time (src_repoupdater_perms_syncer_perms_consecutive_sync_delay{type="user"} [10m]) / 60.0`,
							Panel:          monitoring.Panel().LegendFormat("{{type}}").Unit(monitoring.Number),
							Owner:          monitoring.ObservableOwnerRepoManagement,
							NoAlert:        true,
						...
						},
						{
							...
							Description:    "max duration between two consecutive permissions sync for repo (minutes) [10m]",
							Query:          `max_over_time (src_repoupdater_perms_syncer_perms_consecutive_sync_delay{type="repo"} [10m]) / 60.0`,
							Panel:          monitoring.Panel().LegendFormat("{{type}}").Unit(monitoring.Number),
							Owner:          monitoring.ObservableOwnerRepoManagement,
							NoAlert:        true,
					...
					{
						{
							...
							Description:    "max duration between user creation and first permissions sync (minutes) [10m]",
							Query:          `max_over_time (src_repoupdater_perms_syncer_perms_first_sync_delay{type="user"} [10m]) / 60.0`,
							Panel:          monitoring.Panel().LegendFormat("{{type}}").Unit(monitoring.Number),
							Owner:          monitoring.ObservableOwnerRepoManagement,
							NoAlert:        true,
						...
						},
						{
							...
							Description:    "max duration between repo creation and first permissions sync (minutes) [10m]",
							Query:          `max_over_time (src_repoupdater_perms_syncer_perms_first_sync_delay{type="repo"} [10m]) / 60.0`,
							Panel:          monitoring.Panel().LegendFormat("{{type}}").Unit(monitoring.Number),
							Owner:          monitoring.ObservableOwnerRepoManagement,
							NoAlert:        true,
