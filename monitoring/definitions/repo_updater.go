					...
					{
						{
							...
							Description:    "max duration between two consecutive permissions sync for user [1m]",
							Query:          `max(max_over_time (src_repoupdater_perms_syncer_perms_consecutive_sync_delay{type="user"} [1m]) / 60.0)`,
							Panel:          monitoring.Panel().LegendFormat("minutes").Unit(monitoring.Minutes),
							Owner:          monitoring.ObservableOwnerIAM,
							NoAlert:        true,
						...
						},
						{
							...
							Description:    "max duration between two consecutive permissions sync for repo [1m]",
					...
					{
						{
							...
							Description:    "max duration between user creation and first permissions sync [1m]",
						...
						},
						{
							...
							Description:    "max duration between repo creation and first permissions sync [1m]",
