		...
		Groups: []monitoring.Group{
			{
				...
				Rows: []monitoring.Row{
					{
						shared.FrontendInternalAPIErrorResponses("repo-updater", monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
			{
					...
					{
						{
							...
							Owner:       monitoring.ObservableOwnerCoreApp,
							Interpretation: `
			...
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.ContainerCPUUsage("repo-updater", monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ContainerMemoryUsage("repo-updater", monitoring.ObservableOwnerCoreApp).
							WithWarning(nil).
							WithCritical(monitoring.Alert().GreaterOrEqual(90)).
							Observable(),
					},
					{
						shared.ContainerMissing("repo-updater", monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.ProvisioningCPUUsageLongTerm("repo-updater", monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ProvisioningMemoryUsageLongTerm("repo-updater", monitoring.ObservableOwnerCoreApp).Observable(),
					},
					{
						shared.ProvisioningCPUUsageShortTerm("repo-updater", monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ProvisioningMemoryUsageShortTerm("repo-updater", monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.GoGoroutines("repo-updater", monitoring.ObservableOwnerCoreApp).Observable(),
						shared.GoGcDuration("repo-updater", monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.KubernetesPodsAvailable("repo-updater", monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
		},
