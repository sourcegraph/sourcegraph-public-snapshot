...
// Collection of ordered monitoring.Observable vars for the "Repositories" monitoring.Group
var (
	syncerSyncLastTime = monitoring.Observable{
	...
	srcRepoUpdaterMaxSyncBackoff = monitoring.Observable{
	...
	srcRepoUpdaterSyncerSyncErrorsTotal = monitoring.Observable{
	...
	syncerSyncStart = monitoring.Observable{
	...
	syncerSyncDuration = monitoring.Observable{
	...
	sourceDuration = monitoring.Observable{
	...
	syncerSyncedRepos = monitoring.Observable{
	...
	sourcedRepos = monitoring.Observable{
		Name:              "sourced_repos",
	...
	userAddedRepos = monitoring.Observable{
	...
	purgeFailed = monitoring.Observable{
		Name:              "purge_failed",
	...
	schedAutoFetch = monitoring.Observable{
	...
	schedManualFetch = monitoring.Observable{
	...
	schedKnownRepos = monitoring.Observable{
	...
	schedUpdateQueueLength = monitoring.Observable{
	...
	schedLoops = monitoring.Observable{
		Name:              "sched_loops",
	...
	schedError = monitoring.Observable{
		Name:              "sched_error",
...
// Collection of ordered monitoring.Observable vars for the "Permissions" monitoring.Group
var (
	permsSyncerPerms = monitoring.Observable{
	...
	permsSyncerStalePerms = monitoring.Observable{
	...
	permsSyncerNoPerms = monitoring.Observable{
	...
	permsSyncerSyncDuration = monitoring.Observable{
	...
	permsSyncerQueueSize = monitoring.Observable{
	...
	permsSyncerSyncErrors = monitoring.Observable{
...
// Collection of ordered monitoring.Observable vars for the "External services" monitoring.Group
var (
	srcRepoupdaterExternalServicesTotal = monitoring.Observable{
	...
	srcRepoupdaterUserExternalServicesTotal = monitoring.Observable{
	...
	repoupdaterQueuedSyncJobsTotal = monitoring.Observable{
	...
	repoupdaterCompletedSyncJobsTotal = monitoring.Observable{
	...
	repoupdaterErroredSyncJobsPercentage = monitoring.Observable{
	...
	githubGraphqlRateLimitRemaining = monitoring.Observable{
	...
	githubRestRateLimitRemaining = monitoring.Observable{
	...
	githubSearchRateLimitRemaining = monitoring.Observable{
	...
	githubGraphqlRateLimitWaitDuration = monitoring.Observable{Name: "github_graphql_rate_limit_wait_duration",
	...
	githRestRateLimitWaitDuration = monitoring.Observable{
	...
	githubSearchRateLimitWaitDuration = monitoring.Observable{
	...
	gitlabRestRateLimitRemaining = monitoring.Observable{
	...
	gitlabRestRateLimitWaitDuration = monitoring.Observable{
		...
		Groups: []monitoring.Group{
			{
				Title: "Repositories",
				Rows: []monitoring.Row{
					{syncerSyncLastTime, srcRepoUpdaterMaxSyncBackoff, srcRepoUpdaterSyncerSyncErrorsTotal},
					{syncerSyncStart, syncerSyncDuration, sourceDuration},
					{syncerSyncedRepos, sourcedRepos, userAddedRepos},
					{purgeFailed},
					{schedAutoFetch, schedManualFetch},
					{schedKnownRepos, schedUpdateQueueLength, schedLoops},
					{schedError},
				},
			},
			{
				...
				Hidden: true,
				Rows: []monitoring.Row{
					{permsSyncerPerms, permsSyncerStalePerms, permsSyncerNoPerms},
					{permsSyncerSyncDuration, permsSyncerQueueSize},
					{permsSyncerSyncErrors},
				},
			},
			{
				...
				Hidden: true,
				Rows: []monitoring.Row{
					{srcRepoupdaterExternalServicesTotal, srcRepoupdaterUserExternalServicesTotal},
					{repoupdaterQueuedSyncJobsTotal, repoupdaterCompletedSyncJobsTotal, repoupdaterErroredSyncJobsPercentage},
					{githubGraphqlRateLimitRemaining, githubRestRateLimitRemaining, githubSearchRateLimitRemaining},
					{githubGraphqlRateLimitWaitDuration, githRestRateLimitWaitDuration, githubSearchRateLimitWaitDuration},
					{gitlabRestRateLimitRemaining, gitlabRestRateLimitWaitDuration},
				},
			},
