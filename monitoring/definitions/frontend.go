	...
	return &monitoring.Container{
		...
		Groups: []monitoring.Group{
			...
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.ContainerCPUUsage(containerName, monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ContainerMemoryUsage(containerName, monitoring.ObservableOwnerCoreApp).Observable(),
					},
					{
						shared.ContainerMissing(containerName, monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.ProvisioningCPUUsageLongTerm(containerName, monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ProvisioningMemoryUsageLongTerm(containerName, monitoring.ObservableOwnerCoreApp).Observable(),
					},
					{
						shared.ProvisioningCPUUsageShortTerm(containerName, monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ProvisioningMemoryUsageShortTerm(containerName, monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.GoGoroutines(containerName, monitoring.ObservableOwnerCoreApp).Observable(),
						shared.GoGcDuration(containerName, monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.KubernetesPodsAvailable(containerName, monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
		},
