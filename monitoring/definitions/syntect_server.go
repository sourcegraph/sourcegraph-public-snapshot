	...
	return &monitoring.Container{
		...
		Groups: []monitoring.Group{
			...
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.ContainerCPUUsage("syntect-server", monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ContainerMemoryUsage("syntect-server", monitoring.ObservableOwnerCoreApp).Observable(),
					},
					{
						shared.ContainerMissing("syntect-server", monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.ProvisioningCPUUsageLongTerm("syntect-server", monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ProvisioningMemoryUsageLongTerm("syntect-server", monitoring.ObservableOwnerCoreApp).Observable(),
					},
					{
						shared.ProvisioningCPUUsageShortTerm("syntect-server", monitoring.ObservableOwnerCoreApp).Observable(),
						shared.ProvisioningMemoryUsageShortTerm("syntect-server", monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
			{
				...
				Rows: []monitoring.Row{
					{
						shared.KubernetesPodsAvailable("syntect-server", monitoring.ObservableOwnerCoreApp).Observable(),
					},
				},
			},
		},
