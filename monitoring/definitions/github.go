		...
		Groups: []monitoring.Group{
			{
				...
				Rows: []monitoring.Row{
					...
					},
					{
						...
						{
							Name:           "src_github_concurrency_lock_acquire_duration_seconds_latency_p75",
							Description:    "75 percentile latency of src_github_concurrency_lock_acquire_duration_seconds",
