				...
				Rows: []monitoring.Row{
					{
						...
						},
						{
							...
							Description:    "number of requests uncached",
							Query:          `increase(github_proxy_uncached_rest_requests[5m])`,
							Panel:          monitoring.Panel().LegendFormat("number of uncached requests"),
							Owner:          monitoring.ObservableOwnerRepoManagement,
							NoAlert:        true,
						...
						},
						{
							...
							Description:    "number of requests cached",
							Query:          `increase(github_proxy_cached_rest_requests[5m])`,
							Panel:          monitoring.Panel().LegendFormat("number of cached requests"),
							Owner:          monitoring.ObservableOwnerRepoManagement,
							NoAlert:        true,
							Interpretation: "do it",
						},
