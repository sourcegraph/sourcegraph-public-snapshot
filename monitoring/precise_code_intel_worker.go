					...
					{
						{
							...
							PanelOptions:      NewPanelOptions().LegendFormat("uploads queued for processing"),
						...
						},
						{
							...
							PanelOptions:      NewPanelOptions().LegendFormat("upload queue growth rate"),
							PossibleSolutions: "none",
						},
						{
					...
					{
						{
							...
							DataMayNotExist:   true,
							Warning:           Alert{GreaterOrEqual: 20},
							PanelOptions:      NewPanelOptions().LegendFormat("uploads"),
							PossibleSolutions: "none",
						},
						{
