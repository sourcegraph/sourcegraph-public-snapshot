				...
				Rows: []Row{
							...
							Alerts: []Alert{
								{
									...
									GreaterOrEqual: Threshold(float32(time.Hour.Seconds())),
									For:            5 * time.Minute,
								},
							},
							...
							Alerts: []Alert{
								{
									...
									GreaterOrEqual: Threshold(float32(syncDurationThreshold.Seconds())),
									For:            10 * time.Minute,
								},
							},
							PanelOptions: PanelOptions().Unit(Seconds),
					...
					},
					{
						Observable{
							...
							DataMayNotExist:   true,
							Alerts:            []Alert{{Level: AlertLevelWarning, LessOrEqual: Threshold(0), For: syncDurationThreshold}},
						...
						Observable{
							...
							DataMayNotExist:   true,
							Alerts:            []Alert{{Level: AlertLevelWarning, GreaterOrEqual: Threshold(30), For: 5 * time.Minute}},
					...
					},
					{
						...
						Observable{
							...
							Alerts:            []Alert{{Level: AlertLevelCritical, GreaterOrEqual: Threshold(200000 * 0.9), For: 5 * time.Minute}},
							PanelOptions:      PanelOptions().Unit(Number),
							Owner:             ObservableOwnerCloud,
					...
					},
					{
						Observable{
							...
							DataMayNotExist:   true,
							Alerts:            []Alert{{Level: AlertLevelWarning, GreaterOrEqual: Threshold(0), For: 5 * time.Minute}},
							PanelOptions:      PanelOptions().Unit(Number),
							Owner:             ObservableOwnerCloud,
					...
					},
					{
						Observable{
							...
							DataMayNotExist:   true,
							Alerts:            []Alert{{Level: AlertLevelWarning, LessOrEqual: Threshold(0), For: 10 * time.Minute}},
							PanelOptions:      PanelOptions().Unit(Number),
							Owner:             ObservableOwnerCloud,
							PossibleSolutions: "Check repo-updater logs. This is expected to fire if there are no user added code hosts",
						},
						Observable{
							...
							Alerts:            []Alert{{Level: AlertLevelCritical, GreaterOrEqual: Threshold(0), For: 30 * time.Minute}},
							PanelOptions:      PanelOptions().Unit(Number),
							Owner:             ObservableOwnerCloud,
					...
					},
					{
						Observable{
							...
							DataMayNotExist:   true,
							Alerts:            []Alert{{Level: AlertLevelCritical, GreaterOrEqual: Threshold(1), For: time.Minute}},
							PanelOptions:      PanelOptions().Unit(Number),
							Owner:             ObservableOwnerCloud,
							PossibleSolutions: "Check repo-updater logs for errors",
						},
				...
				Rows: []Row{
					{
						Observable{
							...
							Alerts: []Alert{
								{
									Level:          AlertLevelWarning,
									GreaterOrEqual: Threshold(float32((3 * 24 * time.Hour).Seconds())), // 3 days
									For:            5 * time.Minute,
								},
							},
						...
						Observable{
							...
							DataMayNotExist:   true,
							Alerts:            []Alert{{Level: AlertLevelWarning, GreaterOrEqual: Threshold(100), For: 5 * time.Minute}},
				...
				Rows: []Row{
					{
						Observable{
							...
							DataMayNotExist:   true,
							Alerts:            []Alert{{Level: AlertLevelCritical, GreaterOrEqual: Threshold(20000), For: 1 * time.Hour}},
							PanelOptions:      PanelOptions().Unit(Number),
							Owner:             ObservableOwnerCloud,
						...
						Observable{
							...
							DataMayNotExist:   true,
							Alerts:            []Alert{{Level: AlertLevelWarning, GreaterOrEqual: Threshold(20000), For: 1 * time.Hour}},
							PanelOptions:      PanelOptions().Unit(Number),
							Owner:             ObservableOwnerCloud,
							PossibleSolutions: "Check for spikes in external services, could be abuse",
						},
					},
					{
						Observable{
							...
							DataMayNotExist: true,
							Alerts:          []Alert{{Level: AlertLevelWarning, GreaterOrEqual: Threshold(100), For: 1 * time.Hour}},
							PanelOptions:    PanelOptions().Unit(Number),
							Owner:           ObservableOwnerCloud,
							PossibleSolutions: `
						...
						Observable{
							...
							DataMayNotExist:   true,
							Alerts:            []Alert{{Level: AlertLevelWarning, GreaterOrEqual: Threshold(100000), For: 1 * time.Hour}},
							PanelOptions:      PanelOptions().Unit(Number),
							Owner:             ObservableOwnerCloud,
