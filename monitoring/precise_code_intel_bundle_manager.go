					...
					{
						{
							...
							PanelOptions:      NewPanelOptions().LegendFormat("database operation").Unit(Seconds),
						...
						},
						{
							...
							DataMayNotExist:   true,
							Warning:           Alert{GreaterOrEqual: 20},
							PanelOptions:      NewPanelOptions().LegendFormat("database operation"),
							PossibleSolutions: "none",
						},
					},
					{
						{
							...
							DataMayBeNaN:      true,
							Warning:           Alert{GreaterOrEqual: 20},
							PanelOptions:      NewPanelOptions().LegendFormat("reader operation").Unit(Seconds),
							PossibleSolutions: "none",
						},
						{
							...
							DataMayNotExist:   true,
							Warning:           Alert{GreaterOrEqual: 20},
							PanelOptions:      NewPanelOptions().LegendFormat("reader operation"),
							PossibleSolutions: "none",
						},
					},
					{
				...
				Rows: []Row{
					{
						{
							...
							DataMayNotExist:   true,
							Warning:           Alert{GreaterOrEqual: 20},
							PanelOptions:      NewPanelOptions().LegendFormat("errors"),
							PossibleSolutions: "none",
						},
						{
							...
							DataMayNotExist:   true,
							Warning:           Alert{GreaterOrEqual: 20},
							PanelOptions:      NewPanelOptions().LegendFormat("files removed"),
							PossibleSolutions: "none",
						},
						{
					...
					},
					{
						...
						},
						{
							...
							DataMayNotExist:   true,
							Warning:           Alert{GreaterOrEqual: 20},
							PanelOptions:      NewPanelOptions().LegendFormat("records removed"),
							PossibleSolutions: "none",
						},
					},
				},
					...
					{
						{
							...
							PanelOptions:      NewPanelOptions().LegendFormat("{{cache}}").Unit(Percentage),
							PossibleSolutions: "none",
						},
						{
