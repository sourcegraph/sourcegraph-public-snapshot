					...
					{
						{
							...
							PanelOptions:      NewPanelOptions().LegendFormat("error"),
						...
						},
						{
							...
							DataMayNotExist:   true,
							Warning:           Alert{GreaterOrEqual: 5},
							PanelOptions:      NewPanelOptions().LegendFormat("panic"),
							PossibleSolutions: "none",
						},
					},
					{
						{
							...
							DataMayNotExist:   true,
							Warning:           Alert{GreaterOrEqual: 5},
							PanelOptions:      NewPanelOptions().LegendFormat("timeout"),
							PossibleSolutions: "none",
						},
						{
							...
							PanelOptions:      NewPanelOptions().LegendFormat("worker death"),
							PossibleSolutions: "none",
						},
					},
				},
