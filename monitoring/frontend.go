					...
					{
						{
							...
							Critical:          Alert{GreaterOrEqual: 20, For: 15 * time.Minute},
						...
						},
						{
							...
							DataMayNotExist: true,
							Warning:         Alert{GreaterOrEqual: 25, For: 15 * time.Minute},
				...
				Rows: []Row{
					{
						...
						},
						{
							...
							DataMayNotExist:   true,
							Warning:           Alert{GreaterOrEqual: 10, For: 15 * time.Minute},
