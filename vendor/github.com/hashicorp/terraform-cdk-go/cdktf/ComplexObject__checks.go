...
func validateNewComplexObjectParameters(terraformResource IInterpolatingParent, terraformAttribute *string, complexObjectIsFromSet *bool, complexObjectIndex interface{}) error {
	...
	switch complexObjectIndex.(type) {
	case *string:
		// ok
	case string:
		// ok
	...
	case uint64:
		// ok
	default:
		return fmt.Errorf("parameter complexObjectIndex must be one of the allowed types: *string, *float64; received %#v (a %T)", complexObjectIndex, complexObjectIndex)
	}
