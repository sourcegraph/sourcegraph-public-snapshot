...
func (j *jsiiProxy_DataResource) validateSetConnectionParameters(val interface{}) error {
	switch val.(type) {
	case *SSHProvisionerConnection:
		val := val.(*SSHProvisionerConnection)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case SSHProvisionerConnection:
		val_ := val.(SSHProvisionerConnection)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case *WinrmProvisionerConnection:
		val := val.(*WinrmProvisionerConnection)
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	case WinrmProvisionerConnection:
		val_ := val.(WinrmProvisionerConnection)
		val := &val_
		if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
			return err
		}
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *SSHProvisionerConnection, *WinrmProvisionerConnection; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_DataResource) validateSetCountParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: *float64, TerraformCount; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_DataResource) validateSetProvisionersParameters(val *[]interface{}) error {
	for idx_97dfc6, v := range *val {
		...
		case FileProvisioner:
			v_ := v.(FileProvisioner)
			v := &v_
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
			}
		case *LocalExecProvisioner:
			v := v.(*LocalExecProvisioner)
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
			}
		case LocalExecProvisioner:
			v_ := v.(LocalExecProvisioner)
			v := &v_
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
			}
		case *RemoteExecProvisioner:
			v := v.(*RemoteExecProvisioner)
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
			}
		case RemoteExecProvisioner:
			v_ := v.(RemoteExecProvisioner)
			v := &v_
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter val[%#v]", idx_97dfc6) }); err != nil {
				return err
			}
		default:
			if !_jsii_.IsAnonymousProxy(v) {
				return fmt.Errorf("parameter val[%#v] must be one of the allowed types: *FileProvisioner, *LocalExecProvisioner, *RemoteExecProvisioner; received %#v (a %T)", idx_97dfc6, v, v)
			}
		}
	}
