...
func (u *Upstream) sendUpdate(params zap.RefUpdateUpstreamParams) error {
	...
	case u.Buf != nil:
		...
		case u.Buf.Ops != nil:
			var err error
			buf, err := ot.Compose(nil, u.Buf.Ops, params.Ops)
			if err != nil {
				return err
			}
			u.Buf.Ops = buf
...
func (u *Upstream) recvFromUpstream(params *RefUpdate) error {
	...
	case params.Ops != nil:
		...
		if u.Wait != nil && u.Wait.Ops != nil {
			var err error
			if u.Wait.Ops, params.Ops, err = ot.Transform(nil, u.Wait.Ops, params.Ops); err != nil {
				return err
			}
		}
		if u.Buf != nil && u.Buf.Ops != nil {
			var err error
			if u.Buf.Ops, params.Ops, err = ot.Transform(nil, u.Buf.Ops, params.Ops); err != nil {
				return err
			}
		}
		u.Rev++
