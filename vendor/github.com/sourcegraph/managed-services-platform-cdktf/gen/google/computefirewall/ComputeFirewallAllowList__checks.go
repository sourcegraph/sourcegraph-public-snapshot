...
func (j *jsiiProxy_ComputeFirewallAllowList) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *[]*ComputeFirewallAllow; received %#v (a %T)", val, val)
		}
	}
