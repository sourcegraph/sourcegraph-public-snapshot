...
type ComputeUrlMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelay struct {
	// fixed_delay block.
	//
	...
	FixedDelay *ComputeUrlMapPathMatcherDefaultRouteActionFaultInjectionPolicyDelayFixedDelay `field:"optional" json:"fixedDelay" yaml:"fixedDelay"`
