...
func (c *jsiiProxy_CloudRunV2JobConditionsList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_CloudRunV2JobConditionsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_CloudRunV2JobConditionsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
