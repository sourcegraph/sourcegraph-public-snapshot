...
// Represents a {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.12.0/docs/data-sources/ip_ranges cloudflare_ip_ranges}.
...
type jsiiProxy_DataCloudflareIpRanges struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataCloudflareIpRanges) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataCloudflareIpRanges) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataCloudflareIpRanges) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataCloudflareIpRanges) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataCloudflareIpRanges) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataCloudflareIpRanges) Node() constructs.Node {
...
func (j *jsiiProxy_DataCloudflareIpRanges) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataCloudflareIpRanges) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataCloudflareIpRanges) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/cloudflare/cloudflare/4.12.0/docs/data-sources/ip_ranges cloudflare_ip_ranges} Data Source.
func NewDataCloudflareIpRanges(scope constructs.Construct, id *string, config *DataCloudflareIpRangesConfig) DataCloudflareIpRanges {
	...
	if err := validateNewDataCloudflareIpRangesParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (d *jsiiProxy_DataCloudflareIpRanges) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareIpRanges) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataCloudflareIpRanges) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataCloudflareIpRanges) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataCloudflareIpRanges) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataCloudflareIpRanges) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataCloudflareIpRanges) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataCloudflareIpRanges) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataCloudflareIpRanges) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataCloudflareIpRanges) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataCloudflareIpRanges) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataCloudflareIpRanges) ToString() *string {
	var returns *string
