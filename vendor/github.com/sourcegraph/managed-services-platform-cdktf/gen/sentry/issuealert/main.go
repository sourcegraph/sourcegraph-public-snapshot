...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "filterMatch", GoGetter: "FilterMatch"},
			_jsii_.MemberProperty{JsiiProperty: "filterMatchInput", GoGetter: "FilterMatchInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFilterMatch", GoMethod: "ResetFilterMatch"},
