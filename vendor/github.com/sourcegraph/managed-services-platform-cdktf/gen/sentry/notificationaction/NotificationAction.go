...
type jsiiProxy_NotificationAction struct {
	internal.Type__cdktfTerraformResource
}

func (j *jsiiProxy_NotificationAction) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_NotificationAction) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_NotificationAction) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_NotificationAction) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NotificationAction) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_NotificationAction) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_NotificationAction) IntegrationId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"integrationId",
...
func (j *jsiiProxy_NotificationAction) IntegrationIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"integrationIdInput",
...
func (j *jsiiProxy_NotificationAction) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NotificationAction) Node() constructs.Node {
...
func (j *jsiiProxy_NotificationAction) Organization() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organization",
...
func (j *jsiiProxy_NotificationAction) OrganizationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"organizationInput",
...
func (j *jsiiProxy_NotificationAction) Projects() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"projects",
...
func (j *jsiiProxy_NotificationAction) ProjectsInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"projectsInput",
...
func (j *jsiiProxy_NotificationAction) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_NotificationAction) ServiceType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceType",
...
func (j *jsiiProxy_NotificationAction) ServiceTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceTypeInput",
...
func (j *jsiiProxy_NotificationAction) TargetDisplay() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetDisplay",
...
func (j *jsiiProxy_NotificationAction) TargetDisplayInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetDisplayInput",
...
func (j *jsiiProxy_NotificationAction) TargetIdentifier() *string {
	var returns *string
	_jsii_.Get(
		j,
		"targetIdentifier",
...
func (j *jsiiProxy_NotificationAction) TargetIdentifierInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NotificationAction) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_NotificationAction) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NotificationAction) TriggerType() *string {
	var returns *string
	_jsii_.Get(
		j,
		"triggerType",
...
func (j *jsiiProxy_NotificationAction) TriggerTypeInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"triggerTypeInput",
...
func NewNotificationAction(scope constructs.Construct, id *string, config *NotificationActionConfig) NotificationAction {
	...
	if err := validateNewNotificationActionParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NotificationAction) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NotificationAction) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (n *jsiiProxy_NotificationAction) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (n *jsiiProxy_NotificationAction) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (n *jsiiProxy_NotificationAction) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (n *jsiiProxy_NotificationAction) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (n *jsiiProxy_NotificationAction) GetStringAttribute(terraformAttribute *string) *string {
...
func (n *jsiiProxy_NotificationAction) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (n *jsiiProxy_NotificationAction) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NotificationAction) OverrideLogicalId(newLogicalId *string) {
...
func (n *jsiiProxy_NotificationAction) ResetIntegrationId() {
	_jsii_.InvokeVoid(
		n,
		"resetIntegrationId",
		nil, // no parameters
...
func (n *jsiiProxy_NotificationAction) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		n,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (n *jsiiProxy_NotificationAction) ResetTargetDisplay() {
	_jsii_.InvokeVoid(
		n,
		"resetTargetDisplay",
		nil, // no parameters
...
func (n *jsiiProxy_NotificationAction) ResetTargetIdentifier() {
	_jsii_.InvokeVoid(
		n,
		"resetTargetIdentifier",
		nil, // no parameters
...
func (n *jsiiProxy_NotificationAction) ToString() *string {
	var returns *string
