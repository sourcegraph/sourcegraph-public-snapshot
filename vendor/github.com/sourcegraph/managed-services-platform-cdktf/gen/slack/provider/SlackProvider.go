...
import (
	...
	"github.com/sourcegraph/managed-services-platform-cdktf/gen/slack/provider/internal"
)

// Represents a {@link https://registry.terraform.io/providers/pablovarela/slack/1.2.2/docs slack}.
...
type jsiiProxy_SlackProvider struct {
	internal.Type__cdktfTerraformProvider
}

func (j *jsiiProxy_SlackProvider) Alias() *string {
	var returns *string
	_jsii_.Get(
		j,
		"alias",
...
func (j *jsiiProxy_SlackProvider) AliasInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"aliasInput",
...
func (j *jsiiProxy_SlackProvider) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_SlackProvider) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_SlackProvider) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_SlackProvider) Node() constructs.Node {
...
func (j *jsiiProxy_SlackProvider) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_SlackProvider) TerraformProviderSource() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SlackProvider) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_SlackProvider) Token() *string {
	var returns *string
	_jsii_.Get(
		j,
		"token",
...
func (j *jsiiProxy_SlackProvider) TokenInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"tokenInput",
...
func NewSlackProvider(scope constructs.Construct, id *string, config *SlackProviderConfig) SlackProvider {
	...
	if err := validateNewSlackProviderParameters(scope, id, config); err != nil {
		panic(err)
	}
...
// Create a new {@link https://registry.terraform.io/providers/pablovarela/slack/1.2.2/docs slack} Resource.
func NewSlackProvider_Override(s SlackProvider, scope constructs.Construct, id *string, config *SlackProviderConfig) {
	_init_.Initialize()
...
func SlackProvider_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-slack.provider.SlackProvider",
...
func (s *jsiiProxy_SlackProvider) OverrideLogicalId(newLogicalId *string) {
...
func (s *jsiiProxy_SlackProvider) ResetAlias() {
	_jsii_.InvokeVoid(
		s,
		"resetAlias",
		nil, // no parameters
...
func (s *jsiiProxy_SlackProvider) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		s,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (s *jsiiProxy_SlackProvider) ToString() *string {
	var returns *string
