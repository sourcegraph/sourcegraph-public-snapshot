...
type jsiiProxy_DataOpsgenieTeam struct {
	internal.Type__cdktfTerraformDataSource
}

func (j *jsiiProxy_DataOpsgenieTeam) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataOpsgenieTeam) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataOpsgenieTeam) Description() *string {
	var returns *string
	_jsii_.Get(
		j,
		"description",
...
func (j *jsiiProxy_DataOpsgenieTeam) DescriptionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"descriptionInput",
...
func (j *jsiiProxy_DataOpsgenieTeam) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataOpsgenieTeam) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataOpsgenieTeam) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataOpsgenieTeam) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataOpsgenieTeam) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataOpsgenieTeam) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataOpsgenieTeam) Member() DataOpsgenieTeamMemberList {
	var returns DataOpsgenieTeamMemberList
	_jsii_.Get(
		j,
		"member",
		&returns,
...
func (j *jsiiProxy_DataOpsgenieTeam) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataOpsgenieTeam) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_DataOpsgenieTeam) Node() constructs.Node {
...
func (j *jsiiProxy_DataOpsgenieTeam) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataOpsgenieTeam) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataOpsgenieTeam) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewDataOpsgenieTeam(scope constructs.Construct, id *string, config *DataOpsgenieTeamConfig) DataOpsgenieTeam {
	...
	if err := validateNewDataOpsgenieTeamParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func DataOpsgenieTeam_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-opsgenie.dataOpsgenieTeam.DataOpsgenieTeam",
...
func (d *jsiiProxy_DataOpsgenieTeam) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOpsgenieTeam) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataOpsgenieTeam) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataOpsgenieTeam) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataOpsgenieTeam) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataOpsgenieTeam) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataOpsgenieTeam) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataOpsgenieTeam) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataOpsgenieTeam) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataOpsgenieTeam) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataOpsgenieTeam) ResetDescription() {
	_jsii_.InvokeVoid(
		d,
		"resetDescription",
		nil, // no parameters
...
func (d *jsiiProxy_DataOpsgenieTeam) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOpsgenieTeam) ResetMember() {
	_jsii_.InvokeVoid(
		d,
		"resetMember",
		nil, // no parameters
...
func (d *jsiiProxy_DataOpsgenieTeam) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataOpsgenieTeam) ToString() *string {
	var returns *string
