...
func (a *jsiiProxy_ApiIntegration) validatePutRespondersParameters(value interface{}) error {
	...
	case *[]*ApiIntegrationResponders:
		value := value.(*[]*ApiIntegrationResponders)
	...
	case []*ApiIntegrationResponders:
		value_ := value.([]*ApiIntegrationResponders)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ApiIntegrationResponders; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ApiIntegration) validateSetHeadersParameters(val *map[string]*string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_ApiIntegration) validateSetOwnerTeamIdParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_ApiIntegration) validateSetTypeParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func (j *jsiiProxy_ApiIntegration) validateSetWebhookUrlParameters(val *string) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
