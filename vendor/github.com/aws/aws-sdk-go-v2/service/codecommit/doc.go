...
//
// * UpdateApprovalRuleTemplateContent, which
// updates the content of an approval rule template.
//
// Comments in a repository, by
// calling the following:
//
// * DeleteCommentContent, which deletes the content of a
// comment on a commit in a repository.
//
// * GetComment, which returns information
// about a comment on a commit.
//
// * GetCommentReactions, which returns information
// about emoji reactions to comments.
//
// * GetCommentsForComparedCommit, which
// returns information about comments on the comparison between two commit
// specifiers in a repository.
//
// * PostCommentForComparedCommit, which creates a
// comment on the comparison between two commit specifiers in a repository.
//
// *
...
//
// * UpdateComment, which
// updates the content of a comment on a commit in a repository.
//
// Tags used to tag
...
//
// * TagResource, which adds or
// updates tags for a resource in AWS CodeCommit.
//
