...
// Validate checks the field values on ObjectOrUserset with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *ObjectOrUserset) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on ObjectOrUserset with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// ObjectOrUsersetMultiError, or nil if none found.
func (m *ObjectOrUserset) ValidateAll() error {
	return m.validate(true)
}

func (m *ObjectOrUserset) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	case *ObjectOrUserset_Object:
		...
		if all {
			...
			case interface{ ValidateAll() error }:
				if err := v.ValidateAll(); err != nil {
					errors = append(errors, ObjectOrUsersetValidationError{
						field:  "Object",
						reason: "embedded message failed validation",
						cause:  err,
					})
			...
			if err := v.Validate(); err != nil {
				return ObjectOrUsersetValidationError{
					field:  "Object",
					reason: "embedded message failed validation",
					cause:  err,
				}
	...
	if len(errors) > 0 {
		return ObjectOrUsersetMultiError(errors)
	}

	return nil
}

// ObjectOrUsersetMultiError is an error wrapping multiple validation errors
// returned by ObjectOrUserset.ValidateAll() if the designated constraints
// aren't met.
type ObjectOrUsersetMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m ObjectOrUsersetMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m ObjectOrUsersetMultiError) AllErrors() []error { return m }

// ObjectOrUsersetValidationError is the validation error returned by
// ObjectOrUserset.Validate if the designated constraints aren't met.
type ObjectOrUsersetValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e ObjectOrUsersetValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e ObjectOrUsersetValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e ObjectOrUsersetValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e ObjectOrUsersetValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e ObjectOrUsersetValidationError) ErrorName() string { return "ObjectOrUsersetValidationError" }

// Error satisfies the builtin error interface
func (e ObjectOrUsersetValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sObjectOrUserset.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = ObjectOrUsersetValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = ObjectOrUsersetValidationError{}
