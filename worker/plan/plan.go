...
func Create(configYAML string, droneYMLFileExists bool, inv *inventory.Inventory, srclibImportURL, srclibValidateURL *url.URL) (string, []matrix.Axis, error) {
	...
	if err := configureSrclib(inv, config, axes, srclibImportURL, srclibValidateURL); err != nil {
		return "", nil, err
	}
