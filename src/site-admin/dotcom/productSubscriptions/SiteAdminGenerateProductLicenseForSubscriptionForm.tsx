                    ...
                    <Form onSubmit={this.onSubmit}>
                        <div className="form-group">
                            ...
                            <small className="form-text text-muted">
                                Tags restrict a license. Leave empty for full Sourcegraph Enterprise. Recognized tags:
                                <code>starter</code> (Enterprise Starter), <code>trial</code> (shows a "trial"
                                indicator), <code>dev</code> (shows a "for development only" indicator). Separate
                                multiple with commas and no spaces (like <code>starter,trial</code>
