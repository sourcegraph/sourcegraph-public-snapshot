...
Sourcegraph OSS is available freely under the [Apache 2 license](LICENSE.apache). Sourcegraph OSS comprises all files in that repository except those in the `enterprise/` and `web/src/enterprise` directories.
