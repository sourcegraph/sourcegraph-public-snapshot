...
- Try it out on any open-source repository at [sourcegraph.com](https://sourcegraph.com/github.com/golang/go/-/blob/src/net/http/httptest/httptest.go#L41:6&tab=references).
...
- Spin up your own Sourcegraph instance with the [quickstart installation guide](https://about.sourcegraph.com/docs).
