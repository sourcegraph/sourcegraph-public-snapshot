...
const (
	IndexedSearchConfigurationService_SearchConfiguration_FullMethodName = "/frontend.indexedsearch.v1.IndexedSearchConfigurationService/SearchConfiguration"
	IndexedSearchConfigurationService_List_FullMethodName                = "/frontend.indexedsearch.v1.IndexedSearchConfigurationService/List"
	IndexedSearchConfigurationService_RepositoryRank_FullMethodName      = "/frontend.indexedsearch.v1.IndexedSearchConfigurationService/RepositoryRank"
	IndexedSearchConfigurationService_DocumentRanks_FullMethodName       = "/frontend.indexedsearch.v1.IndexedSearchConfigurationService/DocumentRanks"
	IndexedSearchConfigurationService_UpdateIndexStatus_FullMethodName   = "/frontend.indexedsearch.v1.IndexedSearchConfigurationService/UpdateIndexStatus"
)
