CREATE TABLE IF NOT EXISTS tenants (
    ...
    name citext UNIQUE NOT NULL CONSTRAINT tenant_name_max_length CHECK (char_length(name::text) <= 32) CONSTRAINT tenant_name_valid_chars CHECK (name ~ '^[a-zA-Z](?:[a-zA-Z0-9-])*$'::citext),
