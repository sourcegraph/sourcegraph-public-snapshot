...
ALTER TABLE IF EXISTS ONLY changesets DROP CONSTRAINT IF EXISTS changesets_previous_spec_id_fkey;
ALTER TABLE IF EXISTS ONLY changesets DROP CONSTRAINT IF EXISTS changesets_owned_by_campaign_id_fkey;
ALTER TABLE IF EXISTS ONLY changesets DROP CONSTRAINT IF EXISTS changesets_changeset_spec_id_fkey;
ALTER TABLE IF EXISTS ONLY changeset_specs DROP CONSTRAINT IF EXISTS changeset_specs_user_id_fkey;
ALTER TABLE IF EXISTS ONLY changeset_specs DROP CONSTRAINT IF EXISTS changeset_specs_repo_id_fkey;
ALTER TABLE IF EXISTS ONLY changeset_specs DROP CONSTRAINT IF EXISTS changeset_specs_campaign_spec_id_fkey;
...
ALTER TABLE IF EXISTS ONLY campaigns DROP CONSTRAINT IF EXISTS campaigns_last_applier_id_fkey;
ALTER TABLE IF EXISTS ONLY campaigns DROP CONSTRAINT IF EXISTS campaigns_initial_applier_id_fkey;
ALTER TABLE IF EXISTS ONLY campaigns DROP CONSTRAINT IF EXISTS campaigns_campaign_spec_id_fkey;
ALTER TABLE IF EXISTS ONLY campaign_specs DROP CONSTRAINT IF EXISTS campaign_specs_user_id_fkey;
...
DROP INDEX IF EXISTS lsif_uploads_visible_at_tip_repository_id;
...
DROP INDEX IF EXISTS lsif_nearest_uploads_repository_id_commit;
...
DROP INDEX IF EXISTS campaign_specs_rand_id;
...
ALTER TABLE IF EXISTS ONLY secrets DROP CONSTRAINT IF EXISTS secrets_pkey;
...
ALTER TABLE IF EXISTS ONLY lsif_dirty_repositories DROP CONSTRAINT IF EXISTS lsif_dirty_repositories_pkey;
...
ALTER TABLE IF EXISTS ONLY changeset_specs DROP CONSTRAINT IF EXISTS changeset_specs_pkey;
...
ALTER TABLE IF EXISTS ONLY campaign_specs DROP CONSTRAINT IF EXISTS campaign_specs_pkey;
...
ALTER TABLE IF EXISTS secrets ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS changeset_specs ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS campaign_specs ALTER COLUMN id DROP DEFAULT;
...
DROP TABLE IF EXISTS lsif_uploads_visible_at_tip;
...
DROP TABLE IF EXISTS lsif_nearest_uploads;
...
DROP TABLE IF EXISTS lsif_dirty_repositories;
...
DROP SEQUENCE IF EXISTS changeset_specs_id_seq;
...
DROP SEQUENCE IF EXISTS campaign_specs_id_seq;
...
ALTER TABLE ONLY changesets
    ADD CONSTRAINT changesets_owned_by_campaign_id_fkey FOREIGN KEY (owned_by_campaign_id) REFERENCES campaigns(id) DEFERRABLE;
