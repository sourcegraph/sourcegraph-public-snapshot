...
ALTER TABLE batch_spec_executions ADD COLUMN last_updated_at timestamp with time zone;
...
ALTER TABLE lsif_dependency_indexing_jobs ADD COLUMN last_updated_at timestamp with time zone;
