...
ALTER TABLE lsif_data_docs_search_current_public ADD COLUMN IF NOT EXISTS last_cleanup_scan_at TIMESTAMP WITH TIME ZONE  DEFAULT NOW();
...
-- Restore old last_cleanup_scan_at column
ALTER TABLE lsif_data_docs_search_current_private ADD COLUMN IF NOT EXISTS last_cleanup_scan_at TIMESTAMP WITH TIME ZONE  DEFAULT NOW();
