...
var langRepos_ = map[string][]string{
	...
	"JavaScript": []string{
		...
		"github.com/mohebifar/lebab",
		"github.com/koistya/react-static-boilerplate",
		"github.com/sgaurav/understanding-es6",
		"github.com/decaffeinate/decaffeinate",
		"github.com/filipedeschamps/rss-feed-emitter",
		"github.com/douglasduteil/isparta",
		"github.com/jrowny/react-absolute-grid",
		"github.com/angular/watchtower.js",
		"github.com/lvarayut/relay-fullstack",
		"github.com/toshok/echojs",
		"github.com/Wildhoney/Maple.js",
		"github.com/GianlucaGuarini/es6-project-starter-kit",
		"github.com/jaxgeller/tweezer.js",
		"github.com/michaelbromley/angular-es6",
		"github.com/thoughtram/es6-babel-browserify-boilerplate",
		"github.com/hemanth/paws-on-es6",
		"github.com/RisingStack/react-way-immutable-flux",
		"github.com/c58/marsdb",
		"github.com/tastejs/todomvc-backbone-es6",
		"github.com/scottwrobinson/camo",
		"github.com/belohlavek/phaser-es6-boilerplate",
		"github.com/tddbin/es6katas.org",
		"github.com/GianlucaGuarini/parallax",
		"github.com/krasimir/webpack-library-starter",
		"github.com/vasanthk/react-es6-webpack-boilerplate",
		"github.com/hiddentao/robe",
		"github.com/tinkertrain/jspm-react",
		"github.com/keithwhor/cmnd",
		"github.com/rauschma/webpack-es6-demo",
		"github.com/glazedio/frisbee",
		"github.com/tcoopman/react-es6-browserify",
		"github.com/alexweber/es6-jspm-gulp-boilerplate",
		"github.com/takanabe/react-redux-material_ui-boilerplate",
		"github.com/DavidCai1993/JsPatterns-ES6",
		"github.com/FormidableLabs/es6-interactive-guide",
		"github.com/rauschma/react-starter-project",
		"github.com/coryhouse/pluralsight-redux-starter",
		"github.com/blacksonic/angular2-esnext-todomvc",
		"github.com/mrblueblue/react-native-alt-demo",
		"github.com/topheman/react-es6-redux",
		"github.com/loverajoel/spotify-sdk",
		"github.com/mobxjs/mobx-react-boilerplate",
		"github.com/ostera/tldr.jsx",
		"github.com/jamesknelson/webpack-black-triangle",
		"github.com/vojtajina/es6-playground",
		"github.com/code0wl/react-example-es2015",
		"github.com/DanWahlin/ES6Samples",
		"github.com/btholt/es6-react-pres",
		"github.com/substack/react-starter-es6-babel",
		"github.com/davidjnelson/es6-boilerplate",
		"github.com/tribou/react-todo",
		"github.com/arnarthor/react-es6-boilerplate",
	},
	"TypeScript": []string{
	...
	"Python": []string{
		...
		"github.com/mitsuhiko/flask-sqlalchemy",
		...
		/*
			// Data science libraries (explicitly unsupported at the moment)
