...
type Origin struct {
	...
	Service Origin_ServiceType `protobuf:"varint,2,opt,name=Service,json=service,proto3,enum=sourcegraph.Origin_ServiceType" json:""`
	...
	APIBaseURL string `protobuf:"bytes,3,opt,name=APIBaseURL,json=aPIBaseURL,proto3" json:"APIBaseURL,omitempty"`
}
...
type CombinedStatus struct {
	...
	Rev string `protobuf:"bytes,4,opt,name=Rev,json=rev,proto3" json:"Rev,omitempty"`
	// CommitID is the full commit ID of the commit this status describes. It is set mutually exclusively with Rev.
	CommitID string `protobuf:"bytes,1,opt,name=CommitID,json=commitID,proto3" json:"CommitID,omitempty"`
	...
	Statuses []*RepoStatus `protobuf:"bytes,3,rep,name=Statuses,json=statuses" json:"Statuses,omitempty"`
}
...
type ListOptions struct {
	PerPage int32 `protobuf:"varint,1,opt,name=PerPage,json=perPage,proto3" json:"PerPage,omitempty" url:",omitempty"`
	Page    int32 `protobuf:"varint,2,opt,name=Page,json=page,proto3" json:"Page,omitempty" url:",omitempty"`
}
...
type ListResponse struct {
	...
	Total int32 `protobuf:"varint,1,opt,name=Total,json=total,proto3" json:"Total,omitempty" url:",omitempty"`
}
...
type StreamResponse struct {
	...
	HasMore bool `protobuf:"varint,1,opt,name=HasMore,json=hasMore,proto3" json:"HasMore,omitempty" url:",omitempty"`
}
...
type Repo struct {
	...
	ID int32 `protobuf:"varint,18,opt,name=ID,json=iD,proto3" json:"ID,omitempty"`
	...
	HTTPCloneURL string `protobuf:"bytes,5,opt,name=HTTPCloneURL,json=hTTPCloneURL,proto3" json:"HTTPCloneURL,omitempty"`
	// SSHCloneURL is the SSH clone URL if the repository, if any.
	SSHCloneURL string `protobuf:"bytes,6,opt,name=SSHCloneURL,json=sSHCloneURL,proto3" json:"SSHCloneURL,omitempty"`
	// HomepageURL is the URL to the repository's homepage, if any.
	HomepageURL string `protobuf:"bytes,7,opt,name=HomepageURL,json=homepageURL,proto3" json:"HomepageURL,omitempty"`
	// HTMLURL is the URL to the repository's main page on the
	// Sourcegraph server.
	HTMLURL string `protobuf:"bytes,22,opt,name=HTMLURL,json=hTMLURL,proto3" json:"HTMLURL,omitempty"`
	// DefaultBranch is the default git branch used (typically "master").
	DefaultBranch string `protobuf:"bytes,8,opt,name=DefaultBranch,json=defaultBranch,proto3" json:"DefaultBranch,omitempty"`
	...
	Blocked bool `protobuf:"varint,10,opt,name=Blocked,json=blocked,proto3" json:"Blocked,omitempty"`
	...
	Fork bool `protobuf:"varint,12,opt,name=Fork,json=fork,proto3" json:"Fork,omitempty"`
	...
	Mirror bool `protobuf:"varint,13,opt,name=Mirror,json=mirror,proto3" json:"Mirror,omitempty"`
	// Private is whether this repository is private.
	Private bool `protobuf:"varint,14,opt,name=Private,json=private,proto3" json:"Private,omitempty"`
	...
	// that origin.
	CreatedAt *pbtypes.Timestamp `protobuf:"bytes,15,opt,name=CreatedAt,json=createdAt" json:"CreatedAt,omitempty"`
	// UpdatedAt is when this repository's metadata was last updated (on its origin if
	// it's an externally hosted repository).
	UpdatedAt *pbtypes.Timestamp `protobuf:"bytes,16,opt,name=UpdatedAt,json=updatedAt" json:"UpdatedAt,omitempty"`
	// PushedAt is when this repository's was last (VCS-)pushed to.
	PushedAt *pbtypes.Timestamp `protobuf:"bytes,17,opt,name=PushedAt,json=pushedAt" json:"PushedAt,omitempty"`
	// VCSSyncedAt is when this repository's VCS data was last synced
	// with the upstream. This field is only populated for mirror
	// repositories.
	VCSSyncedAt *pbtypes.Timestamp `protobuf:"bytes,20,opt,name=VCSSyncedAt,json=vCSSyncedAt" json:"VCSSyncedAt,omitempty"`
	// Origin describes the repo's canonical location. It is only
	// populated for mirror repos; for non-mirror repos, it is null.
	Origin *Origin `protobuf:"bytes,19,opt,name=Origin,json=origin" json:"Origin,omitempty"`
	...
	Permissions *RepoPermissions `protobuf:"bytes,21,opt,name=Permissions,json=permissions" json:"Permissions,omitempty"`
}
...
type RepoPermissions struct {
	Pull  bool `protobuf:"varint,1,opt,name=Pull,json=pull,proto3" json:"Pull,omitempty"`
	Push  bool `protobuf:"varint,2,opt,name=Push,json=push,proto3" json:"Push,omitempty"`
	Admin bool `protobuf:"varint,3,opt,name=Admin,json=admin,proto3" json:"Admin,omitempty"`
}
...
type RepoListOptions struct {
	Name string `protobuf:"bytes,1,opt,name=Name,json=name,proto3" json:"Name,omitempty" url:",omitempty"`
	// Specifies a search query for repositories. If specified, then the Sort and
	// Direction options are ignored
	Query     string   `protobuf:"bytes,2,opt,name=Query,json=query,proto3" json:"Query,omitempty" url:",omitempty"`
	URIs      []string `protobuf:"bytes,3,rep,name=URIs,json=uRIs" json:"URIs,omitempty" url:",comma,omitempty"`
	Sort      string   `protobuf:"bytes,5,opt,name=Sort,json=sort,proto3" json:"Sort,omitempty" url:",omitempty"`
	Direction string   `protobuf:"bytes,6,opt,name=Direction,json=direction,proto3" json:"Direction,omitempty" url:",omitempty"`
	NoFork    bool     `protobuf:"varint,7,opt,name=NoFork,json=noFork,proto3" json:"NoFork,omitempty" url:",omitempty"`
	...
	Type  string `protobuf:"bytes,8,opt,name=Type,json=type,proto3" json:"Type,omitempty" url:",omitempty"`
	Owner string `protobuf:"bytes,10,opt,name=Owner,json=owner,proto3" json:"Owner,omitempty" url:",omitempty"`
	...
	RemoteOnly bool `protobuf:"varint,12,opt,name=RemoteOnly,json=remoteOnly,proto3" json:"RemoteOnly,omitempty" url:",omitempty"`
}
...
type RepoRevSpec struct {
	Repo int32 `protobuf:"varint,1,opt,name=Repo,json=repo,proto3" json:"Repo,omitempty"`
	...
	// Repos.GetCommit.
	CommitID string `protobuf:"bytes,2,opt,name=CommitID,json=commitID,proto3" json:"CommitID,omitempty"`
}
...
type RepoStatus struct {
	...
	TargetURL string `protobuf:"bytes,3,opt,name=TargetURL,json=targetURL,proto3" json:"TargetURL,omitempty"`
	// Description is a short, high-level summary of the status.
	Description string `protobuf:"bytes,4,opt,name=Description,json=description,proto3" json:"Description,omitempty"`
	// A string label to differentiate this status from the statuses of other systems.
	Context   string            `protobuf:"bytes,5,opt,name=Context,json=context,proto3" json:"Context,omitempty"`
	CreatedAt pbtypes.Timestamp `protobuf:"bytes,6,opt,name=CreatedAt,json=createdAt" json:"CreatedAt"`
	UpdatedAt pbtypes.Timestamp `protobuf:"bytes,7,opt,name=UpdatedAt,json=updatedAt" json:"UpdatedAt"`
}
...
type RepoStatusList struct {
	RepoStatuses []*RepoStatus `protobuf:"bytes,1,rep,name=RepoStatuses,json=repoStatuses" json:"RepoStatuses,omitempty"`
}
...
type RepoStatusesCreateOp struct {
	Repo   RepoRevSpec `protobuf:"bytes,1,opt,name=Repo,json=repo" json:"Repo"`
	Status RepoStatus  `protobuf:"bytes,2,opt,name=Status,json=status" json:"Status"`
}
...
type RepoList struct {
	Repos []*Repo `protobuf:"bytes,1,rep,name=Repos,json=repos" json:"Repos,omitempty"`
}
...
type URIList struct {
	URIs []string `protobuf:"bytes,1,rep,name=URIs,json=uRIs" json:"URIs,omitempty"`
}
...
type RepoResolution struct {
	...
	CanonicalPath string `protobuf:"bytes,3,opt,name=CanonicalPath,json=canonicalPath,proto3" json:"CanonicalPath,omitempty"`
	// RemoteRepo holds metadata about the repo that exists on a
	// remote service (such as GitHub).
	RemoteRepo *Repo `protobuf:"bytes,2,opt,name=RemoteRepo,json=remoteRepo" json:"RemoteRepo,omitempty"`
}
...
type SrclibDataVersion struct {
	CommitID      string `protobuf:"bytes,1,opt,name=CommitID,json=commitID,proto3" json:"CommitID,omitempty"`
	CommitsBehind int32  `protobuf:"varint,2,opt,name=CommitsBehind,json=commitsBehind,proto3" json:"CommitsBehind,omitempty"`
}
...
type ReposCreateOp_New struct {
	New *ReposCreateOp_NewRepo `protobuf:"bytes,1,opt,name=New,json=new,oneof"`
}
type ReposCreateOp_FromGitHubID struct {
	FromGitHubID int32 `protobuf:"varint,2,opt,name=FromGitHubID,json=fromGitHubID,proto3,oneof"`
}
type ReposCreateOp_Origin struct {
	Origin *Origin `protobuf:"bytes,3,opt,name=Origin,json=origin,oneof"`
}
...
type ReposCreateOp_NewRepo struct {
	...
	CloneURL string `protobuf:"bytes,3,opt,name=CloneURL,json=cloneURL,proto3" json:"CloneURL,omitempty"`
	// DefaultBranch is the repository's default Git branch.
	DefaultBranch string `protobuf:"bytes,4,opt,name=DefaultBranch,json=defaultBranch,proto3" json:"DefaultBranch,omitempty"`
	...
	Mirror bool `protobuf:"varint,5,opt,name=Mirror,json=mirror,proto3" json:"Mirror,omitempty"`
	...
	Language string `protobuf:"bytes,7,opt,name=Language,json=language,proto3" json:"Language,omitempty"`
}
...
type ReposUpdateOp struct {
	...
	DefaultBranch string `protobuf:"bytes,6,opt,name=DefaultBranch,json=defaultBranch,proto3" json:"DefaultBranch,omitempty"`
	// Fork is whether this repository is a fork.
	Fork ReposUpdateOp_BoolType `protobuf:"varint,7,opt,name=Fork,json=fork,proto3,enum=sourcegraph.ReposUpdateOp_BoolType" json:"Fork,omitempty"`
	// Private is whether this repository is private.
	Private ReposUpdateOp_BoolType `protobuf:"varint,8,opt,name=Private,json=private,proto3,enum=sourcegraph.ReposUpdateOp_BoolType" json:"Private,omitempty"`
}
...
type ReposListCommitsOp struct {
	Repo int32                   `protobuf:"varint,1,opt,name=Repo,json=repo,proto3" json:"Repo,omitempty"`
	Opt  *RepoListCommitsOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}
...
type RepoListCommitsOptions struct {
	Head        string `protobuf:"bytes,1,opt,name=Head,json=head,proto3" json:"Head,omitempty" url:",omitempty"`
	Base        string `protobuf:"bytes,2,opt,name=Base,json=base,proto3" json:"Base,omitempty" url:",omitempty"`
	ListOptions `protobuf:"bytes,3,opt,name=ListOptions,json=listOptions,embedded=ListOptions" json:""`
	Path        string `protobuf:"bytes,4,opt,name=Path,json=path,proto3" json:"Path,omitempty" url:",omitempty"`
}
...
type CommitList struct {
	Commits        []*vcs.Commit `protobuf:"bytes,1,rep,name=Commits,json=commits" json:"Commits,omitempty"`
	StreamResponse `protobuf:"bytes,2,opt,name=StreamResponse,json=streamResponse,embedded=StreamResponse" json:""`
}
...
type ReposListBranchesOp struct {
	Repo int32                    `protobuf:"varint,1,opt,name=Repo,json=repo,proto3" json:"Repo,omitempty"`
	Opt  *RepoListBranchesOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}
...
type RepoListBranchesOptions struct {
	IncludeCommit     bool   `protobuf:"varint,4,opt,name=IncludeCommit,json=includeCommit,proto3" json:"IncludeCommit,omitempty"`
	BehindAheadBranch string `protobuf:"bytes,5,opt,name=BehindAheadBranch,json=behindAheadBranch,proto3" json:"BehindAheadBranch,omitempty"`
	ContainsCommit    string `protobuf:"bytes,6,opt,name=ContainsCommit,json=containsCommit,proto3" json:"ContainsCommit,omitempty"`
	ListOptions       `protobuf:"bytes,3,opt,name=ListOptions,json=listOptions,embedded=ListOptions" json:""`
}
...
type BranchList struct {
	Branches       []*vcs.Branch `protobuf:"bytes,1,rep,name=Branches,json=branches" json:"Branches,omitempty"`
	StreamResponse `protobuf:"bytes,2,opt,name=StreamResponse,json=streamResponse,embedded=StreamResponse" json:""`
}
...
type ReposListTagsOp struct {
	Repo int32                `protobuf:"varint,1,opt,name=Repo,json=repo,proto3" json:"Repo,omitempty"`
	Opt  *RepoListTagsOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}
...
type ReposListCommittersOp struct {
	Repo int32                      `protobuf:"varint,1,opt,name=Repo,json=repo,proto3" json:"Repo,omitempty"`
	Opt  *RepoListCommittersOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}
...
type RepoListCommittersOptions struct {
	Rev         string `protobuf:"bytes,1,opt,name=Rev,json=rev,proto3" json:"Rev,omitempty"`
	ListOptions `protobuf:"bytes,2,opt,name=ListOptions,json=listOptions,embedded=ListOptions" json:""`
}
...
type CommitterList struct {
	Committers     []*vcs.Committer `protobuf:"bytes,1,rep,name=Committers,json=committers" json:"Committers,omitempty"`
	StreamResponse `protobuf:"bytes,2,opt,name=StreamResponse,json=streamResponse,embedded=StreamResponse" json:""`
}
...
type TagList struct {
	Tags           []*vcs.Tag `protobuf:"bytes,1,rep,name=Tags,json=tags" json:"Tags,omitempty"`
	StreamResponse `protobuf:"bytes,2,opt,name=StreamResponse,json=streamResponse,embedded=StreamResponse" json:""`
}
...
type MirrorReposRefreshVCSOp struct {
	...
	AsUser *UserSpec `protobuf:"bytes,3,opt,name=AsUser,json=asUser" json:"AsUser,omitempty"`
}
...
type VCSCredentials struct {
	...
	Pass string `protobuf:"bytes,1,opt,name=Pass,json=pass,proto3" json:"Pass,omitempty"`
}
...
type RemoteRepo struct {
	...
	GitHubID int32 `protobuf:"varint,1,opt,name=GitHubID,json=gitHubID,proto3" json:"GitHubID,omitempty"`
	// Owner is the login or org name of the repo's owner ("foo" in
	// github.com/foo/bar).
	Owner string `protobuf:"bytes,2,opt,name=Owner,json=owner,proto3" json:"Owner,omitempty"`
	// OwnerIsOrg is true if the repo's owner is an org (not a user).
	OwnerIsOrg bool `protobuf:"varint,15,opt,name=OwnerIsOrg,json=ownerIsOrg,proto3" json:"OwnerIsOrg,omitempty"`
	// Name is the repo's name ("bar" in github.com/foo/bar).
	Name string `protobuf:"bytes,3,opt,name=Name,json=name,proto3" json:"Name,omitempty"`
	// VCS is "git".
	VCS string `protobuf:"bytes,4,opt,name=VCS,json=vCS,proto3" json:"VCS,omitempty"`
	...
	UpdatedAt *pbtypes.Timestamp `protobuf:"bytes,9,opt,name=UpdatedAt,json=updatedAt" json:"UpdatedAt,omitempty"`
	// PushedAt is the date of the most recent git push to the repo.
	PushedAt *pbtypes.Timestamp `protobuf:"bytes,14,opt,name=PushedAt,json=pushedAt" json:"PushedAt,omitempty"`
	// Private is true for private repos.
	Private bool `protobuf:"varint,10,opt,name=Private,json=private,proto3" json:"Private,omitempty"`
	// Fork is true for repos that were forked from another repo using
	// GitHub's "fork" operation.
	Fork bool `protobuf:"varint,11,opt,name=Fork,json=fork,proto3" json:"Fork,omitempty"`
	// Mirror is true for mirror repos (e.g., Apache Foundation
	// open-source repo mirrors on GitHub.com).
	Mirror bool `protobuf:"varint,12,opt,name=Mirror,json=mirror,proto3" json:"Mirror,omitempty"`
	// Stars is the number of stargazers of the GitHub repo.
	Stars int32 `protobuf:"varint,13,opt,name=Stars,json=stars,proto3" json:"Stars,omitempty"`
	...
	Permissions *RepoPermissions `protobuf:"bytes,24,opt,name=Permissions,json=permissions" json:"Permissions,omitempty"`
}
...
type Build struct {
	...
	CommitID string `protobuf:"bytes,3,opt,name=CommitID,json=commitID,proto3" json:"CommitID,omitempty"`
	...
	Branch string `protobuf:"bytes,14,opt,name=Branch,json=branch,proto3" json:"Branch,omitempty"`
	...
	Tag         string             `protobuf:"bytes,15,opt,name=Tag,json=tag,proto3" json:"Tag,omitempty"`
	CreatedAt   pbtypes.Timestamp  `protobuf:"bytes,4,opt,name=CreatedAt,json=createdAt" json:"CreatedAt"`
	StartedAt   *pbtypes.Timestamp `protobuf:"bytes,5,opt,name=StartedAt,json=startedAt" json:"StartedAt,omitempty"`
	EndedAt     *pbtypes.Timestamp `protobuf:"bytes,6,opt,name=EndedAt,json=endedAt" json:"EndedAt,omitempty"`
	HeartbeatAt *pbtypes.Timestamp `protobuf:"bytes,7,opt,name=HeartbeatAt,json=heartbeatAt" json:"HeartbeatAt,omitempty"`
	Success     bool               `protobuf:"varint,8,opt,name=Success,json=success,proto3" json:"Success,omitempty"`
	Failure     bool               `protobuf:"varint,9,opt,name=Failure,json=failure,proto3" json:"Failure,omitempty"`
	...
	Killed bool `protobuf:"varint,10,opt,name=Killed,json=killed,proto3" json:"Killed,omitempty"`
	// Host is the hostname of the machine that is working on this build.
	Host        string `protobuf:"bytes,11,opt,name=Host,json=host,proto3" json:"Host,omitempty"`
	Purged      bool   `protobuf:"varint,12,opt,name=Purged,json=purged,proto3" json:"Purged,omitempty"`
	BuildConfig `protobuf:"bytes,13,opt,name=BuildConfig,json=buildConfig,embedded=BuildConfig" json:""`
}
...
type BuildConfig struct {
	...
	Queue bool `protobuf:"varint,2,opt,name=Queue,json=queue,proto3" json:"Queue,omitempty"`
	...
	// repository).
	BuilderConfig string `protobuf:"bytes,16,opt,name=BuilderConfig,json=builderConfig,proto3" json:"BuilderConfig,omitempty"`
}
...
type BuildJob struct {
	...
	Spec BuildSpec `protobuf:"bytes,1,opt,name=Spec,json=spec" json:"Spec"`
	// CommitID is the full resolved commit ID to build.
	CommitID string `protobuf:"bytes,3,opt,name=CommitID,json=commitID,proto3" json:"CommitID,omitempty"`
	// Branch, if set, is the name of the VCS branch on which this
	...
	AccessToken string `protobuf:"bytes,16,opt,name=AccessToken,json=accessToken,proto3" json:"AccessToken,omitempty"`
}
...
type BuildGetLogOptions struct {
	...
	MinID string `protobuf:"bytes,1,opt,name=MinID,json=minID,proto3" json:"MinID,omitempty"`
}
...
type BuildListOptions struct {
	Queued      bool   `protobuf:"varint,1,opt,name=Queued,json=queued,proto3" json:"Queued,omitempty" url:",omitempty"`
	Active      bool   `protobuf:"varint,2,opt,name=Active,json=active,proto3" json:"Active,omitempty" url:",omitempty"`
	Ended       bool   `protobuf:"varint,3,opt,name=Ended,json=ended,proto3" json:"Ended,omitempty" url:",omitempty"`
	Succeeded   bool   `protobuf:"varint,4,opt,name=Succeeded,json=succeeded,proto3" json:"Succeeded,omitempty" url:",omitempty"`
	Failed      bool   `protobuf:"varint,5,opt,name=Failed,json=failed,proto3" json:"Failed,omitempty" url:",omitempty"`
	Purged      bool   `protobuf:"varint,6,opt,name=Purged,json=purged,proto3" json:"Purged,omitempty" url:",omitempty"`
	Repo        int32  `protobuf:"varint,7,opt,name=Repo,json=repo,proto3" json:"Repo,omitempty" url:",omitempty"`
	CommitID    string `protobuf:"bytes,8,opt,name=CommitID,json=commitID,proto3" json:"CommitID,omitempty" url:",omitempty"`
	Sort        string `protobuf:"bytes,9,opt,name=Sort,json=sort,proto3" json:"Sort,omitempty" url:",omitempty"`
	Direction   string `protobuf:"bytes,10,opt,name=Direction,json=direction,proto3" json:"Direction,omitempty" url:",omitempty"`
	ListOptions `protobuf:"bytes,11,opt,name=ListOptions,json=listOptions,embedded=ListOptions" json:""`
}
...
type BuildTask struct {
	...
	Build BuildSpec `protobuf:"bytes,2,opt,name=Build,json=build" json:"Build"`
	...
	ParentID uint64 `protobuf:"varint,3,opt,name=ParentID,json=parentID,proto3" json:"ParentID,omitempty"`
	// Label describes the task (e.g., "Go build").
	Label string `protobuf:"bytes,4,opt,name=Label,json=label,proto3" json:"Label,omitempty"`
	// CreatedAt is when this task was initially created.
	CreatedAt pbtypes.Timestamp `protobuf:"bytes,5,opt,name=CreatedAt,json=createdAt" json:"CreatedAt"`
	// StartedAt is when this task's execution began.
	StartedAt *pbtypes.Timestamp `protobuf:"bytes,6,opt,name=StartedAt,json=startedAt" json:"StartedAt,omitempty"`
	// EndedAt is when this task's execution ended (whether because it succeeded or
	// failed).
	EndedAt *pbtypes.Timestamp `protobuf:"bytes,7,opt,name=EndedAt,json=endedAt" json:"EndedAt,omitempty"`
	...
	Skipped bool `protobuf:"varint,10,opt,name=Skipped,json=skipped,proto3" json:"Skipped,omitempty"`
	...
	Warnings bool `protobuf:"varint,11,opt,name=Warnings,json=warnings,proto3" json:"Warnings,omitempty"`
}
...
type BuildTaskListOptions struct {
	ListOptions `protobuf:"bytes,1,opt,name=ListOptions,json=listOptions,embedded=ListOptions" json:""`
}
...
type BuildUpdate struct {
	StartedAt     *pbtypes.Timestamp `protobuf:"bytes,1,opt,name=StartedAt,json=startedAt" json:"StartedAt,omitempty"`
	EndedAt       *pbtypes.Timestamp `protobuf:"bytes,2,opt,name=EndedAt,json=endedAt" json:"EndedAt,omitempty"`
	HeartbeatAt   *pbtypes.Timestamp `protobuf:"bytes,3,opt,name=HeartbeatAt,json=heartbeatAt" json:"HeartbeatAt,omitempty"`
	...
	Purged        bool               `protobuf:"varint,6,opt,name=Purged,json=purged,proto3" json:"Purged,omitempty"`
	Failure       bool               `protobuf:"varint,7,opt,name=Failure,json=failure,proto3" json:"Failure,omitempty"`
	Killed        bool               `protobuf:"varint,8,opt,name=Killed,json=killed,proto3" json:"Killed,omitempty"`
	Priority      int32              `protobuf:"varint,9,opt,name=Priority,json=priority,proto3" json:"Priority,omitempty"`
	BuilderConfig string             `protobuf:"bytes,10,opt,name=BuilderConfig,json=builderConfig,proto3" json:"BuilderConfig,omitempty"`
	FileScore     float32            `protobuf:"fixed32,11,opt,name=FileScore,json=fileScore,proto3" json:"FileScore,omitempty"`
	RefScore      float32            `protobuf:"fixed32,12,opt,name=RefScore,json=refScore,proto3" json:"RefScore,omitempty"`
	TokDensity    float32            `protobuf:"fixed32,13,opt,name=TokDensity,json=tokDensity,proto3" json:"TokDensity,omitempty"`
}
...
type BuildList struct {
	Builds         []*Build `protobuf:"bytes,1,rep,name=Builds,json=builds" json:"Builds,omitempty"`
	StreamResponse `protobuf:"bytes,2,opt,name=StreamResponse,json=streamResponse,embedded=StreamResponse" json:""`
}
...
type BuildsCreateOp struct {
	...
	Config BuildConfig `protobuf:"bytes,5,opt,name=Config,json=config" json:"Config"`
}
...
type BuildsUpdateOp struct {
	Build BuildSpec   `protobuf:"bytes,1,opt,name=Build,json=build" json:"Build"`
	Info  BuildUpdate `protobuf:"bytes,2,opt,name=Info,json=info" json:"Info"`
}
...
type BuildsListBuildTasksOp struct {
	Build BuildSpec             `protobuf:"bytes,1,opt,name=Build,json=build" json:"Build"`
	Opt   *BuildTaskListOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}
...
type BuildTaskList struct {
	BuildTasks []*BuildTask `protobuf:"bytes,1,rep,name=BuildTasks,json=buildTasks" json:"BuildTasks,omitempty"`
}
...
type BuildsCreateTasksOp struct {
	Build BuildSpec    `protobuf:"bytes,1,opt,name=Build,json=build" json:"Build"`
	Tasks []*BuildTask `protobuf:"bytes,2,rep,name=Tasks,json=tasks" json:"Tasks,omitempty"`
}
...
type BuildsUpdateTaskOp struct {
	Task TaskSpec   `protobuf:"bytes,1,opt,name=Task,json=task" json:"Task"`
	Info TaskUpdate `protobuf:"bytes,2,opt,name=Info,json=info" json:"Info"`
}
...
type BuildsGetTaskLogOp struct {
	Task TaskSpec            `protobuf:"bytes,1,opt,name=Task,json=task" json:"Task"`
	Opt  *BuildGetLogOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}
...
type EmailAddr struct {
	...
	Verified bool `protobuf:"varint,2,opt,name=Verified,json=verified,proto3" json:"Verified,omitempty"`
	// indicates this is the user's primary email (only 1 email can be primary per user)
	Primary bool `protobuf:"varint,3,opt,name=Primary,json=primary,proto3" json:"Primary,omitempty"`
	// whether Sourcegraph inferred via public data that this is an email for the user
	Guessed bool `protobuf:"varint,4,opt,name=Guessed,json=guessed,proto3" json:"Guessed,omitempty"`
	// indicates that this email should not be associated with the user (even if guessed in the future)
	Blacklisted bool `protobuf:"varint,5,opt,name=Blacklisted,json=blacklisted,proto3" json:"Blacklisted,omitempty"`
}
...
type LogEntries struct {
	MaxID   string   `protobuf:"bytes,1,opt,name=MaxID,json=maxID,proto3" json:"MaxID,omitempty"`
	Entries []string `protobuf:"bytes,2,rep,name=Entries,json=entries" json:"Entries,omitempty"`
}
...
func (*TaskSpec) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{63} }
...
type TaskUpdate struct {
	...
	Failure   bool               `protobuf:"varint,4,opt,name=Failure,json=failure,proto3" json:"Failure,omitempty"`
	Skipped   bool               `protobuf:"varint,5,opt,name=Skipped,json=skipped,proto3" json:"Skipped,omitempty"`
	Warnings  bool               `protobuf:"varint,6,opt,name=Warnings,json=warnings,proto3" json:"Warnings,omitempty"`
}
...
func (*TaskUpdate) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{64} }

// User represents a registered user.
type User struct {
	// UID is the numeric primary key for a user.
	UID int32 `protobuf:"varint,1,opt,name=UID,json=uID,proto3" json:"UID"`
	// Login is the user's username.
	Login string `protobuf:"bytes,2,opt,name=Login,json=login,proto3" json:"Login"`
	...
	IsOrganization bool `protobuf:"varint,5,opt,name=IsOrganization,json=isOrganization,proto3" json:"IsOrganization,omitempty"`
	// AvatarURL is the URL to an avatar image specified by the user.
	AvatarURL string `protobuf:"bytes,6,opt,name=AvatarURL,json=avatarURL,proto3" json:"AvatarURL,omitempty"`
	...
	Company string `protobuf:"bytes,8,opt,name=Company,json=company,proto3" json:"Company,omitempty"`
	// HomepageURL is the user's homepage or blog URL.
	HomepageURL string `protobuf:"bytes,9,opt,name=HomepageURL,json=homepageURL,proto3" json:"HomepageURL,omitempty"`
	// Disabled is whether the user account is disabled.
	Disabled bool `protobuf:"varint,10,opt,name=Disabled,json=disabled,proto3" json:"Disabled,omitempty"`
	// Admin is whether the user is a site admin for the site.
	Admin bool `protobuf:"varint,12,opt,name=Admin,json=admin,proto3" json:"Admin,omitempty"`
	...
	Betas []string `protobuf:"bytes,14,rep,name=Betas,json=betas" json:"Betas,omitempty"`
	...
	BetaRegistered bool `protobuf:"varint,15,opt,name=BetaRegistered,json=betaRegistered,proto3" json:"BetaRegistered,omitempty"`
	// Write is whether the user has write access for the site.
	Write bool `protobuf:"varint,13,opt,name=Write,json=write,proto3" json:"Write,omitempty"`
	...
	RegisteredAt *pbtypes.Timestamp `protobuf:"bytes,11,opt,name=RegisteredAt,json=registeredAt" json:"RegisteredAt,omitempty"`
}

func (m *User) Reset()                    { *m = User{} }
func (m *User) String() string            { return proto.CompactTextString(m) }
func (*User) ProtoMessage()               {}
func (*User) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{65} }
...
type UserSpec struct {
	...
	// UID is a user's UID.
	UID int32 `protobuf:"varint,2,opt,name=UID,json=uID,proto3" json:"UID,omitempty"`
}

func (m *UserSpec) Reset()                    { *m = UserSpec{} }
func (m *UserSpec) String() string            { return proto.CompactTextString(m) }
func (*UserSpec) ProtoMessage()               {}
func (*UserSpec) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{66} }
...
type UsersListOptions struct {
	...
	Query       string `protobuf:"bytes,1,opt,name=Query,json=query,proto3" json:"Query,omitempty" url:",omitempty"`
	Sort        string `protobuf:"bytes,2,opt,name=Sort,json=sort,proto3" json:"Sort,omitempty" url:",omitempty"`
	Direction   string `protobuf:"bytes,3,opt,name=Direction,json=direction,proto3" json:"Direction,omitempty" url:",omitempty"`
	ListOptions `protobuf:"bytes,4,opt,name=ListOptions,json=listOptions,embedded=ListOptions" json:""`
	// UIDs filters the resulting list to only contain users
	// with one of these UIDs.
	UIDs []int32 `protobuf:"varint,5,rep,name=UIDs,json=uIDs" json:"UIDs,omitempty" url:",omitempty"`
	...
	AllBetas []string `protobuf:"bytes,6,rep,name=AllBetas,json=allBetas" json:"AllBetas,omitempty" url:",omitempty"`
	// RegisteredBeta filters the resulting list to only users who have
	// registered for beta access.
	RegisteredBeta bool `protobuf:"varint,7,opt,name=RegisteredBeta,json=registeredBeta,proto3" json:"RegisteredBeta,omitempty" url:",omitempty"`
	// HaveBeta filters the resulting list to only users who have access to at
	// least one beta.
	HaveBeta bool `protobuf:"varint,8,opt,name=HaveBeta,json=haveBeta,proto3" json:"HaveBeta,omitempty" url:",omitempty"`
}
...
func (*UsersListOptions) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{67} }

type EmailAddrList struct {
	EmailAddrs []*EmailAddr `protobuf:"bytes,1,rep,name=EmailAddrs,json=emailAddrs" json:"EmailAddrs,omitempty"`
}
...
func (*EmailAddrList) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{68} }
...
type UpdateEmailsOp struct {
	...
	UserSpec UserSpec `protobuf:"bytes,1,opt,name=UserSpec,json=userSpec" json:"UserSpec"`
	// Add is a list of email addresses to add, if they do not already exist.
	Add *EmailAddrList `protobuf:"bytes,2,opt,name=Add,json=add" json:"Add,omitempty"`
}
...
func (*UpdateEmailsOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{69} }

type RequestPasswordResetOp struct {
	Email string `protobuf:"bytes,1,opt,name=Email,json=email,proto3" json:"Email,omitempty"`
}

func (m *RequestPasswordResetOp) Reset()         { *m = RequestPasswordResetOp{} }
func (m *RequestPasswordResetOp) String() string { return proto.CompactTextString(m) }
func (*RequestPasswordResetOp) ProtoMessage()    {}
func (*RequestPasswordResetOp) Descriptor() ([]byte, []int) {
	return fileDescriptorSourcegraph, []int{70}
}
...
type CreatedAccount struct {
	...
	TemporaryAccessToken string `protobuf:"bytes,2,opt,name=TemporaryAccessToken,json=temporaryAccessToken,proto3" json:"TemporaryAccessToken,omitempty"`
}
...
func (*CreatedAccount) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{71} }
...
func (*PasswordResetToken) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{72} }
...
type PendingPasswordReset struct {
	...
	// It is set in the response only if the request was made
	// by an admin user.
	Token *PasswordResetToken `protobuf:"bytes,2,opt,name=Token,json=token" json:"Token,omitempty"`
	// EmailSent is set if the password reset link was emailed to
	// the user.
	EmailSent bool `protobuf:"varint,3,opt,name=EmailSent,json=emailSent,proto3" json:"EmailSent,omitempty"`
	// Login is the login name of user for whom this request is created.
	Login string `protobuf:"bytes,4,opt,name=Login,json=login,proto3" json:"Login,omitempty"`
}
...
func (*PendingPasswordReset) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{73} }
...
func (*NewPassword) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{74} }
...
func (*NewAccount) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{75} }
...
type BetaRegistration struct {
	...
	Languages []string `protobuf:"bytes,4,rep,name=Languages,json=languages" json:"Languages,omitempty"`
	// Editors is a list of editors the user is interested in.
	Editors []string `protobuf:"bytes,5,rep,name=Editors,json=editors" json:"Editors,omitempty"`
...
func (*BetaRegistration) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{76} }
...
type BetaResponse struct {
	...
	EmailAddress string `protobuf:"bytes,1,opt,name=EmailAddress,json=emailAddress,proto3" json:"EmailAddress,omitempty"`
}
...
func (*BetaResponse) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{77} }
...
func (*LoginCredentials) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{78} }
...
func (*GitHubAuthCode) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{79} }
...
type AccessTokenRequest struct {
	...
	Scope              []string                                `protobuf:"bytes,17,rep,name=Scope,json=scope" json:"Scope,omitempty"`
}
...
type AccessTokenRequest_ResourceOwnerPassword struct {
	ResourceOwnerPassword *LoginCredentials `protobuf:"bytes,2,opt,name=ResourceOwnerPassword,json=resourceOwnerPassword,oneof"`
}
type AccessTokenRequest_GitHubAuthCode struct {
	GitHubAuthCode *GitHubAuthCode `protobuf:"bytes,3,opt,name=GitHubAuthCode,json=gitHubAuthCode,oneof"`
}
...
type AccessTokenResponse struct {
	AccessToken  string   `protobuf:"bytes,1,opt,name=AccessToken,json=accessToken,proto3" json:"AccessToken,omitempty"`
	TokenType    string   `protobuf:"bytes,2,opt,name=TokenType,json=tokenType,proto3" json:"TokenType,omitempty"`
	ExpiresInSec int32    `protobuf:"varint,3,opt,name=ExpiresInSec,json=expiresInSec,proto3" json:"ExpiresInSec,omitempty"`
	RefreshToken string   `protobuf:"bytes,4,opt,name=RefreshToken,json=refreshToken,proto3" json:"RefreshToken,omitempty"`
	Scope        []string `protobuf:"bytes,5,rep,name=Scope,json=scope" json:"Scope,omitempty"`
	// Extra fields only used by Sourcegraph.
	UID               int32       `protobuf:"varint,6,opt,name=UID,json=uID,proto3" json:"UID,omitempty"`
	GitHubAccessToken string      `protobuf:"bytes,7,opt,name=GitHubAccessToken,json=gitHubAccessToken,proto3" json:"GitHubAccessToken,omitempty"`
	GitHubUser        *GitHubUser `protobuf:"bytes,8,opt,name=GitHubUser,json=gitHubUser" json:"GitHubUser,omitempty"`
}
...
type GitHubUser struct {
	...
	Company   string `protobuf:"bytes,6,opt,name=Company,json=company,proto3" json:"Company,omitempty"`
	AvatarURL string `protobuf:"bytes,7,opt,name=AvatarURL,json=avatarURL,proto3" json:"AvatarURL,omitempty"`
}
...
func (*GitHubUser) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{82} }
...
type AuthInfo struct {
	...
	Write bool `protobuf:"varint,5,opt,name=Write,json=write,proto3" json:"Write,omitempty"`
...
type ExternalToken struct {
	...
	// to this token.
	ExtUID int32 `protobuf:"varint,6,opt,name=ext_uid,json=extUid,proto3" json:"ext_uid,omitempty"`
}
...
type Def struct {
	graph.Def  `protobuf:"bytes,1,opt,name=Def,json=def,embedded=Def" json:""`
	DocHTML    *pbtypes2.HTML          `protobuf:"bytes,2,opt,name=DocHTML,json=docHTML" json:"DocHTML,omitempty"`
	FmtStrings *graph.DefFormatStrings `protobuf:"bytes,3,opt,name=FmtStrings,json=fmtStrings" json:"FmtStrings,omitempty"`
...
type DefGetOptions struct {
	Doc bool `protobuf:"varint,1,opt,name=Doc,json=doc,proto3" json:"Doc,omitempty" url:",omitempty"`
	...
	ComputeLineRange bool `protobuf:"varint,2,opt,name=ComputeLineRange,json=computeLineRange,proto3" json:"ComputeLineRange,omitempty" url:",omitempty"`
}
...
type DefListOptions struct {
	...
	// both values are set.
	ByteStart uint32 `protobuf:"varint,3,opt,name=ByteStart,json=byteStart,proto3" json:"ByteStart,omitempty"`
	// ByteStart and ByteEnd will restrict the results to only definitions that overlap
	// with the specified start and end byte offsets. This filter is only applied if
	// both values are set.
	ByteEnd uint32 `protobuf:"varint,4,opt,name=ByteEnd,json=byteEnd,proto3" json:"ByteEnd,omitempty"`
	// DefKeys, if set, will return the definitions that match the given DefKey
	DefKeys []*graph.DefKey `protobuf:"bytes,5,rep,name=DefKeys,json=defKeys" json:"DefKeys,omitempty"`
	...
	RepoRevs []string `protobuf:"bytes,6,rep,name=RepoRevs,json=repoRevs" json:"RepoRevs,omitempty" url:",omitempty,comma"`
	UnitType string   `protobuf:"bytes,7,opt,name=UnitType,json=unitType,proto3" json:"UnitType,omitempty" url:",omitempty"`
	Unit     string   `protobuf:"bytes,8,opt,name=Unit,json=unit,proto3" json:"Unit,omitempty" url:",omitempty"`
	Path     string   `protobuf:"bytes,9,opt,name=Path,json=path,proto3" json:"Path,omitempty" url:",omitempty"`
	// Files, if specified, will restrict the results to only defs defined in the
	// specified file.
	Files []string `protobuf:"bytes,10,rep,name=Files,json=files" json:"Files,omitempty" url:",omitempty"`
	...
	FilePathPrefix string   `protobuf:"bytes,11,opt,name=FilePathPrefix,json=filePathPrefix,proto3" json:"FilePathPrefix,omitempty" url:",omitempty"`
	Kinds          []string `protobuf:"bytes,12,rep,name=Kinds,json=kinds" json:"Kinds,omitempty" url:",omitempty,comma"`
	Exported       bool     `protobuf:"varint,13,opt,name=Exported,json=exported,proto3" json:"Exported,omitempty" url:",omitempty"`
	Nonlocal       bool     `protobuf:"varint,14,opt,name=Nonlocal,json=nonlocal,proto3" json:"Nonlocal,omitempty" url:",omitempty"`
	// IncludeTest is whether the results should include definitions in test files.
	IncludeTest bool `protobuf:"varint,15,opt,name=IncludeTest,json=includeTest,proto3" json:"IncludeTest,omitempty" url:",omitempty"`
	// Enhancements
	Doc   bool `protobuf:"varint,16,opt,name=Doc,json=doc,proto3" json:"Doc,omitempty" url:",omitempty"`
	Fuzzy bool `protobuf:"varint,17,opt,name=Fuzzy,json=fuzzy,proto3" json:"Fuzzy,omitempty" url:",omitempty"`
	// Sorting
	Sort      string `protobuf:"bytes,18,opt,name=Sort,json=sort,proto3" json:"Sort,omitempty" url:",omitempty"`
	Direction string `protobuf:"bytes,19,opt,name=Direction,json=direction,proto3" json:"Direction,omitempty" url:",omitempty"`
	// Paging
	ListOptions `protobuf:"bytes,20,opt,name=ListOptions,json=listOptions,embedded=ListOptions" json:""`
}
...
type DefListRefsOptions struct {
	Repo        int32    `protobuf:"varint,1,opt,name=Repo,json=repo,proto3" json:"Repo,omitempty" url:",omitempty"`
	CommitID    string   `protobuf:"bytes,4,opt,name=CommitID,json=commitID,proto3" json:"CommitID,omitempty" url:",omitempty"`
	Files       []string `protobuf:"bytes,2,rep,name=Files,json=files" json:"Files,omitempty" url:",omitempty"`
	ListOptions `protobuf:"bytes,3,opt,name=ListOptions,json=listOptions,embedded=ListOptions" json:""`
}
...
type DefSpec struct {
	Repo     int32  `protobuf:"varint,1,opt,name=Repo,json=repo,proto3" json:"Repo,omitempty"`
	CommitID string `protobuf:"bytes,2,opt,name=CommitID,json=commitID,proto3" json:"CommitID,omitempty"`
	UnitType string `protobuf:"bytes,3,opt,name=UnitType,json=unitType,proto3" json:"UnitType,omitempty"`
	Unit     string `protobuf:"bytes,4,opt,name=Unit,json=unit,proto3" json:"Unit,omitempty"`
...
type DefsGetOp struct {
	Def DefSpec        `protobuf:"bytes,1,opt,name=Def,json=def" json:"Def"`
	Opt *DefGetOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}
...
type DefList struct {
	Defs         []*Def `protobuf:"bytes,1,rep,name=Defs,json=defs" json:"Defs,omitempty"`
	ListResponse `protobuf:"bytes,2,opt,name=ListResponse,json=listResponse,embedded=ListResponse" json:""`
}
...
type DefsListRefsOp struct {
	Def DefSpec             `protobuf:"bytes,1,opt,name=Def,json=def" json:"Def"`
	Opt *DefListRefsOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}
...
type RefList struct {
	Refs           []*graph1.Ref `protobuf:"bytes,1,rep,name=Refs,json=refs" json:"Refs,omitempty"`
	StreamResponse `protobuf:"bytes,2,opt,name=StreamResponse,json=streamResponse,embedded=StreamResponse" json:""`
}
...
type DefListRefLocationsOptions struct {
	...
	Repos []string `protobuf:"bytes,1,rep,name=Repos,json=repos" json:"Repos,omitempty" url:",omitempty"`
...
type DefsListRefLocationsOp struct {
	...
	Opt *DefListRefLocationsOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}
...
func (*DefsListExamplesOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{97} }
...
type RefLocationsList struct {
	...
	RepoRefs []*DefRepoRef `protobuf:"bytes,1,rep,name=RepoRefs,json=repoRefs" json:"RepoRefs,omitempty"`
	// StreamResponse specifies if more results are available.
	StreamResponse `protobuf:"bytes,2,opt,name=StreamResponse,json=streamResponse,embedded=StreamResponse" json:""`
	// TotalRepos is the total number of repos which reference the def.
	TotalRepos int32 `protobuf:"varint,3,opt,name=TotalRepos,json=totalRepos,proto3" json:"TotalRepos,omitempty"`
}
...
type DefRepoRef struct {
	...
	Repo string `protobuf:"bytes,1,opt,name=Repo,json=repo,proto3" json:"Repo,omitempty"`
	...
	Files []*DefFileRef `protobuf:"bytes,4,rep,name=Files,json=files" json:"Files,omitempty"`
}
...
type RepoTreeGetOptions struct {
	ContentsAsString bool `protobuf:"varint,4,opt,name=ContentsAsString,json=contentsAsString,proto3" json:"ContentsAsString,omitempty" url:",omitempty"`
	GetFileOptions   `protobuf:"bytes,5,opt,name=GetFileOptions,json=getFileOptions,embedded=GetFileOptions" json:""`
	// NoSrclibAnns indicates whether or not srclib annotations should be
	// excluded in the (optional) returned list of annotations.
	NoSrclibAnns bool `protobuf:"varint,6,opt,name=NoSrclibAnns,json=noSrclibAnns,proto3" json:"NoSrclibAnns,omitempty"`
}
...
func (*RepoTreeGetOptions) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{101} }
...
type GetFileOptions struct {
	...
	FileRange `protobuf:"bytes,1,opt,name=FileRange,json=fileRange,embedded=FileRange" json:""`
	// EntireFile is whether the entire file contents should be returned. If true,
	// Start/EndLine and Start/EndBytes are ignored.
	EntireFile bool `protobuf:"varint,2,opt,name=EntireFile,json=entireFile,proto3" json:"EntireFile,omitempty" url:",omitempty"`
	...
	ExpandContextLines int32 `protobuf:"varint,3,opt,name=ExpandContextLines,json=expandContextLines,proto3" json:"ExpandContextLines,omitempty" url:",omitempty"`
	...
	FullLines bool `protobuf:"varint,4,opt,name=FullLines,json=fullLines,proto3" json:"FullLines,omitempty" url:",omitempty"`
	...
	// sub-directories.
	Recursive bool `protobuf:"varint,5,opt,name=Recursive,json=recursive,proto3" json:"Recursive,omitempty" url:",omitempty"`
	...
	RecurseSingleSubfolderLimit int32 `protobuf:"varint,6,opt,name=RecurseSingleSubfolderLimit,json=recurseSingleSubfolderLimit,proto3" json:"RecurseSingleSubfolderLimit,omitempty" url:",omitempty"`
}
...
func (*GetFileOptions) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{102} }

type RepoTreeSearchOptions struct {
	vcs.SearchOptions `protobuf:"bytes,1,opt,name=SearchOptions,json=searchOptions,embedded=SearchOptions" json:""`
}
...
type RepoTreeSearchResult struct {
	vcs.SearchResult `protobuf:"bytes,1,opt,name=SearchResult,json=searchResult,embedded=SearchResult" json:""`
	RepoRev          RepoRevSpec `protobuf:"bytes,2,opt,name=RepoRev,json=repoRev" json:"RepoRev"`
}
...
type RepoTreeGetOp struct {
	Entry TreeEntrySpec       `protobuf:"bytes,1,opt,name=Entry,json=entry" json:"Entry"`
	Opt   *RepoTreeGetOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}
...
func (*RepoTreeGetOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{105} }

type RepoTreeSearchOp struct {
	Rev RepoRevSpec            `protobuf:"bytes,1,opt,name=Rev,json=rev" json:"Rev"`
	Opt *RepoTreeSearchOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}
...
func (*RepoTreeSearchOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{106} }
...
func (*RepoTreeListOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{107} }

type RepoTreeListResult struct {
	Files []string `protobuf:"bytes,1,rep,name=Files,json=files" json:"Files,omitempty"`
}
...
func (*RepoTreeListResult) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{108} }

type VCSSearchResultList struct {
	SearchResults []*vcs.SearchResult `protobuf:"bytes,1,rep,name=SearchResults,json=searchResults" json:"SearchResults,omitempty"`
	ListResponse  `protobuf:"bytes,2,opt,name=ListResponse,json=listResponse,embedded=ListResponse" json:""`
}
...
func (*VCSSearchResultList) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{109} }

// TreeEntry is a file or directory in a repository.
type TreeEntry struct {
	*BasicTreeEntry `protobuf:"bytes,1,opt,name=BasicTreeEntry,json=basicTreeEntry,embedded=BasicTreeEntry" json:""`
	*FileRange      `protobuf:"bytes,2,opt,name=FileRange,json=fileRange,embedded=FileRange" json:""`
	ContentsString  string `protobuf:"bytes,3,opt,name=ContentsString,json=contentsString,proto3" json:"ContentsString,omitempty"`
}

func (m *TreeEntry) Reset()                    { *m = TreeEntry{} }
func (m *TreeEntry) String() string            { return proto.CompactTextString(m) }
func (*TreeEntry) ProtoMessage()               {}
func (*TreeEntry) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{110} }

type BasicTreeEntry struct {
	Name     string            `protobuf:"bytes,1,opt,name=Name,json=name,proto3" json:"Name,omitempty"`
	Type     TreeEntryType     `protobuf:"varint,2,opt,name=Type,json=type,proto3,enum=sourcegraph.TreeEntryType" json:"Type,omitempty"`
	CommitID string            `protobuf:"bytes,3,opt,name=CommitID,json=commitID,proto3" json:"CommitID,omitempty"`
	Contents []byte            `protobuf:"bytes,5,opt,name=Contents,json=contents,proto3" json:"Contents,omitempty"`
	Entries  []*BasicTreeEntry `protobuf:"bytes,6,rep,name=Entries,json=entries" json:"Entries,omitempty"`
}
...
func (*BasicTreeEntry) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{111} }

type TreeEntrySpec struct {
	RepoRev RepoRevSpec `protobuf:"bytes,1,opt,name=RepoRev,json=repoRev" json:"RepoRev"`
...
func (*TreeEntrySpec) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{112} }

// FileRange is a line and byte range in a file.
type FileRange struct {
	// start of line range
	StartLine int64 `protobuf:"varint,1,opt,name=StartLine,json=startLine,proto3" json:"StartLine,omitempty" url:",omitempty"`
	// end of line range
	EndLine int64 `protobuf:"varint,2,opt,name=EndLine,json=endLine,proto3" json:"EndLine,omitempty" url:",omitempty"`
	// start of byte range
	StartByte int64 `protobuf:"varint,3,opt,name=StartByte,json=startByte,proto3" json:"StartByte,omitempty" url:",omitempty"`
	// end of byte range
	EndByte int64 `protobuf:"varint,4,opt,name=EndByte,json=endByte,proto3" json:"EndByte,omitempty" url:",omitempty"`
}
...
func (*FileRange) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{113} }
...
type DefsRefreshIndexOp struct {
	...
	RefreshRefLocations bool `protobuf:"varint,2,opt,name=RefreshRefLocations,json=refreshRefLocations,proto3" json:"RefreshRefLocations,omitempty"`
	// Force ensures we reindex, even if we have already indexed the latest
	// commit for repo
	Force bool `protobuf:"varint,3,opt,name=Force,json=force,proto3" json:"Force,omitempty"`
}
...
func (*DefsRefreshIndexOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{114} }
...
type AuthorshipInfo struct {
	LastCommitDate pbtypes.Timestamp `protobuf:"bytes,1,opt,name=LastCommitDate,json=lastCommitDate" json:"LastCommitDate"`
	// LastCommitID is the commit ID of the last commit that this author made to the
	// thing that this info describes.
	LastCommitID string `protobuf:"bytes,2,opt,name=LastCommitID,json=lastCommitID,proto3" json:"LastCommitID,omitempty"`
}
...
func (*AuthorshipInfo) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{116} }
...
type DefAuthor struct {
	...
	AvatarURL string `protobuf:"bytes,2,opt,name=AvatarURL,json=avatarURL,proto3" json:"AvatarURL,omitempty"`
	// DefAuthorship contains statistics about the author's contributions
	// to the def.
	DefAuthorship `protobuf:"bytes,3,opt,name=DefAuthorship,json=defAuthorship,embedded=DefAuthorship" json:""`
}
...
func (*DefAuthor) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{117} }

type DefAuthorship struct {
	AuthorshipInfo  `protobuf:"bytes,1,opt,name=AuthorshipInfo,json=authorshipInfo,embedded=AuthorshipInfo" json:""`
	Bytes           int32   `protobuf:"varint,3,opt,name=Bytes,json=bytes,proto3" json:"Bytes,omitempty"`
	BytesProportion float64 `protobuf:"fixed64,4,opt,name=BytesProportion,json=bytesProportion,proto3" json:"BytesProportion,omitempty"`
}
...
func (*DefAuthorship) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{118} }
...
func (*DefListAuthorsOptions) Descriptor() ([]byte, []int) {
	return fileDescriptorSourcegraph, []int{119}
}

type DefsListAuthorsOp struct {
	Def DefSpec                `protobuf:"bytes,1,opt,name=Def,json=def" json:"Def"`
	Opt *DefListAuthorsOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}
...
func (*DefsListAuthorsOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{120} }

type DefAuthorList struct {
	DefAuthors []*DefAuthor `protobuf:"bytes,1,rep,name=DefAuthors,json=defAuthors" json:"DefAuthors,omitempty"`
}
...
func (*DefAuthorList) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{121} }
...
type ServerConfig struct {
	...
	AppURL string `protobuf:"bytes,2,opt,name=AppURL,json=appURL,proto3" json:"AppURL,omitempty"`
	// IDKey is the server's identity key (ID key).
	IDKey string `protobuf:"bytes,7,opt,name=IDKey,json=iDKey,proto3" json:"IDKey,omitempty"`
}

func (m *ServerConfig) Reset()                    { *m = ServerConfig{} }
func (m *ServerConfig) String() string            { return proto.CompactTextString(m) }
func (*ServerConfig) ProtoMessage()               {}
func (*ServerConfig) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{122} }
...
type UserEvent struct {
	...
	UID      int32  `protobuf:"varint,2,opt,name=UID,json=uID,proto3" json:"UID,omitempty"`
	ClientID string `protobuf:"bytes,3,opt,name=ClientID,json=clientID,proto3" json:"ClientID,omitempty"`
	Service  string `protobuf:"bytes,4,opt,name=Service,json=service,proto3" json:"Service,omitempty"`
	Method   string `protobuf:"bytes,5,opt,name=Method,json=method,proto3" json:"Method,omitempty"`
	Result   string `protobuf:"bytes,6,opt,name=Result,json=result,proto3" json:"Result,omitempty"`
	// CreatedAt holds the time when this event was logged.
	CreatedAt *pbtypes.Timestamp `protobuf:"bytes,7,opt,name=CreatedAt,json=createdAt" json:"CreatedAt,omitempty"`
...
func (*UserEvent) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{123} }
...
type Event struct {
	...
	// instance.
	DeviceID string `protobuf:"bytes,3,opt,name=DeviceID,json=deviceID,proto3" json:"DeviceID,omitempty"`
	// ClientID is this Sourcegraph instance's public key fingerprint.
	ClientID string `protobuf:"bytes,4,opt,name=ClientID,json=clientID,proto3" json:"ClientID,omitempty"`
	// Timestamp records the instant when this event was logged.
	Timestamp *pbtypes.Timestamp `protobuf:"bytes,5,opt,name=Timestamp,json=timestamp" json:"Timestamp,omitempty"`
	// UserProperties holds metadata relating to user who performed this
	// action, eg. "Email".
	UserProperties map[string]string `protobuf:"bytes,6,rep,name=UserProperties,json=userProperties" json:"UserProperties,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	EventProperties map[string]string `protobuf:"bytes,7,rep,name=EventProperties,json=eventProperties" json:"EventProperties,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (m *Event) Reset()                    { *m = Event{} }
func (m *Event) String() string            { return proto.CompactTextString(m) }
func (*Event) ProtoMessage()               {}
func (*Event) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{124} }
...
type EventList struct {
	...
	AppURL string `protobuf:"bytes,3,opt,name=AppURL,json=appURL,proto3" json:"AppURL,omitempty"`
}

func (m *EventList) Reset()                    { *m = EventList{} }
func (m *EventList) String() string            { return proto.CompactTextString(m) }
func (*EventList) ProtoMessage()               {}
func (*EventList) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{125} }
...
type Annotation struct {
	...
	StartByte uint32 `protobuf:"varint,2,opt,name=StartByte,json=startByte,proto3" json:"StartByte"`
	// EndByte is the end of the byte range.
	EndByte uint32 `protobuf:"varint,3,opt,name=EndByte,json=endByte,proto3" json:"EndByte"`
	...
	Def bool `protobuf:"varint,7,opt,name=Def,json=def,proto3" json:"Def,omitempty"`
	...
	// nested more deeply.
	WantInner int32 `protobuf:"varint,5,opt,name=WantInner,json=wantInner,proto3" json:"WantInner,omitempty"`
...
func (*Annotation) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{126} }

// AnnotationList is a list of annotations.
type AnnotationList struct {
	Annotations    []*Annotation `protobuf:"bytes,1,rep,name=Annotations,json=annotations" json:"Annotations,omitempty"`
	LineStartBytes []uint32      `protobuf:"varint,2,rep,name=LineStartBytes,json=lineStartBytes" json:"LineStartBytes,omitempty"`
}
...
func (*AnnotationList) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{127} }
...
type AnnotationsListOptions struct {
	...
	Range *FileRange `protobuf:"bytes,2,opt,name=Range,json=range" json:"Range,omitempty"`
	// NoSrclibAnns indicates whether or not srclib annotations should be
	// excluded in the returned list of annotations.
	NoSrclibAnns bool `protobuf:"varint,3,opt,name=NoSrclibAnns,json=noSrclibAnns,proto3" json:"NoSrclibAnns,omitempty"`
}
...
type AnnotationsGetDefAtPosOptions struct {
	...
	Line uint32 `protobuf:"varint,2,opt,name=Line,json=line,proto3" json:"Line,omitempty"`
	// Character specifies the character of the ref in the line (zero based).
	Character uint32 `protobuf:"varint,3,opt,name=Character,json=character,proto3" json:"Character,omitempty"`
}
...
type SearchOptions struct {
	...
	Repos []int32 `protobuf:"varint,1,rep,name=Repos,json=repos" json:"Repos,omitempty" url:",omitempty"`
	// NotRepos is the list of repos from which to exclude results.
	// If empty, then no repositories are excluded.
	NotRepos []int32 `protobuf:"varint,2,rep,name=NotRepos,json=notRepos" json:"NotRepos,omitempty" url:",omitempty"`
	...
	Languages []string `protobuf:"bytes,6,rep,name=Languages,json=languages" json:"Languages,omitempty"`
	// NotLanguages, if specified, excludes the specified languages from the
	// returned results.
	//
	// The values are case-insensitive, e.g. "java", "Java", and "jAvA" will
	// all exclude the Java programming language.
	NotLanguages []string `protobuf:"bytes,7,rep,name=NotLanguages,json=notLanguages" json:"NotLanguages,omitempty"`
	// Kinds, if specified, limits the returned results to just the specified
	// kinds of definitions (func, var, etc).
	Kinds []string `protobuf:"bytes,8,rep,name=Kinds,json=kinds" json:"Kinds,omitempty"`
	// NotKinds, if specified, excludes the specified kinds of definitions
	// (func, var, etc) from the returned results.
	NotKinds []string `protobuf:"bytes,9,rep,name=NotKinds,json=notKinds" json:"NotKinds,omitempty"`
	// ListOptions specifies options for paginating
	// the result.
	ListOptions `protobuf:"bytes,3,opt,name=ListOptions,json=listOptions,embedded=ListOptions" json:""`
	// IncludeRepos indicates whether to include repository search results.
	IncludeRepos bool `protobuf:"varint,4,opt,name=IncludeRepos,json=includeRepos,proto3" json:"IncludeRepos,omitempty"`
	...
	Fast bool `protobuf:"varint,10,opt,name=Fast,json=fast,proto3" json:"Fast,omitempty"`
	...
	AllowEmpty bool `protobuf:"varint,11,opt,name=AllowEmpty,json=allowEmpty,proto3" json:"AllowEmpty,omitempty"`
}

func (m *SearchOptions) Reset()                    { *m = SearchOptions{} }
func (m *SearchOptions) String() string            { return proto.CompactTextString(m) }
func (*SearchOptions) ProtoMessage()               {}
func (*SearchOptions) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{130} }
...
type SearchOp struct {
	...
	Opt *SearchOptions `protobuf:"bytes,2,opt,name=Opt,json=opt" json:"Opt,omitempty"`
}

func (m *SearchOp) Reset()                    { *m = SearchOp{} }
func (m *SearchOp) String() string            { return proto.CompactTextString(m) }
func (*SearchOp) ProtoMessage()               {}
func (*SearchOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{131} }

// RepoSearchResult holds a result of a global repo search.
type RepoSearchResult struct {
	// Repo represents a source code repository.
	Repo *Repo `protobuf:"bytes,1,opt,name=Repo,json=repo" json:"Repo,omitempty"`
}
...
func (*RepoSearchResult) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{132} }
...
func (*SearchReposOp) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{133} }
...
func (*SearchReposResultList) Descriptor() ([]byte, []int) {
	return fileDescriptorSourcegraph, []int{134}
}

// DefSearchResult holds a result of a global def search.
type DefSearchResult struct {
	// Def is the def matching the search query.
	Def `protobuf:"bytes,1,opt,name=Def,json=def,embedded=Def" json:""`
	// Score is the computed relevance of this result to the search query.
	Score float32 `protobuf:"fixed32,2,opt,name=Score,json=score,proto3" json:"Score,omitempty"`
	// RefCount is global ref count for this def.
	RefCount int32 `protobuf:"varint,3,opt,name=RefCount,json=refCount,proto3" json:"RefCount,omitempty"`
}
...
func (*DefSearchResult) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{135} }
...
type SearchResultsList struct {
	...
	RepoResults []*RepoSearchResult `protobuf:"bytes,1,rep,name=RepoResults,json=repoResults" json:"RepoResults,omitempty"`
	// DefResults is the list of def search results
	DefResults []*DefSearchResult `protobuf:"bytes,2,rep,name=DefResults,json=defResults" json:"DefResults,omitempty"`
	// SearchOptions is a list of options to a global search query.
	SearchQueryOptions []*SearchOptions `protobuf:"bytes,3,rep,name=SearchQueryOptions,json=searchQueryOptions" json:"SearchQueryOptions,omitempty"`
}
...
func (*SearchResultsList) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{136} }
...
func init() {
	...
	proto.RegisterType((*RequestPasswordResetOp)(nil), "sourcegraph.RequestPasswordResetOp")
...
type AccountsClient interface {
	...
	RequestPasswordReset(ctx context.Context, in *RequestPasswordResetOp, opts ...grpc.CallOption) (*PendingPasswordReset, error)
	...
	Delete(ctx context.Context, in *UserSpec, opts ...grpc.CallOption) (*pbtypes1.Void, error)
}
...
func (c *accountsClient) RequestPasswordReset(ctx context.Context, in *RequestPasswordResetOp, opts ...grpc.CallOption) (*PendingPasswordReset, error) {
...
func (c *accountsClient) Delete(ctx context.Context, in *UserSpec, opts ...grpc.CallOption) (*pbtypes1.Void, error) {
	out := new(pbtypes1.Void)
...
type AccountsServer interface {
	...
	// RequestPasswordReset stores a password reset token in the database, to
	// later verify the authenticity of a user using CheckResetToken
	RequestPasswordReset(context.Context, *RequestPasswordResetOp) (*PendingPasswordReset, error)
	// CheckResetToken verifies a password reset token is authentic and valid
	...
	// Delete deletes a user account from this server.
	Delete(context.Context, *UserSpec) (*pbtypes1.Void, error)
}
...
func (m *UpdateEmailsOp) MarshalTo(data []byte) (int, error) {
	...
	n62, err := m.UserSpec.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n62
	if m.Add != nil {
		...
		n63, err := m.Add.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n63
...
func (m *RequestPasswordResetOp) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *RequestPasswordResetOp) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RepoTreeGetOptions) MarshalTo(data []byte) (int, error) {
	...
	n87, err := m.GetFileOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n87
...
func (m *GetFileOptions) MarshalTo(data []byte) (int, error) {
	...
	n88, err := m.FileRange.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n88
...
func (m *RepoTreeSearchOptions) MarshalTo(data []byte) (int, error) {
	...
	n89, err := m.SearchOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n89
...
func (m *RepoTreeSearchResult) MarshalTo(data []byte) (int, error) {
	...
	n90, err := m.SearchResult.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n90
	...
	n91, err := m.RepoRev.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n91
...
func (m *RepoTreeGetOp) MarshalTo(data []byte) (int, error) {
	...
	n92, err := m.Entry.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n92
...
func (m *RepoTreeSearchOp) MarshalTo(data []byte) (int, error) {
	...
	n94, err := m.Rev.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n94
...
func (m *RepoTreeListOp) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Rev.Size()))
	n96, err := m.Rev.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n96
...
func (m *TreeEntry) MarshalTo(data []byte) (int, error) {
	...
	if m.BasicTreeEntry != nil {
		...
		n98, err := m.BasicTreeEntry.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n98
	...
	if m.FileRange != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.FileRange.Size()))
		n99, err := m.FileRange.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n99
...
func (m *TreeEntrySpec) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.RepoRev.Size()))
	n100, err := m.RepoRev.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n100
...
func (m *AuthorshipInfo) MarshalTo(data []byte) (int, error) {
	...
	n101, err := m.LastCommitDate.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n101
...
func (m *DefAuthor) MarshalTo(data []byte) (int, error) {
	...
	n102, err := m.DefAuthorship.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n102
...
func (m *DefAuthorship) MarshalTo(data []byte) (int, error) {
	...
	n103, err := m.AuthorshipInfo.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n103
...
func (m *DefListAuthorsOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListOptions.Size()))
	n104, err := m.ListOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n104
...
func (m *UserEvent) MarshalTo(data []byte) (int, error) {
	...
	if m.CreatedAt != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.CreatedAt.Size()))
		n107, err := m.CreatedAt.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n107
...
func (m *AnnotationsListOptions) MarshalTo(data []byte) (int, error) {
	...
	if m.Range != nil {
		...
		n110, err := m.Range.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n110
...
func (m *SearchOptions) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.ListOptions.Size()))
	n112, err := m.ListOptions.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n112
...
func (m *RepoSearchResult) MarshalTo(data []byte) (int, error) {
	...
	if m.Repo != nil {
		...
		i++
		i = encodeVarintSourcegraph(data, i, uint64(m.Repo.Size()))
		n114, err := m.Repo.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n114
...
func (m *DefSearchResult) MarshalTo(data []byte) (int, error) {
	...
	i++
	i = encodeVarintSourcegraph(data, i, uint64(m.Def.Size()))
	n115, err := m.Def.MarshalTo(data[i:])
	if err != nil {
		return 0, err
	}
	i += n115
...
func (m *RequestPasswordResetOp) Size() (n int) {
	var l int
	_ = l
	l = len(m.Email)
	if l > 0 {
...
func (m *RequestPasswordResetOp) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RequestPasswordResetOp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RequestPasswordResetOp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorSourcegraph = []byte{
	...
	,
}
