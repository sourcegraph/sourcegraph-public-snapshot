...
// ExamplesList lists the locations for examples for a def.
type ExamplesList struct {
	// RepoRefs holds the repos and files for the selected examples.
	RepoRefs []*DefRepoRef `protobuf:"bytes,1,rep,name=RepoRefs" json:"RepoRefs,omitempty"`
	// Selected refs is a mapping from repo refs to the index of a ref selected
	// as a usage example.
	//
	// TODO this is a temporary format until the front-end can properly support
	// displaying specific examples independent of repo refs.
	SelectedRefs map[string]int32 `protobuf:"bytes,2,rep,name=SelectedRefs" json:"SelectedRefs,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}

func (m *ExamplesList) Reset()                    { *m = ExamplesList{} }
func (m *ExamplesList) String() string            { return proto.CompactTextString(m) }
func (*ExamplesList) ProtoMessage()               {}
func (*ExamplesList) Descriptor() ([]byte, []int) { return fileDescriptorSourcegraph, []int{104} }
...
func init() {
	...
	proto.RegisterType((*ExamplesList)(nil), "sourcegraph.ExamplesList")
...
type DefsClient interface {
	...
	ListExamples(ctx context.Context, in *DefsListExamplesOp, opts ...grpc.CallOption) (*ExamplesList, error)
...
func (c *defsClient) ListExamples(ctx context.Context, in *DefsListExamplesOp, opts ...grpc.CallOption) (*ExamplesList, error) {
	out := new(ExamplesList)
...
type DefsServer interface {
	...
	// ListExamples lists usage examples for a given def.
	ListExamples(context.Context, *DefsListExamplesOp) (*ExamplesList, error)
	// ListAuthors lists people who committed parts of def's definition.
...
func (m *ExamplesList) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *ExamplesList) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.SelectedRefs) > 0 {
		for k, _ := range m.SelectedRefs {
			data[i] = 0x12
			i++
			v := m.SelectedRefs[k]
			mapSize := 1 + len(k) + sovSourcegraph(uint64(len(k))) + 1 + sovSourcegraph(uint64(v))
			...
			data[i] = 0x10
			i++
			i = encodeVarintSourcegraph(data, i, uint64(v))
		}
	}
	return i, nil
}
...
func (m *ExamplesList) Size() (n int) {
	var l int
	_ = l
	if len(m.RepoRefs) > 0 {
		for _, e := range m.RepoRefs {
	...
	if len(m.SelectedRefs) > 0 {
		for k, v := range m.SelectedRefs {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovSourcegraph(uint64(len(k))) + 1 + sovSourcegraph(uint64(v))
...
func (m *ExamplesList) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ExamplesList: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ExamplesList: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SelectedRefs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SelectedRefs == nil {
				m.SelectedRefs = make(map[string]int32)
			}
			m.SelectedRefs[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSourcegraph(data[iNdEx:])
...
var fileDescriptorSourcegraph = []byte{
	// 6937 bytes of a gzipped FileDescriptorProto
	,
}
