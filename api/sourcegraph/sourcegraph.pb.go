...
type User struct {
	...
	// granted access to any arbitrary beta string, but "pending" and "accepted" are
	// reserved. The three states are:
	//
	...
	//  4. `len(Betas) > 1 && InBeta("accepted")` (user granted access to one or more betas).
	//
	// The "pending" and "accepted" statuses are implicitly set as you would
	// expect, thus their present in the list can generally be thought of as
	// optional.
	//
	// To add a beta status, simply append it. The "pending" status will be
	// removed and the "accepted" status added.
	//
	// To remove a beta status, simply remove it from the slice. If the user is
	// in no more betas, the "accepted" status will be removed and "pending"
	// added.
	//
	// Only admins may set a list of non-"pending" betas.
...
type BetaRegistration struct {
	// Email is the email to register for the beta program. If it is an empty
	// string, the account's primary email address will be used.
	//
	// TODO(slimsag): this field is not currently supported. Do not use it.
	Email string `protobuf:"bytes,1,opt,name=Email,proto3" json:"Email,omitempty"`
...
var fileDescriptorSourcegraph = []byte{
	// 6830 bytes of a gzipped FileDescriptorProto
	,
}
