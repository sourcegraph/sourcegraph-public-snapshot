import { TextDocumentIdentifier } from '../../../../ui-kit-legacy-shared/src/api/client/types/textDocument'
import { TextDocumentPositionParameters } from '../../../../ui-kit-legacy-shared/src/api/protocol'
import {
