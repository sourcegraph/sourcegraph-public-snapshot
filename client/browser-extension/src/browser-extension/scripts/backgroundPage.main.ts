...
import { createExtensionHostWorker } from '../../../../ui-kit-legacy-shared/src/api/extension/worker'
import { GraphQLResult, requestGraphQLCommon } from '../../../../ui-kit-legacy-shared/src/graphql/graphql'
...
import { isDefined } from '../../../../ui-kit-legacy-shared/src/util/types'
import { browserPortToMessagePort, findMessagePorts } from '../../shared/platform/ports'
import { EndpointPair } from '../../../../ui-kit-legacy-shared/src/platform/context'
