...
export const POSITION_VARIANTS = {
	[Position.topLeft]: {
		...
		elementAttachments: createPoint(0.0, 1.0),
		targetAttachments: createPoint(0.0, 0.0),
	...
	[Position.topCenter]: {
		...
		elementAttachments: createPoint(0.5, 1.0),
		targetAttachments: createPoint(0.5, 0.0),
		targetOffset: createPoint(0, 1),
	},
	[Position.topRight]: {
		positionSides: Side.top,
		...
		elementAttachments: createPoint(1.0, 1.0),
		targetAttachments: createPoint(1.0, 0.0),
		targetOffset: createPoint(0, 1),
	},
	[Position.rightTop]: {
		...
		elementAttachments: createPoint(0.0, 0.0),
		targetAttachments: createPoint(1.0, 0.0),
	...
	[Position.rightMiddle]: {
		...
		elementAttachments: createPoint(0.0, 0.5),
		targetAttachments: createPoint(1.0, 0.5),
		targetOffset: createPoint(1, 0),
	},
	[Position.rightBottom]: {
		...
		elementAttachments: createPoint(0.0, 1.0),
		targetAttachments: createPoint(1.0, 1.0),
		targetOffset: createPoint(1, 0),
	},
	[Position.bottomLeft]: {
		...
		elementAttachments: createPoint(0.0, 0.0),
		targetAttachments: createPoint(0.0, 1.0),
		targetOffset: createPoint(0, 1),
	},
	[Position.bottomCenter]: {
		...
		elementAttachments: createPoint(0.5, 0.0),
		targetAttachments: createPoint(0.5, 1.0),
		targetOffset: createPoint(0, 1),
	},
	[Position.bottomRight]: {
		...
		elementAttachments: createPoint(1.0, 0.0),
		targetAttachments: createPoint(1.0, 1.0),
		targetOffset: createPoint(0, 1),
	},
	[Position.leftTop]: {
	...
	[Position.leftMiddle]: {
		...
		elementAttachments: createPoint(1.0, 0.5),
		targetAttachments: createPoint(0.0, 0.5),
		targetOffset: createPoint(1, 0),
	},
	[Position.leftBottom]: {
		positionSides: Side.left,
