...
storiesOf('wildcard/Container', module)
    .addDecorator(story => (
            ...
            <>
                <div className="alert alert-info">
                    <p>
                        ...
                        header, optionally a description for the page and the container itself. Depending on the scope
                        of a button, it should live inside or outside of the container.
                    </p>
                    <p>If the button</p>
                    <ul className="mb-0">
                        <li>
                        ...
                        <li>
                            affects just a subset of content inside the container (ie. submits one of multiple forms),
                            it should live inside of the container, next to the content it is modifying. See example 2
                        </li>
                    </ul>
                </div>
                <hr />
