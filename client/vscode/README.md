...
| sourcegraph.proxyHost             | The host to use when proxying requests to the Sourcegraph instance. It shouldn't include a protocol (like "http://") or a port (like ":7080")                                                        | "localhost"                                                  |
| sourcegraph.proxyPort             | The port to use when proxying requests to the Sourcegraph instance.                                                                                                                                  | 80, 443, 7080, 9090                                          |
