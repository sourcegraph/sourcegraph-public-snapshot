...
| sourcegraph.accessToken           | The access token to query the Sourcegraph API. Required to use this extension with private instances. Create a new access token at `https://sourcegraph.com/users/<sourcegraph-username>/settings/tokens`                                           | "6dfc880b320dff712d9f6cfcac5cbd13ebfad1d8"                   |
