...
storiesOf('branded/Global styles', module)
    .addDecorator(story => <BrandedStory>{() => <div className="p-3 container">{story()}</div>}</BrandedStory>)
    .add(
        'Text',
        () => (
            <>
        ...
        () => (
            <>
                ...
                <p>
                    ...
                    <code>h1</code> headings. Do not use a superscript for smaller text, because the font size would
                    become too small.
                </p>
        ...
        () => {
            ...
            return (
                <>
                    ...
                    <div className="mb-2">
                        <p>
                            Button groups have no styles on their own, they just group buttons together. This means they
                            can be used to group any other semantic or outline button variant.
                        </p>
                        <div className="mb-2">
