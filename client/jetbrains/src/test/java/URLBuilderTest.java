...
public class URLBuilderTest {
  ...
  public void testBuildCommitUrl_AllValid() {
    ...
    String want =
        "https://www.sourcegraph.com/github.com/sourcegraph/sourcegraph-jetbrains.git/-/commit/1fa8d5d6286c24924b55c15ed4d1a0b85ccab4d5?editor=JetBrains&version=v1.2.2&utm_product_name=intellij&utm_product_version=1.1";
  ...
  public void testBuildCommitUrl_MissingRevision(String revision) {
    ...
    assertThrows(
        ...
        () ->
            URLBuilder.buildCommitUrl(
                "https://www.sourcegraph.com", revision, remoteUrl, "intellij", "1.1"));
  }
  ...
  public void testBuildCommitUrl_MissingBaseUri(String baseUri) {
    ...
    assertThrows(
        ...
        () ->
            URLBuilder.buildCommitUrl(
                baseUri, "1fa8d5d6286c24924b55c15ed4d1a0b85c44b4d5", remoteUrl, "intellij", "1.1"));
  }
