...
/**
 * Base class for account management application service, with listeners for account added/removed
 * Accounts are stored in [accountsRepository]
 * Credentials are serialized and stored in [passwordSafe]
 *
 * @see [AccountsListener]
 */
abstract class CustomAccountManagerBase<A : Account, Cred>(private val serviceName: String)
