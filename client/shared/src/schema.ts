...
export interface IBatchSpecsOnBatchChangeArguments {
     ...
     */
    excludeEmptySpecs?: boolean | null
}
...
export interface IBlobOnGitCommitArguments {
    ...
    /**
     * Return blob content starting at line "startLine".
     */
    startLine?: number | null

    /**
     * Return blob content ending at line "endLine".
     */
    endLine?: number | null
}
 ...
 */
export type StatusMessage = ICloningProgress | IExternalServiceSyncError | ISyncError | IIndexingProgress
