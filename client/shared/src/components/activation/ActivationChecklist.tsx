...
export const ActivationChecklistItem: React.FunctionComponent<ActivationChecklistItemProps> = ({
    ...
    <div className={classNames('d-flex justify-content-between', styles.activationChecklistItem, className)}>
        <div className="d-flex align-items-center">
            <span className={classNames(styles.iconContainer, styles.iconDown)}>
                <Icon className={styles.icon} as={ChevronDownIcon} />
            </span>
            <span className={classNames(styles.iconContainer, styles.iconRight)}>
                <Icon className={styles.icon} as={ChevronRightIcon} />
            </span>
