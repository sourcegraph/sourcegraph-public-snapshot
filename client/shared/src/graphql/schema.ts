...
export interface IMutation {
    ...
    /**
     * Replaces the original input of the batch spec. All existing resolution jobs
     * and workspaces are deleted and recreated in the background as the `on` section
     * is evaluated. This mutation is used for overwriting existing resolutions, so
     * after typing in the editor, we don't create 10s of batch specs.
     */
     ...
     * a final state (COMPLETED, FAILED) to be retryable.
     */
    retryBatchSpecExecution: IEmptyResponse
...
export interface ISearch {
    ...
    /**
     * The suggestions.
     * @deprecated "Suggestions now done with streaming search. This field is deprecated and will be removed in a future release."
     */
 ...
 * A search suggestion.
 */
export type SearchSuggestion = IRepository | IFile | ISymbol | ILanguage | ISearchContext
