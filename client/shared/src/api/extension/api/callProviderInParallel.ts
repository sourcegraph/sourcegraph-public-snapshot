        ...
        switchMap(providers =>
            ...
            concat(of(null), from(providers)).pipe(
                ...
                scan((accumulator, current) => {
                    ...
                    return accumulator
                }, [null, ...providers.map(provider => ({ id: provider.id, view: undefined }))] as [null, (undefined | { id: string, view: sourcegraph.View | null | undefined | ErrorLike })]),
            ),
        ),
