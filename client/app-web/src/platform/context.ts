...
import { createExtensionHost } from '../../../ui-kit-legacy-shared/src/api/extension/worker'
...
import { mutateSettings, updateSettings } from '../../../ui-kit-legacy-shared/src/settings/edit'
import { gqlToCascade } from '../../../ui-kit-legacy-shared/src/settings/settings'
import { createAggregateError, asError } from '../../../ui-kit-legacy-shared/src/util/errors'
import { LocalStorageSubject } from '../../../ui-kit-legacy-shared/src/util/LocalStorageSubject'
import {
    toPrettyBlobURL,
    RepoFile,
    UIPositionSpec,
...
import { Tooltip } from '../../../ui-kit-legacy-branded/src/components/tooltip/Tooltip'
