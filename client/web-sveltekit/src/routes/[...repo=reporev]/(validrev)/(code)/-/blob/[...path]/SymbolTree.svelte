<script lang="ts" context="module">
    ...
    export class SymbolTree implements TreeProvider<Symbol> {
        ...
        public static fromOccurrences(occurrences: Occurrence[]): SymbolTree {
            const definitions = occurrences.filter(occ => ((occ.symbolRoles ?? 0) & SymbolRole.Definition) > 0)
        }
...
<script lang="ts">
    ...
    import type { Occurrence, SymbolRole } from '$lib/shared'
