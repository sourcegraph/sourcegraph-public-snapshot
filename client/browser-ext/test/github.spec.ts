	...
	describe("blob view", () => {
		...
		describe("annotations", () => {
			...
			it("should convert element node", () => {
				...
				const convertedNode = annotations.convertElementNode(_codeCells[4].cell, 1, 5, false, 0);
			...
			it("should convert text node", () => {
				...
				const convertedNode = annotations.convertTextNode(_codeCells[17].cell.childNodes[2], 8, 18, false, 0);
			...
			it("should convert node (stress test)", () => {
				...
				const convertedNode = annotations.convertElementNode(_codeCells[17].cell, 1, 18, false, 0);
	...
	describe("PR unified diff", () => {
		...
		describe("annotations", () => {
			...
			it("should convert deletion node (stress test)", () => {
				...
				const convertedNode = annotations.convertElementNode(codeCells[0].cell, 1, 80, false, 0);
			...
			it("should convert addition node (stress test)", () => {
				...
				const convertedNode = annotations.convertElementNode(codeCells[4].cell, 1, 57, false, 0);
