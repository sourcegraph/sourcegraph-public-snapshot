	...
	describe("blob view", () => {
		...
		describe("annotations", () => {
			...
			it("should convert node (stress test)", () => {
				...
				expect(convertedNode.resultNode.innerHTML).to.eql(`<span id="text-node-wrapper-319"><span id="text-node-319-1" data-byteoffset="1">\t</span></span><span data-byteoffset="2" class="pl-k"><span id="text-node-wrapper-320"><span id="text-node-320-2" data-byteoffset="2">return</span></span></span><span id="text-node-wrapper-326"><span id="text-node-326-8" data-byteoffset="8"> &amp;</span><span id="text-node-326-10" data-byteoffset="10">Router</span><span id="text-node-326-16" data-byteoffset="16">{</span><span id="text-node-326-17" data-byteoffset="17">namedRoutes</span><span id="text-node-326-28" data-byteoffset="28">: </span></span><span data-byteoffset="30" class="pl-c1"><span class="pl-c1">make</span></span><span id="text-node-wrapper-352"><span id="text-node-352-34" data-byteoffset="34">(</span></span><span data-byteoffset="35" class="pl-k"><span id="text-node-wrapper-353"><span id="text-node-353-35" data-byteoffset="35">map</span></span></span><span id="text-node-wrapper-356"><span id="text-node-356-38" data-byteoffset="38">[</span></span><span data-byteoffset="39" class="pl-k"><span id="text-node-wrapper-357"><span id="text-node-357-39" data-byteoffset="39">string</span></span></span><span id="text-node-wrapper-363"><span id="text-node-363-45" data-byteoffset="45">]*</span><span id="text-node-363-47" data-byteoffset="47">Route</span><span id="text-node-363-52" data-byteoffset="52">), </span><span id="text-node-363-55" data-byteoffset="55">KeepContext</span><span id="text-node-363-66" data-byteoffset="66">: </span></span><span data-byteoffset="68" class="pl-c1"><span class="pl-c1">false</span></span><span id="text-node-wrapper-391"><span id="text-node-391-73" data-byteoffset="73">}</span></span>`);
			});
