...
function convertNode(parentNode: HTMLElement): void {
	for (let i = 0; i < parentNode.childNodes.length; ++i) {
		...
		} else if (node.nodeType === Node.ELEMENT_NODE && (node as HTMLElement).children.length > 0) {
 ...
 */
function getTargetLineAndOffset(target: HTMLElement, ignoreFirstChar: boolean = false): { line: number, char: number } | undefined {
