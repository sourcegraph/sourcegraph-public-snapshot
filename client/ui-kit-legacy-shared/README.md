...
Code that is only used in branded contexts (web app, options menu of the browser extension, ...) should go into [`../ui-kit-legacy-branded`](../ui-kit-legacy-branded) instead.
