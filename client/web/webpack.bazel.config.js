...
const NPM_JSX = [
  'react-visibility-sensor/visibility-sensor.js'
]
...
const config = {
  ...
  devtool: IS_PRODUCTION ? 'source-map' : 'source-map', //TODO: WEBPACK_DEVELOPMENT_DEVTOOL,
  plugins: [
    ...
    //   }),
    // ...(WEBPACK_SERVE_INDEX || true ? getHTMLWebpackPlugins() : []),
