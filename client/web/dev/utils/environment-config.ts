...
export const ENVIRONMENT_CONFIG = {
    ...
    OTEL_TRACING_COLLECTOR_URL: process.env.OTEL_TRACING_COLLECTOR_URL || 'https://0.0.0.0:4318/v1/traces',
    OTEL_METRICS_COLLECTOR_URL: process.env.OTEL_METRICS_COLLECTOR_URL || 'https://0.0.0.0:4318/v1/metrics',
}
