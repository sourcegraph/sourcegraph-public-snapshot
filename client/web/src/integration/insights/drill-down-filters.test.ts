...
describe('Backend insight drill down filters', () => {
    ...
    it(
        'should update user settings if drill-down filters have been persisted',
        async () => {
    ...
    it(
        'should create a new insight with predefined filters via drill-down flow insight creation',
        async () => {
            const userSubjectSettigns = {
                'insights.allrepos': {
                    'searchInsights.insight.backend_ID_001': {
