...
import { createEditorAPI, EditorAPI, percySnapshotWithVariants } from './utils'
...
describe('Blob viewer', () => {
    ...
    const commonBlobGraphQlResults: Partial<WebGraphQlOperations & SharedGraphQlOperations> = {
        ...
        ...createViewerSettingsGraphQLOverride({ user: { experimentalFeatures: { enableCodeMirrorFileView: true } } }),
    ...
    describe('extensibility', () => {
        ...
        function lineAt(line: number): string {
            return `[data-testid=repo-blob] .cm-line:nth-child(${line})`
        }
            ...
            testContext.overrideGraphQL({
                ...
                ...createViewerSettingsGraphQLOverride({
                    user: {
                        ...
                        extensions: mockExtensions.reduce(
                            (extensionsSettings: Record<string, boolean>, mockExtension) => {
