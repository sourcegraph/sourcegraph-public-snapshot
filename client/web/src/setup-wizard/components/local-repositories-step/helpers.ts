 ...
 */
export function getLocalService(data?: GetLocalCodeHostsResult): LocalCodeHost | null {
    if (!data) {
        return null
    }

    return data.localExternalServices.find(service => !service.autogenerated) ?? null
}
