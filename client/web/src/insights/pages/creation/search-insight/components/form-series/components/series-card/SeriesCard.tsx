        ...
        >
            <div className={styles.cardInfo}>
                <div className={classnames('mb-1 ', styles.cardTitle)}>
                    ...
                    <span data-test-id='series-name' title={name} className={classnames(styles.cardName, 'ml-1 font-weight-bold')}>
                        {name}
                    </span>
                </div>

                <span data-test-id='series-query' className="mb-0 text-muted">{query}</span>
            </div>

            <div className="d-flex align-items-center">
                <button data-test-id='series-edit-button' type="button" onClick={onEdit} className="border-0 btn btn-outline-primary">
                    Edit
                </button>

                <button data-test-id='series-delete-button' type="button" onClick={onRemove} className="border-0 btn btn-outline-danger ml-1">
                    Remove
                </button>
            </div>
        </li>
