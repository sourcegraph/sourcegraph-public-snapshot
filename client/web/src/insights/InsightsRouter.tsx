 ...
 */
export interface InsightsRouterProps extends RouteComponentProps, Omit<InsightsPageProps, 'isCreationUIEnabled'>, CreateInsightPageProps {}
    ...
    return (
        <Switch>
            <Route
                ...
                render={props => <InsightsLazyPage
                    isCreationUIEnabled={!!isCreationUIEnabled}
                    {...outerProps}
                    {...props} />}
                path={match.url}
                exact={true}
