...
export const NotebookCommandPaletteInput: React.FunctionComponent<NotebookCommandPaletteInputProps> = ({
    index,
    onAddBlock,
    ...
    const onKeyDown = useCallback(
        ...
        [selectedOptionId, focusOption, getNextOptionId, onFocusPreviousBlock, getPreviousOptionId, closeCommandPalette]
    )
        ...
        <div className={styles.root} ref={rootReference} data-testid="notebook-command-palette">
            <div className={styles.inputRow}>
                <input
                    ...
                    // This attribute allows us to find the input and focus it from other components in the notebook
