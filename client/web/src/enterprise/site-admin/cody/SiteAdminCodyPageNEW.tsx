...
import { RepoEmbeddingJobNodeNew } from './RepoEmbeddingJobNode'
...
// TODO: remove suffice "NEW"

export const SiteAdminCodyPageNew: FC<SiteAdminCodyPageProps> = ({ telemetryService }) => {
    useEffect(() => {
        ...
        <>
            ...
            <Container>
                ...
                >
                    ...
                    nodeComponent={RepoEmbeddingJobNodeNew}
                    hideSearch={true}
                    updates={refresh}
