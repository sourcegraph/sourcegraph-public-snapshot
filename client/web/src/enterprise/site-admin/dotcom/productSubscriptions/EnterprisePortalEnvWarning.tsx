...
export const EnterprisePortalEnvWarning: React.FunctionComponent<EnterprisePortalEnvWarningProps> = ({
    ...
    return (
        <Alert variant="danger" className={className}>
            <Text>
                You are {actionText} for the <strong>{env}</strong> Enterprise Portal instance. Everything you do on
                this instance will only be visible to non-production environments that connect to this specific
