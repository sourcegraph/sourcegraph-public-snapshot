                ...
                <Form onSubmit={onSubmit}>
                    <div className="form-group">
                        ...
                        <small className="form-text text-muted">
                            ...
                            limit), <code>trial</code> (shows a "trial" indicator), <code>dev</code> (shows a "for
                            development only" indicator). Separate multiple with commas and no spaces (like{' '}
                            <code>true-up,trial</code>
