...
export const ProductCertificate: React.FunctionComponent<Props> = ({
    ...
    <div className={classNames(styles.productCertificate, 'card', className, 'test-product-certificate')}>
        <div className="card-body d-flex align-items-center">
            <img
                className={classNames(styles.productCertificateLogo, 'mr-1', 'p-2')}
        ...
        <div className={styles.productCertificateBg} />
        {footer}
    </div>
)
