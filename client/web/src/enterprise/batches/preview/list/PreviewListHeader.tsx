...
export const PreviewListHeader: React.FunctionComponent<React.PropsWithChildren<PreviewListHeaderProps>> = ({
    ...
    <>
        ...
        <H5 as={Typography.H3} className="p-2 d-none d-sm-block text-uppercase text-center">
            Current state
        </H5>
        <H5 as={Typography.H3} className="d-none d-sm-block text-uppercase text-center">
            +<br />-
        </H5>
        <H5 as={Typography.H3} className="p-2 d-none d-sm-block text-uppercase text-nowrap">
            Actions
        </H5>
        <H5 as={Typography.H3} className="p-2 d-none d-sm-block text-uppercase text-nowrap">
            Changeset information
        </H5>
        <H5 as={Typography.H3} className="p-2 d-none d-sm-block text-uppercase text-center text-nowrap">
            Commit changes
        </H5>
        <H5 as={Typography.H3} className="p-2 d-none d-sm-block text-uppercase text-center text-nowrap">
            Change state
