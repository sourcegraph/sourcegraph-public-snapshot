...
const completedSteps: LsifIndexStepsFields = {
    ...
    upload: {
        ...
        out: trim(`
            ...
            stdout:    \\u001b[?25h
            stdout: \\u001b[?25h\\u001b[?25l💡 View processing status at https://sourcegraph.com/github.com/kubernetes/kubernetes/-/settings/code-intelligence/uploads/TFNJRlVwbG9hZDoiNTUyNzg3Ig==
            stdout: \\u001b[?25h
        `),
