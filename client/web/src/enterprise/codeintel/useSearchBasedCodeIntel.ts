...
import { Position as ExtensionPosition, Range as ExtensionRange } from '@sourcegraph/extension-api-types'
...
import { buildSearchBasedLocation, Location, split } from '../../codeintel/location'
