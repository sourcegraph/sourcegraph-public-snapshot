...
const TS_VS_GO: Template = {
    ...
    description: 'Codebase Topline Metrics: are there more Typescript or more Go files.',
    templateValues: {
        title: 'Typescript vs. Go',
        allRepos: true,
        series: [
...
const IOS_APP_SCREENS: Template = {
    ...
    description: 'Codebase Topline Metrics: what number of iOS app screens are in the entire app.',
    templateValues: {
        title: 'iOS app screens',
        allRepos: true,
        series: [
...
const ADOPTING_NEW_API: Template = {
    ...
    description: 'Understanding Code by Team: which teams or repos have adopted a new API so far.',
    templateValues: {
        title: 'Adopting new API by Team',
        allRepos: true,
        series: [
