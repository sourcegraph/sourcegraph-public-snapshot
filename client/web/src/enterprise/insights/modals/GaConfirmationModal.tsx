    ...
    return (
        <>
            ...
            <div className={styles.textContent}>
                ...
                <p>
                    Code Insights is now Generally Available. <b>You can create unlimited insights and dashboards while on
                    this version of Sourcegraph.</b> In the next version upgrade, you will either need to purchase Code
