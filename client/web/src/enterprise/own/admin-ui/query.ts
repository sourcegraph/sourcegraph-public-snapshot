...
export const GET_INSTANCE_OWN_STATS = gql`
    query GetInstanceOwnStats($dateRange: AnalyticsDateRange!) {
        ownershipUsageStats(dateRange: $dateRange) {
            fileHasOwnerSearches
            selectFileOwnersSearches
            ownershipPanelViewed
        }
