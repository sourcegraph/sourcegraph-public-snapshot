    ...
    const onSubmit = useCallback(() => {
        ...
        translateToQuery(sanitizedInput, authenticatedUser).then(
            query => {
                ...
                if (query) {
                    eventLogger.log('web:codySearch:submitSucceeded', { input: sanitizedInput, translatedQuery: query }, { input: sanitizedInput, translatedQuery: query })
                    ...
                    eventLogger.log('web:codySearch:submitFailed', { input: sanitizedInput, reason: 'untranslatable' }, { input: sanitizedInput, reason: 'untranslatable' })
