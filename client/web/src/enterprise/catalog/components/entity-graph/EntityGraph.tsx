...
import { CatalogEntitiesResult, CatalogEntitiesVariables, CatalogEntityFields } from '../../../../graphql-operations'
...
export const EntityGraph: React.FunctionComponent<Props> = ({ className }) => {
