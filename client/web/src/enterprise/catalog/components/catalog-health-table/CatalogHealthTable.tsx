...
import { ComponentStateIndicator } from '../../pages/overview/components/entity-state-indicator/ComponentStateIndicator'
    ...
    return (
        <tr>
            ...
            <td className={styles.cellEntityOwner}>
                <ComponentOwner owner={node.owner} className="text-nowrap d-flex" blankIfNone={true} />
            </td>
