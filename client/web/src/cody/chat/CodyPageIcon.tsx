...
export const CodyPageIcon: React.FunctionComponent<React.PropsWithChildren<SVGProps<SVGSVGElement>>> = (
    ...
    <svg width="38" height="38" viewBox="0 0 25 20" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <path
...
export const CodyColorIcon: React.FunctionComponent<React.PropsWithChildren<SVGProps<SVGSVGElement>>> = (
    props: SVGProps<SVGSVGElement>
) => (
    <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128" {...props}>
