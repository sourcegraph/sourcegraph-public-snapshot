...
import { LoadingSpinner, Button, Link, Alert, Icon, Input } from '@sourcegraph/wildcard'
        ...
        <div>
            <div className={styles.container}>
                ...
                <Form className="form-inline align-items-start" onSubmit={onSubmit}>
                    <Input className="mb-2 mr-sm-2" id="invite-form__username" placeholder="Username" onChange={onUsernameChange} value={username} autoComplete="off" autoCapitalize="off" autoCorrect="off" required={true} spellCheck={false} size={30}
                    />
