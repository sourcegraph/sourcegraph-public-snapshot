        ...
        <>
            <Form onSubmit={handleSubmit}>
                <div className="form-group d-flex flex-column align-content-start">
                    ...
                    <Input id="username-or-email" onChange={onUsernameOrEmailFieldChange} required={true} value={usernameOrEmail} disabled={loading} autoCapitalize="off" autoFocus={true} autoComplete="username"
