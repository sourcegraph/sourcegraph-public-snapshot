...
import { GithubCodeHostScopeProvider } from './site/GitHubCodeHostScopeAlert/GithubScopeProvider'
                    ...
                    <BrowserRouter key={0}>
                        <Route
                            ...
                            render={routeComponentProps => (
                                <GithubCodeHostScopeProvider authenticatedUser={authenticatedUser}>
