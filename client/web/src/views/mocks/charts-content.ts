...
export const LINE_CHART_WITH_HUGE_NUMBER_OF_LINES: LineChartContent<any, string> = {
    ...
    series: [
        ...
        { dataKey: 'c', name: 'useTheme adoption', stroke: 'var(--blue)' },
        { dataKey: 'd', name: 'Class without CSS modules', stroke: 'var(--purple)' },
        { dataKey: 'e', name: 'Go lang version 1.11', stroke: 'var(--oc-grape-7)' },
        { dataKey: 'f', name: 'Functional components without CSS modules', stroke: 'var(--oc-red-7)' },
        { dataKey: 'g', name: 'Go lang version 1.12', stroke: 'var(--pink)' },
        { dataKey: 'h', name: 'Go lang version 1.13', stroke: 'var(--oc-violet-7)' },
        { dataKey: 'i', name: 'Go lang version 1.14', stroke: 'var(--indigo)' },
        { dataKey: 'm', name: 'Go lang version 1.15', stroke: 'var(--cyan)' },
        { dataKey: 'j', name: 'Go lang version 1.16', stroke: 'var(--teal)' },
        { dataKey: 'k', name: 'Go lang version 1.17', stroke: 'var(--oc-lime-7)' },
        { dataKey: 'l', name: 'Go lang version 1.18', stroke: 'var(--yellow)' },
        { dataKey: 'n', name: 'Go lang version 1.19', stroke: 'var(--oc-lime-7)' },
        { dataKey: 'o', name: 'Go lang version 1.20', stroke: 'var(--oc-pink-7)' },
        { dataKey: 'p', name: 'Go lang version 1.21', stroke: 'var(--oc-red-7)' },
        { dataKey: 'q', name: 'Go lang version 1.22', stroke: 'var(--oc-blue-7)' },
        { dataKey: 'r', name: 'Go lang version 1.23', stroke: 'var(--oc-grape-7)' },
        { dataKey: 's', name: 'Go lang version 1.24', stroke: 'var(--oc-green-7)' },
        { dataKey: 't', name: 'Go lang version 1.25', stroke: 'var(--oc-cyan-7)' },
    ],
    xAxis: {
        dataKey: 'x',
        scale: 'time',
