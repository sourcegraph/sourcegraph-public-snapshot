...
import { DocumentationIndexNode } from './DocumenationIndexNode'
 ...
 */
export const RepositoryDocsSidebar: React.FunctionComponent<Props> = props => {
    const [toggleSidebar, setToggleSidebar] = useLocalStorage(SIDEBAR_KEY, SIDEBAR_DEFAULT_VISIBILITY)
    const handleSidebarToggle = useCallback(() => {
        props.onToggle(!toggleSidebar);
        setToggleSidebar(!toggleSidebar);
    }, [setToggleSidebar, toggleSidebar, props.onToggle])
        ...
        <Resizable
            ...
            element={
                <div className={'d-flex flex-column w-100 border-right'}>
                    ...
                    <div
                        aria-hidden={true}
                        className={'d-flex explorer overflow-auto px-3'}
                    >
