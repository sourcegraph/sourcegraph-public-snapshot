...
export const RepoRevisionSidebarFileTree: React.FunctionComponent<Props> = props => {
    ...
    const onLoadData = useCallback(
        async ({ element }: { element: TreeNode }) => {
            ...
            telemetryRecorder.recordEvent('blob-sidebar.file-tree-directory', 'load')
            await fetchEntries({
                ...defaultVariables,
                filePath: fullPath,
                ancestors: false,
    ...
    const onSelect = useCallback(
        ({ element, isSelected }: { element: TreeNode; isSelected: boolean }) => {
            ...
            if (element.dotdot) {
                ...
                telemetryRecorder.recordEvent('blob-sidebar.file-tree-parent-link', 'click')
            ...
            if (element.entry) {
                ...
                telemetryRecorder.recordEvent('blob-sidebar.file-tree-link', 'click')
