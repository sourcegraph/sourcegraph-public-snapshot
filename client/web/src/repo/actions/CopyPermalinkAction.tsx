...
export const CopyPermalinkAction: React.FunctionComponent<CopyPermalinkActionProps> = props => {
    ...
    const onClick = (): void => {
        ...
        telemetryRecorder.recordEvent('blob.header.permalink', 'click')
    }
    ...
    const copyPermalink = (): void => {
        ...
        telemetryRecorder.recordEvent('blob.header.permalink', 'copy')
    ...
    const copyLink = (): void => {
        ...
        telemetryRecorder.recordEvent('blob.header.link', 'click')
