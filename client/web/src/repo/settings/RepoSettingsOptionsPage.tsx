                ...
                <Container className="repo-settings-options-page">
                    ...
                    <Form>
                        <div className="form-group mb-0">
                            ...
                            <Input id="repo-settings-options-page__name" readOnly={true} disabled={true} value={this.state.repo.name} required={true} spellCheck={false} autoCapitalize="off" autoCorrect="off"
                            />
                        </div>
                    </Form>
                </Container>
