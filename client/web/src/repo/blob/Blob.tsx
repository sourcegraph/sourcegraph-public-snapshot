...
import { createHoverifier, findPositionsFromEvents, HoveredToken } from '@sourcegraph/shared/src/codeintellify'
import { getCodeElementsInRange, locateTarget } from '@sourcegraph/shared/src/codeintellify/tokenPosition'
