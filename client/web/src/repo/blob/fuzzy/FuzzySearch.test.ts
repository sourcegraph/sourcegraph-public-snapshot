...
const all = ['to/the/moon.jpg', 'lol/business.txt', 'haha/business.txt', 'business/crazy.txt', 'fuzzy/business.txt']
...
checkNoFuzzyMatch('missing-separator', 'hahabusiness', 'haha/business')

checkFuzzyMatch('lowercase-insensitive', 'ha/bu', 'Haha/Business', ['Ha', 'Bu'])
