...
interface UseShowMorePaginationURLParameters extends Pick<GetUrlQueryParameters, 'first'> {
    enabled?: boolean
}
 ...
 */
export const useShowMorePaginationUrl = ({ enabled, first }: UseShowMorePaginationURLParameters): void => {
