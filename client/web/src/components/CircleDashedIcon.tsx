...
import { AccessibleSvgComponent } from '@sourcegraph/wildcard'

export const CircleDashedIcon: AccessibleSvgComponent = memo(
    ({ color = 'currentColor', size = 24, className = '', ...props }) => (
        ...
        >
            <title id="circleDashedIconTitle">Dashed circle</title>
