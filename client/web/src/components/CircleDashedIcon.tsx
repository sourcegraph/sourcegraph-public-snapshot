...
import { IconProps } from '@sourcegraph/wildcard'

export const CircleDashedIcon: React.FunctionComponent<React.PropsWithChildren<IconProps>> = memo(
    ({ color = 'currentColor', height = 24, width = 24, className = '', ...props }) => (
        <svg {...props} className={className} width={width} height={height} fill={color} viewBox="0 0 24 24">
