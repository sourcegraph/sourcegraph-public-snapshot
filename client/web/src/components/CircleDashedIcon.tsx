...
export const CircleDashedIcon: AccessibleSvg = memo(
    ({ color = 'currentColor', height = 24, width = 24, className = '', ...props }) => (
        <svg
            {...props}
            className={className}
            width={width}
            ...
            fill={color}
            viewBox="0 0 24 24"
            aria-labelledby="circleDashedIconTitle"
        >
            {'title' in props ? <title id="circleDashedIconTitle">{props.title}</title> : null}
