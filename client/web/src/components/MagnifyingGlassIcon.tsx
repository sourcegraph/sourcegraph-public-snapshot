...
export const MagnifyingGlassIcon: React.FunctionComponent<{ className?: string; fillCurrentColor?: boolean }> = ({
    className,
    fillCurrentColor,
}) => (
    <svg className={className} width="55" height="55" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
            ...
            fill={!fillCurrentColor ? '#F96216' : 'currentColor'}
        />
        <path
            ...
            fill={!fillCurrentColor ? '#A6B6D9' : 'currentColor'}
        />
    </svg>
)
