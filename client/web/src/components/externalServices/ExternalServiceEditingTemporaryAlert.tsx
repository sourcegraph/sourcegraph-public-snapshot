...
export const ExternalServiceEditingTemporaryAlert: React.FunctionComponent<React.PropsWithChildren<{}>> = () => (
    <Alert variant="warning">
        ...
        <Text className="mb-0">
            ...
            <Code>EXTSVC_CONFIG_FILE</Code>. Every change made through the UI will be undone with the next restart and
            code host connection configuration is reset to the contents of <Code>EXTSVC_CONFIG_FILE</Code>.
        </Text>
    </Alert>
)
