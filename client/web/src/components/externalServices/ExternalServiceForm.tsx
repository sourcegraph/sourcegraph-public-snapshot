...
import { Button, LoadingSpinner, Alert, Input } from '@sourcegraph/wildcard'
        ...
        <Form className="external-service-form" onSubmit={onSubmit}>
            ...
            {hideDisplayNameField || (
                <div className="form-group">
                    ...
                    <Input id="test-external-service-form-display-name" required={true} autoCorrect="off" autoComplete="off" autoFocus={autoFocus} spellCheck={false} value={input.displayName} onChange={onDisplayNameChange} disabled={loading}
                    />
                </div>
            )}
