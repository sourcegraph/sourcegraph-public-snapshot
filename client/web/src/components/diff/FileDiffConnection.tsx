...
import { ErrorLike, isDefined, isErrorLike, logError, property } from '@sourcegraph/common'
    ...
    useEffect(
        () => () => {
            ...
            extensionInfo?.extensionsController.extHostAPI
                ...
                .catch(error => {
                    logError('Error removing viewers from extension host', error)
                })
        },
                                ...
                                return from(
                                    setViewerIds(async currentViewerIdByUri => {
                                        try {
                                            ...
                                            logError('Error syncing documents/viewers with extension host', error)
                                            return new Map([...currentViewerIdByUri])
                                        }
                                    })
                                )
