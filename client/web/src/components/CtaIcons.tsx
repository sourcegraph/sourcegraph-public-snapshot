...
export const JetBrainsIcon = memo(({ width = 30, height = 30 }: { width?: number; height?: number } = {}) => (
    <svg width={width} height={height} viewBox="22 22 61 61" xmlns="http://www.w3.org/2000/svg">
        ...
        <g fill="#fff">
            ...
            <path d="M49.59 43h2.5l4 9.44H53.3l-.67-1.69H49l-.67 1.69h-2.71zm2.27 5.73-1-2.65-1.06 2.65zm4.6-5.68h2.6v9.37h-2.6zm3.6 0h2.42l3.37 5v-5h2.57v9.37h-2.26l-3.53-5.14v5.14h-2.57zm8.8 7.95 1.45-1.73a4.84 4.84 0 0 0 3 1.13c.71 0 1.08-.24 1.08-.65 0-.4-.31-.6-1.59-.91-2-.46-3.53-1-3.53-2.93 0-1.74 1.37-3 3.62-3a5.89 5.89 0 0 1 3.86 1.25L75.49 46a4.63 4.63 0 0 0-2.62-.92c-.63 0-.94.25-.94.6 0 .42.32.61 1.63.91 2.14.46 3.44 1.16 3.44 2.91 0 1.91-1.51 3-3.79 3a6.58 6.58 0 0 1-4.35-1.5z" />
        </g>
        <path d="M0 0h105v105H0z" fill="none" />
    </svg>
))
