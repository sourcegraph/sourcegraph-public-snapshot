...
export class Range {
    ...
    public toString(): string {
        if (this.isSingleLine()) {
            return [this.start.line, this.start.character, this.end.character].toString()
        }
        return [this.start.line, this.start.character, this.end.line, this.end.character].toString()
    }
