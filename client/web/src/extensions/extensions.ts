...
import { ExtensionCategory, EXTENSION_CATEGORIES } from '../../../ui-kit-legacy-shared/src/schema/extensionSchema'
import {
    ConfiguredRegistryExtension,
    toConfiguredRegistryExtension,
    isExtensionEnabled,
} from '../../../ui-kit-legacy-shared/src/extensions/extension'
import { validCategories } from './extension/extension'
import { isErrorLike, ErrorLike } from '../../../ui-kit-legacy-shared/src/util/errors'
import { ConfiguredExtensionCache, ExtensionsEnablement } from './ExtensionRegistry'
import { Settings } from '../../../ui-kit-legacy-shared/src/settings/settings'
import { createRecord } from '../../../ui-kit-legacy-shared/src/util/createRecord'
