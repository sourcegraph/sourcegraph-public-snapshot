 ...
 */
export function useV2QueryInput(): [boolean, UseTemporarySettingsReturnType<'search.input.v2'>[1]] {
    ...
    const [userSettingEnabled, setUserSetting] = useTemporarySetting('search.input.v2', true)
