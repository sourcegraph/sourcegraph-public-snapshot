...
export const SearchNotebookFileBlockInputs: React.FunctionComponent<SearchNotebookFileBlockInputsProps> = ({
    ...
    return (
        <div className={styles.fileBlockInputs}>
            ...
            <div id={`file-location-input-${id}`} className={styles.filePathInputWrapper}>
                <SearchNotebookFileBlockInput
                    className="flex-1"
                    inputClassName={styles.fileBlockInput}
                ...
                {showRevisionInput && (
                    <div className="w-50 mr-2">
                        ...
                        <SearchNotebookFileBlockInput
                            ...
                            inputClassName={styles.fileBlockRevisionLineRangeInput}
                            value={revision}
