                ...
                <div className="search-results-list" ref={this.setScrollableElementRef}>
                    ...
                    {this.props.resultsOrError === undefined ? (
                        ...
                        (() => {
                            ...
                            const excludeForksFilter = results.dynamicFilters.find(
                                filter => filter.value === 'fork:yes'
                            )
                            const excludedForksCount = excludeForksFilter?.count || 0
                            const excludeArchivedFilter = results.dynamicFilters.find(
                                ...
                                <>
                                    <div className="search-results-info-bar__notice test-search-results-stats">
                                        <span>
                                            ...
                                            {pluralize('result', results.matchCount)} in{' '}
                                        ...
                                        {results.limitHit && this.props.onShowMoreResultsClick && (
                                            <button
                                                type="button"
                                    ...
                                    {excludedArchivedCount > 0 && (
                                        ...
                                        >
                                            <span>
                                                <AlertCircleIcon className="icon-inline" /> {excludedArchivedCount}{' '}
                                                archived{' '}
                                                {pluralize('repository', excludedArchivedCount, 'repositories')}{' '}
                                                excluded
                                            </span>
                                        </div>
                                    )}
                                    ...
                                    {results.missing.length > 0 && (
                                        ...
                                        >
                                            <span>
                                                ...
                                                {pluralize('repository', results.missing.length, 'repositories')} not
                                                found
                                            </span>
                                        </div>
                                    )}
                                    ...
                                    {results.timedout.length > 0 && (
                                        ...
                                        >
                                            <span>
                                                ...
                                                {pluralize('repository', results.timedout.length, 'repositories')} timed
                                    ...
                                    {results.cloning.length > 0 && (
                                        ...
                                        >
                                            <span>
                                                ...
                                                {pluralize('repository', results.cloning.length, 'repositories')}{' '}
