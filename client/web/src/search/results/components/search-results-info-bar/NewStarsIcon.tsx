...
export const NewStarsIcon: React.FunctionComponent = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" fill="none" viewBox="0 0 21 21">
        ...
        <defs>
            ...
            >
                <stop stopColor="#7048E8"></stop>
                <stop offset="0.035" stopColor="#607CE8"></stop>
                <stop offset="0.185" stopColor="#4AC1E8"></stop>
                <stop offset="0.35" stopColor="#59A3EC"></stop>
                <stop offset="0.626" stopColor="#A112FF"></stop>
