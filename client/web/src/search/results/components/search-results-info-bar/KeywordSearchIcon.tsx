...
<<<<<<<< HEAD:client/web/src/search/results/components/search-results-info-bar/NewStarsIcon.tsx
export const NewStarsIcon: React.FunctionComponent = () => (
========
export const KeywordSearchIcon: React.FunctionComponent = () => (
>>>>>>>> ee70db42460a9a2e3eb0626456721d1bb284a667:client/web/src/search/results/components/search-results-info-bar/KeywordSearchIcon.tsx
