...
function sendAggregationPing(props: UseAggregationPingsArgs): void {
    ...
    if (aggregationType === 'SearchAggregationNotAvailable') {
        ...
        if (extendedTimeout) {
            ...
            telemetryRecorder.recordEvent(GroupResultsPing.ExplicitLimitSuccess, 'succeeded', {
                privateMetadata: { aggregationMode: mode },
            })
        } else {
            telemetryService.log(
            ...
            telemetryRecorder.recordEvent(GroupResultsPing.ProactiveLimitSuccess, 'succeeded', {
                privateMetadata: { aggregationMode: mode },
            })
        }
    }
