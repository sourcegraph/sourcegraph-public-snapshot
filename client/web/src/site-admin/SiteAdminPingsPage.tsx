 ...
 */
export const SiteAdminPingsPage: React.FunctionComponent<React.PropsWithChildren<Props & TelemetryV2Props>> = ({
    telemetryRecorder,
}) => {
    ...
    useEffect(() => {
        telemetryRecorder.recordEvent('siteAdminPings', 'viewed')
