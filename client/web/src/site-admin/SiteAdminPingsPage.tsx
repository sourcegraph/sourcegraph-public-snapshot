            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>Weekly count of total and unique views to the Create new insight, Create search insight,
                            and Create language insight pages</li>
                        <li>Weekly count of total and unique clicks of the Create search insight, Create language
                            usage insight, and Explore the extensions buttons on the Create new insight page</li>
                        <li>Weekly count of total and unique clicks of the Create and Cancel buttons on the Create
                            search insight and Create language insight pages</li>
