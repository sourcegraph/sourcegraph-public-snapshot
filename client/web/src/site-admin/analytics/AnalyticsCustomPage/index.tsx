...
export const AnalyticsCustomPage: React.FunctionComponent<{}> = () => {
    ...
    const debouncedSearchText = useDebounce(events.value, 300).split(",").map(e => e.trim())
    ...
    return (
        <>
            ...
            <Card className="p-3">
                ...
                <AnalyticsCustomChartComponent dateRange={dateRange} aggregation={aggregation} debouncedSearchText={debouncedSearchText} grouping={grouping} />
                <AnalyticsCustomConnectionComponent dateRange={dateRange} debouncedSearchText={debouncedSearchText} grouping={grouping} />
            </Card>
        </>
    )
}
