...
import { LayoutRouteProps, LayoutRouteComponentProps, PAGE_ROUTES } from './routes'
...
export const Layout: React.FunctionComponent<LayoutProps> = props => {
    ...
    const isSiteInit = props.location.pathname === PAGE_ROUTES.SITE_ADMIN_INIT
    const isSignInOrUp =
        props.location.pathname === PAGE_ROUTES.SIGN_IN ||
        props.location.pathname === PAGE_ROUTES.SIGN_UP ||
        props.location.pathname === PAGE_ROUTES.PASSWORD_RESET ||
        props.location.pathname === PAGE_ROUTES.WELCOME
    ...
    const isSearchAutoFocusRequired = routeMatch === PAGE_ROUTES.SURVEY || routeMatch === '/insights'
