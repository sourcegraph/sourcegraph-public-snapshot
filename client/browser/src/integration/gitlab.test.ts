            ...
            .intercept((request, response) => {
                response.sendStatus(200).send(
                    JSON.stringify({
                        ...
                        render_error: null,
                        raw_path: '/sourcegraph/jsonrpc2/-/raw/4fb7cd90793ee6ab445f466b900e6bffb9b63d78/call_opt.go',
                        blame_path:
                        ...
                        permalink: '/sourcegraph/jsonrpc2/-/blob/4fb7cd90793ee6ab445f466b900e6bffb9b63d78/call_opt.go',
                        html:
