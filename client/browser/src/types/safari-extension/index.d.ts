...
declare namespace safari {
    export var application: SafariApplication | undefined
    export var extension: SafariExtension | SafariContentExtension
    export var self: SafariExtensionGlobalPage | SafariExtensionBar | SafariContentWebPage
}
