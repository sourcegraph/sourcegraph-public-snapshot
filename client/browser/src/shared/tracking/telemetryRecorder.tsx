...
export class EventTelemetry implements TelemetryServiceV2 {
     ...
     */
    public async record(eventName: string, eventProperties?: any, publicArgument?: any): Promise<void> {
        await this.recordEvent(eventName, eventProperties, publicArgument)
    }
     ...
     */
    public async recordViewEvent(pageTitle: string, eventProperties?: any): Promise<void> {
        await this.recordEvent(`View${pageTitle}`, eventProperties)
    }
     ...
     */
    public async recordPageView(eventName: string, eventProperties?: any, publicArgument?: any): Promise<void> {
        await this.recordEvent(`${eventName}Viewed`, eventProperties, publicArgument)
    }
}
