...
import manifestSpec from './manifest.spec.json'
...
export function copyIntegrationAssets(): void {
    ...
    shelljs.cp('-r', 'build/dist/*', 'build/integration')

    // This destination filename is hardcoded in
    ...
    shelljs.cp(
        'build/dist/js/native-integration/phabricator/integration.main.bundle.js',
    ...
    shelljs.cp(
        'build/dist/js/native-integration/integration.bundle.js',
        'build/integration/scripts/integration.bundle.js'
    )
