...
- Cody completions: Improves the behavior of the completions cache when characters are completed. [pull/](https://github.com/sourcegraph/sourcegraph/pull/52697)

### Changed

- Cody completions: Improve completion logger and measure the duration a completion is displayed for. [pull/](https://github.com/sourcegraph/sourcegraph/pull/)
