...
- Added a new Cody status bar item to relay global loading states and allowing you to quickly enable/disable features [pull/](https://github.com/sourcegraph/sourcegraph/pull/)
