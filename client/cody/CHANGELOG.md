...
- Show network error message in webview when connection is lost and a reload button to get back when network is restored. [pull/54134](https://github.com/sourcegraph/sourcegraph/pull/54134)
