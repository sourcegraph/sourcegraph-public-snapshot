...
export const Tips: React.FunctionComponent<{}> = () => (
	<div className="tips-container">
		...
		<ul>
			...
			<li>
				Use the <code>reset</code> button in the upper right to reset the chat when you want to start a new line
				of thought. Cody does not remember anything outside the current chat.
			</li>
