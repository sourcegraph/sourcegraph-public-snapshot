...
export const highlightCode = (code: string, language?: string): string => {
  try {
    ...
    if (language) {
      return highlight.highlight(code, { language, ignoreIllegals: true })
        .value;
    }
...
export function registerHighlightContributions(): void {
  ...
  highlight.registerLanguage(
    'elixir',
    require('highlight.js/lib/languages/elixir')
  );
  highlight.registerLanguage(
    'haskell',
  ...
  highlight.registerLanguage(
    'ocaml',
    require('highlight.js/lib/languages/ocaml')
  );
  ...
  highlight.registerLanguage(
    'dart',
    require('highlight.js/lib/languages/dart')
  );
  highlight.registerLanguage(
    'perl',
  ...
  highlight.registerLanguage(
    'http',
    require('highlight.js/lib/languages/http')
  );
}
