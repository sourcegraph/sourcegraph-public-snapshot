...
import './App.css'
import { VSCodeButton, VSCodeLink, VSCodeProgressRing, VSCodeBadge } from '@vscode/webview-ui-toolkit/react'
...
export const Terms: React.FunctionComponent<React.PropsWithChildren<TermsProps>> = ({ setTermsAccepted }) => (
    <div className="non-transcript-container">
        <div className="terms-header-container">
            <VSCodeButton id="tab-menu-item-terms" className="terms-container-header" appearance="icon" disabled={true}>
        ...
        <div className="terms-container">
            <p>
                <em>
                    Will my queries or Cody's responses to my queries be used as training data for any machine learning
                    models?
                </em>
            </p>
            <p>
            ...
            <p>
                Yes, we will send your queries to LLM providers we use for the sole purpose of providing you the
                service.
            </p>
            <p>
            ...
            <p>
                No, Sourcegraph has obtained commitments from our LLM providers that no Cody requests will be used to
                train LLM models.
            </p>
            <p>
                For Sourcegraph Cody security standards, data retention, and more information, see
...
export const LoadingPage: React.FunctionComponent<React.PropsWithChildren> = () => (
