export const CodySvg: React.FunctionComponent<React.PropsWithChildren> = () => (
...
export const ResetSvg: React.FunctionComponent<
...
export const SubmitSvg: React.FunctionComponent<
  React.PropsWithChildren
> = () => (
