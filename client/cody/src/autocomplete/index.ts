...
import * as CompletionLogger from '@sourcegraph/cody-shared/src/autocomplete/logger'
import { detectMultilineMode } from '@sourcegraph/cody-shared/src/autocomplete/multiline'
import { Provider, ProviderConfig } from '@sourcegraph/cody-shared/src/autocomplete/providers/provider'
import { sharedPostProcess } from '@sourcegraph/cody-shared/src/autocomplete/shared-post-process'
import { SNIPPET_WINDOW_SIZE, isAbortError } from '@sourcegraph/cody-shared/src/autocomplete/utils'
...
export class CodyCompletionItemProvider implements vscode.InlineCompletionItemProvider {
    ...
    private async provideInlineCompletionItemsInner(
        ...
        const processedCompletions = completions.map(completion =>
            sharedPostProcess({ textEditor, prefix, suffix, multiline: multilineMode !== null, languageId, completion })
        )
