import { Range } from './VSCodeMocks'

function lineTrackerTest(change: Range, cur: Range, changeText: string): Range | null {
    ...
    const newRange = new Range(newStartLine, 0, cur.end.line + addedLines, 0)
    return newRange
}
