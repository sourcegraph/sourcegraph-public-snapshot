		...
		for _, tc := range []struct {
			...
			for _, listDepsTc := range []struct {
				...
				{"repos-python-poetry", `r:deps(^github\.com/sgtest/poetry-hw$)`, []string{
					"/pypi/atomicwrites@v1.4.0",
					"/pypi/attrs@v21.4.0",
					"/pypi/colorama@v0.4.4",
					"/pypi/more-itertools@v8.13.0",
					"/pypi/packaging@v21.3",
					"/pypi/pluggy@v0.13.1",
					"/pypi/py@v1.11.0",
					"/pypi/pyparsing@v3.0.8",
					"/pypi/pytest@v5.4.3",
					"/pypi/tqdm@v4.64.0",
					"/pypi/wcwidth@v0.2.5",
				}},
				{"repos-python-pipenv", `r:deps(^github\.com/sgtest/pipenv-hw$)`, []string{
					"/pypi/certifi@v2021.10.8",
					"/pypi/charset-normalizer@v2.0.12",
					"/pypi/idna@v3.3",
					"/pypi/requests@v2.27.1",
					"/pypi/urllib3@v1.26.9",
				}},
