...
- [ ] Release a new version of src-cli and bake the constants + documentation into sourcegraph/sourcegraph.
  ```shell
  pnpm run release release:src-cli
  ```
- [ ] Merge the resulting pull request generated by the command above and ensure it is backported into the release branch.
