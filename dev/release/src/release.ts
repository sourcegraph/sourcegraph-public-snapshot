            ...
            const createdChanges = await createChangesets({
                ...
                changes: [
                    ...
                    },
                    {
                        ...
                        title: defaultPRMessage,
                        edits: [
                            'sg ops update-images -kind helm -pin-tag 5.1.0 charts/sourcegraph-executor/k8s/.',
                            'sg ops update-images -kind helm -pin-tag 5.1.0 charts/sourcegraph-executor/dind/.',
