...
all_oss_commands=" gitserver query-runner github-proxy searcher replacer frontend repo-updater symbols precise-code-intel-server precise-code-intel-bundle-manager precise-code-intel-converter "
