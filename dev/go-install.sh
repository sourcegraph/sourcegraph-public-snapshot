...
all_oss_commands=" gitserver query-runner github-proxy searcher replacer frontend repo-updater symbols precise-code-intel-api-server precise-code-intel-bundle-manager precise-code-intel-worker precise-code-intel-indexer "
