...
all_commands=" gitserver indexer query-runner github-proxy lsp-proxy xlang-go searcher frontend repo-updater symbols "

ENTERPRISE_COMMANDS="frontend xlang-go"
