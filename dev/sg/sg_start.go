...
var (
	...
	fixOSXFirewall     = startFlagSet.Bool("fix-osx-firewall", false, "OSX only; Add required exceptions to the firewall")
...
`, set.Name))
	...
	return run.Commands(ctx, env, *fixOSXFirewall, *verboseFlag, cmds...)
}
