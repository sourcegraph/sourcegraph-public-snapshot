...
var (
	...
	runFlagFixOSXFirewall = runFlagSet.Bool("fix-osx-firewall", false, "OSX only; Add required exceptions to the firewall")
...
func runExec(ctx context.Context, args []string) error {
	...
	return run.Commands(ctx, globalConf.Env, *runFlagFixOSXFirewall, *verboseFlag, cmds...)
}
