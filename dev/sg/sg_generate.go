...
func printGeneratedNotice() {
	std.Out.WriteMarkdown(fmt.Sprintf(`# 🚨 Generated targets have moved!
	Some of the files that were generated by %sgo generate%s have been migrated to bazel.

	To generate files with Bazel run:
