...
func TestRevertMessage(t *testing.T) {
	...
	approveUrl, _ := url.Parse("https://build.tracker/revert/123/digestive/approve")
	rejectUrl, _ := url.Parse("https://build.tracker/revert/123/digestive/reject")
	num := 160000
	buildUrl := "http://www.google.com"
	commit := "78926a5b3b836a8a104a5d5adf891e5626b1e405"
	pipelineID := "sourcegraph"
	exit := 999
	msg := "this is a test"
