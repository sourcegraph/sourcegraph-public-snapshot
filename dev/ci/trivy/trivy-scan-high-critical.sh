...
case "${exitCode:-"0"}" in
  ...
  "${VULNERABILITY_EXIT_CODE}")
    ...
    echo "\nTrivy found issues. More information [here](https://handbook.sourcegraph.com/departments/product-engineering/engineering/cloud/security/trivy/#for-sourcegraph-engineers)." >> ./annotations/trivy-scan-high-critical.md    
