This directory contains _flakefiles_ that lists tests to disable when running Postgres backwards compatibility9 tests (see [go-test-backcompat.sh](../go-test-backcompat.sh)).
