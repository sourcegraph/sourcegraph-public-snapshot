...
func TestUserInvites_Get(t *testing.T) {
	...
	want := s.mustCreate(ctx, t, &sourcegraph.UserInvite{URI: "i", UserLogin: "test", OrgID: "123", OrgLogin: "sgtest123"})
...
func TestUserInvites_List(t *testing.T) {
	...
	want := s.mustCreate(ctx, t, &sourcegraph.UserInvite{URI: "j", UserLogin: "test", OrgID: "1234", OrgLogin: "sgtest1234"})
...
func TestUserInvites_List_URIs(t *testing.T) {
	...
	// Add some invites.
	if err := s.Create(ctx, &sourcegraph.UserInvite{URI: "k", UserLogin: "test", OrgID: "12345", OrgLogin: "sgtest12345"}); err != nil {
		t.Fatal(err)
	}
	if err := s.Create(ctx, &sourcegraph.UserInvite{URI: "l", UserLogin: "test", OrgID: "123456", OrgLogin: "sgtest123456"}); err != nil {
		t.Fatal(err)
	}
