...
type Validator = func(conftypes.SiteConfiguration) (problems []string)
...
func validateCustomBasicRaw(normalizedInput []byte) (problems []string, err error) {
	...
	return validateCustom(conftypes.SiteConfiguration{basic, schema.CoreSiteConfiguration{}}), nil
}
...
func validateCustomCoreRaw(normalizedInput []byte) (problems []string, err error) {
	...
	return validateCustom(conftypes.SiteConfiguration{schema.BasicSiteConfiguration{}, core}), nil
}
...
func validateCustom(cfg conftypes.SiteConfiguration) (problems []string) {
...
func validateEmail(c conftypes.SiteConfiguration) (problems []string) {
...
func validatePhabricator(c conftypes.SiteConfiguration) (problems []string) {
...
func validateBitbucketServer(c conftypes.SiteConfiguration) (problems []string) {
...
func validateGitlab(c conftypes.SiteConfiguration) (problems []string) {
...
func TestValidator(t interface {
	...
	Helper()
}, c conftypes.SiteConfiguration, f func(conftypes.SiteConfiguration) []string, wantProblems []string) {
	t.Helper()
	problems := f(c)
