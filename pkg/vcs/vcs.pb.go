...
type Commit struct {
	ID        CommitID   `protobuf:"bytes,1,opt,name=ID,json=iD,proto3,customtype=CommitID" json:"ID,omitempty"`
	Author    Signature  `protobuf:"bytes,2,opt,name=Author,json=author" json:"Author"`
	Committer *Signature `protobuf:"bytes,3,opt,name=Committer,json=committer" json:"Committer,omitempty"`
	...
	Parents []CommitID `protobuf:"bytes,5,rep,name=Parents,json=parents,customtype=CommitID" json:"Parents,omitempty"`
}
...
type Signature struct {
	...
	Date  pbtypes.Timestamp `protobuf:"bytes,3,opt,name=Date,json=date" json:"Date"`
}
...
type Branch struct {
	...
	Head CommitID `protobuf:"bytes,2,opt,name=Head,json=head,proto3,customtype=CommitID" json:"Head,omitempty"`
	...
	Commit *Commit `protobuf:"bytes,4,opt,name=Commit,json=commit" json:"Commit,omitempty"`
	// Counts optionally contains the commit counts relative to specified branch.
	Counts *BehindAhead `protobuf:"bytes,3,opt,name=Counts,json=counts" json:"Counts,omitempty"`
}
...
type BehindAhead struct {
	Behind uint32 `protobuf:"varint,1,opt,name=Behind,json=behind,proto3" json:"Behind,omitempty"`
	Ahead  uint32 `protobuf:"varint,2,opt,name=Ahead,json=ahead,proto3" json:"Ahead,omitempty"`
}
...
type BranchesOptions struct {
	...
	MergedInto string `protobuf:"bytes,4,opt,name=MergedInto,json=mergedInto,proto3" json:"MergedInto,omitempty" url:",omitempty"`
	// IncludeCommit controls whether complete commit information is included.
	IncludeCommit bool `protobuf:"varint,2,opt,name=IncludeCommit,json=includeCommit,proto3" json:"IncludeCommit,omitempty" url:",omitempty"`
	...
	BehindAheadBranch string `protobuf:"bytes,1,opt,name=BehindAheadBranch,json=behindAheadBranch,proto3" json:"BehindAheadBranch,omitempty" url:",omitempty"`
	// ContainsCommit filters the list of branches to only those that
	// contain a specific commit ID (if set).
	ContainsCommit string `protobuf:"bytes,3,opt,name=ContainsCommit,json=containsCommit,proto3" json:"ContainsCommit,omitempty" url:",omitempty"`
}
...
type Tag struct {
	Name     string   `protobuf:"bytes,1,opt,name=Name,json=name,proto3" json:"Name,omitempty"`
	CommitID CommitID `protobuf:"bytes,2,opt,name=CommitID,json=commitID,proto3,customtype=CommitID" json:"CommitID,omitempty"`
}
...
type SearchOptions struct {
	...
	QueryType string `protobuf:"bytes,2,opt,name=QueryType,json=queryType,proto3" json:"QueryType,omitempty"`
	// the number of lines before and after each hit to display
	ContextLines int32 `protobuf:"varint,3,opt,name=ContextLines,json=contextLines,proto3" json:"ContextLines,omitempty"`
	// max number of matches to return
	N int32 `protobuf:"varint,4,opt,name=N,json=n,proto3" json:"N,omitempty"`
...
type SearchResult struct {
	...
	File string `protobuf:"bytes,1,opt,name=File,json=file,proto3" json:"File,omitempty"`
	// The byte range [start,end) of the match.
	StartByte uint32 `protobuf:"varint,2,opt,name=StartByte,json=startByte,proto3" json:"StartByte,omitempty"`
	EndByte   uint32 `protobuf:"varint,3,opt,name=EndByte,json=endByte,proto3" json:"EndByte,omitempty"`
	// The line range [start,end] of the match.
	StartLine uint32 `protobuf:"varint,4,opt,name=StartLine,json=startLine,proto3" json:"StartLine,omitempty"`
	EndLine   uint32 `protobuf:"varint,5,opt,name=EndLine,json=endLine,proto3" json:"EndLine,omitempty"`
	// Match is the matching portion of the file from [StartByte,
	// EndByte).
	Match []byte `protobuf:"bytes,6,opt,name=Match,json=match,proto3" json:"Match,omitempty"`
}
...
type Committer struct {
	Name    string `protobuf:"bytes,1,opt,name=Name,json=name,proto3" json:"Name,omitempty"`
	Email   string `protobuf:"bytes,2,opt,name=Email,json=email,proto3" json:"Email,omitempty"`
	Commits int32  `protobuf:"varint,3,opt,name=Commits,json=commits,proto3" json:"Commits,omitempty"`
}
...
var fileDescriptorVcs = []byte{
	...
	,
}
