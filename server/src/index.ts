...
import { WSChatRequest, WSChatResponseChange, WSChatResponseComplete, WSChatResponseError, WSCompletionResponseCompletion, WSCompletionsRequest, WSCompletionResponse, Completion } from "@sourcegraph/cody-common";
