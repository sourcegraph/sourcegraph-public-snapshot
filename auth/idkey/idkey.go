...
// Bits is the size (in bits) of RSA keys generated by Generate. For
// testing, 1024 is faster, but in production you should probably use
// at least 2048.
...
const idKeyKey contextKey = iota
