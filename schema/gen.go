...
//go:generate $PWD/.bin/go-jsonschema-compiler -o schema.go -pkg schema site.schema.json settings.schema.json extension.schema.json core.schema.json
...
//go:generate gofmt -w site_stringdata.go settings_stringdata.go extension_stringdata.go core_stringdata.go
