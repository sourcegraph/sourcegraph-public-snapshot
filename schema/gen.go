...
//go:generate env GO111MODULE=on go run stringdata.go -i campaign-types/regex_search_replace.schema.json -name RegexSearchReplaceCampaignTypeSchemaJSON -pkg schema -o campaign-types/regex_search_replace_stringdata.go
