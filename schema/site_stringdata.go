...
const SiteSchemaJSON = `{
  ...
  "properties": {
    ...
    "corsOrigin": {
      "description": "Required when using native code host integrations: Phabricator integration, GitLab integration, or Bitbucket Server plugin. This value is the space-separated list of allowed origins for cross-origin HTTP requests to Sourcegraph. Usually it contains the base URL for your Phabricator, GitLab, or Bitbucket Server instance.",
      "type": "string",
