  ...
  "definitions": {
    ...
    "OtherExternalServiceConnection": {
      ...
      "properties": {
        ...
        "repos": {
          ...
          "items": {
            ...
            "pattern": "^(git|ssh|https?)://",
            "examples": [
              "https://github.com/my/repo?access_token=secret",
              "ssh://user@host.xz:2333/my/repo.git/",
              "git://host.xz:2333/my/repo.git/"
            ]
          }
        }
      },
      "dependencies": {
        "url": {
          "repos": {
            "title": "List of repository paths to be merged with the provided Git clone base URL.",
            "type": "array",
            "items": {
              "type": "string",
