    ...
    "experimentalFeatures": {
      ...
      "properties": {
        "archiveBatchChangeChangesets": {
          "description": "When enabled, changesets that would be detached when a new batch spec is applied will be archived instead, thereby retaining an association with the batch change.",
          "type": "boolean",
          "default": false,
          "!go": {
            "pointer": true
