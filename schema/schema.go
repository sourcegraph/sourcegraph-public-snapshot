...
type Embeddings struct {
	...
	Endpoint string `json:"endpoint,omitempty"`
	// ExcludeFileOnError description: Whether to skip indexing a file if an embedding request fails for it. If true, the file is not indexed and indexing the remainder of the repository proceeds.
	ExcludeFileOnError *bool `json:"excludeFileOnError,omitempty"`
