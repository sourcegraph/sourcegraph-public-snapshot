...
type SiteConfiguration struct {
	...
	// DefaultRateLimit description: The rate limit for the default rate limiter in the rate limiters registry. By default this is disabled and the default rate limit is infinity.
