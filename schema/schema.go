...
type GitHubAuthProvider struct {
	...
	// AllowOrgsMap description: Restricts new logins to members of GitHub organization > teams. Existing sessions won't be invalidated. Leave empty or unset for no org > team restrictions.
