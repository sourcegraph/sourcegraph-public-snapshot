...
type ExperimentalFeatures struct {
	...
	// EnableWebhookSyncing description: Enables consumers to sync repositories using webhooks to subscribe to GihHub push events
	EnableWebhookSyncing bool `json:"enableWebhookSyncing,omitempty"`
