...
type ExperimentalFeatures struct {
	...
	// SearchContextsRepositoryQuery description: Enables repository query based search contexts.
	SearchContextsRepositoryQuery bool `json:"search.contexts.repositoryQuery,omitempty"`
