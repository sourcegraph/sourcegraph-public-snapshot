...
type Embeddings struct {
	...
	Endpoint string `json:"endpoint,omitempty"`
	// ExcludeChunkOnError description: Whether to cancel indexing a repo if an embedding request fails. If true, the chunk that cannot generate embeddings is not indexed and the remainder of the repository proceeds with indexing.
