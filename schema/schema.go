...
type SiteConfiguration struct {
	...
	// InsightsMaximumSampleSize description: WIP. The maximum number of data points that will be available to view for a series on an insight view. Points beyond that will be stored in a separate table and available for data export.
