...
type SiteConfiguration struct {
	...
	// DisableDiagnosticTelemetry description: Disable aggregated event counts and latencies from being sent back via pings.
	DisableDiagnosticTelemetry bool `json:"disableDiagnosticTelemetry,omitempty"`
