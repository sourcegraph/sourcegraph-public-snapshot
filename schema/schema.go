...
type RepoPurgeWorker struct {
	...
	// IntervalMinutes description: Interval in minutes at which to run purge jobs. Set to 0 to disable. NOTE: This interval is no longer used, but you can still set it to 0 to disable the purge worker.
