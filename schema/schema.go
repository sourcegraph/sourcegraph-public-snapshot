...
type GitLabAuthProvider struct {
	...
	// AllowSignup description: Allows new visitors to sign up for accounts via GitLab authentication. If false or not set, users signing in via GitLab must have an existing Sourcegraph account, which will be linked to their GitLab identity after sign-in.
	AllowSignup bool `json:"allowSignup,omitempty"`
