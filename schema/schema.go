...
type SiteConfiguration struct {
	...
	// GitMaxCodehostRequestsPerSecond description: Maximum number of remote code host git operations (e.g. clone or ls-remote) be run per second per gitserver. Default is -1, which is unlimited.
