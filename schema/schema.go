...
type SiteConfiguration struct {
	...
	// DisableEventCountTelemetry description: Disable aggregated event counts from being sent back via pings.
	DisableEventCountTelemetry bool `json:"disableEventCountTelemetry,omitempty"`
