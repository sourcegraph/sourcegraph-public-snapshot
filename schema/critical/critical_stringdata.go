...
// CriticalSchemaJSON is the content of the file "critical/critical.schema.json".
const CriticalSchemaJSON = `{
  ...
  "properties": {
    ...
    "migrated": {
      "description": "Whether the critical configuration has been migrated to the site configuration yet.",
      "type": "boolean",
      "default": false
    }
  },
