...
type MonikerOccurrence_Highlight int32

const (
	MonikerOccurrence_HIGHLIGHT_UNSPECIFIED        MonikerOccurrence_Highlight = 0
	MonikerOccurrence_HIGHLIGHT_STRING_LITERAL     MonikerOccurrence_Highlight = 1
	MonikerOccurrence_HIGHLIGHT_NUMERIC_LITERAL    MonikerOccurrence_Highlight = 2
	MonikerOccurrence_HIGHLIGHT_IDENTIFIER         MonikerOccurrence_Highlight = 3
	MonikerOccurrence_HIGHLIGHT_METHOD_IDENTIFIER  MonikerOccurrence_Highlight = 4
	MonikerOccurrence_HIGHLIGHT_TYPE_IDENTIFIER    MonikerOccurrence_Highlight = 5
	MonikerOccurrence_HIGHLIGHT_TERM_IDENTIFIER    MonikerOccurrence_Highlight = 6
	MonikerOccurrence_HIGHLIGHT_LOCAL_IDENTIFIER   MonikerOccurrence_Highlight = 7
	MonikerOccurrence_HIGHLIGHT_SHADED_IDENTIFIER  MonikerOccurrence_Highlight = 8
	MonikerOccurrence_HIGHLIGHT_PACKAGE_IDENTIFIER MonikerOccurrence_Highlight = 9
)

// Enum value maps for MonikerOccurrence_Highlight.
var (
	MonikerOccurrence_Highlight_name = map[int32]string{
	...
	MonikerOccurrence_Highlight_value = map[string]int32{
...
func (x MonikerOccurrence_Highlight) Enum() *MonikerOccurrence_Highlight {
	p := new(MonikerOccurrence_Highlight)
	*p = x
	return p
}

func (x MonikerOccurrence_Highlight) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MonikerOccurrence_Highlight) Descriptor() protoreflect.EnumDescriptor {
	return file_lib_codeintel_lsif_typed_lsif_proto_enumTypes[3].Descriptor()
}

func (MonikerOccurrence_Highlight) Type() protoreflect.EnumType {
	return &file_lib_codeintel_lsif_typed_lsif_proto_enumTypes[3]
}

func (x MonikerOccurrence_Highlight) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MonikerOccurrence_Highlight.Descriptor instead.
func (MonikerOccurrence_Highlight) EnumDescriptor() ([]byte, []int) {
	return file_lib_codeintel_lsif_typed_lsif_proto_rawDescGZIP(), []int{7, 1}
}
...
type MonikerOccurrence struct {
	...
	RangeCompressed []int32 `protobuf:"varint,6,rep,packed,name=range_compressed,json=rangeCompressed,proto3" json:"range_compressed,omitempty"`
	...
	Highlight MonikerOccurrence_Highlight `protobuf:"varint,5,opt,name=highlight,proto3,enum=lib.codeintel.lsif_typed.MonikerOccurrence_Highlight" json:"highlight,omitempty"`
}
...
func (x *MonikerOccurrence) GetRangeCompressed() []int32 {
	if x != nil {
		return x.RangeCompressed
	}
	return nil
}
...
func (x *MonikerOccurrence) GetHighlight() MonikerOccurrence_Highlight {
	if x != nil {
		return x.Highlight
	}
	return MonikerOccurrence_HIGHLIGHT_UNSPECIFIED
}
...
var file_lib_codeintel_lsif_typed_lsif_proto_rawDesc = []byte{
	...
	0x4e, 0x49, 0x51, 0x55, 0x45, 0x5f, 0x47, 0x4c, 0x4f, 0x42, 0x41, 0x4c, 0x10, 0x02, 0x22, 0xdf,
	0x05, 0x0a, 0x11, 0x4d, 0x6f, 0x6e, 0x69, 0x6b, 0x65, 0x72, 0x4f, 0x63, 0x63, 0x75, 0x72, 0x72,
	...
	0x6e, 0x67, 0x65, 0x52, 0x05, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x29, 0x0a, 0x10, 0x72, 0x61,
	0x6e, 0x67, 0x65, 0x5f, 0x63, 0x6f, 0x6d, 0x70, 0x72, 0x65, 0x73, 0x73, 0x65, 0x64, 0x18, 0x06,
	0x20, 0x03, 0x28, 0x05, 0x52, 0x0f, 0x72, 0x61, 0x6e, 0x67, 0x65, 0x43, 0x6f, 0x6d, 0x70, 0x72,
	0x65, 0x73, 0x73, 0x65, 0x64, 0x12, 0x44, 0x0a, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x18, 0x03, 0x20,
	...
	0x65, 0x72, 0x12, 0x53, 0x0a, 0x09, 0x68, 0x69, 0x67, 0x68, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x35, 0x2e, 0x6c, 0x69, 0x62, 0x2e, 0x63, 0x6f, 0x64, 0x65,
	0x69, 0x6e, 0x74, 0x65, 0x6c, 0x2e, 0x6c, 0x73, 0x69, 0x66, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x64,
	0x2e, 0x4d, 0x6f, 0x6e, 0x69, 0x6b, 0x65, 0x72, 0x4f, 0x63, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e,
	0x63, 0x65, 0x2e, 0x48, 0x69, 0x67, 0x68, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x52, 0x09, 0x68, 0x69,
	0x67, 0x68, 0x6c, 0x69, 0x67, 0x68, 0x74, 0x22, 0x45, 0x0a, 0x04, 0x52, 0x6f, 0x6c, 0x65, 0x12,
	...
	,
...
var file_lib_codeintel_lsif_typed_lsif_proto_goTypes = []interface{}{
	...
	(MonikerOccurrence_Highlight)(0), // 3: lib.codeintel.lsif_typed.MonikerOccurrence.Highlight
	(*LsifValues)(nil),               // 4: lib.codeintel.lsif_typed.LsifValues
	(*LsifValue)(nil),                // 5: lib.codeintel.lsif_typed.LsifValue
	(*Metadata)(nil),                 // 6: lib.codeintel.lsif_typed.Metadata
	(*ToolInfo)(nil),                 // 7: lib.codeintel.lsif_typed.ToolInfo
	(*Position)(nil),                 // 8: lib.codeintel.lsif_typed.Position
	(*Range)(nil),                    // 9: lib.codeintel.lsif_typed.Range
	(*Moniker)(nil),                  // 10: lib.codeintel.lsif_typed.Moniker
	(*MonikerOccurrence)(nil),        // 11: lib.codeintel.lsif_typed.MonikerOccurrence
	(*Document)(nil),                 // 12: lib.codeintel.lsif_typed.Document
	(*Package)(nil),                  // 13: lib.codeintel.lsif_typed.Package
}
var file_lib_codeintel_lsif_typed_lsif_proto_depIdxs = []int32{
	5,  // 0: lib.codeintel.lsif_typed.LsifValues.values:type_name -> lib.codeintel.lsif_typed.LsifValue
	6,  // 1: lib.codeintel.lsif_typed.LsifValue.metadata:type_name -> lib.codeintel.lsif_typed.Metadata
	13, // 2: lib.codeintel.lsif_typed.LsifValue.package:type_name -> lib.codeintel.lsif_typed.Package
	12, // 3: lib.codeintel.lsif_typed.LsifValue.document:type_name -> lib.codeintel.lsif_typed.Document
	10, // 4: lib.codeintel.lsif_typed.LsifValue.moniker:type_name -> lib.codeintel.lsif_typed.Moniker
	7,  // 5: lib.codeintel.lsif_typed.Metadata.toolInfo:type_name -> lib.codeintel.lsif_typed.ToolInfo
	0,  // 6: lib.codeintel.lsif_typed.Metadata.positionEncoding:type_name -> lib.codeintel.lsif_typed.Metadata.PositionEncoding
	8,  // 7: lib.codeintel.lsif_typed.Range.start:type_name -> lib.codeintel.lsif_typed.Position
	8,  // 8: lib.codeintel.lsif_typed.Range.end:type_name -> lib.codeintel.lsif_typed.Position
	1,  // 9: lib.codeintel.lsif_typed.Moniker.unique:type_name -> lib.codeintel.lsif_typed.Moniker.Unique
	9,  // 10: lib.codeintel.lsif_typed.MonikerOccurrence.range:type_name -> lib.codeintel.lsif_typed.Range
	2,  // 11: lib.codeintel.lsif_typed.MonikerOccurrence.role:type_name -> lib.codeintel.lsif_typed.MonikerOccurrence.Role
	3,  // 12: lib.codeintel.lsif_typed.MonikerOccurrence.highlight:type_name -> lib.codeintel.lsif_typed.MonikerOccurrence.Highlight
	11, // 13: lib.codeintel.lsif_typed.Document.occurrences:type_name -> lib.codeintel.lsif_typed.MonikerOccurrence
	10, // 14: lib.codeintel.lsif_typed.Document.monikers:type_name -> lib.codeintel.lsif_typed.Moniker
