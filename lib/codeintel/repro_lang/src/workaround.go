...
// error: failed to index: failed to load packages: packages.Load: err: exit status 1: stderr: go build github.com/sourcegraph/sourcegraph/lib/codeintel/repro_lang/src: build constraints exclude all Go files in /__w/sourcegraph/sourcegraph/lib/codeintel/repro_lang/src
