...
type indexFunction = func(inputDirectory, outputDirectory string, sources []*lsif_typed.SourceFile) []*lsif_typed.SourceFile
...
func snapshotTestSources(t *testing.T, inputDirectory, outputDirectory string, obtainedSnapshots []*lsif_typed.SourceFile) {
