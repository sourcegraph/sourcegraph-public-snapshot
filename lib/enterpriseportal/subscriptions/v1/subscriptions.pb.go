...
type EnterpriseSubscriptionConditionStatus int32

const (
	EnterpriseSubscriptionConditionStatus_ENTERPRISE_SUBSCRIPTION_CONDITION_STATUS_UNSPECIFIED EnterpriseSubscriptionConditionStatus = 0
	// License creation status.
	EnterpriseSubscriptionConditionStatus_ENTERPRISE_SUBSCRIPTION_CONDITION_STATUS_CREATED EnterpriseSubscriptionConditionStatus = 1
	// License archival status. i.e. 'is_archived'
	EnterpriseSubscriptionConditionStatus_ENTERPRISE_SUBSCRIPTION_CONDITION_STATUS_ARCHIVED EnterpriseSubscriptionConditionStatus = 2
)

// Enum value maps for EnterpriseSubscriptionConditionStatus.
var (
	EnterpriseSubscriptionConditionStatus_name = map[int32]string{
		0: "ENTERPRISE_SUBSCRIPTION_CONDITION_STATUS_UNSPECIFIED",
		1: "ENTERPRISE_SUBSCRIPTION_CONDITION_STATUS_CREATED",
		2: "ENTERPRISE_SUBSCRIPTION_CONDITION_STATUS_ARCHIVED",
	}
	EnterpriseSubscriptionConditionStatus_value = map[string]int32{
		"ENTERPRISE_SUBSCRIPTION_CONDITION_STATUS_UNSPECIFIED": 0,
		"ENTERPRISE_SUBSCRIPTION_CONDITION_STATUS_CREATED":     1,
		"ENTERPRISE_SUBSCRIPTION_CONDITION_STATUS_ARCHIVED":    2,
	}
)

func (x EnterpriseSubscriptionConditionStatus) Enum() *EnterpriseSubscriptionConditionStatus {
	p := new(EnterpriseSubscriptionConditionStatus)
	*p = x
	return p
}

func (x EnterpriseSubscriptionConditionStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (EnterpriseSubscriptionConditionStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_subscriptions_proto_enumTypes[0].Descriptor()
}

func (EnterpriseSubscriptionConditionStatus) Type() protoreflect.EnumType {
	return &file_subscriptions_proto_enumTypes[0]
}

func (x EnterpriseSubscriptionConditionStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use EnterpriseSubscriptionConditionStatus.Descriptor instead.
func (EnterpriseSubscriptionConditionStatus) EnumDescriptor() ([]byte, []int) {
	return file_subscriptions_proto_rawDescGZIP(), []int{0}
}

type EnterpriseSubscriptionLicenseConditionStatus int32

const (
	EnterpriseSubscriptionLicenseConditionStatus_ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_UNSPECIFIED EnterpriseSubscriptionLicenseConditionStatus = 0
	// License creation status.
	EnterpriseSubscriptionLicenseConditionStatus_ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_CREATED EnterpriseSubscriptionLicenseConditionStatus = 1
	// License archival status. i.e. 'is_archived'
	EnterpriseSubscriptionLicenseConditionStatus_ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_ARCHIVED EnterpriseSubscriptionLicenseConditionStatus = 2
	// License revocation status, i.e. 'is_revoked'
	EnterpriseSubscriptionLicenseConditionStatus_ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_REVOKED EnterpriseSubscriptionLicenseConditionStatus = 3
)

// Enum value maps for EnterpriseSubscriptionLicenseConditionStatus.
var (
	EnterpriseSubscriptionLicenseConditionStatus_name = map[int32]string{
		0: "ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_UNSPECIFIED",
		1: "ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_CREATED",
		2: "ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_ARCHIVED",
		3: "ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_REVOKED",
	}
	EnterpriseSubscriptionLicenseConditionStatus_value = map[string]int32{
		"ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_UNSPECIFIED": 0,
		"ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_CREATED":     1,
		"ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_ARCHIVED":    2,
		"ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_REVOKED":     3,
	}
)

func (x EnterpriseSubscriptionLicenseConditionStatus) Enum() *EnterpriseSubscriptionLicenseConditionStatus {
	p := new(EnterpriseSubscriptionLicenseConditionStatus)
	*p = x
	return p
}

func (x EnterpriseSubscriptionLicenseConditionStatus) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (EnterpriseSubscriptionLicenseConditionStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_subscriptions_proto_enumTypes[1].Descriptor()
}

func (EnterpriseSubscriptionLicenseConditionStatus) Type() protoreflect.EnumType {
	return &file_subscriptions_proto_enumTypes[1]
}

func (x EnterpriseSubscriptionLicenseConditionStatus) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use EnterpriseSubscriptionLicenseConditionStatus.Descriptor instead.
func (EnterpriseSubscriptionLicenseConditionStatus) EnumDescriptor() ([]byte, []int) {
...
type EnterpriseSubscriptionCondition struct {
	...
	Status EnterpriseSubscriptionConditionStatus `protobuf:"varint,2,opt,name=status,proto3,enum=enterpriseportal.subscriptions.v1.EnterpriseSubscriptionConditionStatus" json:"status,omitempty"`
...
func (x *EnterpriseSubscriptionCondition) GetStatus() EnterpriseSubscriptionConditionStatus {
	if x != nil {
		return x.Status
	}
	return EnterpriseSubscriptionConditionStatus_ENTERPRISE_SUBSCRIPTION_CONDITION_STATUS_UNSPECIFIED
}
...
type EnterpriseSubscriptionLicenseCondition struct {
	...
	LastTransitionTime *timestamppb.Timestamp `protobuf:"bytes,1,opt,name=last_transition_time,json=lastTransitionTime,proto3" json:"last_transition_time,omitempty"`
	// Status is the type of status corresponding to this condition.
	Status EnterpriseSubscriptionLicenseConditionStatus `protobuf:"varint,2,opt,name=status,proto3,enum=enterpriseportal.subscriptions.v1.EnterpriseSubscriptionLicenseConditionStatus" json:"status,omitempty"`
	// Message is a description of the status transition and why it happened.
	Message string `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`
}
...
func (x *EnterpriseSubscriptionLicenseCondition) GetStatus() EnterpriseSubscriptionLicenseConditionStatus {
	if x != nil {
		return x.Status
	}
	return EnterpriseSubscriptionLicenseConditionStatus_ENTERPRISE_SUBSCRIPTION_LICENSE_CONDITION_STATUS_UNSPECIFIED
}
...
var file_subscriptions_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xeb, 0x01, 0x0a, 0x1f, 0x45, 0x6e,
	0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x4c, 0x0a,
	...
	0x6e, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x60, 0x0a, 0x06, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x48, 0x2e, 0x65, 0x6e,
	...
	0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x53,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x18, 0x0a,
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07,
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xaf, 0x01, 0x0a, 0x16, 0x45, 0x6e, 0x74, 0x65,
	0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69,
	0x6f, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02,
	0x69, 0x64, 0x12, 0x62, 0x0a, 0x0a, 0x63, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73,
	...
	,
	...
	0x65, 0x4b, 0x65, 0x79, 0x2e, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x12,
	...
	0x64, 0x1a, 0xf0, 0x01, 0x0a, 0x04, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x61,
	...
	,
	...
	0x72, 0x61, 0x6e, 0x73, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x67, 0x0a,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x4f, 0x2e,
	...
	0x42, 0x07, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0x60, 0x0a, 0x22, 0x4c, 0x69, 0x73,
	0x74, 0x45, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x53, 0x75, 0x62, 0x73, 0x63,
	...
	0x52, 0x09, 0x70, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xae, 0x01, 0x0a, 0x23,
	...
	0x78, 0x74, 0x50, 0x61, 0x67, 0x65, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x5f, 0x0a, 0x0d, 0x73,
	...
	0x65, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0d, 0x73,
	0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x94, 0x02, 0x0a,
	0x28, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x53,
	0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x63, 0x65, 0x6e,
	0x73, 0x65, 0x73, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x29, 0x0a, 0x0f, 0x73, 0x75, 0x62,
	...
	,
	...
	0x53, 0x75, 0x62, 0x73, 0x74, 0x72, 0x69, 0x6e, 0x67, 0x42, 0x08, 0x0a, 0x06, 0x66, 0x69, 0x6c,
	...
	0x08, 0x6c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x73, 0x2a, 0xce, 0x01, 0x0a, 0x25, 0x45, 0x6e,
	0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70,
	0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x38, 0x0a, 0x34, 0x45, 0x4e, 0x54, 0x45, 0x52, 0x50, 0x52, 0x49, 0x53,
	...
	0x30, 0x45, 0x4e, 0x54, 0x45, 0x52, 0x50, 0x52, 0x49, 0x53, 0x45, 0x5f, 0x53, 0x55, 0x42, 0x53,
	...
	0x44, 0x10, 0x01, 0x12, 0x35, 0x0a, 0x31, 0x45, 0x4e, 0x54, 0x45, 0x52, 0x50, 0x52, 0x49, 0x53,
	0x45, 0x5f, 0x53, 0x55, 0x42, 0x53, 0x43, 0x52, 0x49, 0x50, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x43,
	0x4f, 0x4e, 0x44, 0x49, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f,
	0x41, 0x52, 0x43, 0x48, 0x49, 0x56, 0x45, 0x44, 0x10, 0x02, 0x2a, 0xab, 0x02, 0x0a, 0x2c, 0x45,
	...
	0x69, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x40, 0x0a, 0x3c, 0x45,
	0x4e, 0x54, 0x45, 0x52, 0x50, 0x52, 0x49, 0x53, 0x45, 0x5f, 0x53, 0x55, 0x42, 0x53, 0x43, 0x52,
	0x49, 0x50, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x4c, 0x49, 0x43, 0x45, 0x4e, 0x53, 0x45, 0x5f, 0x43,
	0x4f, 0x4e, 0x44, 0x49, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f,
	0x55, 0x4e, 0x53, 0x50, 0x45, 0x43, 0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x3c, 0x0a,
	0x38, 0x45, 0x4e, 0x54, 0x45, 0x52, 0x50, 0x52, 0x49, 0x53, 0x45, 0x5f, 0x53, 0x55, 0x42, 0x53,
	...
	,
	...
	0x10, 0x01, 0x32, 0xb6, 0x04, 0x0a, 0x14, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74,
	0x69, 0x6f, 0x6e, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0xa0, 0x01, 0x0a, 0x19,
	...
	0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x03, 0x90, 0x02, 0x01, 0x12, 0xb1,
	0x01, 0x0a, 0x1b, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73,
	0x65, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x45,
	0x2e, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x61,
	0x6c, 0x2e, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e,
	0x76, 0x31, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x6e, 0x74, 0x65, 0x72, 0x70, 0x72, 0x69, 0x73,
	...
	0x02, 0x01, 0x12, 0xc6, 0x01, 0x0a, 0x22, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x6e, 0x74, 0x65, 0x72,
	0x70, 0x72, 0x69, 0x73, 0x65, 0x53, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x4c, 0x69, 0x63, 0x65, 0x6e, 0x73, 0x65, 0x73, 0x12, 0x4c, 0x2e, 0x65, 0x6e, 0x74, 0x65,
	0x72, 0x70, 0x72, 0x69, 0x73, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x2e, 0x73, 0x75, 0x62,
	...
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x4d, 0x2e, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x70,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03, 0x90, 0x02, 0x01, 0x42, 0x4a, 0x5a, 0x48, 0x67,
	...
	0x70, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x2f, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74,
...
var file_subscriptions_proto_goTypes = []interface{}{
	(EnterpriseSubscriptionConditionStatus)(0),         // 0: enterpriseportal.subscriptions.v1.EnterpriseSubscriptionConditionStatus
	(EnterpriseSubscriptionLicenseConditionStatus)(0),  // 1: enterpriseportal.subscriptions.v1.EnterpriseSubscriptionLicenseConditionStatus
	...
	(*EnterpriseSubscriptionLicenseKey_Info)(nil),      // 14: enterpriseportal.subscriptions.v1.EnterpriseSubscriptionLicenseKey.Info
	(*timestamppb.Timestamp)(nil),                      // 15: google.protobuf.Timestamp
}
var file_subscriptions_proto_depIdxs = []int32{
	15, // 0: enterpriseportal.subscriptions.v1.EnterpriseSubscriptionCondition.last_transition_time:type_name -> google.protobuf.Timestamp
	0,  // 1: enterpriseportal.subscriptions.v1.EnterpriseSubscriptionCondition.status:type_name -> enterpriseportal.subscriptions.v1.EnterpriseSubscriptionConditionStatus
	...
	14, // 3: enterpriseportal.subscriptions.v1.EnterpriseSubscriptionLicenseKey.info:type_name -> enterpriseportal.subscriptions.v1.EnterpriseSubscriptionLicenseKey.Info
	15, // 4: enterpriseportal.subscriptions.v1.EnterpriseSubscriptionLicenseCondition.last_transition_time:type_name -> google.protobuf.Timestamp
	1,  // 5: enterpriseportal.subscriptions.v1.EnterpriseSubscriptionLicenseCondition.status:type_name -> enterpriseportal.subscriptions.v1.EnterpriseSubscriptionLicenseConditionStatus
	...
	15, // 12: enterpriseportal.subscriptions.v1.EnterpriseSubscriptionLicenseKey.Info.expire_time:type_name -> google.protobuf.Timestamp
