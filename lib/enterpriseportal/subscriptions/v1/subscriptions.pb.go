...
const (
	EnterpriseSubscriptionInstanceType_TYPE_UNSPECIFIED EnterpriseSubscriptionInstanceType = 0
	// Represents a primary, production instance.
	EnterpriseSubscriptionInstanceType_TYPE_PRIMARY EnterpriseSubscriptionInstanceType = 1
	// Represents a secondary (e.g. dev or testing) instance.
	EnterpriseSubscriptionInstanceType_TYPE_SECONDARY EnterpriseSubscriptionInstanceType = 2
	// Represents a Sourcegraph-internal instance.
	EnterpriseSubscriptionInstanceType_TYPE_INTERNAL EnterpriseSubscriptionInstanceType = 3
)
...
func (x *EnterpriseSubscription) GetInstanceType() EnterpriseSubscriptionInstanceType {
	...
	return EnterpriseSubscriptionInstanceType_TYPE_UNSPECIFIED
}
