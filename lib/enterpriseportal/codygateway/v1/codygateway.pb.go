...
var file_codygateway_proto_depIdxs = []int32{
	...
	3, // 5: enterpriseportal.codygateway.v1.CodyGatewayAccess.access_tokens:type_name -> enterpriseportal.codygateway.v1.CodyGatewayAccessToken
	4, // 6: enterpriseportal.codygateway.v1.ListCodyGatewayAccessesResponse.accesses:type_name -> enterpriseportal.codygateway.v1.CodyGatewayAccess
	1, // 7: enterpriseportal.codygateway.v1.CodyGatewayService.GetCodyGatewayAccess:input_type -> enterpriseportal.codygateway.v1.GetCodyGatewayAccessRequest
	5, // 8: enterpriseportal.codygateway.v1.CodyGatewayService.ListCodyGatewayAccesses:input_type -> enterpriseportal.codygateway.v1.ListCodyGatewayAccessesRequest
	4, // 9: enterpriseportal.codygateway.v1.CodyGatewayService.GetCodyGatewayAccess:output_type -> enterpriseportal.codygateway.v1.CodyGatewayAccess
	6, // 10: enterpriseportal.codygateway.v1.CodyGatewayService.ListCodyGatewayAccesses:output_type -> enterpriseportal.codygateway.v1.ListCodyGatewayAccessesResponse
