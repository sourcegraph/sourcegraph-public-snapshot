	...
	tests := map[lsp.DocumentURI]struct { // map key is rootPath
		...
		"git://github.com/coreos/fuze?7df4f06041d9daba45e4c68221b9b04203dff1d8": {
			...
			wantDefinition: map[string]string{
				...
				"config/vendor/github.com/coreos/ignition/config/vendor/github.com/coreos/go-semver/semver/semver_test.go:287:27": "git://github.com/go-yaml/yaml?v2.2.0#yaml.go:138:6", // diff repo
			},
			wantXDefinition: map[string]string{
