...
func TestProxy(t *testing.T) {
	tests := map[string]struct {
		...
		"go basic": {
			...
			wantXDefinition: map[string]string{
				"a.go:1:17": "git://test/pkg?master#a.go:1:17 name:A package:test/pkg packageName:p recv: vendor:false",
				"a.go:1:23": "git://test/pkg?master#a.go:1:17 name:A package:test/pkg packageName:p recv: vendor:false",
				"b.go:1:17": "git://test/pkg?master#b.go:1:17 name:B package:test/pkg packageName:p recv: vendor:false",
				"b.go:1:23": "git://test/pkg?master#a.go:1:17 name:A package:test/pkg packageName:p recv: vendor:false",
			},
			wantReferences: map[string][]string{
				"a.go:1:17": []string{
		...
		"go subdirectory in repo": {
			...
			wantXDefinition: map[string]string{
				"a.go:1:17":    "git://test/pkg?master#d/a.go:1:17 name:A package:test/pkg/d packageName:d recv: vendor:false",
				"a.go:1:23":    "git://test/pkg?master#d/a.go:1:17 name:A package:test/pkg/d packageName:d recv: vendor:false",
				"d2/b.go:1:39": "git://test/pkg?master#d/d2/b.go:1:39 name:B package:test/pkg/d/d2 packageName:d2 recv: vendor:false",
				"d2/b.go:1:47": "git://test/pkg?master#d/a.go:1:17 name:A package:test/pkg/d packageName:d recv: vendor:false",
				"d2/b.go:1:52": "git://test/pkg?master#d/d2/b.go:1:39 name:B package:test/pkg/d/d2 packageName:d2 recv: vendor:false",
			},
			wantSymbols: map[string][]string{
...
package main; import "test/pkg"; func B() { p.A(); B() }`,
		...
		"goroot": {
			...
			wantXDefinition: map[string]string{
				"a.go:1:40": "git://github.com/golang/go?go1.7.1#src/fmt/print.go:1:19 name:Println package:fmt packageName:fmt recv: vendor:false",
			},
		...
		"gopath": {
			...
			wantXDefinition: map[string]string{
				"a/a.go:1:17": "git://test/pkg?master#a/a.go:1:17 name:A package:test/pkg/a packageName:a recv: vendor:false",
				"b/b.go:1:43": "git://test/pkg?master#a/a.go:1:17 name:A package:test/pkg/a packageName:a recv: vendor:false",
			},
			wantReferences: map[string][]string{
				"a/a.go:1:17": []string{
		...
		"go vendored dep": {
			...
			wantXDefinition: map[string]string{
				"a.go:1:61": "git://test/pkg?master#vendor/github.com/v/vendored/v.go:1:24 name:V package:test/pkg/vendor/github.com/v/vendored packageName:vendored recv: vendor:true",
			},
			wantReferences: map[string][]string{
		...
		"go external dep": {
			...
			wantXDefinition: map[string]string{
				"a.go:1:51": "git://github.com/d/dep?HEAD#d.go:1:19 name:D package:github.com/d/dep packageName:dep recv: vendor:false",
			},
			wantReferences: map[string][]string{
				"a.go:1:51": []string{
		...
		"external dep with vendor": {
			...
			wantXDefinition: map[string]string{
				"a.go:1:55": "git://github.com/d/dep?HEAD#vendor/vendp/vp.go:1:32 name:F package:github.com/d/dep/vendor/vendp packageName:vendp recv:V vendor:true",
			},
			depFS: map[string]map[string]string{
		...
		"go external dep at subtree": {
			...
			wantXDefinition: map[string]string{
				"a.go:1:57": "git://github.com/d/dep?HEAD#subp/d.go:1:20 name:D package:github.com/d/dep/subp packageName:subp recv: vendor:false",
			},
			depFS: map[string]map[string]string{
				"https://github.com/d/dep?HEAD": {
		...
		"go nested external dep": { // a depends on dep1, dep1 depends on dep2
			...
			wantXDefinition: map[string]string{
				"a.go:1:53": "git://github.com/d/dep1?HEAD#d1.go:1:48 name:D1 package:github.com/d/dep1 packageName:dep1 recv: vendor:false",
				"a.go:1:58": "git://github.com/d/dep2?HEAD#d2.go:1:32 name:D2 package:github.com/d/dep2 packageName:dep2 recv:D2 vendor:false",
			},
			depFS: map[string]map[string]string{
		...
		"go external dep at vanity import path": {
			...
			wantXDefinition: map[string]string{
				"a.go:1:53": "git://github.com/golang/text?HEAD#dummy.go:1:20 name:F package:golang.org/x/text packageName:text recv: vendor:false",
			},
			depFS: map[string]map[string]string{
...
var (
	...
	bb = B
			...
			wantXDefinition: map[string]string{
				"a/a.go:5:5":  "git://test/foo?master#a/a.go:5:5 name:A package:other/foo/a packageName:a recv: vendor:false",
				"a/a.go:5:11": "git://test/foo?master#b/b.go:4:2 name:B package:other/foo/b packageName:b recv: vendor:false",
				"b/b.go:4:2":  "git://test/foo?master#b/b.go:4:2 name:B package:other/foo/b packageName:b recv: vendor:false",
				"b/b.go:5:7":  "git://test/foo?master#b/b.go:4:2 name:B package:other/foo/b packageName:b recv: vendor:false",
			},
		},
