				...
				Observables: []Observable{
					{
						...
						PanelOptions:    PanelOptions().DefaultValue(0).LegendFormat("error"),
					},
					{
						...
						DataMayNotExist: true,
						Warning:         Alert{GreaterOrEqual: 5},
						PanelOptions:    PanelOptions().DefaultValue(0).LegendFormat("panic"),
					},
				},
			},
			{
				...
				Observables: []Observable{
					{
						...
						DataMayNotExist: true,
						Warning:         Alert{GreaterOrEqual: 5},
						PanelOptions:    PanelOptions().DefaultValue(0).LegendFormat("timeout"),
					},
					{
						...
						PanelOptions:    PanelOptions().DefaultValue(0).LegendFormat("worker death"),
					},
				},
			},
		},
